/*
 * include/linux/atmel_qt602240 - platform data structure for the touchscreen of Atmel mXT224E
 *
...
#define ATMEL_MXT224E_ADDRESS (0x4A)
#define ATMEL_MXT224E_GPIO_BLOCK "block_ts"
