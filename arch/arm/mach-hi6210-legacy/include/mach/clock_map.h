...
#define SCTRL_OFF_BASE_ADDR  IO_ADDRESS(SOC_PERI_SCTRL_BASE_ADDR)
#define SCTRL_ON_BASE_ADDR   IO_ADDRESS(SOC_AO_SCTRL_BASE_ADDR)
#define PMCTRL_BASE_ADDR     IO_ADDRESS(SOC_PMCTRL_BASE_ADDR)

#if defined(CHIP_BB_HI6210) 
/*对时钟打桩处理*/
#define TMP_CLOCK_ADDR SOC_PMCTRL_MEDPLLRESERVED1_ADDR(IO_ADDRESS(SOC_PMCTRL_BASE_ADDR))
#define TMP_CLOCK_BIT  1
#endif
/* clkin_sys操作宏相关转定义 */
...
/* clk_syslpl操作宏相关转定义 */
/* 转定义时钟clk_syspll的使能寄存器，状态寄存器的地址和位偏移 */
#define CLK_SYSPLL_ENABLE_REG_ADDR  NULL    /* 使能寄存器地址转定义宏 */
#define CLK_SYSPLL_ENABLE_BIT_OFFSET    0   /* 时钟使能位偏移 */

/* 转定义时钟clk_syspll的时钟选择寄存器、选择掩码和设置有效标志位 */
#define CLK_SYSPLL_CLKSEL_REG_ADDR  NULL    //父时钟选择寄存器地址转定义宏
#define CLK_SYSPLL_CLKSEL_MASK      0   //父时钟选择掩码
#define CLK_SYSPLL_CLKSEL_SET_VALID 0       //父时钟选择有效标志位
#define CLK_SYSPLL_CLKDIV_REG_ADDR  NULL    //时钟分频寄存器地址转定义宏
#define CLK_SYSPLL_CLKDIV_MASK      0                   //时钟分频掩码
#define CLK_SYSPLL_CLKDIV_SET_VALID 0       //时钟分频设置有效标志位

/* clk_gpll0操作宏相关转定义 */
/* 转定义时钟clk_gpll0的使能寄存器，状态寄存器的地址和位偏移 */
#if defined(CHIP_BB_HI6210)
#define CLK_GPLL0_ENABLE_REG_ADDR   SOC_PMCTRL_GPUPLLCTRL_ADDR(PMCTRL_BASE_ADDR)  /* 使能寄存器地址转定义宏 */
#define CLK_GPLL0_ENABLE_BIT_OFFSET SOC_PMCTRL_GPUPLLCTRL_gpupll_en_START /* 时钟使能位偏移 */
#else
...
#define CLK_PERIPLL_ENABLE_REG_ADDR  SOC_PMCTRL_MEDPLLCTRL_ADDR(PMCTRL_BASE_ADDR)//SOC_PMCTRL_PERIPLLCTRL_ADDR(PMCTRL_BASE_ADDR)    /* 使能寄存器地址转定义宏 */
#define CLK_PERIPLL_ENABLE_BIT_OFFSET   SOC_PMCTRL_MEDPLLCTRL_medpll_en_START//SOC_PMCTRL_PERIPLLCTRL_peripll_en_START

#define CLK_DDRBUS_DIV_CLKDIV_REG_ADDR  TMP_CLOCK_ADDR//SOC_PMCTRL_DDRCLKPROFILE_ADDR(PMCTRL_BASE_ADDR) //时钟分频寄存器地址转定义宏
#define CLK_DDRBUS_DIV_CLKDIV_MASK      TMP_CLOCK_BIT/*CALC_REG_MASK(SOC_PMCTRL_DDRCLKPROFILE_ddrbus_clk_div_prof_START, \
...
#define CLK_HDMIPLL_ENABLE_REG_ADDR TMP_CLOCK_ADDR//SOC_PMCTRL_HDMIPLLCTRL_ADDR(PMCTRL_BASE_ADDR)    /* 使能寄存器地址转定义宏 */
#define CLK_HDMIPLL_ENABLE_BIT_OFFSET   TMP_CLOCK_BIT//SOC_PMCTRL_HDMIPLLCTRL_hdmipll_en_START   /* 时钟使能位偏移 */
...
#define CLK_BUS_SRC_CLKDIV_REG_ADDR SOC_PERI_SCTRL_SC_CLKCFG8BIT0_ADDR(SCTRL_OFF_BASE_ADDR)  //时钟分频寄存器地址转定义宏
#define CLK_BUS_SRC_CLKDIV_MASK     CALC_REG_MASK(SOC_PERI_SCTRL_SC_CLKCFG8BIT0_clk_8bit_cfg0_value0_clkbus_low_START, \
                                        SOC_PERI_SCTRL_SC_CLKCFG8BIT0_clk_8bit_cfg0_value0_clkbus_low_END)                  //时钟分频掩码
#define CLK_BUS_SRC_CLKDIV_SET_VALID    SOC_PERI_SCTRL_SC_CLKCFG8BIT0_clk_8bit_cfg0_vld0_clkbus_low_START       //时钟分频设置有效标志位
...
#if 1
/*暂时注释掉，手册未找到*/                                                   
#define CLK_27M_ENABLE_REG_ADDR     TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN8_ADDR(SCTRL_OFF_BASE_ADDR)    /* 使能寄存器地址转定义宏 */
#define CLK_27M_ENABLE_BIT_OFFSET   TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN8_periph_clken8_27m_START   /* 时钟使能位偏移 */

#define CLK_27M_CLKDIV_REG_ADDR    TMP_CLOCK_ADDR//SOC_SCTRL_SC_CLKCFG8BIT4_ADDR(SCTRL_OFF_BASE_ADDR)  //时钟分频寄存器地址转定义宏
#define CLK_27M_CLKDIV_MASK        TMP_CLOCK_BIT/*CALC_REG_MASK(SOC_SCTRL_SC_CLKCFG8BIT4_clk_8bit_cfg4_value1_START, \
                                                            SOC_SCTRL_SC_CLKCFG8BIT4_clk_8bit_cfg4_value1_END)*/                  //时钟分频掩码
#define CLK_27M_CLKDIV_SET_VALID   TMP_CLOCK_BIT//SOC_SCTRL_SC_CLKCFG8BIT4_clk_8bit_cfg4_vld1_START       //时钟分频设置有效标志位

#define CLK_90K_ENABLE_REG_ADDR  TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN8_ADDR(SCTRL_OFF_BASE_ADDR)    /* 使能寄存器地址转定义宏 */
#define CLK_90K_ENABLE_BIT_OFFSET   TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN8_periph_clken8_90k_START   /* 时钟使能位偏移 */

/* clk_mali 操作宏相关转定义 */
/* 转定义时钟clk_mali的使能寄存器，状态寄存器的地址和位偏移 */
#define CLK_MALI_ENABLE_REG_ADDR    TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN12_ADDR(SCTRL_OFF_BASE_ADDR)   /* 使能寄存器地址转定义宏 */
#define CLK_MALI_ENABLE_BIT_OFFSET  TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN12_periph_clken12_6clk_mali_START  /* 时钟使能位偏移 */

/* 转定义时钟clk_mali的时钟选择寄存器、选择掩码和设置有效标志位 */
#define CLK_MALI_CLKSEL_REG_ADDR    TMP_CLOCK_ADDR//SOC_PMCTRL_G3DCLKSEL_ADDR(PMCTRL_BASE_ADDR) //父时钟选择寄存器地址转定义宏
#define CLK_MALI_CLKSEL_MASK        TMP_CLOCK_BIT//CALC_REG_MASK(SOC_PMCTRL_G3DCLKSEL_g3d_pllsw_cfg_START, SOC_PMCTRL_G3DCLKSEL_g3d_pllsw_cfg_END) //父时钟选择掩码
#define CLK_MALI_CLKSEL_SET_VALID   TMP_CLOCK_BIT//CALC_REG_MASK(SOC_PMCTRL_G3DCLKSEL_g3d_pllsw_stat_START, SOC_PMCTRL_G3DCLKSEL_g3d_pllsw_stat_END)        //父时钟选择有效标志位

/* 转定义时钟 clk_mali 的时钟分频寄存器、选择掩码和设置有效标志位 */
#define CLK_MALI_CLKDIV_REG_ADDR    TMP_CLOCK_ADDR//SOC_PMCTRL_G3DCLKDIV_ADDR(PMCTRL_BASE_ADDR) //时钟分频寄存器地址转定义宏
#define CLK_MALI_CLKDIV_MASK        TMP_CLOCK_BIT/*CALC_REG_MASK(SOC_PMCTRL_G3DCLKDIV_g3d_clkdiv_cfg_START, \
...
#define CLK_DSPPLL_EDC0_CORE_GATED_ENABLE_REG_ADDR      TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN12_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_DSPPLL_EDC0_CORE_GATED_ENABLE_BIT_OFFSET    TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN12_periph_clkstat12_dsppll_edc0_core_gated_START           //时钟使能位偏移

/* 转定义时钟clk_dsppll_edc0_core_gated的时钟选择寄存器、选择掩码和设置有效标志位 */
#define CLK_DSPPLL_EDC0_CORE_GATED_CLKSEL_REG_ADDR  TMP_CLOCK_ADDR//SOC_PMCTRL_CLKCFG4BIT1_ADDR(PMCTRL_BASE_ADDR)   //父时钟选择寄存器地址转定义宏
#define CLK_DSPPLL_EDC0_CORE_GATED_CLKSEL_MASK      TMP_CLOCK_BIT//CALC_REG_MASK(SOC_PMCTRL_CLKCFG4BIT1_clk_4bit_cfg1_value4_START, \
                                                            //SOC_PMCTRL_CLKCFG4BIT1_clk_4bit_cfg1_value4_END)    //父时钟选择掩码
#define CLK_DSPPLL_EDC0_CORE_GATED_CLKSEL_SET_VALID  TMP_CLOCK_BIT//CALC_REG_MASK(SOC_PMCTRL_CLKCFG4BIT1_clk_4bit_cfg1_vld4_START , \
...
#define CLK_EDC0_CORE_ENABLE_REG_ADDR       TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN11_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_EDC0_CORE_ENABLE_BIT_OFFSET     TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN11_periph_clken11_edc0_core_START          //时钟使能位偏移
...
#define CLK_EDC0_CORE_CLKDIV_REG_ADDR   TMP_CLOCK_ADDR//SOC_SCTRL_SC_CLKCFG8BIT7_ADDR(SCTRL_OFF_BASE_ADDR)  //时钟分频寄存器地址转定义宏
#define CLK_EDC0_CORE_CLKDIV_MASK       TMP_CLOCK_BIT/*CALC_REG_MASK(SOC_SCTRL_SC_CLKCFG8BIT7_clk_8bit_cfg7_value1_START, \
                                                SOC_SCTRL_SC_CLKCFG8BIT7_clk_8bit_cfg7_value1_END)*/                  //时钟分频掩码
#define CLK_EDC0_CORE_CLKDIV_SET_VALID  TMP_CLOCK_ADDR//SOC_SCTRL_SC_CLKCFG8BIT7_clk_8bit_cfg7_vld1_START       //时钟分频设置有效标志位

/* clk_edc0_core操作宏相关转定义 */

/* clk_mux_edc0_pix_gated操作宏相关转定义 */
/* 转定义时钟clk_mux_edc0_pix_gated的使能寄存器，状态寄存器的地址和位偏移 */
#define CLK_MUX_EDC0_PIX_GATED_ENABLE_REG_ADDR      TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN12_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_MUX_EDC0_PIX_GATED_ENABLE_BIT_OFFSET    TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN12_periph_clkstat12_mux_dec0_pix_gated_START           //时钟使能位偏移

/* 转定义时钟clk_mux_edc0_pix_gated的时钟选择寄存器、选择掩码和设置有效标志位 */
#define CLK_MUX_EDC0_PIX_GATED_CLKSEL_REG_ADDR  TMP_CLOCK_ADDR//SOC_PMCTRL_CLKCFG4BIT1_ADDR(PMCTRL_BASE_ADDR)   //父时钟选择寄存器地址转定义宏
#define CLK_MUX_EDC0_PIX_GATED_CLKSEL_MASK      TMP_CLOCK_BIT//CALC_REG_MASK(SOC_PMCTRL_CLKCFG4BIT1_clk_4bit_cfg1_value4_START, \
                                                        //SOC_PMCTRL_CLKCFG4BIT1_clk_4bit_cfg1_value4_END)    //父时钟选择掩码
#define CLK_MUX_EDC0_PIX_GATED_CLKSEL_SET_VALID TMP_CLOCK_BIT//CALC_REG_MASK(SOC_PMCTRL_CLKCFG4BIT1_clk_4bit_cfg1_vld4_START, \
                                                        //SOC_PMCTRL_CLKCFG4BIT1_clk_4bit_cfg1_vld4_END)    //父时钟选择掩码
...
#define CLK_EDC0_PIX_LDI_ENABLE_REG_ADDR    TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN11_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_EDC0_PIX_LDI_ENABLE_BIT_OFFSET  TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN11_periph_clken11_edc0_pix_ldi_START           //时钟使能位偏移
...
#define CLK_EDC0_PIX_LDI_CLKDIV_REG_ADDR    TMP_CLOCK_ADDR//SOC_SCTRL_SC_CLKCFG8BIT7_ADDR(SCTRL_OFF_BASE_ADDR)  //时钟分频寄存器地址转定义宏
#define CLK_EDC0_PIX_LDI_CLKDIV_MASK        TMP_CLOCK_BIT/*CALC_REG_MASK(SOC_SCTRL_SC_CLKCFG8BIT7_clk_8bit_cfg7_value0_START, \
                                                            SOC_SCTRL_SC_CLKCFG8BIT7_clk_8bit_cfg7_value0_END)*/                 //时钟分频掩码
#define CLK_EDC0_PIX_LDI_CLKDIV_SET_VALID   TMP_CLOCK_BIT//SOC_SCTRL_SC_CLKCFG8BIT7_clk_8bit_cfg7_vld0_START       //时钟分频设置有效标志位

/* clk_edc0_pix_ldi操作宏相关转定义 */

/* clk_edc1_core操作宏相关转定义 */
/* 转定义时钟clk_edc1_core的使能寄存器，状态寄存器的地址和位偏移 */
#define CLK_EDC1_CORE_ENABLE_REG_ADDR       TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN11_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_EDC1_CORE_ENABLE_BIT_OFFSET     TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN11_periph_clken11_edc1_core_START          //时钟使能位偏移
...
#define CLK_EDC1_CORE_CLKDIV_REG_ADDR   TMP_CLOCK_ADDR//SOC_SCTRL_SC_CLKCFG8BIT7_ADDR(SCTRL_OFF_BASE_ADDR)  //时钟分频寄存器地址转定义宏
#define CLK_EDC1_CORE_CLKDIV_MASK       TMP_CLOCK_BIT/*CALC_REG_MASK(SOC_SCTRL_SC_CLKCFG8BIT7_clk_8bit_cfg7_value3_START, \
                                                SOC_SCTRL_SC_CLKCFG8BIT7_clk_8bit_cfg7_value3_END)*/                  //时钟分频掩码
#define CLK_EDC1_CORE_CLKDIV_SET_VALID  TMP_CLOCK_BIT//SOC_SCTRL_SC_CLKCFG8BIT7_clk_8bit_cfg7_vld3_START       //时钟分频设置有效标志位
...
#define CLK_AXI_VIDEO_BUS_ENABLE_REG_ADDR       TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN10_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_AXI_VIDEO_BUS_ENABLE_BIT_OFFSET     TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN10_periph_clken10_axi_video_bus_START          //时钟使能位偏移
...
#define CLK_AXI_IMG_BUS_ENABLE_REG_ADDR     TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN10_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_AXI_IMG_BUS_ENABLE_BIT_OFFSET       TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN10_periph_clken10_axi_img_bus_START            //时钟使能位偏移
...
#define CLK_PERIPLL_VPP_GATED_ENABLE_REG_ADDR       TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN12_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_PERIPLL_VPP_GATED_ENABLE_BIT_OFFSET TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN12_periph_clkstat12_peripll_vpp_gated_START            //时钟使能位偏移
...
#define CLK_X2X_VPP_BRG_S_ENABLE_REG_ADDR       TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN10_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_X2X_VPP_BRG_S_ENABLE_BIT_OFFSET     TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN10_periph_clken10_x2x_vpp_brg_s_START          //时钟使能位偏移
...
#define CLK_P2P_VPP_BRG_S_ENABLE_REG_ADDR       TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN8_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_P2P_VPP_BRG_S_ENABLE_BIT_OFFSET     TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN8_periph_clken8_p2p_vpp_brg_s_START            //时钟使能位偏移
...
#define CLK_2VPP_SLAVE_CLK_ENABLE_REG_ADDR      TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN12_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_2VPP_SLAVE_CLK_ENABLE_BIT_OFFSET    TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN12_periph_clken12_2vpp_slave_clk_START         //时钟使能位偏移
...
#define CLK_2VPP_SLAVE_CLK_CLKDIV_REG_ADDR  TMP_CLOCK_ADDR//SOC_SCTRL_SC_CLKCFG8BIT8_ADDR(SCTRL_OFF_BASE_ADDR)  //时钟分频寄存器地址转定义宏
#define CLK_2VPP_SLAVE_CLK_CLKDIV_MASK      TMP_CLOCK_BIT/*CALC_REG_MASK(SOC_SCTRL_SC_CLKCFG8BIT8_clk_8bit_cfg8_value2_START, \
                                                SOC_SCTRL_SC_CLKCFG8BIT8_clk_8bit_cfg8_value2_END)*/                  //时钟分频掩码
#define CLK_2VPP_SLAVE_CLK_CLKDIV_SET_VALID TMP_CLOCK_BIT//SOC_SCTRL_SC_CLKCFG8BIT8_clk_8bit_cfg8_vld2_START       //时钟分频设置有效标志位

/* clk_2vpp_slave_clk操作宏相关转定义 */

/* clk_peripll_venc_gated操作宏相关转定义 */
/* 转定义时钟clk_peripll_venc_gated的使能寄存器，状态寄存器的地址和位偏移 */
#define CLK_PERIPLL_VENC_GATED_ENABLE_REG_ADDR      TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN12_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_PERIPLL_VENC_GATED_ENABLE_BIT_OFFSET        TMP_CLOCK_BIT//C_SCTRL_SC_PERIPH_CLKEN12_periph_clkstat12_peripll_venc_gated_START           //时钟使能位偏移
...
#define CLK_X2X_VENC_BRG_S_ENABLE_REG_ADDR      TMP_CLOCK_ADDR//C_SCTRL_SC_PERIPH_CLKEN10_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_X2X_VENC_BRG_S_ENABLE_BIT_OFFSET    TMP_CLOCK_BIT//CTRL_SC_PERIPH_CLKEN10_periph_clken10_x2x_venc_brg_s_START         //时钟使能位偏移
...
#define CLK_P2P_VENC_BRG_S_ENABLE_REG_ADDR      TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN8_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_P2P_VENC_BRG_S_ENABLE_BIT_OFFSET    TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN8_periph_clken8_p2p_venc_brg_s_START           //时钟使能位偏移
...
#define CLK_0VENC_SLAVE_CLK_ENABLE_REG_ADDR     TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN12_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_0VENC_SLAVE_CLK_ENABLE_BIT_OFFSET       TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN12_periph_clken12_0venc_clk_START          //时钟使能位偏移
...
#define CLK_0VENC_SLAVE_CLK_CLKDIV_REG_ADDR TMP_CLOCK_ADDR//SOC_SCTRL_SC_CLKCFG8BIT8_ADDR(SCTRL_OFF_BASE_ADDR)  //时钟分频寄存器地址转定义宏
#define CLK_0VENC_SLAVE_CLK_CLKDIV_MASK     TMP_CLOCK_BIT/*CALC_REG_MASK(SOC_SCTRL_SC_CLKCFG8BIT8_clk_8bit_cfg8_value3_START, \
                                                SOC_SCTRL_SC_CLKCFG8BIT8_clk_8bit_cfg8_value3_END)*/                  //时钟分频掩码
#define CLK_0VENC_SLAVE_CLK_CLKDIV_SET_VALID    TMP_CLOCK_BIT//SOC_SCTRL_SC_CLKCFG8BIT8_clk_8bit_cfg8_vld3_START       //时钟分频设置有效标志位

/* clk_0venc_slave_clk操作宏相关转定义 */

/* clk_peripll_vdec_gated操作宏相关转定义 */
/* 转定义时钟clk_peripll_vdec_gated的使能寄存器，状态寄存器的地址和位偏移 */
#define CLK_PERIPLL_VDEC_GATED_ENABLE_REG_ADDR      TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN12_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_PERIPLL_VDEC_GATED_ENABLE_BIT_OFFSET       TMP_CLOCK_BIT //SOC_SCTRL_SC_PERIPH_CLKEN12_periph_clkstat12_dsppll_vdec_gated_START            //时钟使能位偏移
...
#define CLK_X2X_VDEC_BRG_S_ENABLE_REG_ADDR      TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN10_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_X2X_VDEC_BRG_S_ENABLE_BIT_OFFSET    TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN10_periph_clken10_x2x_vdec_brg_s_START         //时钟使能位偏移
...
#define CLK_P2P_VDEC_BRG_S_ENABLE_REG_ADDR      TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN8_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_P2P_VDEC_BRG_S_ENABLE_BIT_OFFSET    TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN8_periph_clken8_p2p_vdec_brg_s_START           //时钟使能位偏移
...
#define CLK_1VDEC_SLAVE_CLK_ENABLE_REG_ADDR     TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN12_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_1VDEC_SLAVE_CLK_ENABLE_BIT_OFFSET       TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN12_periph_clken12_2vpp_slave_clk_START         //时钟使能位偏移
...
#define CLK_1VDEC_SLAVE_CLK_CLKDIV_REG_ADDR TMP_CLOCK_ADDR//SOC_SCTRL_SC_CLKCFG8BIT8_ADDR(SCTRL_OFF_BASE_ADDR)  //时钟分频寄存器地址转定义宏
#define CLK_1VDEC_SLAVE_CLK_CLKDIV_MASK     TMP_CLOCK_BIT/*CALC_REG_MASK(SOC_SCTRL_SC_CLKCFG8BIT8_clk_8bit_cfg8_value1_START, \
                                                SOC_SCTRL_SC_CLKCFG8BIT8_clk_8bit_cfg8_value1_END)*/                  //时钟分频掩码
#define CLK_1VDEC_SLAVE_CLK_CLKDIV_SET_VALID    TMP_CLOCK_ADDR//SOC_SCTRL_SC_CLKCFG8BIT8_clk_8bit_cfg8_vld1_START       //时钟分频设置有效标志位
...
#define CLK_5G2D_CORE_CLK_ENABLE_REG_ADDR       TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN12_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_5G2D_CORE_CLK_ENABLE_BIT_OFFSET     TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN12_periph_clken12_5g2d_core_clk_START          //时钟使能位偏移
...
#define CLK_5G2D_CORE_CLK_CLKDIV_REG_ADDR   TMP_CLOCK_ADDR//SOC_SCTRL_SC_CLKCFG8BIT6_ADDR(SCTRL_OFF_BASE_ADDR)  //时钟分频寄存器地址转定义宏
#define CLK_5G2D_CORE_CLK_CLKDIV_MASK      TMP_CLOCK_BIT /*CALC_REG_MASK(SOC_SCTRL_SC_CLKCFG8BIT6_clk_8bit_cfg6_value0_START, \
                                                SOC_SCTRL_SC_CLKCFG8BIT6_clk_8bit_cfg6_value0_END)*/                  //时钟分频掩码
#define CLK_5G2D_CORE_CLK_CLKDIV_SET_VALID  TMP_CLOCK_ADDR//SOC_SCTRL_SC_CLKCFG8BIT6_clk_8bit_cfg6_vld0_START       //时钟分频设置有效标志位

/* clk_5g2d_core_clk操作宏相关转定义 */

/* clk_4g2d_axi_clkhb操作宏相关转定义 */
/* 转定义时钟clk_4g2d_axi_clkhb的使能寄存器，状态寄存器的地址和位偏移 */
#define CLK_4G2D_AXI_CLKHB_ENABLE_REG_ADDR      TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN12_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_4G2D_AXI_CLKHB_ENABLE_BIT_OFFSET        TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN12_periph_clken12_4g2d_axi_clkhb_START         //时钟使能位偏移
...
#define CLK_3G2D_CFG_CLK_ENABLE_REG_ADDR        TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN12_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_3G2D_CFG_CLK_ENABLE_BIT_OFFSET      TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN12_periph_clken12_3g2d_cfg_clk_START           //时钟使能位偏移
...
#define CLK_P2P_MALI_BRG_S_ENABLE_REG_ADDR      TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN8_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_P2P_MALI_BRG_S_ENABLE_BIT_OFFSET        TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN8_periph_clken8_p2p_mali_brg_s_START           //时钟使能位偏移
...
#define CLK_X2X_MALI_BRG_S_ENABLE_REG_ADDR      TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN10_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_X2X_MALI_BRG_S_ENABLE_BIT_OFFSET        TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN10_periph_clken10_x2x_mali_brg_s_START         //时钟使能位偏移
...
#define CLK_X2X_MALI_BRG_M_ENABLE_REG_ADDR      TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN10_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_X2X_MALI_BRG_M_ENABLE_BIT_OFFSET        TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN10_periph_clken10_x2x_mali_brg_m_START         //时钟使能位偏移
...
#define CLK_AXI_MALI_BUS_ENABLE_REG_ADDR        TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN10_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_AXI_MALI_BUS_ENABLE_BIT_OFFSET      TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN10_periph_clken10_axi_mali_bus_START           //时钟使能位偏移
...
#define CLK_ACLK_EDC0_ENABLE_REG_ADDR       TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN11_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_ACLK_EDC0_ENABLE_BIT_OFFSET     TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN11_periph_clken11_aclk_edc0_START          //时钟使能位偏移
...
#define CLK_EDC0_CFG_CLK_ENABLE_REG_ADDR        TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN11_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_EDC0_CFG_CLK_ENABLE_BIT_OFFSET      TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN11_periph_clken11_edc0_cfg_clk_START           //时钟使能位偏移
...
#define CLK_DSIO_CFG_CLK_ENABLE_REG_ADDR        TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN12_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_DSIO_CFG_CLK_ENABLE_BIT_OFFSET      TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN11_periph_clken11_dsio_cfg_clk_START           //时钟使能位偏移
...
#define CLK_EDC1_PIX_LDI_ENABLE_REG_ADDR        TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN11_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_EDC1_PIX_LDI_ENABLE_BIT_OFFSET      TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN11_periph_clken11_edc1_pix_ldi_START           //时钟使能位偏移
...
#define CLK_EDC1_PIX_LDI_CLKDIV_REG_ADDR    TMP_CLOCK_ADDR//SOC_SCTRL_SC_CLKCFG8BIT7_ADDR(SCTRL_OFF_BASE_ADDR)  //时钟分频寄存器地址转定义宏
#define CLK_EDC1_PIX_LDI_CLKDIV_MASK        TMP_CLOCK_BIT/*CALC_REG_MASK(SOC_SCTRL_SC_CLKCFG8BIT7_clk_8bit_cfg7_value2_START, \
                                                SOC_SCTRL_SC_CLKCFG8BIT7_clk_8bit_cfg7_value2_END) */                 //时钟分频掩码
#define CLK_EDC1_PIX_LDI_CLKDIV_SET_VALID   TMP_CLOCK_BIT//SOC_SCTRL_SC_CLKCFG8BIT7_clk_8bit_cfg7_vld2_START       //时钟分频设置有效标志位

/* clk_edc1_pix_ldi操作宏相关转定义 */

/* clk_edc1_axi操作宏相关转定义 */
/* 转定义时钟clk_edc1_axi的使能寄存器，状态寄存器的地址和位偏移 */
#define CLK_EDC1_AXI_ENABLE_REG_ADDR        TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN11_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_EDC1_AXI_ENABLE_BIT_OFFSET      TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN11_periph_clken11_edc1_axi_START           //时钟使能位偏移
...
#define CLK_EDC1_CFG_CLK_ENABLE_REG_ADDR        TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN11_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_EDC1_CFG_CLK_ENABLE_BIT_OFFSET      TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN11_periph_clken11_edc1_cfg_clk_START         //时钟使能位偏移
...
#define CLK_ISP_CFG_CLK_ENABLE_REG_ADDR     TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN11_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_ISP_CFG_CLK_ENABLE_BIT_OFFSET       TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN11_periph_clken11_isp_cfg_clk_START            //时钟使能位偏移
...
#define CLK_ISP_AXI_ENABLE_REG_ADDR     TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN11_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_ISP_AXI_ENABLE_BIT_OFFSET       TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN11_periph_clken11_isp_axi_START         //时钟使能位偏移
...
#define CLK_PERIPLL_ISP_GATED_ENABLE_REG_ADDR       TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN12_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_PERIPLL_ISP_GATED_ENABLE_BIT_OFFSET     TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN12_periph_clkstat12_dsppll_isp_gated_START         //时钟使能位偏移
...
#define CLK_ISP_ENABLE_REG_ADDR     TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN11_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_ISP_ENABLE_BIT_OFFSET       TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN11_periph_clken11_clk_isp_START            //时钟使能位偏移
...
#define CLK_ISP_CLKDIV_REG_ADDR     TMP_CLOCK_ADDR//SOC_SCTRL_SC_CLKCFG8BIT6_ADDR(SCTRL_OFF_BASE_ADDR)  //时钟分频寄存器地址转定义宏
#define CLK_ISP_CLKDIV_MASK         TMP_CLOCK_BIT/*CALC_REG_MASK(SOC_SCTRL_SC_CLKCFG8BIT6_clk_8bit_cfg6_value1_START, \
                                                SOC_SCTRL_SC_CLKCFG8BIT6_clk_8bit_cfg6_value1_END)*/              //时钟分频掩码
#define CLK_ISP_CLKDIV_SET_VALID    TMP_CLOCK_BIT//SOC_SCTRL_SC_CLKCFG8BIT6_clk_8bit_cfg6_vld1_START       //时钟分频设置有效标志位

/* clk_isp操作宏相关转定义 */

/* clk_peripll_isp_ref_gated操作宏相关转定义 */
/* 转定义时钟clk_peripll_isp_ref_gated的使能寄存器，状态寄存器的地址和位偏移 */
#define CLK_PERIPLL_ISP_REF_GATED_ENABLE_REG_ADDR       TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN12_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_PERIPLL_ISP_REF_GATED_ENABLE_BIT_OFFSET     TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN12_periph_clkstat12_peripll_isp_ref_gated_START            //时钟使能位偏移
...
#define CLK_ISP_REF_ENABLE_REG_ADDR     TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN11_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_ISP_REF_ENABLE_BIT_OFFSET       TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN11_periph_clken11_clk_isp_ref_START            //时钟使能位偏移
...
#define CLK_ISP_REF_CLKDIV_REG_ADDR     TMP_CLOCK_ADDR//SOC_SCTRL_SC_CLKCFG8BIT6_ADDR(SCTRL_OFF_BASE_ADDR)  //时钟分频寄存器地址转定义宏
#define CLK_ISP_REF_CLKDIV_MASK         TMP_CLOCK_BIT/*CALC_REG_MASK(SOC_SCTRL_SC_CLKCFG8BIT6_clk_8bit_cfg6_value3_START, \
                                                SOC_SCTRL_SC_CLKCFG8BIT6_clk_8bit_cfg6_value3_END) */             //时钟分频掩码
#define CLK_ISP_REF_CLKDIV_SET_VALID   TMP_CLOCK_BIT// SOC_SCTRL_SC_CLKCFG8BIT6_clk_8bit_cfg6_vld3_START       //时钟分频设置有效标志位
...
/*hdmi暂时注释掉，手册未提供修改策略*/
#define CLK_HDMI_SLAVE_ENABLE_REG_ADDR      TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN11_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_HDMI_SLAVE_ENABLE_BIT_OFFSET        TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN11_periph_clken11_hdmi_slave_START         //时钟使能位偏移
...
#define CLK_HDMI_SCK_ENABLE_REG_ADDR        TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN11_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_HDMI_SCK_ENABLE_BIT_OFFSET      TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN11_periph_clken11_clk_hdmi_sck_START           //时钟使能位偏移
...
#define CLK_HDMIPLL_DIVFRAC_CLKDIV_REG_ADDR TMP_CLOCK_ADDR//SOC_SCTRL_SC_CLKCFGALL4_ADDR(SCTRL_OFF_BASE_ADDR)   //时钟分频寄存器地址转定义宏
#define CLK_HDMIPLL_DIVFRAC_CLKDIV_MASK     TMP_CLOCK_BIT/*CALC_REG_MASK(SOC_SCTRL_SC_CLKCFGALL4_divfrac_49m_START, \
...
#define CLK_MCLK_HDMI_ENABLE_REG_ADDR       TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN11_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_MCLK_HDMI_ENABLE_BIT_OFFSET     TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN11_periph_clken11_mclk_hdmi_START          //时钟使能位偏移
...
#define CLK_ASP_HDMI_ADWS_ENABLE_REG_ADDR       TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN3_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_ASP_HDMI_ADWS_ENABLE_BIT_OFFSET     TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN3_periph_clken3_clk_asp_hdmi_adws_START            //时钟使能位偏移
...
#define CLK_ASP_HDMI_BCLK_ENABLE_REG_ADDR       TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN3_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_ASP_HDMI_BCLK_ENABLE_BIT_OFFSET     TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN3_periph_clken3_clk_asp_hdmi_bclk_START            //时钟使能位偏移
...
#define CLK_ASP_HDMI_REF_ENABLE_REG_ADDR        TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN3_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_ASP_HDMI_REF_ENABLE_BIT_OFFSET      TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN3_periph_clken3_clk_asp_hdmi_ref_START         //时钟使能位偏移
...
#define CLK_ASP_SPDIF_REF_ENABLE_REG_ADDR       TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN3_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_ASP_SPDIF_REF_ENABLE_BIT_OFFSET TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN3_periph_clken3_clk_asp_spdif_ref_START            //时钟使能位偏移
...
#define CLK_ASP_CFG_ENABLE_REG_ADDR       TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN3_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_ASP_CFG_ENABLE_BIT_OFFSET TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN3_periph_clken3_asp_cfg_clk_START            //时钟使能位偏移

/* clk_asp_spdif_ref操作宏相关转定义 */

/* clk_dphy0_ref操作宏相关转定义 */
/* 转定义时钟clk_dphy0_ref的使能寄存器，状态寄存器的地址和位偏移 */
#define CLK_DPHY0_REF_ENABLE_REG_ADDR       TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN11_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_DPHY0_REF_ENABLE_BIT_OFFSET     TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN11_periph_clken11_dphy0_START          //时钟使能位偏移
...
#define CLK_DPHY0_CFG_ENABLE_REG_ADDR       TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN11_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_DPHY0_CFG_ENABLE_BIT_OFFSET     TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN11_periph_clken11_dphy0_clk_START          //时钟使能位偏移
...
#define CLK_DPHY1_CFG_ENABLE_REG_ADDR       TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN11_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_DPHY1_CFG_ENABLE_BIT_OFFSET     TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN11_periph_clken11_dphy1_cfg_START          //时钟使能位偏移
...
#define CLK_DPHY2_CFG_ENABLE_REG_ADDR       TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN11_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_DPHY2_CFG_ENABLE_BIT_OFFSET     TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN11_periph_clken11_dphy2_cfg_clk_START          //时钟使能位偏移
...
#if defined(CHIP_BB_HI6210)
#define CLK_UART0_ENABLE_REG_ADDR       SOC_AO_SCTRL_SC_PERIPH_CLKEN4_ADDR(SCTRL_ON_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_UART0_ENABLE_BIT_OFFSET     SOC_AO_SCTRL_SC_PERIPH_CLKEN4_periph_clken4_24clk_uart0_START            //时钟使能位偏移
#else
...
#if defined(CHIP_BB_HI6210)
#define PCLK_UART0_ENABLE_REG_ADDR       SOC_AO_SCTRL_SC_PERIPH_CLKEN4_ADDR(SCTRL_ON_BASE_ADDR)    //使能寄存器地址转定义宏
#define PCLK_UART0_ENABLE_BIT_OFFSET     SOC_AO_SCTRL_SC_PERIPH_CLKEN4_periph_clken4_24clk_uart0_START            //时钟使能位偏移
#else
...
#define CLK_UART1_ENABLE_REG_ADDR       SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_UART1_ENABLE_BIT_OFFSET     SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_periph_clken3_uart1_START            //时钟使能位偏移

/* 转定义时钟clk_uart1的时钟选择寄存器、选择掩码和设置有效标志位 */
#define CLK_UART1_CLKSEL_REG_ADDR   SOC_PERI_SCTRL_SC_CLK_SEL0_ADDR(SCTRL_OFF_BASE_ADDR) //父时钟选择寄存器地址转定义宏
#define CLK_UART1_CLKSEL_MASK       CALC_REG_MASK(SOC_PERI_SCTRL_SC_CLK_SEL0_sel_clk_uart1_START, \
                                        SOC_PERI_SCTRL_SC_CLK_SEL0_sel_clk_uart1_END)    //父时钟选择掩码
#define CLK_UART1_CLKSEL_SET_VALID  CALC_REG_MASK(SOC_PERI_SCTRL_SC_CLK_SEL0_sel_clk_uart1_msk_START , \
                                        SOC_PERI_SCTRL_SC_CLK_SEL0_sel_clk_uart1_msk_END)    //父时钟选择掩码
...
#define PCLK_UART1_ENABLE_REG_ADDR       SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define PCLK_UART1_ENABLE_BIT_OFFSET     SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_periph_clken3_uart1_START            //时钟使能位偏移
...
#define CLK_UART2_ENABLE_REG_ADDR       SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_UART2_ENABLE_BIT_OFFSET     SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_periph_clken3_uart2_START            //时钟使能位偏移

/* 转定义时钟clk_uart2的时钟选择寄存器、选择掩码和设置有效标志位 */
#define CLK_UART2_CLKSEL_REG_ADDR   SOC_PERI_SCTRL_SC_CLK_SEL0_ADDR(SCTRL_OFF_BASE_ADDR) //父时钟选择寄存器地址转定义宏
#define CLK_UART2_CLKSEL_MASK       CALC_REG_MASK(SOC_PERI_SCTRL_SC_CLK_SEL0_sel_clk_uart2_START, \
                                        SOC_PERI_SCTRL_SC_CLK_SEL0_sel_clk_uart2_END)    //父时钟选择掩码
#define CLK_UART2_CLKSEL_SET_VALID  CALC_REG_MASK(SOC_PERI_SCTRL_SC_CLK_SEL0_sel_clk_uart2_msk_START, \
                                        SOC_PERI_SCTRL_SC_CLK_SEL0_sel_clk_uart2_msk_END)    //父时钟选择掩码
...
#define PCLK_UART2_ENABLE_REG_ADDR       SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define PCLK_UART2_ENABLE_BIT_OFFSET     SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_periph_clken3_uart2_START            //时钟使能位偏移
...
#define CLK_UART3_ENABLE_REG_ADDR       SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_UART3_ENABLE_BIT_OFFSET     SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_periph_clken3_uart3_START            //时钟使能位偏移


/* 转定义时钟clk_uart3的时钟选择寄存器、选择掩码和设置有效标志位 */
#define CLK_UART3_CLKSEL_REG_ADDR   SOC_PERI_SCTRL_SC_CLK_SEL0_ADDR(SCTRL_OFF_BASE_ADDR) //父时钟选择寄存器地址转定义宏
#define CLK_UART3_CLKSEL_MASK       CALC_REG_MASK(SOC_PERI_SCTRL_SC_CLK_SEL0_sel_clk_uart3_START, \
                                        SOC_PERI_SCTRL_SC_CLK_SEL0_sel_clk_uart3_END)    //父时钟选择掩码
#define CLK_UART3_CLKSEL_SET_VALID  CALC_REG_MASK(SOC_PERI_SCTRL_SC_CLK_SEL0_sel_clk_uart3_msk_START , \
                                        SOC_PERI_SCTRL_SC_CLK_SEL0_sel_clk_uart3_msk_END)    //父时钟选择掩码
...
#define PCLK_UART3_ENABLE_REG_ADDR       SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define PCLK_UART3_ENABLE_BIT_OFFSET     SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_periph_clken3_uart3_START            //时钟使能位偏移
...
#define CLK_UART4_ENABLE_REG_ADDR       SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_UART4_ENABLE_BIT_OFFSET     SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_periph_clken3_uart4_START            //时钟使能位偏移

/* 转定义时钟clk_uart4的时钟选择寄存器、选择掩码和设置有效标志位 */
#define CLK_UART4_CLKSEL_REG_ADDR   SOC_PERI_SCTRL_SC_CLK_SEL0_ADDR(SCTRL_OFF_BASE_ADDR) //父时钟选择寄存器地址转定义宏
#define CLK_UART4_CLKSEL_MASK       CALC_REG_MASK(SOC_PERI_SCTRL_SC_CLK_SEL0_sel_clk_uart4_START, \
                                        SOC_PERI_SCTRL_SC_CLK_SEL0_sel_clk_uart4_END)    //父时钟选择掩码
#define CLK_UART4_CLKSEL_SET_VALID  CALC_REG_MASK(SOC_PERI_SCTRL_SC_CLK_SEL0_sel_clk_uart4_msk_START, \
                                        SOC_PERI_SCTRL_SC_CLK_SEL0_sel_clk_uart4_msk_END)    //父时钟选择掩码
...
#define PCLK_UART4_ENABLE_REG_ADDR       SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define PCLK_UART4_ENABLE_BIT_OFFSET     SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_periph_clken3_uart4_START            //时钟使能位偏移
...
#define CLK_UART5_ENABLE_REG_ADDR       TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN1_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_UART5_ENABLE_BIT_OFFSET     TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN1_periph_clken1_uart5_START            //时钟使能位偏移

/* 转定义时钟clk_uart5的时钟选择寄存器、选择掩码和设置有效标志位 */
#define CLK_UART5_CLKSEL_REG_ADDR   TMP_CLOCK_ADDR//SOC_SCTRL_SC_CLK_SEL0_ADDR(SCTRL_OFF_BASE_ADDR) //父时钟选择寄存器地址转定义宏
#define CLK_UART5_CLKSEL_MASK       TMP_CLOCK_BIT/*CALC_REG_MASK(SOC_SCTRL_SC_CLK_SEL0_sel_clk_uart5_START, \
                                        SOC_SCTRL_SC_CLK_SEL0_sel_clk_uart5_END)*/    //父时钟选择掩码
#define CLK_UART5_CLKSEL_SET_VALID  TMP_CLOCK_ADDR/*CALC_REG_MASK(SOC_SCTRL_SC_CLK_SEL0_sel_clk_uart5_msk_START, \
...
#define PCLK_UART5_ENABLE_REG_ADDR       TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN1_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define PCLK_UART5_ENABLE_BIT_OFFSET     TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN1_periph_clken1_uart5_pclk_START            //时钟使能位偏移
...
#define CLK_UART6_ENABLE_REG_ADDR       TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN1_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_UART6_ENABLE_BIT_OFFSET     TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN1_periph_clken1_uart6_START            //时钟使能位偏移

/* 转定义时钟clk_uart6的时钟选择寄存器、选择掩码和设置有效标志位 */
#define CLK_UART6_CLKSEL_REG_ADDR   TMP_CLOCK_ADDR//SOC_SCTRL_SC_CLK_SEL0_ADDR(SCTRL_OFF_BASE_ADDR) //父时钟选择寄存器地址转定义宏
#define CLK_UART6_CLKSEL_MASK       TMP_CLOCK_BIT/*CALC_REG_MASK(SOC_SCTRL_SC_CLK_SEL0_sel_clk_uart6_START, \
                                        SOC_SCTRL_SC_CLK_SEL0_sel_clk_uart6_END)*/    //父时钟选择掩码
#define CLK_UART6_CLKSEL_SET_VALID  TMP_CLOCK_BIT/*CALC_REG_MASK(SOC_SCTRL_SC_CLK_SEL0_sel_clk_uart6_msk_START, \
...
#define PCLK_UART6_ENABLE_REG_ADDR       TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN1_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define PCLK_UART6_ENABLE_BIT_OFFSET     TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN1_periph_clken1_uart6_pclk_START            //时钟使能位偏移
...
#define HCLK_NANDC_ENABLE_REG_ADDR     SOC_PERI_SCTRL_SC_PERIPH_CLKEN0_ADDR(SCTRL_OFF_BASE_ADDR)    /* 使能寄存器地址转定义宏 */
#define HCLK_NANDC_ENABLE_BIT_OFFSET   SOC_PERI_SCTRL_SC_PERIPH_CLKEN0_periph_clken0_nandc_START  /* 时钟使能位偏移 */

/* hclk_mmc0操作宏相关转定义 */
/* 转定义时钟hclk_mmc0的使能寄存器，状态寄存器的地址和位偏移 */
#define HCLK_MMC0_ENABLE_REG_ADDR     SOC_PERI_SCTRL_SC_PERIPH_CLKEN0_ADDR(SCTRL_OFF_BASE_ADDR)    /* 使能寄存器地址转定义宏 */
#define HCLK_MMC0_ENABLE_BIT_OFFSET   SOC_PERI_SCTRL_SC_PERIPH_CLKEN0_periph_clken0_mmc0_START /* 时钟使能位偏移 */

/* hclk_mmc1操作宏相关转定义 */
/* 转定义时钟hclk_mmc1的使能寄存器，状态寄存器的地址和位偏移 */
#define HCLK_MMC1_ENABLE_REG_ADDR     SOC_PERI_SCTRL_SC_PERIPH_CLKEN0_ADDR(SCTRL_OFF_BASE_ADDR)    /* 使能寄存器地址转定义宏 */
#define HCLK_MMC1_ENABLE_BIT_OFFSET   SOC_PERI_SCTRL_SC_PERIPH_CLKEN0_periph_clken0_mmc1_START  /* 时钟使能位偏移 */

/* hclk_mmc2操作宏相关转定义 */
/* 转定义时钟hclk_mmc2的使能寄存器，状态寄存器的地址和位偏移 */
#define HCLK_MMC2_ENABLE_REG_ADDR     SOC_PERI_SCTRL_SC_PERIPH_CLKEN0_ADDR(SCTRL_OFF_BASE_ADDR)    /* 使能寄存器地址转定义宏 */
#define HCLK_MMC2_ENABLE_BIT_OFFSET   SOC_PERI_SCTRL_SC_PERIPH_CLKEN0_periph_clken0_mmc2_START  /* 时钟使能位偏移 */
...
#define CLK_DSPPLL_MMC0_GATED_CLKDIV_SET_VALID  SOC_PERI_SCTRL_SC_CLKCFG8BIT1_clk_8bit_cfg1_vld1_mmc0_high_START       //时钟分频设置有效标志位
*/
...
#define CLK_DSPPLL_MMC1_GATED_CLKDIV_SET_VALID  SOC_PERI_SCTRL_SC_CLKCFG8BIT2_clk_8bit_cfg2_vld1_mmc1_high_START       //时钟分频设置有效标志位
*/
...
#define CLK_DSPPLL_MMC2_GATED_CLKDIV_SET_VALID  SOC_PERI_SCTRL_SC_CLKCFG8BIT3_clk_8bit_cfg3_vld1_mmc2_high_START       //时钟分频设置有效标志位
*/
...
#define CLK_MMC0HIGH_ENABLE_REG_ADDR        SOC_PERI_SCTRL_SC_PERIPH_CLKEN0_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_MMC0HIGH_ENABLE_BIT_OFFSET      SOC_PERI_SCTRL_SC_PERIPH_CLKEN0_periph_clken0_mmc0_START         //时钟使能位偏移
...
#define CLK_MMC0HIGH_CLKDIV_MASK          CALC_REG_MASK(SOC_PERI_SCTRL_SC_CLKCFG8BIT1_clk_8bit_cfg1_value1_mmc0_high_START, \
                                                        SOC_PERI_SCTRL_SC_CLKCFG8BIT1_clk_8bit_cfg1_value1_mmc0_high_END)                  //时钟分频掩码
#define CLK_MMC0HIGH_CLKDIV_SET_VALID  SOC_PERI_SCTRL_SC_CLKCFG8BIT1_clk_8bit_cfg1_vld1_mmc0_high_START       //时钟分频设置有效标志位
*/
...
#define CLK_MMC1HIGH_ENABLE_REG_ADDR        SOC_PERI_SCTRL_SC_PERIPH_CLKEN0_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_MMC1HIGH_ENABLE_BIT_OFFSET      SOC_PERI_SCTRL_SC_PERIPH_CLKEN0_periph_clken0_mmc1_START         //时钟使能位偏移
...
#define CLK_MMC1HIGH_CLKDIV_MASK           CALC_REG_MASK(SOC_PERI_SCTRL_SC_CLKCFG8BIT2_clk_8bit_cfg2_value1_mmc1_high_START, \
                                                        SOC_PERI_SCTRL_SC_CLKCFG8BIT2_clk_8bit_cfg2_value1_mmc1_high_END)                  //时钟分频掩码
#define CLK_MMC1HIGH_CLKDIV_SET_VALID  SOC_PERI_SCTRL_SC_CLKCFG8BIT2_clk_8bit_cfg2_vld1_mmc1_high_START       //时钟分频设置有效标志位
*/
...
#define CLK_MMC2HIGH_ENABLE_REG_ADDR        SOC_PERI_SCTRL_SC_PERIPH_CLKEN0_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_MMC2HIGH_ENABLE_BIT_OFFSET      SOC_PERI_SCTRL_SC_PERIPH_CLKEN0_periph_clken0_mmc2_START         //时钟使能位偏移
...
#define CLK_MMC2HIGH_CLKDIV_MASK           CALC_REG_MASK(SOC_PERI_SCTRL_SC_CLKCFG8BIT3_clk_8bit_cfg3_value1_mmc2_high_START, \
                                                        SOC_PERI_SCTRL_SC_CLKCFG8BIT3_clk_8bit_cfg3_value1_mmc2_high_END)                  //时钟分频掩码
#define CLK_MMC2HIGH_CLKDIV_SET_VALID  SOC_PERI_SCTRL_SC_CLKCFG8BIT3_clk_8bit_cfg3_vld1_mmc2_high_START       //时钟分频设置有效标志位
*/
...
#define CLK_MMC0LOW_ENABLE_REG_ADDR     SOC_PERI_SCTRL_SC_PERIPH_CLKEN0_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_MMC0LOW_ENABLE_BIT_OFFSET       SOC_PERI_SCTRL_SC_PERIPH_CLKEN0_periph_clken0_mmc0_START          //时钟使能位偏移
...
#define CLK_MMC0LOW_CLKDIV_REG_ADDR  SOC_PERI_SCTRL_SC_CLKCFG8BIT1_ADDR(SCTRL_OFF_BASE_ADDR)     //时钟分频寄存器地址转定义宏
#define CLK_MMC0LOW_CLKDIV_MASK     CALC_REG_MASK(SOC_PERI_SCTRL_SC_CLKCFG8BIT1_clk_8bit_cfg1_value0_mmc0_START, \
                                                        SOC_PERI_SCTRL_SC_CLKCFG8BIT1_clk_8bit_cfg1_value0_mmc0_END)                  //时钟分频掩码
#define CLK_MMC0LOW_CLKDIV_SET_VALID    SOC_PERI_SCTRL_SC_CLKCFG8BIT1_clk_8bit_cfg1_vld0_mmc0_START      //时钟分频设置有效标志位

/* clk_mmc0low操作宏相关转定义 */

/* clk_mmc1low操作宏相关转定义 */
/* 转定义时钟clk_mmc1low的使能寄存器，状态寄存器的地址和位偏移 */
#define CLK_MMC1LOW_ENABLE_REG_ADDR     SOC_PERI_SCTRL_SC_PERIPH_CLKEN0_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_MMC1LOW_ENABLE_BIT_OFFSET       SOC_PERI_SCTRL_SC_PERIPH_CLKEN0_periph_clken0_mmc1_START          //时钟使能位偏移
...
#define CLK_MMC1LOW_CLKDIV_REG_ADDR SOC_PERI_SCTRL_SC_CLKCFG8BIT2_ADDR(SCTRL_OFF_BASE_ADDR)    //时钟分频寄存器地址转定义宏
#define CLK_MMC1LOW_CLKDIV_MASK    CALC_REG_MASK(SOC_PERI_SCTRL_SC_CLKCFG8BIT2_clk_8bit_cfg2_value0_mmc1_START, \
                                                        SOC_PERI_SCTRL_SC_CLKCFG8BIT2_clk_8bit_cfg2_value0_mmc1_END)                  //时钟分频掩码
#define CLK_MMC1LOW_CLKDIV_SET_VALID    SOC_PERI_SCTRL_SC_CLKCFG8BIT2_clk_8bit_cfg2_vld0_mmc1_START      //时钟分频设置有效标志位

/* clk_mmc1low操作宏相关转定义 */

/* clk_mmc2low操作宏相关转定义 */
/* 转定义时钟clk_mmc2low的使能寄存器，状态寄存器的地址和位偏移 */
#define CLK_MMC2LOW_ENABLE_REG_ADDR     SOC_PERI_SCTRL_SC_PERIPH_CLKEN0_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_MMC2LOW_ENABLE_BIT_OFFSET       SOC_PERI_SCTRL_SC_PERIPH_CLKEN0_periph_clken0_mmc2_START          //时钟使能位偏移
...
#define CLK_MMC2LOW_CLKDIV_REG_ADDR SOC_PERI_SCTRL_SC_CLKCFG8BIT3_ADDR(SCTRL_OFF_BASE_ADDR)    //时钟分频寄存器地址转定义宏
#define CLK_MMC2LOW_CLKDIV_MASK     CALC_REG_MASK(SOC_PERI_SCTRL_SC_CLKCFG8BIT3_clk_8bit_cfg3_value0_mmc2_START, \
                                                        SOC_PERI_SCTRL_SC_CLKCFG8BIT3_clk_8bit_cfg3_value0_mmc2_END)                  //时钟分频掩码
#define CLK_MMC2LOW_CLKDIV_SET_VALID    SOC_PERI_SCTRL_SC_CLKCFG8BIT3_clk_8bit_cfg3_vld0_mmc2_START      //时钟分频设置有效标志位
...
#define CLK_DDRIO_DIV_CLKSEL_REG_ADDR   TMP_CLOCK_ADDR//SOC_PMCTRL_DDRCLKPROFILE_ADDR(PMCTRL_BASE_ADDR) //父时钟选择寄存器地址转定义宏
#define CLK_DDRIO_DIV_CLKSEL_MASK       TMP_CLOCK_BIT/*CALC_REG_MASK(SOC_PMCTRL_DDRCLKPROFILE_ddr_pllsw_prof_START, \
                                                SOC_PMCTRL_DDRCLKPROFILE_ddr_pllsw_prof_END)*/    //父时钟选择掩码
#define CLK_DDRIO_DIV_CLKSEL_SET_VALID  CLKSEL_SET_INVALID      //父时钟选择有效标志位

#define CLK_DDRIO_DIV_CLKDIV_REG_ADDR   TMP_CLOCK_ADDR//SOC_PMCTRL_DDRCLKPROFILE_ADDR(PMCTRL_BASE_ADDR) //时钟分频寄存器地址转定义宏
#define CLK_DDRIO_DIV_CLKDIV_MASK       TMP_CLOCK_BIT/*CALC_REG_MASK(SOC_PMCTRL_DDRCLKPROFILE_ddrio_clk_div_prof_START, \
...
#define CLK_DDRIO_ENABLE_REG_ADDR       TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN0_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_DDRIO_ENABLE_BIT_OFFSET     TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN0_periph_clken0_clk_ddrio_START            //时钟使能位偏移
...
#define CLK_DDRC_DIV_CLKDIV_REG_ADDR    TMP_CLOCK_ADDR//SOC_PMCTRL_DDRCLKPROFILE_ADDR(PMCTRL_BASE_ADDR) //时钟分频寄存器地址转定义宏
#define CLK_DDRC_DIV_CLKDIV_MASK        TMP_CLOCK_BIT/*CALC_REG_MASK(SOC_PMCTRL_DDRCLKPROFILE_ddrc_clk_div_prof_START, \
...
#define CLK_DDRC_ENABLE_REG_ADDR        TMP_CLOCK_ADDR//RSOC_SCTRL_SC_PERIPH_CLKEN0_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_DDRC_ENABLE_BIT_OFFSET      TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN0_periph_clken0_clk_ddrc_START         //时钟使能位偏移
...
#define CLK_DDRPHY_ENABLE_REG_ADDR      TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN0_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_DDRPHY_ENABLE_BIT_OFFSET    TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN0_periph_clken0_clk_ddrphy_START           //时钟使能位偏移
...
#if defined(CHIP_BB_HI6210)
#define CLK_I2C0_ENABLE_REG_ADDR        SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_I2C0_ENABLE_BIT_OFFSET      SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_periph_clken3_i2c0_START         //时钟使能位偏移
#else
#define CLK_I2C0_ENABLE_REG_ADDR        TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN1_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_I2C0_ENABLE_BIT_OFFSET      TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN1_periph_clken1_i2c0_START         //时钟使能位偏移
#endif
...
#if defined(CHIP_BB_HI6210)
#define PCLK_I2C0_ENABLE_REG_ADDR        SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define PCLK_I2C0_ENABLE_BIT_OFFSET      SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_periph_clken3_i2c0_START         //时钟使能位偏移
#else
...
#if defined(CHIP_BB_HI6210)
#define CLK_I2C1_ENABLE_REG_ADDR        SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_I2C1_ENABLE_BIT_OFFSET      SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_periph_clken3_i2c1_START         //时钟使能位偏移
#else
...
/* 转定义时钟clk_i2c1的使能寄存器，状态寄存器的地址和位偏移 */
#if defined(CHIP_BB_HI6210)
#define PCLK_I2C1_ENABLE_REG_ADDR        SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define PCLK_I2C1_ENABLE_BIT_OFFSET      SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_periph_clken3_i2c1_START         //时钟使能位偏移
#else
...
#if defined(CHIP_BB_HI6210)
#define CLK_I2C2_ENABLE_REG_ADDR        SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_I2C2_ENABLE_BIT_OFFSET      SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_periph_clken3_i2c2_START         //时钟使能位偏移
#else
...
/* 转定义时钟clk_i2c2的使能寄存器，状态寄存器的地址和位偏移 */
#if defined(CHIP_BB_HI6210)
#define PCLK_I2C2_ENABLE_REG_ADDR        SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define PCLK_I2C2_ENABLE_BIT_OFFSET      SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_periph_clken3_i2c2_START         //时钟使能位偏移
#else
...
#if defined(CHIP_BB_HI6210)
#define CLK_I2C3_ENABLE_REG_ADDR        SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_I2C3_ENABLE_BIT_OFFSET      SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_periph_clken3_i2c3_START         //时钟使能位偏移
#else
...
/* 转定义时钟clk_i2c3的使能寄存器，状态寄存器的地址和位偏移 */
#if defined(CHIP_BB_HI6210)
#define PCLK_I2C3_ENABLE_REG_ADDR        SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define PCLK_I2C3_ENABLE_BIT_OFFSET      SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_periph_clken3_i2c3_START         //时钟使能位偏移
#else
...
#define CLK_I2C4_ENABLE_REG_ADDR        TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN1_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_I2C4_ENABLE_BIT_OFFSET      TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN1_periph_clken1_i2c4_START         //时钟使能位偏移
...
/* 转定义时钟clk_i2c4的使能寄存器，状态寄存器的地址和位偏移 */
#define PCLK_I2C4_ENABLE_REG_ADDR        TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN1_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define PCLK_I2C4_ENABLE_BIT_OFFSET      TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN1_periph_clken1_i2c4_pclk_START         //时钟使能位偏移
...
#define CLK_I2C5_ENABLE_REG_ADDR       TMP_CLOCK_ADDR// SOC_SCTRL_SC_PERIPH_CLKEN1_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_I2C5_ENABLE_BIT_OFFSET      TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN1_periph_clken1_i2c5_START         //时钟使能位偏移
...
/* 转定义时钟clk_i2c5的使能寄存器，状态寄存器的地址和位偏移 */
#define PCLK_I2C5_ENABLE_REG_ADDR        TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN1_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define PCLK_I2C5_ENABLE_BIT_OFFSET      TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN1_periph_clken1_i2c5_pclk_START         //时钟使能位偏移
...
#define CLK_PWM0_ENABLE_REG_ADDR        SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_PWM0_ENABLE_BIT_OFFSET      SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_periph_clken3_pwm_START         //时钟使能位偏移


/* 转定义时钟clk_pwm0的时钟选择寄存器、选择掩码和设置有效标志位 */
/*temp modify chip modify*/
#if 1
#define CLK_PWM0_CLKSEL_REG_ADDR    TMP_CLOCK_ADDR//SOC_PERI_SCTRL_SC_CLK_SEL1_ADDR(SCTRL_OFF_BASE_ADDR) //父时钟选择寄存器地址转定义宏
#define CLK_PWM0_CLKSEL_MASK        TMP_CLOCK_BIT/*CALC_REG_MASK(SOC_SCTRL_SC_CLK_SEL1_sel_clk_pwm0_START, \
                                                SOC_SCTRL_SC_CLK_SEL1_sel_clk_pwm0_END)*/ //父时钟选择掩码
#define CLK_PWM0_CLKSEL_SET_VALID   TMP_CLOCK_ADDR/*CALC_REG_MASK(SOC_SCTRL_SC_CLK_SEL1_sel_clk_pwm0_msk_START, \
                                                SOC_SCTRL_SC_CLK_SEL1_sel_clk_pwm0_msk_END)*/ //父时钟选择掩码
#define CLK_PWM0_CLKDIV_REG_ADDR    TMP_CLOCK_ADDR//TMP_CLOCK_ADDRSOC_SCTRL_SC_CLKCFG8BIT10_ADDR(SCTRL_OFF_BASE_ADDR) //时钟分频寄存器地址转定义宏
#define CLK_PWM0_CLKDIV_MASK       TMP_CLOCK_BIT/* CALC_REG_MASK(SOC_SCTRL_SC_CLKCFG8BIT10_clk_8bit_cfg10_value0_START, \
                                                SOC_SCTRL_SC_CLKCFG8BIT10_clk_8bit_cfg10_value0_END)*/                    //时钟分频掩码
#define CLK_PWM0_CLKDIV_SET_VALID   TMP_CLOCK_BIT//SOC_SCTRL_SC_CLKCFG8BIT10_clk_8bit_cfg10_vld0_START     //时钟分频设置有效标志位
...
#if defined(CHIP_BB_HI6210)
#define PCLK_PWM0_ENABLE_REG_ADDR       SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define PCLK_PWM0_ENABLE_BIT_OFFSET     SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_periph_clken3_pwm_START            //时钟使能位偏移
#else
...
/*temp modify chip modify*/
#if 1
#define CLK_PWM1_ENABLE_REG_ADDR        TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN2_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_PWM1_ENABLE_BIT_OFFSET      TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN2_periph_clken2_pwm1_START         //时钟使能位偏移

/* 转定义时钟clk_pwm1的时钟选择寄存器、选择掩s码和设置有效标志位 */
#define CLK_PWM1_CLKSEL_REG_ADDR    TMP_CLOCK_ADDR//SOC_SCTRL_SC_CLK_SEL1_ADDR(SCTRL_OFF_BASE_ADDR) //父时钟选择寄存器地址转定义宏
#define CLK_PWM1_CLKSEL_MASK        TMP_CLOCK_BIT/*CALC_REG_MASK(SOC_SCTRL_SC_CLK_SEL1_sel_clk_pwm1_START, \
                                                SOC_SCTRL_SC_CLK_SEL1_sel_clk_pwm1_END)*/ //父时钟选择掩码
#define CLK_PWM1_CLKSEL_SET_VALID   TMP_CLOCK_BIT/*CALC_REG_MASK(SOC_SCTRL_SC_CLK_SEL1_sel_clk_pwm1_msk_START, \
                                                SOC_SCTRL_SC_CLK_SEL1_sel_clk_pwm1_msk_END)*/ //父时钟选择掩码
#define CLK_PWM1_CLKDIV_REG_ADDR    TMP_CLOCK_ADDR//SOC_SCTRL_SC_CLKCFG8BIT10_ADDR(SCTRL_OFF_BASE_ADDR) //时钟分频寄存器地址转定义宏
#define CLK_PWM1_CLKDIV_MASK        TMP_CLOCK_BIT/*CALC_REG_MASK(SOC_SCTRL_SC_CLKCFG8BIT10_clk_8bit_cfg10_value1_START, \
                                                SOC_SCTRL_SC_CLKCFG8BIT10_clk_8bit_cfg10_value1_END)*/                   //时钟分频掩码
#define CLK_PWM1_CLKDIV_SET_VALID   TMP_CLOCK_ADDR//SOC_SCTRL_SC_CLKCFG8BIT10_clk_8bit_cfg10_vld1_START     //时钟分频设置有效标志位

/* clk_pwm1操作宏相关转定义 */

/* pclk_pwm1操作宏相关转定义 */
/* 转定义时钟pclk_pwm1的使能寄存器，状态寄存器的地址和位偏移 */
#define PCLK_PWM1_ENABLE_REG_ADDR       TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN2_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define PCLK_PWM1_ENABLE_BIT_OFFSET     TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN2_periph_clken2_pwm1_pclk_START            //时钟使能位偏移
...
#if defined(CHIP_BB_HI6210)
#define CLK_SPI0_ENABLE_REG_ADDR       SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_ADDR(SCTRL_OFF_BASE_ADDR)  //使能寄存器地址转定义宏
#define CLK_SPI0_ENABLE_BIT_OFFSET     SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_periph_clken3_ssp_START //时钟使能位偏移
#else
...
#if defined(CHIP_BB_HI6210)
#define PCLK_SPI0_ENABLE_REG_ADDR       SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_ADDR(SCTRL_OFF_BASE_ADDR)  //使能寄存器地址转定义宏
#define PCLK_SPI0_ENABLE_BIT_OFFSET     SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_periph_clken3_ssp_START //时钟使能位偏移
#else
...
#define CLK_SPI1_ENABLE_REG_ADDR        TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN1_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define CLK_SPI1_ENABLE_BIT_OFFSET      TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN1_periph_clken1_spi1_START         //时钟使能位偏移
...
/* 转定义时钟clk_spi1的使能寄存器，状态寄存器的地址和位偏移 */
#define PCLK_SPI1_ENABLE_REG_ADDR        TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN1_ADDR(SCTRL_OFF_BASE_ADDR)    //使能寄存器地址转定义宏
#define PCLK_SPI1_ENABLE_BIT_OFFSET      TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN1_periph_clken1_spi1_pclk_START         //时钟使能位偏移
...
#define CLK_DSPPLL_HIFI_CORE_GATED_ENABLE_REG_ADDR      SOC_PERI_SCTRL_SC_PERIPH_CLKEN1_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_DSPPLL_HIFI_CORE_GATED_ENABLE_BIT_OFFSET    SOC_PERI_SCTRL_SC_PERIPH_CLKEN1_periph_clken1_hifi_START           //时钟使能位偏移
...
/* clk_hifi_core操作宏相关转定义 */
#if 1
#define CLK_CSI_APB_MUX_ENABLE_REG_ADDR         TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN11_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_CSI_APB_MUX_ENABLE_BIT_OFFSET       TMP_CLOCK_BIT//_SCTRL_SC_PERIPH_CLKEN11_periph_clken11_csi_apb_mux_START            //时钟使能位偏移
...
#define CLK_CSIO_CFG_ENABLE_REG_ADDR        TMP_CLOCK_ADDR//C_SCTRL_SC_PERIPH_CLKEN11_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_CSIO_CFG_ENABLE_BIT_OFFSET      TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN11_periph_clken11_clk_csio_cfg_START           //时钟使能位偏移
...
#define CSI1_CFG_CLK_ENABLE_REG_ADDR        TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN11_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CSI1_CFG_CLK_ENABLE_BIT_OFFSET      TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN11_periph_clken11_csi1_cfg_clk_START           //时钟使能位偏移
...
#define CSI2_CFG_CLK_ENABLE_REG_ADDR        TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN11_ADDR(SCTRL_OFF_BASE_ADDR)   //使能寄存器地址转定义宏
#define CSI2_CFG_CLK_ENABLE_BIT_OFFSET      TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN11_periph_clken11_csi2_cfg_clk_START           //时钟使能位偏移
...
#define CLK_PMUSSI_ENABLE_REG_ADDR        SOC_AO_SCTRL_SC_PERIPH_CLKEN4_ADDR(SCTRL_ON_BASE_ADDR)   //使能寄存器地址转定义宏
#define CLK_PMUSSI_ENABLE_BIT_OFFSET      SOC_AO_SCTRL_SC_PERIPH_CLKEN4_periph_clken4_27pclk_pmussi_START           //时钟使能位偏移
...
#define CLK_RTC_ENABLE_BIT_OFFSET   SOC_AO_SCTRL_SC_PERIPH_CLKEN4_periph_clken4_25clk_rtc0_START  /* 时钟使能位偏移 */
...
#define CLK_WATCHDOG0_ENABLE_BIT_OFFSET   SOC_AO_SCTRL_SC_PERIPH_CLKEN4_periph_clken4_12pclk_wdt0_START  /* 时钟使能位偏移 */
...
#define PCLK_WATCHDOG0_ENABLE_BIT_OFFSET   SOC_AO_SCTRL_SC_PERIPH_CLKEN4_periph_clken4_12pclk_wdt0_START  /* 时钟使能位偏移 */

#define HCLK_USBOTG_ON_ENABLE_REG_ADDR     NULL    /* 使能寄存器地址转定义宏 */
#define HCLK_USBOTG_ON_ENABLE_BIT_OFFSET   0  /* 时钟使能位偏移 */

#define HCLK_USBOTG_OFF_ENABLE_REG_ADDR     SOC_PERI_SCTRL_SC_PERIPH_CLKEN0_ADDR(SCTRL_OFF_BASE_ADDR)    /* 使能寄存器地址转定义宏 */
#define HCLK_USBOTG_OFF_ENABLE_BIT_OFFSET   SOC_PERI_SCTRL_SC_PERIPH_CLKEN0_periph_clken0_usbotg_START  /* 时钟使能位偏移 */

#if defined(CHIP_BB_HI6210)/*B020 Modify*/

#define CLK_USBOTG_OFF_ENABLE_REG_ADDR     SOC_PERI_SCTRL_SC_PERIPH_CLKEN0_ADDR(SCTRL_OFF_BASE_ADDR)    /* 使能寄存器地址转定义宏 */
#define CLK_USBOTG_OFF_ENABLE_BIT_OFFSET   SOC_PERI_SCTRL_SC_PERIPH_CLKEN0_periph_clken0_usbotg_START  /* 时钟使能位偏移 */


#define CLK_PICOPHY_ENABLE_REG_ADDR     TMP_CLOCK_ADDR//SOC_AO_SCTRL_SC_PERIPH_CLKEN6_ADDR(SCTRL_ON_BASE_ADDR)    /* 使能寄存器地址转定义宏 */
#define CLK_PICOPHY_ENABLE_BIT_OFFSET   TMP_CLOCK_BIT//SOC_AO_SCTRL_SC_PERIPH_CLKEN6_periph_clken6_clk_picophy_START  /* 时钟使能位偏移 */
#endif

#define CLK_PICOPHY_TEST_ENABLE_REG_ADDR     TMP_CLOCK_ADDR//SOC_AO_SCTRL_SC_PERIPH_CLKEN6_ADDR(SCTRL_ON_BASE_ADDR)    /* 使能寄存器地址转定义宏 */
#define CLK_PICOPHY_TEST_ENABLE_BIT_OFFSET   TMP_CLOCK_BIT//SOC_AO_SCTRL_SC_PERIPH_CLKEN6_periph_clken6_clk_picophy_test_START  /* 时钟使能位偏移 */
...
#define CLK_GPS_ENABLE_REG_ADDR     SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_ADDR(SCTRL_OFF_BASE_ADDR)    /* 使能寄存器地址转定义宏 */
#define CLK_GPS_ENABLE_BIT_OFFSET   SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_periph_clken3_gps_START  /* 时钟使能位偏移 */

#define CLK_TSENSOR1_ENABLE_REG_ADDR     TMP_CLOCK_ADDR//SOC_PERI_SCTRL_SC_PERIPH_CLKEN2_ADDR(SCTRL_OFF_BASE_ADDR)    /* 使能寄存器地址转定义宏 */
#define CLK_TSENSOR1_ENABLE_BIT_OFFSET   TMP_CLOCK_BIT//SOC_PERI_SCTRL_SC_PERIPH_CLKEN2_periph_clken2_tsensor0_clk_START  /* 时钟使能位偏移 */

#define CLK_TSENSOR0_ENABLE_REG_ADDR     SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_ADDR(SCTRL_OFF_BASE_ADDR)    /* 使能寄存器地址转定义宏 */
#define CLK_TSENSOR0_ENABLE_BIT_OFFSET   SOC_PERI_SCTRL_SC_PERIPH_CLKEN3_periph_clken3_tsensor_START  /* 时钟使能位偏移 */
/* clk_ap_dmac_axi0操作宏相关转定义 */
/* 转定义时钟clk_ap_dmac_axi0的使能寄存器，状态寄存器的地址和位偏移 */
#define CLK_AP_DMAC_AXI0_ENABLE_REG_ADDR     SOC_PERI_SCTRL_SC_PERIPH_CLKEN2_ADDR(SCTRL_OFF_BASE_ADDR)//SOC_SCTRL_SC_PERIPH_CLKEN2_ADDR(SCTRL_OFF_BASE_ADDR)    /* 使能寄存器地址转定义宏 */
#define CLK_AP_DMAC_AXI0_ENABLE_BIT_OFFSET   SOC_PERI_SCTRL_SC_PERIPH_CLKEN2_periph_clken2_dmac_START//SOC_SCTRL_SC_PERIPH_CLKEN2_periph_clken2_ap_dmac_axi0_START  /* 时钟使能位偏移 */

/* clk_ap_dmac_axi1操作宏相关转定义 */
/* 转定义时钟clk_ap_dmac_axi1的使能寄存器，状态寄存器的地址和位偏移 */
#define CLK_AP_DMAC_AXI1_ENABLE_REG_ADDR     TMP_CLOCK_ADDR//SOC_SCTRL_SC_PERIPH_CLKEN2_ADDR(SCTRL_OFF_BASE_ADDR)    /* 使能寄存器地址转定义宏 */
#define CLK_AP_DMAC_AXI1_ENABLE_BIT_OFFSET   TMP_CLOCK_BIT//SOC_SCTRL_SC_PERIPH_CLKEN2_periph_clken2_ap_dmac_axi1_START  /* 时钟使能位偏移 */
...
#define PCLK_TIMER0_ENABLE_BIT_OFFSET   SOC_AO_SCTRL_SC_PERIPH_CLKEN4_periph_clken4_15pclk_timer0_START  /* 时钟使能位偏移 */
...
#define CLK_TIMER0_ENABLE_BIT_OFFSET   SOC_AO_SCTRL_SC_PERIPH_CLKEN4_periph_clken4_15pclk_timer0_START  /* 时钟使能位偏移 */
...
#define PCLK_TIMER1_ENABLE_BIT_OFFSET   SOC_AO_SCTRL_SC_PERIPH_CLKEN4_periph_clken4_16pclk_timer1_START  /* 时钟使能位偏移 */
...
#define CLK_TIMER1_ENABLE_BIT_OFFSET   SOC_AO_SCTRL_SC_PERIPH_CLKEN4_periph_clken4_16pclk_timer1_START  /* 时钟使能位偏移 */
...
#define PCLK_TIMER2_ENABLE_BIT_OFFSET   SOC_AO_SCTRL_SC_PERIPH_CLKEN4_periph_clken4_17pclk_timer2_START  /* 时钟使能位偏移 */
...
#define CLK_TIMER2_ENABLE_BIT_OFFSET   SOC_AO_SCTRL_SC_PERIPH_CLKEN4_periph_clken4_17pclk_timer2_START  /* 时钟使能位偏移 */
...
#define PCLK_TIMER3_ENABLE_BIT_OFFSET   SOC_AO_SCTRL_SC_PERIPH_CLKEN4_periph_clken4_18pclk_timer3_START  /* 时钟使能位偏移 */
...
#define CLK_TIMER3_ENABLE_BIT_OFFSET   SOC_AO_SCTRL_SC_PERIPH_CLKEN4_periph_clken4_18pclk_timer3_START  /* 时钟使能位偏移 */
...
#define PCLK_TIMER4_ENABLE_BIT_OFFSET   SOC_AO_SCTRL_SC_PERIPH_CLKEN4_periph_clken4_19pclk_timer4_START  /* 时钟使能位偏移 */
...
#define CLK_TIMER4_ENABLE_BIT_OFFSET   SOC_AO_SCTRL_SC_PERIPH_CLKEN4_periph_clken4_19pclk_timer4_START  /* 时钟使能位偏移 */
...
#define PCLK_TIMER5_ENABLE_BIT_OFFSET   SOC_AO_SCTRL_SC_PERIPH_CLKEN4_periph_clken4_20pclk_timer5_START  /* 时钟使能位偏移 */
...
#define CLK_TIMER5_ENABLE_BIT_OFFSET   SOC_AO_SCTRL_SC_PERIPH_CLKEN4_periph_clken4_20pclk_timer5_START  /* 时钟使能位偏移 */
...
#define PCLK_TIMER6_ENABLE_BIT_OFFSET   SOC_AO_SCTRL_SC_PERIPH_CLKEN4_periph_clken4_21pclk_timer6_START  /* 时钟使能位偏移 */
...
#define CLK_TIMER6_ENABLE_BIT_OFFSET   SOC_AO_SCTRL_SC_PERIPH_CLKEN4_periph_clken4_21pclk_timer6_START  /* 时钟使能位偏移 */
...
#define PCLK_TIMER7_ENABLE_BIT_OFFSET   SOC_AO_SCTRL_SC_PERIPH_CLKEN4_periph_clken4_22pclk_timer7_START  /* 时钟使能位偏移 */
...
#define CLK_TIMER7_ENABLE_BIT_OFFSET   SOC_AO_SCTRL_SC_PERIPH_CLKEN4_periph_clken4_22pclk_timer7_START  /* 时钟使能位偏移 */
...
#define PCLK_TIMER8_ENABLE_BIT_OFFSET   SOC_AO_SCTRL_SC_PERIPH_CLKEN4_periph_clken4_23pclk_timer8_START  /* 时钟使能位偏移 */
...
#define CLK_TIMER8_ENABLE_BIT_OFFSET   SOC_AO_SCTRL_SC_PERIPH_CLKEN4_periph_clken4_23pclk_timer8_START  /* 时钟使能位偏移 */
...
#define PCLK_TIMER9_ENABLE_BIT_OFFSET   SOC_AO_SCTRL_SC_PERIPH_CLKEN4_periph_clken4_23pclk_timer8_START  /* 时钟使能位偏移 */

/* clk_timer8操作宏相关转定义 */
/* 转定义时钟clk_timer8的使能寄存器，状态寄存器的地址和位偏移 */
#define CLK_TIMER9_ENABLE_REG_ADDR     SOC_AO_SCTRL_SC_PERIPH_CLKEN4_ADDR(SCTRL_ON_BASE_ADDR)    /* 使能寄存器地址转定义宏 */
#define CLK_TIMER9_ENABLE_BIT_OFFSET   SOC_AO_SCTRL_SC_PERIPH_CLKEN4_periph_clken4_23pclk_timer8_START  /* 时钟使能位偏移 */
