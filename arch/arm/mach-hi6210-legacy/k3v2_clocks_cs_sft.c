...
MACRO_CLK(clk_syspll, CLK_SYSPLL, ON, CLK_SYSPLL_RATE, CLK_SYSPLL_MIN_RATE, CLK_SYSPLL_MAX_RATE, NULL, NULL, \
		NULL, CLK_SYSPLL_ENABLE_REG_ADDR, CLK_SYSPLL_ENABLE_BIT_OFFSET, CLK_SYSPLL_CLKSEL_REG_ADDR, CLK_SYSPLL_CLKSEL_MASK, \
		CLK_SYSPLL_CLKSEL_SET_VALID, CLK_SYSPLL_CLKDIV_REG_ADDR, CLK_SYSPLL_CLKDIV_MASK, CLK_SYSPLL_CLKDIV_SET_VALID)
...
#endif
MACRO_CLK(clk_mmc0low, CLK_MMC0LOW, OFF, CLK_MMC0LOW_RATE, CLK_MMC0LOW_MIN_RATE, CLK_MMC0LOW_MAX_RATE, &clk_syspll, clkfr_mmc0low, \
...
#endif
MACRO_CLK(clk_mmc1low, CLK_MMC1LOW, OFF, CLK_MMC1LOW_RATE, CLK_MMC1LOW_MIN_RATE, CLK_MMC1LOW_MAX_RATE, &clk_syspll, clkfr_mmc1low, \
...
#endif
MACRO_CLK(clk_mmc2low, CLK_MMC2LOW, OFF, CLK_MMC2LOW_RATE, CLK_MMC2LOW_MIN_RATE, CLK_MMC2LOW_MAX_RATE, &clk_syspll, clkfr_mmc2low, \
...
struct clk_lookup k3v2_clk_lookups[] = {
    ...
    {_REGISTER_CLOCK(NULL,	"clk_syspll", 	clk_syspll)},
