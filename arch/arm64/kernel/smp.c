...
void smp_send_all_cpu_backtrace(struct pt_regs *regs)
{
	...
	for (i = 1; i < NR_CPUS; i++) {
		pr_info("cpu %d: idle %d, online %d\n", i, idle_cpu(i), cpu_online(i));
	}
...
extern void hisi_wdt_inform(void);
/*
