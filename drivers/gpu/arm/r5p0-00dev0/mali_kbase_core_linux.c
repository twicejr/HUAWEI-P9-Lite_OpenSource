...
/*
	//keep this code for SR debug, don't delete;
	//GPU reset and dereset;
	void __iomem *sctrl = ioremap(0xfff35000, 0x94);
	writel(0x00000038, sctrl+0x30);
	writel(0x00100000, sctrl+0x40);
	writel(0xc0078400, sctrl+0x50);
	writel(0x007c001c, sctrl+0x84);
	writel(0x03d00000, sctrl+0x90);
	writel(0x60000000, sctrl+0x70);
	writel(0x007c001c, sctrl+0x88);
	writel(0x03d00000, sctrl+0x94);
*/
