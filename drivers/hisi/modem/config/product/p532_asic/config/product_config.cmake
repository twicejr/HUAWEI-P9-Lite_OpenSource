...
set(CFG_PRODUCT_NAME "p532_asic") 

set(CFG_PRODUCT_CFG_CHIP_SOLUTION_NAME "Balong") 

set(CFG_BUILD_TYPE RELEASE) 

set(CFG_PRODUCT_VERSION V700R200C31B120) 

set(CFG_PRODUCT_VERSION_STR "V700R200C31B120") 

set(CFG_PRODUCT_FULL_VERSION_STR "Balong V700R200C31B120") 

set(CFG_PRODUCT_FILE_VERSION_STR "2.1.6.8") 

set(CFG_PRODUCT_DLOAD_SOFTWARE_VER		 "21.120.00.00.031") 

set(CFG_CONFIG_VERSION_STUB YES) 

set(CFG_HW_VERSION_STUB 0XFF000000) 

set(CFG_PXXX_BOARD_TYPE_ONLY_SOC YES) 
...
set(CFG_PLATFORM p532) 

set(CFG_OS_PATH modem/config/product/p532_asic/os) 
...
set(CFG_PRODUCT_NV_XNV_PDT_VERSION hi6950_fpga_p532) 
...
set(LPHY_LD_MAP_PUB_PATH modem/phy/lt/Tensilica_LSP/BBE16_NOCACHE_P532_LSP/mainlsp) 

set(LPHY_LD_MAP_LTE_PATH modem/phy/lt/Tensilica_LSP/BBE16_NOCACHE_P532_LSP/overlaylsp) 

set(LPHY_LD_MAP_TDS_PATH modem/phy/lt/Tensilica_LSP/BBE16_NOCACHE_P532_LSP/overlaylsp) 
...
set(CFG_LPHY_PRV_DTCM_BASE	 0x49080000) 

set(CFG_LPHY_PRV_ITCM_BASE	 0x49180000) 

set(CFG_LPHY_PUB_DTCM_SIZE		 0x80000) 

set(CFG_LPHY_PUB_ITCM_SIZE		 0x80000) 

set(CFG_LPHY_PRV_DTCM_SIZE		 0x80000) 

set(CFG_LPHY_PRV_ITCM_SIZE		 0x80000) 

set(CFG_LPHY_LTE_DTCM_SIZE		 0x80000) 

set(CFG_LPHY_LTE_ITCM_SIZE		 0x80000) 

set(CFG_LPHY_TDS_DTCM_SIZE		 0x80000) 

set(CFG_LPHY_TDS_ITCM_SIZE		 0x80000) 

set(CFG_LPHY_ALL_IMAG_SIZE		 0x300000) 

set(CFG_LPHY_TOTAL_IMG_SIZE ((LPHY_PUB_DTCM_SIZE)+(LPHY_PUB_ITCM_SIZE)+(LPHY_LTE_DTCM_SIZE)*1+(LPHY_LTE_ITCM_SIZE)*1+(LPHY_TDS_DTCM_SIZE)+(LPHY_TDS_ITCM_SIZE))) 
...
set(CFG_PLATFORM_HISI_BALONG p532) 

set(CFG_TTF_SKB_EXP NO) 

set(CFG_GU_FEATURE_CONFIG_PATH modem/config/product/p532_asic/include_gu) 
...
set(CFG_BSP_CONFIG_P532_FPGA NO) 
...
set(CFG_RTOSCK_CCORE_COMPONENTS bsp_ccore.o) 

set(CFG_CCORE_COMPONENTS bsp_ccore.o os_ccore.o) 

set(CFG_CCORE_MODEM1_COMPONENTS bsp_ccore1.o) 
...
set(CFG_PRODUCT_CFG_PTABLE_VER_NAME "HI6930_V7R2_UDP") 
...
set(CFG_PRODUCT_CFG_KERNEL_ENTRY 		 0x56E08000) 

set(CFG_PRODUCT_KERNEL_PARAMS_PHYS		 0x56E00100) 
...
set(CFG_DRV_SRAM_SIZE						 0x100000) 
...
set(CFG_FEATURE_GU_DSP_SPLIT FEATURE_OFF) 
