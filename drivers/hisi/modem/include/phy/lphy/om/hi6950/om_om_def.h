...
typedef enum __LPHY_REQ_MSGID_OM__
{
    ...
    LPHY_REQ_OM_ENA_PRINT_LEVEL     =  OM_CMD_ID(LPHY_OM_MID, OM_TYPE_REQ, 0x100            ),
    LPHY_REQ_OM_ENA_L1MSG_LEVEL     =  OM_CMD_ID(LPHY_OM_MID, OM_TYPE_REQ, 0x101            ),
    LPHY_REQ_OM_ENA_PRINT_XO        =  OM_CMD_ID(LPHY_OM_MID, OM_TYPE_REQ, 0x102            ),

    TPHY_REQ_OM_ENA_RPT_RESERVED  =  OM_TCMD_ID(TPHY_OM_MID, OM_TYPE_REQ, 0                  ),
    TPHY_REQ_OM_ENA_RPT_RFE       =  OM_TCMD_ID(TPHY_OM_MID, OM_TYPE_REQ, TPHY_RFDRV_MID     ),
    TPHY_REQ_OM_ENA_RPT_AGC       =  OM_TCMD_ID(TPHY_OM_MID, OM_TYPE_REQ, TPHY_AGC_MID       ),
    TPHY_REQ_OM_ENA_RPT_AFC       =  OM_TCMD_ID(TPHY_OM_MID, OM_TYPE_REQ, TPHY_AFC_MID       ),
    TPHY_REQ_OM_ENA_RPT_CS        =  OM_TCMD_ID(TPHY_OM_MID, OM_TYPE_REQ, TPHY_CS_MID        ),
    TPHY_REQ_OM_ENA_RPT_CMU       =  OM_TCMD_ID(TPHY_OM_MID, OM_TYPE_REQ, TPHY_CMU_MID       ),
    TPHY_REQ_OM_ENA_RPT_EMU       =  OM_TCMD_ID(TPHY_OM_MID, OM_TYPE_REQ, TPHY_MEAS_MID      ),
    TPHY_REQ_OM_ENA_RPT_CHE       =  OM_TCMD_ID(TPHY_OM_MID, OM_TYPE_REQ, TPHY_CHE_MID       ),

    TPHY_REQ_OM_ENA_RPT_DATA      =  OM_TCMD_ID(TPHY_OM_MID, OM_TYPE_REQ, TPHY_DATA_MID      ),
    TPHY_REQ_OM_ENA_RPT_CORR      =  OM_TCMD_ID(TPHY_OM_MID, OM_TYPE_REQ, TPHY_CORR_MID      ),
    TPHY_REQ_OM_ENA_RPT_CQI       =  OM_TCMD_ID(TPHY_OM_MID, OM_TYPE_REQ, TPHY_CQI_MID       ),
    TPHY_REQ_OM_ENA_RPT_PC        =  OM_TCMD_ID(TPHY_OM_MID, OM_TYPE_REQ, TPHY_PC_MID        ),
    TPHY_REQ_OM_ENA_RPT_SYNC      =  OM_TCMD_ID(TPHY_OM_MID, OM_TYPE_REQ, TPHY_SYNC_MID      ),
    TPHY_REQ_OM_ENA_RPT_TIMING    =  OM_TCMD_ID(TPHY_OM_MID, OM_TYPE_REQ, TPHY_TIMING_MID    ),
    TPHY_REQ_OM_ENA_RPT_DRX       =  OM_TCMD_ID(TPHY_OM_MID, OM_TYPE_REQ, TPHY_DRX_MID       ),
    TPHY_REQ_OM_ENA_RPT_SERV      =  OM_TCMD_ID(TPHY_OM_MID, OM_TYPE_REQ, TPHY_SERV_MID      ),
    TPHY_REQ_OM_ENA_RPT_UL        =  OM_TCMD_ID(TPHY_OM_MID, OM_TYPE_REQ, TPHY_UL_MID        ),

    TPHY_REQ_OM_ENA_RPT_CHANCTRL  =  OM_TCMD_ID(TPHY_OM_MID, OM_TYPE_REQ, TPHY_CHANCTRL_MID  ),
    TPHY_REQ_OM_ENA_RPT_OM        =  OM_TCMD_ID(TPHY_OM_MID, OM_TYPE_REQ, TPHY_OM_MID        ),
    TPHY_REQ_OM_ENA_RPT_DMA       =  OM_TCMD_ID(TPHY_OM_MID, OM_TYPE_REQ, TPHY_DMA_MID       ),
    TPHY_REQ_OM_ENA_RPT_CD        =  OM_TCMD_ID(TPHY_OM_MID, OM_TYPE_REQ, TPHY_CD_MID        ),
    TPHY_REQ_OM_ENA_RPT_VIT_TURBO =  OM_TCMD_ID(TPHY_OM_MID, OM_TYPE_REQ, TPHY_VIT_TURBO_MID ),
    TPHY_REQ_OM_ENA_RPT_SCHED     =  OM_TCMD_ID(TPHY_OM_MID, OM_TYPE_REQ, TPHY_SCHED_MID     ),
    TPHY_REQ_OM_ENA_RPT_INTERRUPT =  OM_TCMD_ID(TPHY_OM_MID, OM_TYPE_REQ, TPHY_INT_MID       ),
    TPHY_REQ_OM_ENA_RPT_JD        =  OM_TCMD_ID(TPHY_OM_MID, OM_TYPE_REQ, TPHY_JD_MID        ),

    TPHY_REQ_OM_ENA_RPT_DCOC      =  OM_TCMD_ID(TPHY_OM_MID, OM_TYPE_REQ, TPHY_DCOC_MID      ),
    TPHY_REQ_OM_ENA_RPT_RXIQ      =  OM_TCMD_ID(TPHY_OM_MID, OM_TYPE_REQ, TPHY_RXIQ_MID      ),
    TPHY_REQ_OM_ENA_RPT_CT        =  OM_TCMD_ID(TPHY_OM_MID, OM_TYPE_REQ, TPHY_CT_MID        ),
    TPHY_REQ_OM_ENA_RPT_BT        =  OM_TCMD_ID(TPHY_OM_MID, OM_TYPE_REQ, TPHY_BT_MID        ),
    TPHY_REQ_OM_ENA_RPT_NCIT      =  OM_TCMD_ID(TPHY_OM_MID, OM_TYPE_REQ, TPHY_NCIT_MID      )
...
typedef struct __LPHY_REQ_OM_ENA_XO_PRINT__
{
    OM_REQ_ENABLE_ENUM_UINT16  enEna;
}LPHY_REQ_OM_ENA_XO_PRINT_STRU;
...
typedef struct __LPHY_REQ_OM_ENA_RPT_LEVEL_STRU__
{
    ...
    OM_REQ_ENABLE_ENUM_UINT16  enDebug;          /*是否使能调试级别上报*/
	OM_REQ_ENABLE_ENUM_UINT16  enRsd;
...
typedef enum __LPHY_TRACE_OM_ENUM__
{
    ...
    LPHY_TRACE_OM_STRING                = OM_PRNT_ID(LPHY_OM_MID, OM_TYPE_TRACE, 0x1) /*打印字符串用, 没有对应的结构体*/
}LPHY_TRACE_OM_ENUM;
