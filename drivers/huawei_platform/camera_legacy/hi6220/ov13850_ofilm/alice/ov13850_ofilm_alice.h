...
#ifndef _OV13850_OFILM_ALICE_H_
#define _OV13850_OFILM_ALICE_H_


#include "../isp/k3_isp_io.h"

static const struct _sensor_reg_t ov13850_ofilm_alice_init_regs[] = {
	/* Global Setting */
...
static const struct _sensor_reg_t ov13850_ofilm_alice_framesize_quater[] = {
...
static const struct _sensor_reg_t ov13850_ofilm_alice_framesize_fullsize_nonzsl[] = {
#if 0 //10fps
...
static sensor_setting_t ov13850_ofilm_alice_init_array[] = {
    {ov13850_ofilm_alice_init_regs, ARRAY_SIZE(ov13850_ofilm_alice_init_regs)},
};

static framesize_s ov13850_ofilm_alice_framesizes[] = {
    //2080x1560, 30fps
    {0, 0, 2080, 1560, 4736, 1786, 30, 30, 0x214, 0x1bb, 0x100, VIEW_FULL, RESOLUTION_4_3, false, false, {ov13850_ofilm_alice_framesize_quater, ARRAY_SIZE(ov13850_ofilm_alice_framesize_quater)}, CLK_500M},
    //4160x3120, 10fps
    ...
    //4160x3120, 13fps
    {0, 0, 4160, 3120, 5704, 3328, 13, 13, 0x1B0, 0x168, 0xD0, VIEW_FULL, RESOLUTION_4_3, false, false, {ov13850_ofilm_alice_framesize_fullsize_nonzsl, ARRAY_SIZE(ov13850_ofilm_alice_framesize_fullsize_nonzsl)}, CLK_500M}
};

#endif /* _OV13850_OFILM_ALICE_H_ */
/************************** END ***************************/
