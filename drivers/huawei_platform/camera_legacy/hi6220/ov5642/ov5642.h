 ...
 *bit[5]:  vertical flip
 */
#define OV5642REG_TIMING_FORMAT1	0x3818
#define OV5642REG_TIMING_FORMAT2 0x3621
...
//2592 1944 raw8
const struct _sensor_reg_t ov5642_2592_1944_raw8[] = {
{0x3103, 0x93},
{0x3008, 0x82},
{0x3017, 0x7f},
{0x3018, 0xfc},
...
{0x4708, 0x06},
{0x370c, 0xa0},
{0x3808, 0x0a},/* width 2592 */
{0x3809, 0x20},
{0x380a, 0x07},/* height 1944 */
{0x380b, 0x98},
{0x380c, 0x0c},/* hts 3200 */
{0x380d, 0x80},
{0x380e, 0x07},/* vts 2000 */
{0x380f, 0xd0},
{0x5000, 0x06},
...
{0x350a, 0x00},
{0x350b, 0x00},
{0x3503, 0x00},//default value is 0x00
{0x3030, 0x0b},//default value is 0x0b
{0x3a02, 0x00},
{0x3a03, 0x7d},
{0x3a04, 0x00},
{0x3a14, 0x00},
...
// 1296 972 quarter raw8
const struct _sensor_reg_t ov5642_quarter_raw8[]= {
{0x3103, 0x93},
//{0x3008, 0x82},
{0x3008, 0xc2},
{0x3017, 0x7f},
...
{0x5686, 0x03},
{0x5687, 0xc8},
{0x3808, 0x05},/* width 1296 */
{0x3809, 0x10},
{0x380a, 0x03},/* height 972 */
{0x380b, 0xcc},
{0x5025, 0x80},
{0x3824, 0x13},
{0x3825, 0x50},
...
{0x5000, 0x06},
{0x5001, 0x00},
{0x380e, 0x0b},/* vts = 3000 */
{0x380f, 0xb8}
};

const struct _sensor_reg_t ov5642_1296x972[] = {
	{0x3008, 0x42},/* soft power down */
	{0x3808, 0x05},/* width 1296 */
	{0x3809, 0x10},
	{0x380a, 0x03},/* height 972 */
	{0x380b, 0xcc},
