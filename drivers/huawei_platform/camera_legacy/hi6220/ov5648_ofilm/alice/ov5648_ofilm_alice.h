...
#ifndef _OV5648_OFILM_ALICE_H_
#define _OV5648_OFILM_ALICE_H_
 ...
 *
 ***********************************************************************/
const struct _sensor_reg_t ov5648_ofilm_alice_init_regs[] = {
...
/*1280x960*/
static const struct _sensor_reg_t ov5648_ofilm_alice_framesize_quarter[] = {
...
/*2592 1952 full size*/
static const struct _sensor_reg_t ov5648_ofilm_alice_framesize_full[] = {
...
static sensor_setting_t ov5648_ofilm_alice_init_array[] = {
    {ov5648_ofilm_alice_init_regs, ARRAY_SIZE(ov5648_ofilm_alice_init_regs)},
};

static framesize_s ov5648_ofilm_alice_framesizes[] = {
    {0, 0, 1280, 960, 2136, 1360, 30, 30, 0x194, 0x151, 0x100, VIEW_FULL, RESOLUTION_4_3, false, false, {ov5648_ofilm_alice_framesize_quarter, ARRAY_SIZE(ov5648_ofilm_alice_framesize_quarter)}, CLK_450M},
    {0, 0, 2592, 1952, 2816, 2128, 14, 14, 0x133, 0x100, 0xc2, VIEW_FULL, RESOLUTION_4_3, false, false, {ov5648_ofilm_alice_framesize_full, ARRAY_SIZE(ov5648_ofilm_alice_framesize_full)}, CLK_450M },
};

#endif /* _OV5648_OFILM_ALICE_H_ */
