...
#ifndef _OV5648_OFILM_CHERRYPRO_H_
#define _OV5648_OFILM_CHERRYPRO_H_
 ...
 *
 ***********************************************************************/
const struct _sensor_reg_t ov5648_ofilm_cherrypro_init_regs[] = {
...
//	{0x3503, 0x07}, // gain delay 2 frames, manual agc/aec
...
/*1280x960*/
static const struct _sensor_reg_t ov5648_ofilm_cherrypro_framesize_quarter[] = {
...
//	{0x301c, 0xd6},
  ...
  //  {0x3810, 0x00}, // isp x win = 16
   ...
   // {0x3817, 0x00}, // hsync start
    ...
    //{0x350b, 0x80}, // gain = 8x
    {0x4837, 0x22}, //0x17        //kenxu @ 20130913 to update mipi global timing
    {0x0100, 0x01},
};

/*2592 1952 full size*/
static const struct _sensor_reg_t ov5648_ofilm_cherrypro_framesize_full[] = {
    // 2592x1952 14.4fps 2 lane MIPI 431.97Mbps/lane
...
static sensor_setting_t ov5648_ofilm_cherrypro_init_array[] = {
    {ov5648_ofilm_cherrypro_init_regs, ARRAY_SIZE(ov5648_ofilm_cherrypro_init_regs)},
};

static framesize_s ov5648_ofilm_cherrypro_framesizes[] = {
    {0, 0, 1280, 960, 1408, 1360, 30, 30, 0x199, 0x154, 0x100, VIEW_FULL, RESOLUTION_4_3, false, false, {ov5648_ofilm_cherrypro_framesize_quarter, ARRAY_SIZE(ov5648_ofilm_cherrypro_framesize_quarter)}, CLK_300M},
    {0, 0, 2592, 1952, 2816, 2128, 14, 14, 0x133, 0x100, 0xC0, VIEW_FULL, RESOLUTION_4_3, false, false, {ov5648_ofilm_cherrypro_framesize_full, ARRAY_SIZE(ov5648_ofilm_cherrypro_framesize_full)}, CLK_450M },
};
#endif /* _OV5648_OFILM_CHERRYPRO_H_ */
