...
#ifndef _S5K4E1GA_SUNNY_CHERRYPLUS_H_
#define _S5K4E1GA_SUNNY_CHERRYPLUS_H_
 ...
 *
 ***********************************************************************/
static const struct _sensor_reg_t s5k4e1ga_sunny_cherryplus_init_regs[] = {
...
/*1280x960*/
static const struct _sensor_reg_t s5k4e1ga_sunny_cherryplus_framesize_1280x960[] = {
    ...
    {0x0341, 0x4c},//SXGA 03CC(960[# of row]+[V-blank])
...
/*1920x1080*/
static const struct _sensor_reg_t s5k4e1ga_sunny_cherryplus_framesize_1080p[] = {
{0x0100, 0x00},//stream off
{0x0105, 0x01}, //
{0x301B, 0x75},
...
/*2592x1952*/
static const struct _sensor_reg_t s5k4e1ga_sunny_cherryplus_framesize_full[] = {
{0x0100, 0x00},//stream off
{0x0105, 0x01}, //
{0x301B, 0x75},
...
{0x0341, 0x98},//SXGA 03E0(960[# of row]+[V-blank])
...
static sensor_setting_t s5k4e1ga_sunny_cherryplus_init_array[] = {
    {s5k4e1ga_sunny_cherryplus_init_regs, ARRAY_SIZE(s5k4e1ga_sunny_cherryplus_init_regs)},
};

static framesize_s s5k4e1ga_sunny_cherryplus_framesizes[] = {
    {0, 0, 1280, 960, 2982, 1100, 30, 30, 0x14b, 0x113, 0x100, VIEW_FULL, RESOLUTION_4_3, false, false,{s5k4e1ga_sunny_cherryplus_framesize_1280x960, ARRAY_SIZE(s5k4e1ga_sunny_cherryplus_framesize_1280x960)}, CLK_500M },
    ...
    {0, 0, 2592, 1952, 2982, 2200, 15, 15, 0x14b, 0x113, 0x100, VIEW_FULL, RESOLUTION_4_3, false, false,{s5k4e1ga_sunny_cherryplus_framesize_full, ARRAY_SIZE(s5k4e1ga_sunny_cherryplus_framesize_full)}, CLK_500M },
};

#endif /* _S5K4E1GA_SUNNY_CHERRYPLUS_H_ */
