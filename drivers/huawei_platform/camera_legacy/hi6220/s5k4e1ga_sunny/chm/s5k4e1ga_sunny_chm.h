/*
 *  s5k4e1ga_sunny camera driver head file
 *
...
#ifndef _S5K4E1GA_SUNNY_CHM_H_
#define _S5K4E1GA_SUNNY_CHM_H_

#include "k3_isp_io.h"
/***********************************************************************
 *
 * s5k4e1ga_sunny init sensor registers list
 *
 ***********************************************************************/
static const struct _sensor_reg_t s5k4e1ga_sunny_chm_init_regs[] = {
...
{0x0307, 0x68},//PLL M = 104
{0x30B5, 0x01},//01//PLL S = 1 
{0x30E2, 0x02},//02//num lanes[1:0] = 2
{0x30F1, 0x70},//70//DPHY BANDCTRL 428Mbps
...
/*1280x960*/
static const struct _sensor_reg_t s5k4e1ga_sunny_chm_framesize_1280x960[] = {
//1280x960_29.708fps_427.856Mbps/lane
//HTS = 2738, VTS = 1052
    ...
    {0x0341, 0x1c},//SXGA 03CC(960[# of row]+[V-blank])
...
/*1920x1080*/
static const struct _sensor_reg_t s5k4e1ga_sunny_chm_framesize_1080p[] = {
{0x0100, 0x00},//stream off
{0x0105, 0x01}, //
{0x301B, 0x75},
...
/*2592x1952*/
static const struct _sensor_reg_t s5k4e1ga_sunny_chm_framesize_full[] = {
//2952x1952_14.997fps_427.856Mbps/lane
//HTS = 2738, VTS = 2084
{0x0100, 0x00},//stream off
{0x0105, 0x01}, //
{0x301B, 0x75},
...
{0x30BF, 0xAB},//outif_enable[7], data_type[5:0](2Bh = bayer 10bit)
{0x30C0, 0xC0},//video_offset[7:4] 3240%12
{0x30C8, 0x0C},//video_data_length 3240 = 2592 * 1.25
{0x30C9, 0xA8},

/* Frame Length = 2084 */
{0x0340, 0x08},//Capture 07B4(2084[# of row]+[V-blank])
{0x0341, 0x24},//SXGA 03E0(960[# of row]+[V-blank])
...
static sensor_setting_t s5k4e1ga_sunny_chm_init_array[] = {
    {s5k4e1ga_sunny_chm_init_regs, ARRAY_SIZE(s5k4e1ga_sunny_chm_init_regs)},
};

static framesize_s s5k4e1ga_sunny_chm_framesizes[] = {
    {0, 0, 1280, 960, 2738, 1052, 30, 30, 0x139, 0x104, 0x100, VIEW_FULL, RESOLUTION_4_3, false, false,{s5k4e1ga_sunny_chm_framesize_1280x960, ARRAY_SIZE(s5k4e1ga_sunny_chm_framesize_1280x960)}, CLK_450M },
    ...
    {0, 0, 2592, 1952, 2738, 2084, 15, 15, 0x139, 0x104, 0x100, VIEW_FULL, RESOLUTION_4_3, false, false,{s5k4e1ga_sunny_chm_framesize_full, ARRAY_SIZE(s5k4e1ga_sunny_chm_framesize_full)}, CLK_450M },
};

#endif /* _S5K4E1GA_SUNNY_CHM_H_ */
