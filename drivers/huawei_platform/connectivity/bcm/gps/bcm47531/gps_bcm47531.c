...
static int k3_gps_bcm_probe(struct platform_device* pdev)
{
    ...
    printk(KERN_INFO "[GPS] start find gps_power and ic type is 47531\n");
...
static int __init k3_gps_bcm_init(void)
{
    ...
    {
        printk(KERN_INFO "gps chip type is matched with Broadcom, but is not 47531");
        return -EINVAL;
    }
    printk(KERN_INFO "gps chip type is matched with Broadcom, and it is 47531\n");
