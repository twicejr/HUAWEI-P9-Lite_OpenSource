...
int
bcmsdh_power_on(void *sdh)
{
    bcmsdh_info_t *bcmsdh = (bcmsdh_info_t *)sdh;
    return sdioh_power_on(bcmsdh->sdioh);
}

int
bcmsdh_power_off(void *sdh)
{
    bcmsdh_info_t *bcmsdh = (bcmsdh_info_t *)sdh;
    return sdioh_power_off(bcmsdh->sdioh);
}
#endif

#ifdef HW_SKIP_CMD52_TIMEOUT_LOG
int
bcmsdh_wakelog_switch(void *sdh, bool enable)
{
	bcmsdh_info_t *bcmsdh = (bcmsdh_info_t *)sdh;
    return sdioh_wakelog_switch(bcmsdh->sdioh, enable);
}
#endif
