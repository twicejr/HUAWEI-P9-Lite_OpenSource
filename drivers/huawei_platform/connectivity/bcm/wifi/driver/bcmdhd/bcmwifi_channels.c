...
struct UT_TEST_WL  UT_bcmwifi= {
	.center_chan_to_edge = center_chan_to_edge,
	.channel_low_edge = channel_low_edge,
	.channel_to_sb = channel_to_sb,
	.channel_80mhz_to_id = channel_80mhz_to_id,
	.channel_to_ctl_chan = channel_to_ctl_chan,
	.wf_chspec_get80Mhz_ch = wf_chspec_get80Mhz_ch
};
