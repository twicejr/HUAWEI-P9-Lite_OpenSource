...
#if  defined(HW_WIFI_DRV_DEBUG)
#define WIFI_TAG  "WIFI_DBG "
#define HW_PRINT(args)  {printk args;}
#define HW_PRINT_HI(fmt, args...) do {if (dhd_msg_level & DHD_ERROR_VAL) \
                                      printk(KERN_ERR "WIFI_DBG " fmt, ## args);} while(0)
#define HW_PRINT_LO(fmt, args...) do {if (dhd_msg_level & DHD_INFO_VAL) \
                                      printk(KERN_INFO "WIFI_DBG " fmt, ## args);} while(0)
#else
#define WIFI_TAG
#define HW_PRINT(args)
#define HW_PRINT_HI(fmt, args...)
#define HW_PRINT_LO(fmt, args...)
#endif
