...
#define MAX_SENSOR_CALIBRATE_DATA_LENGTH  24
...
#define MAX_MAG_AKM_CALIBRATE_DATA_LENGTH    32
...
enum {
    ...
    FILE_FUSION,                            // 6
    FILE_FUSION_GAME,                       // 7
    FILE_FUSION_GEOMAGNETIC,                // 8
    FILE_MOTION,                            // 9
    FILE_PEDOMETER,                         // 10
    FILE_PDR,                               // 11
    FILE_AR,                                // 12
    FILE_GSENSOR_GATHER_FOR_GPS,            // 13
    FILE_PHONECALL,                         // 14
    FILE_FINGERSENSE,                       // 15
    FILE_SIX_FUSION,                        // 16
    FILE_UNCALIBRATE_GYRO,                  // 17
    FILE_UNCALIBRATE_MAG,                   // 18
    ...
    FILE_GPS_4774,                          // 47
    FILE_ST_LPS22BH,                        // 48
    FILE_ID_MAX = 63,                       // MAX VALID FILE ID
};
