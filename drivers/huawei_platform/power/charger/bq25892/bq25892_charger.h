...
#ifndef _BQ25892_CHARGER
#define _BQ25892_CHARGER
...
#define BQ25892_REG_04_ICHG_MASK (BIT(6) | BIT(5) | BIT(4) |\
...
#define BQ25892_REG_06_VREG_MASK (BIT(7) | BIT(6) | BIT(5) | \
	BIT(4) | BIT(3) | BIT(2))
...
struct bq25892_static_ops {
    int (*bq25892_write_mask)(u8, u8, u8, u8);
    int (*bq25892_read_byte)(u8, u8 *);
    int (*bq25892_write_byte)(u8, u8);
    int (*bq25892_set_bat_comp)(int);
    int (*bq25892_set_vclamp)(int);
    int (*bq25892_set_input_current)(int);
    int (*bq25892_set_charge_current)(int);
    int (*bq25892_set_terminal_voltage)(int);
    int (*bq25892_set_dpm_voltage)(int);
    int (*bq25892_set_terminal_current)(int);
    int (*bq25892_set_otg_current)(int);
    int (*bq25892_get_vbus_mv)(int);
    int (*bq25892_set_watchdog_timer)(int);
    int (*bq25892_set_charger_hiz)(int);
};
#endif
