...
static struct bq25892_aux_device_info *g_bq25892_aux_dev = NULL;
...
**********************************************************/
static int bq25892_aux_write_block(struct bq25892_aux_device_info *di, u8 *value,
...
*  return value:  0-sucess or others-fail
**********************************************************/
static int bq25892_aux_read_block(struct bq25892_aux_device_info *di, u8 *value,
                            u8 reg, unsigned num_bytes)
{
...
int bq25892_aux_get_ichg_reg(void)
{
    ...
    u8 ichg_reg = 0;
    int ichg = 0;
    ret = bq25892_aux_read_mask(BQ25892_AUX_REG_04, BQ25892_AUX_REG_04_ICHG_MASK, BQ25892_AUX_REG_04_ICHG_SHIFT,&ichg_reg);
    if(ret)
    {
...
static struct attribute *
        bq25892_aux_sysfs_attrs[ARRAY_SIZE(bq25892_aux_sysfs_field_tbl) + 1];
...
static void bq25892_aux_sysfs_init_attrs(void)
{
    ...
    for (i = 0; i < limit; i++)
        bq25892_aux_sysfs_attrs[i] = &bq25892_aux_sysfs_field_tbl[i].attr.attr;
...
**********************************************************/
static struct bq25892_aux_sysfs_field_info *bq25892_aux_sysfs_field_lookup(const char *name)
{
    int i, limit = ARRAY_SIZE(bq25892_aux_sysfs_field_tbl);

    for (i = 0; i < limit; i++)
        if (!strcmp(name, bq25892_aux_sysfs_field_tbl[i].attr.attr.name))
            break;
...
static int bq25892_aux_sysfs_create_group(struct bq25892_aux_device_info *di)
{
    ...
    return sysfs_create_group(&di->dev->kobj,&bq25892_aux_sysfs_attr_group);
}
/**********************************************************
...
static int bq25892_aux_device_check()
{
    int ret = 0;
    u8 reg = 0xff;
...
static int bq25892_aux_set_bat_comp(int value)
{
    ...
    return bq25892_aux_write_mask(BQ25892_AUX_REG_08,BQ25892_AUX_REG_08_BAT_COMP_MASK,BQ25892_AUX_REG_08_BAT_COMP_SHIFT,bat_comp_reg);
}
/**********************************************************
...
static int bq25892_aux_set_vclamp(int value)
{
    ...
    return bq25892_aux_write_mask(BQ25892_AUX_REG_08,BQ25892_AUX_REG_08_VCLAMP_MASK,BQ25892_AUX_REG_08_VCLAMP_SHIFT,vclamp_reg);
}
/**********************************************************
...
static int bq25892_aux_set_covn_start(int enable)
{
    ...
    ret = bq25892_aux_write_mask(BQ25892_AUX_REG_02,BQ25892_AUX_REG_02_CONV_START_MASK,BQ25892_AUX_REG_02_CONV_START_SHIFT,enable);
    if(ret)
    {
    ...
    for(i=0; i<10;i++)
    {
        ret =  bq25892_aux_read_mask(BQ25892_AUX_REG_02, BQ25892_AUX_REG_02_CONV_START_MASK, BQ25892_AUX_REG_02_CONV_START_SHIFT, &reg);
        if(ret )
        {
...
static int bq25892_aux_set_adc_conv_rate(int mode)
{
    ...
    return bq25892_aux_write_mask(BQ25892_AUX_REG_02,BQ25892_AUX_REG_02_CONV_RATE_MASK,BQ25892_AUX_REG_02_CONV_RATE_SHIFT,mode);
}
...
static int bq25892_aux_set_input_current(int value)
{
    ...
    return bq25892_aux_write_mask(BQ25892_AUX_REG_00,BQ25892_AUX_REG_00_IINLIM_MASK,BQ25892_AUX_REG_00_IINLIM_SHIFT,Iin_limit);
}
/**********************************************************
...
static int bq25892_aux_set_charge_current(int value)
{
    ...
    return bq25892_aux_write_mask(BQ25892_AUX_REG_04,BQ25892_AUX_REG_04_ICHG_MASK,BQ25892_AUX_REG_04_ICHG_SHIFT,ichg);
}
/**********************************************************
...
static int bq25892_aux_set_terminal_voltage(int value)
{
    ...
    return bq25892_aux_write_mask(BQ25892_AUX_REG_06,BQ25892_AUX_REG_06_VREG_MASK,BQ25892_AUX_REG_06_VREG_SHIFT,Voreg);
}
/**********************************************************
...
static int bq25892_aux_set_terminal_current(int value)
{
    ...
    return bq25892_aux_write_mask(BQ25892_AUX_REG_05,BQ25892_AUX_REG_05_ITERM_MASK,BQ25892_AUX_REG_05_ITERM_SHIFT,iterm_reg);
}
...
static int bq25892_aux_set_charge_enable(int enable)
{
    ...
    return bq25892_aux_write_mask(BQ25892_AUX_REG_03,BQ25892_AUX_REG_03_CHG_CONFIG_MASK,BQ25892_AUX_REG_03_CHG_CONFIG_SHIFT,enable);
}
/**********************************************************
...
static int bq25892_aux_set_otg_enable(int enable)
{
    ...
    gpio_set_value(di->gpio_cd, !enable);
    val = enable << 1;
    return bq25892_aux_write_mask(BQ25892_AUX_REG_03,BQ25892_AUX_REG_03_CHG_CONFIG_MASK,BQ25892_AUX_REG_03_CHG_CONFIG_SHIFT,val);
}
/**********************************************************
...
{
    return bq25892_aux_write_mask(BQ25892_AUX_REG_07,BQ25892_AUX_REG_07_EN_TERM_MASK,BQ25892_AUX_REG_07_EN_TERM_SHIFT,enable);
}
/**********************************************************
...
static int bq25892_aux_get_charge_state(unsigned int *state)
{
    ...
    if((reg & BQ25892_AUX_CHGR_STAT_CHARGE_DONE) != BQ25892_AUX_CHGR_STAT_NOT_CHARGING)
    {
        if((reg & BQ25892_AUX_CHGR_STAT_CHARGE_DONE) == BQ25892_AUX_CHGR_STAT_CHARGE_DONE)
        {
    ...
    if((reg & BQ25892_AUX_POWER_SUPPLY_OVP) == BQ25892_AUX_POWER_SUPPLY_OVP)
    {
...
{
    return bq25892_aux_write_mask(BQ25892_AUX_REG_03,BQ25892_AUX_REG_03_WDT_RESET_MASK,BQ25892_AUX_REG_03_WDT_RESET_SHIFT,0x01);
}
/**********************************************************
...
static int bq25892_aux_get_ilim(void)
{
    ...
    int ichg, vbat, vbus;
    ret = bq25892_aux_read_mask(BQ25892_AUX_REG_12, BQ25892_AUX_REG_12_ICHGR_MASK, BQ25892_AUX_REG_12_ICHGR_SHIFT,&ichg_reg);
    if(ret)
    {
        hwlog_err(" bq25892 aux read ichg_adc fail.\n");
        return -1;
    }
    ichg = ichg_reg * BQ25892_AUX_REG_12_ICHGR_STEP_MA + BQ25892_AUX_REG_12_ICHGR_OFFSET_MA;

    ret = bq25892_aux_read_mask(BQ25892_AUX_REG_0E, BQ25892_AUX_REG_0E_BATV_MASK, BQ25892_AUX_REG_0E_BATV_SHIFT,&vbat_reg);
    if(ret)
    {
        hwlog_err(" bq25892 aux read vbat_adc fail.\n");
        return -1;
    }
    vbat = vbat_reg* BQ25892_AUX_REG_0E_VBAT_STEP_MV + BQ25892_AUX_REG_0E_VBAT_OFFSET_MV;

    ret = bq25892_aux_read_mask(BQ25892_AUX_REG_11, BQ25892_AUX_REG_11_VBUSV_MASK, BQ25892_AUX_REG_11_VBUSV_SHIFT,&vbus_reg);
    if(ret)
    {
        hwlog_err(" bq25892 aux read vbus_adc fail.\n");
        return -1;
    }
    vbus = vbus_reg * BQ25892_AUX_REG_11_VBUSV_STEP_MV + BQ25892_AUX_REG_11_VBUSV_OFFSET_MV;
...
{
    return bq25892_aux_write_mask(BQ25892_AUX_REG_09,BQ25892_AUX_REG_09_BATFET_DISABLE_MASK,BQ25892_AUX_REG_09_BATFET_DISABLE_SHIFT,disable);
}
/**********************************************************
...
static int bq25892_aux_set_watchdog_timer(int value)
{
    ...
    return bq25892_aux_write_mask(BQ25892_AUX_REG_07,BQ25892_AUX_REG_07_WATCHDOG_MASK,BQ25892_AUX_REG_07_WATCHDOG_SHIFT,val);
}
/**********************************************************
...
static int bq25892_aux_set_charger_hiz(int enable)
{
    ...
    if(enable > 0)
    {
        ret |= bq25892_aux_write_mask(BQ25892_AUX_REG_00,BQ25892_AUX_REG_00_EN_HIZ_MASK,BQ25892_AUX_REG_00_EN_HIZ_SHIFT,TRUE);
    }
    else
    {
        ret |= bq25892_aux_write_mask(BQ25892_AUX_REG_00,BQ25892_AUX_REG_00_EN_HIZ_MASK,BQ25892_AUX_REG_00_EN_HIZ_SHIFT,FALSE);
    }
    return ret;
}
/**********************************************************
...
static int bq25892_aux_check_input_dpm_state(void)
{
    ...
    if ((reg & BQ25892_AUX_REG_13_VDPM_STAT_MASK) || (reg & BQ25892_AUX_REG_13_IDPM_STAT_MASK))
    {
        return TRUE;
    }
    else
...
{
    struct bq25892_aux_device_info *di = container_of(work,struct bq25892_aux_device_info, irq_work);
    u8 reg = 0,reg1 = 0;
...
static void parse_dts(struct device_node *np,struct bq25892_aux_device_info *di)
{
    ...
    {
        bq25892_aux_ops.fcp_chip_init = bq25892_aux_fcp_chip_init;
...
*  return value:  0-sucess or others-fail
**********************************************************/
static int bq25892_aux_probe(struct i2c_client *client,const struct i2c_device_id *id)
{
    int ret = 0;
    ...
    ret = request_irq(di->irq_int,bq25892_aux_interrupt,IRQF_TRIGGER_FALLING,"charger_int_irq",di);
    if(ret)
    {
    ...
    if(power_class)
    {
        ...
        ret = sysfs_create_link(&charge_dev->kobj, &di->dev->kobj, "bq25892_aux");
        if(ret)
...
static const struct i2c_device_id bq25892_aux_i2c_id[] = {{"bq25892_charger_aux",0},{}};
