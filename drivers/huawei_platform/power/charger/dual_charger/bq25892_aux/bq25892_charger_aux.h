...
#define BQ25892_AUX_REG_02_CONV_RATE_MASK      BIT(6)
#define BQ25892_AUX_REG_02_CONV_RATE_SHIFT   (6)
...
#define BQ25892_AUX_REG_14_REG_PN_MASK  (BIT(5) | BIT(4) | BIT(3))
#define BQ25892_AUX_REG_14_REG_PN_IS_25892      0
