...
struct csv_parser {
  ...
  void *(*realloc_func)(const void *p, size_t new_size, gfp_t flags);
...
void csv_set_realloc_func(struct csv_parser *p, void *(*)(const void *, size_t, gfp_t));
void csv_set_free_func(struct csv_parser *p, void (*)(const void *));
