...
#define ETM_TRCEXTINSELR_sel3 0x3000000
...
/* CTI trigger output pin number, which is the input of ETM*/
#define ETM_STOP_TRIGOUT (7)	/*CTI tigger output is 7, == ETM_INPUT_EXTIN*/
#define ETM_STOP_EXTIN  (ETM_STOP_TRIGOUT-4)
