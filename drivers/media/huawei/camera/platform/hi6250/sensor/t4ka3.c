...
struct sensor_power_setting t4ka3_power_setting[] = {
...
struct sensor_power_setting t4ka3_power_setting_dvdd120[] = {
	//disable main camera reset
	{
		.seq_type = SENSOR_SUSPEND,
		.config_val = SENSOR_GPIO_LOW,
...
static sensor_t s_t4ka3 =
{
    ...
    .power_setting_array = {
            .size = ARRAY_SIZE(t4ka3_power_setting),
            .power_setting = t4ka3_power_setting,
     },
};
        ...
        struct platform_device* pdev)
{
	...
	if (pdev->dev.of_node) {
		...
		if(DVDD120V == s_t4ka3.board_info->ldo_diverse){
			...
			s_t4ka3.power_setting_array.size = ARRAY_SIZE(t4ka3_power_setting_dvdd120);
			s_t4ka3.power_setting_array.power_setting = t4ka3_power_setting_dvdd120;
		}
	} else {
