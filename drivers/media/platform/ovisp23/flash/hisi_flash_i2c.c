...
int hisi_flash_i2c_read(struct hisi_flash_i2c_client *client,
	u8 reg, u8 *data)
{
	int rc = 0;
...
int hisi_flash_i2c_write(struct hisi_flash_i2c_client *client,
	u8 reg, u8 data)
{
	int rc = 0;
	u8 buf[2] = {0};
...
struct hisi_flash_i2c_fn_t hisi_flash_i2c_func_tbl = {
	.i2c_read = hisi_flash_i2c_read,
	.i2c_write = hisi_flash_i2c_write,
};
