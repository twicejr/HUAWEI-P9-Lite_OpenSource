...
static int bq25892_chip_init(void)
{
    ...
    /*06 Charge Voltage Limit 4.352,Battery Precharge to Fast Charge Threshold 3,Battery Recharge 100mV*/
    ret |= bq25892_write_byte(BQ25892_REG_06,0x82);
    /*07 EN_TERM 1,Watchdog Timer 80s,EN_TIMER 1,Charge Timer 20h,JEITA Low Temperature Current Setting 1*/
    ret |= bq25892_write_byte(BQ25892_REG_07,0xaf);
...
static int bq25892_set_terminal_current(int value)
{
    ...
    iterm_reg = (term_currentmA -ITERM_MIN_64)/ITERM_STEP_64;
...
static int bq25892_get_charge_state(unsigned int *state)
{
    ...
    if((reg & BQ25892_POWER_SUPPLY_OVP) == BQ25892_POWER_SUPPLY_OVP)
    {
