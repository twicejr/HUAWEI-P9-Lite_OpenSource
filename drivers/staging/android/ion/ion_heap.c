...
static int __attribute__((unused)) ion_heap_clear_pages(struct page **pages, int num, pgprot_t pgprot)
{
...
static int __attribute__((unused)) ion_heap_clear_pages_for_large_buffer(struct page **pages, int num, pgprot_t pgprot)
{
	void *vaddr;
