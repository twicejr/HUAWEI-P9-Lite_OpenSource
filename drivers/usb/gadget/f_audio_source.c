...
static struct usb_endpoint_descriptor audio_ss_as_in_ep_desc  = {
...
static struct usb_ss_ep_comp_descriptor audio_ss_as_in_ep_comp_desc = {
...
static struct usb_descriptor_header *ss_audio_desc[] = {
	...
	(struct usb_descriptor_header *)&audio_ss_as_in_ep_desc,
	(struct usb_descriptor_header *)&audio_ss_as_in_ep_comp_desc,
...
audio_bind(struct usb_configuration *c, struct usb_function *f)
{
	...
	if (gadget_is_superspeed(c->cdev->gadget))
		audio_ss_as_in_ep_desc.bEndpointAddress =
			audio_fs_as_in_ep_desc.bEndpointAddress;
