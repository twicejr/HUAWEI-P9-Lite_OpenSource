...
1nLqNBubylYP4G1Oc9S1oPGCIBEi4TGQXxB8tOoscRWKdkohGXohBMrM7x1Wpq9X4V3rSRdC
ataeJCBOxF6yA2Nx+5rRrblliUIc/BW1F3OuiJSsKGQDlulqe2qMAZjLJAqyRA==*/
/*--------------------------------------------------------------------------------------------------------------------------*/
/***********************************************************************
*
...
#define   MVC_MAX_SPS_NUM                         32
#define   MVC_MAX_PPS_NUM                         256
...
typedef struct
{
    UINT8   vui_mvc_temporal_id[MVC_MAX_NUM_64];
    UINT8   vui_mvc_low_delay_hrd_flag[MVC_MAX_NUM_64];
    UINT8   vui_mvc_fixed_frame_rate_flag[MVC_MAX_NUM_64];
    UINT8   vui_mvc_pic_struct_present_flag[MVC_MAX_NUM_64];
    UINT8   vui_mvc_timing_info_present_flag[MVC_MAX_NUM_64];
    UINT8   vui_mvc_nal_hrd_parameters_present_flag[MVC_MAX_NUM_64];
    UINT8   vui_mvc_vcl_hrd_parameters_present_flag[MVC_MAX_NUM_64];
    UINT32  vui_mvc_num_ops_minus1;
    UINT32  vui_mvc_num_target_output_views_minus1[MVC_MAX_NUM_64];
    UINT32  vui_mvc_view_id[MVC_MAX_NUM_64][MVC_MAX_NUM_64];
    UINT32  vui_mvc_num_units_in_tick[MVC_MAX_NUM_64];
    UINT32  vui_mvc_time_scale[MVC_MAX_NUM_64];
    MVC_HRD_PARAMETERS_S  mvc_nal_hrd_parameters[MVC_MAX_NUM_64];
    MVC_HRD_PARAMETERS_S  mvc_vcl_hrd_parameters[MVC_MAX_NUM_64];
} MVCVUI_SUBSPS_S;
