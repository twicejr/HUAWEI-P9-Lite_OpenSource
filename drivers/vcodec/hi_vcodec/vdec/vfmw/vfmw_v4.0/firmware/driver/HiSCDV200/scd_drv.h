...
/*######################################################
       MACRO & CONSTANTS
 ######################################################*/
#define REP_SCD_ADDR_BUG               //修改SCD地址问题
...
#define SCD_LOWDLY_BUFFER              (600*1024)   //低延迟所需部分空间在这里一起分配
#else
#define SCD_LOWDLY_BUFFER              (0)
#endif
#ifdef VFMW_AVSPLUS_SUPPORT
#define SCD_AVSPLUS_BUFFER             (20*1024)    //AVS+所需部分空间在这里一起分配
#else
#define SCD_AVSPLUS_BUFFER             (0)
#endif

#define SCD_MSG_BUFFER                 (60*1024 + SCD_AVSPLUS_BUFFER + SCD_LOWDLY_BUFFER)  // SCD基础内存
#endif
...
/************************************************************************
原型  VOID GetFreshSegStream( SEG_ARRAY_S *pSegStreamArray, SINT32 *pFreshNum, SINT32 *pFreshSize)
功能  获取空闲Seg Buffer大小和个数
参数  
返回值  无
************************************************************************/
...
/************************************************************************
原型  SINT32 SM_OpenSCDDrv(SCD_OPEN_PARAM_S *pOpenParam)
功能  打开SCD硬件
参数  
返回值  无
************************************************************************/
...
/************************************************************************
原型  VOID SM_GiveThreadEvent(SINT32 SmID)
功能  SCD工作完成唤醒解码线程
参数  
返回值  无
************************************************************************/
...
/************************************************************************
原型  VOID SCDDRV_ResetSCD(SINT32 ChanID)
功能  检查SCD是否工作在指定通道，如是复位SCD
参数  
返回值  无
************************************************************************/
...
/************************************************************************
  原型  SINT32 WriteScdMsg(SM_PUSHRAW_S *pSmPushRaw, SINT32 *pDownMsgVirAddr, UADDR DownMsgPhyAddr)
    功能  配置Scd下行消息池
    参数  
    返回值
************************************************************************/
...
/************************************************************************
原型  SINT32 ReadRawStreamData(SINT32 InstID, STREAM_DATA_S * pRawPacket)
功能  实际读取码流接口
参数  
返回值  无
************************************************************************/
...
/************************************************************************
原型  SINT32 ReleaseRawStreamData(SINT32 InstID, STREAM_DATA_S * pRawPacket)
功能  实际释放码流接口
参数  
返回值  无
************************************************************************/
...
/************************************************************************
原型  SINT32 SM_AllocDSPCtxMem(SINT32 SmID)
功能  申请SCD DSP通道上下文内存
参数  
返回值  无
************************************************************************/
...
/************************************************************************
原型  VOID SM_DeletDSPCtxMem(MEM_RECORD_S *pstDSPMem)
功能  释放SCD DSP通道上下文内存
参数  
返回值  无
************************************************************************/
...
/************************************************************************
原型  VOID WriteHexFile(SINT32 eVidStd)
功能  载入DSP程序
参数  
返回值  无
************************************************************************/
