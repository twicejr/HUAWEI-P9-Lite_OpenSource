...
#ifndef __VDM_HAL_V400R004_AVS_H__
#define __VDM_HAL_V400R004_AVS_H__
...
typedef struct
{
    ...
    USIGN rsv:                      23;
} AVS_V400R004_DWNMSG_D3;

typedef struct
{
    USIGN bwd_address:              32;
} AVS_V400R004_DWNMSG_D4;

typedef struct
{
    USIGN fwd_address_0:            32;
} AVS_V400R004_DWNMSG_D5;

typedef struct
{
    USIGN fwd_address_1:            32;
} AVS_V400R004_DWNMSG_D6;

typedef struct
{
    USIGN rcn_address:             32;
} AVS_V400R004_DWNMSG_D7;
...
typedef struct
{
    ...
    USIGN rsv1:                     6;
} AVS_V400R004_DWNMSG_D8;

typedef struct
{
    USIGN bit_stream_address_0:     24;
    USIGN rsv:                      8;
} AVS_V400R004_DWNMSG_D9;
...
typedef struct
{
    ...
    USIGN rsv:                      1;
} AVS_V400R004_DWNMSG_D10;

typedef struct
{
    USIGN bit_stream_address_1:     24;
    USIGN rsv:                      8;
} AVS_V400R004_DWNMSG_D11;
...
typedef struct
{
    ...
    UINT32 rsv:                      1;
#endif
} AVS_V400R004_DWNMSG_D12;

typedef struct
{
    USIGN pmv_top_addr:         32;
} AVS_V400R004_DWNMSG_D13;

typedef struct
{
    USIGN topmb_intra_addr:         32;
} AVS_V400R004_DWNMSG_D14;

typedef struct
{
    USIGN  colpic_mv_addr:           32;
} AVS_V400R004_DWNMSG_D16;

typedef struct
{
    USIGN pmv_cfg_table:           32;
} AVS_V400R004_DWNMSG_D17_48;

typedef struct
{
    USIGN  pmv_colmb_addr:           32;
} AVS_V400R004_DWNMSG_D49;
typedef struct
{
    USIGN  dblk_top_addr:         32;
} AVS_V400R004_DWNMSG_D50;
typedef struct
{
    USIGN  sed_top_addr:         32;
} AVS_V400R004_DWNMSG_D51;
