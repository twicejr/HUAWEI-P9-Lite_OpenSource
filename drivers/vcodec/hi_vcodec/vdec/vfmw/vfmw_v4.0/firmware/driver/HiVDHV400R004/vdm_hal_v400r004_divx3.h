...
#ifndef __VDM_HAL_V400R004_DIVX3_HEADER__
#define __VDM_HAL_V400R004_DIVX3_HEADER__
...
typedef struct
{
    USIGN dec_start:                            1;
    USIGN reserved:                             31;
} DIVX3_V400R004_VDH_START;

typedef struct
{
    USIGN repair_start:                         1;
    USIGN reserved:                             31;
} DIVX3_V400R004_VDH_REPAIR;
...
typedef struct
{
    ...
    USIGN compress_en:                          1;
    USIGN ppfd_en:                              1;
} DIVX3_V400R004_BASIC_CFG1;

typedef struct
{
    USIGN av_msg_addr:                          32;
} DIVX3_V400R004_AVM_ADDR;

typedef struct
{
    USIGN va_msg_addr:                          32;
} DIVX3_V400R004_VAM_ADDR;

typedef struct
{
    USIGN stream_base_addr:                     32;
} DIVX3_V400R004_STREAM_BASE_ADDR;
...
} DIVX3_V400R004_REF_PIC_TYPE;

typedef struct
{
    USIGN ff_apt_en:                    1;
    USIGN reserved:                     31;
} DIVX3_V400R004_FF_APT_EN;

typedef struct
{
    USIGN rpr_start:                            1;
    USIGN reserved:                             31;
} DIVX3_V400R004_RPR_START;
...
typedef struct
{
    ...
    USIGN reserved:                             23;
} DIVX3_V400R004_PICDNMSG_D3;


typedef struct
{
    USIGN bit_stream_address_0:                 32;
} DIVX3_V400R004_PICDNMSG_D16;

typedef struct
{
    USIGN bit_offset_0:                         7;
    USIGN reserved:                             25;
} DIVX3_V400R004_PICDNMSG_D17;

typedef struct
{
    USIGN bit_len_0:                            32;
} DIVX3_V400R004_PICDNMSG_D18;

typedef struct
{
    USIGN bit_stream_address_1:                 32;
} DIVX3_V400R004_PICDNMSG_D19;

typedef struct
{
    USIGN bit_offset_1:                         7;
    USIGN reserved:                             25;
} DIVX3_V400R004_PICDNMSG_D20;

typedef struct
{
    USIGN bit_len_1:                            32;
} DIVX3_V400R004_PICDNMSG_D21;
...
} DIVX3_V400R004_PICDNMSG_D32;

typedef struct
{
    USIGN fwd_ref_addr:                         32;
} DIVX3_V400R004_PICDNMSG_D33;

typedef struct
{
    USIGN sed_top_addr:                         32;
} DIVX3_V400R004_PICDNMSG_D34;

typedef struct
{
    USIGN pmv_top_addr:                         32;
} DIVX3_V400R004_PICDNMSG_D35;

typedef struct
{
    USIGN it_top_addr:                          32;
} DIVX3_V400R004_PICDNMSG_D36;

typedef struct
{
    USIGN pmv_colmb_addr:                       32;
} DIVX3_V400R004_PICDNMSG_D37;

typedef struct
{
    USIGN next_slice_para_addr:                 32;
} DIVX3_V400R004_PICDNMSG_D63;
...
typedef struct
{
    ...
    USIGN reserved:                             12;
} DIVX3_V400R004_SLCDNMSG_D0;

typedef struct
{
    USIGN slice_end_mbn:                        20;
    USIGN reserved:                             12;
} DIVX3_V400R004_SLCDNMSG_D1;

typedef struct
{
    USIGN next_slice_para_addr:                 32;
} DIVX3_V400R004_SLCDNMSG_D63;
...
typedef struct
{
    ...
    USIGN reserved:                             1;
    USIGN error_mode:                           11;
} DIVX3_V400R004_UPMSG_D0;

typedef struct
{
    USIGN slice0_start_mb_num:                  20;
    USIGN reserved:                             12;
} DIVX3_V400R004_UPMSG_D1;

typedef struct
{
    USIGN slice0_end_mb_num:                    20;
    USIGN reserved:                             12;
} DIVX3_V400R004_UPMSG_D2;

typedef struct
{
    USIGN reserved:                             32;
} DIVX3_V400R004_UPMSG_D3;

//PIC消息池结构体
typedef struct
{
    DIVX3_V400R004_PICDNMSG_D0  *d0;
    DIVX3_V400R004_PICDNMSG_D1  *d1;
    DIVX3_V400R004_PICDNMSG_D2  *d2;
    DIVX3_V400R004_PICDNMSG_D3  *d3;

    DIVX3_V400R004_PICDNMSG_D16 *d16;
    DIVX3_V400R004_PICDNMSG_D17 *d17;
    DIVX3_V400R004_PICDNMSG_D18 *d18;
    DIVX3_V400R004_PICDNMSG_D19 *d19;
    DIVX3_V400R004_PICDNMSG_D20 *d20;
    DIVX3_V400R004_PICDNMSG_D21 *d21;

    DIVX3_V400R004_PICDNMSG_D32 *d32;
    DIVX3_V400R004_PICDNMSG_D33 *d33;
    DIVX3_V400R004_PICDNMSG_D34 *d34;
    DIVX3_V400R004_PICDNMSG_D35 *d35;
    DIVX3_V400R004_PICDNMSG_D36 *d36;
    DIVX3_V400R004_PICDNMSG_D37 *d37;

    DIVX3_V400R004_PICDNMSG_D63 *d63;
} DIVX3_V400PICDNMSG_S;


//SLICE消息池结构体
typedef struct
{
    DIVX3_V400R004_SLCDNMSG_D0  *d0;
    DIVX3_V400R004_SLCDNMSG_D1  *d1;

    DIVX3_V400R004_SLCDNMSG_D63 *d63;
} DIVX3_V400R004_SLCDNMSG_S;
