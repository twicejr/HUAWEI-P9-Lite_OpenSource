...
/******************************************************************************
  ...
  ******************************************************************************
  文 件 名   : vdm_hal_v400r004_mpeg4.h
  版 本 号   : 初稿
  作    者   :
  生成日期   :
  最近修改   :
...
#ifndef _VDM_HAL_V400R004_MPEG4_HEADER_
#define _VDM_HAL_V400R004_MPEG4_HEADER_
...
typedef struct
{
    ...
    USIGN reserved:                             1;
} MP4SLCDNMSG_V400R004_D0;

typedef struct
{
    USIGN bit_stream_address_0:               24;
    USIGN reserved:                             8;
} MP4SLCDNMSG_V400R004_D1;
...
typedef struct
{
    ...
    USIGN reserved:                             1;
} MP4SLCDNMSG_V400R004_D2;

typedef struct
{
    USIGN bit_stream_address_1:               24;
    USIGN reserved:                             8;
} MP4SLCDNMSG_V400R004_D3;
...
typedef struct
{
    ...
    USIGN reserved:                             16;
} MP4SLCDNMSG_V400R004_D4;

typedef struct
{
    USIGN slice_start_mbn:                     20;
    USIGN reserved:                             12;
} MP4SLCDNMSG_V400R004_D5;

typedef struct
{
    USIGN slice_end_mbn:                       20;
    USIGN reserved:                             12;
} MP4SLCDNMSG_V400R004_D6;

typedef struct
{
    USIGN next_slice_para_addr:               32;
} MP4SLCDNMSG_V400R004_D7;
