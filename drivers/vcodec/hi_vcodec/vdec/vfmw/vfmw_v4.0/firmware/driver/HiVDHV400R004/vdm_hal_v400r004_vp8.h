...
#ifndef __VDM_HAL_V400R004_VP8_HERAER__
#define __VDM_HAL_V400R004_VP8_HERAER__
...
typedef struct
{
    ...
    USIGN reserved:                              7;
} VP8_V400R004_PICDNMSG_D6;

typedef struct
{
    USIGN base_qindex:							 7;
    USIGN reserved:                              25;
} VP8_V400R004_PICDNMSG_D7;


typedef struct
{
    USIGN value:                              	32;
} VP8_V400R004_PICDNMSG_D8;
...
} VP8_V400R004_PICDNMSG_D16;

typedef struct
{
    USIGN bit_stream_addr_0:                   24;
    USIGN reserved:                             8;
} VP8_V400R004_PICDNMSG_D17;

typedef struct
{
    USIGN bit_len_1:                           25;
    USIGN bit_offset_1:                        7;
} VP8_V400R004_PICDNMSG_D18;

typedef struct
{
    USIGN bit_stream_addr_1:                   24;
    USIGN reserved:                             8;
} VP8_V400R004_PICDNMSG_D19;
...
} VP8_V400R004_PICDNMSG_D24;

typedef struct
{
    USIGN curr_rcn_addr:                        32;
} VP8_V400R004_PICDNMSG_D32;

typedef struct
{
    USIGN alt_ref_addr:                         32;
} VP8_V400R004_PICDNMSG_D33;

typedef struct
{
    USIGN golden_ref_addr:                      32;
} VP8_V400R004_PICDNMSG_D34;

typedef struct
{
    USIGN last_ref_addr:                        32;
} VP8_V400R004_PICDNMSG_D35;

typedef struct
{
    USIGN sed_top_addr:                         32;
} VP8_V400R004_PICDNMSG_D36;

typedef struct
{
    USIGN pmv_top_addr:                         32;
} VP8_V400R004_PICDNMSG_D37;

typedef struct
{
    USIGN rcn_top_addr:                         32;
} VP8_V400R004_PICDNMSG_D38;

typedef struct
{
    USIGN tab_addr:                             32;
} VP8_V400R004_PICDNMSG_D39;

typedef struct
{
    USIGN dblk_top_addr:                        32;
} VP8_V400R004_PICDNMSG_D40;


/*typedef struct {
	USIGN dblk_top_addr:                        32;
} VP8_V400R004_PICDNMSG_D59;*/

typedef struct
{
    USIGN bitn_len:                          	25;
    USIGN bitn_offset:                        	7;
} VP8_V400R004_BITSTREAM_LEN_OFFSET;

typedef struct
{
    USIGN bitn_stream_addr:                  	24;
    USIGN reserved:                             8;
} VP8_V400R004_BITSTREAM_ADDR;
