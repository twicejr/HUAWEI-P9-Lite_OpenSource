...
HI_S32 VENC_DRV_EflQueueFrame_OMX( HI_HANDLE EncHandle, venc_user_buf  *pstFrame);
...
HI_S32 VENC_DRV_EflMMapToKernel_OMX(HI_HANDLE EncHandle, HI_MMZ_BUF_S *pMMZbuf);
HI_S32 VENC_DRV_EflUMMapToKernel_OMX(HI_HANDLE EncHandle, HI_MMZ_BUF_S *pMMZbuf);
