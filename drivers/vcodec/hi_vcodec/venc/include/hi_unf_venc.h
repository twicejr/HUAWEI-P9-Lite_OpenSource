...
typedef struct hiUNF_VENC_CHN_ATTR_S
{
	...
	HI_UNF_HEVC_PROFILE_E		enVencHevcProfile;	  /**<H265 Profile of Encoder,it is just valid for H265 Encoder*/ /**<CNcomment: 编码HEVC的档次，只在定义了HEVC协议编码器情况下才有效*/
    ...
    HI_U32                      u32MaxQp;         /**<The maximum quantization parameter,it is just valid for Encoder. It can be set dynamically.*/    /**<CNcomment: 最大量化参数,仅在编码H264协议有效，可动态设置*/
    HI_U32                      u32MinQp;         /**<The minimum quantization parameter,it is just valid for Encoder. It can be set dynamically.*/    /**<CNcomment: 最小量化参数,仅在编码H264协议有效，可动态设置*/
