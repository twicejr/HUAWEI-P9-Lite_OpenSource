 ...
 ******************************************************************************
  文 件 名   : soc_cs_ap_funnel_interface.h
  版 本 号   : 初稿
  作    者   : Excel2Code
  生成日期   : 2015-11-20 13:57:07
  最近修改   :
  功能描述   : 接口头文件
  函数列表   :
  修改历史   :
  1.日    期   : 2015年11月20日
    作    者   : l00352922
    修改内容   : 从《Hi3660V100 SOC寄存器手册_CS_AP_FUNNEL.xml》自动生成
 ...
 ****************************************************************************/
/*****************************************************************************
 结构名    : SOC_CS_AP_FUNNEL_FUNNEL_CTRL_REG_UNION
...
typedef union
{
    ...
    struct
    {
        unsigned int  enable   : 4;  /* bit[0-3]  : bit[0]~bit[3]分别对应port0~port3，即core0~core4。
...
/*****************************************************************************
 结构名    : SOC_CS_AP_FUNNEL_FUNNEL_PRIORITY_CTRL_REG_UNION
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  priport3 : 3;  /* bit[9-11] : 端口3优先级设置，数值越低，优先级越高；当设置值相同时，编号小的端口优先级较高。可能的取值如下：
                                                    b000：优先级0
                                                    b001：优先级1
                                                    b010：优先级2
                                                    b011：优先级3
...
/*****************************************************************************
 结构名    : SOC_CS_AP_FUNNEL_FUNNEL_LAR_UNION
...
/*****************************************************************************
 结构名    : SOC_CS_AP_FUNNEL_FUNNEL_LSR_UNION
 结构说明  : FUNNEL_LSR 寄存器结构定义。地址偏移量:0xFB4，初值:0x00000000，宽度:32
 寄存器说明: Funnel锁定状态寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
