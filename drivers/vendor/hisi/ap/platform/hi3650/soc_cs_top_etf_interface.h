 ...
 ******************************************************************************
  文 件 名   : soc_cs_top_etf_interface.h
  版 本 号   : 初稿
  作    者   : Excel2Code
  生成日期   : 2015-11-20 11:31:07
  最近修改   :
  功能描述   : 接口头文件
  函数列表   :
  修改历史   :
  1.日    期   : 2015年11月20日
    作    者   : l00352922
    修改内容   : 从《Hi3660V100 SOC寄存器手册_CS_TOP_ETF.xml》自动生成
 ...
 ****************************************************************************/
/*****************************************************************************
 结构名    : SOC_CS_TOP_ETF_ETF_RSZ_UNION
 结构说明  : ETF_RSZ 寄存器结构定义。地址偏移量:0x004，初值:0x00000400，宽度:32
 寄存器说明: ETF RAM size寄存器。
*****************************************************************************/
...
typedef union
{
    ...
    struct
    {
        unsigned int  rsz      : 31; /* bit[0-30]: 指示TOP ETF trace buffer的大小为4KB。 */
...
/*****************************************************************************
 结构名    : SOC_CS_TOP_ETF_ETF_STS_UNION
...
/*****************************************************************************
 结构名    : SOC_CS_TOP_ETF_ETF_RRD_UNION
...
/*****************************************************************************
 结构名    : SOC_CS_TOP_ETF_ETF_RRP_UNION
...
/*****************************************************************************
 结构名    : SOC_CS_TOP_ETF_ETF_RWP_UNION
...
/*****************************************************************************
 结构名    : SOC_CS_TOP_ETF_ETF_TRG_UNION
...
/*****************************************************************************
 结构名    : SOC_CS_TOP_ETF_ETF_CTL_UNION
...
/*****************************************************************************
 结构名    : SOC_CS_TOP_ETF_ETF_RWD_UNION
...
/*****************************************************************************
 结构名    : SOC_CS_TOP_ETF_ETF_MODE_UNION
...
/*****************************************************************************
 结构名    : SOC_CS_TOP_ETF_ETF_LBUFLEVEL_UNION
...
/*****************************************************************************
 结构名    : SOC_CS_TOP_ETF_ETF_CBUFLEVEL_UNION
...
/*****************************************************************************
 结构名    : SOC_CS_TOP_ETF_ETF_BUFWM_UNION
...
/*****************************************************************************
 结构名    : SOC_CS_TOP_ETF_ETF_FFSR_UNION
...
/*****************************************************************************
 结构名    : SOC_CS_TOP_ETF_ETF_FFCR_UNION
...
/*****************************************************************************
 结构名    : SOC_CS_TOP_ETF_ETF_FSCR_UNION
...
/*****************************************************************************
 结构名    : SOC_CS_TOP_ETF_ETF_LAR_UNION
...
/*****************************************************************************
 结构名    : SOC_CS_TOP_ETF_ETF_LSR_UNION
...
#endif /* end of soc_cs_top_etf_interface.h */
