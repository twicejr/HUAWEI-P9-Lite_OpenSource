 ...
 ******************************************************************************
  文 件 名   : soc_gic_s_interface.h
  版 本 号   : 初稿
  作    者   : Excel2Code
  生成日期   : 2015-03-11 10:14:01
  最近修改   :
  功能描述   : 接口头文件
  函数列表   :
  修改历史   :
  1.日    期   : 2015年3月11日
    作    者   : w00140341
    修改内容   : 从《Hi3650V100 SOC寄存器手册_GIC_S.xml》自动生成
 ...
 ****************************************************************************/
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_CTLR_S_UNION
 结构说明  : GICD_CTLR_S 寄存器结构定义。地址偏移量:0x1000，初值:0x00000000，宽度:32
 寄存器说明: Distributor的使能控制
*****************************************************************************/
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_TYPER_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_IIDR_UNION
 结构说明  : GICD_IIDR 寄存器结构定义。地址偏移量:0x1008，初值:0x2000043B，宽度:32
 寄存器说明: 分发器集成识别寄存器
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_IGROUPRn_UNION
 结构说明  : GICD_IGROUPRn 寄存器结构定义。地址偏移量:0x1080+(4*(N))，初值:0x00000000，宽度:32
 寄存器说明: 中断分组寄存器
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  version     : 16; /* bit[0-15] : GIC的主版本号 */
        unsigned int  reserved    : 9;  /* bit[16-24]: Since there in no interrupt for
                                                       ID16~ID24, the bit[24:16] should be 
                                                       Write invalid and Read as Zero */
        unsigned int  groupstatus : 7;  /* bit[25-31]: 配置对应中断的分组
                                                       0: 中断配置为Group0
                                                       1: 中断配置为Group1
                                                       地址偏移计算方法：
                                                       -> ID为中断号
                                                       -> 每个寄存器的偏移地址为(0x1080+(4*n))，n为ID/32的整数
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_ISENABLER0_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_ISENABLERN_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_ICENABLER0_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_ICENABLERn_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_ISPENDRN_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_ICPENDRn_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_ISACTIVERn_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_ICACTIVERn_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_IPRIORITYRn_UNION
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  Priority_byte_offset0 : 5;  /* bit[3-7]  : Each priority field holds a priority value. The lower the value, the greater the priority of the corresponding interrupt.
                                                                 The GIC-400 implements 32 priority levels in Secure state and 16 priority levels in 
                                                                 Non-secure state. */
        unsigned int  reserved_1            : 3;  /* bit[8-10] :  */
        unsigned int  Priority_byte_offset1 : 5;  /* bit[11-15]:  */
        unsigned int  reserved_2            : 3;  /* bit[16-18]:  */
        unsigned int  Priority_byte_offset2 : 5;  /* bit[19-23]:  */
        unsigned int  reserved_3            : 3;  /* bit[24-26]:  */
        unsigned int  Priority_byte_offset3 : 5;  /* bit[27-31]:  */
    } reg;
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_ITARGETSR0_7_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_ITARGETSRn_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_ICFGR0_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_ICFGR1_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_ICFGRn_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_PPISR_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_SPISRn_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_CPENDSGIRn_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_SPENDSGIRn_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_PIDR4_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_PIDR5_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_PIDR6_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_PIDR7_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_PIDR0_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_PIDR1_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_PIDR2_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_PIDR3_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_CIDR0_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_CIDR1_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_CIDR2_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICD_CIDR3_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICC_CTLR_S_UNION
 结构说明  : GICC_CTLR_S 寄存器结构定义。地址偏移量:0x2000，初值:0x00000000，宽度:32
 寄存器说明: CPU Interface使能以及顶层控制寄存器。（特别注意：GICC_CTLR是banked。此寄存器是在secure access下的备份。和在non_secure 的备份的位分配不一样）。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  enablegrp0    : 1;  /* bit[0]    : 对Group0的中断而言， 
                                                         0：不使能该中断 
                                                         1：使能该中断 */
        unsigned int  enablegrp1    : 1;  /* bit[1]    : 对Group1的中断而言， 
                                                         0：不使能该中断 
                                                         1：使能该中断 */
        unsigned int  ackctl        : 1;  /* bit[2]    : 推荐接1'b0 */
        unsigned int  fiqen         : 1;  /* bit[3]    : group0的中断： 
                                                         1：以FIQ的形式 
                                                         0：以IRQ的形式送给相应的Cpu_interface。 */
        unsigned int  cbpr          : 1;  /* bit[4]    : 1：GICC_BPR控制group0中断，GICC_ABPR控制group1中断； 
                                                         0：GICC_BPR 控制group0、group1中断  */
        unsigned int  fiqbypdisgrp0 : 1;  /* bit[5]    : 当FIQs不使能时， 
                                                         0：Bypass FIQ被送到处理器核 
                                                         1：Bypass FIQ不被送到处理器核 */
        unsigned int  irqbypdisgrp0 : 1;  /* bit[6]    : 当IRQs不使能时， 
                                                         0：Bypass IRQ被送到处理器核 
                                                         1：Bypass IRQ不被送到处理器核 */
        unsigned int  fiqbypdisgrp1 : 1;  /* bit[7]    : 当FIQs不使能时， 
                                                         0：Bypass FIQ被送到处理器核 
                                                         1：Bypass FIQ不被送到处理器核 */
        unsigned int  irqbypdisgrp1 : 1;  /* bit[8]    : 当IRQs不使能时， 
                                                         0：Bypass IRQ被送到处理器核 
                                                         1：Bypass IRQ不被送到处理器核 */
        unsigned int  eoimodes      : 1;  /* bit[9]    : 当访问为安全访问时： 
                                                         0：访问GICC_EOIR可以完成priority drop和deactive 
                                                         1：访问GICC_EOIR只能完成priority drop，而deactive则通过访问GICC_DIR完成。 */
        unsigned int  eoimodens     : 1;  /* bit[10]   : 当访问为非安全访问时： 
                                                         0：访问GICC_EOIR可以完成priority drop和deactive 
                                                         1：访问GICC_EOIR只能完成priority drop，而deactive则通过访问GICC_DIR完成。 */
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICC_BPR_S_UNION
 结构说明  : GICC_BPR_S 寄存器结构定义。地址偏移量:0x2008，初值:0x00000002，宽度:32
 寄存器说明: CPU接口BPR寄存器
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICC_HPPIR_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICC_ABPR_UNION
 结构说明  : GICC_ABPR 寄存器结构定义。地址偏移量:0x201C，初值:0x00000003，宽度:32
 寄存器说明: CPU接口别名BPR寄存器
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICC_AIAR_UNION
 结构说明  : GICC_AIAR 寄存器结构定义。地址偏移量:0x2020，初值:0x000003FF，宽度:32
 寄存器说明: CPU接口别名中断确认寄存器
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICC_AEOIR_UNION
 结构说明  : GICC_AEOIR 寄存器结构定义。地址偏移量:0x2024，初值:0x00000000，宽度:32
 寄存器说明: CPU接口别名中断结束寄存器
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  EOIINTID : 10; /* bit[0-9]  : 中断号，与GICC_IAR或非安全访问的GICC_IAR一致 */
        unsigned int  CPUID    : 3;  /* bit[10-12]: 对于多核系统中的SGI中断，该域与GICC_AIAR或非安全访问的GICC_IAR一致；对于所有其他中断，该域无效 */
        unsigned int  reserved : 19; /* bit[13-31]: 保留 */
    } reg;
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICC_AHPPIR_UNION
 结构说明  : GICC_AHPPIR 寄存器结构定义。地址偏移量:0x2028，初值:0x000003FF，宽度:32
 寄存器说明: CPU接口别名最高优先级pending中断寄存器
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICH_EISR0_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICH_ELSR0_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICV_HPPIR_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICV_AEOIR_UNION
...
/*****************************************************************************
 结构名    : SOC_GIC_S_GICV_AHPPIR_UNION
...
#endif /* end of soc_gic_s_interface.h */
