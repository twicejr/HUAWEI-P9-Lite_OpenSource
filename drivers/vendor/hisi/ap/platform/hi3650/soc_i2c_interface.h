 ...
 ******************************************************************************
  文 件 名   : soc_i2c_interface.h
  版 本 号   : 初稿
  作    者   : Excel2Code
  生成日期   : 2015-03-10 11:21:01
  最近修改   :
  功能描述   : 接口头文件
  函数列表   :
  修改历史   :
  1.日    期   : 2015年3月10日
    作    者   : fWX220878
    修改内容   : 从《Hi3650V100 SOC寄存器手册_I2C.xml》自动生成
...
/* 寄存器说明：I2C硬件状态寄存器，反映i2c当IC_ENABLE[0]从1到0跳变时的状态。当IC_ENABLE[0]为1时，IC_ENABLE_STATUS[2:1]为0，IC_ENABLE_STATUS[0]为1。.
   ...
   位域定义UNION结构:  SOC_I2C_IC_ENABLE_STATUS_UNION */
...
/* 寄存器说明：在Fast Speed模式下，可过滤毛刺长度配置寄存器，在I2C设备未使能时（IC_ENABLE bit[0]为0），才可配置此寄存器。
   位域定义UNION结构:  SOC_I2C_IC_FS_SPKLEN_UNION */
...
/* 寄存器说明：在High Speed模式下，可过滤毛刺长度配置寄存器，在I2C设备未使能时（IC_ENABLE bit[0]为0），才可配置此寄存器。
   位域定义UNION结构:  SOC_I2C_IC_HS_SPKLEN_UNION */
#define SOC_I2C_IC_HS_SPKLEN_ADDR(base)               ((base) + (0x00A4))

/* 寄存器说明：器件参数寄存器
   位域定义UNION结构:  SOC_I2C_IC_COMP_PARAM_1_UNION */
#define SOC_I2C_IC_COMP_PARAM_1_ADDR(base)            ((base) + (0x00F4))

/* 寄存器说明：器件版本寄存器
   位域定义UNION结构:  SOC_I2C_IC_COMP_VERSION_UNION */
#define SOC_I2C_IC_COMP_VERSION_ADDR(base)            ((base) + (0x00F8))

/* 寄存器说明：器件编号寄存器
   位域定义UNION结构:  SOC_I2C_IC_COMP_TYPE_UNION */
...
/*****************************************************************************
 结构名    : SOC_I2C_IC_SS_SCL_HCNT_UNION
...
/*****************************************************************************
 结构名    : SOC_I2C_IC_SS_SCL_LCNT_UNION
...
/*****************************************************************************
 结构名    : SOC_I2C_IC_FS_SCL_HCNT_UNION
...
/*****************************************************************************
 结构名    : SOC_I2C_IC_FS_SCL_LCNT_UNION
...
/*****************************************************************************
 结构名    : SOC_I2C_IC_HS_SCL_HCNT_UNION
...
/*****************************************************************************
 结构名    : SOC_I2C_IC_HS_SCL_LCNT_UNION
...
/*****************************************************************************
 结构名    : SOC_I2C_IC_INTR_STAT_UNION
...
/*****************************************************************************
 结构名    : SOC_I2C_IC_INTR_MASK_UNION
...
/*****************************************************************************
 结构名    : SOC_I2C_IC_RAW_INTR_STAT_UNION
...
/*****************************************************************************
 结构名    : SOC_I2C_IC_CLR_RX_UNDER_UNION
...
/*****************************************************************************
 结构名    : SOC_I2C_IC_CLR_RX_OVER_UNION
...
/*****************************************************************************
 结构名    : SOC_I2C_IC_CLR_TX_OVER_UNION
...
/*****************************************************************************
 结构名    : SOC_I2C_IC_CLR_TX_ABRT_UNION
...
/*****************************************************************************
 结构名    : SOC_I2C_IC_CLR_ACTIVITY_UNION
...
/*****************************************************************************
 结构名    : SOC_I2C_IC_CLR_STOP_DET_UNION
...
/*****************************************************************************
 结构名    : SOC_I2C_IC_CLR_SART_DET_UNION
...
/*****************************************************************************
 结构名    : SOC_I2C_IC_CLR_GEN_CALL_UNION
...
/*****************************************************************************
 结构名    : SOC_I2C_IC_TX_ABRT_SOURCE_UNION
...
/*****************************************************************************
 结构名    : SOC_I2C_IC_SDA_SETUP_UNION
...
/*****************************************************************************
 结构名    : SOC_I2C_IC_ACK_GENERAL_CALL_UNION
...
/*****************************************************************************
 结构名    : SOC_I2C_IC_ENABLE_STATUS_UNION
...
/*****************************************************************************
 结构名    : SOC_I2C_IC_FS_SPKLEN_UNION
...
/*****************************************************************************
 结构名    : SOC_I2C_IC_HS_SPKLEN_UNION
...
/*****************************************************************************
 结构名    : SOC_I2C_IC_COMP_PARAM_1_UNION
 结构说明  : IC_COMP_PARAM_1 寄存器结构定义。地址偏移量:0x00F4，初值:0x000808EE，宽度:32
 寄存器说明: 器件参数寄存器
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_I2C_IC_COMP_VERSION_UNION
...
/*****************************************************************************
 结构名    : SOC_I2C_IC_COMP_TYPE_UNION
