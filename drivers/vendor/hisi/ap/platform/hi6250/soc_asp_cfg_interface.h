...
/* 寄存器说明：语音唤醒中断使能寄存器
   位域定义UNION结构:  SOC_ASP_CFG_R_VOICE_WAKEUP_INTR_EN_UNION */
#define SOC_ASP_CFG_R_VOICE_WAKEUP_INTR_EN_ADDR(base) ((base) + (0x01D4))

/* 寄存器说明：codec选择寄存器
   位域定义UNION结构:  SOC_ASP_CFG_R_CODEC_SEL_EN_UNION */
#define SOC_ASP_CFG_R_CODEC_SEL_EN_ADDR(base)         ((base) + (0x01E0))
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  rst_dmac_n          : 1;  /* bit[8]    : asp_dmac模块软复位使能：
                                                               0：软复位使能状态不变；
                                                               1：软复位使能。 */
        unsigned int  preset_codec_n      : 1;  /* bit[9]    : codec的apb总线模块软复位使能：
                                                               0：软复位使能状态不变；
                                                               1：软复位使能。 */
        unsigned int  rst_codec_n         : 1;  /* bit[10]   : codec模块软复位使能：
                                                               0：软复位使能状态不变；
                                                               1：软复位使能。 */
...
#define SOC_ASP_CFG_R_RST_CTRLEN_preset_codec_n_START       (9)
#define SOC_ASP_CFG_R_RST_CTRLEN_preset_codec_n_END         (9)
#define SOC_ASP_CFG_R_RST_CTRLEN_rst_codec_n_START          (10)
#define SOC_ASP_CFG_R_RST_CTRLEN_rst_codec_n_END            (10)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  rst_dmac_n          : 1;  /* bit[8]    : asp_dmac模块软复位撤离：
                                                               0：软复位使能状态不变；
                                                               1：软复位撤离。 */
        unsigned int  preset_codec_n      : 1;  /* bit[9]    : codec模块软复位撤离：
                                                               0：软复位使能状态不变；
                                                               1：软复位撤离。 */
        unsigned int  rst_codec_n         : 1;  /* bit[10]   : codec模块软复位撤离：
                                                               0：软复位使能状态不变；
                                                               1：软复位撤离。 */
...
#define SOC_ASP_CFG_R_RST_CTRLDIS_preset_codec_n_START       (9)
#define SOC_ASP_CFG_R_RST_CTRLDIS_preset_codec_n_END         (9)
#define SOC_ASP_CFG_R_RST_CTRLDIS_rst_codec_n_START          (10)
#define SOC_ASP_CFG_R_RST_CTRLDIS_rst_codec_n_END            (10)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  rst_dmac_n          : 1;  /* bit[8]    : asp_dmac模块软复位使能状态：
                                                               0：软复位使能撤销；
                                                               1：软复位使能。 */
        unsigned int  preset_codec_n      : 1;  /* bit[9]    : codec模块apb总线软复位使能状态：
                                                               0：软复位使能撤销；
                                                               1：软复位使能。 */
        unsigned int  rst_codec_n         : 1;  /* bit[10]   : codec模块软复位使能状态：
                                                               0：软复位使能撤销；
                                                               1：软复位使能。 */
...
#define SOC_ASP_CFG_R_RST_CTRLSTAT_preset_codec_n_START       (9)
#define SOC_ASP_CFG_R_RST_CTRLSTAT_preset_codec_n_END         (9)
#define SOC_ASP_CFG_R_RST_CTRLSTAT_rst_codec_n_START          (10)
#define SOC_ASP_CFG_R_RST_CTRLSTAT_rst_codec_n_END            (10)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  gt_dmachclk          : 1;  /* bit[11]   : asp_dmac时钟使能控制：
                                                                0：写0无效果；
                                                                1：使能IP时钟。 */
        unsigned int  gt_pclk_codec        : 1;  /* bit[12]   : codec的apb总线时钟使能控制：
                                                                0：写0无效果；
                                                                1：使能IP时钟。 */
        unsigned int  gt_codec_sysclk      : 1;  /* bit[13]   : codec时钟使能控制：
                                                                0：写0无效果；
                                                                1：使能IP时钟。 */
        ...
        unsigned int  gt_slimbus_base_clk  : 1;  /* bit[17]   : slimbus base clk时钟使能控制：
                                                                0：写0无效果；
                                                                1：使能IP时钟。 */
        unsigned int  reserved_3           : 1;  /* bit[18]   : 保留 */
        unsigned int  reserved_4           : 1;  /* bit[19]   : 保留 */
        unsigned int  reserved_5           : 1;  /* bit[20]   : 保留 */
...
#define SOC_ASP_CFG_R_GATE_EN_gt_pclk_codec_START         (12)
#define SOC_ASP_CFG_R_GATE_EN_gt_pclk_codec_END           (12)
#define SOC_ASP_CFG_R_GATE_EN_gt_codec_sysclk_START       (13)
#define SOC_ASP_CFG_R_GATE_EN_gt_codec_sysclk_END         (13)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  gt_dmachclk          : 1;  /* bit[11]   : asp_dmac时钟禁止控制：
                                                                0：写0无效果；
                                                                1：禁止IP时钟。 */
        unsigned int  gt_pclk_codec        : 1;  /* bit[12]   : codec的apb总线时钟禁止控制：
                                                                0：写0无效果；
                                                                1：禁止IP时钟。 */
        unsigned int  gt_codec_sysclk      : 1;  /* bit[13]   : codec时钟禁止控制：
                                                                0：写0无效果；
                                                                1：禁止IP时钟。 */
...
#define SOC_ASP_CFG_R_GATE_DIS_gt_pclk_codec_START         (12)
#define SOC_ASP_CFG_R_GATE_DIS_gt_pclk_codec_END           (12)
#define SOC_ASP_CFG_R_GATE_DIS_gt_codec_sysclk_START       (13)
#define SOC_ASP_CFG_R_GATE_DIS_gt_codec_sysclk_END         (13)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  gt_dmachclk          : 1;  /* bit[11]   : asp_dmac时钟使能状态：
                                                                0：IP时钟使能撤销状态；
                                                                1：IP时钟使能状态。 */
        unsigned int  gt_pclk_codec        : 1;  /* bit[12]   : codec apb总线时钟使能状态：
                                                                0：IP时钟使能撤销状态；
                                                                1：IP时钟使能状态。 */
        unsigned int  gt_codec_sysclk      : 1;  /* bit[13]   : codec时钟使能状态：
                                                                0：IP时钟使能撤销状态；
                                                                1：IP时钟使能状态。 */
...
#define SOC_ASP_CFG_R_GATE_CLKEN_gt_pclk_codec_START         (12)
#define SOC_ASP_CFG_R_GATE_CLKEN_gt_pclk_codec_END           (12)
#define SOC_ASP_CFG_R_GATE_CLKEN_gt_codec_sysclk_START       (13)
#define SOC_ASP_CFG_R_GATE_CLKEN_gt_codec_sysclk_END         (13)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  st_dmachclk1        : 1;  /* bit[12]: asp_dmac hclk1时钟最终状态：
                                                            0：IP时钟禁止状态；
                                                            1：IP时钟使能状态。 */
        unsigned int  st_pclk_codec       : 1;  /* bit[13]: codec时钟最终状态：
                                                            0：IP时钟禁止状态；
                                                            1：IP时钟使能状态。 */
        unsigned int  st_codec_sysclk     : 1;  /* bit[14]: codec时钟最终状态：
                                                            0：IP时钟禁止状态；
                                                            1：IP时钟使能状态。 */
        ...
        unsigned int  reserved_4          : 1;  /* bit[20]: 保留 */
        unsigned int  reserved_5          : 1;  /* bit[21]: 保留 */
        ...
        unsigned int  st_bthclk           : 1;  /* bit[25]: sio_bt hclk时钟最终状态：
                                                            0：IP时钟禁止状态；
                                                            1：IP时钟使能状态。 */
        unsigned int  reserved_6          : 1;  /* bit[26]: 保留 */
        ...
        unsigned int  st_timer1hclk       : 1;  /* bit[29]: timer1时钟最终状态：
                                                            0：IP时钟禁止状态；
                                                            1：IP时钟使能状态。 */
        unsigned int  reserved_7          : 1;  /* bit[30]: 保留 */
        unsigned int  reserved_8          : 1;  /* bit[31]: 整个寄存器的复位值由asp_cfg的输入时钟最终状态信号的复位值来定。 */
    } reg;
...
#define SOC_ASP_CFG_R_GATE_CLKSTAT_st_pclk_codec_START        (13)
#define SOC_ASP_CFG_R_GATE_CLKSTAT_st_pclk_codec_END          (13)
#define SOC_ASP_CFG_R_GATE_CLKSTAT_st_codec_sysclk_START      (14)
#define SOC_ASP_CFG_R_GATE_CLKSTAT_st_codec_sysclk_END        (14)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_3            : 23; /* bit[9-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  reserved_0: 27; /* bit[0-26] : 保留 */
...
/*****************************************************************************
 ...
 结构说明  : R_CLK_SEL 寄存器结构定义。地址偏移量:0x0038，初值:0x00000007，宽度:32
 寄存器说明: 时钟选择寄存器
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  sio_bt_slave_en      : 1;  /* bit[2]    : sio bt的master或slave模式选择寄存器：
                                                                ...
                                                                0：输出模式；
                                                                1：输入模式。 */
        unsigned int  asp_modemclk_sel     : 1;  /* bit[3]    : codec主时钟选择，默认选择modem bbe16的时钟：
                                                                0：时钟源选择bbe16的49.152M时钟
                                                                1：时钟源选择cbbe16的49.152M时钟 */
        ...
        unsigned int  timer1_2_clken_sel   : 1;  /* bit[11]   : timer1_2的时钟使能信号频率选择寄存器：
                                                                0：32kHz；
                                                                1：4.8MHZ。 */
        unsigned int  freq_tcxo_sel        : 1;  /* bit[12]   : 频偏模块的输入晶振时钟选择：
                                                                0：时钟源选择晶振19.2M时钟
                                                                1：时钟源选择cbbe16的49.152M时钟 */
        unsigned int  freq_modem_sel       : 1;  /* bit[13]   : 频偏模块的输入modem时钟选择：
                                                                0：时钟源选择bbe16的49.152M时钟
                                                                1：时钟源选择cbbe16的49.152M时钟 */
...
#define SOC_ASP_CFG_R_CLK_SEL_asp_modemclk_sel_START      (3)
#define SOC_ASP_CFG_R_CLK_SEL_asp_modemclk_sel_END        (3)
...
#define SOC_ASP_CFG_R_CLK_SEL_freq_tcxo_sel_START         (12)
#define SOC_ASP_CFG_R_CLK_SEL_freq_tcxo_sel_END           (12)
#define SOC_ASP_CFG_R_CLK_SEL_freq_modem_sel_START        (13)
#define SOC_ASP_CFG_R_CLK_SEL_freq_modem_sel_END          (13)
...
typedef union
{
    ...
    struct
    {
        unsigned int  slp      : 2;  /* bit[0-1]  : OCRAM每片RAM通过3个信号（SD、DSLP、SLP）控制其功耗模式。
        ...
        unsigned int  dslp     : 2;  /* bit[4-5]  : OCRAM每片RAM通过3个信号（SD、DSLP、SLP）控制其功耗模式。
                                                    默认为Normal Mode(SD=0，DSLP=0，SLP=0)
                                                    如果某片RAM在不需要使用的时候，可以通过软件配置按照模式切换时序进入Power Down模式(SD=1，DSLP=0，SLP=0)，以节省功耗。
        ...
        unsigned int  sd       : 2;  /* bit[8-9]  : OCRAM每片RAM通过3个信号（SD、DSLP、SLP）控制其功耗模式。
                                                    默认为Normal Mode(SD=0，DSLP=0，SLP=0)
                                                    如果某片RAM在不需要使用的时候，可以通过软件配置按照模式切换时序进入Power Down模式(SD=1，DSLP=0，SLP=0)，以节省功耗。
...
#define SOC_ASP_CFG_R_OCRAM_RET_slp_END         (1)
#define SOC_ASP_CFG_R_OCRAM_RET_dslp_START      (4)
#define SOC_ASP_CFG_R_OCRAM_RET_dslp_END        (5)
#define SOC_ASP_CFG_R_OCRAM_RET_sd_START        (8)
#define SOC_ASP_CFG_R_OCRAM_RET_sd_END          (9)
...
typedef union
{
    ...
    struct
    {
        unsigned int  codec_intr   : 1;  /* bit[0]   : codec原始非安全中断。
                                                       0：无中断；
                                                       1：有中断。 */
...
#endif
#define SOC_ASP_CFG_R_INTR_NS_INI_codec_intr_START    (0)
#define SOC_ASP_CFG_R_INTR_NS_INI_codec_intr_END      (0)
...
typedef union
{
    ...
    struct
    {
        unsigned int  codec_intr_en   : 1;  /* bit[0]   : codec非安全中断使能。
                                                          0：不使能；
                                                          1：使能。 */
...
#endif
#define SOC_ASP_CFG_R_INTR_NS_EN_codec_intr_en_START    (0)
#define SOC_ASP_CFG_R_INTR_NS_EN_codec_intr_en_END      (0)
...
typedef union
{
    ...
    struct
    {
        unsigned int  codec_intr_mask   : 1;  /* bit[0]   : codec屏蔽后非安全中断。
                                                            0：无中断；
                                                            1：有中断。 */
        unsigned int  reserved_0        : 1;  /* bit[1]   :  */
        unsigned int  reserved_1        : 1;  /* bit[2]   :  */
...
#endif
#define SOC_ASP_CFG_R_INTR_NS_MASK_codec_intr_mask_START    (0)
#define SOC_ASP_CFG_R_INTR_NS_MASK_codec_intr_mask_END      (0)
...
typedef union
{
    ...
    struct
    {
        unsigned int  dlock_bp_codec    : 1;  /* bit[0]    : codec防挂死bypass寄存器：
                                                             0：防挂死功能生效；
                                                             1：防挂死功能被bypass。 */
        unsigned int  reserved_0        : 1;  /* bit[1]    :  */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  mdm_hifi_harq_intr_2ff : 1;  /* bit[12]   : modem给hifi的harq中断 */
        unsigned int  codec_intr             : 1;  /* bit[13]   : codec模块给hifi的中断 */
...
#define SOC_ASP_CFG_R_DSP_BINTERRUPT_mdm_hifi_harq_intr_2ff_START  (12)
#define SOC_ASP_CFG_R_DSP_BINTERRUPT_mdm_hifi_harq_intr_2ff_END    (12)
#define SOC_ASP_CFG_R_DSP_BINTERRUPT_codec_intr_START              (13)
#define SOC_ASP_CFG_R_DSP_BINTERRUPT_codec_intr_END                (13)
...
typedef union
{
    ...
    struct
    {
        unsigned int  tz_secure_codec_n    : 1;  /* bit[0]    : asp codec模块的安全属性；
                                                                0：asp codec只能被安全配置；
                                                                1：asp codec可以被非安全配置；
                                                                此寄存器只有安全可 */
        unsigned int  reserved_0           : 1;  /* bit[1]    : 保留。 */
...
typedef union
{
    ...
    struct
    {
        unsigned int  remap_length : 9;  /* bit[0-8]  : DDR与Harq Memory remap地址范围配置，地址范围为4kB * （remap_length+1）
                                                        此寄存器安全属性可配； */
...
typedef union
{
    ...
    struct
    {
        unsigned int  remap_length : 9;  /* bit[0-8]  : DDR与MMBUF remap地址范围配置，地址范围为4kB * （remap_length+1）
                                                        此寄存器安全属性可配； */
...
typedef union
{
    ...
    struct
    {
        unsigned int  remap_length : 9;  /* bit[0-8]  : DDR与OCRAM remap地址范围配置，地址范围为4kB * （remap_length+1）
                                                        此寄存器安全属性可配； */
...
typedef union
{
    ...
    {
        unsigned int  reserved          : 12; /* bit[0-11] : 保留 */
        unsigned int  addr_monitor0_len : 20; /* bit[12-31]: 内存监控模块0地址长度：实际为：4kB * （base_len+1） */
    } reg;
...
typedef union
{
    ...
    {
        unsigned int  reserved          : 12; /* bit[0-11] : 保留 */
        unsigned int  addr_monitor1_len : 20; /* bit[12-31]: 内存监控模块1地址长度：实际为：4kB * （base_len+1） */
    } reg;
...
typedef union
{
    ...
    {
        unsigned int  reserved          : 12; /* bit[0-11] : 保留 */
        unsigned int  addr_monitor2_len : 20; /* bit[12-31]: 内存监控模块2地址长度：实际为：4kB * （base_len+1） */
    } reg;
...
typedef union
{
    ...
    {
        unsigned int  reserved          : 12; /* bit[0-11] : 保留 */
        unsigned int  addr_monitor3_len : 20; /* bit[12-31]: 内存监控模块3地址长度：实际为：4kB * （base_len+1） */
    } reg;
...
/*****************************************************************************
 结构名    : SOC_ASP_CFG_R_VOICE_WAKEUP_INTR_EN_UNION
 结构说明  : R_VOICE_WAKEUP_INTR_EN 寄存器结构定义。地址偏移量:0x01D4，初值:0x00000000，宽度:32
 寄存器说明: 语音唤醒中断使能寄存器
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  voice_wakeup_intr_en : 1;  /* bit[0]   : 语音唤醒中断屏蔽功能，默认语音唤醒中断屏蔽
                                                               1'b0:语音唤醒中断不使能
                                                               1'b1:语音唤醒中断使能 */
        unsigned int  reserved             : 31; /* bit[1-31]: 保留 */
    } reg;
} SOC_ASP_CFG_R_VOICE_WAKEUP_INTR_EN_UNION;
#endif
#define SOC_ASP_CFG_R_VOICE_WAKEUP_INTR_EN_voice_wakeup_intr_en_START  (0)
#define SOC_ASP_CFG_R_VOICE_WAKEUP_INTR_EN_voice_wakeup_intr_en_END    (0)


/*****************************************************************************
 结构名    : SOC_ASP_CFG_R_CODEC_SEL_EN_UNION
 结构说明  : R_CODEC_SEL_EN 寄存器结构定义。地址偏移量:0x01E0，初值:0x00000000，宽度:32
 寄存器说明: codec选择寄存器
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  codec_dma_sel : 1;  /* bit[0]   : codec dma 请求选择控制，默认选择asp的sio的dma请求
                                                        1'b0:dma选择响应asp的sio的dma请求
                                                        1'b1:dma选择响应codec的sio的dma请求 */
        unsigned int  codec_i2s_sel : 1;  /* bit[1]   : codec i2s选择控制，默认选择asp的i2s通路
                                                        1'b0:选择asp的sio的i2s的通路使能
                                                        1'b1:选择codec的sio的i2s通路使能 */
        unsigned int  reserved      : 30; /* bit[2-31]: 保留 */
    } reg;
} SOC_ASP_CFG_R_CODEC_SEL_EN_UNION;
#endif
#define SOC_ASP_CFG_R_CODEC_SEL_EN_codec_dma_sel_START  (0)
#define SOC_ASP_CFG_R_CODEC_SEL_EN_codec_dma_sel_END    (0)
#define SOC_ASP_CFG_R_CODEC_SEL_EN_codec_i2s_sel_START  (1)
#define SOC_ASP_CFG_R_CODEC_SEL_EN_codec_i2s_sel_END    (1)
