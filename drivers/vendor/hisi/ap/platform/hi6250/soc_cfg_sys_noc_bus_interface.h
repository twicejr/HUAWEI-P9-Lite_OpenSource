...
/* 寄存器说明：MODEM Transaction Probe的bin_1配置。
...
/* 寄存器说明：MODEM Transaction Probe的bin_2配置。
   位域定义UNION结构:  SOC_CFG_SYS_NOC_BUS_MODEM_TRANS_P_THRESHOLDS_0_2_UNION */
#define SOC_CFG_SYS_NOC_BUS_MODEM_TRANS_P_THRESHOLDS_0_2_ADDR(base) ((base) + (0x80B4))

/* 寄存器说明：MODEM Transaction Probe的bin_3配置。
   位域定义UNION结构:  SOC_CFG_SYS_NOC_BUS_MODEM_TRANS_P_THRESHOLDS_0_3_UNION */
...
/* 寄存器说明：ASP Transaction Probe的bin_2配置。
...
/* 寄存器说明：ASP Transaction Probe的bin_3配置。
 ...
 ****************************************************************************/
/* 寄存器说明：
   位域定义UNION结构:  SOC_CFG_SYS_NOC_BUS_USB2_QOS_ID_COREID_UNION */
#define SOC_CFG_SYS_NOC_BUS_USB2_QOS_ID_COREID_ADDR(base) ((base) + (0x0000))

/* 寄存器说明：
   位域定义UNION结构:  SOC_CFG_SYS_NOC_BUS_USB2_QOS_ID_REVISIONID_UNION */
#define SOC_CFG_SYS_NOC_BUS_USB2_QOS_ID_REVISIONID_ADDR(base) ((base) + (0x0004))

/* 寄存器说明：
   位域定义UNION结构:  SOC_CFG_SYS_NOC_BUS_USB2_QOS_PRIORITY_UNION */
#define SOC_CFG_SYS_NOC_BUS_USB2_QOS_PRIORITY_ADDR(base) ((base) + (0x0008))

/* 寄存器说明：
   位域定义UNION结构:  SOC_CFG_SYS_NOC_BUS_USB2_QOS_MODE_UNION */
#define SOC_CFG_SYS_NOC_BUS_USB2_QOS_MODE_ADDR(base)  ((base) + (0x000C))

/* 寄存器说明：
   位域定义UNION结构:  SOC_CFG_SYS_NOC_BUS_USB2_QOS_BANDWIDTH_UNION */
#define SOC_CFG_SYS_NOC_BUS_USB2_QOS_BANDWIDTH_ADDR(base) ((base) + (0x0010))

/* 寄存器说明：
   位域定义UNION结构:  SOC_CFG_SYS_NOC_BUS_USB2_QOS_SATURATION_UNION */
#define SOC_CFG_SYS_NOC_BUS_USB2_QOS_SATURATION_ADDR(base) ((base) + (0x0014))

/* 寄存器说明：
   位域定义UNION结构:  SOC_CFG_SYS_NOC_BUS_USB2_QOS_EXTCONTROL_UNION */
#define SOC_CFG_SYS_NOC_BUS_USB2_QOS_EXTCONTROL_ADDR(base) ((base) + (0x0018))
...
/* 寄存器说明：
   位域定义UNION结构:  SOC_CFG_SYS_NOC_BUS_IPF_QOS_ID_COREID_UNION */
#define SOC_CFG_SYS_NOC_BUS_IPF_QOS_ID_COREID_ADDR(base) ((base) + (0x0300))

/* 寄存器说明：
   位域定义UNION结构:  SOC_CFG_SYS_NOC_BUS_IPF_QOS_ID_REVISIONID_UNION */
#define SOC_CFG_SYS_NOC_BUS_IPF_QOS_ID_REVISIONID_ADDR(base) ((base) + (0x0304))

/* 寄存器说明：
   位域定义UNION结构:  SOC_CFG_SYS_NOC_BUS_IPF_QOS_PRIORITY_UNION */
#define SOC_CFG_SYS_NOC_BUS_IPF_QOS_PRIORITY_ADDR(base) ((base) + (0x0308))

/* 寄存器说明：
   位域定义UNION结构:  SOC_CFG_SYS_NOC_BUS_IPF_QOS_MODE_UNION */
#define SOC_CFG_SYS_NOC_BUS_IPF_QOS_MODE_ADDR(base)   ((base) + (0x030C))

/* 寄存器说明：
   位域定义UNION结构:  SOC_CFG_SYS_NOC_BUS_IPF_QOS_EXTCONTROL_UNION */
 ...
 ****************************************************************************/
/* 寄存器说明：
   位域定义UNION结构:  SOC_CFG_SYS_NOC_BUS_EMMC_QOS_ID_COREID_UNION */
#define SOC_CFG_SYS_NOC_BUS_EMMC_QOS_ID_COREID_ADDR(base) ((base) + (0x0000))

/* 寄存器说明：
   位域定义UNION结构:  SOC_CFG_SYS_NOC_BUS_EMMC_QOS_ID_REVISIONID_UNION */
#define SOC_CFG_SYS_NOC_BUS_EMMC_QOS_ID_REVISIONID_ADDR(base) ((base) + (0x0004))

/* 寄存器说明：
   位域定义UNION结构:  SOC_CFG_SYS_NOC_BUS_EMMC_QOS_PRIORITY_UNION */
#define SOC_CFG_SYS_NOC_BUS_EMMC_QOS_PRIORITY_ADDR(base) ((base) + (0x0008))

/* 寄存器说明：
   位域定义UNION结构:  SOC_CFG_SYS_NOC_BUS_EMMC_QOS_MODE_UNION */
#define SOC_CFG_SYS_NOC_BUS_EMMC_QOS_MODE_ADDR(base)  ((base) + (0x000C))

/* 寄存器说明：
   位域定义UNION结构:  SOC_CFG_SYS_NOC_BUS_EMMC_QOS_EXTCONTROL_UNION */
#define SOC_CFG_SYS_NOC_BUS_EMMC_QOS_EXTCONTROL_ADDR(base) ((base) + (0x0018))
...
/*****************************************************************************
 ...
 结构说明  : DJTAG_QOS_ID_COREID 寄存器结构定义。地址偏移量:0x0000，初值:0x262C4804，宽度:32
 寄存器说明: 
*****************************************************************************/
...
/*****************************************************************************
 ...
 结构说明  : DJTAG_QOS_PRIORITY 寄存器结构定义。地址偏移量:0x0008，初值:0x20000000，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : A7TOCFG_QOS_ID_COREID 寄存器结构定义。地址偏移量:0x0080，初值:0x006C8604，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : A7TOCFG_QOS_PRIORITY 寄存器结构定义。地址偏移量:0x0088，初值:0x20000000，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : LPMCU_QOS_ID_COREID 寄存器结构定义。地址偏移量:0x0100，初值:0x8A1C9E04，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : LPMCU_QOS_PRIORITY 寄存器结构定义。地址偏移量:0x0108，初值:0x20000000，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : CFGBUS_ERR_ID_COREID 寄存器结构定义。地址偏移量:0x1C00，初值:0x17BDAF0D，宽度:32
 寄存器说明: CFG_BUS Err probe域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
typedef union
{
    ...
    struct
    {
        unsigned int  errlog1 : 32; /* bit[0-31]: 保留。
                                                  RouteId：路由信息，各bit含义如下
                                                  [20:16]-->Initiator Flow ID，用于表示发起访问的master；
                                                  [15:11]-->target Flow ID，用于表示被访问的slave；
                                                  [10：9]-->targ Subrange 
...
#define SOC_CFG_SYS_NOC_BUS_CFGBUS_ERRLOG1_errlog1_END    (31)
...
/*****************************************************************************
 ...
 结构说明  : MODEM_QOS_ID_COREID 寄存器结构定义。地址偏移量:0x0000，初值:0x46711C04，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : MODEM_QOS_PRIORITY 寄存器结构定义。地址偏移量:0x0008，初值:0x20000000，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : MODEMBUS_ERR_ID_COREID 寄存器结构定义。地址偏移量:0x1C00，初值:0x17BDAF0D，宽度:32
 寄存器说明: MODEMBUS Err probe域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
#define SOC_CFG_SYS_NOC_BUS_MODEMBUS_ERRLOG1_errlog1_END    (31)
...
/*****************************************************************************
 ...
 结构说明  : MODEM_TRANS_F_ID_COREID 寄存器结构定义。地址偏移量:0x8000，初值:0x721CFE09，宽度:32
 寄存器说明: MODEM TransactionStatFilter域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
typedef union
{
    ...
    struct
    {
        unsigned int  thresholds_0_0 : 2;  /* bit[0-1] : 0x0-->选择threshold_0（delay：64；outstanding：2）；
                                                         0x1-->选择threshold_1（delay：128；outstanding：4）；
                                                         0x2-->选择threshold_2（delay：256；outstanding：6）；
                                                         0x3-->选择threshold_3（delay：1023；outstanding：10）；。 */
        unsigned int  reserved       : 30; /* bit[2-31]: 保留 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  thresholds_0_1 : 2;  /* bit[0-1] : 0x0-->选择threshold_0（delay：64；outstanding：2）；
                                                         0x1-->选择threshold_1（delay：128；outstanding：4）；
                                                         0x2-->选择threshold_2（delay：256；outstanding：6）；
                                                         0x3-->选择threshold_3（delay：1023；outstanding：10）；。 */
        unsigned int  reserved       : 30; /* bit[2-31]: 保留 */
...
/*****************************************************************************
 结构名    : SOC_CFG_SYS_NOC_BUS_MODEM_TRANS_P_THRESHOLDS_0_2_UNION
 结构说明  : MODEM_TRANS_P_THRESHOLDS_0_2 寄存器结构定义。地址偏移量:0x80B4，初值:0x00000000，宽度:32
 寄存器说明: MODEM Transaction Probe的bin_2配置。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  thresholds_0_2 : 2;  /* bit[0-1] : 0x0-->选择threshold_0（delay：64；outstanding：2）；
                                                         0x1-->选择threshold_1（delay：128；outstanding：4）；
                                                         0x2-->选择threshold_2（delay：256；outstanding：6）；
                                                         0x3-->选择threshold_3（delay：1023；outstanding：10）；。 */
        unsigned int  reserved       : 30; /* bit[2-31]: 保留 */
...
/*****************************************************************************
 结构名    : SOC_CFG_SYS_NOC_BUS_MODEM_TRANS_P_THRESHOLDS_0_3_UNION
 结构说明  : MODEM_TRANS_P_THRESHOLDS_0_3 寄存器结构定义。地址偏移量:0x80B8，初值:0x00000000，宽度:32
 寄存器说明: MODEM Transaction Probe的bin_3配置。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  thresholds_0_3 : 2;  /* bit[0-1] : 0x0-->选择threshold_0（delay：64；outstanding：2）；
                                                         0x1-->选择threshold_1（delay：128；outstanding：4）；
                                                         0x2-->选择threshold_2（delay：256；outstanding：6）；
                                                         0x3-->选择threshold_3（delay：1023；outstanding：10）；。 */
        unsigned int  reserved       : 30; /* bit[2-31]: 保留 */
...
/*****************************************************************************
 ...
 结构说明  : MODEM_TRANS_M_ID_COREID 寄存器结构定义。地址偏移量:0x8400，初值:0x250DA106，宽度:32
 寄存器说明: MODEM Transaction probe域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : ASP_QOS_ID_COREID 寄存器结构定义。地址偏移量:0x0000，初值:0xB03BAD04，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : ASP_QOS_PRIORITY 寄存器结构定义。地址偏移量:0x0008，初值:0x20000000，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : ASP_QOS_BANDWIDTH 寄存器结构定义。地址偏移量:0x0010，初值:0x00000600，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : ASP_TRANS_F_ID_COREID 寄存器结构定义。地址偏移量:0x8000，初值:0x13A15709，宽度:32
 寄存器说明: ASP TransactionStatFilter域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
typedef union
{
    ...
    struct
    {
        unsigned int  thresholds_0_0 : 2;  /* bit[0-1] : 0x0-->选择threshold_0（delay：64；outstanding：4）；
                                                         0x1-->选择threshold_1（delay：128；outstanding：8）；
                                                         0x2-->选择threshold_2（delay：256；outstanding：12）；
                                                         0x3-->选择threshold_3（delay：1023；outstanding：16）；。 */
        unsigned int  reserved       : 30; /* bit[2-31]: 保留 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  thresholds_0_1 : 2;  /* bit[0-1] : 0x0-->选择threshold_0（delay：64；outstanding：4）；
                                                         0x1-->选择threshold_1（delay：128；outstanding：8）；
                                                         0x2-->选择threshold_2（delay：256；outstanding：12）；
                                                         0x3-->选择threshold_3（delay：1023；outstanding：16）；。 */
        unsigned int  reserved       : 30; /* bit[2-31]: 保留 */
...
typedef union
{
    ...
    struct
    {
        unsigned int  thresholds_0_2 : 2;  /* bit[0-1] : 0x0-->选择threshold_0（delay：64；outstanding：4）；
                                                         0x1-->选择threshold_1（delay：128；outstanding：8）；
                                                         0x2-->选择threshold_2（delay：256；outstanding：12）；
                                                         0x3-->选择threshold_3（delay：1023；outstanding：16）；。 */
        unsigned int  reserved       : 30; /* bit[2-31]: 保留 */
...
typedef union
{
    ...
    struct
    {
        unsigned int  thresholds_0_3 : 2;  /* bit[0-1] : 0x0-->选择threshold_0（delay：64；outstanding：4）；
                                                         0x1-->选择threshold_1（delay：128；outstanding：8）；
                                                         0x2-->选择threshold_2（delay：256；outstanding：12）；
                                                         0x3-->选择threshold_3（delay：1023；outstanding：16）；。 */
        unsigned int  reserved       : 30; /* bit[2-31]: 保留 */
...
/*****************************************************************************
 ...
 结构说明  : ASP_TRANS_M_ID_COREID 寄存器结构定义。地址偏移量:0x8400，初值:0x4764CC06，宽度:32
 寄存器说明: ASP Transaction probe域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : CCI2SYSBUS_QOS_ID_COREID 寄存器结构定义。地址偏移量:0x0000，初值:0x34D5CF04，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : CCI2SYSBUS_QOS_PRIORITY 寄存器结构定义。地址偏移量:0x0008，初值:0x20000000，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : AOBUS2DDRC_ADAPTER_ID_COREID 寄存器结构定义。地址偏移量:0x1000，初值:0x4DC0D601，宽度:32
 寄存器说明: adapter域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : SYS2CFG_ADAPTER_ID_COREID 寄存器结构定义。地址偏移量:0x1080，初值:0x2A620C01，宽度:32
 寄存器说明: adapter域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : PERI2DDRC_ADAPTER_ID_COREID 寄存器结构定义。地址偏移量:0x1100，初值:0xBA7BD001，宽度:32
 寄存器说明: adapter域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : SYS2PERI_ADAPTER_ID_COREID 寄存器结构定义。地址偏移量:0x1180，初值:0x56593F01，宽度:32
 寄存器说明: adapter域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : MODEM2DDR_ADAPTER_ID_COREID 寄存器结构定义。地址偏移量:0x1200，初值:0x3B507901，宽度:32
 寄存器说明: adapter域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : CFG2SYS_ADAPTER_ID_COREID 寄存器结构定义。地址偏移量:0x1280，初值:0xA9690A01，宽度:32
 寄存器说明: adapter域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : MMC1_ADAPTER_ID_COREID 寄存器结构定义。地址偏移量:0x1300，初值:0x1740CD01，宽度:32
 寄存器说明: adapter域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : SYSBUS_ERR_ID_COREID 寄存器结构定义。地址偏移量:0x1C00，初值:0x17BDAF0D，宽度:32
 寄存器说明: SYSBUS Err probe域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
#define SOC_CFG_SYS_NOC_BUS_SYSBUS_ERRLOG1_errlog1_END    (31)
...
/*****************************************************************************
 ...
 结构说明  : SYSBUS_DDRC_PACKET_ID_COREID 寄存器结构定义。地址偏移量:0x2000，初值:0x52A4FA06，宽度:32
 寄存器说明: SYSBUS_DDRC Packet probe域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : DMAC_QOS_ID_COREID 寄存器结构定义。地址偏移量:0x0000，初值:0x2799A404，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : DMAC_QOS_PRIORITY 寄存器结构定义。地址偏移量:0x0008，初值:0x20000000，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : DMA2SYS_ADAPTER_ID_COREID 寄存器结构定义。地址偏移量:0x1000，初值:0xA310B201，宽度:32
 寄存器说明: adapter域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : DMABUS_ERR_ID_COREID 寄存器结构定义。地址偏移量:0x1C00，初值:0x17BDAF0D，宽度:32
 寄存器说明: DMABUS Err probe域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
#define SOC_CFG_SYS_NOC_BUS_DMABUS_ERRLOG1_errlog1_END    (31)
 ...
 ****************************************************************************/
/*****************************************************************************
 结构名    : SOC_CFG_SYS_NOC_BUS_USB2_QOS_ID_COREID_UNION
 结构说明  : USB2_QOS_ID_COREID 寄存器结构定义。地址偏移量:0x0000，初值:0x7166D204，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
} SOC_CFG_SYS_NOC_BUS_USB2_QOS_ID_COREID_UNION;
#endif
#define SOC_CFG_SYS_NOC_BUS_USB2_QOS_ID_COREID_coretypeid_START    (0)
#define SOC_CFG_SYS_NOC_BUS_USB2_QOS_ID_COREID_coretypeid_END      (7)
#define SOC_CFG_SYS_NOC_BUS_USB2_QOS_ID_COREID_corechecksum_START  (8)
#define SOC_CFG_SYS_NOC_BUS_USB2_QOS_ID_COREID_corechecksum_END    (31)


/*****************************************************************************
 结构名    : SOC_CFG_SYS_NOC_BUS_USB2_QOS_ID_REVISIONID_UNION
 结构说明  : USB2_QOS_ID_REVISIONID 寄存器结构定义。地址偏移量:0x0004，初值:0x012D5300，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
} SOC_CFG_SYS_NOC_BUS_USB2_QOS_ID_REVISIONID_UNION;
#endif
#define SOC_CFG_SYS_NOC_BUS_USB2_QOS_ID_REVISIONID_userid_START     (0)
#define SOC_CFG_SYS_NOC_BUS_USB2_QOS_ID_REVISIONID_userid_END       (7)
#define SOC_CFG_SYS_NOC_BUS_USB2_QOS_ID_REVISIONID_flexnocid_START  (8)
#define SOC_CFG_SYS_NOC_BUS_USB2_QOS_ID_REVISIONID_flexnocid_END    (31)


/*****************************************************************************
 结构名    : SOC_CFG_SYS_NOC_BUS_USB2_QOS_PRIORITY_UNION
 结构说明  : USB2_QOS_PRIORITY 寄存器结构定义。地址偏移量:0x0008，初值:0x20000000，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
} SOC_CFG_SYS_NOC_BUS_USB2_QOS_PRIORITY_UNION;
#endif
#define SOC_CFG_SYS_NOC_BUS_USB2_QOS_PRIORITY_p0_START        (0)
#define SOC_CFG_SYS_NOC_BUS_USB2_QOS_PRIORITY_p0_END          (1)
#define SOC_CFG_SYS_NOC_BUS_USB2_QOS_PRIORITY_p1_START        (8)
#define SOC_CFG_SYS_NOC_BUS_USB2_QOS_PRIORITY_p1_END          (9)


/*****************************************************************************
 结构名    : SOC_CFG_SYS_NOC_BUS_USB2_QOS_MODE_UNION
 结构说明  : USB2_QOS_MODE 寄存器结构定义。地址偏移量:0x000C，初值:0x00000001，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
} SOC_CFG_SYS_NOC_BUS_USB2_QOS_MODE_UNION;
#endif
#define SOC_CFG_SYS_NOC_BUS_USB2_QOS_MODE_mode_START      (0)
#define SOC_CFG_SYS_NOC_BUS_USB2_QOS_MODE_mode_END        (1)


/*****************************************************************************
 结构名    : SOC_CFG_SYS_NOC_BUS_USB2_QOS_BANDWIDTH_UNION
 结构说明  : USB2_QOS_BANDWIDTH 寄存器结构定义。地址偏移量:0x0010，初值:0x0000042A，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
} SOC_CFG_SYS_NOC_BUS_USB2_QOS_BANDWIDTH_UNION;
#endif
#define SOC_CFG_SYS_NOC_BUS_USB2_QOS_BANDWIDTH_bandwidth_START  (0)
#define SOC_CFG_SYS_NOC_BUS_USB2_QOS_BANDWIDTH_bandwidth_END    (11)


/*****************************************************************************
 结构名    : SOC_CFG_SYS_NOC_BUS_USB2_QOS_SATURATION_UNION
 结构说明  : USB2_QOS_SATURATION 寄存器结构定义。地址偏移量:0x0014，初值:0x000003E8，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
} SOC_CFG_SYS_NOC_BUS_USB2_QOS_SATURATION_UNION;
#endif
#define SOC_CFG_SYS_NOC_BUS_USB2_QOS_SATURATION_saturation_START  (0)
#define SOC_CFG_SYS_NOC_BUS_USB2_QOS_SATURATION_saturation_END    (9)


/*****************************************************************************
 结构名    : SOC_CFG_SYS_NOC_BUS_USB2_QOS_EXTCONTROL_UNION
 结构说明  : USB2_QOS_EXTCONTROL 寄存器结构定义。地址偏移量:0x0018，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
} SOC_CFG_SYS_NOC_BUS_USB2_QOS_EXTCONTROL_UNION;
#endif
#define SOC_CFG_SYS_NOC_BUS_USB2_QOS_EXTCONTROL_socketqosen_START  (0)
#define SOC_CFG_SYS_NOC_BUS_USB2_QOS_EXTCONTROL_socketqosen_END    (0)
#define SOC_CFG_SYS_NOC_BUS_USB2_QOS_EXTCONTROL_extthren_START     (1)
#define SOC_CFG_SYS_NOC_BUS_USB2_QOS_EXTCONTROL_extthren_END       (1)
#define SOC_CFG_SYS_NOC_BUS_USB2_QOS_EXTCONTROL_intclken_START     (2)
#define SOC_CFG_SYS_NOC_BUS_USB2_QOS_EXTCONTROL_intclken_END       (2)


/*****************************************************************************
 结构名    : SOC_CFG_SYS_NOC_BUS_SEC_P_QOS_ID_COREID_UNION
 结构说明  : SEC_P_QOS_ID_COREID 寄存器结构定义。地址偏移量:0x0080，初值:0xA5014104，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : SEC_P_QOS_PRIORITY 寄存器结构定义。地址偏移量:0x0088，初值:0x20000000，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : SEC_S_QOS_ID_COREID 寄存器结构定义。地址偏移量:0x0100，初值:0x490B8304，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : SEC_S_QOS_PRIORITY 寄存器结构定义。地址偏移量:0x0108，初值:0x20000000，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : SOCP_QOS_ID_COREID 寄存器结构定义。地址偏移量:0x0180，初值:0xC6234F04，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : SOCP_QOS_PRIORITY 寄存器结构定义。地址偏移量:0x0188，初值:0x20000000，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : CSSYS_QOS_ID_COREID 寄存器结构定义。地址偏移量:0x0200，初值:0x74DF2604，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : CSSYS_QOS_PRIORITY 寄存器结构定义。地址偏移量:0x0208，初值:0x20000000，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : PERF_STAT_QOS_ID_COREID 寄存器结构定义。地址偏移量:0x0280，初值:0x163A7804，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : PERF_STAT_QOS_PRIORITY 寄存器结构定义。地址偏移量:0x0288，初值:0x20000000，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_CFG_SYS_NOC_BUS_IPF_QOS_ID_COREID_UNION
 结构说明  : IPF_QOS_ID_COREID 寄存器结构定义。地址偏移量:0x0300，初值:0xA698AC04，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_CFG_SYS_NOC_BUS_IPF_QOS_ID_REVISIONID_UNION
 结构说明  : IPF_QOS_ID_REVISIONID 寄存器结构定义。地址偏移量:0x0304，初值:0x012D5300，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_CFG_SYS_NOC_BUS_IPF_QOS_PRIORITY_UNION
 结构说明  : IPF_QOS_PRIORITY 寄存器结构定义。地址偏移量:0x0308，初值:0x20000000，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_CFG_SYS_NOC_BUS_IPF_QOS_MODE_UNION
 结构说明  : IPF_QOS_MODE 寄存器结构定义。地址偏移量:0x030C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_CFG_SYS_NOC_BUS_IPF_QOS_EXTCONTROL_UNION
 结构说明  : IPF_QOS_EXTCONTROL 寄存器结构定义。地址偏移量:0x0318，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : DBG2SYS_ADAPTER_ID_COREID 寄存器结构定义。地址偏移量:0x1000，初值:0xF3704301，宽度:32
 寄存器说明: adapter域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : DBGBUS_ERR_ID_COREID 寄存器结构定义。地址偏移量:0x1C00，初值:0x17BDAF0D，宽度:32
 寄存器说明: DBGBUS Err probe域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
#define SOC_CFG_SYS_NOC_BUS_DBGBUS_ERRLOG1_errlog1_END    (31)
...
/*****************************************************************************
 ...
 结构说明  : MMC1BUS_QOS_ID_COREID 寄存器结构定义。地址偏移量:0x0080，初值:0x92135704，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : MMC1BUS_QOS_PRIORITY 寄存器结构定义。地址偏移量:0x0088，初值:0x20000000，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : MMC1BUS_ERR_ID_COREID 寄存器结构定义。地址偏移量:0x1C00，初值:0x17BDAF0D，宽度:32
 寄存器说明: MMC1BUS Err probe域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
#define SOC_CFG_SYS_NOC_BUS_MMC1BUS_ERRLOG1_errlog1_END    (31)
 ...
 ****************************************************************************/
/*****************************************************************************
 结构名    : SOC_CFG_SYS_NOC_BUS_EMMC_QOS_ID_COREID_UNION
 结构说明  : EMMC_QOS_ID_COREID 寄存器结构定义。地址偏移量:0x0000，初值:0x9242F404，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
} SOC_CFG_SYS_NOC_BUS_EMMC_QOS_ID_COREID_UNION;
#endif
#define SOC_CFG_SYS_NOC_BUS_EMMC_QOS_ID_COREID_coretypeid_START    (0)
#define SOC_CFG_SYS_NOC_BUS_EMMC_QOS_ID_COREID_coretypeid_END      (7)
#define SOC_CFG_SYS_NOC_BUS_EMMC_QOS_ID_COREID_corechecksum_START  (8)
#define SOC_CFG_SYS_NOC_BUS_EMMC_QOS_ID_COREID_corechecksum_END    (31)


/*****************************************************************************
 结构名    : SOC_CFG_SYS_NOC_BUS_EMMC_QOS_ID_REVISIONID_UNION
 结构说明  : EMMC_QOS_ID_REVISIONID 寄存器结构定义。地址偏移量:0x0004，初值:0x012D5300，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
} SOC_CFG_SYS_NOC_BUS_EMMC_QOS_ID_REVISIONID_UNION;
#endif
#define SOC_CFG_SYS_NOC_BUS_EMMC_QOS_ID_REVISIONID_userid_START     (0)
#define SOC_CFG_SYS_NOC_BUS_EMMC_QOS_ID_REVISIONID_userid_END       (7)
#define SOC_CFG_SYS_NOC_BUS_EMMC_QOS_ID_REVISIONID_flexnocid_START  (8)
#define SOC_CFG_SYS_NOC_BUS_EMMC_QOS_ID_REVISIONID_flexnocid_END    (31)


/*****************************************************************************
 结构名    : SOC_CFG_SYS_NOC_BUS_EMMC_QOS_PRIORITY_UNION
 结构说明  : EMMC_QOS_PRIORITY 寄存器结构定义。地址偏移量:0x0008，初值:0x20000000，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
} SOC_CFG_SYS_NOC_BUS_EMMC_QOS_PRIORITY_UNION;
#endif
#define SOC_CFG_SYS_NOC_BUS_EMMC_QOS_PRIORITY_p0_START        (0)
#define SOC_CFG_SYS_NOC_BUS_EMMC_QOS_PRIORITY_p0_END          (1)
#define SOC_CFG_SYS_NOC_BUS_EMMC_QOS_PRIORITY_p1_START        (8)
#define SOC_CFG_SYS_NOC_BUS_EMMC_QOS_PRIORITY_p1_END          (9)


/*****************************************************************************
 结构名    : SOC_CFG_SYS_NOC_BUS_EMMC_QOS_MODE_UNION
 结构说明  : EMMC_QOS_MODE 寄存器结构定义。地址偏移量:0x000C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
} SOC_CFG_SYS_NOC_BUS_EMMC_QOS_MODE_UNION;
#endif
#define SOC_CFG_SYS_NOC_BUS_EMMC_QOS_MODE_mode_START      (0)
#define SOC_CFG_SYS_NOC_BUS_EMMC_QOS_MODE_mode_END        (1)


/*****************************************************************************
 结构名    : SOC_CFG_SYS_NOC_BUS_EMMC_QOS_EXTCONTROL_UNION
 结构说明  : EMMC_QOS_EXTCONTROL 寄存器结构定义。地址偏移量:0x0018，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
} SOC_CFG_SYS_NOC_BUS_EMMC_QOS_EXTCONTROL_UNION;
#endif
#define SOC_CFG_SYS_NOC_BUS_EMMC_QOS_EXTCONTROL_socketqosen_START  (0)
#define SOC_CFG_SYS_NOC_BUS_EMMC_QOS_EXTCONTROL_socketqosen_END    (0)
#define SOC_CFG_SYS_NOC_BUS_EMMC_QOS_EXTCONTROL_extthren_START     (1)
#define SOC_CFG_SYS_NOC_BUS_EMMC_QOS_EXTCONTROL_extthren_END       (1)
#define SOC_CFG_SYS_NOC_BUS_EMMC_QOS_EXTCONTROL_intclken_START     (2)
#define SOC_CFG_SYS_NOC_BUS_EMMC_QOS_EXTCONTROL_intclken_END       (2)


/*****************************************************************************
 结构名    : SOC_CFG_SYS_NOC_BUS_MMC0BUS_ADAPTER_ID_COREID_UNION
 结构说明  : MMC0BUS_ADAPTER_ID_COREID 寄存器结构定义。地址偏移量:0x1000，初值:0x38AA2001，宽度:32
 寄存器说明: adapter域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : MMC0BUS_ERR_ID_COREID 寄存器结构定义。地址偏移量:0x1C00，初值:0x17BDAF0D，宽度:32
 寄存器说明: MMC0BUS Err probe域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
#define SOC_CFG_SYS_NOC_BUS_MMC0BUS_ERRLOG1_errlog1_END    (31)
