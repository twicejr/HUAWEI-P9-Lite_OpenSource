...
/* 寄存器说明：core sight状态寄存器
   位域定义UNION结构:  SOC_CRGPERIPH_CORESIGHT_STAT_UNION */
...
/* 寄存器说明：core sight控制配置寄存器0
   位域定义UNION结构:  SOC_CRGPERIPH_CORESIGHT_CTRL_UNION */
...
/* 寄存器说明：自动降频状态寄存器
   位域定义UNION结构:  SOC_CRGPERIPH_PERI_AUTODIV_STAT_UNION */
#define SOC_CRGPERIPH_PERI_AUTODIV_STAT_ADDR(base)    ((base) + (0xE2C))
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  gt_clk_vivobus           : 1;  /* bit[16]:  */
...
#define SOC_CRGPERIPH_PEREN0_gt_clk_vivobus_START            (16)
#define SOC_CRGPERIPH_PEREN0_gt_clk_vivobus_END              (16)
...
#define SOC_CRGPERIPH_PEREN0_gt_clk_pack_dfi_START           (27)
#define SOC_CRGPERIPH_PEREN0_gt_clk_pack_dfi_END             (27)
#define SOC_CRGPERIPH_PEREN0_gt_hclk_sd_START                (30)
#define SOC_CRGPERIPH_PEREN0_gt_hclk_sd_END                  (30)
#define SOC_CRGPERIPH_PEREN0_gt_clk_socp_hifi_START          (31)
#define SOC_CRGPERIPH_PEREN0_gt_clk_socp_hifi_END            (31)
...
#define SOC_CRGPERIPH_PERDIS0_gt_clk_vivobus_START            (16)
#define SOC_CRGPERIPH_PERDIS0_gt_clk_vivobus_END              (16)
...
#define SOC_CRGPERIPH_PERDIS0_gt_clk_pack_dfi_START           (27)
#define SOC_CRGPERIPH_PERDIS0_gt_clk_pack_dfi_END             (27)
#define SOC_CRGPERIPH_PERDIS0_gt_hclk_sd_START                (30)
#define SOC_CRGPERIPH_PERDIS0_gt_hclk_sd_END                  (30)
#define SOC_CRGPERIPH_PERDIS0_gt_clk_socp_hifi_START          (31)
#define SOC_CRGPERIPH_PERDIS0_gt_clk_socp_hifi_END            (31)


/*****************************************************************************
 结构名    : SOC_CRGPERIPH_PERCLKEN0_UNION
 结构说明  : PERCLKEN0 寄存器结构定义。地址偏移量:0x008，初值:0xFEFFEF9F，宽度:32
 寄存器说明: 外设时钟使能状态寄存器0
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
#define SOC_CRGPERIPH_PERCLKEN0_gt_clk_vivobus_START            (16)
#define SOC_CRGPERIPH_PERCLKEN0_gt_clk_vivobus_END              (16)
...
#define SOC_CRGPERIPH_PERCLKEN0_gt_clk_pack_dfi_START           (27)
#define SOC_CRGPERIPH_PERCLKEN0_gt_clk_pack_dfi_END             (27)
#define SOC_CRGPERIPH_PERCLKEN0_gt_hclk_sd_START                (30)
#define SOC_CRGPERIPH_PERCLKEN0_gt_hclk_sd_END                  (30)
#define SOC_CRGPERIPH_PERCLKEN0_gt_clk_socp_hifi_START          (31)
#define SOC_CRGPERIPH_PERCLKEN0_gt_clk_socp_hifi_END            (31)


/*****************************************************************************
 结构名    : SOC_CRGPERIPH_PERSTAT0_UNION
 结构说明  : PERSTAT0 寄存器结构定义。地址偏移量:0x00C，初值:0xFFFFEF9F，宽度:32
 寄存器说明: 外设时钟最终状态寄存器0
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  reserved_0               : 1;  /* bit[0] : 外设时钟最终状态：
                                                                 0：IP时钟禁止状态；
                                                                 1：IP时钟使能状态。 */
        unsigned int  gt_clk_ddrbyp_ckp0       : 1;  /* bit[1] :  */
        unsigned int  gt_clk_ddrc              : 1;  /* bit[2] :  */
        ...
        unsigned int  gt_hclk_sd               : 1;  /* bit[30]:  */
        unsigned int  gt_clk_packdfi_div2      : 1;  /* bit[31]:  */
    } reg;
...
#define SOC_CRGPERIPH_PERSTAT0_gt_clk_vivobus_START            (16)
#define SOC_CRGPERIPH_PERSTAT0_gt_clk_vivobus_END              (16)
...
#define SOC_CRGPERIPH_PERSTAT0_gt_clk_pack_dfi_START           (27)
#define SOC_CRGPERIPH_PERSTAT0_gt_clk_pack_dfi_END             (27)
#define SOC_CRGPERIPH_PERSTAT0_gt_hclk_sd_START                (30)
#define SOC_CRGPERIPH_PERSTAT0_gt_hclk_sd_END                  (30)
#define SOC_CRGPERIPH_PERSTAT0_gt_clk_packdfi_div2_START       (31)
#define SOC_CRGPERIPH_PERSTAT0_gt_clk_packdfi_div2_END         (31)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  gt_clk_socp_tlbbe16 : 1;  /* bit[30]:  */
        unsigned int  gt_clk_socp_cbbe16  : 1;  /* bit[31]: 保留。 */
    } reg;
...
#define SOC_CRGPERIPH_PEREN1_gt_clk_socp_tlbbe16_START  (30)
#define SOC_CRGPERIPH_PEREN1_gt_clk_socp_tlbbe16_END    (30)
#define SOC_CRGPERIPH_PEREN1_gt_clk_socp_cbbe16_START   (31)
#define SOC_CRGPERIPH_PEREN1_gt_clk_socp_cbbe16_END     (31)
...
#define SOC_CRGPERIPH_PERDIS1_gt_clk_socp_tlbbe16_START  (30)
#define SOC_CRGPERIPH_PERDIS1_gt_clk_socp_tlbbe16_END    (30)
#define SOC_CRGPERIPH_PERDIS1_gt_clk_socp_cbbe16_START   (31)
#define SOC_CRGPERIPH_PERDIS1_gt_clk_socp_cbbe16_END     (31)
...
#define SOC_CRGPERIPH_PERCLKEN1_gt_clk_socp_tlbbe16_START  (30)
#define SOC_CRGPERIPH_PERCLKEN1_gt_clk_socp_tlbbe16_END    (30)
#define SOC_CRGPERIPH_PERCLKEN1_gt_clk_socp_cbbe16_START   (31)
#define SOC_CRGPERIPH_PERCLKEN1_gt_clk_socp_cbbe16_END     (31)
...
typedef union
{
    ...
    struct
    {
        unsigned int  gt_clk_pwm          : 1;  /* bit[0] : 外设时钟使能控制：
                                                            0：写0无效果；
                                                            1：使能IP时钟。 */
        unsigned int  gt_clk_hkadcssi1    : 1;  /* bit[1] : 保留。 */
        unsigned int  gt_clk_ipc0         : 1;  /* bit[2] :  */
        unsigned int  gt_clk_ipc1         : 1;  /* bit[3] :  */
        unsigned int  gt_clk_60m          : 1;  /* bit[4] : 保留。 */
        unsigned int  gt_clk_loadmonitor0 : 1;  /* bit[5] : 保留。 */
        unsigned int  gt_clk_loadmonitor1 : 1;  /* bit[6] : 保留。 */
        ...
        unsigned int  gt_pclk_loadmonitor : 1;  /* bit[19]:  */
        ...
        unsigned int  gt_pclk_ipc_mdm_s   : 1;  /* bit[28]: 保留。 */
        unsigned int  reserved_2          : 1;  /* bit[29]: 保留。 */
        unsigned int  reserved_3          : 1;  /* bit[30]: 保留。 */
        unsigned int  gt_pclk_pctrl       : 1;  /* bit[31]:  */
    } reg;
} SOC_CRGPERIPH_PEREN2_UNION;
#endif
#define SOC_CRGPERIPH_PEREN2_gt_clk_pwm_START           (0)
#define SOC_CRGPERIPH_PEREN2_gt_clk_pwm_END             (0)
#define SOC_CRGPERIPH_PEREN2_gt_clk_hkadcssi1_START     (1)
#define SOC_CRGPERIPH_PEREN2_gt_clk_hkadcssi1_END       (1)
...
#define SOC_CRGPERIPH_PEREN2_gt_clk_60m_START           (4)
#define SOC_CRGPERIPH_PEREN2_gt_clk_60m_END             (4)
#define SOC_CRGPERIPH_PEREN2_gt_clk_loadmonitor0_START  (5)
#define SOC_CRGPERIPH_PEREN2_gt_clk_loadmonitor0_END    (5)
#define SOC_CRGPERIPH_PEREN2_gt_clk_loadmonitor1_START  (6)
#define SOC_CRGPERIPH_PEREN2_gt_clk_loadmonitor1_END    (6)
...
#define SOC_CRGPERIPH_PEREN2_gt_pclk_loadmonitor_START  (19)
#define SOC_CRGPERIPH_PEREN2_gt_pclk_loadmonitor_END    (19)
...
#define SOC_CRGPERIPH_PEREN2_gt_pclk_ipc_mdm_s_START    (28)
#define SOC_CRGPERIPH_PEREN2_gt_pclk_ipc_mdm_s_END      (28)
...
#define SOC_CRGPERIPH_PERDIS2_gt_clk_hkadcssi1_START     (1)
#define SOC_CRGPERIPH_PERDIS2_gt_clk_hkadcssi1_END       (1)
...
#define SOC_CRGPERIPH_PERDIS2_gt_clk_60m_START           (4)
#define SOC_CRGPERIPH_PERDIS2_gt_clk_60m_END             (4)
#define SOC_CRGPERIPH_PERDIS2_gt_clk_loadmonitor0_START  (5)
#define SOC_CRGPERIPH_PERDIS2_gt_clk_loadmonitor0_END    (5)
#define SOC_CRGPERIPH_PERDIS2_gt_clk_loadmonitor1_START  (6)
#define SOC_CRGPERIPH_PERDIS2_gt_clk_loadmonitor1_END    (6)
...
#define SOC_CRGPERIPH_PERDIS2_gt_pclk_loadmonitor_START  (19)
#define SOC_CRGPERIPH_PERDIS2_gt_pclk_loadmonitor_END    (19)
...
#define SOC_CRGPERIPH_PERDIS2_gt_pclk_ipc_mdm_s_START    (28)
#define SOC_CRGPERIPH_PERDIS2_gt_pclk_ipc_mdm_s_END      (28)
...
/*****************************************************************************
 ...
 结构说明  : PERCLKEN2 寄存器结构定义。地址偏移量:0x028，初值:0xFF97FF9F，宽度:32
 寄存器说明: 外设时钟使能状态寄存器2
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  gt_pclk_wd1         : 1;  /* bit[17]:  */
        unsigned int  gt_pclk_tzpc        : 1;  /* bit[18]:  */
        unsigned int  gt_pclk_loadmonitor : 1;  /* bit[19]: 保留。 */
        unsigned int  gt_pclk_ipc_mdm     : 1;  /* bit[20]:  */
        unsigned int  gt_clk_adb_mst_a53  : 1;  /* bit[21]:  */
        unsigned int  gt_clk_adb_mst_a57  : 1;  /* bit[22]:  */
        unsigned int  gt_clk_gic          : 1;  /* bit[23]:  */
...
#define SOC_CRGPERIPH_PERCLKEN2_gt_clk_hkadcssi1_START     (1)
#define SOC_CRGPERIPH_PERCLKEN2_gt_clk_hkadcssi1_END       (1)
...
#define SOC_CRGPERIPH_PERCLKEN2_gt_clk_60m_START           (4)
#define SOC_CRGPERIPH_PERCLKEN2_gt_clk_60m_END             (4)
#define SOC_CRGPERIPH_PERCLKEN2_gt_clk_loadmonitor0_START  (5)
#define SOC_CRGPERIPH_PERCLKEN2_gt_clk_loadmonitor0_END    (5)
#define SOC_CRGPERIPH_PERCLKEN2_gt_clk_loadmonitor1_START  (6)
#define SOC_CRGPERIPH_PERCLKEN2_gt_clk_loadmonitor1_END    (6)
...
#define SOC_CRGPERIPH_PERCLKEN2_gt_pclk_loadmonitor_START  (19)
#define SOC_CRGPERIPH_PERCLKEN2_gt_pclk_loadmonitor_END    (19)
...
#define SOC_CRGPERIPH_PERCLKEN2_gt_pclk_ipc_mdm_s_START    (28)
#define SOC_CRGPERIPH_PERCLKEN2_gt_pclk_ipc_mdm_s_END      (28)
...
/*****************************************************************************
 ...
 结构说明  : PERSTAT2 寄存器结构定义。地址偏移量:0x02C，初值:0xFF97FF9F，宽度:32
 寄存器说明: 外设时钟最终状态寄存器2
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
#define SOC_CRGPERIPH_PERSTAT2_gt_clk_hkadcssi1_START     (1)
#define SOC_CRGPERIPH_PERSTAT2_gt_clk_hkadcssi1_END       (1)
...
#define SOC_CRGPERIPH_PERSTAT2_gt_clk_60m_START           (4)
#define SOC_CRGPERIPH_PERSTAT2_gt_clk_60m_END             (4)
#define SOC_CRGPERIPH_PERSTAT2_gt_clk_loadmonitor0_START  (5)
#define SOC_CRGPERIPH_PERSTAT2_gt_clk_loadmonitor0_END    (5)
#define SOC_CRGPERIPH_PERSTAT2_gt_clk_loadmonitor1_START  (6)
#define SOC_CRGPERIPH_PERSTAT2_gt_clk_loadmonitor1_END    (6)
...
#define SOC_CRGPERIPH_PERSTAT2_gt_pclk_loadmonitor_START  (19)
#define SOC_CRGPERIPH_PERSTAT2_gt_pclk_loadmonitor_END    (19)
...
#define SOC_CRGPERIPH_PERSTAT2_gt_pclk_ipc_mdm_s_START    (28)
#define SOC_CRGPERIPH_PERSTAT2_gt_pclk_ipc_mdm_s_END      (28)
...
#define SOC_CRGPERIPH_PEREN3_sc_abb_pll_audio_gt_en1_START  (14)
#define SOC_CRGPERIPH_PEREN3_sc_abb_pll_audio_gt_en1_END    (14)
...
#define SOC_CRGPERIPH_PEREN3_sc_abb_pll_gps_gt_en1_START    (22)
#define SOC_CRGPERIPH_PEREN3_sc_abb_pll_gps_gt_en1_END      (22)
...
#define SOC_CRGPERIPH_PERDIS3_sc_abb_pll_audio_gt_en1_START  (14)
#define SOC_CRGPERIPH_PERDIS3_sc_abb_pll_audio_gt_en1_END    (14)
...
#define SOC_CRGPERIPH_PERDIS3_sc_abb_pll_gps_gt_en1_START    (22)
#define SOC_CRGPERIPH_PERDIS3_sc_abb_pll_gps_gt_en1_END      (22)
...
#define SOC_CRGPERIPH_PERCLKEN3_sc_abb_pll_audio_gt_en1_START  (14)
#define SOC_CRGPERIPH_PERCLKEN3_sc_abb_pll_audio_gt_en1_END    (14)
...
#define SOC_CRGPERIPH_PERCLKEN3_sc_abb_pll_gps_gt_en1_START    (22)
#define SOC_CRGPERIPH_PERCLKEN3_sc_abb_pll_gps_gt_en1_END      (22)
...
/*****************************************************************************
 ...
 结构说明  : PERSTAT3 寄存器结构定义。地址偏移量:0x03C，初值:0xC44D43C7，宽度:32
 寄存器说明: 外设时钟最终状态寄存器3
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  gt_clk_ldi0        : 1;  /* bit[15]:  */
        unsigned int  reserved_6         : 1;  /* bit[16]: 保留。 */
        unsigned int  gt_clk_edc0        : 1;  /* bit[17]:  */
        unsigned int  reserved_7         : 1;  /* bit[18]: 保留。 */
...
typedef union
{
    ...
    struct
    {
        unsigned int  reserved_0             : 1;  /* bit[0] : 外设时钟使能控制：
                                                               0：写0无效果；
                                                               1：使能IP时钟。 */
        unsigned int  gt_hclk_usb2otg        : 1;  /* bit[1] :  */
        unsigned int  gt_clk_usb2phy_ref     : 1;  /* bit[2] :  */
        unsigned int  gt_clk_ipf0            : 1;  /* bit[3] :  */
        unsigned int  gt_clk_ipf1            : 1;  /* bit[4] :  */
        unsigned int  reserved_1             : 1;  /* bit[5] :  */
        unsigned int  gt_clk_usb2phy_ref_pll : 1;  /* bit[6] :  */
        ...
        unsigned int  gt_clk_a53_tp          : 1;  /* bit[31]: maya_svdf 64分频测试时钟门控 */
    } reg;
} SOC_CRGPERIPH_PEREN4_UNION;
#endif
#define SOC_CRGPERIPH_PEREN4_gt_hclk_usb2otg_START         (1)
#define SOC_CRGPERIPH_PEREN4_gt_hclk_usb2otg_END           (1)
#define SOC_CRGPERIPH_PEREN4_gt_clk_usb2phy_ref_START      (2)
#define SOC_CRGPERIPH_PEREN4_gt_clk_usb2phy_ref_END        (2)
#define SOC_CRGPERIPH_PEREN4_gt_clk_ipf0_START             (3)
#define SOC_CRGPERIPH_PEREN4_gt_clk_ipf0_END               (3)
#define SOC_CRGPERIPH_PEREN4_gt_clk_ipf1_START             (4)
#define SOC_CRGPERIPH_PEREN4_gt_clk_ipf1_END               (4)
#define SOC_CRGPERIPH_PEREN4_gt_clk_usb2phy_ref_pll_START  (6)
#define SOC_CRGPERIPH_PEREN4_gt_clk_usb2phy_ref_pll_END    (6)
...
#endif
#define SOC_CRGPERIPH_PERDIS4_gt_hclk_usb2otg_START         (1)
#define SOC_CRGPERIPH_PERDIS4_gt_hclk_usb2otg_END           (1)
#define SOC_CRGPERIPH_PERDIS4_gt_clk_usb2phy_ref_START      (2)
#define SOC_CRGPERIPH_PERDIS4_gt_clk_usb2phy_ref_END        (2)
#define SOC_CRGPERIPH_PERDIS4_gt_clk_ipf0_START             (3)
#define SOC_CRGPERIPH_PERDIS4_gt_clk_ipf0_END               (3)
#define SOC_CRGPERIPH_PERDIS4_gt_clk_ipf1_START             (4)
#define SOC_CRGPERIPH_PERDIS4_gt_clk_ipf1_END               (4)
#define SOC_CRGPERIPH_PERDIS4_gt_clk_usb2phy_ref_pll_START  (6)
#define SOC_CRGPERIPH_PERDIS4_gt_clk_usb2phy_ref_pll_END    (6)
...
/*****************************************************************************
 ...
 结构说明  : PERCLKEN4 寄存器结构定义。地址偏移量:0x048，初值:0x7FF078C7，宽度:32
 寄存器说明: 外设时钟使能状态寄存器4
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  gt_clk_usb2phy_ref     : 1;  /* bit[2] :  */
        unsigned int  gt_clk_ipf0            : 1;  /* bit[3] :  */
        unsigned int  gt_clk_ipf1            : 1;  /* bit[4] : 保留。 */
        unsigned int  reserved_1             : 1;  /* bit[5] :  */
        unsigned int  gt_clk_usb2phy_ref_pll : 1;  /* bit[6] :  */
        unsigned int  reserved_2             : 1;  /* bit[7] :  */
        unsigned int  gt_clk_perf_stat       : 1;  /* bit[8] :  */
...
#endif
#define SOC_CRGPERIPH_PERCLKEN4_gt_hclk_usb2otg_START         (1)
#define SOC_CRGPERIPH_PERCLKEN4_gt_hclk_usb2otg_END           (1)
#define SOC_CRGPERIPH_PERCLKEN4_gt_clk_usb2phy_ref_START      (2)
#define SOC_CRGPERIPH_PERCLKEN4_gt_clk_usb2phy_ref_END        (2)
#define SOC_CRGPERIPH_PERCLKEN4_gt_clk_ipf0_START             (3)
#define SOC_CRGPERIPH_PERCLKEN4_gt_clk_ipf0_END               (3)
#define SOC_CRGPERIPH_PERCLKEN4_gt_clk_ipf1_START             (4)
#define SOC_CRGPERIPH_PERCLKEN4_gt_clk_ipf1_END               (4)
#define SOC_CRGPERIPH_PERCLKEN4_gt_clk_usb2phy_ref_pll_START  (6)
#define SOC_CRGPERIPH_PERCLKEN4_gt_clk_usb2phy_ref_pll_END    (6)
...
/*****************************************************************************
 ...
 结构说明  : PERSTAT4 寄存器结构定义。地址偏移量:0x04C，初值:0x7FE178E7，宽度:32
 寄存器说明: 外设时钟最终状态寄存器4
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  gt_clk_sd              : 1;  /* bit[17]:  */
        unsigned int  gt_clk_sdio0           : 1;  /* bit[18]: svfd2 的测试时钟门控状态。 */
        unsigned int  st_clk_svfd2_tp        : 1;  /* bit[19]: svfd1 的测试时钟门控状态。 */
        unsigned int  st_clk_svfd1_tp        : 1;  /* bit[20]: 保留。 */
        unsigned int  gt_clk_a57_tsensor     : 1;  /* bit[21]:  */
        unsigned int  gt_clk_a53_tsensor     : 1;  /* bit[22]:  */
        unsigned int  gt_clk_apll0_sscg      : 1;  /* bit[23]:  */
        unsigned int  gt_clk_apll1_sscg      : 1;  /* bit[24]:  */
...
#endif
#define SOC_CRGPERIPH_PERSTAT4_gt_hclk_usb2otg_START         (1)
#define SOC_CRGPERIPH_PERSTAT4_gt_hclk_usb2otg_END           (1)
#define SOC_CRGPERIPH_PERSTAT4_gt_clk_usb2phy_ref_START      (2)
#define SOC_CRGPERIPH_PERSTAT4_gt_clk_usb2phy_ref_END        (2)
#define SOC_CRGPERIPH_PERSTAT4_gt_clk_ipf0_START             (3)
#define SOC_CRGPERIPH_PERSTAT4_gt_clk_ipf0_END               (3)
#define SOC_CRGPERIPH_PERSTAT4_gt_clk_ipf1_START             (4)
#define SOC_CRGPERIPH_PERSTAT4_gt_clk_ipf1_END               (4)
#define SOC_CRGPERIPH_PERSTAT4_gt_clk_usb2phy_ref_pll_START  (6)
#define SOC_CRGPERIPH_PERSTAT4_gt_clk_usb2phy_ref_pll_END    (6)
...
#define SOC_CRGPERIPH_PERSTAT4_st_clk_svfd2_tp_START         (19)
#define SOC_CRGPERIPH_PERSTAT4_st_clk_svfd2_tp_END           (19)
#define SOC_CRGPERIPH_PERSTAT4_st_clk_svfd1_tp_START         (20)
#define SOC_CRGPERIPH_PERSTAT4_st_clk_svfd1_tp_END           (20)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  gt_clk_isp_timer          : 1;  /* bit[19]   : 保留。 */
        ...
        unsigned int  gt_clk_sysbus_tp          : 1;  /* bit[31]   :  */
    } reg;
...
#define SOC_CRGPERIPH_PEREN5_gt_clk_isp_timer_START           (19)
#define SOC_CRGPERIPH_PEREN5_gt_clk_isp_timer_END             (19)
...
#define SOC_CRGPERIPH_PERDIS5_gt_clk_isp_timer_START           (19)
#define SOC_CRGPERIPH_PERDIS5_gt_clk_isp_timer_END             (19)
...
/*****************************************************************************
 ...
 结构说明  : PERCLKEN5 寄存器结构定义。地址偏移量:0x058，初值:0xFF60BB6B，宽度:32
 寄存器说明: 外设时钟使能状态寄存器5
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
#define SOC_CRGPERIPH_PERCLKEN5_gt_clk_isp_timer_START           (19)
#define SOC_CRGPERIPH_PERCLKEN5_gt_clk_isp_timer_END             (19)
...
/*****************************************************************************
 ...
 结构说明  : PERSTAT5 寄存器结构定义。地址偏移量:0x05C，初值:0xBFF0BB6B，宽度:32
 寄存器说明: 外设时钟最终状态寄存器5
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  gt_clk_sysbus2hkmem       : 1;  /* bit[0]    : 外设时钟最终状态：
                                                                     0：IP时钟禁止状态；
                                                                     1：IP时钟使能状态。 */
        unsigned int  gt_clk_modem_sys          : 1;  /* bit[1]    :  */
        unsigned int  gt_clk_modem_subsys       : 1;  /* bit[2]    :  */
        ...
        unsigned int  gt_clk_cci400             : 1;  /* bit[14]   :  */
        unsigned int  gt_clk_gpu_hpm            : 1;  /* bit[15]   :  */
        unsigned int  gt_clk_isp_snclk          : 3;  /* bit[16-18]: clk_isp_snclk_0/1/2 时钟门控信号：
                                                                     0：时钟关闭；
                                                                     1：时钟使能； */
        unsigned int  gt_clk_isp_timer          : 1;  /* bit[19]   : 保留。 */
        unsigned int  reserved_1                : 1;  /* bit[20]   : 保留。 */
        ...
        unsigned int  reserved_7                : 1;  /* bit[26]   :  */
        unsigned int  gt_clk_ddrphy_apb_dfi_a   : 1;  /* bit[27]   :  */
        unsigned int  gt_pclk_dsi0              : 1;  /* bit[28]   :  */
        unsigned int  reserved_8                : 1;  /* bit[29]   :  */
        unsigned int  gt_clk_ace0_mst_g3d       : 1;  /* bit[30]   :  */
        unsigned int  reserved_9                : 1;  /* bit[31]   :  */
    } reg;
...
#define SOC_CRGPERIPH_PERSTAT5_gt_clk_isp_timer_START           (19)
#define SOC_CRGPERIPH_PERSTAT5_gt_clk_isp_timer_END             (19)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_3           : 1;  /* bit[14]   : hreset_ocb */
        ...
        unsigned int  reserved_12          : 2;  /* bit[30-31]: 保留。 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  ip_rst_lpm32cfgbus   : 1;  /* bit[20]   :  */
        unsigned int  ip_rst_noc_dmabus    : 1;  /* bit[21]   :  */
        unsigned int  reserved_7           : 1;  /* bit[22]   : 上电默认处于复位状态。 */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  ip_rst_vdm_acg1 : 1;  /* bit[31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  ip_rst_vdm_acg1 : 1;  /* bit[31]: 上电默认处于复位状态。 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  ip_rst_pwm          : 1;  /* bit[0] : IP软复位使能：
                                                            0：IP软复位使能状态不变；
                                                            1：IP软复位使能。 */
        unsigned int  ip_rst_hkadcssi1    : 1;  /* bit[1] : 保留。 */
        ...
        unsigned int  ip_prst_loadmonitor : 1;  /* bit[6] : 保留。 */
        ...
        unsigned int  ip_prst_ipc_mdm_s   : 1;  /* bit[19]: 保留。 */
        ...
        unsigned int  reserved_7          : 1;  /* bit[29]: 保留。 */
        unsigned int  reserved_8          : 1;  /* bit[30]: 保留。 */
        unsigned int  ip_rst_pctrl        : 1;  /* bit[31]:  */
    } reg;
...
#define SOC_CRGPERIPH_PERRSTEN2_ip_rst_hkadcssi1_START     (1)
#define SOC_CRGPERIPH_PERRSTEN2_ip_rst_hkadcssi1_END       (1)
...
#define SOC_CRGPERIPH_PERRSTEN2_ip_prst_loadmonitor_START  (6)
#define SOC_CRGPERIPH_PERRSTEN2_ip_prst_loadmonitor_END    (6)
...
#define SOC_CRGPERIPH_PERRSTEN2_ip_prst_ipc_mdm_s_START    (19)
#define SOC_CRGPERIPH_PERRSTEN2_ip_prst_ipc_mdm_s_END      (19)
...
#define SOC_CRGPERIPH_PERRSTDIS2_ip_rst_hkadcssi1_START     (1)
#define SOC_CRGPERIPH_PERRSTDIS2_ip_rst_hkadcssi1_END       (1)
...
#define SOC_CRGPERIPH_PERRSTDIS2_ip_prst_loadmonitor_START  (6)
#define SOC_CRGPERIPH_PERRSTDIS2_ip_prst_loadmonitor_END    (6)
...
#define SOC_CRGPERIPH_PERRSTDIS2_ip_prst_ipc_mdm_s_START    (19)
#define SOC_CRGPERIPH_PERRSTDIS2_ip_prst_ipc_mdm_s_END      (19)
...
/*****************************************************************************
 ...
 结构说明  : PERRSTSTAT2 寄存器结构定义。地址偏移量:0x080，初值:0x00600040，宽度:32
 寄存器说明: 外设软复位状态寄存器2
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_0          : 1;  /* bit[4] : 保留。 */
        unsigned int  reserved_1          : 1;  /* bit[5] : 保留。 */
        unsigned int  ip_prst_loadmonitor : 1;  /* bit[6] : 上电默认处于复位状态。 */
        unsigned int  ip_rst_i2c3         : 1;  /* bit[7] :  */
        unsigned int  reserved_2          : 1;  /* bit[8] : 保留。 */
        unsigned int  ip_rst_spi1         : 1;  /* bit[9] :  */
        unsigned int  ip_rst_uart0        : 1;  /* bit[10]:  */
...
#define SOC_CRGPERIPH_PERRSTSTAT2_ip_rst_hkadcssi1_START     (1)
#define SOC_CRGPERIPH_PERRSTSTAT2_ip_rst_hkadcssi1_END       (1)
...
#define SOC_CRGPERIPH_PERRSTSTAT2_ip_prst_loadmonitor_START  (6)
#define SOC_CRGPERIPH_PERRSTSTAT2_ip_prst_loadmonitor_END    (6)
...
#define SOC_CRGPERIPH_PERRSTSTAT2_ip_prst_ipc_mdm_s_START    (19)
#define SOC_CRGPERIPH_PERRSTSTAT2_ip_prst_ipc_mdm_s_END      (19)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  ip_rst_dss_crg   : 1;  /* bit[31]: 保留。 */
    } reg;
...
#define SOC_CRGPERIPH_PERRSTEN3_ip_rst_dss_crg_START    (31)
#define SOC_CRGPERIPH_PERRSTEN3_ip_rst_dss_crg_END      (31)
...
#define SOC_CRGPERIPH_PERRSTDIS3_ip_rst_dss_crg_START    (31)
#define SOC_CRGPERIPH_PERRSTDIS3_ip_rst_dss_crg_END      (31)


/*****************************************************************************
 结构名    : SOC_CRGPERIPH_PERRSTSTAT3_UNION
 结构说明  : PERRSTSTAT3 寄存器结构定义。地址偏移量:0x008C，初值:0xD1FF5F1C，宽度:32
 寄存器说明: 外设软复位状态寄存器3
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_11      : 1;  /* bit[29]: 上电默认处于复位状态。 */
        unsigned int  reserved_12      : 1;  /* bit[30]: 保留。 */
        unsigned int  ip_rst_dss_crg   : 1;  /* bit[31]: dss_crg的复位信号：
                                                         0：处于复位撤离状态；
                                                         1：处于复位使能状态。 */
    } reg;
...
#define SOC_CRGPERIPH_PERRSTSTAT3_ip_rst_dss_crg_START    (31)
#define SOC_CRGPERIPH_PERRSTSTAT3_ip_rst_dss_crg_END      (31)
...
typedef union
{
    ...
    struct
    {
        unsigned int  ip_rst_dbgsechsic_subsys_crg : 1;  /* bit[0] : IP软复位使能：
                                                                     0：IP软复位使能状态不变；
                                                                     1：IP软复位使能。 */
        unsigned int  ip_rst_ipf                   : 1;  /* bit[1] : 保留。 */
        unsigned int  reserved_0                   : 1;  /* bit[2] : 保留。 */
        unsigned int  reserved_1                   : 1;  /* bit[3] :  */
        ...
        unsigned int  ip_rst_usb2otg               : 1;  /* bit[9] : 保留。 */
        unsigned int  ip_rst_usb2otg_mux           : 1;  /* bit[10]: 保留。 */
        unsigned int  ip_rst_usb2otg_ahbif         : 1;  /* bit[11]: 保留。 */
        unsigned int  ip_rst_usbotg2_phy           : 1;  /* bit[12]: usb控制器的异步复位，。 */
        unsigned int  ip_rst_usb2otgphy_por        : 1;  /* bit[13]: usbphy的异步复位，高电平有效。 */
        unsigned int  ip_rst_usb2bc_32k            : 1;  /* bit[14]: usb控制器的复位(32k时钟域撤离)。 */
        ...
        unsigned int  reserved_10                  : 1;  /* bit[26]:  */
        unsigned int  ip_rst_usbotg2_apb           : 1;  /* bit[27]: usb控制器的adp复位。 */
        ...
        unsigned int  reserved_12                  : 1;  /* bit[31]: 保留。 */
    } reg;
...
#define SOC_CRGPERIPH_PERRSTEN4_ip_rst_ipf_START                    (1)
#define SOC_CRGPERIPH_PERRSTEN4_ip_rst_ipf_END                      (1)
#define SOC_CRGPERIPH_PERRSTEN4_ip_rst_usb2otg_START                (9)
#define SOC_CRGPERIPH_PERRSTEN4_ip_rst_usb2otg_END                  (9)
#define SOC_CRGPERIPH_PERRSTEN4_ip_rst_usb2otg_mux_START            (10)
#define SOC_CRGPERIPH_PERRSTEN4_ip_rst_usb2otg_mux_END              (10)
#define SOC_CRGPERIPH_PERRSTEN4_ip_rst_usb2otg_ahbif_START          (11)
#define SOC_CRGPERIPH_PERRSTEN4_ip_rst_usb2otg_ahbif_END            (11)
#define SOC_CRGPERIPH_PERRSTEN4_ip_rst_usbotg2_phy_START            (12)
#define SOC_CRGPERIPH_PERRSTEN4_ip_rst_usbotg2_phy_END              (12)
#define SOC_CRGPERIPH_PERRSTEN4_ip_rst_usb2otgphy_por_START         (13)
#define SOC_CRGPERIPH_PERRSTEN4_ip_rst_usb2otgphy_por_END           (13)
#define SOC_CRGPERIPH_PERRSTEN4_ip_rst_usb2bc_32k_START             (14)
#define SOC_CRGPERIPH_PERRSTEN4_ip_rst_usb2bc_32k_END               (14)
...
#define SOC_CRGPERIPH_PERRSTEN4_ip_rst_usbotg2_apb_START            (27)
#define SOC_CRGPERIPH_PERRSTEN4_ip_rst_usbotg2_apb_END              (27)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  ip_rst_usb2otg_mux           : 1;  /* bit[10]: 保留。 */
        unsigned int  ip_rst_usb2otg_ahbif         : 1;  /* bit[11]: 保留。 */
        unsigned int  ip_rst_usbotg2_phy           : 1;  /* bit[12]: 保留。 */
        unsigned int  ip_rst_usb2otgphy_por        : 1;  /* bit[13]: 保留。 */
        unsigned int  ip_rst_usb2bc_32k            : 1;  /* bit[14]:  */
        unsigned int  ip_rst_secp                  : 1;  /* bit[15]:  */
        ...
        unsigned int  reserved_10                  : 1;  /* bit[26]: 保留。 */
        unsigned int  ip_rst_usbotg2_apb           : 1;  /* bit[27]: 保留。 */
        unsigned int  ip_rst_lpmcu                 : 1;  /* bit[28]: 整个LPM3子系统的复位使能：
                                                                     0：软复位使能状态不变；
                                                                     1：软复位使能。
                                                                     不允许软件使用，一旦配置会导致系统死锁。 */
...
#define SOC_CRGPERIPH_PERRSTDIS4_ip_rst_ipf_START                    (1)
#define SOC_CRGPERIPH_PERRSTDIS4_ip_rst_ipf_END                      (1)
#define SOC_CRGPERIPH_PERRSTDIS4_ip_rst_usb2otg_START                (9)
#define SOC_CRGPERIPH_PERRSTDIS4_ip_rst_usb2otg_END                  (9)
#define SOC_CRGPERIPH_PERRSTDIS4_ip_rst_usb2otg_mux_START            (10)
#define SOC_CRGPERIPH_PERRSTDIS4_ip_rst_usb2otg_mux_END              (10)
#define SOC_CRGPERIPH_PERRSTDIS4_ip_rst_usb2otg_ahbif_START          (11)
#define SOC_CRGPERIPH_PERRSTDIS4_ip_rst_usb2otg_ahbif_END            (11)
#define SOC_CRGPERIPH_PERRSTDIS4_ip_rst_usbotg2_phy_START            (12)
#define SOC_CRGPERIPH_PERRSTDIS4_ip_rst_usbotg2_phy_END              (12)
#define SOC_CRGPERIPH_PERRSTDIS4_ip_rst_usb2otgphy_por_START         (13)
#define SOC_CRGPERIPH_PERRSTDIS4_ip_rst_usb2otgphy_por_END           (13)
#define SOC_CRGPERIPH_PERRSTDIS4_ip_rst_usb2bc_32k_START             (14)
#define SOC_CRGPERIPH_PERRSTDIS4_ip_rst_usb2bc_32k_END               (14)
...
#define SOC_CRGPERIPH_PERRSTDIS4_ip_rst_usbotg2_apb_START            (27)
#define SOC_CRGPERIPH_PERRSTDIS4_ip_rst_usbotg2_apb_END              (27)
...
/*****************************************************************************
 ...
 结构说明  : PERRSTSTAT4 寄存器结构定义。地址偏移量:0x098，初值:0x083F7FE2，宽度:32
 寄存器说明: 外设软复位状态寄存器4
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_1                   : 1;  /* bit[3] :  */
        unsigned int  reserved_2                   : 1;  /* bit[4] : 保留。 */
        unsigned int  reserved_3                   : 1;  /* bit[5] : 上电默认处于复位状态。 */
        unsigned int  reserved_4                   : 1;  /* bit[6] : 上电默认处于复位状态。 */
        unsigned int  reserved_5                   : 1;  /* bit[7] : 上电默认处于复位状态。 */
        unsigned int  reserved_6                   : 1;  /* bit[8] :  */
        unsigned int  ip_rst_usb2otg               : 1;  /* bit[9] : 保留。 */
        unsigned int  ip_rst_usb2otg_mux           : 1;  /* bit[10]: 保留。 */
        unsigned int  ip_rst_usb2otg_ahbif         : 1;  /* bit[11]: 保留。 */
        ...
        unsigned int  ip_rst_sdio0_m               : 1;  /* bit[25]:  */
        unsigned int  reserved_10                  : 1;  /* bit[26]:  */
        unsigned int  ip_rst_usbotg2_apb           : 1;  /* bit[27]:  */
...
#define SOC_CRGPERIPH_PERRSTSTAT4_ip_rst_ipf_START                    (1)
#define SOC_CRGPERIPH_PERRSTSTAT4_ip_rst_ipf_END                      (1)
#define SOC_CRGPERIPH_PERRSTSTAT4_ip_rst_usb2otg_START                (9)
#define SOC_CRGPERIPH_PERRSTSTAT4_ip_rst_usb2otg_END                  (9)
#define SOC_CRGPERIPH_PERRSTSTAT4_ip_rst_usb2otg_mux_START            (10)
#define SOC_CRGPERIPH_PERRSTSTAT4_ip_rst_usb2otg_mux_END              (10)
#define SOC_CRGPERIPH_PERRSTSTAT4_ip_rst_usb2otg_ahbif_START          (11)
#define SOC_CRGPERIPH_PERRSTSTAT4_ip_rst_usb2otg_ahbif_END            (11)
#define SOC_CRGPERIPH_PERRSTSTAT4_ip_rst_usbotg2_phy_START            (12)
#define SOC_CRGPERIPH_PERRSTSTAT4_ip_rst_usbotg2_phy_END              (12)
#define SOC_CRGPERIPH_PERRSTSTAT4_ip_rst_usb2otgphy_por_START         (13)
#define SOC_CRGPERIPH_PERRSTSTAT4_ip_rst_usb2otgphy_por_END           (13)
#define SOC_CRGPERIPH_PERRSTSTAT4_ip_rst_usb2bc_32k_START             (14)
#define SOC_CRGPERIPH_PERRSTSTAT4_ip_rst_usb2bc_32k_END               (14)
...
#define SOC_CRGPERIPH_PERRSTSTAT4_ip_rst_usbotg2_apb_START            (27)
#define SOC_CRGPERIPH_PERRSTSTAT4_ip_rst_usbotg2_apb_END              (27)
...
typedef union
{
    ...
    struct
    {
        unsigned int  ip_prst_ctf      : 1;  /* bit[0]   :  */
        unsigned int  ip_rst_ctf_async : 1;  /* bit[1]   :  */
        unsigned int  reserved         : 30; /* bit[2-31]: 保留。 */
    } reg;
} SOC_CRGPERIPH_PERRSTEN5_UNION;
#endif
#define SOC_CRGPERIPH_PERRSTEN5_ip_prst_ctf_START       (0)
#define SOC_CRGPERIPH_PERRSTEN5_ip_prst_ctf_END         (0)
#define SOC_CRGPERIPH_PERRSTEN5_ip_rst_ctf_async_START  (1)
#define SOC_CRGPERIPH_PERRSTEN5_ip_rst_ctf_async_END    (1)
...
#endif
#define SOC_CRGPERIPH_PERRSTDIS5_ip_prst_ctf_START       (0)
#define SOC_CRGPERIPH_PERRSTDIS5_ip_prst_ctf_END         (0)
#define SOC_CRGPERIPH_PERRSTDIS5_ip_rst_ctf_async_START  (1)
#define SOC_CRGPERIPH_PERRSTDIS5_ip_rst_ctf_async_END    (1)
...
typedef union
{
    ...
    struct
    {
        unsigned int  ip_prst_ctf      : 1;  /* bit[0]   : IP软复位使能状态：
                                                           0：IP处于复位撤离状态；
                                                           1：IP处于软复位使能状态。 */
        unsigned int  ip_rst_ctf_async : 1;  /* bit[1]   :  */
        unsigned int  reserved         : 30; /* bit[2-31]: 保留。 */
...
#endif
#define SOC_CRGPERIPH_PERRSTSTAT5_ip_prst_ctf_START       (0)
#define SOC_CRGPERIPH_PERRSTSTAT5_ip_prst_ctf_END         (0)
#define SOC_CRGPERIPH_PERRSTSTAT5_ip_rst_ctf_async_START  (1)
#define SOC_CRGPERIPH_PERRSTSTAT5_ip_rst_ctf_async_END    (1)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  sc_div_lpmcu  : 5;  /* bit[5-9]  : LPMCU总线时钟分频比。（可选PPLL0\PPLL1分频，控制见sel_lpmcu）
                                                         ...
                                                         5'h1E:31；
                                                         5'h1F:32； */
        unsigned int  reserved_0    : 4;  /* bit[10-13]: IVP32DSP CORE时钟分频比。（可选PPLL0\PPLL1\PPLL2\PPLL3分频，控制见sel_ivp32dsp_core）
                                                         4'h0:1；
                                                         4'h1:2；
                                                         4'h2:3；
                                                         …
                                                         4'hE:15；
                                                         4'hF:16； */
        unsigned int  reserved_1    : 2;  /* bit[14-15]: IVP32DSP CORE时钟源选择。（可选PPLL0\PPLL1\PPLL2\PPLL3）
                                                         00:PPLL0；
                                                         01:PPLL1；
                                                         10:PPLL2；
                                                         11:PPLL3; */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  sel_uarth             : 1;  /* bit[3]    : UART1/UART4工作时钟源选择：
                                                                 0：19.2MHz时钟；
                                                                 1：从clk_a53hpm(480MHz时钟分频产生)。 */
        unsigned int  sel_gps_ref           : 1;  /* bit[4]    : GPS的时钟来源选择：
                                                                 0：mdm_pll0；
                                                                 1：mdm_pll1; */
        unsigned int  reserved_0            : 1;  /* bit[5]    : 保留。 */
        unsigned int  reserved_1            : 1;  /* bit[6]    : 保留。 */
...
#define SOC_CRGPERIPH_CLKDIV1_sel_gps_ref_START            (4)
#define SOC_CRGPERIPH_CLKDIV1_sel_gps_ref_END              (4)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  sc_sel_sdio0 : 3;  /* bit[11-13]: SDIO0时钟源选择。
                                                        ...
                                                        101:PPLL1；
                                                        11x:PPLL3; */
        unsigned int  reserved     : 2;  /* bit[14-15]: Dallas不用。LDI1时钟的PLL时钟源选择的高2bit */
        unsigned int  clkdivmasken : 16; /* bit[16-31]: clkdiv每个比特位的使能位：
                                                        只有当clkdivmasken对应的比特位为1'b1，clkdiv相应的比特位才起作用。Clkdivmasken[0]就是clkdiv[0]的mask使能位。写1有效。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CLKDIV5 寄存器结构定义。地址偏移量:0x0BC，初值:0x00004603，宽度:32
 寄存器说明: 时钟分频比控制寄存器5
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
typedef union
{
    ...
    struct
    {
        unsigned int  reserved_0   : 4;  /* bit[0-3]  : Dallas不用。SDIO1时钟分频比选择。
                                                        4'h0:1；
                                                        4'h1:2；
                                                        4'h2:3；
                                                        …
                                                        4'hE:15；
                                                        4'hF:16； */
        unsigned int  reserved_1   : 3;  /* bit[4-6]  : Dallas不用。SDIO1时钟源选择。
                                                        0xx:3.2M；
                                                        100:PPLL0；
                                                        101:PPLL1；
                                                        11x:PPLL3; */
        unsigned int  reserved_2   : 1;  /* bit[7]    : 保留。 */
        unsigned int  reserved_3   : 6;  /* bit[8-13] : Dallas不用。LDI1时钟分频比选择。
                                                        6'h0:1；
                                                        6'h1:2；
                                                        6'h2:3；
                                                        …
                                                        6'h3E:63；
                                                        6'h3F:64； */
        unsigned int  reserved_4   : 2;  /* bit[14-15]: Dallas不用。LDI1时钟的PLL时钟源选择的低2bit，高2bit见CLKDIV4[15:14]：
                                                        4'b0001:PPLL0；
                                                        4'b0010:PPLL2；
                                                        4'b0100:PPLL1；
                                                        4'b1000:PPLL3；
...
/*****************************************************************************
 ...
 结构说明  : CLKDIV7 寄存器结构定义。地址偏移量:0x0C4，初值:0x00005003，宽度:32
 寄存器说明: 时钟分频比控制寄存器7
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  sel_ispfunc1           : 2;  /* bit[5-6]  : ISPFUNC1 PLL时钟源选择：
                                                                  ...
                                                                  2'h01：PPLL1；
                                                                  2'h1x：PPLL3； */
        unsigned int  reserved_0             : 1;  /* bit[7]    : ISPFUNC 时钟源选择：
                                                                  1'h0：clk_ispfunc2；
                                                                  1'h1：clk_ispfunc1； */
...
/*****************************************************************************
 ...
 结构说明  : CLKDIV8 寄存器结构定义。地址偏移量:0x0C8，初值:0x000010C0，宽度:32
 寄存器说明: 时钟分频比控制寄存器8
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  reserved_0   : 5;  /* bit[0-4]  : ISPFUNC2 时钟分频比：
                                                        5'h0:1；
                                                        5'h1:2；
                                                        5'h2:3；
                                                        …
                                                        5'h1E:31；
                                                        5'h1F:32； */
        unsigned int  reserved_1   : 1;  /* bit[5]    : ISPFUNC2 PLL时钟源选择：
                                                        0：PPLL0；
                                                        1：PPLL1。 */
...
/*****************************************************************************
 ...
 结构说明  : CLKDIV9 寄存器结构定义。地址偏移量:0x0CC，初值:0x00000063，宽度:32
 寄存器说明: 时钟分频比控制寄存器9
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : CLKDIV10 寄存器结构定义。地址偏移量:0x0D0，初值:0x0000F1E3，宽度:32
 寄存器说明: 时钟分频比控制寄存器10
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  sc_sel_vivobus   : 2;  /* bit[12-13]: VIVOBUS PLL时钟源选择：
                                                            ...
                                                            2'b10:PPLL2；
                                                            2'b11:PPLL3； */
        unsigned int  reserved         : 2;  /* bit[14-15]: DALLAS 不用 CLK_PERF_STAT 时钟分频比：
                                                            2'h0:1；
                                                            2'h1:2；
                                                            2'h2:3；
                                                            2'h3:4； */
...
/*****************************************************************************
 ...
 结构说明  : CLKDIV11 寄存器结构定义。地址偏移量:0x0D4，初值:0x00007541，宽度:32
 寄存器说明: 时钟分频比控制寄存器11
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  sel_a53hpm       : 1;  /* bit[9]    : A53HPM PLL时钟源选择：
                                                            0：PPLL0；
                                                            1：PPLL1。 */
        unsigned int  div_loadmonitor0 : 2;  /* bit[10-11]: loadmonitor0的分频比：
                                                            2'h0:1;
                                                            2'h1:2;
                                                            2'h2:3;
                                                            2'h3:4; */
        unsigned int  reserved_0       : 3;  /* bit[12-14]: Dallas不用。OCB时钟分频比选择：
                                                            3'h0:1；
                                                            3'h1:2；
                                                            3'h2:3；
                                                            …
...
#define SOC_CRGPERIPH_CLKDIV11_div_loadmonitor0_START  (10)
#define SOC_CRGPERIPH_CLKDIV11_div_loadmonitor0_END    (11)
...
typedef union
{
    ...
    struct
    {
        unsigned int  sc_sel_clk_usb2phy_ref : 1;  /* bit[0]    : PERI_CRG 送给USB2PHY 参考时钟的时钟源选择：
                                                                  0:19.2M clk_usb2phy_ref;
...
#endif
#define SOC_CRGPERIPH_CLKDIV14_sc_sel_clk_usb2phy_ref_START  (0)
#define SOC_CRGPERIPH_CLKDIV14_sc_sel_clk_usb2phy_ref_END    (0)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  gt_clk_ddrc         : 1;  /* bit[2]    :  */
        unsigned int  gt_clk_loadmonitor0 : 1;  /* bit[3]    : 分频器前的门控 */
        unsigned int  gt_clk_lpmcu        : 1;  /* bit[4]    :  */
        unsigned int  reserved_0          : 1;  /* bit[5]    : 分频器前的门控 */
...
#define SOC_CRGPERIPH_CLKDIV18_gt_clk_loadmonitor0_START  (3)
#define SOC_CRGPERIPH_CLKDIV18_gt_clk_loadmonitor0_END    (3)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_4     : 1;  /* bit[9]    : 保留。 */
        unsigned int  reserved_5     : 1;  /* bit[10]   : 保留。 */
...
/*****************************************************************************
 ...
 结构说明  : CLKDIV22 寄存器结构定义。地址偏移量:0x100，初值:0x00000180，宽度:32
 寄存器说明: 时钟分频比控制寄存器22
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_1         : 4;  /* bit[7-10] : AONOMMBUF 400M备份时钟分频系数 */
...
typedef union
{
    ...
    struct
    {
        unsigned int  div_clk_ddrc       : 5;  /* bit[0-4]  : DDRC源时钟分频选择：
                                                              ...
                                                              5'h1E:15；
                                                              5'h1F:32； */
        unsigned int  reserved_0         : 2;  /* bit[5-6]  : dallas不用。DDRCFG时钟分频选择：
                                                              2'h0:1；
                                                              2'h1:2；
                                                              2'h2:3；
                                                              2'h3:4； */
        unsigned int  reserved_1         : 1;  /* bit[7]    : dallas不用。clk_ddrcfg门控使能信号：
                                                              0：时钟关闭；
                                                              1：时钟使能； */
        unsigned int  div_clk_ddrphy_ref : 1;  /* bit[8]    : ddrphy refclk分频选择：
                                                              1'h0：1；
                                                              1'h1：2； */
        unsigned int  reserved_2         : 1;  /* bit[9]    : dallas不用。ddrphy refclk分频使能：
                                                              0：分频使能撤销；
                                                              1：时钟使能有效； */
...
/*****************************************************************************
 ...
 结构说明  : CLKDIV24 寄存器结构定义。地址偏移量:0x108，初值:0x00000177，宽度:32
 寄存器说明: 时钟分频比控制寄存器24
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  sel_clk_isp_snclk           : 1;  /* bit[3]    : clk_isp_snclk_sys 时钟选择信号：
                                                                       0：clk_isp_snclk_sys；
                                                                       1：clk_isp_snclk_div； */
        unsigned int  atclk_to_iapa7_clkoff_sys   : 1;  /* bit[4]    : ATCLK_TO_ISPA7时钟使能系统控制：上电默认为1 。
                                                                       0：关闭ATCLK_TO_IAPA7
                                                                       1：打开ATCLK_TO_IAPA7 */
        unsigned int  pclkdbg_to_iapa7_clkoff_sys : 1;  /* bit[5]    : PCLKDBG_TO_ISPA7时钟使能系统控制，上电默认为1 。
                                                                       0：关闭PCLKDBG_TO_ISPA7
                                                                       1：打开PCLKDBG_TO_ISPA7 */
        unsigned int  sc_div_packdfi              : 3;  /* bit[6-8]  : pack dfi 的2分频时钟：
                                                                       8bit:门控，默认值1；
                                                                       7:6bit：是分频比，默认值1，
                                                                       2'h0:1分频；
                                                                       2'h1:2分频；
...
#define SOC_CRGPERIPH_CLKDIV24_sc_div_packdfi_START               (6)
#define SOC_CRGPERIPH_CLKDIV24_sc_div_packdfi_END                 (8)
...
/*****************************************************************************
 结构名    : SOC_CRGPERIPH_PERI_STAT0_UNION
 结构说明  : PERI_STAT0 寄存器结构定义。地址偏移量:0x110，初值:0x00000000，宽度:32
 寄存器说明: 外设状态寄存器0
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_CRGPERIPH_PERI_STAT1_UNION
 结构说明  : PERI_STAT1 寄存器结构定义。地址偏移量:0x114，初值:0x00000000，宽度:32
 寄存器说明: 外设状态寄存器1
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_CRGPERIPH_PERI_STAT2_UNION
 结构说明  : PERI_STAT2 寄存器结构定义。地址偏移量:0x118，初值:0x00104000，宽度:32
 寄存器说明: 外设状态寄存器2
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  swdone_clk_packdfi          : 1;  /* bit[5]    :  */
        ...
        unsigned int  swdone_clk_loadmonitor0_div : 1;  /* bit[11]   :  */
        ...
        unsigned int  swdone_clk_ddrphy_ref       : 1;  /* bit[23]   :  */
...
#define SOC_CRGPERIPH_PERI_STAT2_swdone_clk_packdfi_START           (5)
#define SOC_CRGPERIPH_PERI_STAT2_swdone_clk_packdfi_END             (5)
...
#define SOC_CRGPERIPH_PERI_STAT2_swdone_clk_loadmonitor0_div_START  (11)
#define SOC_CRGPERIPH_PERI_STAT2_swdone_clk_loadmonitor0_div_END    (11)
...
#define SOC_CRGPERIPH_PERI_STAT2_ddr_pll_sw_ack_START               (14)
#define SOC_CRGPERIPH_PERI_STAT2_ddr_pll_sw_ack_END                 (17)
...
#define SOC_CRGPERIPH_PERI_STAT2_swdone_clk_ddrphy_ref_START        (23)
#define SOC_CRGPERIPH_PERI_STAT2_swdone_clk_ddrphy_ref_END          (23)
...
#define SOC_CRGPERIPH_PERI_STAT2_swdone_clk_uarth_div_START         (25)
#define SOC_CRGPERIPH_PERI_STAT2_swdone_clk_uarth_div_END           (25)
#define SOC_CRGPERIPH_PERI_STAT2_swdone_clk_uartl_div_START         (26)
#define SOC_CRGPERIPH_PERI_STAT2_swdone_clk_uartl_div_END           (26)
...
/*****************************************************************************
 结构名    : SOC_CRGPERIPH_PERI_STAT3_UNION
 结构说明  : PERI_STAT3 寄存器结构定义。地址偏移量:0x11C，初值:0x15210120，宽度:32
 寄存器说明: 外设状态寄存器3
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  swdone_clk_dmabus_div          : 1;  /* bit[4]    : DIV分频比切换是否完成指示信号：
                                                                          0：未完成；
                                                                          1：完成； */
        unsigned int  reserved_0                     : 1;  /* bit[5]    : clk_ispfunc 切换时钟源指示信号：
        ...
        unsigned int  ldi0_pll_sw_ack                : 4;  /* bit[8-11] : ldi0 pll时钟源切换ack信号： 
                                                                          ...
                                                                          4'b0100:PPLL1；
                                                                          4'b1000:PPLL3； */
        unsigned int  reserved_1                     : 4;  /* bit[12-15]: Dallas不用。ldi1 pll时钟源切换ack信号： 
                                                                          4'b0001:PPLL0；
                                                                          4'b0010:PPLL2；
                                                                          4'b0100:PPLL1；
                                                                          4'b1000:PPLL3； */
        ...
        unsigned int  swdone_clk_cssysdbg_div        : 1;  /* bit[30]   : DIV分频比切换是否完成指示信号：
                                                                          0：未完成；
                                                                          1：完成； */
        unsigned int  reserved_2                     : 1;  /* bit[31]   : DIV分频比切换是否完成指示信号：
                                                                          0：未完成；
                                                                          1：完成； */
    } reg;
} SOC_CRGPERIPH_PERI_STAT3_UNION;
#endif
#define SOC_CRGPERIPH_PERI_STAT3_swdone_clk_out1_div1_START            (0)
#define SOC_CRGPERIPH_PERI_STAT3_swdone_clk_out1_div1_END              (0)
#define SOC_CRGPERIPH_PERI_STAT3_swdone_clk_cfgbus_div_START           (1)
#define SOC_CRGPERIPH_PERI_STAT3_swdone_clk_cfgbus_div_END             (1)
#define SOC_CRGPERIPH_PERI_STAT3_swdone_clk_dbgsechsic_bus_div_START   (2)
#define SOC_CRGPERIPH_PERI_STAT3_swdone_clk_dbgsechsic_bus_div_END     (2)
#define SOC_CRGPERIPH_PERI_STAT3_swdone_clk_modem_bbe16_tdl_div_START  (3)
#define SOC_CRGPERIPH_PERI_STAT3_swdone_clk_modem_bbe16_tdl_div_END    (3)
#define SOC_CRGPERIPH_PERI_STAT3_swdone_clk_dmabus_div_START           (4)
#define SOC_CRGPERIPH_PERI_STAT3_swdone_clk_dmabus_div_END             (4)
#define SOC_CRGPERIPH_PERI_STAT3_swdone_clk_slimbus_div_START          (6)
#define SOC_CRGPERIPH_PERI_STAT3_swdone_clk_slimbus_div_END            (6)
#define SOC_CRGPERIPH_PERI_STAT3_swdone_clk_ispa7_div_START            (7)
#define SOC_CRGPERIPH_PERI_STAT3_swdone_clk_ispa7_div_END              (7)
...
#define SOC_CRGPERIPH_PERI_STAT3_swdone_clk_cssysdbg_div_START         (30)
#define SOC_CRGPERIPH_PERI_STAT3_swdone_clk_cssysdbg_div_END           (30)


/*****************************************************************************
 结构名    : SOC_CRGPERIPH_PERI_CTRL0_UNION
 结构说明  : PERI_CTRL0 寄存器结构定义。地址偏移量:0x120，初值:0x000001FF，宽度:32
 寄存器说明: 外设控制寄存器0
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  gt_clk_cci400_bypass  : 1;  /* bit[8]   : Dallas中为CCI500，配置和CCI400保持一致。CCI-400时钟门控bypass控制：
...
#endif
#define SOC_CRGPERIPH_PERI_CTRL0_cactive_cci400_cfgcnt_START  (0)
#define SOC_CRGPERIPH_PERI_CTRL0_cactive_cci400_cfgcnt_END    (7)
#define SOC_CRGPERIPH_PERI_CTRL0_gt_clk_cci400_bypass_START   (8)
#define SOC_CRGPERIPH_PERI_CTRL0_gt_clk_cci400_bypass_END     (8)


/*****************************************************************************
 结构名    : SOC_CRGPERIPH_PERI_CTRL1_UNION
 结构说明  : PERI_CTRL1 寄存器结构定义。地址偏移量:0x124，初值:0x0000000F，宽度:32
 寄存器说明: 外设控制寄存器1
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
#define SOC_CRGPERIPH_PERI_CTRL1_gt_auto_clk_i2c34_bypass_START             (1)
#define SOC_CRGPERIPH_PERI_CTRL1_gt_auto_clk_i2c34_bypass_END               (1)
...
/*****************************************************************************
 结构名    : SOC_CRGPERIPH_PERI_CTRL2_UNION
 结构说明  : PERI_CTRL2 寄存器结构定义。地址偏移量:0x128，初值:0x7FE337FE，宽度:32
 寄存器说明: 外设控制寄存器2
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_CRGPERIPH_PERI_CTRL3_UNION
 结构说明  : PERI_CTRL3 寄存器结构定义。地址偏移量:0x12C，初值:0x00001001，宽度:32
 寄存器说明: 外设控制寄存器3
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_CRGPERIPH_PERI_CTRL4_UNION
 结构说明  : PERI_CTRL4 寄存器结构定义。地址偏移量:0x130，初值:0x00000000，宽度:32
 寄存器说明: 外设控制寄存器4
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  reserved_0: 1;  /* bit[0]   : modem的IPF门控控制信号 */
...
/*****************************************************************************
 结构名    : SOC_CRGPERIPH_PERI_CTRL5_UNION
 结构说明  : PERI_CTRL5 寄存器结构定义。地址偏移量:0x134，初值:0x00000000，宽度:32
 寄存器说明: 外设控制寄存器5
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_CRGPERIPH_PERI_CTRL6_UNION
 结构说明  : PERI_CTRL6 寄存器结构定义。地址偏移量:0x138，初值:0x00000000，宽度:32
 寄存器说明: 外设控制寄存器6
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_6       : 1;  /* bit[24]   : IVP32DSP子系统ISO单元使能控制：写1执行ISO使能操作。 */
        unsigned int  reserved_7       : 7;  /* bit[25-31]: 保留。 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_6       : 1;  /* bit[24]   : IVP32DSP子系统ISO单元使能控制：写1执行ISO使能撤消操作。 */
        unsigned int  reserved_7       : 7;  /* bit[25-31]: 保留。 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_6       : 1;  /* bit[24]   : IVP32DSP子系统ISO单元使能状态：0：不使能；1：使能。 */
        unsigned int  reserved_7       : 7;  /* bit[25-31]: 保留。 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_7      : 1;  /* bit[21]   : IVP32DSP子系统电源使能控制：写1执行电源使能操作。 */
        unsigned int  reserved_8      : 10; /* bit[22-31]: 保留。 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_7       : 1;  /* bit[21]   : IVP32DSP子系统电源使能控制：写1执行电源使能撤销操作。 */
        unsigned int  reserved_8       : 10; /* bit[22-31]: 保留。 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  modemirmpwrstat   : 1;  /* bit[20]   : MODEM子系统IRM电源使能状态：
                                                             0：MODEM子系统IRM电源使能撤销；
                                                             1：MODEM子系统IRM电源使能。 */
        unsigned int  reserved_7        : 1;  /* bit[21]   : IVP32DSP子系统电源使能状态：
                                                             0：IVP32DSP子系统电源使能撤销；
                                                             1：IVP32DSP子系统电源使能。 */
        unsigned int  reserved_8        : 10; /* bit[22-31]: 保留。 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  modemirmpwrack    : 1;  /* bit[28]   : MODEM子系统IRM电源使能状态：
                                                             0：MODEM子系统IRM电源切断状态
                                                             1：MODEM子系统IRM电源供给状态 */
        unsigned int  reserved_8        : 1;  /* bit[29]   : IVP32DSP子系统电源使能状态：
                                                             0：IVP32DSP子系统电源切断状态
                                                             1：IVP32DSP子系统电源供给状态 */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved         : 2;  /* bit[30-31]: Dallas中A53小核。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : MAIA_CTRL1 寄存器结构定义。地址偏移量:0x1DC，初值:0x00000013，宽度:32
 寄存器说明: A57 CLUSTER控制配置寄存器1
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : MAIA_CTRL2 寄存器结构定义。地址偏移量:0x1E0，初值:0x09F1C020，宽度:32
 寄存器说明: A57 CLUSTER控制配置寄存器2
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
#define SOC_CRGPERIPH_MAIA_CTRL2_a53_l2_input_lat_sel_START     (27)
#define SOC_CRGPERIPH_MAIA_CTRL2_a53_l2_input_lat_sel_END       (27)
#define SOC_CRGPERIPH_MAIA_CTRL2_a53_l2_output_lat_sel_START    (28)
#define SOC_CRGPERIPH_MAIA_CTRL2_a53_l2_output_lat_sel_END      (28)
#define SOC_CRGPERIPH_MAIA_CTRL2_a53_stretch_l2ramclk_en_START  (29)
#define SOC_CRGPERIPH_MAIA_CTRL2_a53_stretch_l2ramclk_en_END    (29)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  a53_dbgack       : 1;  /* bit[13]   : A53 core进入debug状态后的状态指示，高有效。当任一core进入debug状态时，该信号有效 */
        unsigned int  a53_l2flushdone  : 1;  /* bit[14]   : L2硬件flush已完成。 */
        unsigned int  a57_idle_flag    : 1;  /* bit[15]   : a53idle指示状态，为1表示idle，可以切tcxo */
        unsigned int  a53_sbgpwrupreq  : 4;  /* bit[16-19]: Processor powerup request:
                                                            0: No request for processor power up.
                                                            1: Request for processor power up. */
        unsigned int  a53_dbgnopwrdwn  : 4;  /* bit[20-23]: No powerdown request. On a powerdown request:
                                                            ...
                                                            1: The SoC power controller does not power down the processor */
        unsigned int  a53_snoop_cnt    : 6;  /* bit[24-29]: A53 snoop counter计数值 */
        unsigned int  reserved         : 2;  /* bit[30-31]: Dallas中A53大核。 */
    } reg;
} SOC_CRGPERIPH_MAIA_STAT_UNION;
#endif
#define SOC_CRGPERIPH_MAIA_STAT_a53_standbywfi_START    (0)
#define SOC_CRGPERIPH_MAIA_STAT_a53_standbywfi_END      (3)
#define SOC_CRGPERIPH_MAIA_STAT_a53_standbywfe_START    (4)
#define SOC_CRGPERIPH_MAIA_STAT_a53_standbywfe_END      (7)
#define SOC_CRGPERIPH_MAIA_STAT_a53_smpen_START         (8)
#define SOC_CRGPERIPH_MAIA_STAT_a53_smpen_END           (11)
#define SOC_CRGPERIPH_MAIA_STAT_a53_standbywfil2_START  (12)
#define SOC_CRGPERIPH_MAIA_STAT_a53_standbywfil2_END    (12)
#define SOC_CRGPERIPH_MAIA_STAT_a53_dbgack_START        (13)
#define SOC_CRGPERIPH_MAIA_STAT_a53_dbgack_END          (13)
#define SOC_CRGPERIPH_MAIA_STAT_a53_l2flushdone_START   (14)
#define SOC_CRGPERIPH_MAIA_STAT_a53_l2flushdone_END     (14)
#define SOC_CRGPERIPH_MAIA_STAT_a57_idle_flag_START     (15)
#define SOC_CRGPERIPH_MAIA_STAT_a57_idle_flag_END       (15)
#define SOC_CRGPERIPH_MAIA_STAT_a53_sbgpwrupreq_START   (16)
#define SOC_CRGPERIPH_MAIA_STAT_a53_sbgpwrupreq_END     (19)
#define SOC_CRGPERIPH_MAIA_STAT_a53_dbgnopwrdwn_START   (20)
#define SOC_CRGPERIPH_MAIA_STAT_a53_dbgnopwrdwn_END     (23)
#define SOC_CRGPERIPH_MAIA_STAT_a53_snoop_cnt_START     (24)
#define SOC_CRGPERIPH_MAIA_STAT_a53_snoop_cnt_END       (29)


/*****************************************************************************
 结构名    : SOC_CRGPERIPH_CORESIGHT_STAT_UNION
 结构说明  : CORESIGHT_STAT 寄存器结构定义。地址偏移量:0x200，初值:0x00000000，宽度:32
 寄存器说明: core sight状态寄存器
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_CRGPERIPH_CORESIGHT_CTRL_UNION
 结构说明  : CORESIGHT_CTRL 寄存器结构定义。地址偏移量:0x208，初值:0x00000000，宽度:32
 寄存器说明: core sight控制配置寄存器0
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_CRGPERIPH_ADB400_STAT_UNION
 结构说明  : ADB400_STAT 寄存器结构定义。地址偏移量:0x220，初值:0x00000000，宽度:32
 寄存器说明: ADB400状态寄存器
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_0            : 1;  /* bit[3]   : indicates if there is still an transaction in the bridge */
...
/*****************************************************************************
 结构名    : SOC_CRGPERIPH_CCI400_CTRL0_UNION
 结构说明  : CCI400_CTRL0 寄存器结构定义。地址偏移量:0x228，初值:0x00000000，宽度:32
 寄存器说明: CCI400控制配置寄存器0
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_2: 11; /* bit[2-12] : 覆盖 AWCACHE[0]和ARCACHE[0] 的输出为non-bufferable，一个bit对应一个master接口。 */
        unsigned int  reserved_3: 3;  /* bit[13-15]: barrier操作是terminate类型还是传输类型，一个bit对应一个master接口。 */
        unsigned int  reserved_4: 13; /* bit[16-28]: 保留。 */
        unsigned int  reserved_5: 3;  /* bit[29-31]: 配置cci交织粒度。 */
    } reg;
...
/*****************************************************************************
 结构名    : SOC_CRGPERIPH_CCI400_CTRL1_UNION
 结构说明  : CCI400_CTRL1 寄存器结构定义。地址偏移量:0x22C，初值:0x00006000，宽度:32
 寄存器说明: CCI400控制配置寄存器1
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  cci_ecorevnum : 4;  /* bit[0-3]  : 用于ECO时，CCI内部寄存器对于ECO版本进行记录。 */
        unsigned int  reserved_0    : 1;  /* bit[4]    : cci500 snoop filter RAM 动态retention使能控制信号。 */
        unsigned int  reserved_1    : 3;  /* bit[5-7]  : cci500 snoop filter RAM normal状态控制字，{SD，DSLP，SLP}，默认值3'b0。 */
        unsigned int  cci_ctrl_ret  : 3;  /* bit[8-10] : cci500 snoop filter RAM retention状态控制字，{SD，DSLP，SLP},默认值3'b010。 */
        unsigned int  reserved_2    : 6;  /* bit[11-16]: cci500 snoop filter RAM退出retention状态的等待时间默认值6'h0C。 */
        unsigned int  reserved_3    : 1;  /* bit[17]   : cci500 snoop filter RAM退出retention状态等待时间变化指示信号默认值1'b0。 */
        unsigned int  reserved_4    : 8;  /* bit[18-25]:  */
        unsigned int  reserved_5    : 1;  /* bit[26]   : CCI内部信号观测是否使能，1为使能 */
        unsigned int  reserved_6    : 4;  /* bit[27-30]: 用于ECO时，CCI内部寄存器对于ECO版本进行记录。 */
        unsigned int  reserved_7    : 1;  /* bit[31]   : CCI400相关寄存器为Dallas中CCI500的配置。 */
    } reg;
} SOC_CRGPERIPH_CCI400_CTRL1_UNION;
#endif
#define SOC_CRGPERIPH_CCI400_CTRL1_cci_ecorevnum_START  (0)
#define SOC_CRGPERIPH_CCI400_CTRL1_cci_ecorevnum_END    (3)
#define SOC_CRGPERIPH_CCI400_CTRL1_cci_ctrl_ret_START   (8)
#define SOC_CRGPERIPH_CCI400_CTRL1_cci_ctrl_ret_END     (10)


/*****************************************************************************
 结构名    : SOC_CRGPERIPH_CCI400_STAT_UNION
 结构说明  : CCI400_STAT 寄存器结构定义。地址偏移量:0x230，初值:0x00000000，宽度:32
 寄存器说明: CCI400状态寄存器
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  reserved_0    : 1;  /* bit[0]    : clock gating输出，输出给外部状态控制器，做低功耗控制使用 */
        unsigned int  reserved_1    : 1;  /* bit[1]    : clock gating输出，输出给外部状态控制器，做低功耗控制使用 */
        unsigned int  reserved_2    : 1;  /* bit[2]    : clock gating输出，输出给外部状态控制器，做低功耗控制使用 */
        unsigned int  cci_awakeupm2 : 1;  /* bit[3]    : 可读，只记录状态
                                                         ACTIVE信号需要同步处理，用于门控下一级电路。 */
        unsigned int  cci_awakeupm0 : 1;  /* bit[4]    : 可读，只记录状态
                                                         ACTIVE信号需要同步处理，用于门控下一级电路。 */
        unsigned int  cci_pactive   : 5;  /* bit[5-9]  : cci500 P-channel状态指示信号，bit[4]表示snoop filter是否有访问进行，bit[3]表示cci是否有访问进行，高有效。其余bit常为0。 */
        unsigned int  reserved_3    : 22; /* bit[10-31]: 保留。 */
    } reg;
} SOC_CRGPERIPH_CCI400_STAT_UNION;
#endif
#define SOC_CRGPERIPH_CCI400_STAT_cci_awakeupm2_START  (3)
#define SOC_CRGPERIPH_CCI400_STAT_cci_awakeupm2_END    (3)
#define SOC_CRGPERIPH_CCI400_STAT_cci_awakeupm0_START  (4)
#define SOC_CRGPERIPH_CCI400_STAT_cci_awakeupm0_END    (4)
#define SOC_CRGPERIPH_CCI400_STAT_cci_pactive_START    (5)
#define SOC_CRGPERIPH_CCI400_STAT_cci_pactive_END      (9)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  ipc_mdm_s_clkrst_bypass : 1;  /* bit[6] :  */
...
#define SOC_CRGPERIPH_IPCLKRST_BYPASS1_ipc_mdm_s_clkrst_bypass_START  (6)
#define SOC_CRGPERIPH_IPCLKRST_BYPASS1_ipc_mdm_s_clkrst_bypass_END    (6)
...
#define SOC_CRGPERIPH_IPCLKRST_BYPASS1_usb2otg_clkrst_bypass_START    (27)
#define SOC_CRGPERIPH_IPCLKRST_BYPASS1_usb2otg_clkrst_bypass_END      (27)
...
typedef union
{
    ...
    struct
    {
        unsigned int  g3d_clkrst_bypass           : 1;  /* bit[0]    : 防挂死功能byapss控制：
                                                                       0：bypass无效；
                                                                       1：bypass有效。 */
        unsigned int  psam_clkrst_bypass          : 1;  /* bit[1]    : 保留。 */
        unsigned int  reserved_0                  : 1;  /* bit[2]    : 保留。 */
        unsigned int  usb2otg_mux_clkrst_bypass   : 1;  /* bit[3]    :  */
        unsigned int  usb2otg_ahbif_clkrst_bypass : 1;  /* bit[4]    :  */
        unsigned int  reserved_1                  : 1;  /* bit[5]    : 保留。 */
        ...
        unsigned int  hkadcssi1_clkrst_bypass     : 1;  /* bit[12]   :  */
        unsigned int  ipf_mdm_clkrst_bypass       : 1;  /* bit[13]   :  */
        unsigned int  loadmonitor_clkrst_bypass   : 1;  /* bit[14]   :  */
        unsigned int  ctf_clkrst_bypass           : 1;  /* bit[15]   :  */
...
#define SOC_CRGPERIPH_IPCLKRST_BYPASS2_psam_clkrst_bypass_START           (1)
#define SOC_CRGPERIPH_IPCLKRST_BYPASS2_psam_clkrst_bypass_END             (1)
#define SOC_CRGPERIPH_IPCLKRST_BYPASS2_usb2otg_mux_clkrst_bypass_START    (3)
#define SOC_CRGPERIPH_IPCLKRST_BYPASS2_usb2otg_mux_clkrst_bypass_END      (3)
#define SOC_CRGPERIPH_IPCLKRST_BYPASS2_usb2otg_ahbif_clkrst_bypass_START  (4)
#define SOC_CRGPERIPH_IPCLKRST_BYPASS2_usb2otg_ahbif_clkrst_bypass_END    (4)
...
#define SOC_CRGPERIPH_IPCLKRST_BYPASS2_hkadcssi1_clkrst_bypass_START      (12)
#define SOC_CRGPERIPH_IPCLKRST_BYPASS2_hkadcssi1_clkrst_bypass_END        (12)
...
typedef union
{
    ...
    struct
    {
        unsigned int  a53_0_pdc_en : 1;  /* bit[0]   : A53_0上下电状态机使能寄存器
                                                       0：状态机不使能
                                                       1：状态机使能 */
        unsigned int  reserved     : 31; /* bit[1-31]: A53_*为Dallas中A53小核的相关寄存器保留。 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  a57_1_pdc_en : 1;  /* bit[0]   : A53_1上下电状态机使能寄存器
                                                       0：状态机不使能
                                                       1：状态机使能 */
        unsigned int  reserved     : 31; /* bit[1-31]: MAIA_*为Dallas中A53大核的相关寄存器保留。 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  reserved_0: 1;  /* bit[0]    : 硬件自动降频功能bypass配置：
                                                     0：不bypass；
                                                     1：bypass。 */
        unsigned int  reserved_1: 10; /* bit[1-10] : 硬件进入自动降频IDLE等待时钟周期配置 */
        unsigned int  reserved_2: 10; /* bit[11-20]: 硬件退出自动降频IDLE等待时钟周期配置 */
        unsigned int  reserved_3: 6;  /* bit[21-26]: 硬件自动降频倍数配置
                                                     6'h00:1；
                                                     6'h01:2；
                                                     …
                                                     6'h3F:64； */
        unsigned int  reserved_4: 1;  /* bit[27]   : dw_axi_m1_st 是否加入自动降频判断条件：
                                                     1'h0:加入；
                                                     1'h1:不加入； */
        unsigned int  reserved_5: 1;  /* bit[28]   : dw_axi_m1_st 是否加入自动降频判断条件：
                                                     1'h0:加入；
                                                     1'h1:不加入； */
        unsigned int  reserved_6: 1;  /* bit[29]   : dw_axi_m2_st 是否加入自动降频判断条件：
                                                     1'h0:加入；
                                                     1'h1:不加入； */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  vivobus_ispa7_bypass           : 1;  /* bit[31]   : iaps7是否加入自动降频判断条件： */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  vcodecbus_vdec_bypass            : 1;  /* bit[31]   : vdec是否加入自动降频判断条件： */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  sysbus_usb2_bypass          : 1;  /* bit[3]    :  */
...
#define SOC_CRGPERIPH_PERI_AUTODIV7_sysbus_ipf_bypass_START            (18)
#define SOC_CRGPERIPH_PERI_AUTODIV7_sysbus_ipf_bypass_END              (18)
...
/*****************************************************************************
 ...
 结构说明  : PERI_AUTODIV10 寄存器结构定义。地址偏移量:0x388，初值:0x00707BFF，宽度:32
 寄存器说明: 外设自动降频控制寄存器10
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  dbgbus_sysbus_relate_auto_reduce_bypass : 1;  /* bit[19]   : sysbus降频时dbgbus是否自动退出自动降频bypass控制（sysbus自动降频时dbgbus是否自动退出自动降频）：
                                                                                   1'h0:不bypass（退出）；
                                                                                   1'h1:bypass（不退出）； */
        unsigned int  dbgbus_div_auto_cfg                     : 3;  /* bit[20-22]: 硬件自动降频倍数配置
                                                                                   3'h00:1；
                                                                                   3'h01:2；
                                                                                   …
                                                                                   3'h7:8； */
        unsigned int  dbgbus_ipf_bypass                       : 1;  /* bit[23]   : ipf是否加入自动降频判断条件：
                                                                                   1'h0:加入；
                                                                                   1'h1:不加入； */
        ...
        unsigned int  dbgbus_secs_bypass                      : 1;  /* bit[28]   : secs是否加入自动降频判断条件：
                                                                                   1'h0:加入；
                                                                                   1'h1:不加入； */
        unsigned int  dbgbus_usb2_bypass                      : 1;  /* bit[29]   : usb2是否加入自动降频判断条件：
                                                                                   1'h0:加入；
                                                                                   1'h1:不加入； */
        unsigned int  dbgbus_perf_stat_bypass                 : 1;  /* bit[30]   : perf_stat是否加入自动降频判断条件：
                                                                                   1'h0:加入；
                                                                                   1'h1:不加入； */
        unsigned int  dbgbus_top_cssys_bypass                 : 1;  /* bit[31]   : top_cssys是否加入自动降频判断条件：
                                                                                   1'h0:加入；
                                                                                   1'h1:不加入； */
    } reg;
...
#define SOC_CRGPERIPH_PERI_AUTODIV10_dbgbus_div_auto_cfg_END                        (22)
#define SOC_CRGPERIPH_PERI_AUTODIV10_dbgbus_ipf_bypass_START                        (23)
#define SOC_CRGPERIPH_PERI_AUTODIV10_dbgbus_ipf_bypass_END                          (23)
...
#define SOC_CRGPERIPH_PERI_AUTODIV10_dbgbus_usb2_bypass_START                       (29)
#define SOC_CRGPERIPH_PERI_AUTODIV10_dbgbus_usb2_bypass_END                         (29)
...
/*****************************************************************************
 ...
 结构说明  : PERSTAT6 寄存器结构定义。地址偏移量:0x41C，初值:0xFFFF8001，宽度:32
 寄存器说明: 外设时钟最终状态寄存器6
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
typedef union
{
    ...
    struct
    {
        unsigned int  gt_clk_ddr_pub_pipereg_wr_0 : 1;  /* bit[0]    : 外设时钟使能控制：
                                                                       0：写0无效果；
                                                                       1：使能IP时钟。 */
        unsigned int  gt_clk_ddr_pub_pipereg_wr_1 : 1;  /* bit[1]    :  */
        unsigned int  gt_clk_ddr_pub_pipereg_rd_0 : 1;  /* bit[2]    :  */
        unsigned int  gt_clk_ddr_pub_pipereg_rd_1 : 1;  /* bit[3]    :  */
        unsigned int  gt_clk_ddrphy_gt            : 1;  /* bit[4]    : ddrphy rs/phy 相关时钟总门控 */
        unsigned int  gt_clk_ddrphy_dfi           : 1;  /* bit[5]    :  */
        unsigned int  gt_pclk_ctf                 : 1;  /* bit[6]    :  */
        unsigned int  gt_clk_ctf_async            : 1;  /* bit[7]    :  */
        unsigned int  reserved_0                  : 1;  /* bit[8]    :  */
        unsigned int  gt_clk_ddrphy_dfi_dly       : 1;  /* bit[9]    :  */
        unsigned int  reserved_1                  : 22; /* bit[10-31]:  */
    } reg;
} SOC_CRGPERIPH_PEREN7_UNION;
#endif
#define SOC_CRGPERIPH_PEREN7_gt_clk_ddr_pub_pipereg_wr_0_START  (0)
#define SOC_CRGPERIPH_PEREN7_gt_clk_ddr_pub_pipereg_wr_0_END    (0)
#define SOC_CRGPERIPH_PEREN7_gt_clk_ddr_pub_pipereg_wr_1_START  (1)
#define SOC_CRGPERIPH_PEREN7_gt_clk_ddr_pub_pipereg_wr_1_END    (1)
#define SOC_CRGPERIPH_PEREN7_gt_clk_ddr_pub_pipereg_rd_0_START  (2)
#define SOC_CRGPERIPH_PEREN7_gt_clk_ddr_pub_pipereg_rd_0_END    (2)
#define SOC_CRGPERIPH_PEREN7_gt_clk_ddr_pub_pipereg_rd_1_START  (3)
#define SOC_CRGPERIPH_PEREN7_gt_clk_ddr_pub_pipereg_rd_1_END    (3)
#define SOC_CRGPERIPH_PEREN7_gt_clk_ddrphy_gt_START             (4)
#define SOC_CRGPERIPH_PEREN7_gt_clk_ddrphy_gt_END               (4)
#define SOC_CRGPERIPH_PEREN7_gt_clk_ddrphy_dfi_START            (5)
#define SOC_CRGPERIPH_PEREN7_gt_clk_ddrphy_dfi_END              (5)
#define SOC_CRGPERIPH_PEREN7_gt_pclk_ctf_START                  (6)
#define SOC_CRGPERIPH_PEREN7_gt_pclk_ctf_END                    (6)
#define SOC_CRGPERIPH_PEREN7_gt_clk_ctf_async_START             (7)
#define SOC_CRGPERIPH_PEREN7_gt_clk_ctf_async_END               (7)
#define SOC_CRGPERIPH_PEREN7_gt_clk_ddrphy_dfi_dly_START        (9)
#define SOC_CRGPERIPH_PEREN7_gt_clk_ddrphy_dfi_dly_END          (9)
...
typedef union
{
    ...
    struct
    {
        unsigned int  gt_clk_ddr_pub_pipereg_wr_0 : 1;  /* bit[0]    : 外设时钟禁止控制：
                                                                       0：写0无效果；
                                                                       1：禁止IP时钟。 */
        unsigned int  gt_clk_ddr_pub_pipereg_wr_1 : 1;  /* bit[1]    :  */
        unsigned int  gt_clk_ddr_pub_pipereg_rd_0 : 1;  /* bit[2]    :  */
...
#endif
#define SOC_CRGPERIPH_PERDIS7_gt_clk_ddr_pub_pipereg_wr_0_START  (0)
#define SOC_CRGPERIPH_PERDIS7_gt_clk_ddr_pub_pipereg_wr_0_END    (0)
#define SOC_CRGPERIPH_PERDIS7_gt_clk_ddr_pub_pipereg_wr_1_START  (1)
#define SOC_CRGPERIPH_PERDIS7_gt_clk_ddr_pub_pipereg_wr_1_END    (1)
#define SOC_CRGPERIPH_PERDIS7_gt_clk_ddr_pub_pipereg_rd_0_START  (2)
#define SOC_CRGPERIPH_PERDIS7_gt_clk_ddr_pub_pipereg_rd_0_END    (2)
#define SOC_CRGPERIPH_PERDIS7_gt_clk_ddr_pub_pipereg_rd_1_START  (3)
#define SOC_CRGPERIPH_PERDIS7_gt_clk_ddr_pub_pipereg_rd_1_END    (3)
#define SOC_CRGPERIPH_PERDIS7_gt_clk_ddrphy_gt_START             (4)
#define SOC_CRGPERIPH_PERDIS7_gt_clk_ddrphy_gt_END               (4)
#define SOC_CRGPERIPH_PERDIS7_gt_clk_ddrphy_dfi_START            (5)
#define SOC_CRGPERIPH_PERDIS7_gt_clk_ddrphy_dfi_END              (5)
#define SOC_CRGPERIPH_PERDIS7_gt_pclk_ctf_START                  (6)
#define SOC_CRGPERIPH_PERDIS7_gt_pclk_ctf_END                    (6)
#define SOC_CRGPERIPH_PERDIS7_gt_clk_ctf_async_START             (7)
#define SOC_CRGPERIPH_PERDIS7_gt_clk_ctf_async_END               (7)
#define SOC_CRGPERIPH_PERDIS7_gt_clk_ddrphy_dfi_dly_START        (9)
#define SOC_CRGPERIPH_PERDIS7_gt_clk_ddrphy_dfi_dly_END          (9)


/*****************************************************************************
 结构名    : SOC_CRGPERIPH_PERCLKEN7_UNION
 结构说明  : PERCLKEN7 寄存器结构定义。地址偏移量:0x428，初值:0x0000023F，宽度:32
 寄存器说明: 外设时钟使能状态寄存器7
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  gt_clk_ddr_pub_pipereg_wr_0 : 1;  /* bit[0]    : 外设时钟使能状态：
                                                                       0：IP时钟使能撤销状态；
                                                                       1：IP时钟使能状态。 */
        unsigned int  gt_clk_ddr_pub_pipereg_wr_1 : 1;  /* bit[1]    :  */
        unsigned int  gt_clk_ddr_pub_pipereg_rd_0 : 1;  /* bit[2]    :  */
        unsigned int  gt_clk_ddr_pub_pipereg_rd_1 : 1;  /* bit[3]    :  */
        unsigned int  gt_clk_ddrphy_gt            : 1;  /* bit[4]    : ddrphy rs/phy 相关时钟总门控 */
        unsigned int  gt_clk_ddrphy_dfi           : 1;  /* bit[5]    : 默认时钟打开。 */
        unsigned int  gt_pclk_ctf                 : 1;  /* bit[6]    :  */
        unsigned int  gt_clk_ctf_async            : 1;  /* bit[7]    :  */
        unsigned int  reserved_0                  : 1;  /* bit[8]    :  */
        unsigned int  gt_clk_ddrphy_dfi_dly       : 1;  /* bit[9]    :  */
...
#endif
#define SOC_CRGPERIPH_PERCLKEN7_gt_clk_ddr_pub_pipereg_wr_0_START  (0)
#define SOC_CRGPERIPH_PERCLKEN7_gt_clk_ddr_pub_pipereg_wr_0_END    (0)
#define SOC_CRGPERIPH_PERCLKEN7_gt_clk_ddr_pub_pipereg_wr_1_START  (1)
#define SOC_CRGPERIPH_PERCLKEN7_gt_clk_ddr_pub_pipereg_wr_1_END    (1)
#define SOC_CRGPERIPH_PERCLKEN7_gt_clk_ddr_pub_pipereg_rd_0_START  (2)
#define SOC_CRGPERIPH_PERCLKEN7_gt_clk_ddr_pub_pipereg_rd_0_END    (2)
#define SOC_CRGPERIPH_PERCLKEN7_gt_clk_ddr_pub_pipereg_rd_1_START  (3)
#define SOC_CRGPERIPH_PERCLKEN7_gt_clk_ddr_pub_pipereg_rd_1_END    (3)
#define SOC_CRGPERIPH_PERCLKEN7_gt_clk_ddrphy_gt_START             (4)
#define SOC_CRGPERIPH_PERCLKEN7_gt_clk_ddrphy_gt_END               (4)
#define SOC_CRGPERIPH_PERCLKEN7_gt_clk_ddrphy_dfi_START            (5)
#define SOC_CRGPERIPH_PERCLKEN7_gt_clk_ddrphy_dfi_END              (5)
#define SOC_CRGPERIPH_PERCLKEN7_gt_pclk_ctf_START                  (6)
#define SOC_CRGPERIPH_PERCLKEN7_gt_pclk_ctf_END                    (6)
#define SOC_CRGPERIPH_PERCLKEN7_gt_clk_ctf_async_START             (7)
#define SOC_CRGPERIPH_PERCLKEN7_gt_clk_ctf_async_END               (7)
#define SOC_CRGPERIPH_PERCLKEN7_gt_clk_ddrphy_dfi_dly_START        (9)
#define SOC_CRGPERIPH_PERCLKEN7_gt_clk_ddrphy_dfi_dly_END          (9)


/*****************************************************************************
 结构名    : SOC_CRGPERIPH_PERSTAT7_UNION
 结构说明  : PERSTAT7 寄存器结构定义。地址偏移量:0x42C，初值:0xFFFFFE3F，宽度:32
 寄存器说明: 外设时钟最终状态寄存器7
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  gt_clk_ddr_pub_pipereg_wr_0 : 1;  /* bit[0]    : 外设时钟最终状态：
                                                                       0：IP时钟禁止状态；
                                                                       1：IP时钟使能状态。 */
        unsigned int  gt_clk_ddr_pub_pipereg_wr_1 : 1;  /* bit[1]    :  */
        unsigned int  gt_clk_ddr_pub_pipereg_rd_0 : 1;  /* bit[2]    :  */
        ...
        unsigned int  gt_clk_ddrphy_dfi           : 1;  /* bit[5]    : 默认时钟打开。 */
        unsigned int  gt_pclk_ctf                 : 1;  /* bit[6]    :  */
        unsigned int  gt_pclk_ctf_async           : 1;  /* bit[7]    :  */
        unsigned int  gt_aclk_ctf_async           : 1;  /* bit[8]    :  */
        unsigned int  gt_clk_ddrphy_dfi_dly       : 1;  /* bit[9]    : 时钟默认打开 */
        unsigned int  reserved                    : 22; /* bit[10-31]:  */
    } reg;
} SOC_CRGPERIPH_PERSTAT7_UNION;
#endif
#define SOC_CRGPERIPH_PERSTAT7_gt_clk_ddr_pub_pipereg_wr_0_START  (0)
#define SOC_CRGPERIPH_PERSTAT7_gt_clk_ddr_pub_pipereg_wr_0_END    (0)
#define SOC_CRGPERIPH_PERSTAT7_gt_clk_ddr_pub_pipereg_wr_1_START  (1)
#define SOC_CRGPERIPH_PERSTAT7_gt_clk_ddr_pub_pipereg_wr_1_END    (1)
#define SOC_CRGPERIPH_PERSTAT7_gt_clk_ddr_pub_pipereg_rd_0_START  (2)
#define SOC_CRGPERIPH_PERSTAT7_gt_clk_ddr_pub_pipereg_rd_0_END    (2)
#define SOC_CRGPERIPH_PERSTAT7_gt_clk_ddr_pub_pipereg_rd_1_START  (3)
#define SOC_CRGPERIPH_PERSTAT7_gt_clk_ddr_pub_pipereg_rd_1_END    (3)
#define SOC_CRGPERIPH_PERSTAT7_gt_clk_ddrphy_gt_START             (4)
#define SOC_CRGPERIPH_PERSTAT7_gt_clk_ddrphy_gt_END               (4)
#define SOC_CRGPERIPH_PERSTAT7_gt_clk_ddrphy_dfi_START            (5)
#define SOC_CRGPERIPH_PERSTAT7_gt_clk_ddrphy_dfi_END              (5)
#define SOC_CRGPERIPH_PERSTAT7_gt_pclk_ctf_START                  (6)
#define SOC_CRGPERIPH_PERSTAT7_gt_pclk_ctf_END                    (6)
#define SOC_CRGPERIPH_PERSTAT7_gt_pclk_ctf_async_START            (7)
#define SOC_CRGPERIPH_PERSTAT7_gt_pclk_ctf_async_END              (7)
#define SOC_CRGPERIPH_PERSTAT7_gt_aclk_ctf_async_START            (8)
#define SOC_CRGPERIPH_PERSTAT7_gt_aclk_ctf_async_END              (8)
#define SOC_CRGPERIPH_PERSTAT7_gt_clk_ddrphy_dfi_dly_START        (9)
#define SOC_CRGPERIPH_PERSTAT7_gt_clk_ddrphy_dfi_dly_END          (9)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  ip_rst_isp_timer : 1;  /* bit[5]   :  */
        unsigned int  reserved         : 26; /* bit[6-31]: 保留。 */
    } reg;
...
#define SOC_CRGPERIPH_ISP_SEC_RSTEN_ip_rst_isp_timer_START  (5)
#define SOC_CRGPERIPH_ISP_SEC_RSTEN_ip_rst_isp_timer_END    (5)
...
#define SOC_CRGPERIPH_ISP_SEC_RSTDIS_ip_rst_isp_timer_START  (5)
#define SOC_CRGPERIPH_ISP_SEC_RSTDIS_ip_rst_isp_timer_END    (5)


/*****************************************************************************
 结构名    : SOC_CRGPERIPH_ISP_SEC_RSTSTAT_UNION
 结构说明  : ISP_SEC_RSTSTAT 寄存器结构定义。地址偏移量:0xC88，初值:0x0000003F，宽度:32
 寄存器说明: ISP安全软复位状态寄存器
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
#define SOC_CRGPERIPH_ISP_SEC_RSTSTAT_ip_rst_isp_timer_START  (5)
#define SOC_CRGPERIPH_ISP_SEC_RSTSTAT_ip_rst_isp_timer_END    (5)
...
/*****************************************************************************
 结构名    : SOC_CRGPERIPH_PERI_AUTODIV_STAT_UNION
 结构说明  : PERI_AUTODIV_STAT 寄存器结构定义。地址偏移量:0xE2C，初值:0x00000000，宽度:32
 寄存器说明: 自动降频状态寄存器
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  autodiv_sysbus_stat     : 1;  /* bit[0]    : 自动降频状态回读，默认为0
                                                                   0:处于不降频；
                                                                   1：处于降频态。 */
        unsigned int  autodiv_lpmcu_stat      : 1;  /* bit[1]    :  */
        unsigned int  autodiv_ispa7_stat      : 1;  /* bit[2]    :  */
        unsigned int  autodiv_vdec_stat       : 1;  /* bit[3]    :  */
        unsigned int  autodiv_venc_stat       : 1;  /* bit[4]    :  */
        unsigned int  autodiv_cfgbus_stat     : 1;  /* bit[5]    :  */
        unsigned int  autodiv_dmabus_stat     : 1;  /* bit[6]    :  */
        unsigned int  autodiv_vivobus_stat    : 1;  /* bit[7]    :  */
        unsigned int  autodiv_vcodecbus_stat  : 1;  /* bit[8]    :  */
        unsigned int  autodiv_dbgsechsic_stat : 1;  /* bit[9]    :  */
        unsigned int  autodiv_emmc0bus_stat   : 1;  /* bit[10]   :  */
        unsigned int  autodiv_emmc1bus_stat   : 1;  /* bit[11]   :  */
...
#define SOC_CRGPERIPH_PERI_AUTODIV_STAT_autodiv_vivobus_stat_START     (7)
#define SOC_CRGPERIPH_PERI_AUTODIV_STAT_autodiv_vivobus_stat_END       (7)
#define SOC_CRGPERIPH_PERI_AUTODIV_STAT_autodiv_vcodecbus_stat_START   (8)
#define SOC_CRGPERIPH_PERI_AUTODIV_STAT_autodiv_vcodecbus_stat_END     (8)
#define SOC_CRGPERIPH_PERI_AUTODIV_STAT_autodiv_dbgsechsic_stat_START  (9)
#define SOC_CRGPERIPH_PERI_AUTODIV_STAT_autodiv_dbgsechsic_stat_END    (9)
