...
typedef union
{
    ...
    struct
    {
        unsigned int  gmp_bypass_en : 1;  /* bit[0]   : 保留 */
        unsigned int  reserved      : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  gmp_mem_ctrl : 4;  /* bit[0-3] : 保留 */
        unsigned int  reserved     : 28; /* bit[4-31]: 保留 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  u_gama_coef : 8;  /* bit[0-7] : GAMA系数查找表 */
        unsigned int  reserved    : 24; /* bit[8-31]: 保留 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  h_l_out  : 10; /* bit[0-9]  : U_HL_COEF系数 */
        unsigned int  reserved_0: 6;  /* bit[10-15]: 保留 */
        unsigned int  h_r_out  : 10; /* bit[16-25]: U_HR_COEF系数 */
        unsigned int  reserved_1: 6;  /* bit[26-31]: 保留 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  sata_l_out : 8;  /* bit[0-7]  : U_SATAL_COEF系数 */
        unsigned int  sata_r_out : 8;  /* bit[8-15] : U_SATAR_COEF系数 */
        unsigned int  reserved   : 16; /* bit[16-31]: 保留 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  satr_l_out : 8;  /* bit[0-7]  : U_SATRL_COEF系数 */
        unsigned int  satr_r_out : 8;  /* bit[8-15] : U_SATRR_COEF系数 */
        unsigned int  reserved   : 16; /* bit[16-31]: 保留 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  u_igm_r_coef : 12; /* bit[0-11] : IGM R分量查找表 */
...
typedef union
{
    ...
    struct
    {
        unsigned int  u_igm_g_coef : 12; /* bit[0-11] : IGM G分量查找表 */
        unsigned int  reserved     : 20; /* bit[12-31]: 保留 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  u_igm_b_coef : 12; /* bit[0-11] : IGM B分量查找表 */
        unsigned int  reserved     : 20; /* bit[12-31]: 保留 */
    } reg;
