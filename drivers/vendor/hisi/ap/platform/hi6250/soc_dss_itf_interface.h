...
/* 寄存器说明：
   位域定义UNION结构:  SOC_DSS_ITF_VSTATE_UNION */
#define SOC_DSS_ITF_VSTATE_ADDR(base)                 ((base) + (0x0054))

/* 寄存器说明：
   位域定义UNION结构:  SOC_DSS_ITF_DPI0_HSTATE_UNION */
#define SOC_DSS_ITF_DPI0_HSTATE_ADDR(base)            ((base) + (0x0058))

/* 寄存器说明：
   位域定义UNION结构:  SOC_DSS_ITF_DPI1_HSTATE_UNION */
#define SOC_DSS_ITF_DPI1_HSTATE_ADDR(base)            ((base) + (0x005C))
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  bpp            : 2;  /* bit[3-4]  : 输入像素深度配置。
                                                          ...
                                                          10：输入RGB888像素格式；
                                                          11：保留 */
        unsigned int  dual_mode_en   : 1;  /* bit[5]    : 保留。 */
        ...
        unsigned int  shutdown       : 1;  /* bit[15]   : 给DSI DPI接口的shutdown信号：
                                                          0： LCD正常显示;
                                                          1： LCD进入Sleep模式 */
        unsigned int  split_mode     : 1;  /* bit[16]   : 保留。 */
        unsigned int  dpi0_rs_clear  : 1;  /* bit[17]   : 输出给DPI0_RS的clear信号，高有效
                                                          (PDP专用) */
        unsigned int  dpi1_rs_clear  : 1;  /* bit[18]   : 保留。 */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  dsi_te0_pin_p     : 1;  /* bit[1]    : TE0 极性选择
                                                             0：保持输入极性
                                                             1：输入极性取反 */
        unsigned int  dsi_te1_pin_p     : 1;  /* bit[2]    : 保留。 */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  dsi_te1_hs_num : 13; /* bit[13-25]: 保留。 */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  dsi_te1_hs_wd : 12; /* bit[12-23]: 保留。 */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  dsi_te1_vs_wd : 12; /* bit[12-23]: 保留。 */
        unsigned int  reserved      : 8;  /* bit[24-31]:  */
    } reg;
...
/*****************************************************************************
 结构名    : SOC_DSS_ITF_VSTATE_UNION
 结构说明  : VSTATE 寄存器结构定义。地址偏移量:0x0054，初值:0x00000001，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  vstate   : 10; /* bit[0-9]  : 保留。 */
        unsigned int  reserved : 22; /* bit[10-31]: 保留。 */
    } reg;
} SOC_DSS_ITF_VSTATE_UNION;
#endif
#define SOC_DSS_ITF_VSTATE_vstate_START    (0)
#define SOC_DSS_ITF_VSTATE_vstate_END      (9)


/*****************************************************************************
 结构名    : SOC_DSS_ITF_DPI0_HSTATE_UNION
 结构说明  : DPI0_HSTATE 寄存器结构定义。地址偏移量:0x0058，初值:0x00000001，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  dpi0_hstate : 6;  /* bit[0-5] : 保留。 */
        unsigned int  reserved    : 26; /* bit[6-31]: 保留。 */
    } reg;
} SOC_DSS_ITF_DPI0_HSTATE_UNION;
#endif
#define SOC_DSS_ITF_DPI0_HSTATE_dpi0_hstate_START  (0)
#define SOC_DSS_ITF_DPI0_HSTATE_dpi0_hstate_END    (5)


/*****************************************************************************
 结构名    : SOC_DSS_ITF_DPI1_HSTATE_UNION
 结构说明  : DPI1_HSTATE 寄存器结构定义。地址偏移量:0x005C，初值:0x00000001，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  dpi1_hstate : 6;  /* bit[0-5] : 保留。 */
        unsigned int  reserved    : 26; /* bit[6-31]: 保留。 */
    } reg;
} SOC_DSS_ITF_DPI1_HSTATE_UNION;
#endif
#define SOC_DSS_ITF_DPI1_HSTATE_dpi1_hstate_START  (0)
#define SOC_DSS_ITF_DPI1_HSTATE_dpi1_hstate_END    (5)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  dpi1_hbp : 13; /* bit[16-28]: 保留。 */
        unsigned int  reserved_1: 3;  /* bit[29-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  dpi1_hsw : 13; /* bit[0-12] : 保留。 */
        unsigned int  reserved : 19; /* bit[13-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  dpi1_hsize : 13; /* bit[0-12] : 保留。 */
        unsigned int  reserved   : 19; /* bit[13-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  dpi0_overlap_size : 8;  /* bit[0-7]  : 保留。 */
        unsigned int  reserved_0        : 8;  /* bit[8-15] : 保留。 */
        unsigned int  dpi1_overlap_size : 8;  /* bit[16-23]: 保留。 */
