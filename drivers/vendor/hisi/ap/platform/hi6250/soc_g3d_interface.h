...
/*****************************************************************************
 ...
 结构说明  : GPU_ID 寄存器结构定义。地址偏移量:0x0000，初值:0x08301000，宽度:32
 寄存器说明: GPU硬件版本号。
*****************************************************************************/
...
/*****************************************************************************
 ...
 结构说明  : L2_FEATURES 寄存器结构定义。地址偏移量:0x0004，初值:0x07110206，宽度:32
 寄存器说明: GPU L2 CAHCE配置查询寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_0          : 6;  /* bit[2-7]  : Reserved, write as zero, read undefined */
...
/*****************************************************************************
 ...
 结构说明  : MMU_FEATURES 寄存器结构定义。地址偏移量:0x0014，初值:0x00002821，宽度:32
 寄存器说明: GPU内存配置寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  va_bits      : 8;  /* bit[0-7]  : 虚拟地址位宽33bit */
...
typedef union
{
    ...
    struct
    {
        unsigned int  js_present_low : 3;  /* bit[0-2] : JS0~JS2使能。
                                                         1：使能
                                                         0：禁止 */
        unsigned int  js_present     : 29; /* bit[3-31]: Reserved, write as zero, read undefined */
    } reg;
} SOC_G3D_JS_PRESENT_UNION;
#endif
#define SOC_G3D_JS_PRESENT_js_present_low_START  (0)
#define SOC_G3D_JS_PRESENT_js_present_low_END    (2)
#define SOC_G3D_JS_PRESENT_js_present_START      (3)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  prfcnt_sample_complete : 1;  /* bit[16]   : 完成一次performance count sample，置1 */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  soft_reset_command : 1;  /* bit[1]   : 软复位 */
        unsigned int  hard_reset_command : 1;  /* bit[2]   : 硬复位 */
...
#endif
#define SOC_G3D_GPU_COMMAND_soft_reset_command_START  (1)
#define SOC_G3D_GPU_COMMAND_soft_reset_command_END    (1)
#define SOC_G3D_GPU_COMMAND_hard_reset_command_START  (2)
#define SOC_G3D_GPU_COMMAND_hard_reset_command_END    (2)
...
/*****************************************************************************
 ...
 结构说明  : THREAD_MAX_WORKGROUP 寄存器结构定义。地址偏移量:0x00A4，初值:0x00000080，宽度:32
 寄存器说明: work group最大线程个数。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : SHADER_PRESENT_LO 寄存器结构定义。地址偏移量:0x0100，初值:0x00000003，宽度:32
 寄存器说明: 可使用的shader core个数查询寄存器(低)。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
typedef union
{
    ...
    struct
    {
        unsigned int  jm_config : 32; /* bit[0-31]: RSV */
    } reg;
} SOC_G3D_JM_CONFIG_UNION;
#endif
#define SOC_G3D_JM_CONFIG_jm_config_START  (0)
#define SOC_G3D_JM_CONFIG_jm_config_END    (31)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  alt_counters  : 1;  /* bit[3-3] : Switch to an alternate set of performance counters */
        unsigned int  shader_config : 28; /* bit[4-31]: Reserved. write as zero, read undefined.  */
    } reg;
} SOC_G3D_SHADER_CONFIG_UNION;
#endif
#define SOC_G3D_SHADER_CONFIG_alt_counters_START   (3)
#define SOC_G3D_SHADER_CONFIG_alt_counters_END     (3)
