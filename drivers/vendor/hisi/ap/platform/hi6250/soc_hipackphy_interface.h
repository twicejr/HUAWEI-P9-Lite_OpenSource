...
/* 寄存器说明：This register control the data training.
   位域定义UNION结构:  SOC_HIPACKPHY_TRAINCTRL8_UNION */
#define SOC_HIPACKPHY_TRAINCTRL8_ADDR(base)           ((base) + (0x00CC))
...
/* 寄存器说明：GDS Margin Configuration
   位域定义UNION结构:  SOC_HIPACKPHY_TRAINCTRL9_UNION */
#define SOC_HIPACKPHY_TRAINCTRL9_ADDR(base)           ((base) + (0x110))
...
#define SOC_HIPACKPHY_AC_IOCTL5_ADDR(base)            ((base) + (0x0AC))

/* 寄存器说明：bypass mode shadow register
   位域定义UNION结构:  SOC_HIPACKPHY_ACCTL_BYP_CK90_B1_UNION */
#define SOC_HIPACKPHY_ACCTL_BYP_CK90_B1_ADDR(base)    ((base) + (0x0E0))

/* 寄存器说明：SELECT CK90 delay line value
   位域定义UNION结构:  SOC_HIPACKPHY_BYP_CK90_SETTING_UNION */
#define SOC_HIPACKPHY_BYP_CK90_SETTING_ADDR(base)     ((base) + (0x0E4))

/* 寄存器说明：DBL Software rest
   位域定义UNION结构:  SOC_HIPACKPHY_BDL_SW_RST_UNION */
#define SOC_HIPACKPHY_BDL_SW_RST_ADDR(base)           ((base) + (0x0E8))

/* 寄存器说明：bypass clock gated function
   位域定义UNION结构:  SOC_HIPACKPHY_DDRPHY_GATED_BYPASS_UNION */
#define SOC_HIPACKPHY_DDRPHY_GATED_BYPASS_ADDR(base)  ((base) + (0x0EC))



/****************************************************************************
                     (3/3) register_dx_static
 ****************************************************************************/
/* 寄存器说明：PHY control registers 
            Register in this field are connected to PHY interface directly
   位域定义UNION结构:  SOC_HIPACKPHY_DX_PHYCTRL0_UNION */
#define SOC_HIPACKPHY_DX_PHYCTRL0_ADDR(base, q)       ((base) + (0x200+(q)*0x100))

/* 寄存器说明：IO control register
   位域定义UNION结构:  SOC_HIPACKPHY_DX_IOCTL_UNION */
#define SOC_HIPACKPHY_DX_IOCTL_ADDR(base, q)          ((base) + (0x204+(q)*0x100))

/* 寄存器说明：Swap of DQ in PHY
   位域定义UNION结构:  SOC_HIPACKPHY_DX_DQSSEL_UNION */
#define SOC_HIPACKPHY_DX_DQSSEL_ADDR(base, q)         ((base) + (0x208+(q)*0x100))

/* 寄存器说明：This register is for PLL phase select within the PHY. And should not be modified.
   位域定义UNION结构:  SOC_HIPACKPHY_DX_DXNCKCTRL_UNION */
#define SOC_HIPACKPHY_DX_DXNCKCTRL_ADDR(base, q)      ((base) + (0x20C+(q)*0x100))

/* 寄存器说明：PHY PLL control registers 
            Register in this field are connected to PHY interface directly
   位域定义UNION结构:  SOC_HIPACKPHY_DX_PHYPLLCTRL_DX_UNION */
#define SOC_HIPACKPHY_DX_PHYPLLCTRL_DX_ADDR(base, q)  ((base) + (0x210+(q)*0x100))

/* 寄存器说明：PHY control registers 
            Register in this field are connected to PHY interface directly
   位域定义UNION结构:  SOC_HIPACKPHY_DX_PHYCTRL2_UNION */
#define SOC_HIPACKPHY_DX_PHYCTRL2_ADDR(base, q)       ((base) + (0x214+(q)*0x100))

/* 寄存器说明：PHY control registers 
            Register in this field are connected to PHY interface directly
   位域定义UNION结构:  SOC_HIPACKPHY_DX_IOCTL1_UNION */
#define SOC_HIPACKPHY_DX_IOCTL1_ADDR(base, q)         ((base) + (0x218+(q)*0x100))

/* 寄存器说明：PHY control registers 
            Register in this field are connected to PHY interface directly
   位域定义UNION结构:  SOC_HIPACKPHY_DX_IOCTL2_UNION */
#define SOC_HIPACKPHY_DX_IOCTL2_ADDR(base, q)         ((base) + (0x21C+(q)*0x100))

/* 寄存器说明：PHY PLL control register
   位域定义UNION结构:  SOC_HIPACKPHY_DX_PHYPLLCTRL_DX2_UNION */
#define SOC_HIPACKPHY_DX_PHYPLLCTRL_DX2_ADDR(base, q)  ((base) + (0x220+(q)*0x100))

/* 寄存器说明：PHY PLL control register 3
   位域定义UNION结构:  SOC_HIPACKPHY_DX_PHYPLLCTRL_DX3_UNION */
#define SOC_HIPACKPHY_DX_PHYPLLCTRL_DX3_ADDR(base, q)  ((base) + (0x224+(q)*0x100))

/* 寄存器说明：DATA block clock bit delay line setting
   位域定义UNION结构:  SOC_HIPACKPHY_DX_DXNCLKBDL_UNION */
#define SOC_HIPACKPHY_DX_DXNCLKBDL_ADDR(base, q)      ((base) + (0x230+(q)*0x100))

/* 寄存器说明：DX PHY control registers 
            Register in this field are connected to PHY interface directly
   位域定义UNION结构:  SOC_HIPACKPHY_DX_DXPHYCTRL_UNION */
#define SOC_HIPACKPHY_DX_DXPHYCTRL_ADDR(base, q)      ((base) + (0x234+(q)*0x100))

/* 寄存器说明：Data block PHY miscellaneous control register. This register is for PHY control, and should not be modified.
   位域定义UNION结构:  SOC_HIPACKPHY_DX_DXNMISCCTRL0_UNION */
#define SOC_HIPACKPHY_DX_DXNMISCCTRL0_ADDR(base, q, p)  ((base) + (0x238+(p)*0x80+(q)*0x100))

/* 寄存器说明：Data block PHY miscellaneous control register. This register is for PHY control, and should not be modified.
   位域定义UNION结构:  SOC_HIPACKPHY_DX_DXNMISCCTRL1_UNION */
#define SOC_HIPACKPHY_DX_DXNMISCCTRL1_ADDR(base, q, p)  ((base) + (0x264+(p)*0x80+(q)*0x100))

/* 寄存器说明：Data block PHY debug signals
   位域定义UNION结构:  SOC_HIPACKPHY_DX_DXDEBUG0_UNION */
#define SOC_HIPACKPHY_DX_DXDEBUG0_ADDR(base, q, p)    ((base) + (0x23C+(p)*0x80+(q)*0x100))
...
#define SOC_HIPACKPHY_DX_DXPHYRSVD_ADDR(base, q, p)   ((base) + (0x244+(p)*0x80+(q)*0x100))

/* 寄存器说明：Data block PHY miscellaneous control register. This register is for PHY control, and should not be modified.
   位域定义UNION结构:  SOC_HIPACKPHY_DX_DXNMISCCTRL2_UNION */
#define SOC_HIPACKPHY_DX_DXNMISCCTRL2_ADDR(base, q, p)  ((base) + (0x248+(p)*0x80+(q)*0x100))

/* 寄存器说明：Data block PHY debug/miscellaneous control register. This register is for PHY control, and should not be modified.
   位域定义UNION结构:  SOC_HIPACKPHY_DX_DXDEBUGCONFIG_UNION */
#define SOC_HIPACKPHY_DX_DXDEBUGCONFIG_ADDR(base, q, p)  ((base) + (0x24C+(p)*0x80+(q)*0x100))

/* 寄存器说明：Data block PHY DCC control register. This register is for PHY control, and should not be modified.
   位域定义UNION结构:  SOC_HIPACKPHY_DX_DXNDCC_UNION */
#define SOC_HIPACKPHY_DX_DXNDCC_ADDR(base, q, p)      ((base) + (0x250+(p)*0x80+(q)*0x100))

/* 寄存器说明：Data block PHY debug/miscellaneous control register. This register is for PHY control, and should not be modified.
   位域定义UNION结构:  SOC_HIPACKPHY_DX_DXNMISCCTRL3_UNION */
#define SOC_HIPACKPHY_DX_DXNMISCCTRL3_ADDR(base, q, p)  ((base) + (0x254+(p)*0x80+(q)*0x100))

/* 寄存器说明：Data block PHY debug/miscellaneous control register. This register is for PHY control, and should not be modified.
   位域定义UNION结构:  SOC_HIPACKPHY_DX_DXNMISCCTRL4_UNION */
#define SOC_HIPACKPHY_DX_DXNMISCCTRL4_ADDR(base, q)   ((base) + (0x258+(q)*0x100))

/* 寄存器说明：IO control register
   位域定义UNION结构:  SOC_HIPACKPHY_DX_IOCTL3_UNION */
#define SOC_HIPACKPHY_DX_IOCTL3_ADDR(base, q)         ((base) + (0x25C+(q)*0x100))

/* 寄存器说明：IO control register
   位域定义UNION结构:  SOC_HIPACKPHY_DX_IOCTL5_UNION */
#define SOC_HIPACKPHY_DX_IOCTL5_ADDR(base, q)         ((base) + (0x260+(q)*0x100))

/* 寄存器说明：Bypass mode delay line code
   位域定义UNION结构:  SOC_HIPACKPHY_DX_BYP_CK90_CODE_UNION */
#define SOC_HIPACKPHY_DX_BYP_CK90_CODE_ADDR(base, q, p)  ((base) + (0x278+(p)*0x80+(q)*0x100))

/* 寄存器说明：Bypass mode delay line code shadow register
   位域定义UNION结构:  SOC_HIPACKPHY_DX_BYP_CK90_CODE_B1_UNION */
#define SOC_HIPACKPHY_DX_BYP_CK90_CODE_B1_ADDR(base, q, p)  ((base) + (0x27C+(p)*0x80+(q)*0x100))

/* 寄存器说明：bypass clock gated function
   位域定义UNION结构:  SOC_HIPACKPHY_DX_DDRPHY_GATED_BYPASS_UNION */
#define SOC_HIPACKPHY_DX_DDRPHY_GATED_BYPASS_ADDR(base, q)  ((base) + (0x280+(q)*0x100))
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  dxdvrefs_en    : 1;  /* bit[18]   : DRAM VREF(DQ) Synchronize Operations.
                                                          ...
                                                          Note that if DDR4 configured, the VREF(DQ) synchronization will turn-on PDA function automatically. For non-PDA mode, the user may use SMR from Memory Controller. */
...
/*****************************************************************************
 ...
 结构说明  : DLYMEASCTRL 寄存器结构定义。地址偏移量:0x020，初值:0x04100471，宽度:32
 寄存器说明: This register specify the control for delay measurement of the read delay line.
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  dly_track_type      : 1;  /* bit[1]    : Delay Tracking Type (DQS tracking).
                                                               ...
                                                               Note:
                                                                When dly_track_type=0x0, the phy will use rdqscyc to do the rdqs tracking. The user should let rdqscyc has margin to be tuned by selecting proper delay measure type. */
        ...
        unsigned int  dynamic_dqsgen      : 1;  /* bit[4]    : Dynamic DQSG Tracking Enable.
                                                               ...
                                                               0: disable
                                                               Note:
                                                               This field should be set 0x0 (disable) when:
                                                               1. the phy's DQSG extend function is enabled.
                                                               2. BL4 (Burst Length4) case */
        ...
        unsigned int  dynamic_dqsg_ph_dis : 1;  /* bit[16]   : Dynamic DQSG Tracking phase-tuning disable.
                                                               ...
                                                               Note: when dynamic_dqsg_ph_dis=0x0, gtrten should be 0x0 */
...
/*****************************************************************************
 ...
 结构说明  : IMPCTRL 寄存器结构定义。地址偏移量:0x024，初值:0x80008220，宽度:32
 寄存器说明: This register specify the control the ZQ calibration.
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  zcomp_rsp_dly       : 6;  /* bit[0-5]  : ZQ Comparator Response Time.
                                                               This field specify the delay that the zcomp result after apply the zctrl. (Unit: pclk) */
        ...
        unsigned int  zcal_errstopup      : 1;  /* bit[28]   : ZCAL stop updating code when error.
                                                               1: does not update code when error
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  cfg_rl      : 8;  /* bit[8-15] : PHY read latency.
                                                       ...
                                                       LPDDR4: RL+3+RD(tdqsck(min)/tCK)-(dfi_clk_ratio)?3:5)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reg_sel_dficlk_rx : 1;  /* bit[1]    : PHY RX Path Clock Selection
                                                             ...
                                                             1: DFI Clock
                                                             Note:
                                                              In byp_mode, this field should be set 0x0. (timing may not meet due to PHY internal clock scheme issue) */
...
/*****************************************************************************
 ...
 结构说明  : RETCTRL0 寄存器结构定义。地址偏移量:0x0080，初值:0x00010400，宽度:32
 寄存器说明: ReTrain Control
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  rt_onebyone               : 1;  /* bit[4]    : Enable retraining one by one
                                                                     grt/gdsrt and rdert be excuted one by one if the field be set */
        ...
        unsigned int  phyupd_type_nopre         : 2;  /* bit[14-15]: PHY Update Type Value for Telling MC without Precharge */
        unsigned int  phyupd_type_pre           : 2;  /* bit[16-17]: PHY Update Type Value for Telling MC with Precharge
...
typedef union
{
    ...
    struct
    {
        unsigned int  hvreft_maxv   : 6;  /* bit[0-5]  : Host PHY VREF(DQ) Training Maximum Value.
        ...
        unsigned int  hvreft_minv   : 6;  /* bit[6-11] : Host PHY VREF(DQ) Training Minimum Value.
        ...
        unsigned int  hvreft_hckpts : 6;  /* bit[18-23]: Host PHY VREF(DQ) Training Horizontal Check Points.
                                                         ...
                                                         Setting the MSB bit of this field to a '1' will enable the horizontal testing points. Setting the MSB bit of this field to a '0' will disable the horizontal check points. Only current write DQ phase will be check at specific VREF(DQ).
                                                         5'b0XXXX : Horizontal checking disabled.
                                                         5'b10000 : Reserved
                                                         5'b10001 : +/- 1 RDQS BDL
                                                         5'b10010 : +/- 2 RDQS BDL
                                                         ......
                                                         5'b11111 : +/- 15 RDQS BDL */
        unsigned int  reserved      : 8;  /* bit[24-31]: -- */
    } reg;
...
/*****************************************************************************
 结构名    : SOC_HIPACKPHY_TRAINCTRL8_UNION
 结构说明  : TRAINCTRL8 寄存器结构定义。地址偏移量:0x00CC，初值:0x35088000，宽度:32
 寄存器说明: This register control the data training.
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  reserved_0          : 15; /* bit[0-14] :  */
        unsigned int  gtrt_ph_reload_type : 1;  /* bit[15]   : GATE retrain rdqsgphase reload type. (only valid for non fast gt)
                                                               1: re-calculate (default)
                                                               0: use org_rdqsgph (not recommended) */
        unsigned int  reserved_1          : 3;  /* bit[16-18]:  */
        unsigned int  cat_re_eyeopen_en   : 1;  /* bit[19]   : HW CAT re-eyeopen enable (only valid for LP3).
                                                               When this field is enabled, HW CAT will re-do eyeopen for CA0/1/2/3/5/6/7/8 when CA4/9 turn met any failed conditions during eyeopne stage.
                                                               1: enable (default)
                                                               2: disable (not recommended) */
        unsigned int  reserved_2          : 4;  /* bit[20-23]:  */
        unsigned int  det_rstpost_time    : 4;  /* bit[24-27]: DET RESET post time during MST_DONE state, unit: 2nCK */
        unsigned int  det_sstrstphy_time  : 4;  /* bit[28-31]: DET RESET state time during SST_RESETPHY state, unit: 2nCK */
    } reg;
...
#define SOC_HIPACKPHY_TRAINCTRL8_cat_re_eyeopen_en_START    (19)
#define SOC_HIPACKPHY_TRAINCTRL8_cat_re_eyeopen_en_END      (19)
...
/*****************************************************************************
 ...
 结构说明  : TRAINCTRL1 寄存器结构定义。地址偏移量:0x00D0，初值:0xF006F306，宽度:32
 寄存器说明: This register control the data training.
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  wdet_samp_num      : 4;  /* bit[0-3]  : Write DET sample number control. The multiple sample is used to overcome the meta situations.
                                                              Valid value: 1~15 */
        unsigned int  wdet_trysamp_num   : 4;  /* bit[4-7]  : Write DET try sample number control. The field is used to constrain the try times of multiple sample.
                                                              Valid value: 1~15 */
        ...
        unsigned int  rdet_samp_num      : 4;  /* bit[16-19]: Read DET sample number control. The multiple sample is used to overcome the meta situations.
                                                              Valid value: 1~15 */
        unsigned int  rdet_trysamp_num   : 4;  /* bit[20-23]: Read DET try sample number control. The field is used to constrain the try times of multiple sample.
                                                              Valid value: 1~15 */
        unsigned int  cfg_comp_en        : 1;  /* bit[24]   : Fast read data eye training compensation enable */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  fast_gt_en      : 1;  /* bit[25]   : fast gate training during auto training or retraining. When the field be enabled, must set dqsgsl_mrgn to 0. */
        unsigned int  fast_gdst_en    : 1;  /* bit[26]   : fast gds training during auto training or retraining */
        unsigned int  mrr_bl4         : 1;  /* bit[27]   : MRR burst 4 indicator. If MRR was used in the Read DET, pack needs to know if MRR burst is 4 (LPDDR2) or 8 (other dram types).
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  nopre4wrdet       : 1;  /* bit[15]   : Not Send Precharge for Write/Read DET by LPDDR4 MPC Command
        ...
        unsigned int  rpt_mode_en       : 1;  /* bit[22]   : Enable Gate Training to use "Read Preamble Train mode" (DDR4 only). When this field is diabled in DDR4, GT will use legacy mode (issuing normal read commands).
                                                             ...
                                                             -------------------LPDDR4---------------------
                                                             1: Entering Read Preamble Training Mode (RPT) and Using MPC RD DQ Calibration for GT/GDS Training and Re-Training */
...
/*****************************************************************************
 ...
 结构说明  : TRAINCTRL6 寄存器结构定义。地址偏移量:0x0E8，初值:0x30730000，宽度:32
 寄存器说明: This register control the data training.
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  phyupdtimer      : 16; /* bit[0-15] : Timer to Trigger PHY Update (Unit: 64 pclk)
                                                            0: Disable
                                                            Others: n* 64pclk */
        unsigned int  cfg_reg_sync_cnt : 4;  /* bit[16-19]: config the delay of phyconnt reset when delay line update.
                                                            Note: in V7R5, when retrain_en=0x1, this field should be set as 0xF. (SW workaound for rdert when phyconn_rst is not long enough during rdqsbdl changing by using cfg_reg_sync_cnt=0xF) */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  cso_fp              : 1;  /* bit[21]   : Flip cso loopback data enable
                                                               0: Not inverted
                                                               1: Make cso's loopback data inverted to cs's */
        unsigned int  ckeo_fp             : 1;  /* bit[22]   : Flip ckeo loopback data enable
                                                               0: Not inverted
                                                               1: Make ckeo's loopback data inverted to cke's */
        unsigned int  cso_cmp_msk         : 4;  /* bit[23-26]: CS odd Loopback Compare Mask.
                                                               This field is used to control if the comparison of the loopback data on CKE bits are disabled. 
                                                               0: Not compare 
                                                               1: Compare */
        unsigned int  ckeo_cmp_msk        : 4;  /* bit[27-30]: CKE odd Loopback Compare Mask.
                                                               This field is used to control if the comparison of the loopback data on CKE bits are disabled. 
                                                               0: Not compare 
                                                               1: Compare */
        unsigned int  cso_cke0_p1_cmp_msk : 1;  /* bit[31]   : CS/CKE P1 odd Loopback compare Mask
                                                               0: Not compare 
                                                               1: Compare */
    } reg;
...
/*****************************************************************************
 结构名    : SOC_HIPACKPHY_TRAINCTRL9_UNION
 结构说明  : TRAINCTRL9 寄存器结构定义。地址偏移量:0x110，初值:0x00000000，宽度:32
 寄存器说明: GDS Margin Configuration
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  gds_margin_sel : 3;  /* bit[0-2] : GDS Margin Selection
                                                         3'b000: GDS margin value = 1
                                                         3'b001: GDS margin value = 2
                                                         3'b010: GDS margin value = 3
                                                         3'b011: GDS margin value = 4
                                                         3'b100: GDS margin value = 5
                                                         3'b101: GDS margin value = 6
                                                         3'b110: GDS margin value = 7
                                                         3'b111: GDS margin value = 7 (due to max. GDS margin value is limited to 7) */
        unsigned int  reserved       : 29; /* bit[3-31]: -- */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : TRAINCTRL4 寄存器结构定义。地址偏移量:0x114，初值:0x2A032021，宽度:32
 寄存器说明: This register control the data training.
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : TRAINCTRL5 寄存器结构定义。地址偏移量:0x118，初值:0x00010100，宽度:32
 寄存器说明: This register control the data training.
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : TRAINCTRL7 寄存器结构定义。地址偏移量:0x11C，初值:0x00200010，宽度:32
 寄存器说明: This register control the data training.
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
typedef union
{
    ...
    struct
    {
        unsigned int  ac_rsv_control : 32; /* bit[0-31]: Reserved registers for the future.
                                                         ...
                                                         EC for K3V5@20141119:
                                                         PACK side's bit[0] is used as fast_wdet_en:
                                                         1: enable
                                                         0: disable (default) */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CATCONFIG 寄存器结构定义。地址偏移量:0x01C8，初值:0x001A2066，宽度:32
 寄存器说明: CA Training Configuration
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  ca_samp_num_ph    : 4;  /* bit[4-7]  : HW CA Training - sample count for CA phase:
                                                             Valid value: 1~15 */
        unsigned int  ca_trysamp_num    : 4;  /* bit[8-11] : HW CA Training - constrain the times of multi-sample count:
                                                             Valid value: 1~15 */
        ...
        unsigned int  sw_cat_dqvalid    : 1;  /* bit[30]   : SW CA Training - indicate if the CA result is ready. This bit will be cleared when sw_cat_strobe is asserted. Then after the timing tCACD, this bit will be asserted.
                                                             1: valid
                                                             0: not valid */
        unsigned int  sw_cat_en         : 1;  /* bit[31]   : SW CA Training - enable bit. Assert this bit, PACK will enter the SW CA Training state. After the SW CA Training is done, this bit should be de-assert by firmware (to prevent de-assert too early, should make sure sw_cat_dqvalid==0x1 and then wait for at least the time defined by the DRAMTIMER2.t_xp register).
                                                             1: enable
                                                             0: disable (default)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  dqm_cmp_mask : 1;  /* bit[16]   : DQM Loopback Compare Mask.
                                                        ...
                                                        0: Not compare 
                                                        1: Compare */
        unsigned int  prbs_mode    : 1;  /* bit[17]   : PRBS mode select.
                                                        0:PRBS16
                                                        1:PRBS11 */
...
#define SOC_HIPACKPHY_DXNBISTCTRL_prbs_mode_END       (17)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  dx_margin_a1              : 1;  /* bit[16]  : After modify this field, it need the "phyconn_rst" to update the latest setting. When user want to use dly_track_type=1 tracking type, this field should be set as 0x1 before initial trainings and dly_track_type should be set as 0x1 after initial trainings.
                                                                    Obsolete. Please refer to DX_Static_Reg.dxctl_pre_margin_code/dxctl_post_margin_code */
...
/*****************************************************************************
 ...
 结构说明  : DXDEBUG0 寄存器结构定义。地址偏移量:0x268+(n)*0x80，初值:0x0000A815，宽度:32
 寄存器说明: Data block PHY debug signals
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  dqs_cb    : 3;  /* bit[0-2]  : Move to DX_Static_Reg */
        unsigned int  dqs_ca    : 3;  /* bit[3-5]  : Move to DX_Static_Reg */
        unsigned int  dqs_rdcnt : 4;  /* bit[6-9]  : Move to DX_Static_Reg */
        unsigned int  s2b       : 1;  /* bit[10]   : Move to DX_Static_Reg */
        unsigned int  s2a       : 1;  /* bit[11]   : Move to DX_Static_Reg */
        unsigned int  s1b       : 1;  /* bit[12]   : Move to DX_Static_Reg */
        unsigned int  s1a       : 1;  /* bit[13]   : Move to DX_Static_Reg */
        unsigned int  s0b       : 1;  /* bit[14]   : Move to DX_Static_Reg */
        unsigned int  s0a       : 1;  /* bit[15]   : Move to DX_Static_Reg */
        unsigned int  dqs0_gold : 16; /* bit[16-31]: Debug signals */
    } reg;
} SOC_HIPACKPHY_DXDEBUG0_UNION;
#endif
#define SOC_HIPACKPHY_DXDEBUG0_dqs_cb_START     (0)
#define SOC_HIPACKPHY_DXDEBUG0_dqs_cb_END       (2)
#define SOC_HIPACKPHY_DXDEBUG0_dqs_ca_START     (3)
#define SOC_HIPACKPHY_DXDEBUG0_dqs_ca_END       (5)
#define SOC_HIPACKPHY_DXDEBUG0_dqs_rdcnt_START  (6)
#define SOC_HIPACKPHY_DXDEBUG0_dqs_rdcnt_END    (9)
#define SOC_HIPACKPHY_DXDEBUG0_s2b_START        (10)
#define SOC_HIPACKPHY_DXDEBUG0_s2b_END          (10)
#define SOC_HIPACKPHY_DXDEBUG0_s2a_START        (11)
#define SOC_HIPACKPHY_DXDEBUG0_s2a_END          (11)
#define SOC_HIPACKPHY_DXDEBUG0_s1b_START        (12)
#define SOC_HIPACKPHY_DXDEBUG0_s1b_END          (12)
#define SOC_HIPACKPHY_DXDEBUG0_s1a_START        (13)
#define SOC_HIPACKPHY_DXDEBUG0_s1a_END          (13)
#define SOC_HIPACKPHY_DXDEBUG0_s0b_START        (14)
#define SOC_HIPACKPHY_DXDEBUG0_s0b_END          (14)
#define SOC_HIPACKPHY_DXDEBUG0_s0a_START        (15)
#define SOC_HIPACKPHY_DXDEBUG0_s0a_END          (15)
...
/*****************************************************************************
 ...
 结构说明  : DXDEBUG1 寄存器结构定义。地址偏移量:0x26C+(n)*0x80，初值:0x00000000，宽度:32
 寄存器说明: Data block PHY debug signals
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : AC_PHYCTRL0 寄存器结构定义。地址偏移量:0x014，初值:0x00003980，宽度:32
 寄存器说明: PHY control registers 
            Register in this field are connected to PHY interface directly
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  acctl_cmdoen   : 1;  /* bit[7]    :  */
        unsigned int  acctl_ckoen    : 1;  /* bit[8]    :  */
        unsigned int  reserved_1     : 2;  /* bit[9-10] :  */
        unsigned int  acctl_ckeoen   : 1;  /* bit[11]   :  */
        unsigned int  acctl_csoen    : 1;  /* bit[12]   :  */
        unsigned int  acctl_resetoen : 1;  /* bit[13]   :  */
        unsigned int  reserved_2     : 18; /* bit[14-31]: -- */
    } reg;
} SOC_HIPACKPHY_AC_PHYCTRL0_UNION;
#endif
#define SOC_HIPACKPHY_AC_PHYCTRL0_acctl_cmdoen_START    (7)
#define SOC_HIPACKPHY_AC_PHYCTRL0_acctl_cmdoen_END      (7)
#define SOC_HIPACKPHY_AC_PHYCTRL0_acctl_ckoen_START     (8)
#define SOC_HIPACKPHY_AC_PHYCTRL0_acctl_ckoen_END       (8)
#define SOC_HIPACKPHY_AC_PHYCTRL0_acctl_ckeoen_START    (11)
#define SOC_HIPACKPHY_AC_PHYCTRL0_acctl_ckeoen_END      (11)
#define SOC_HIPACKPHY_AC_PHYCTRL0_acctl_csoen_START     (12)
#define SOC_HIPACKPHY_AC_PHYCTRL0_acctl_csoen_END       (12)
#define SOC_HIPACKPHY_AC_PHYCTRL0_acctl_resetoen_START  (13)
#define SOC_HIPACKPHY_AC_PHYCTRL0_acctl_resetoen_END    (13)


/*****************************************************************************
 结构名    : SOC_HIPACKPHY_AC_IOCTL_UNION
 结构说明  : AC_IOCTL 寄存器结构定义。地址偏移量:0x018，初值:0x03FE0000，宽度:32
 寄存器说明: IO control register
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : AC_IOCTL1 寄存器结构定义。地址偏移量:0x024，初值:0x00500003，宽度:32
 寄存器说明: PHY control registers 
            Register in this field are connected to PHY interface directly
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  acctl_ioctl_genvref_range_2      : 2;  /* bit[0-1]  :  */
        unsigned int  reserved_0                       : 10; /* bit[2-11] :  */
        unsigned int  acctl_ioctl_genvref_pd           : 2;  /* bit[12-13]:  */
        ...
        unsigned int  reserved_4                       : 9;  /* bit[23-31]:  */
    } reg;
} SOC_HIPACKPHY_AC_IOCTL1_UNION;
#endif
#define SOC_HIPACKPHY_AC_IOCTL1_acctl_ioctl_genvref_range_2_START       (0)
#define SOC_HIPACKPHY_AC_IOCTL1_acctl_ioctl_genvref_range_2_END         (1)
#define SOC_HIPACKPHY_AC_IOCTL1_acctl_ioctl_genvref_pd_START            (12)
#define SOC_HIPACKPHY_AC_IOCTL1_acctl_ioctl_genvref_pd_END              (13)
...
/*****************************************************************************
 ...
 结构说明  : AC_IOCTL2 寄存器结构定义。地址偏移量:0x028，初值:0x00C000C0，宽度:32
 寄存器说明: PHY control registers 
            Register in this field are connected to PHY interface directly
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  acctl_ioctl_genvref_range_0  : 2;  /* bit[0-1]  :  */
        unsigned int  reserved_0                   : 4;  /* bit[2-5]  :  */
        unsigned int  acctl_ioctl_genvref_range_1  : 2;  /* bit[6-7]  :  */
        unsigned int  reserved_1                   : 4;  /* bit[8-11] :  */
        unsigned int  acctl_ioctl_genvref_refsel_0 : 2;  /* bit[12-13]:  */
        unsigned int  reserved_2                   : 4;  /* bit[14-17]:  */
        unsigned int  acctl_ioctl_genvref_refsel_1 : 2;  /* bit[18-19]:  */
        unsigned int  reserved_3                   : 2;  /* bit[20-21]:  */
        unsigned int  acctl_ioctl_genvref_refsel_2 : 2;  /* bit[22-23]:  */
...
#define SOC_HIPACKPHY_AC_IOCTL2_acctl_ioctl_genvref_range_0_END     (1)
#define SOC_HIPACKPHY_AC_IOCTL2_acctl_ioctl_genvref_range_1_START   (6)
#define SOC_HIPACKPHY_AC_IOCTL2_acctl_ioctl_genvref_range_1_END     (7)
#define SOC_HIPACKPHY_AC_IOCTL2_acctl_ioctl_genvref_refsel_0_START  (12)
#define SOC_HIPACKPHY_AC_IOCTL2_acctl_ioctl_genvref_refsel_0_END    (13)
#define SOC_HIPACKPHY_AC_IOCTL2_acctl_ioctl_genvref_refsel_1_START  (18)
#define SOC_HIPACKPHY_AC_IOCTL2_acctl_ioctl_genvref_refsel_1_END    (19)
#define SOC_HIPACKPHY_AC_IOCTL2_acctl_ioctl_genvref_refsel_2_START  (22)
#define SOC_HIPACKPHY_AC_IOCTL2_acctl_ioctl_genvref_refsel_2_END    (23)
...
typedef union
{
    ...
    struct
    {
        unsigned int  acctl_cs_bdl  : 7;  /* bit[0-6]  : Bit delay line setting of CS0 */
        unsigned int  reserved_0    : 9;  /* bit[7-15] : -- */
        unsigned int  acctl_cs1_bdl : 7;  /* bit[16-22]: Bit delay line setting of CS1 */
        unsigned int  reserved_1    : 9;  /* bit[23-31]: -- */
    } reg;
} SOC_HIPACKPHY_AC_ACCMDBDL2_UNION;
#endif
#define SOC_HIPACKPHY_AC_ACCMDBDL2_acctl_cs_bdl_START   (0)
#define SOC_HIPACKPHY_AC_ACCMDBDL2_acctl_cs_bdl_END     (6)
#define SOC_HIPACKPHY_AC_ACCMDBDL2_acctl_cs1_bdl_START  (16)
#define SOC_HIPACKPHY_AC_ACCMDBDL2_acctl_cs1_bdl_END    (22)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  acctl_refclk_bdl   : 5;  /* bit[16-20]: Bit delay line setting of REFCLK
                                                              The valid range of this register is 0x00 ~ 0xF. Other values are reserved, and should not be used. */
        unsigned int  reserved_2         : 3;  /* bit[21-23]:  */
...
/*****************************************************************************
 ...
 结构说明  : AC_ACPHYCTL0 寄存器结构定义。地址偏移量:0x054，初值:0x00002010，宽度:32
 寄存器说明: AC block PHY control register. This register is for PHY control, and should not be modified.
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  acctl_byp_clk_gated_dis    : 1;  /* bit[7]    : AC clock gated disable in bypass mode.
                                                                      0: turn off clocks in bypass mode (default)
                                                                      1: turn on clocks in bypass mode */
        unsigned int  acctl_byp_ck90_cmd_code_b0 : 9;  /* bit[8-16] : Only bit[7:1] are valid. Used as {bit[7:1],1'b1}. The bit[8] is useless. */
...
#define SOC_HIPACKPHY_AC_ACPHYCTL0_acctl_byp_ck90_cmd_code_b0_START  (8)
#define SOC_HIPACKPHY_AC_ACPHYCTL0_acctl_byp_ck90_cmd_code_b0_END    (16)


/*****************************************************************************
 结构名    : SOC_HIPACKPHY_AC_ACPHYCTL1_UNION
 结构说明  : AC_ACPHYCTL1 寄存器结构定义。地址偏移量:0x058，初值:0x00000000，宽度:32
 寄存器说明: AC block PHY control register. This register is for PHY control, and should not be modified.
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  acctl_dram1sel_cas   : 1;  /* bit[5]    : PHY control registers. */
        unsigned int  acctl_dram1sel_we    : 1;  /* bit[6]    : PHY control registers. */
        unsigned int  reserved_0           : 1;  /* bit[7]    : -- */
...
typedef union
{
    ...
    struct
    {
        unsigned int  acdbg_rdcnt          : 3;  /* bit[0-2]  :  */
        unsigned int  reserved_0           : 5;  /* bit[3-7]  :  */
...
#define SOC_HIPACKPHY_AC_ACDEBUG_acdbg_rdcnt_END             (2)
...
/*****************************************************************************
 ...
 结构说明  : AC_ACPHYRSVDS 寄存器结构定义。地址偏移量:0x07C，初值:0xFFFF0000，宽度:32
 寄存器说明: AC block PHY reserved control pins. This register is for PHY control and should not be modified.
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : AC_ACPHYDCC 寄存器结构定义。地址偏移量:0x094，初值:0x00000000，宽度:32
 寄存器说明: AC block PHY control register. This register is for PHY control, and should not be modified.
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  acctl_dq1_dcc       : 3;  /* bit[0-2]  :  */
        unsigned int  acctl_dq0_dcc       : 3;  /* bit[3-5]  :  */
        unsigned int  acctl_dqs1_dcc      : 3;  /* bit[6-8]  :  */
        unsigned int  acctl_dqs0_dcc      : 3;  /* bit[9-11] :  */
        unsigned int  acctl_mclk_dcc      : 3;  /* bit[12-14]:  */
        unsigned int  reserved_0          : 1;  /* bit[15]   :  */
        unsigned int  acctl_dq1_dcc_byt1  : 3;  /* bit[16-18]:  */
...
/*****************************************************************************
 ...
 结构说明  : AC_IOCTL3 寄存器结构定义。地址偏移量:0x0A4，初值:0x320F0000，宽度:32
 寄存器说明: IO control register
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  acctl_zcal_vbias_n : 2;  /* bit[16-17]:  */
        unsigned int  acctl_zcal_vbias_p : 2;  /* bit[18-19]:  */
        unsigned int  reserved           : 4;  /* bit[20-23]:  */
        unsigned int  acctl_zcal_rdsel_n : 4;  /* bit[24-27]:  */
        unsigned int  acctl_zcal_rdsel_p : 4;  /* bit[28-31]: --- */
    } reg;
...
#define SOC_HIPACKPHY_AC_IOCTL3_acctl_zcal_vbias_n_START  (16)
#define SOC_HIPACKPHY_AC_IOCTL3_acctl_zcal_vbias_n_END    (17)
#define SOC_HIPACKPHY_AC_IOCTL3_acctl_zcal_vbias_p_START  (18)
#define SOC_HIPACKPHY_AC_IOCTL3_acctl_zcal_vbias_p_END    (19)
#define SOC_HIPACKPHY_AC_IOCTL3_acctl_zcal_rdsel_n_START  (24)
#define SOC_HIPACKPHY_AC_IOCTL3_acctl_zcal_rdsel_n_END    (27)
#define SOC_HIPACKPHY_AC_IOCTL3_acctl_zcal_rdsel_p_START  (28)
#define SOC_HIPACKPHY_AC_IOCTL3_acctl_zcal_rdsel_p_END    (31)


/*****************************************************************************
 结构名    : SOC_HIPACKPHY_AC_IOCTL4_UNION
 结构说明  : AC_IOCTL4 寄存器结构定义。地址偏移量:0x0A8，初值:0x00000000，宽度:32
 寄存器说明: IO control register
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  ioctl_lpddr4en         : 1;  /* bit[0]    :  */
        unsigned int  ioctl_sp               : 1;  /* bit[1]    :  */
        unsigned int  reserved_0             : 10; /* bit[2-11] :  */
        unsigned int  ac2t_ioctl_rdsel_p     : 4;  /* bit[12-15]:  */
        unsigned int  ac2t_ioctl_rdsel_n     : 4;  /* bit[16-19]:  */
        unsigned int  ac2t_ioctl_tdsel_p     : 4;  /* bit[20-23]:  */
        unsigned int  ac2t_ioctl_tdsel_n     : 4;  /* bit[24-27]:  */
        unsigned int  acctl_ioctl_zq_rx_mode : 2;  /* bit[28-29]:  */
        unsigned int  reserved_1             : 2;  /* bit[30-31]: --- */
    } reg;
} SOC_HIPACKPHY_AC_IOCTL4_UNION;
#endif
#define SOC_HIPACKPHY_AC_IOCTL4_ioctl_lpddr4en_START          (0)
#define SOC_HIPACKPHY_AC_IOCTL4_ioctl_lpddr4en_END            (0)
#define SOC_HIPACKPHY_AC_IOCTL4_ioctl_sp_START                (1)
#define SOC_HIPACKPHY_AC_IOCTL4_ioctl_sp_END                  (1)
#define SOC_HIPACKPHY_AC_IOCTL4_ac2t_ioctl_rdsel_p_START      (12)
#define SOC_HIPACKPHY_AC_IOCTL4_ac2t_ioctl_rdsel_p_END        (15)
#define SOC_HIPACKPHY_AC_IOCTL4_ac2t_ioctl_rdsel_n_START      (16)
#define SOC_HIPACKPHY_AC_IOCTL4_ac2t_ioctl_rdsel_n_END        (19)
#define SOC_HIPACKPHY_AC_IOCTL4_ac2t_ioctl_tdsel_p_START      (20)
#define SOC_HIPACKPHY_AC_IOCTL4_ac2t_ioctl_tdsel_p_END        (23)
#define SOC_HIPACKPHY_AC_IOCTL4_ac2t_ioctl_tdsel_n_START      (24)
#define SOC_HIPACKPHY_AC_IOCTL4_ac2t_ioctl_tdsel_n_END        (27)
#define SOC_HIPACKPHY_AC_IOCTL4_acctl_ioctl_zq_rx_mode_START  (28)
#define SOC_HIPACKPHY_AC_IOCTL4_acctl_ioctl_zq_rx_mode_END    (29)


/*****************************************************************************
 结构名    : SOC_HIPACKPHY_AC_IOCTL5_UNION
 结构说明  : AC_IOCTL5 寄存器结构定义。地址偏移量:0x0AC，初值:0x00000000，宽度:32
 寄存器说明: IO control register
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
#endif
#define SOC_HIPACKPHY_AC_IOCTL5_ck_ioctl_rdsel_p_START  (0)
#define SOC_HIPACKPHY_AC_IOCTL5_ck_ioctl_rdsel_p_END    (3)
#define SOC_HIPACKPHY_AC_IOCTL5_ck_ioctl_rdsel_n_START  (4)
#define SOC_HIPACKPHY_AC_IOCTL5_ck_ioctl_rdsel_n_END    (7)
#define SOC_HIPACKPHY_AC_IOCTL5_ck_ioctl_tdsel_p_START  (8)
#define SOC_HIPACKPHY_AC_IOCTL5_ck_ioctl_tdsel_p_END    (11)
#define SOC_HIPACKPHY_AC_IOCTL5_ck_ioctl_tdsel_n_START  (12)
#define SOC_HIPACKPHY_AC_IOCTL5_ck_ioctl_tdsel_n_END    (15)


/*****************************************************************************
 结构名    : SOC_HIPACKPHY_ACCTL_BYP_CK90_B1_UNION
 结构说明  : ACCTL_BYP_CK90_B1 寄存器结构定义。地址偏移量:0x0E0，初值:0x00000000，宽度:32
 寄存器说明: bypass mode shadow register
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  acctl_byp_ck90_cmd_code_code_b1 : 9;  /* bit[0-8] : Shadow register:
                                                                          use op_sel to switch the PHY input value */
        unsigned int  reserved                        : 23; /* bit[9-31]:  */
    } reg;
} SOC_HIPACKPHY_ACCTL_BYP_CK90_B1_UNION;
#endif
#define SOC_HIPACKPHY_ACCTL_BYP_CK90_B1_acctl_byp_ck90_cmd_code_code_b1_START  (0)
#define SOC_HIPACKPHY_ACCTL_BYP_CK90_B1_acctl_byp_ck90_cmd_code_code_b1_END    (8)


/*****************************************************************************
 结构名    : SOC_HIPACKPHY_BYP_CK90_SETTING_UNION
 结构说明  : BYP_CK90_SETTING 寄存器结构定义。地址偏移量:0x0E4，初值:0x00000000，宽度:32
 寄存器说明: SELECT CK90 delay line value
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  byp_ck90_sel      : 1;  /* bit[0]   : Select PHY ck90 code input
                                                            1: choose the latch value of the delay measurement.
                                                            0: From static register. */
        unsigned int  byp_ck90_latch_en : 1;  /* bit[1]   : Enable to latch the result of delay_measure.
                                                            1: latch result when PACK has update.
                                                            0: keep the current value. */
        unsigned int  reserved          : 30; /* bit[2-31]:  */
    } reg;
} SOC_HIPACKPHY_BYP_CK90_SETTING_UNION;
#endif
#define SOC_HIPACKPHY_BYP_CK90_SETTING_byp_ck90_sel_START       (0)
#define SOC_HIPACKPHY_BYP_CK90_SETTING_byp_ck90_sel_END         (0)
#define SOC_HIPACKPHY_BYP_CK90_SETTING_byp_ck90_latch_en_START  (1)
#define SOC_HIPACKPHY_BYP_CK90_SETTING_byp_ck90_latch_en_END    (1)


/*****************************************************************************
 结构名    : SOC_HIPACKPHY_BDL_SW_RST_UNION
 结构说明  : BDL_SW_RST 寄存器结构定义。地址偏移量:0x0E8，初值:0x00000000，宽度:32
 寄存器说明: DBL Software rest
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  bdl_sw_rst : 1;  /* bit[0]   : bdl setting software reset
                                                     1: reset */
        unsigned int  reserved   : 31; /* bit[1-31]:  */
    } reg;
} SOC_HIPACKPHY_BDL_SW_RST_UNION;
#endif
#define SOC_HIPACKPHY_BDL_SW_RST_bdl_sw_rst_START  (0)
#define SOC_HIPACKPHY_BDL_SW_RST_bdl_sw_rst_END    (0)


/*****************************************************************************
 结构名    : SOC_HIPACKPHY_DDRPHY_GATED_BYPASS_UNION
 结构说明  : DDRPHY_GATED_BYPASS 寄存器结构定义。地址偏移量:0x0EC，初值:0x00000003，宽度:32
 寄存器说明: bypass clock gated function
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  bypclk_gated_bypass : 1;  /* bit[0]   : turn off the higher level gated clock
                                                              1: bypass gated logic
                                                              0: turn of the gated logic */
        unsigned int  dlyline_gate_bypass : 1;  /* bit[1]   : turn off the higher level gated clock
                                                              1: bypass gated logic
                                                              0: turn of the gated logic */
        unsigned int  reserved            : 30; /* bit[2-31]:  */
    } reg;
} SOC_HIPACKPHY_DDRPHY_GATED_BYPASS_UNION;
#endif
#define SOC_HIPACKPHY_DDRPHY_GATED_BYPASS_bypclk_gated_bypass_START  (0)
#define SOC_HIPACKPHY_DDRPHY_GATED_BYPASS_bypclk_gated_bypass_END    (0)
#define SOC_HIPACKPHY_DDRPHY_GATED_BYPASS_dlyline_gate_bypass_START  (1)
#define SOC_HIPACKPHY_DDRPHY_GATED_BYPASS_dlyline_gate_bypass_END    (1)
...
/*****************************************************************************
 ...
 结构说明  : DX_PHYCTRL0 寄存器结构定义。地址偏移量:0x200+(q)*0x100，初值:0x00000000，宽度:32
 寄存器说明: PHY control registers 
            Register in this field are connected to PHY interface directly
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
...
/*****************************************************************************
 ...
 结构说明  : DX_IOCTL 寄存器结构定义。地址偏移量:0x204+(q)*0x100，初值:0x0001F805，宽度:32
 寄存器说明: IO control register
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  dxctl_ioctl_diffdqs_en            : 1;  /* bit[0]    : Differential DQS enable */
        ...
        unsigned int  reserved_4                        : 12; /* bit[17-28]:  */
        unsigned int  dqs_ioctl_odtsel                  : 3;  /* bit[29-31]:  */
    } reg;
} SOC_HIPACKPHY_DX_IOCTL_UNION;
#endif
#define SOC_HIPACKPHY_DX_IOCTL_dxctl_ioctl_diffdqs_en_START             (0)
#define SOC_HIPACKPHY_DX_IOCTL_dxctl_ioctl_diffdqs_en_END               (0)
...
/*****************************************************************************
 ...
 结构说明  : DX_DQSSEL 寄存器结构定义。地址偏移量:0x208+(q)*0x100，初值:0x0000FF00，宽度:32
 寄存器说明: Swap of DQ in PHY
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved         : 16; /* bit[16-31]: DQ swap in PHY
                                                            Each bit decides the relative DQS with DQ
                                                            1: Relative to DQS1
                                                            0: Relative to DQS0  */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : DX_DXNCKCTRL 寄存器结构定义。地址偏移量:0x20C+(q)*0x100，初值:0x00000000，宽度:32
 寄存器说明: This register is for PLL phase select within the PHY. And should not be modified.
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : DX_PHYPLLCTRL_DX 寄存器结构定义。地址偏移量:0x210+(q)*0x100，初值:0x0000000A，宽度:32
 寄存器说明: PHY PLL control registers 
            Register in this field are connected to PHY interface directly
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
...
/*****************************************************************************
 ...
 结构说明  : DX_PHYCTRL2 寄存器结构定义。地址偏移量:0x214+(q)*0x100，初值:0x00000000，宽度:32
 寄存器说明: PHY control registers 
            Register in this field are connected to PHY interface directly
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  dxctl_reg_DVALID_selfgen_en : 1;  /* bit[5]    : 0: GDS use DFI rden signals to generate the dvalid signal (default)
                                                                       ...
                                                                       Note:
                                                                        When this field is enabled, if DRAM do not response any RDQS in the read operation, there are no any dvalid generated from PHY. This may make system hanging. */
...
/*****************************************************************************
 ...
 结构说明  : DX_IOCTL1 寄存器结构定义。地址偏移量:0x218+(q)*0x100，初值:0x70500003，宽度:32
 寄存器说明: PHY control registers 
            Register in this field are connected to PHY interface directly
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_0                       : 4;  /* bit[2-5]  :  */
        unsigned int  dxctl_odt_ioctl_rdsel_p          : 3;  /* bit[6-8]  :  */
...
/*****************************************************************************
 ...
 结构说明  : DX_IOCTL2 寄存器结构定义。地址偏移量:0x21C+(q)*0x100，初值:0x030000C0，宽度:32
 寄存器说明: PHY control registers 
            Register in this field are connected to PHY interface directly
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_4                   : 4;  /* bit[26-29]:  */
...
/*****************************************************************************
 ...
 结构说明  : DX_PHYPLLCTRL_DX2 寄存器结构定义。地址偏移量:0x220+(q)*0x100，初值:0x00000055，宽度:32
 寄存器说明: PHY PLL control register
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : DX_PHYPLLCTRL_DX3 寄存器结构定义。地址偏移量:0x224+(q)*0x100，初值:0x00000000，宽度:32
 寄存器说明: PHY PLL control register 3
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  dxctl_phazmeter_in     : 16; /* bit[0-15] :  */
...
/*****************************************************************************
 ...
 结构说明  : DX_DXNCLKBDL 寄存器结构定义。地址偏移量:0x230+(q)*0x100，初值:0x00000000，宽度:32
 寄存器说明: DATA block clock bit delay line setting
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : DX_DXPHYCTRL 寄存器结构定义。地址偏移量:0x234+(q)*0x100，初值:0x000000A0，宽度:32
 寄存器说明: DX PHY control registers 
            Register in this field are connected to PHY interface directly
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    {
        unsigned int  reserved_0       : 2;  /* bit[0-1]  :  */
        unsigned int  dxctl_pll_testen : 1;  /* bit[2]    :  */
        unsigned int  dxctl_pll_init   : 1;  /* bit[3]    :  */
        unsigned int  dxctl_pll_cpi    : 3;  /* bit[4-6]  :  */
        unsigned int  dxctl_pll_sp     : 2;  /* bit[7-8]  :  */
        unsigned int  reserved_1       : 1;  /* bit[9]    :  */
        unsigned int  dxctl_pll_lt     : 2;  /* bit[10-11]:  */
...
/*****************************************************************************
 ...
 结构说明  : DX_DXNMISCCTRL0 寄存器结构定义。地址偏移量:0x238+(p)*0x80+(q)*0x100，初值:0x00020000，宽度:32
 寄存器说明: Data block PHY miscellaneous control register. This register is for PHY control, and should not be modified.
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_1                   : 2;  /* bit[24-25]:  */
...
/*****************************************************************************
 ...
 结构说明  : DX_DXNMISCCTRL1 寄存器结构定义。地址偏移量:0x264+(p)*0x80+(q)*0x100，初值:0x00000000，宽度:32
 寄存器说明: Data block PHY miscellaneous control register. This register is for PHY control, and should not be modified.
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : DX_DXDEBUG0 寄存器结构定义。地址偏移量:0x23C+(p)*0x80+(q)*0x100，初值:0x0000A815，宽度:32
 寄存器说明: Data block PHY debug signals
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved        : 16; /* bit[16-31]: Debug signals */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : DX_DXPHYRSVD 寄存器结构定义。地址偏移量:0x244+(p)*0x80+(q)*0x100，初值:0x0000FF00，宽度:32
 寄存器说明: Data block PHY reserved control pins. This register is for PHY control and should not be modified.
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : DX_DXNMISCCTRL2 寄存器结构定义。地址偏移量:0x248+(p)*0x80+(q)*0x100，初值:0x0030326E，宽度:32
 寄存器说明: Data block PHY miscellaneous control register. This register is for PHY control, and should not be modified.
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  dxctl_misc2_config               : 11; /* bit[0-10] : [10]: reg_OE_extend1T_en
                                                                            [9]: reg_dqsg_TX_2path
                                                                            [8]: reg_squeach_en
                                                                            [7]: reg_dqsglat1T_en
        ...
        unsigned int  dxctl_WREN_rank_in               : 1;  /* bit[26]   :  */
...
#endif
#define SOC_HIPACKPHY_DX_DXNMISCCTRL2_dxctl_misc2_config_START                (0)
#define SOC_HIPACKPHY_DX_DXNMISCCTRL2_dxctl_misc2_config_END                  (10)
...
#define SOC_HIPACKPHY_DX_DXNMISCCTRL2_dxctl_WREN_rank_in_START                (26)
#define SOC_HIPACKPHY_DX_DXNMISCCTRL2_dxctl_WREN_rank_in_END                  (26)
...
/*****************************************************************************
 ...
 结构说明  : DX_DXDEBUGCONFIG 寄存器结构定义。地址偏移量:0x24C+(p)*0x80+(q)*0x100，初值:0x00000000，宽度:32
 寄存器说明: Data block PHY debug/miscellaneous control register. This register is for PHY control, and should not be modified.
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : DX_DXNDCC 寄存器结构定义。地址偏移量:0x250+(p)*0x80+(q)*0x100，初值:0x00000000，宽度:32
 寄存器说明: Data block PHY DCC control register. This register is for PHY control, and should not be modified.
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
#define SOC_HIPACKPHY_DX_DXNDCC_dxctl_dq_dcc_END      (2)
#define SOC_HIPACKPHY_DX_DXNDCC_dxctl_dqsg_dcc_START  (3)
#define SOC_HIPACKPHY_DX_DXNDCC_dxctl_dqsg_dcc_END    (5)
#define SOC_HIPACKPHY_DX_DXNDCC_dxctl_dqs_dcc_START   (6)
#define SOC_HIPACKPHY_DX_DXNDCC_dxctl_dqs_dcc_END     (8)
#define SOC_HIPACKPHY_DX_DXNDCC_dxctl_mclk_dcc_START  (9)
#define SOC_HIPACKPHY_DX_DXNDCC_dxctl_mclk_dcc_END    (11)


/*****************************************************************************
 结构名    : SOC_HIPACKPHY_DX_DXNMISCCTRL3_UNION
 结构说明  : DX_DXNMISCCTRL3 寄存器结构定义。地址偏移量:0x254+(p)*0x80+(q)*0x100，初值:0x00D80000，宽度:32
 寄存器说明: Data block PHY debug/miscellaneous control register. This register is for PHY control, and should not be modified.
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  dxctl_post_margin_code  : 3;  /* bit[19-21]: Post-margin for DQS delay dynamic tracking. After modify this field, it need the "phyconn_rst" to update the latest setting. This field will be used when user adopts dly_track_type=1 tracking type, this field should be set before initial trainings and dly_track_type should be set as 0x1 after initial trainings. */
        unsigned int  dxctl_pre_margin_code   : 3;  /* bit[22-24]: Pre-margin for DQS delay dynamic tracking. After modify this field, it need the "phyconn_rst" to update the latest setting. This field will be used when user adopts dly_track_type=1 tracking type, this field should be set before initial trainings and dly_track_type should be set as 0x1 after initial trainings. */
...
/*****************************************************************************
 ...
 结构说明  : DX_DXNMISCCTRL4 寄存器结构定义。地址偏移量:0x258+(q)*0x100，初值:0x000030FF，宽度:32
 寄存器说明: Data block PHY debug/miscellaneous control register. This register is for PHY control, and should not be modified.
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  dxctl_reg_clkgated_dis        : 8;  /* bit[0-7]  : Disable PHY Clock Gating by Read/Write Command (1: Disable, 0:Enable) */
        unsigned int  dxctl_reg_dbgmode_byt1_sel    : 2;  /* bit[8-9]  :  */
        unsigned int  reserved_0                    : 2;  /* bit[10-11]:  */
        unsigned int  dxctl_reg_asy_cmd_decode_sel  : 2;  /* bit[12-13]:  */
        unsigned int  reserved_1                    : 2;  /* bit[14-15]:  */
        unsigned int  dxctl_pack_cfg_rs_passthrough : 2;  /* bit[16-17]:  */
...
#define SOC_HIPACKPHY_DX_DXNMISCCTRL4_dxctl_reg_clkgated_dis_END           (7)
#define SOC_HIPACKPHY_DX_DXNMISCCTRL4_dxctl_reg_dbgmode_byt1_sel_START     (8)
#define SOC_HIPACKPHY_DX_DXNMISCCTRL4_dxctl_reg_dbgmode_byt1_sel_END       (9)
#define SOC_HIPACKPHY_DX_DXNMISCCTRL4_dxctl_reg_asy_cmd_decode_sel_START   (12)
#define SOC_HIPACKPHY_DX_DXNMISCCTRL4_dxctl_reg_asy_cmd_decode_sel_END     (13)
#define SOC_HIPACKPHY_DX_DXNMISCCTRL4_dxctl_pack_cfg_rs_passthrough_START  (16)
#define SOC_HIPACKPHY_DX_DXNMISCCTRL4_dxctl_pack_cfg_rs_passthrough_END    (17)


/*****************************************************************************
 结构名    : SOC_HIPACKPHY_DX_IOCTL3_UNION
 结构说明  : DX_IOCTL3 寄存器结构定义。地址偏移量:0x25C+(q)*0x100，初值:0x00000000，宽度:32
 寄存器说明: IO control register
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    {
        unsigned int  reserved_0              : 18; /* bit[0-17] :  */
        unsigned int  dxctl_odt_ioctl_tdsel_p : 4;  /* bit[18-21]:  */
        unsigned int  dxctl_odt_ioctl_tdsel_n : 4;  /* bit[22-25]:  */
        unsigned int  reserved_1              : 6;  /* bit[26-31]: --- */
    } reg;
} SOC_HIPACKPHY_DX_IOCTL3_UNION;
#endif
#define SOC_HIPACKPHY_DX_IOCTL3_dxctl_odt_ioctl_tdsel_p_START  (18)
#define SOC_HIPACKPHY_DX_IOCTL3_dxctl_odt_ioctl_tdsel_p_END    (21)
#define SOC_HIPACKPHY_DX_IOCTL3_dxctl_odt_ioctl_tdsel_n_START  (22)
#define SOC_HIPACKPHY_DX_IOCTL3_dxctl_odt_ioctl_tdsel_n_END    (25)


/*****************************************************************************
 结构名    : SOC_HIPACKPHY_DX_IOCTL5_UNION
 结构说明  : DX_IOCTL5 寄存器结构定义。地址偏移量:0x260+(q)*0x100，初值:0x00000000，宽度:32
 寄存器说明: IO control register
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_HIPACKPHY_DX_BYP_CK90_CODE_UNION
 结构说明  : DX_BYP_CK90_CODE 寄存器结构定义。地址偏移量:0x278+(p)*0x80+(q)*0x100，初值:0x00000000，宽度:32
 寄存器说明: Bypass mode delay line code
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  dxctl_byp_ck90_data_code_dqs_b0 : 9;  /* bit[0-8] : bypass mode ck90 bdl value */
        unsigned int  reserved                        : 23; /* bit[9-31]:  */
    } reg;
} SOC_HIPACKPHY_DX_BYP_CK90_CODE_UNION;
#endif
#define SOC_HIPACKPHY_DX_BYP_CK90_CODE_dxctl_byp_ck90_data_code_dqs_b0_START  (0)
#define SOC_HIPACKPHY_DX_BYP_CK90_CODE_dxctl_byp_ck90_data_code_dqs_b0_END    (8)


/*****************************************************************************
 结构名    : SOC_HIPACKPHY_DX_BYP_CK90_CODE_B1_UNION
 结构说明  : DX_BYP_CK90_CODE_B1 寄存器结构定义。地址偏移量:0x27C+(p)*0x80+(q)*0x100，初值:0x00000000，宽度:32
 寄存器说明: Bypass mode delay line code shadow register
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  dxctl_byp_ck90_data_code_dqs_b1 : 9;  /* bit[0-8] : bypass mode ck90 bdl value shadow register */
        unsigned int  reserved                        : 23; /* bit[9-31]:  */
    } reg;
} SOC_HIPACKPHY_DX_BYP_CK90_CODE_B1_UNION;
#endif
#define SOC_HIPACKPHY_DX_BYP_CK90_CODE_B1_dxctl_byp_ck90_data_code_dqs_b1_START  (0)
#define SOC_HIPACKPHY_DX_BYP_CK90_CODE_B1_dxctl_byp_ck90_data_code_dqs_b1_END    (8)


/*****************************************************************************
 结构名    : SOC_HIPACKPHY_DX_DDRPHY_GATED_BYPASS_UNION
 结构说明  : DX_DDRPHY_GATED_BYPASS 寄存器结构定义。地址偏移量:0x280+(q)*0x100，初值:0x00000003，宽度:32
 寄存器说明: bypass clock gated function
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  dx_bypclk_gated_bypass : 1;  /* bit[0]   : turn off the higher level gated clock
                                                                 1: bypass gated logic
                                                                 0: turn of the gated logic */
        unsigned int  dx_dlyline_gate_bypass : 1;  /* bit[1]   : turn off the higher level gated clock
                                                                 1: bypass gated logic
                                                                 0: turn of the gated logic */
        unsigned int  reserved               : 30; /* bit[2-31]:  */
    } reg;
} SOC_HIPACKPHY_DX_DDRPHY_GATED_BYPASS_UNION;
#endif
#define SOC_HIPACKPHY_DX_DDRPHY_GATED_BYPASS_dx_bypclk_gated_bypass_START  (0)
#define SOC_HIPACKPHY_DX_DDRPHY_GATED_BYPASS_dx_bypclk_gated_bypass_END    (0)
#define SOC_HIPACKPHY_DX_DDRPHY_GATED_BYPASS_dx_dlyline_gate_bypass_START  (1)
#define SOC_HIPACKPHY_DX_DDRPHY_GATED_BYPASS_dx_dlyline_gate_bypass_END    (1)
