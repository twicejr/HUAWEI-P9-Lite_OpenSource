...
typedef union
{
    ...
    struct
    {
        unsigned int  iomg_007 : 2;  /* bit[0-1] : GPIO_185管脚的具体复用情况。
                                                   00：GPIO_185；
                                                   10：GPIO_001_SH；
                                                   其它：保留。 */
        unsigned int  reserved : 30; /* bit[2-31]: 保留。 */
...
typedef union
{
    ...
    struct
    {
        unsigned int  iomg_008 : 2;  /* bit[0-1] : GPIO_186管脚的具体复用情况。
                                                   00：GPIO_186；
                                                   11：CODEC_SSI；
                                                   其它：保留。 */
        unsigned int  reserved : 30; /* bit[2-31]: 保留。 */
...
typedef union
{
    ...
    struct
    {
        unsigned int  iomg_011 : 2;  /* bit[0-1] : SLIMBUS_CLK管脚的具体复用情况。
                                                   00：GPIO_189；
                                                   01：S2P_DI；
                                                   10：SLIMBUS_CLK；
                                                   其它：保留。 */
...
typedef union
{
    ...
    struct
    {
        unsigned int  iomg_012 : 2;  /* bit[0-1] : SLIMBUS_DATA管脚的具体复用情况。
                                                   00：GPIO_190；
                                                   01：S2P_DO；
                                                   10：SLIMBUS_DATA；
                                                   其它：保留。 */
...
typedef union
{
    ...
    struct
    {
        unsigned int  iomg_015 : 2;  /* bit[0-1] : GPIO_194管脚的具体复用情况。
                                                   00：GPIO_194；
                                                   01：I2S2_DI；
                                                   10：UART2_CTS_N；
                                                   其它：保留。 */
...
#define SOC_IOC_AO_IOMG_015_iomg_015_END    (1)
...
typedef union
{
    ...
    struct
    {
        unsigned int  iomg_016 : 2;  /* bit[0-1] : GPIO_195管脚的具体复用情况。
                                                   00：GPIO_195；
                                                   01：I2S2_DO；
                                                   10：UART2_RST_N；
                                                   其它：保留。 */
...
#define SOC_IOC_AO_IOMG_016_iomg_016_END    (1)
...
typedef union
{
    ...
    struct
    {
        unsigned int  iomg_017 : 2;  /* bit[0-1] : GPIO_196管脚的具体复用情况。
                                                   00：GPIO_196；
                                                   01：I2S2_XCLK；
                                                   10：DMIC_CLK；
                                                   其它：保留。 */
...
#define SOC_IOC_AO_IOMG_017_iomg_017_END    (1)
...
typedef union
{
    ...
    struct
    {
        unsigned int  iomg_038 : 2;  /* bit[0-1] : GPIO_218管脚的具体复用情况。
                                                   00：GPIO_218；
                                                   01：SPI2_CS_N；
                                                   10：GPIO_023_SH；
                                                   11：ISP_GPIO09_ENC。 */
