...
typedef union
{
    ...
    struct
    {
        unsigned int  iomg_012 : 3;  /* bit[0-2] : GPIO_015管脚的具体复用情况。
                                                   000：GPIO_015；
                                                   001：SPI1_CS_N；
                                                   111：TEST_006；
                                                   其它：保留。 */
...
typedef union
{
    ...
    struct
    {
        unsigned int  iomg_028 : 3;  /* bit[0-2] : GPIO_031管脚的具体复用情况。
                                                   000：GPIO_031；
                                                   111：TEST_022；
                                                   其它：保留。 */
        unsigned int  reserved : 29; /* bit[3-31]: 保留。 */
...
typedef union
{
    ...
    struct
    {
        unsigned int  iomg_029 : 3;  /* bit[0-2] : GPIO_032管脚的具体复用情况。
                                                   000：GPIO_032；
                                                   111：TEST_023；
                                                   其它：保留。 */
        unsigned int  reserved : 29; /* bit[3-31]: 保留。 */
...
typedef union
{
    ...
    struct
    {
        unsigned int  iomg_030 : 3;  /* bit[0-2] : UART0_RXD管脚的具体复用情况。
                                                   000：GPIO_033；
                                                   001：UART0_RXD；
                                                   111：TEST_024；
                                                   其它：保留。 */
...
typedef union
{
    ...
    struct
    {
        unsigned int  iomg_031 : 3;  /* bit[0-2] : UART0_TXD管脚的具体复用情况。
                                                   000：GPIO_034；
                                                   001：UART0_TXD；
                                                   111：TEST_025；
                                                   其它：保留。 */
...
typedef union
{
    ...
    struct
    {
        unsigned int  iomg_032 : 3;  /* bit[0-2] : UART0_RTS_N管脚的具体复用情况。
                                                   000：GPIO_035；
                                                   001：UART0_RTS_N；
                                                   111：TEST_026；
                                                   其它：保留。 */
...
typedef union
{
    ...
    struct
    {
        unsigned int  iomg_033 : 3;  /* bit[0-2] : UART0_CTS_N管脚的具体复用情况。
                                                   000：GPIO_036；
                                                   001：UART0_CTS_N；
                                                   111：TEST_027；
                                                   其它：保留。 */
...
typedef union
{
    ...
    struct
    {
        unsigned int  iomg_036 : 3;  /* bit[0-2] : GPIO_039管脚的具体复用情况。
                                                   000：GPIO_039；
                                                   001：I2C5_SCL；
                                                   111：TEST_030；
                                                   其它：保留。 */
...
typedef union
{
    ...
    struct
    {
        unsigned int  iomg_037 : 3;  /* bit[0-2] : GPIO_040管脚的具体复用情况。
                                                   000：GPIO_040；
                                                   001：I2C5_SDA；
                                                   111：TEST_031；
                                                   其它：保留。 */
...
typedef union
{
    ...
    struct
    {
        unsigned int  iomg_039 : 3;  /* bit[0-2] : SD_CMD管脚的具体复用情况。
                                                   000：GPIO_042；
                                                   001：SD_CMD；
                                                   010：JTAG_TMS_SWDIO_SD；
                                                   011：JTAG_TMS_M；
                                                   100：JTAG_TMS_SWDIO_SD；
                                                   111：TEST_033；
                                                   其它：保留。 */
        unsigned int  reserved : 29; /* bit[3-31]: 保留。 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  iomg_040 : 3;  /* bit[0-2] : SD_DATA0管脚的具体复用情况。
                                                   000：GPIO_043；
                                                   001：SD_DATA0；
                                                   010：JTAG_TCK_SWCLK_SD；
                                                   011：JTAG_TCK_M；
                                                   100：JTAG_TCK_SWCLK_SD；
                                                   111：TEST_034；
                                                   其它：保留。 */
        unsigned int  reserved : 29; /* bit[3-31]: 保留。 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  iomg_044 : 3;  /* bit[0-2] : GPIO_047管脚的具体复用情况。
                                                   000：GPIO_047；&#13;
                                                   111：TEST_038；
                                                   其它：保留。 */
        unsigned int  reserved : 29; /* bit[3-31]: 保留。 */
...
typedef union
{
    ...
    struct
    {
        unsigned int  iomg_047 : 3;  /* bit[0-2] : SPI0_CLK管脚的具体复用情况。
                                                   000：GPIO_050；
                                                   001：SPI0_CLK；
                                                   111：TEST_041；
                                                   其它：保留。 */
...
typedef union
{
    ...
    struct
    {
        unsigned int  iomg_048 : 3;  /* bit[0-2] : SPI0_CS0_N管脚的具体复用情况。
                                                   000：GPIO_051；
                                                   001：SPI0_CS0_N；
                                                   111：TEST_042；
                                                   其它：保留。 */
...
typedef union
{
    ...
    struct
    {
        unsigned int  iomg_049 : 3;  /* bit[0-2] : SPI0_CS1_N管脚的具体复用情况。
                                                   000：GPIO_052；
                                                   001：SPI0_CS1_N；
                                                   010：UART5_RXD；
                                                   111：TEST_043；
...
typedef union
{
    ...
    struct
    {
        unsigned int  iomg_050 : 3;  /* bit[0-2] : SPI0_CS2_N管脚的具体复用情况。
                                                   000：GPIO_053；
                                                   001：SPI0_CS2_N；
                                                   010：UART5_TXD；
                                                   111：TEST_044；
...
typedef union
{
    ...
    struct
    {
        unsigned int  iomg_053 : 3;  /* bit[0-2] : EMMC_RST_N管脚的具体复用情况。
                                                   000：GPIO_056；
                                                   001：EMMC_RST_N；
                                                   111：TEST_047；
                                                   其它：保留。 */
...
typedef union
{
    ...
    struct
    {
        unsigned int  iomg_095 : 3;  /* bit[0-2] : GPIO_098管脚的具体复用情况。
                                                   000：GPIO_098；
                                                   001：CDMA_GPS_SYNC；
                                                   010：GPIO_030_SH；
                                                   111：TEST_089；
...
typedef union
{
    ...
    struct
    {
        unsigned int  iomg_100 : 3;  /* bit[0-2] : ANTPA_SEL28管脚的具体复用情况。
                                                   000：GPIO_103；
                                                   001：ANTPA_SEL28；
                                                   010：FE2_MIPI_CLK；
                                                   111：TEST_094；
...
typedef union
{
    ...
    struct
    {
        unsigned int  iomg_101 : 3;  /* bit[0-2] : ANTPA_SEL29管脚的具体复用情况。
                                                   000：GPIO_104；
                                                   001：ANTPA_SEL29；
                                                   010：FE1_MIPI_DATA；
                                                   111：TEST_095；
...
typedef union
{
    ...
    struct
    {
        unsigned int  iomg_102 : 3;  /* bit[0-2] : ANTPA_SEL30管脚的具体复用情况。
                                                   000：GPIO_105；
                                                   001：ANTPA_SEL30；
                                                   010：FE1_MIPI_CLK；
                                                   111：TEST_096；
...
typedef union
{
    ...
    struct
    {
        unsigned int  iomg_132 : 1;  /* bit[0]   : ANTPA_SEL23管脚的具体复用情况。
                                                   0：GPIO_135；
                                                   1：ANTPA_SEL23。 */
        unsigned int  reserved : 31; /* bit[1-31]: 保留。 */
    } reg;
...
#define SOC_IOC_IOMG_132_iomg_132_END    (0)
...
typedef union
{
    ...
    struct
    {
        unsigned int  iomg_133 : 1;  /* bit[0]   : ANTPA_SEL24管脚的具体复用情况。
                                                   0：GPIO_136；
                                                   1：ANTPA_SEL24。 */
        unsigned int  reserved : 31; /* bit[1-31]: 保留。 */
    } reg;
...
#define SOC_IOC_IOMG_133_iomg_133_END    (0)
...
typedef union
{
    ...
    struct
    {
        unsigned int  iomg_134 : 1;  /* bit[0]   : ANTPA_SEL25管脚的具体复用情况。
                                                   0：GPIO_137；
                                                   1：ANTPA_SEL25。 */
        unsigned int  reserved : 31; /* bit[1-31]: 保留。 */
    } reg;
...
#define SOC_IOC_IOMG_134_iomg_134_END    (0)
...
typedef union
{
    ...
    struct
    {
        unsigned int  iomg_135 : 1;  /* bit[0]   : ANTPA_SEL26管脚的具体复用情况。
                                                   0：GPIO_138；
                                                   1：ANTPA_SEL26。 */
        unsigned int  reserved : 31; /* bit[1-31]: 保留。 */
    } reg;
...
#define SOC_IOC_IOMG_135_iomg_135_END    (0)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  iocg_041_ds0 : 1;  /* bit[4]   : DS3,DS2,DS1,DS0配置驱动力。配置档如右图表格 */
        unsigned int  iocg_041_ds1 : 1;  /* bit[5]   : DS3,DS2,DS1,DS0配置驱动力。配置档如右图表格 */
        unsigned int  iocg_041_ds2 : 1;  /* bit[6]   : DS3,DS2,DS1,DS0配置驱动力。配置档如右图表格 */
        unsigned int  iocg_041_ds3 : 1;  /* bit[7]   : DS3,DS2,DS1,DS0配置驱动力。配置档如右图表格 */
        unsigned int  reserved_1   : 24; /* bit[8-31]: 保留。 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  iocg_042_ds0 : 1;  /* bit[4]   : DS3,DS2,DS1,DS0配置驱动力。配置档如右图表格 */
        unsigned int  iocg_042_ds1 : 1;  /* bit[5]   : DS3,DS2,DS1,DS0配置驱动力。配置档如右图表格 */
        unsigned int  iocg_042_ds2 : 1;  /* bit[6]   : DS3,DS2,DS1,DS0配置驱动力。配置档如右图表格 */
        unsigned int  iocg_042_ds3 : 1;  /* bit[7]   : DS3,DS2,DS1,DS0配置驱动力。配置档如右图表格 */
        unsigned int  reserved_1   : 24; /* bit[8-31]: 保留。 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  iocg_043_ds0 : 1;  /* bit[4]   : DS3,DS2,DS1,DS0配置驱动力。配置档如右图表格 */
        unsigned int  iocg_043_ds1 : 1;  /* bit[5]   : DS3,DS2,DS1,DS0配置驱动力。配置档如右图表格 */
        unsigned int  iocg_043_ds2 : 1;  /* bit[6]   : DS3,DS2,DS1,DS0配置驱动力。配置档如右图表格 */
        unsigned int  iocg_043_ds3 : 1;  /* bit[7]   : DS3,DS2,DS1,DS0配置驱动力。配置档如右图表格 */
        unsigned int  reserved_1   : 24; /* bit[8-31]: 保留。 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  iocg_044_ds0 : 1;  /* bit[4]   : DS3,DS2,DS1,DS0配置驱动力。配置档如右图表格 */
        unsigned int  iocg_044_ds1 : 1;  /* bit[5]   : DS3,DS2,DS1,DS0配置驱动力。配置档如右图表格 */
        unsigned int  iocg_044_ds2 : 1;  /* bit[6]   : DS3,DS2,DS1,DS0配置驱动力。配置档如右图表格 */
        unsigned int  iocg_044_ds3 : 1;  /* bit[7]   : DS3,DS2,DS1,DS0配置驱动力。配置档如右图表格 */
        unsigned int  reserved_1   : 24; /* bit[8-31]: 保留。 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  iocg_045_ds0 : 1;  /* bit[4]   : DS3,DS2,DS1,DS0配置驱动力。配置档如右图表格 */
        unsigned int  iocg_045_ds1 : 1;  /* bit[5]   : DS3,DS2,DS1,DS0配置驱动力。配置档如右图表格 */
        unsigned int  iocg_045_ds2 : 1;  /* bit[6]   : DS3,DS2,DS1,DS0配置驱动力。配置档如右图表格 */
        unsigned int  iocg_045_ds3 : 1;  /* bit[7]   : DS3,DS2,DS1,DS0配置驱动力。配置档如右图表格 */
        unsigned int  reserved_1   : 24; /* bit[8-31]: 保留。 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  iocg_046_ds0 : 1;  /* bit[4]   : DS3,DS2,DS1,DS0配置驱动力。配置档如右图表格 */
        unsigned int  iocg_046_ds1 : 1;  /* bit[5]   : DS3,DS2,DS1,DS0配置驱动力。配置档如右图表格 */
        unsigned int  iocg_046_ds2 : 1;  /* bit[6]   : DS3,DS2,DS1,DS0配置驱动力。配置档如右图表格 */
        unsigned int  iocg_046_ds3 : 1;  /* bit[7]   : DS3,DS2,DS1,DS0配置驱动力。配置档如右图表格 */
        unsigned int  reserved_1   : 24; /* bit[8-31]: 保留。 */
    } reg;
