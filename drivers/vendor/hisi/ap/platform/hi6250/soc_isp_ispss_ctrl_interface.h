...
/*****************************************************************************
 ...
 结构说明  : REVISION_ID 寄存器结构定义。地址偏移量:0x0008，初值:0x141110A1，宽度:32
 寄存器说明: IP revision number.
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
typedef union
{
    ...
    struct
    {
        unsigned int  reserved_0: 1;  /* bit[0]    : reserved (Functional clock on module PRESCALER is gated when set to 0) */
        unsigned int  reserved_1: 1;  /* bit[1]    : reserved (Functional clock on module SCALER_3 is gated when set to 0) */
        unsigned int  reserved_2: 1;  /* bit[2]    : reserved (Functional clock on module FD is gated when set to 0) */
        unsigned int  cgr_3    : 1;  /* bit[3]    : Functional clock on module JPGENC is gated when set to 0 */
        unsigned int  reserved_3: 1;  /* bit[4]    : reserved (Functional clock on module CVDR_SRAM is gated when set to 0) */
        ...
        unsigned int  reserved_4: 1;  /* bit[9]    : reserved (Functional clock on module CSI2IF_C is gated when set to 0) */
        ...
        unsigned int  cgr_14   : 1;  /* bit[14]   : Functional clock on module CMDLST is gated when set to 0 */
        unsigned int  reserved_5: 17; /* bit[15-31]: Reserved */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  cgr_0    : 1;  /* bit[0]   : Functional clock on module FBCRAW_1_1 is gated when set to 0 */
        unsigned int  cgr_1    : 1;  /* bit[1]   : Functional clock on module FBDRAW_1_1 is gated when set to 0 */
        unsigned int  reserved_0: 1;  /* bit[2]   : reserved (Functional clock on module FBCYUV_(x) is gated when set to 0) */
        unsigned int  reserved_1: 1;  /* bit[3]   : reserved (Functional clock on module FBDYUV_(x) is gated when set to 0) */
        ...
        unsigned int  cgr_6    : 1;  /* bit[6]   : Functional clock on module FBCRAW_2_1 is gated when set to 0 */
        unsigned int  reserved_2: 25; /* bit[7-31]: Reserved */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_0: 1;  /* bit[1]   : Reserved(Functional clock on module FBDRAW_(x) is gated when set to 0) */
        unsigned int  reserved_1: 1;  /* bit[2]   : Reserved(Functional clock on module FBCYUV_(x) is gated when set to 0) */
        unsigned int  reserved_2: 1;  /* bit[3]   : Reserved(Functional clock on module FBDYUV_(x) is gated when set to 0) */
        unsigned int  reserved_3: 1;  /* bit[4]   : Reserved(Functional clock on module SCALER_1_(x) is gated when set to 0) */
        unsigned int  reserved_4: 1;  /* bit[5]   : Reserved(Functional clock on module SCALER_2_(x) is gated when set to 0) */
        unsigned int  cgr_6    : 1;  /* bit[6]   : Functional clock on module FBCRAW_2_2 is gated when set to 0 */
        unsigned int  reserved_5: 25; /* bit[7-31]: Reserved */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  cgr_0    : 1;  /* bit[0]   : Functional clock on module BLC_(x) is gated when set to 0 */
        unsigned int  cgr_1    : 1;  /* bit[1]   : Functional clock on module DGAMMA_(x) is gated when set to 0 */
        unsigned int  reserved_0: 1;  /* bit[2]   : reserved(Functional clock on module LSC_(x) is gated when set to 0) */
        unsigned int  reserved_1: 1;  /* bit[3]   : reserved(Functional clock on module DPCC_(x) is gated when set to 0) */
        ...
        unsigned int  reserved_2: 1;  /* bit[6]   : reserved(Functional clock on module RAWNF_(x) is gated when set to 0) */
        unsigned int  cgr_7    : 1;  /* bit[7]   : Functional clock on module BAS_(x) is gated when set to 0 */
        unsigned int  cgr_8    : 1;  /* bit[8]   : Functional clock on module PDAF_(x) is gated when set to 0 */
        unsigned int  reserved_3: 23; /* bit[9-31]: Reserved */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_0: 1;  /* bit[11]   : reserved(Functional clock on module TNR_(x) is gated when set to 0) */
        unsigned int  reserved_1: 1;  /* bit[12]   : reserved(Functional clock on module IE_(x) is gated when set to 0) */
        unsigned int  cgr_13   : 1;  /* bit[13]   : Functional clock on module LSC_(x) is gated when set to 0 */
        unsigned int  cgr_14   : 1;  /* bit[14]   : Functional clock on module DPCC_(x) is gated when set to 0 */
        unsigned int  cgr_15   : 1;  /* bit[15]   : Functional clock on module RAWNF_(x) is gated when set to 0 */
...
typedef union
{
    ...
    struct
    {
        unsigned int  reserved_0: 1;  /* bit[0]    : Reserved(Functional clock on module AWBGAIN_(x) is gated when set to 0) */
        unsigned int  reserved_1: 1;  /* bit[1]    : Reserved(Functional clock on module GCD_(x) is gated when set to 0) */
        unsigned int  reserved_2: 1;  /* bit[2]    : Reserved(Functional clock on module UVUP_(x) is gated when set to 0) */
        unsigned int  reserved_3: 1;  /* bit[3]    : Reserved(Functional clock on module CC_(x) is gated when set to 0) */
        unsigned int  reserved_4: 1;  /* bit[4]    : Reserved(Functional clock on module DRC_(x) is gated when set to 0) */
        unsigned int  reserved_5: 1;  /* bit[5]    : Reserved(Functional clock on module GAMMA_(x) is gated when set to 0) */
        unsigned int  reserved_6: 1;  /* bit[6]    : Reserved(Functional clock on module YUV2RGB_(x) is gated when set to 0) */
        unsigned int  reserved_7: 1;  /* bit[7]    : Reserved(Functional clock on module UVDEC_(x) is gated when set to 0) */
        unsigned int  reserved_8: 1;  /* bit[8]    : Reserved(Functional clock on module CE_(x) is gated when set to 0) */
        unsigned int  reserved_9: 1;  /* bit[9]    : Reserved(Functional clock on module YUVNF_(x) is gated when set to 0) */
        unsigned int  reserved_10: 1;  /* bit[10]   : Reserved(Functional clock on module SHARPEN_(x) is gated when set to 0) */
        unsigned int  reserved_11: 1;  /* bit[11]   : Reserved(Functional clock on module TNR_(x) is gated when set to 0) */
        unsigned int  reserved_12: 1;  /* bit[12]   : Reserved(Functional clock on module IE_(x) is gated when set to 0) */
        unsigned int  reserved_13: 19; /* bit[13-31]: Reserved */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_0     : 1;  /* bit[3]    : Reserved(Put all memories of TNR_(x) in light_sleep when set to 1) */
        ...
        unsigned int  reserved_1     : 1;  /* bit[7]    : Reserved(Put all memories of E_SRAM_(x) (64KB - block A)in light_sleep when set to 1) */
        unsigned int  light_sleep_8  : 1;  /* bit[8]    : Put all memories of STREAM_ROUTER in light_sleep when set to 1 */
        unsigned int  reserved_2     : 1;  /* bit[9]    : Reserved(Put all memories of PRESCALER in light_sleep when set to 1) */
        unsigned int  reserved_3     : 1;  /* bit[10]   : Reserved(Put all memories of SCALER_3 in light_sleep when set to 1) */
        unsigned int  light_sleep_11 : 1;  /* bit[11]   : Put all memories of JPGENC in light_sleep when set to 1 */
        unsigned int  reserved_4     : 1;  /* bit[12]   : Reserved(Put all memories of FD in light_sleep when set to 1) */
        unsigned int  light_sleep_13 : 1;  /* bit[13]   : Put all memories of DEBUG in light_sleep when set to 1 */
        unsigned int  light_sleep_14 : 1;  /* bit[14]   : Put all memories of FBCRAW_1_(x) and FBDRAW_(x) channels associated to pipe (x) in light_sleep when set to 1 */
        unsigned int  reserved_5     : 1;  /* bit[15]   : Reserved(Put all memories of FBCYUV_(x) and FBDYUV_(x) channels associated to pipe (x) in light_sleep when set to 1) */
        unsigned int  reserved_6     : 1;  /* bit[16]   : Reserved(Put all memories of Frame_merger when set to 1) */
        unsigned int  reserved_7     : 1;  /* bit[17]   : Reserved(Put all memories of E_SRAM_(x) (32KB - block C)in light_sleep when set to 1) */
        unsigned int  reserved_8     : 1;  /* bit[18]   : Reserved(Put all memories of E_SRAM_(x) (32KB - block B)in light_sleep when set to 1) */
        unsigned int  light_sleep_19 : 1;  /* bit[19]   : Put all memories of FBCRAW_2_(x) channels associated to pipe (x) in light_sleep when set to 1 */
        unsigned int  reserved_9     : 12; /* bit[20-31]: Reserved */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  light_sleep_0 : 1;  /* bit[0]   : Put all memories of ISP_FE_(x) except BAS_(x)in light_sleep when set to 1 */
        unsigned int  light_sleep_1 : 1;  /* bit[1]   : Put all memories of BAS_(x)in light_sleep when set to 1 */
        unsigned int  reserved_0    : 1;  /* bit[2]   : Reserved(Put all memories of ISP_BE_(x) except TNR_(x) in light_sleep when set to 1) */
        unsigned int  reserved_1    : 1;  /* bit[3]   : Reserved(Put all memories of TNR_(x) in light_sleep when set to 1) */
        unsigned int  reserved_2    : 1;  /* bit[4]   : Reserved(Put all memories of SCALER_1_(x)in light_sleep when set to 1) */
        unsigned int  reserved_3    : 1;  /* bit[5]   : Reserved(Put all memories of SCALER_2_(x)in light_sleep when set to 1) */
        unsigned int  reserved_4    : 1;  /* bit[6]   : reserved */
        unsigned int  light_sleep_7 : 1;  /* bit[7]   : Put all memories of FBCRAW_1_(x) channels associated to pipe (x) in light_sleep when set to 1 */
        unsigned int  light_sleep_8 : 1;  /* bit[8]   : Put all memories of FBCRAW_2_(x) channels associated to pipe (x) in light_sleep when set to 1 */
        unsigned int  reserved_5    : 23; /* bit[9-31]: Reserved */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_0    : 1;  /* bit[3]    : Reserved(Put all memories of TNR_(x) in deep_sleep when set to 1) */
        ...
        unsigned int  reserved_1    : 1;  /* bit[7]    : Reserved(Put all memories of E_SRAM_(x) (64KB - block A)in deep_sleep when set to 1) */
        unsigned int  deep_sleep_8  : 1;  /* bit[8]    : Put all memories of STREAM_ROUTER in deep_sleep when set to 1 */
        unsigned int  reserved_2    : 1;  /* bit[9]    : Reserved(Put all memories of PRESCALER in deep_sleep when set to 1) */
        unsigned int  reserved_3    : 1;  /* bit[10]   : Reserved(Put all memories of SCALER_3 in deep_sleep when set to 1) */
        unsigned int  deep_sleep_11 : 1;  /* bit[11]   : Put all memories of JPGENC in deep_sleep when set to 1 */
        unsigned int  reserved_4    : 1;  /* bit[12]   : Reserved(Put all memories of FD in deep_sleep when set to 1) */
        ...
        unsigned int  reserved_5    : 1;  /* bit[15]   : Reserved(Put all memories of FBCYUV_(x) and FBDYUV_(x) channels associated to pipe (x) in deep_sleep when set to 1) */
        unsigned int  reserved_6    : 1;  /* bit[16]   : Reserved(Put all memories of Frame_merger when set to 1) */
        unsigned int  reserved_7    : 1;  /* bit[17]   : Reserved(Put all memories of E_SRAM_(x) (32KB - block C)in deep_sleep when set to 1) */
        unsigned int  reserved_8    : 1;  /* bit[18]   : Reserved(Put all memories of E_SRAM_(x) (32KB - block B) in deep_sleep when set to 1) */
        unsigned int  deep_sleep_19 : 1;  /* bit[19]   : Put all memories of FBCRAW_2_(x) channels associated to pipe (x) in deep_sleep when set to 1 */
        unsigned int  reserved_9    : 12; /* bit[20-31]: Reserved */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  deep_sleep_0 : 1;  /* bit[0]   : Put all memories of ISP_FE_(x) except BAS_(x)in deep_sleep when set to 1 */
        unsigned int  deep_sleep_1 : 1;  /* bit[1]   : Put all memories of BAS_(x)in deep_sleep when set to 1 */
        unsigned int  reserved_0   : 1;  /* bit[2]   : Reserved(Put all memories of ISP_BE_(x) except TNR_(x) in deep_sleep when set to 1) */
        unsigned int  reserved_1   : 1;  /* bit[3]   : Reserved(Put all memories of TNR_(x) in deep_sleep when set to 1) */
        unsigned int  reserved_2   : 1;  /* bit[4]   : Reserved(Put all memories of SCALER_1_(x)in deep_sleep when set to 1) */
        unsigned int  reserved_3   : 1;  /* bit[5]   : Reserved(Put all memories of SCALER_2_(x)in deep_sleep when set to 1) */
        unsigned int  reserved_4   : 1;  /* bit[6]   : reserved */
        unsigned int  deep_sleep_7 : 1;  /* bit[7]   : Put all memories of FBCRAW_1_(x) and FBDRAW_(x) channels associated to pipe (x) in deep_sleep when set to 1 */
        unsigned int  deep_sleep_8 : 1;  /* bit[8]   : Put all memories of FBCRAW_2_(x) channels associated to pipe (x) in deep_sleep when set to 1 */
        unsigned int  reserved_5   : 23; /* bit[9-31]: Reserved */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_0    : 1;  /* bit[3]    : Reserved(Put all memories of TNR_(x) in power_down when set to 1) */
        ...
        unsigned int  reserved_1    : 1;  /* bit[7]    : Reserved(Put all memories of E_SRAM_(x) (64KB -block C)in power_down when set to 1) */
        unsigned int  power_down_8  : 1;  /* bit[8]    : Put all memories of STREAM_ROUTER in power_down when set to 1 */
        unsigned int  reserved_2    : 1;  /* bit[9]    : Reserved(Put all memories of PRESCALER in power_down when set to 1) */
        unsigned int  reserved_3    : 1;  /* bit[10]   : Reserved(Put all memories of SCALER_3 in power_down when set to 1) */
        unsigned int  power_down_11 : 1;  /* bit[11]   : Put all memories of JPGENC in power_down when set to 1 */
        unsigned int  reserved_4    : 1;  /* bit[12]   : Reserved(Put all memories of FD in power_down when set to 1) */
        ...
        unsigned int  reserved_5    : 1;  /* bit[15]   : Reserved(Put all memories of FBCYUV_(x) and FBDYUV_(x) channels associated to pipe (x) in power_down when set to 1) */
        unsigned int  reserved_6    : 1;  /* bit[16]   : Reserved(Put all memories of Frame_merger when set to 1) */
        unsigned int  reserved_7    : 1;  /* bit[17]   : Reserved(Put all memories of E_SRAM_(x) (32KB -block C)in power_down when set to 1) */
        unsigned int  reserved_8    : 1;  /* bit[18]   : Reserved(Put all memories of E_SRAM_(x) (32KB -block B)in power_down when set to 1) */
        unsigned int  power_down_19 : 1;  /* bit[19]   : Put all memories of FBCRAW_2_(x) channels associated to pipe (x) in deep_sleep when set to 1 */
        unsigned int  reserved_9    : 12; /* bit[20-31]: Reserved */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  power_down_0 : 1;  /* bit[0]   : Put all memories of ISP_FE_(x) except BAS_(x)in power_down when set to 1 */
        unsigned int  power_down_1 : 1;  /* bit[1]   : Put all memories of BAS_(x)in power_down when set to 1 */
        unsigned int  reserved_0   : 1;  /* bit[2]   : Reserved(Put all memories of ISP_BE_(x) except TNR_(x) in power_down when set to 1) */
        unsigned int  reserved_1   : 1;  /* bit[3]   : Reserved(Put all memories of TNR_(x) in power_down when set to 1) */
        unsigned int  reserved_2   : 1;  /* bit[4]   : Reserved(Put all memories of SCALER_1_(x)in power_down when set to 1) */
        unsigned int  reserved_3   : 1;  /* bit[5]   : Reserved(Put all memories of SCALER_2_(x)in power_down when set to 1) */
        unsigned int  reserved_4   : 1;  /* bit[6]   : reserved */
        unsigned int  power_down_7 : 1;  /* bit[7]   : Put all memories of FBCRAW_1_(x) channels associated to pipe (x) in power_down when set to 1 */
        unsigned int  power_down_8 : 1;  /* bit[8]   : Put all memories of FBCRAW_2_(x) channels associated to pipe (x) in power_down when set to 1 */
        unsigned int  reserved_5   : 23; /* bit[9-31]: Reserved */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  reserved_0: 1;  /* bit[0]    : Reserved(Reset PRESCALER when set to 1) */
        unsigned int  reserved_1: 1;  /* bit[1]    : Reserved(Reset SCALER_3 when set to 1) */
        unsigned int  reserved_2: 1;  /* bit[2]    : Reserved(Reset FD when set to 1) */
        ...
        unsigned int  reserved_4: 1;  /* bit[9]    : Reserved(Reset CSI2IF_C when set to 1) */
        ...
        unsigned int  reserved_5: 1;  /* bit[16]   : Reserved(Reset full ISP_BE_2 ( all sub_modules) when set to 1) */
        unsigned int  rst_17   : 1;  /* bit[17]   : Reset CMDLST when set to 1 */
        unsigned int  reserved_6: 14; /* bit[18-31]: Reserved */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  rst_0    : 1;  /* bit[0]   : Reset FBDRAW_1_(x) when set to 1 */
        unsigned int  rst_1    : 1;  /* bit[1]   : Reset FBCRAW_1_(x) when set to 1 */
        unsigned int  reserved_0: 1;  /* bit[2]   : Reserved(Reset FBDYUV_(x) when set to 1) */
        unsigned int  reserved_1: 1;  /* bit[3]   : Reserved(Reset FBCYUV_(x) when set to 1) */
        unsigned int  rst_4    : 1;  /* bit[4]   : Reset SCALER_1_(x) when set to 1 */
        unsigned int  rst_5    : 1;  /* bit[5]   : Reset SCALER_2_(x) when set to 1 */
        unsigned int  rst_6    : 1;  /* bit[6]   : Reset FBCRAW_2_(x) when set to 1 */
        unsigned int  reserved_2: 25; /* bit[7-31]: Reserved */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  reserved_0: 1;  /* bit[0]   : Reserved(Reset FBDRAW_(x) when set to 1) */
        unsigned int  rst_1    : 1;  /* bit[1]   : Reset FBCRAW_1_(x) when set to 1 */
        unsigned int  reserved_1: 1;  /* bit[2]   : Reserved(Reset FBDYUV_(x) when set to 1) */
        unsigned int  reserved_2: 1;  /* bit[3]   : Reserved(Reset FBCYUV_(x) when set to 1) */
        unsigned int  reserved_3: 1;  /* bit[4]   : Reserved(Reset SCALER_1_(x) when set to 1) */
        unsigned int  reserved_4: 1;  /* bit[5]   : Reserved(Reset SCALER_2_(x) when set to 1) */
        unsigned int  rst_6    : 1;  /* bit[6]   : Reset FBCRAW_2_(x) when set to 1 */
        unsigned int  reserved_5: 25; /* bit[7-31]: Reserved */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_0: 1;  /* bit[2]   : Reserved(Reset LSC_(x) when set to 1) */
        unsigned int  reserved_1: 1;  /* bit[3]   : Reserved(Reset DPCC_(x) when set to 1) */
        unsigned int  rst_4    : 1;  /* bit[4]   : Reset STAT3A_(x) when set to 1 */
        unsigned int  rst_5    : 1;  /* bit[5]   : Reset STATDIS_(x) when set to 1 */
        unsigned int  reserved_2: 1;  /* bit[6]   : Reserved(Reset RAWNF_(x) when set to 1) */
        unsigned int  rst_7    : 1;  /* bit[7]   : Reset BAS_(x) when set to 1 */
        unsigned int  rst_8    : 1;  /* bit[8]   : Reset PDAF_(x) when set to 1 */
        unsigned int  reserved_3: 23; /* bit[9-31]: Reserved */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_0: 1;  /* bit[11]   : Reserved(Reset TNR_(x) when set to 1) */
        unsigned int  reserved_1: 1;  /* bit[12]   : Reserved(Reset IE when set to 1) */
        unsigned int  rst_13   : 1;  /* bit[13]   : Reserved(Reset LSC_(x) when set to 1) */
        unsigned int  rst_14   : 1;  /* bit[14]   : Reserved(Reset DPCC_(x) when set to 1) */
        unsigned int  rst_15   : 1;  /* bit[15]   : Reserved(Reset RAWNF_(x) when set to 1) */
        unsigned int  reserved_2: 16; /* bit[16-31]: Reserved */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  reserved_0: 1;  /* bit[0]    : Reserved(Reset AWBGAIN_(x) when set to 1) */
        unsigned int  reserved_1: 1;  /* bit[1]    : Reserved(Reset GCD_(x) when set to 1) */
        unsigned int  reserved_2: 1;  /* bit[2]    : Reserved(Reset UVUP_(x) when set to 1) */
        unsigned int  reserved_3: 1;  /* bit[3]    : Reserved(Reset CC_(x) when set to 1) */
        unsigned int  reserved_4: 1;  /* bit[4]    : Reserved(Reset DRC_(x) when set to 1) */
        unsigned int  reserved_5: 1;  /* bit[5]    : Reserved(Reset GAMMA_(x) when set to 1) */
        unsigned int  reserved_6: 1;  /* bit[6]    : Reserved(Reset YUV2RGB_(x) when set to 1) */
        unsigned int  reserved_7: 1;  /* bit[7]    : Reserved(Reset UVDEC_(x) when set to 1) */
        unsigned int  reserved_8: 1;  /* bit[8]    : Reserved(Reset CE_(x) when set to 1) */
        unsigned int  reserved_9: 1;  /* bit[9]    : Reserved(Reset YUVNF_(x) when set to 1) */
        unsigned int  reserved_10: 1;  /* bit[10]   : Reserved(Reset SHARPEN_(x) when set to 1) */
        unsigned int  reserved_11: 1;  /* bit[11]   : Reserved(Reset TNR_(x) when set to 1) */
        unsigned int  reserved_12: 1;  /* bit[12]   : Reserved(Reset IE when set to 1) */
        unsigned int  reserved_13: 1;  /* bit[13]   : Reserved(Reset LSC_(x) when set to 1) */
        unsigned int  reserved_14: 1;  /* bit[14]   : Reserved(Reset DPCC_(x) when set to 1) */
        unsigned int  reserved_15: 1;  /* bit[15]   : Reserved(Reset RAWNF_(x) when set to 1) */
        unsigned int  reserved_16: 16; /* bit[16-31]: Reserved */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_1               : 2;  /* bit[2-3]  : Reserved
                                                                    Define the size of the image processed by the FD
                                                                    00 -> QVGA (320x240)
                                                                    01 -> VGA (640x480)
                                                                    10 -> WQVGA (427x240)
                                                                    11 -> WVGA+ (854x480) */
        unsigned int  flash_mode               : 1;  /* bit[4]    : 0: sensor interface works independently from flash control unit 
                                                                    1: one frame is captured when signaled by flash control unit [Note: This is mode is currently not used] */
        unsigned int  reserved_2               : 1;  /* bit[5]    : Reserved */
        unsigned int  reserved_3               : 3;  /* bit[6-8]  : Reserved 
                                                                    Static embedded SRAM connectity configuration
        ...
        unsigned int  disable_axi_data_packing : 1;  /* bit[9]    : This control is enabling the packing of a full burst in the AXI async bridge FIFO before the request is sent to the SOC. It has been added to secure the late AXI fix
                                                                    0: packing is active
                                                                    1: no packing */
        unsigned int  spare                    : 2;  /* bit[10-11]: Spare  */
        unsigned int  reserved_4               : 20; /* bit[12-31]: Reserved */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  reserved_0      : 1;  /* bit[0]    : Reserved - Select if the stream on ISP_BE_(x) (port 1) comes from the ISP_FE_(x) or stream_router.Used to drive the SELECT input of VPM2TO1_32_(x)
                                                           0 -> From ISP_FE_(x)
        ...
        unsigned int  reserved_2      : 1;  /* bit[4]    : Reserved - The FBCRAW may be associated to the STREAM_ROUTER out or the the ISP_FE exclusively. For video use case, the compression is used on the ISP_FE (Vstab) whereas for the Still image capture of large image, RAW Frame is sent to DRAM after STREAM_ROUTER - VPM2TO1_40_(x)
                                                           0 -> Data from Stream_router is sent to FBCRAW
                                                           1 -> Data from ISP_FE is sent to FBCRAW. */
        unsigned int  reserved_3      : 2;  /* bit[5-6]  : Reserved - VPM2TO1_42_(x)
                                                           00 -> Data from STREAM_ROUTER is sent to DRAM
                                                           01 -> Reserved
                                                           10 -> Data from ISP_FE is seent to DRAM
                                                           11 -> reserved ( same as 0b10) */
        unsigned int  reserved_4      : 1;  /* bit[7]    : Reserved - VPM2TO1_41_(x)
                                                           0 -> Data from ISP_FE is sent to DRAM
                                                           1 -> Data from FBCRAW is sent to DRAM */
        unsigned int  reserved_5      : 1;  /* bit[8]    : Reserved - Allow selection of FBDRAW to be used either on the ISP_FE input or on the ISP_BE input VPM2TO1_46_(x)
                                                           0 -> Data from CVDR(R1.x) is sent to FBDRAW
                                                           1 -> Data from CVDR(R10.x) is sent to FBDRAW */
        unsigned int  reserved_6      : 1;  /* bit[9]    : Reserved - Allow selection of FBDRAW to be used either on the ISP_FE input or on the ISP_BE input VPM2TO1_45_(x)
                                                           0 -> Data from CVDR(R10.x) is sent ISP_FE
                                                           1 -> Data from FBDRAW is sent ISP_FE */
        unsigned int  reserved_7      : 1;  /* bit[10]   : Allow selection of FBDRAW to be used either on the ISP_FE input or on the ISP_BE input VPM2TO1_44_(x)
                                                           0 -> Data from FBDRAW is sent ISP_BE
                                                           1 -> Data from CVDR(R1.x) is sent ISP_BE */
        unsigned int  reserved_8      : 5;  /* bit[11-15]: Reserved for extra explicit VPM control */
        unsigned int  reserved_9      : 1;  /* bit[16]   : reserved */
        unsigned int  reserved_10     : 1;  /* bit[17]   : Reserved - Select connection between ISP_BE_1 and SCALER_1_1 to JPGENC 
                                                           0 -> JPGENC (port pipe 1)is connected to SCALER_1_1.Default configuration
                                                           1 -> JPEGENC (port pipe 1) is connected to ISP_BE_1 */
        unsigned int  reserved_11     : 1;  /* bit[18]   : Reserved - Select connection to input of SCALER_1_2 between ISP_BE_1 or ISP_BE_2 (VPM_48_1)
                                                           0 -> SCALER_1_2 is connected to ISP_BE_2. Default configuration
                                                           1 -> SCALER_1_2 is connected to ISP_BE_1. */
        unsigned int  reserved_12     : 1;  /* bit[19]   : Reserved - Select connection to input of SCALER_2_2 between ISP_BE_1 or ISP_BE_2 (VPM_49_1)
                                                           0 -> SCALER_2_2 is connected to ISP_BE_2. Default configuration
                                                           1 -> SCALER_2_2 is connected to ISP_BE_1.  */
        unsigned int  reserved_13     : 1;  /* bit[20]   : Reserved - Select connection to DRAM between output of TNR_x and output of ISP_BE_x (VPM_51_1)
                                                           0 -> TNR_1 is connect to FBCYUV (DRAM). Default configuration
                                                           1 -> ISP_BE_1 is connected to FBDYUV (DRAM). */
        unsigned int  spare           : 2;  /* bit[21-22]: Spare  */
        unsigned int  reserved_14     : 9;  /* bit[23-31]: Reserved */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  reserved_0: 1;  /* bit[0]    : Reserved - Select if the stream on ISP_BE_(x) (port 1) comes from the ISP_FE_(x) or stream_router.Used to drive the SELECT input of VPM2TO1_32_(x)
                                                     0 -> From ISP_FE_(x)
                                                     1 -> From STREAM_ROUTER  */
        unsigned int  reserved_1: 1;  /* bit[1]    : Reserved - The scaler_1 can be used from memory to memory when it is not used for the image capture.Used to drive the SELECT input of VPM2TO1_38_(x)
                                                     0 -> The scaler_1 is connected to the ISP_BE_(x)
                                                     1 -> The scaler_1 is connected to the DRAM through the CDVR . */
        unsigned int  reserved_2: 1;  /* bit[2]    : The scaler_2 can be used from memory to memory when it is not used for the image capture. Used to drive the SELECT input of VPM2TO1_39_(x)
                                                     0 -> The scaler_2 is connected to the ISP_BE_(x)
                                                     1 -> The scaler_2 is connected to the DRAM through the CDVR . */
        unsigned int  reserved_3: 1;  /* bit[3]    : Reserved */
        unsigned int  reserved_4: 1;  /* bit[4]    : Reserved - The FBCRAW may be associated to the STREAM_ROUTER out or the the ISP_FE exclusively. For video use case, the compression is used on the ISP_FE (Vstab) whereas for the Still image capture of large image, RAW Frame is sent to DRAM after STREAM_ROUTER - VPM2TO1_40_(x)
                                                     0 -> Data from Stream_router is sent to FBCRAW
                                                     1 -> Data from ISP_FE is sent to FBCRAW.  */
        unsigned int  reserved_5: 2;  /* bit[5-6]  : Reserved - VPM2TO1_42_(x)
                                                     00 -> Data from STREAM_ROUTER is sent to DRAM
                                                     01 -> Data from FBCRAW is sent to DRAM
                                                     10 -> Data from ISP_FE is seent to DRAM
                                                     11 -> reserved ( same as 0b10) */
        unsigned int  reserved_6: 1;  /* bit[7]    : Reserved - VPM2TO1_41_(x)
                                                     0 -> Data from ISP_FE is sent to DRAM
                                                     1 -> Data from FBCRAW is sent to DRAM */
        unsigned int  reserved_7: 1;  /* bit[8]    : Reserved - Allow selection of FBDRAW to be used either on the ISP_FE input or on the ISP_BE input VPM2TO1_46_(x)
                                                     0 -> Data from CVDR(R1.x) is sent to FBDRAW
                                                     1 -> Data from CVDR(R10.x) is sent to FBDRAW */
        unsigned int  reserved_8: 1;  /* bit[9]    : Reserved -Allow selection of FBDRAW to be used either on the ISP_FE input or on the ISP_BE input VPM2TO1_45_(x)
                                                     0 -> Data from CVDR(R10.x) is sent ISP_FE
                                                     1 -> Data from FBDRAW is sent ISP_FE */
        unsigned int  reserved_9: 1;  /* bit[10]   : Reserved - Allow selection of FBDRAW to be used either on the ISP_FE input or on the ISP_BE input VPM2TO1_44_(x)
                                                     0 -> Data from FBDRAW is sent ISP_BE
                                                     1 -> Data from CVDR(R1.x) is sent ISP_BE */
        unsigned int  reserved_10: 5;  /* bit[11-15]: Reserved for extra explicit VPM control */
        unsigned int  reserved_11: 1;  /* bit[16]   : reserved */
        unsigned int  reserved_12: 1;  /* bit[17]   : Reserved - Select connection between ISP_BE_2 and SCALER_1_2 to JPGENC 
                                                      0 -> JPGENC (port pipe1) is connected to SCALER_1_2.Default configuration
                                                      1 -> JPEGENC (port pipe 1) is connected to ISP_BE_2 */
        unsigned int  reserved_13: 14; /* bit[18-31]: Reserved */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_0   : 1;  /* bit[1]    : Reserved - Configure the CVDR connected to the R1.2 (FBDRAW_1_2)channel as: 
                                                        1 -> Real Time initiator
                                                        0 -> Soft Real Time initiator */
        unsigned int  reserved_1   : 1;  /* bit[2]    : Reserved - Configure the CVDR connected to the R3.1 (FBDYUV_1_1)channel as:
                                                        1 -> Real Time initiator
                                                        0 -> Soft Real Time initiator */
        unsigned int  reserved_2   : 1;  /* bit[3]    : Reserved - Configure the CVDR connected to the R3.2 (FBDYUV_1_2)channel as:
                                                        1 -> Real Time initiator
                                                        0 -> Soft Real Time initiator */
        unsigned int  r2_1_rt_srt  : 1;  /* bit[4]    : Configure the CVDR connected to the R2.1 (CMDLST)channel as:
                                                        1 -> Real Time initiator
                                                        0 -> Soft Real Time initiator */
        unsigned int  reserved_3   : 1;  /* bit[5]    : reserved */
        unsigned int  r11_1_rt_srt : 1;  /* bit[6]    : Configure the CVDR connected to the R11.1 (ITAP_1_1)channel as:
                                                        1 -> Real Time initiator
                                                        0 -> Soft Real Time initiator */
        unsigned int  r11_2_rt_srt : 1;  /* bit[7]    : Configure the CVDR connected to the R11.2 (ITAP_1_2)channel as:
                                                        1 -> Real Time initiator
                                                        0 -> Soft Real Time initiator */
        unsigned int  r12_1_rt_srt : 1;  /* bit[8]    : Configure the CVDR connected to the R12.1 (ITAP_2_1)channel as:
                                                        1 -> Real Time initiator
                                                        0 -> Soft Real Time initiator */
        unsigned int  r12_2_rt_srt : 1;  /* bit[9]    : Configure the CVDR connected to the R12.2 (ITAP_2_2)channel as:
                                                        1 -> Real Time initiator
                                                        0 -> Soft Real Time initiator */
        unsigned int  reserved_4   : 22; /* bit[10-31]: Reserved */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  w1_2_rt_srt   : 1;  /* bit[1]    : Configure the CVDR connected to the W1.2 (CROP_ISP_FE_2) channel as:
                                                         1 -> Real Time initiator
                                                         0 -> Soft Real Time initiator */
        unsigned int  w14_1_rt_srt  : 1;  /* bit[2]    : Configure the CVDR connected to the W14.1 (ISP_FE_1/BAS_1)channel as:
                                                         1 -> Real Time initiator
                                                         0 -> Soft Real Time initiator */
        unsigned int  w14_2_rt_srt  : 1;  /* bit[3]    : Configure the CVDR connected to the W14.2 (ISP_FE_2/BAS_2) channel as:
                                                         1 -> Real Time initiator
                                                         0 -> Soft Real Time initiator */
        unsigned int  reserved_0    : 2;  /* bit[4-5]  : Reserved */
        unsigned int  w3_1_rt_srt   : 1;  /* bit[6]    : Configure the CVDR connected to the W3.1 (CMDLST) channel as:
                                                         1 -> Real Time initiator
                                                         0 -> Soft Real Time initiator */
        ...
        unsigned int  w4_1_2_rt_srt : 1;  /* bit[8]    : Configure the CVDR connected to the W4.1.2 (SCALER_1_1 UV) channel as:
                                                         1 -> Real Time initiator
                                                         0 -> Soft Real Time initiator */
        unsigned int  reserved_1    : 1;  /* bit[9]    : Reserved - Configure the CVDR connected to the W4.2.1 (SCALER_1_2 Y) channel as:
                                                         1 -> Real Time initiator
                                                         0 -> Soft Real Time initiator */
        unsigned int  reserved_2    : 1;  /* bit[10]   : Reserved - Configure the CVDR connected to the W4.2.2 (SCALER_1_2 UV) channel as:
                                                         1 -> Real Time initiator
                                                         0 -> Soft Real Time initiator */
        ...
        unsigned int  w5_1_2_rt_srt : 1;  /* bit[12]   : Configure the CVDR connected to the W5.1.2 (SCALER_2_1 UV)channel as:
                                                         1 -> Real Time initiator
                                                         0 -> Soft Real Time initiator */
        unsigned int  reserved_3    : 1;  /* bit[13]   : Reserved - Configure the CVDR connected to the W5.2.1 (SCALER_2_2 Y) channel as:
                                                         1 -> Real Time initiator
                                                         0 -> Soft Real Time initiator */
        unsigned int  reserved_4    : 1;  /* bit[14]   : Reserved - Configure the CVDR connected to the W5.2.2 (SCALER_2_2 UV) channel as:
                                                         1 -> Real Time initiator
                                                         0 -> Soft Real Time initiator */
        unsigned int  reserved_5    : 1;  /* bit[15]   : Reserved - Configure the CVDR connected to the W6.1 (SCALER_3 Y) channel as:
                                                         1 -> Real Time initiator
                                                         0 -> Soft Real Time initiator */
        unsigned int  reserved_6    : 1;  /* bit[16]   : Reserved - Configure the CVDR connected to the W6.2 (SCALER_3 UV) channel as:
                                                         1 -> Real Time initiator
                                                         0 -> Soft Real Time initiator */
        unsigned int  reserved_7    : 1;  /* bit[17]   : Reserved - Configure the CVDR connected to the W7.1 (FBCYUV_1) channel as:
                                                         1 -> Real Time initiator
                                                         0 -> Soft Real Time initiator */
        unsigned int  reserved_8    : 1;  /* bit[18]   : Reserved - Configure the CVDR connected to the W7.2 (FBCYUV_2) channel as:
                                                         1 -> Real Time initiator
                                                         0 -> Soft Real Time initiator */
        unsigned int  reserved_9    : 1;  /* bit[19]   : Reserved - Configure the CVDR connected to the W8.1 (JPGENC) channel as:
                                                         1 -> Real Time initiator
                                                         0 -> Soft Real Time initiator */
        unsigned int  reserved_10   : 1;  /* bit[20]   : Reserved (Previously used to configure the CVDR connected to the W9.1 (WARP_1)channel a)s:
                                                         1 -> Real Time initiator
                                                         0 -> Soft Real Time initiator */
        unsigned int  reserved_11   : 1;  /* bit[21]   : Reserved (Previously used to configure the CVDR connected to the W9.2 (WARP_2) channel as):
                                                         1 -> Real Time initiator
                                                         0 -> Soft Real Time initiator */
        unsigned int  reserved_12   : 1;  /* bit[22]   : Reserved */
        ...
        unsigned int  w13_2_rt_srt  : 1;  /* bit[28]   : Configure the CVDR connected to the W13.2 (OTAP_2_2) channel as:
                                                         1 -> Real Time initiator
                                                         0 -> Soft Real Time initiator */
        unsigned int  reserved_13   : 3;  /* bit[29-31]: Reserved */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  pos_out_sel_1 : 4;  /* bit[0-3]  : This field defines to which Video Port the OTAP_1_(x) ( x = 1 for pipe 1) is connected to. When configured to zero no data is sent to the OTAP. Default value is zero. 
                                                          0 -> mux is selecting the Video port from ISP_FE_(x) input but Video port traffic is gated 
                                                          1 -> from ISP_FE_(x) input
                                                          2 -> from LSC_(x) out 
                                                          3 -> from RAWNF_(x) out 
                                                          4 -> from PTREG_(x) out (after VPB_4) 
                                                          5 -> from GCD_(x) out
        ...
        unsigned int  pos_in_sel_1  : 4;  /* bit[8-11] : This field defines to which Video Port the ITAP_1_(x) (x = 1 for pipe 1) is connected to. When value is zero ITAP_1_x is disabled.
                                                          ...
                                                          3 -> control on VPM_3_x in front of AWBGAIN_(x) is set to 1 to select ITAP
                                                          4 -> Reserved
                                                          5 -> control on VPM_5_x in front of LSC_(x) is set to 1 to select ITAP
        ...
        unsigned int  pos_out_sel_2 : 4;  /* bit[16-19]: Reserved - This field defines to which Video Port the OTAP_2_(x) ( x = 1 for pipe 1) is connected to. When configured to zero no data is sent to the OTAP. Default value is zero. 
                                                          0 -> mux is selecting the Video port from ISP_FE_(x) input but Video port traffic is gated 
                                                          1 -> from ISP_FE_(x) input
                                                          2 -> from LSC_(x) out 
                                                          3 -> from RAWNF_(x) out
                                                          4 -> from PTREG_(x) out (after VPB_4/VPB_103)
                                                          5 -> from GCD_(x) out
                                                          6 -> from RGB2YUV_(x) out
                                                          7 -> from CE_(x) out
                                                          8 -> from SHARPEN_(x) out
        ...
        unsigned int  pos_in_sel_2  : 4;  /* bit[24-27]: Reserved - This field defines to which Video Port the ITAP_2_(x) (x = 1 for pipe 1) is connected to. When value is zero ITAP_2_x is disabled.
                                                          0 -> ITAP is disabled; No ITAP is connected to the pipe. All VPM receiving ITAP are in normal path mode
                                                          ...
                                                          3 -> control on VPM_14_x in front of AWBGAIN_(x) is set to 1 to select ITAP
                                                          4 -> Reserved 
                                                          5 -> control on VPM_16_x in front of LSC_(x) is set to 1 to select ITAP
                                                          ...
                                                          8 -> control on VPM_19_x in front of YUVNF_(x) is set to 1 to select ITAP
                                                          9 -> control on VPM_20_x in front of SCALER_(x) is set to 1 to select ITAP
                                                          10-15 -> reserved mapping 
...
typedef union
{
    ...
    struct
    {
        unsigned int  pos_out_sel_1 : 4;  /* bit[0-3]  : This field defines to which Video Port the OTAP_1_(x) ( x = 2 for pipe 2) is connected to. When configured to zero no data is sent to the OTAP. Default value is zero. 
                                                          0 -> mux is selecting the Video port ISP_FE_(x) input but Video port traffic is gated 
                                                          1 -> from ISP_FE_(x) input
                                                          2 -> Reserved-from LSC_(x) out 
                                                          3 -> Reserved-from RAWNF_(x) out
                                                          4 -> Reserved-from CROP_2_(x) out after VPB
                                                          5 -> Reserved-from GCD_(x) out
                                                          6 -> Reserved-from RGB2YUV_(x) out
                                                          7 -> Reserved-from CE_(x) out
                                                          8 -> Reserved-from SHARPEN_(x) out 
                                                          9 -> Reserved-from SCALER_1_(x) out (Y for YUV420 after VPB1TO2YUV_2_x or YUV422)
                                                          10 -> reserved
                                                          11 -> Reserved-from CROP_3_(x) out (SCALER_2) (Y for YUV420 after VPB1TO2YUV_1_x or YUV422)
                                                          12-15 -> reserved */
        unsigned int  reserved_0    : 4;  /* bit[4-7]  : Reserved */
        unsigned int  pos_in_sel_1  : 4;  /* bit[8-11] : This field defines to which Video Port the ITAP_1_(x) (x = 2 for pipe 2) is connected to. When value is zero ITAP_1_x is disabled.
                                                          0 -> ITAP is disabled; No ITAP is connected to the pipe. All VPM receiving ITAP are in normal path mode
                                                          1 -> control on VPM_1_x in front of BLC_(x) is set to 1 to select ITAP
                                                          2 -> Reserved-control on VPM_2_x in front of DPCC_(x) is set to 1 to select ITAP
                                                          3 -> Reserved-control on VPM_3_x in front of BAS_(x) is set to 1 to select ITAP
                                                          4 -> Reserved
                                                          5 -> Reserved-control on VPM_5_x in front of AWBGAIN_(x) is set to 1 to select ITAP
                                                          6 -> Reserved-control on VPM_6_x in front of CC_(x) prior to VPB is set to 1 to select ITAP
                                                          7 -> Reserved-control on VPM_7_x in front of UVDEC_(x) is set to 1 to select ITAP
                                                          8 -> Reserved- control on VPM_8_x in front of TNR_(x) is set to 1 to select ITAP
                                                          9 -> Reserved-control on VPM_9_x in front of IE_(x) is set to 1 to select ITAP
                                                          10-15 -> reserved mapping 
                                                         If both IOTAP_MAP_P1.POS_IN_SEL_1 and IOTAP_MAP_P1.POS_IN_SEL_2 equal zero, pipe is in standard configuration, no ITAP is connected to the pipe. 
                                                         If one or the other is different from zero at least one ITAP is connected. If IOTAP_MAP_P1.POS_IN_SEL_1 and IOTAP_P1_MAP.POS_IN_SEL_2 are programmed to the same value ( different from zero) ITAP_1_(x) is connected but not ITAP_2_(x). */
        unsigned int  reserved_1    : 4;  /* bit[12-15]: Reserved */
        unsigned int  pos_out_sel_2 : 4;  /* bit[16-19]: This field defines to which Video Port the OTAP_2_(x) ( x = 2 for pipe 2) is connected to. When configured to zero no data is sent to the OTAP. Default value is zero. 
                                                          ...
                                                          8 -> Reserved-from SHARPEN_(x) out
                                                          9 -> Reserved-from SCALER_1_(x) out (Y for YUV420 after VPB1TO2YUV_2_x or YUV422) 
                                                          10 -> Reserved-from SCALER_1_(x) out (UV for YUV420 after VPB1TO2YUV_2_x)
                                                          11 -> Reserved-from CROP_3 out (SCALER_2) (Y for YUV420 after VPB1TO2YUV_1_x or YUV422)
                                                          12 -> Reserved-from CROP_3 (SCALER_2) (UV for YUV420 after VPB1TO2YUV_1_x)
                                                          13-14 -> reserved 
                                                          15 -> from Debug_infrastructure */
        unsigned int  reserved_2    : 4;  /* bit[20-23]: Reserved */
        unsigned int  pos_in_sel_2  : 4;  /* bit[24-27]: This field defines to which Video Port the ITAP_2_(x) (x = 2 for pipe 2) is connected to. When value is zero ITAP_2_x is disabled.
                                                          0 -> ITAP is disabled; No ITAP is connected to the pipe. All VPM receiving ITAP are in normal path mode
                                                          1 -> control on VPM_12_x in front of BLC_(x) is set to 1 to select ITAP
                                                          2 -> Reserved-control on VPM_13_x in front of DPCC_(x) is set to 1 to select ITAP
                                                          3 -> Reserved-control on VPM_14_x in front of BAS_(x) prior to VPB is set to 1 to select ITAP
                                                          4 -> Reserved
                                                          5 -> Reserved-control on VPM_16_x in front of AWBGAIN_(x) is set to 1 to select ITAP
                                                          6 -> Reserved-control on VPM_17_x in front of CC_(x) is set to 1 to select ITAP
                                                          7 -> Reserved-control on VPM_18_x in front of UVDEC_(x) is set to 1 to select ITAP
                                                          8 -> Reserved-control on VPM_19_x in front of TNR_(x) is set to 1 to select ITAP
                                                          9 -> Reserved-control on VPM_20_x in front of IE_(x) is set to 1 to select ITAP
                                                          10-15 -> reserved mapping 
                                                          If both IOTAP_MAP_P1.POS_IN_SEL_1 and IOTAP_MAP_P1.POS_IN_SEL_2 equal zero, pipe is in standard configuration, no ITAP is connected to the pipe. if one or the other is different from zero at least one ITAP is connected. If IOTAP_MAP_P1.POS_IN_SEL_1 and IOTAP_P1_MAP.POS_IN_SEL_2 are programmed to the same value ( different from zero) ITAP_1_(x) is connected but not ITAP_2_(x). */
...
typedef union
{
    ...
    struct
    {
        unsigned int  reserved_0: 13; /* bit[0-12] : Reserved (Indicate position of first pixel on the left for the cropped window, 0 means no left crop.)  */
        unsigned int  reserved_1: 3;  /* bit[13-15]: reserved */
        unsigned int  reserved_2: 13; /* bit[16-28]: Reserved (Indicate position of last pixel on the right for the cropped window.)  */
...
typedef union
{
    ...
    struct
    {
        unsigned int  reserved_0: 13; /* bit[0-12] : Reserved (indicates position of first line on the top for the cropped window,, 0 means no top crop) */
        unsigned int  reserved_1: 3;  /* bit[13-15]: Reserved */
        unsigned int  reserved_2: 13; /* bit[16-28]: Reserved (indicates position of last line on the bottom for the cropped window) */
        unsigned int  reserved_3: 3;  /* bit[29-31]: Reserved */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  gpo6     : 1;  /* bit[6]    : Strobe input from camera ( not used as output) */
        ...
        unsigned int  gpo11    : 1;  /* bit[11]   : generic gpio/PWM ( Ultra low power sensor A) */
        unsigned int  gpo12    : 1;  /* bit[12]   : generic gpio/PWM ( Ultra low power sensor B) */
...
typedef union
{
    ...
    struct
    {
        unsigned int  prediv   : 27; /* bit[0-26] : Divid functional clock frequency to control Sequence in Mode 1. Zero means no division, 1 divide by 2,by 3,… */
...
/*****************************************************************************
 ...
 结构说明  : VPBG_CTRL_1 寄存器结构定义。地址偏移量:0x01D0，初值:0x00000300，宽度:32
 寄存器说明: VPBG control.
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  reserved_0    : 2;  /* bit[0-1]  : reserved (out1:framemerge_in1; out2: vpm42_1_in2) */
        unsigned int  reserved_1    : 2;  /* bit[2-3]  : reserved (out1:framemerge_in2; out2: vpm42_2_in2) */
        unsigned int  reserved_2    : 2;  /* bit[4-5]  : reserved (out1: BE1; out2: VPB8_1) */
        unsigned int  reserved_3    : 2;  /* bit[6-7]  : reserved */
        unsigned int  ctrl_vpbg_8_1 : 2;  /* bit[8-9]  : out1: Scaler_1_1; out2:Scaler_2_1 */
        unsigned int  reserved_4    : 2;  /* bit[10-11]: reserved (out1: Scaler_1_2; out2:Scaler_2_2) */
        unsigned int  reserved_5    : 2;  /* bit[12-13]: reserved (out1: vpm45_1_in2; out2:vpm44_1_in1) */
        unsigned int  reserved_6    : 2;  /* bit[14-15]: reserved (out1: vpm45_2_in2; out2:vpm44_2_in1) */
        unsigned int  reserved_7    : 2;  /* bit[16-17]: reserved (out1:vpm46_1_in1;out2:vpm44_1_in2) */
        unsigned int  reserved_8    : 2;  /* bit[18-19]: reserved (out1:vpm46_2_in1;out2:vpm44_2_in2) */
        unsigned int  reserved_9    : 2;  /* bit[20-21]: reserved (out1:vpm45_1_in1;out2:vpm46_1_in2) */
        unsigned int  reserved_10   : 2;  /* bit[22-23]: reserved (out1:vpm45_2_in1;out2:vpm46_2_in2) */
        unsigned int  reserved_11   : 2;  /* bit[24-25]: reserved (out1: vpm42_1_in1; out2:vpm40_1_in1) */
        unsigned int  reserved_12   : 2;  /* bit[26-27]: reserved (out1: vpm42_2_in1; out2:vpm40_2_in1) */
        unsigned int  reserved_13   : 2;  /* bit[28-29]: reserved (out1: vpm42_1_in2; out2:vpm41_1_in2) */
        unsigned int  reserved_14   : 2;  /* bit[30-31]: Enables to shutdown the output ports when unused - each bit controls the corresponding output port.
...
/*****************************************************************************
 ...
 结构说明  : VPBG_CTRL_2 寄存器结构定义。地址偏移量:0x01D4，初值:0x00000000，宽度:32
 寄存器说明: VPBG control.
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  reserved_0: 2;  /* bit[0-1]  : reserved (out1: cvdr;out2:vpm50_1_in1) */
        unsigned int  reserved_1: 2;  /* bit[2-3]  : reserved */
        unsigned int  reserved_2: 2;  /* bit[4-5]  : reserved (out1: cvdr;out2:vpm50_2_in1) */
        unsigned int  reserved_3: 10; /* bit[6-15] : reserved */
        unsigned int  reserved_4: 2;  /* bit[16-17]: reserved (out1:vpm50_1_in2;out2:vpm51_1_in2) */
        unsigned int  reserved_5: 2;  /* bit[18-19]: reserved (out1:vpm50_1_in2;out2:cvdr) */
        unsigned int  reserved_6: 2;  /* bit[20-21]: reserved (out1: FE1; out2:VPM32_1_in2) */
        unsigned int  reserved_7: 2;  /* bit[22-23]: reserved (out1: FE2; out2:VPM32_2_in2) */
        unsigned int  reserved_8: 2;  /* bit[24-25]: reserved (out1: VPM40_1_in2;out2:VPM41_1_in1) */
        unsigned int  reserved_9: 2;  /* bit[26-27]: reserved (out1: VPM40_2_in2;out2:VPM41_2_in1) */
        unsigned int  reserved_10: 2;  /* bit[28-29]: reserved (out1:prescaler; out2:crop3_1 */
        unsigned int  reserved_11: 2;  /* bit[30-31]: Enables to shutdown the output ports when unused - each bit controls the corresponding output port.
                                                      0: output port disabled
                                                      1: output port enabled
                                                      reserved (out1:cvdr; out2:crop3_2) */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : VPBG_CTRL_3 寄存器结构定义。地址偏移量:0x01D8，初值:0x0000001F，宽度:32
 寄存器说明: VPBG control.
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  ctrl_vpbg_37_1 : 5;  /* bit[0-4]  : Field 0: enable output to scaler 1_1
                                                          ...
                                                          Reserved- Field 2: enable output to crop_4_1 DRAM / JPGENC output
                                                          Reserved- Field 3: Field 3: enable output to scaler 1_2
                                                          Reserved- Field 4: Field 4: enable output to scaler 2_2 */
        unsigned int  reserved_0     : 3;  /* bit[5-7]  :  */
        unsigned int  reserved_1     : 3;  /* bit[8-10] : Reserved- Field 0: enable output to scaler 1_2
                                                          Reserved- Field 1: enable output to scaler 2_2
                                                          Reserved- Field 2: enable output to crop_4_1 DRAM / JPGENC output */
        unsigned int  reserved_2     : 21; /* bit[11-31]: Enables to shutdown the output ports when unused - each bit controls the corresponding output port.
                                                          0: output port disabled
                                                          1: output port enabled */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  reserved_0: 1;  /* bit[0]    : High speed interface.High-speed reception active. This signal indicates that the lane module is actively receiving a high-speed data transmission from lane interconnect 0. */
        unsigned int  reserved_1: 1;  /* bit[1]    : High speed interface.High-speed reception active. This signal indicates that the lane module is actively receiving a high-speed data transmission from lane interconnect 1. */
        unsigned int  reserved_2: 1;  /* bit[2]    : High speed interface.High-speed reception active. This signal indicates that the lane module is actively receiving a high-speed data transmission from lane interconnect 2. */
        unsigned int  reserved_3: 1;  /* bit[3]    : High speed interface.High-speed reception active. This signal indicates that the lane module is actively receiving a high-speed data transmission from lane interconnect 3. */
        unsigned int  reserved_4: 1;  /* bit[4]    : Escape Low Power Data Receive Mode. This signal is asserted to indicate that the lane module is now in Low Power Data Receive Mode. While in this mode, received data is driven onto RXDATAESC output bus when RXVALIDESC is active. RXLPDTESC remains asserted until a STOP state is detected on the lane interconnect. */
        unsigned int  reserved_5: 1;  /* bit[5]    : Escape Low Power Data Receive Mode. This signal is asserted to indicate that the lane module is now in Low Power Data Receive Mode. While in this mode, received data is driven onto RXDATAESC output bus when RXVALIDESC is active. RXLPDTESC remains asserted until a STOP state is detected on the lane interconnect. */
        unsigned int  reserved_6: 1;  /* bit[6]    : Escape Low Power Data Receive Mode. This signal is asserted to indicate that the lane module is now in Low Power Data Receive Mode. While in this mode, received data is driven onto RXDATAESC output bus when RXVALIDESC is active. RXLPDTESC remains asserted until a STOP state is detected on the lane interconnect. */
        unsigned int  reserved_7: 1;  /* bit[7]    : Escape Low Power Data Receive Mode. This signal is asserted to indicate that the lane module is now in Low Power Data Receive Mode. While in this mode, received data is driven onto RXDATAESC output bus when RXVALIDESC is active. RXLPDTESC remains asserted until a STOP state is detected on the lane interconnect. */
        unsigned int  reserved_8: 1;  /* bit[8]    : ctive Low. Indicates that the lane is in the Ultra Low Power state. For a Tx lane, this signal is asserted some time after TXULPSESC and TXREQUESTESC (or TXULPSCLK) are asserted. TXCLKESC must be supplied to the macro until ULPSACTIVENOT is asserted.
                                                     In order to leave ULP state, the transmitter first drives TXULPSEXIT high, then waits for ULPSACTIVENOT to become high (inactive). At that point, the macro is active and has started transmitting a Mark-1 on the Lines. The protocol waits for a time Twakeup and then drives TXREQUESTESC or TXULPSCLK inactive to return the Lane to Stop state.
                                                     For a Rx lane, this signal indicates that the lane is in ULP state. At the beginning of ULP state, ULPSACTIVENOT is asserted; at the end of the
                                                     ULP state, this signal becomes inactive to indicate that the Mark-1 state has been observed. Later, after a period of time Twakeup, the RXULPSESC (or
                                                     RXULPSCLKNOT) signal is deasserted. */
        unsigned int  reserved_9: 1;  /* bit[9]    : active Low. Indicates that the lane is in the Ultra Low Power state. For a Tx lane, this signal is asserted some time after TXULPSESC and TXREQUESTESC (or TXULPSCLK) are asserted. TXCLKESC must be supplied to the macro until ULPSACTIVENOT is asserted.
                                                     In order to leave ULP state, the transmitter first drives TXULPSEXIT high, then waits for ULPSACTIVENOT to become high (inactive). At that point, the macro is active and has started transmitting a Mark-1 on the Lines. The protocol waits for a time Twakeup and then drives TXREQUESTESC or TXULPSCLK inactive to return the Lane to Stop state.
                                                     For a Rx lane, this signal indicates that the lane is in ULP state. At the beginning of ULP state, ULPSACTIVENOT is asserted; at the end of the
                                                     ULP state, this signal becomes inactive to indicate that the Mark-1 state has been observed. Later, after a period of time Twakeup, the RXULPSESC (or
                                                     RXULPSCLKNOT) signal is deasserted. */
        unsigned int  reserved_10: 1;  /* bit[10]   : active Low. Indicates that the lane is in the Ultra Low Power state. For a Tx lane, this signal is asserted some time after TXULPSESC and TXREQUESTESC (or TXULPSCLK) are asserted. TXCLKESC must be supplied to the macro until ULPSACTIVENOT is asserted.
                                                      In order to leave ULP state, the transmitter first drives TXULPSEXIT high, then waits for ULPSACTIVENOT to become high (inactive). At that point, the macro is active and has started transmitting a Mark-1 on the Lines. The protocol waits for a time Twakeup and then drives TXREQUESTESC or TXULPSCLK inactive to return the Lane to Stop state.
                                                      For a Rx lane, this signal indicates that the lane is in ULP state. At the beginning of ULP state, ULPSACTIVENOT is asserted; at the end of the
                                                      ULP state, this signal becomes inactive to indicate that the Mark-1 state has been observed. Later, after a period of time Twakeup, the RXULPSESC (or
                                                      RXULPSCLKNOT) signal is deasserted. */
        unsigned int  reserved_11: 1;  /* bit[11]   : active Low. Indicates that the lane is in the Ultra Low Power state. For a Tx lane, this signal is asserted some time after TXULPSESC and TXREQUESTESC (or TXULPSCLK) are asserted. TXCLKESC must be supplied to the macro until ULPSACTIVENOT is asserted.
                                                      In order to leave ULP state, the transmitter first drives TXULPSEXIT high, then waits for ULPSACTIVENOT to become high (inactive). At that point, the macro is active and has started transmitting a Mark-1 on the Lines. The protocol waits for a time Twakeup and then drives TXREQUESTESC or TXULPSCLK inactive to return the Lane to Stop state.
                                                      For a Rx lane, this signal indicates that the lane is in ULP state. At the beginning of ULP state, ULPSACTIVENOT is asserted; at the end of the
                                                      ULP state, this signal becomes inactive to indicate that the Mark-1 state has been observed. Later, after a period of time Twakeup, the RXULPSESC (or
                                                      RXULPSCLKNOT) signal is deasserted. */
        unsigned int  reserved_12: 1;  /* bit[12]   : Low Power Data Transmission Synchronization Error. If the number of bits received during low power data transmission mode is not a multiple of eight (8) when the transmission ends, this signal is asserted and remains high until the line returns to Stop state. */
        unsigned int  reserved_13: 1;  /* bit[13]   : Low Power Data Transmission Synchronization Error. If the number of bits received during low power data transmission mode is not a multiple of eight (8) when the transmission ends, this signal is asserted and remains high until the line returns to Stop state. */
        unsigned int  reserved_14: 1;  /* bit[14]   : Low Power Data Transmission Synchronization Error. If the number of bits received during low power data transmission mode is not a multiple of eight (8) when the transmission ends, this signal is asserted and remains high until the line returns to Stop state. */
        unsigned int  reserved_15: 1;  /* bit[15]   : Low Power Data Transmission Synchronization Error. If the number of bits received during low power data transmission mode is not a multiple of eight (8) when the transmission ends, this signal is asserted and remains high until the line returns to Stop state. */
        unsigned int  reserved_16: 1;  /* bit[16]   : Active Low. Indicates that the lane is in the Ultra Low Power state. For a Tx lane, this signal is asserted some time after TXULPSCLK. TXCLKESC must be supplied to the macro until ULPSACTIVENOTCLK is asserted.
                                                      In order to leave ULP state, the transmitter first drives TXULPSEXIT high, then waits for ULPSACTIVENOT to become high (inactive). At that point, the macro is active and has started transmitting a Mark-1 on the Lines. The protocol waits for a time Twakeup and then drives TXULPSCLK inactive to return the Lane to Stop state.
                                                      For a Rx lane, this signal indicates that the lane is in ULP state. At the beginning of ULP state, ULPSACTIVENOT is asserted together with RXCLKULPSNOT; at the end of the ULP state, this signal becomes inactive to indicate that the Mark-1 state has been observed. Later, after a period of time Twakeup, the RXULPSCLKNOT signal is deasserted. */
        unsigned int  reserved_17: 15; /* bit[17-31]:  */
    } reg;
...
/*****************************************************************************
 结构名    : SOC_ISP_ISPSS_CTRL_MEM_CTRL_UNION
 结构说明  : MEM_CTRL 寄存器结构定义。地址偏移量:0x01EC，初值:0x054568F4，宽度:32
 寄存器说明: MEM low power Control.
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  reserved_0    : 2;  /* bit[0-1]  : Rom_trb */
        unsigned int  reserved_1    : 2;  /* bit[2-3]  : Rom_wtsel */
        unsigned int  reserved_2    : 2;  /* bit[4-5]  : Rom_rtsel */
        unsigned int  reserved_3    : 3;  /* bit[6-8]  : Tpmbram_kp */
        unsigned int  reserved_4    : 2;  /* bit[9-10] : Tpmbram_wtsel */
        unsigned int  reserved_5    : 2;  /* bit[11-12]: Tpmbram_rtsel */
        unsigned int  tpsbram_kp    : 3;  /* bit[13-15]: Tpsbram_kp */
        unsigned int  tpsbram_wtsel : 2;  /* bit[16-17]: Tpsbram_wtsel */
        unsigned int  tpsbram_rtsel : 2;  /* bit[18-19]: Tpsbram_rtsel */
        unsigned int  spmbram_wtsel : 2;  /* bit[20-21]: Spmbram_wtsel */
        unsigned int  spmbram_rtsel : 2;  /* bit[22-23]: Spmbram_rtsel */
        unsigned int  spsbram_wtsel : 2;  /* bit[24-25]: Spsbram_wtsel */
        unsigned int  spsbram_rtsel : 2;  /* bit[26-27]: Spsbram_rtsel */
