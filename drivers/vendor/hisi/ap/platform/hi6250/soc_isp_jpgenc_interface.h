...
/* 寄存器说明：swap pixel component at input.
   位域定义UNION结构:  SOC_ISP_JPGENC_INPUT_SWAP_UNION */
#define SOC_ISP_JPGENC_INPUT_SWAP_ADDR(base)          ((base) + (0x00124))
...
/*****************************************************************************
 结构名    : SOC_ISP_JPGENC_INPUT_SWAP_UNION
 结构说明  : INPUT_SWAP 寄存器结构定义。地址偏移量:0x00124，初值:0x00000000，宽度:32
 寄存器说明: swap pixel component at input.
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  swapin_y_uv : 1;  /* bit[0]   : swap y and v uv at input
                                                      0: don't swap
                                                      1: swap
                                                      IN swapin_y_uv swapin_u_v OUT 
                                                      YUYV 0 0 YUYV 
                                                      YVYU 0 0 YVYU 
                                                      UYVY 1 0 YUYV 
                                                      VYUY 1 0 YVYU 
                                                      ...
                                                      UYVY 1 1 YVYU 
                                                      VYUY 1 1 YUYV 
                                                      [Note] when in YUV420 format swapin_y_uv=1 as same effect as swapin_y_uv=0 
                                                      [end] */
        unsigned int  swapin_u_v  : 1;  /* bit[1]   : swap u and v at input
                                                      0: don't swap
                                                      1: swap 
                                                      IN swapin_y_uv swapin_u_v OUT 
                                                      YUYV 0 0 YUYV 
...
} SOC_ISP_JPGENC_INPUT_SWAP_UNION;
#endif
#define SOC_ISP_JPGENC_INPUT_SWAP_swapin_y_uv_START  (0)
#define SOC_ISP_JPGENC_INPUT_SWAP_swapin_y_uv_END    (0)
#define SOC_ISP_JPGENC_INPUT_SWAP_swapin_u_v_START   (1)
#define SOC_ISP_JPGENC_INPUT_SWAP_swapin_u_v_END     (1)
...
/*****************************************************************************
 ...
 结构说明  : DBG_14 寄存器结构定义。地址偏移量:0x0238，初值:0x00000000，宽度:32
 寄存器说明: debug register14.
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : DBG_15 寄存器结构定义。地址偏移量:0x023c，初值:0x00000000，宽度:32
 寄存器说明: debug register15.
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : DBG_RW_0 寄存器结构定义。地址偏移量:0x0300，初值:0x00000000，宽度:32
 寄存器说明: debug writable register.
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
