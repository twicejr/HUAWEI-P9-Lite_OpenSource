...
/* 寄存器说明：Image location offset in the block that includes the upper left corner of the image.
   位域定义UNION结构:  SOC_ISP_LSC_LSC_IMAGE_BLOCK_OFFSET_UNION */
#define SOC_ISP_LSC_LSC_IMAGE_BLOCK_OFFSET_ADDR(base) ((base) + (0x0074))

/* 寄存器说明：Image location offset in the block that includes the upper left corner of the image.
   位域定义UNION结构:  SOC_ISP_LSC_LSC_START_BLOCK_LOC_UNION */
...
/*****************************************************************************
 结构名    : SOC_ISP_LSC_LSC_IMAGE_BLOCK_OFFSET_UNION
 结构说明  : LSC_IMAGE_BLOCK_OFFSET 寄存器结构定义。地址偏移量:0x0074，初值:0x00000000，宽度:32
 寄存器说明: Image location offset in the block that includes the upper left corner of the image.
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_ISP_LSC_LSC_START_BLOCK_LOC_UNION
 结构说明  : LSC_START_BLOCK_LOC 寄存器结构定义。地址偏移量:0x0078，初值:0x00000000，宽度:32
 寄存器说明: Image location offset in the block that includes the upper left corner of the image.
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
