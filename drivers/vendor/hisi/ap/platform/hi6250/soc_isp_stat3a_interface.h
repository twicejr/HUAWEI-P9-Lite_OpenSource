...
/* 寄存器说明：Center coordinates for LSC
   位域定义UNION结构:  SOC_ISP_STAT3A_CENTER_UNION */
#define SOC_ISP_STAT3A_CENTER_ADDR(base)              ((base) + (0x00F8))

/* 寄存器说明：Table Select for LSC
   位域定义UNION结构:  SOC_ISP_STAT3A_LSC_ACTIVE_UNION */
#define SOC_ISP_STAT3A_LSC_ACTIVE_ADDR(base)          ((base) + (0x00FC))

/* 寄存器说明：LookUp Table 0, 256 entries
   位域定义UNION结构:  SOC_ISP_STAT3A_LSC_LUT_0_UNION */
#define SOC_ISP_STAT3A_LSC_LUT_0_ADDR(base, Range256)  ((base) + (0x0800+0x4*(Range256)))

/* 寄存器说明：LookUp Table 0, 256 entries
   位域定义UNION结构:  SOC_ISP_STAT3A_LSC_LUT_1_UNION */
#define SOC_ISP_STAT3A_LSC_LUT_1_ADDR(base, Range256)  ((base) + (0x0C00+0x4*(Range256)))
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  fw_x_width_0 : 13; /* bit[16-28]: Focus window horizontal width
                                                        [Note]
                                                        fw_x_width_0 % 2 = 0
                                                        fw_x_strt_0 + fw_x_width_0 <= endcol
                                                        [end] */
        unsigned int  reserved_1   : 3;  /* bit[29-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  fw_y_strt_0  : 13; /* bit[0-12] : Focus window vertical start
                                                        [Note]
                                                        fw_y_strt_0 % 2 = 0 [0,cbottom-ctop]
                                                        [end] */
        unsigned int  reserved_0   : 3;  /* bit[13-15]:  */
        unsigned int  fw_y_width_0 : 13; /* bit[16-28]: Focus window vertical height
                                                        [Note]
                                                        fw_y_width_0 % 2 = 0
                                                        fw_y_strt_0 + fw_y_width_0 <= cbottom-ctop+1
                                                        [end] */
        unsigned int  reserved_1   : 3;  /* bit[29-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  fw_x_width_1 : 13; /* bit[16-28]: Focus window horizontal width
                                                        [Note]
                                                        fw_x_width_1 % 2 = 0
                                                        fw_x_strt_1 + fw_x_width_1 <= endcol
                                                        [end] */
        unsigned int  reserved_1   : 3;  /* bit[29-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  fw_y_strt_1  : 13; /* bit[0-12] : Focus window vertical start
                                                        [Note]
                                                        fw_y_strt_1 % 2 = 0 [0,cbottom-ctop]
                                                        [end] */
        unsigned int  reserved_0   : 3;  /* bit[13-15]:  */
        unsigned int  fw_y_width_1 : 13; /* bit[16-28]: Focus window vertical height
                                                        [Note]
                                                        fw_y_width_1 % 2 = 0
                                                        fw_y_strt_1 + fw_y_width_1 <= cbottom-ctop+1
                                                        [end] */
        unsigned int  reserved_1   : 3;  /* bit[29-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  fw_x_width_2 : 13; /* bit[16-28]: Focus window horizontal width
                                                        [Note]
                                                        fw_x_width_2 % 2 = 0 
                                                        fw_x_strt_2 + fw_x_width_2 <= endcol
                                                        [end] */
        unsigned int  reserved_1   : 3;  /* bit[29-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  fw_y_strt_2  : 13; /* bit[0-12] : Focus window vertical start
                                                        [Note]
                                                        fw_y_strt_2 % 2 = 0 [0,cbottom-ctop]
                                                        [end] */
        unsigned int  reserved_0   : 3;  /* bit[13-15]:  */
        unsigned int  fw_y_width_2 : 13; /* bit[16-28]: Focus window vertical height
                                                        [Note]
                                                        fw_y_width_2 % 2 = 0 
                                                        fw_y_strt_2 + fw_y_width_2 <= cbottom-ctop+1
                                                        [end] */
        unsigned int  reserved_1   : 3;  /* bit[29-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  fw_x_width_3 : 13; /* bit[16-28]: Focus window horizontal width
                                                        [Note]
                                                        fw_x_width_3 % 2 = 0
                                                        fw_x_strt_3 + fw_x_width_3 <= endcol
                                                        [end] */
        unsigned int  reserved_1   : 3;  /* bit[29-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  fw_y_strt_3  : 13; /* bit[0-12] : Focus window vertical start
                                                        [Note]
                                                        fw_y_strt_3 % 2 = 0 [0,cbottom-ctop]
                                                        [end] */
        unsigned int  reserved_0   : 3;  /* bit[13-15]:  */
        unsigned int  fw_y_width_3 : 13; /* bit[16-28]: Focus window vertical height
                                                        [Note]
                                                        fw_y_width_3 % 2 = 0
                                                        fw_y_strt_3 + fw_y_width_3 <= cbottom-ctop+1
                                                        [end] */
        unsigned int  reserved_1   : 3;  /* bit[29-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  fw_x_width_4 : 13; /* bit[16-28]: Focus window horizontal width
                                                        [Note]
                                                        fw_x_width_4 % 2 = 0 
                                                        fw_x_strt_4 + fw_x_width_4 <= endcol
                                                        [end] */
        unsigned int  reserved_1   : 3;  /* bit[29-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  fw_y_strt_4  : 13; /* bit[0-12] : Focus window vertical start
                                                        [Note]
                                                        fw_y_strt_4 % 2 = 0 [0,cbottom-ctop]
                                                        [end] */
        unsigned int  reserved_0   : 3;  /* bit[13-15]:  */
        unsigned int  fw_y_width_4 : 13; /* bit[16-28]: Focus window vertical height
                                                        [Note]
                                                        fw_y_width_4 % 2 = 0
                                                        fw_y_strt_4 + fw_y_width_4 <= cbottom-ctop+1
                                                        [end] */
        unsigned int  reserved_1   : 3;  /* bit[29-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  fw_x_width_5 : 13; /* bit[16-28]: Focus window horizontal width
                                                        [Note]
                                                        fw_x_width_5 % 2 = 0 
                                                        fw_x_strt_5 + fw_x_width_5 <= endcol
                                                        [end] */
        unsigned int  reserved_1   : 3;  /* bit[29-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  fw_y_strt_5  : 13; /* bit[0-12] : Focus window vertical start
                                                        [Note]
                                                        fw_y_strt_5 % 2 = 0 [0,cbottom-ctop]
                                                        [end] */
        unsigned int  reserved_0   : 3;  /* bit[13-15]:  */
        unsigned int  fw_y_width_5 : 13; /* bit[16-28]: Focus window vertical height
                                                        [Note]
                                                        fw_y_width_5 % 2 = 0 
                                                        fw_y_strt_5 + fw_y_width_5 <= cbottom-ctop+1
                                                        [end] */
        unsigned int  reserved_1   : 3;  /* bit[29-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  fw_x_width_6 : 13; /* bit[16-28]: Focus window horizontal width
                                                        [Note]
                                                        fw_x_width_6 % 2 = 0
                                                        fw_x_strt_6 + fw_x_width_6 <= endcol
                                                        [end] */
        unsigned int  reserved_1   : 3;  /* bit[29-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  fw_y_strt_6  : 13; /* bit[0-12] : Focus window vertical start
                                                        [Note]
                                                        fw_y_strt_6 % 2 = 0 [0,cbottom-ctop]
                                                        [end] */
        unsigned int  reserved_0   : 3;  /* bit[13-15]:  */
        unsigned int  fw_y_width_6 : 13; /* bit[16-28]: Focus window vertical height
                                                        [Note]
                                                        fw_y_width_6 % 2 = 0
                                                        fw_y_strt_6 + fw_y_width_6 <= cbottom-ctop+1
                                                        [end] */
        unsigned int  reserved_1   : 3;  /* bit[29-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  fw_x_width_7 : 13; /* bit[16-28]: Focus window horizontal width
                                                        [Note]
                                                        fw_x_width_7 % 2 = 0 
                                                        fw_x_strt_7 + fw_x_width_7 <= endcol
                                                        [end] */
        unsigned int  reserved_1   : 3;  /* bit[29-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  fw_y_strt_7  : 13; /* bit[0-12] : Focus window vertical start
                                                        [Note]
                                                        fw_y_strt_7 % 2 = 0 [0,cbottom-ctop]
                                                        [end] */
        unsigned int  reserved_0   : 3;  /* bit[13-15]:  */
        unsigned int  fw_y_width_7 : 13; /* bit[16-28]: Focus window vertical height
                                                        [Note]
                                                        fw_y_width_7 % 2 = 0
                                                        fw_y_strt_7 + fw_y_width_7 <= cbottom-ctop+1
                                                        [end] */
        unsigned int  reserved_1   : 3;  /* bit[29-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  fw_x_width_8 : 13; /* bit[16-28]: Focus window horizontal width
                                                        [Note]
                                                        fw_x_width_8 % 2 = 0 
                                                        fw_x_strt_8 + fw_x_width_8 <= endcol
                                                        [end] */
        unsigned int  reserved_1   : 3;  /* bit[29-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  fw_y_strt_8  : 13; /* bit[0-12] : Focus window vertical start
                                                        [Note]
                                                        fw_y_strt_8 % 2 = 0 [0,cbottom-ctop]
                                                        [end] */
        unsigned int  reserved_0   : 3;  /* bit[13-15]:  */
        unsigned int  fw_y_width_8 : 13; /* bit[16-28]: Focus window vertical height
                                                        [Note]
                                                        fw_y_width_8 % 2 = 0
                                                        fw_y_strt_8 + fw_y_width_8 <= cbottom-ctop+1
                                                        [end] */
        unsigned int  reserved_1   : 3;  /* bit[29-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  hist_x_width : 13; /* bit[16-28]: Histogram window horizontal width
                                                        [Note]
                                                        hist_x_width % 2 = 0
                                                        hist_x_strt + hist_x_width <= endcol
                                                        [end] */
        unsigned int  reserved_1   : 3;  /* bit[29-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  numv     : 5;  /* bit[0-4]  : number of rows of blocks, range [2-1,32-1]
                                                    [Note]
                                                    numv % 2 = 1
                                                    [end] */
        unsigned int  reserved_0: 11; /* bit[5-15] :  */
        unsigned int  numh     : 5;  /* bit[16-20]: number of columns of blocks, range [2-1,32-1]
                                                    [Note]
                                                    numh % 2 = 1
                                                    [end] */
...
typedef union
{
    ...
    struct
    {
        unsigned int  winv     : 10; /* bit[0-9]  : height of every blocks, range [4,1020]
                                                    [Note]
                                                    winv % 4 = 0 
                                                    winv = (cbottom-ctop+1)/(numv+1)
                                                    [end] */
        unsigned int  reserved_0: 6;  /* bit[10-15]:  */
        unsigned int  winh     : 10; /* bit[16-25]: width of every block, range [16,1020].
                                                    [Note]
                                                    winh % 4 = 0 
                                                    winh = (endcol-startcol)/(numh+1)
                                                    [end] */
...
typedef union
{
    ...
    struct
    {
        unsigned int  startcol : 12; /* bit[0-11] : [Note]
                                                    startcoll % 4 = 0
                                                    [0,(cright-cleft+1)/2]
                                                    [end] */
        unsigned int  reserved_0: 4;  /* bit[12-15]:  */
        unsigned int  endcol   : 13; /* bit[16-28]: [Note]
                                                    endcol % 4 = 0
                                                    [startcol+32,(cright-cleft+1)]
                                                    endcol = statistic right column + 1
                                                    [end] */
        unsigned int  reserved_1: 3;  /* bit[29-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  bin01thd : 12; /* bit[0-11] : Threshold of min histogram */
        unsigned int  reserved_0: 4;  /* bit[12-15]:  */
        unsigned int  bin23thd : 12; /* bit[16-27]: [Note]
                                                    bin01thd <= bin23thd
                                                    [end] */
...
typedef union
{
    ...
    struct
    {
        unsigned int  locationroi_0 : 13; /* bit[0-12] : ROI Windows point 0 */
        unsigned int  reserved_0    : 3;  /* bit[13-15]:  */
        unsigned int  locationroi_1 : 13; /* bit[16-28]: ROI Windows point 1 */
        unsigned int  reserved_1    : 3;  /* bit[29-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  locationroi_2 : 13; /* bit[0-12] : ROI Windows point 2 */
        unsigned int  reserved_0    : 3;  /* bit[13-15]:  */
        unsigned int  locationroi_3 : 13; /* bit[16-28]: ROI Windows point 3 */
        unsigned int  reserved_1    : 3;  /* bit[29-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  locationroi_4 : 13; /* bit[0-12] : ROI Windows point 4 */
        unsigned int  reserved_0    : 3;  /* bit[13-15]:  */
        unsigned int  locationroi_5 : 13; /* bit[16-28]: ROI Windows point 5 */
        unsigned int  reserved_1    : 3;  /* bit[29-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  locationroi_6 : 13; /* bit[0-12] : ROI Windows point 6 */
        unsigned int  reserved_0    : 3;  /* bit[13-15]:  */
        unsigned int  locationroi_7 : 13; /* bit[16-28]: ROI Windows point 7 */
        unsigned int  reserved_1    : 3;  /* bit[29-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  locationroi_8 : 13; /* bit[0-12] : ROI Windows point 8 */
        unsigned int  reserved_0    : 3;  /* bit[13-15]:  */
        unsigned int  locationroi_9 : 13; /* bit[16-28]: ROI Windows point 9 */
        unsigned int  reserved_1    : 3;  /* bit[29-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  sizeroi_0 : 10; /* bit[0-9]  : ROI Windows width 0 */
        unsigned int  reserved_0: 6;  /* bit[10-15]:  */
        unsigned int  sizeroi_1 : 10; /* bit[16-25]: ROI Windows width 1 */
        unsigned int  reserved_1: 6;  /* bit[26-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  sizeroi_2 : 10; /* bit[0-9]  : ROI Windows width 2 */
        unsigned int  reserved_0: 6;  /* bit[10-15]:  */
        unsigned int  sizeroi_3 : 10; /* bit[16-25]: ROI Windows width 3 */
        unsigned int  reserved_1: 6;  /* bit[26-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  sizeroi_4 : 10; /* bit[0-9]  : ROI Windows width 4 */
        unsigned int  reserved_0: 6;  /* bit[10-15]:  */
        unsigned int  sizeroi_5 : 10; /* bit[16-25]: ROI Windows width 5 */
        unsigned int  reserved_1: 6;  /* bit[26-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  sizeroi_6 : 10; /* bit[0-9]  : ROI Windows width 6 */
        unsigned int  reserved_0: 6;  /* bit[10-15]:  */
        unsigned int  sizeroi_7 : 10; /* bit[16-25]: ROI Windows width 7 */
        unsigned int  reserved_1: 6;  /* bit[26-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  sizeroi_8 : 10; /* bit[0-9]  : ROI Windows width 8 */
        unsigned int  reserved_0: 6;  /* bit[10-15]:  */
...
typedef union
{
    ...
    struct
    {
        unsigned int  maxcolorvalue : 12; /* bit[0-11] : AWB max color value  */
        unsigned int  reserved_0    : 4;  /* bit[12-15]:  */
        unsigned int  mincolorvalue : 12; /* bit[16-27]: AWB min color value 
                                                         [Note]
...
typedef union
{
    ...
    struct
    {
        unsigned int  topk     : 14; /* bit[0-13] : Gray block parameters topk */
        unsigned int  reserved_0: 2;  /* bit[14-15]:  */
        unsigned int  topb     : 14; /* bit[16-29]: Gray block parameters topb */
...
typedef union
{
    ...
    struct
    {
        unsigned int  bottomk  : 14; /* bit[0-13] : Gray block parameters bottomk */
        unsigned int  reserved_0: 2;  /* bit[14-15]:  */
        unsigned int  bottomb  : 14; /* bit[16-29]: Gray block parameters bottomb */
        unsigned int  reserved_1: 2;  /* bit[30-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  leftk    : 14; /* bit[0-13] : Gray block parameters leftk */
        unsigned int  reserved_0: 2;  /* bit[14-15]:  */
        unsigned int  leftb    : 14; /* bit[16-29]: Gray block parameters leftb */
        unsigned int  reserved_1: 2;  /* bit[30-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  rightk   : 14; /* bit[0-13] : Gray block parameters rightk */
        unsigned int  reserved_0: 2;  /* bit[14-15]:  */
        unsigned int  rightb   : 14; /* bit[16-29]: Gray block parameters rightb */
        unsigned int  reserved_1: 2;  /* bit[30-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  maxvalue : 12; /* bit[0-11] : AWB luma max value */
        unsigned int  reserved_0: 4;  /* bit[12-15]:  */
        unsigned int  minvalue : 12; /* bit[16-27]: AWB luma min value
                                                    [Note]
                                                    minvalue < maxvalue
                                                    [end] */
        unsigned int  reserved_1: 4;  /* bit[28-31]:  */
...
typedef union
{
    ...
    struct
    {
        unsigned int  greencenrg : 12; /* bit[0-11] : Green ellipse parameter cen_rg */
        unsigned int  reserved_0 : 4;  /* bit[12-15]:  */
        unsigned int  greencnbg  : 12; /* bit[16-27]: Green ellipse parameter cen_bg */
        unsigned int  reserved_1 : 4;  /* bit[28-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  greendistrg : 16; /* bit[0-15] : Green ellipse parameter distance */
...
typedef union
{
    ...
    struct
    {
        unsigned int  crosscoef : 16; /* bit[0-15] : Green ellipse parameter crosscoef */
        unsigned int  thresh    : 12; /* bit[16-27]: Green ellipse parameter distance threshold */
...
typedef union
{
    ...
    struct
    {
        unsigned int  rgbhistmin   : 12; /* bit[0-11] : Min value of rgb_histogram */
        unsigned int  reserved_0   : 4;  /* bit[12-15]:  */
        unsigned int  rgbhistshift : 4;  /* bit[16-19]: [Note]
                                                        [0,7]
                                                        [end] */
...
typedef union
{
    ...
    struct
    {
        unsigned int  rgpregain : 12; /* bit[0-11] : Gain value for r/g */
        unsigned int  reserved_0: 4;  /* bit[12-15]:  */
        unsigned int  bgpregain : 12; /* bit[16-27]: Gain value for b/g */
        unsigned int  reserved_1: 4;  /* bit[28-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  rcoef    : 8;  /* bit[0-7]  : Luma calculation coefficient R */
        unsigned int  gcoef    : 8;  /* bit[8-15] : Luma calculation coefficient G */
        unsigned int  bcoef    : 8;  /* bit[16-23]: [Note]
                                                    bcoef + gcoef + rcoef = 256
                                                    [end] */
...
/*****************************************************************************
 结构名    : SOC_ISP_STAT3A_CENTER_UNION
 结构说明  : CENTER 寄存器结构定义。地址偏移量:0x00F8，初值:0x00000000，宽度:32
 寄存器说明: Center coordinates for LSC
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  cenx     : 13; /* bit[0-12] : x coordinate of center
                                                    [Note]
                                                    The type of cenx is s13.0
                                                    [end] */
        unsigned int  reserved_0: 3;  /* bit[13-15]:  */
        unsigned int  ceny     : 13; /* bit[16-28]: y coordinate of center
                                                    [Note]
                                                    The type of ceny is s13.0
                                                    [end] */
        unsigned int  reserved_1: 3;  /* bit[29-31]:  */
    } reg;
} SOC_ISP_STAT3A_CENTER_UNION;
#endif
#define SOC_ISP_STAT3A_CENTER_cenx_START      (0)
#define SOC_ISP_STAT3A_CENTER_cenx_END        (12)
#define SOC_ISP_STAT3A_CENTER_ceny_START      (16)
#define SOC_ISP_STAT3A_CENTER_ceny_END        (28)


/*****************************************************************************
 结构名    : SOC_ISP_STAT3A_LSC_ACTIVE_UNION
 结构说明  : LSC_ACTIVE 寄存器结构定义。地址偏移量:0x00FC，初值:0x00000000，宽度:32
 寄存器说明: Table Select for LSC
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  active   : 1;  /* bit[0]    : 0: Table 0 is used by the HW
                                                    1: Table 1 is used by the HW */
        unsigned int  reserved_0: 7;  /* bit[1-7]  :  */
        unsigned int  shiftn   : 4;  /* bit[8-11] : LSC shift used for position calculation */
        unsigned int  reserved_1: 20; /* bit[12-31]:  */
    } reg;
} SOC_ISP_STAT3A_LSC_ACTIVE_UNION;
#endif
#define SOC_ISP_STAT3A_LSC_ACTIVE_active_START    (0)
#define SOC_ISP_STAT3A_LSC_ACTIVE_active_END      (0)
#define SOC_ISP_STAT3A_LSC_ACTIVE_shiftn_START    (8)
#define SOC_ISP_STAT3A_LSC_ACTIVE_shiftn_END      (11)


/*****************************************************************************
 结构名    : SOC_ISP_STAT3A_LSC_LUT_0_UNION
 结构说明  : LSC_LUT_0 寄存器结构定义。地址偏移量:0x0800+0x4*(Range256)，初值:0x00000000，宽度:32
 寄存器说明: LookUp Table 0, 256 entries
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  lcsgain0_even : 13; /* bit[0-12] : Table 0 (Even) for LUT;
                                                         Configure sequence is R,B,Gr,Gb;
                                                         For each channel, range is [1024,5120],incremental */
        unsigned int  reserved_0    : 3;  /* bit[13-15]:  */
        unsigned int  lcsgain0_odd  : 13; /* bit[16-28]: Table 0 (Odd) for LUT;
                                                         Configure sequence is R,B,Gr,Gb;
                                                         For each channel, range is [1024,5120],incremental */
        unsigned int  reserved_1    : 3;  /* bit[29-31]:  */
    } reg;
} SOC_ISP_STAT3A_LSC_LUT_0_UNION;
#endif
#define SOC_ISP_STAT3A_LSC_LUT_0_lcsgain0_even_START  (0)
#define SOC_ISP_STAT3A_LSC_LUT_0_lcsgain0_even_END    (12)
#define SOC_ISP_STAT3A_LSC_LUT_0_lcsgain0_odd_START   (16)
#define SOC_ISP_STAT3A_LSC_LUT_0_lcsgain0_odd_END     (28)


/*****************************************************************************
 结构名    : SOC_ISP_STAT3A_LSC_LUT_1_UNION
 结构说明  : LSC_LUT_1 寄存器结构定义。地址偏移量:0x0C00+0x4*(Range256)，初值:0x00000000，宽度:32
 寄存器说明: LookUp Table 0, 256 entries
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  lcsgain1_even : 13; /* bit[0-12] : Table 1 (Even) for LUT;
                                                         Configure sequence is R,B,Gr,Gb;
                                                         For each channel, range is [1024,5120],incremental */
        unsigned int  reserved_0    : 3;  /* bit[13-15]:  */
        unsigned int  lcsgain1_odd  : 13; /* bit[16-28]: Table 1 (Odd) for LUT;
                                                         Configure sequence is R,B,Gr,Gb;
                                                         For each channel, range is [1024,5120],incremental */
        unsigned int  reserved_1    : 3;  /* bit[29-31]:  */
    } reg;
} SOC_ISP_STAT3A_LSC_LUT_1_UNION;
#endif
#define SOC_ISP_STAT3A_LSC_LUT_1_lcsgain1_even_START  (0)
#define SOC_ISP_STAT3A_LSC_LUT_1_lcsgain1_even_END    (12)
#define SOC_ISP_STAT3A_LSC_LUT_1_lcsgain1_odd_START   (16)
#define SOC_ISP_STAT3A_LSC_LUT_1_lcsgain1_odd_END     (28)
