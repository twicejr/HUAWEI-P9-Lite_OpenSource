...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  bypass_symfilter : 1;  /* bit[3]   : 0:sym filter active
                                                           1:bypass sym filter */
        unsigned int  uvdown_mode      : 1;  /* bit[4]   : UV downscale mode
                                                           0: Q01=P2
                                                           1: Q01=(P03+P02*2+P01)>>2 */
...
#define SOC_ISP_YUVNF_YUVNF_CONFIG_uvdown_mode_START       (4)
#define SOC_ISP_YUVNF_YUVNF_CONFIG_uvdown_mode_END         (4)
...
typedef union
{
    ...
    struct
    {
        unsigned int  off_sad   : 8;  /* bit[0-7]  : value valid in [0,128] */
        unsigned int  shift_sad : 2;  /* bit[8-9]  : value valid in [0,3] */
        unsigned int  reserved_0: 6;  /* bit[10-15]:  */
        unsigned int  inv_sad   : 11; /* bit[16-26]: value valid in [0,1024] inv_sad>>shift_sad=128 */
...
typedef union
{
    ...
    struct
    {
        unsigned int  edgeth     : 8;  /* bit[0-7]  : value valid in [0,128] */
        unsigned int  edgemaxoff : 6;  /* bit[8-13] : value valid in [0,32] */
        unsigned int  reserved_0 : 2;  /* bit[14-15]:  */
        unsigned int  gainmaxoff : 8;  /* bit[16-23]: value valid in [0,160] */
...
typedef union
{
    ...
    struct
    {
        unsigned int  uv_impulsive_th : 8;  /* bit[0-7] : value valid in [0,255] */
...
typedef union
{
    ...
    struct
    {
        unsigned int  v_desaturation_th : 4;  /* bit[0-3] : value valid in [0,15] */
        unsigned int  u_desaturation_th : 4;  /* bit[4-7] : value valid in [0,15] */
        unsigned int  reserved          : 24; /* bit[8-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  x_center : 13; /* bit[0-12] : CenterX-offset, used in dual pipe value valid in [-4095,4095] */
        unsigned int  reserved_0: 3;  /* bit[13-15]:  */
        unsigned int  y_center : 13; /* bit[16-28]: CenterY-offset, used in dual pipe value valid in [-4095,4095] */
...
#define SOC_ISP_YUVNF_XY_CENTER_y_center_START  (16)
#define SOC_ISP_YUVNF_XY_CENTER_y_center_END    (28)
...
typedef union
{
    ...
    struct
    {
        unsigned int  pgaussianlut_0 : 7;  /* bit[0-6]  : value valid in [0,64] */
        unsigned int  reserved_0     : 1;  /* bit[7]    :  */
        unsigned int  pgaussianlut_1 : 7;  /* bit[8-14] : value valid in [0,64] */
...
typedef union
{
    ...
    struct
    {
        unsigned int  weight_low_v : 8;  /* bit[0-7]  : value valid in [0.255] */
        unsigned int  weight_low_u : 8;  /* bit[8-15] : value valid in [0,255] */
...
typedef union
{
    ...
    struct
    {
        unsigned int  weight_high_v : 8;  /* bit[0-7]  : value valid in [0.255] */
        unsigned int  weight_high_u : 8;  /* bit[8-15] : value valid in [0,255] */
        unsigned int  reserved      : 16; /* bit[16-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  blend_x0 : 8;  /* bit[0-7]  : value valid in [0,255] */
        unsigned int  blend_x1 : 8;  /* bit[8-15] : value valid in [0,255],
...
typedef union
{
    ...
    struct
    {
        unsigned int  blend_y0 : 8;  /* bit[0-7]  : value valid in [0,128] */
        unsigned int  blend_y1 : 8;  /* bit[8-15] : value valid in [0,128],
                                                    blend_y1>blend_y0 */
        unsigned int  reserved : 16; /* bit[16-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  pg3lut_0 : 7;  /* bit[0-6]  : value valid in [0,64] */
        unsigned int  reserved_0: 1;  /* bit[7]    :  */
        unsigned int  pg3lut_1 : 7;  /* bit[8-14] : value valid in [0,64]
                                                    pg3lut_0*2+pg3lut_1=64 */
        unsigned int  reserved_1: 1;  /* bit[15]   :  */
        unsigned int  pg9lut_4 : 7;  /* bit[16-22]: value valid in [0,64] */
        unsigned int  reserved_2: 9;  /* bit[23-31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  pg7lut_0 : 7;  /* bit[0-6]  : value valid in [0,64] */
        unsigned int  reserved_0: 1;  /* bit[7]    :  */
        unsigned int  pg7lut_1 : 7;  /* bit[8-14] : value valid in [0,64] */
        unsigned int  reserved_1: 1;  /* bit[15]   :  */
        unsigned int  pg7lut_2 : 7;  /* bit[16-22]: value valid in [0,64] */
        unsigned int  reserved_2: 1;  /* bit[23]   :  */
        unsigned int  pg7lut_3 : 7;  /* bit[24-30]: value valid in [0,64]
...
typedef union
{
    ...
    struct
    {
        unsigned int  pg9lut_0 : 7;  /* bit[0-6]  : value valid in [0,64] */
        unsigned int  reserved_0: 1;  /* bit[7]    :  */
        unsigned int  pg9lut_1 : 7;  /* bit[8-14] : value valid in [0,64] */
        unsigned int  reserved_1: 1;  /* bit[15]   :  */
        unsigned int  pg9lut_2 : 7;  /* bit[16-22]: value valid in [0,64] */
        unsigned int  reserved_2: 1;  /* bit[23]   :  */
        unsigned int  pg9lut_3 : 7;  /* bit[24-30]: value valid in [0,64]
