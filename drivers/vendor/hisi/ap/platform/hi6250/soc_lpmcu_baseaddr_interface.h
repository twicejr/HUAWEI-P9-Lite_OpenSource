...
/* 寄存器说明：4K */
#define SOC_LPMCU_SDIO0_BASE_ADDR                     (0xBF37D000)

/* 寄存器说明：4K */
#define SOC_LPMCU_USB2OTG_BC_BASE_ADDR                (0xBF200000)

/* 寄存器说明：256K */
#define SOC_LPMCU_USB2OTG_BASE_ADDR                   (0xBF100000)
...
/* 寄存器说明：4K */
#define SOC_LPMCU_IPC_MDM_S_BASE_ADDR                 (0xBDF22000)
...
/* 寄存器说明：64K */
#define SOC_LPMCU_OCB_CTRL_BASE_ADDR                  (0xA82C0000)
...
/* 寄存器说明：4K */
#define SOC_LPMCU_DigACodec_BASE_ADDR                 (0xA8052000)
...
/* 寄存器说明：4K */
#define SOC_LPMCU_A53_L_ROM_TABLE_BASE_ADDR           (0x50800000)

/* 寄存器说明：4K */
#define SOC_LPMCU_A53_L_FUNNEL_BASE_ADDR              (0x50801000)

/* 寄存器说明：4K */
#define SOC_LPMCU_A53_L_ETF_BASE_ADDR                 (0x50802000)

/* 寄存器说明：4K */
#define SOC_LPMCU_A53_L_CTI_BASE_ADDR                 (0x50803000)

/* 寄存器说明：4K */
#define SOC_LPMCU_A53_B_ROM_TABLE_BASE_ADDR           (0x51000000)

/* 寄存器说明：4K */
#define SOC_LPMCU_A53_B_FUNNEL_BASE_ADDR              (0x51001000)

/* 寄存器说明：4K */
#define SOC_LPMCU_A53_B_ETF_BASE_ADDR                 (0x51002000)

/* 寄存器说明：4K */
#define SOC_LPMCU_A53_B_CTI_BASE_ADDR                 (0x51003000)
...
/* 寄存器说明：4K */
#define SOC_LPMCU_DDRC_QOSB_BASE_ADDR                 (0x40248000)

/* 寄存器说明：4K */
#define SOC_LPMCU_DDRC_DMC_BASE_ADDR                  (0x40249000)

/* 寄存器说明：4K */
#define SOC_LPMCU_PACK_A_BASE_ADDR                    (0x40250000)

/* 寄存器说明：4K */
#define SOC_LPMCU_DDRPHY_STATIC_AC_DX_BASE_ADDR       (0x40251000)

/* 寄存器说明：4K */
#define SOC_LPMCU_EXMBIST_BASE_ADDR                   (0x40258000)
...
/* 寄存器说明：4K */
#define SOC_LPMCU_PMCTRL_BASE_ADDR                    (0x40231000)
...
/* 寄存器说明：4k */
#define SOC_LPMCU_GPIO29_BASE_ADDR                    (0x4021E000)

/* 寄存器说明：4k */
#define SOC_LPMCU_GPIO30_BASE_ADDR                    (0x4021F000)
