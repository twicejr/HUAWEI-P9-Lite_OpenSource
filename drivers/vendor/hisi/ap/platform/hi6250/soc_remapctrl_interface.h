 ...
 ****************************************************************************/
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_REMAP_CFG_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_MAP_TABLE_WP_UNION
...
typedef union
{
    ...
    struct
    {
        unsigned int  mt_wp : 32; /* bit[0-31]: 只有寄存器。内容为0x6864_6250时，才能对Map Table进行配置，否则只能对Map Table进行读操作。 */
    } reg;
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_LP_CTRL_UNION
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  auto_gate_cnt   : 8;  /* bit[4-11] : TCM时钟自动门控功能的防抖周期数，即配置值的周期内没有操作，TCM自动门控生效；配置值不能小于3； */
        ...
        unsigned int  auto_mem_lp_cnt : 8;  /* bit[20-27]: Memory自动进入Deepsleep的没有操作的周期数，配置值不能小于2，且要比auto_gate_cnt要小； */
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_LP_CTRL_1_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_ITCM_TLB_ENTRY0_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_ITCM_TLB_ENTRY1_UNION
...
typedef union
{
    ...
    struct
    {
        unsigned int  itcm_tlb_entry1 : 20; /* bit[0-19] : ITCM tlb_entry1的值 */
        unsigned int  reserved        : 12; /* bit[20-31]: reserved */
    } reg;
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_ITCM_TLB_ENTRY2_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_ITCM_TLB_ENTRY3_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_ITCM_TLB_ENTRY4_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_ITCM_TLB_ENTRY5_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_ITCM_TLB_ENTRY6_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_ITCM_TLB_ENTRY7_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_D0TCM_TLB_ENTRY0_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_D0TCM_TLB_ENTRY1_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_D0TCM_TLB_ENTRY2_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_D0TCM_TLB_ENTRY3_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_D0TCM_TLB_ENTRY4_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_D0TCM_TLB_ENTRY5_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_D0TCM_TLB_ENTRY6_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_D0TCM_TLB_ENTRY7_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_D1TCM_TLB_ENTRY0_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_D1TCM_TLB_ENTRY1_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_D1TCM_TLB_ENTRY2_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_D1TCM_TLB_ENTRY3_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_D1TCM_TLB_ENTRY4_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_D1TCM_TLB_ENTRY5_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_D1TCM_TLB_ENTRY6_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_D1TCM_TLB_ENTRY7_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_ITCM_HIT_CNT_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_ITCM_MISS_CNT_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_D0TCM_HIT_CNT_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_D0TCM_MISS_CNT_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_D1TCM_HIT_CNT_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_D1TCM_MISS_CNT_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_LP_CTRL_3_UNION
 结构说明  : LP_CTRL_3 寄存器结构定义。地址偏移量:0x088，初值:0x00000001，宽度:32
 寄存器说明: TCM低功耗控制寄存器3。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  m7sleep_tcm_auto_lp_bypass : 1;  /* bit[0-0] : M7 sleeping有效时，TCM自动进入deepsleep功能。软件必须保证M7 处在sleeping且没有访问TCM的操作时才可以使能。
                                                                     1'b0:不bypass，
                                                                     1'b1:bypass */
        unsigned int  reserved                   : 31; /* bit[1-31]: reserved */
    } reg;
} SOC_REMAPCTRL_LP_CTRL_3_UNION;
#endif
#define SOC_REMAPCTRL_LP_CTRL_3_m7sleep_tcm_auto_lp_bypass_START  (0)
#define SOC_REMAPCTRL_LP_CTRL_3_m7sleep_tcm_auto_lp_bypass_END    (0)


/*****************************************************************************
 结构名    : SOC_REMAPCTRL_BANK_MEM_CTRL_UNION
 结构说明  : BANK_MEM_CTRL 寄存器结构定义。地址偏移量:0x08C，初值:0x00000000，宽度:32
 寄存器说明: BANK低功耗状态寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  bank0_mem_ctrl_s : 3;  /* bit[0-2]  : BANK0低功耗状态位：
                                                            0x0：normal；
                                                            0x1：sleep；
                                                            0x2：deepsleep；
                                                            0x4：shutdown；
        ...
        unsigned int  bank1_mem_ctrl_s : 3;  /* bit[4-6]  : BANK1低功耗状态位：
                                                            0x0：normal；
                                                            0x1：sleep；
                                                            0x2：deepsleep；
                                                            0x4：shutdown；
        ...
        unsigned int  bank2_mem_ctrl_s : 3;  /* bit[8-10] : BANK2低功耗状态位：
                                                            0x0：normal；
                                                            0x1：sleep；
                                                            0x2：deepsleep；
                                                            0x4：shutdown；
                                                            其余reserved */
        unsigned int  reserved_2       : 1;  /* bit[11-11]: reserved */
        unsigned int  bank3_mem_ctrl_s : 3;  /* bit[12-14]: BANK3低功耗状态位：
                                                            0x0：normal；
                                                            0x1：sleep；
                                                            0x2：deepsleep；
                                                            0x4：shutdown；
                                                            其余reserved */
        unsigned int  reserved_3       : 1;  /* bit[15-15]: reserved */
        unsigned int  bank4_mem_ctrl_s : 3;  /* bit[16-18]: BANK4低功耗状态位：
                                                            0x0：normal；
                                                            0x1：sleep；
                                                            0x2：deepsleep；
                                                            0x4：shutdown；
                                                            其余reserved */
        unsigned int  reserved_4       : 1;  /* bit[19-19]: reserved */
        unsigned int  bank5_mem_ctrl_s : 3;  /* bit[20-22]: BANK5低功耗状态位：
                                                            0x0：normal；
                                                            0x1：sleep；
                                                            0x2：deepsleep；
                                                            0x4：shutdown；
                                                            其余reserved */
        unsigned int  reserved_5       : 1;  /* bit[23-23]: reserved */
        unsigned int  bank6_mem_ctrl_s : 3;  /* bit[24-26]: BANK6低功耗状态位：
                                                            0x0：normal；
                                                            0x1：sleep；
                                                            0x2：deepsleep；
                                                            0x4：shutdown；
                                                            其余reserved */
        unsigned int  reserved_6       : 5;  /* bit[27-31]: reserved */
    } reg;
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_LP_CTRL_2_UNION
 结构说明  : LP_CTRL_2 寄存器结构定义。地址偏移量:0x098，初值:0x00000003，宽度:32
 寄存器说明: TCM低功耗控制寄存器2。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_TCM_ERR_TYPE_UNION
...
typedef union
{
    ...
    struct
    {
        unsigned int  itcm_page_err          : 1;  /* bit[0-0]  : ITCM缺页错误
                                                                  1'b0:无错
                                                                  1'b1:有错 */
        unsigned int  itcmaddr_out_224k_err  : 1;  /* bit[1-1]  : ITCM访问超过224K空间错误
                                                                  1'b0:无错
                                                                  1'b1:有错 */
        ...
        unsigned int  d0tcm_page_err         : 1;  /* bit[4-4]  : D0TCM缺页错误
                                                                  1'b0:无错
                                                                  1'b1:有错 */
        unsigned int  d0tcmaddr_out_224k_err : 1;  /* bit[5-5]  : D0TCM访问超过224K空间错误
                                                                  1'b0:无错
                                                                  1'b1:有错 */
        ...
        unsigned int  d1tcm_page_err         : 1;  /* bit[8-8]  : D1TCM缺页错误
                                                                  1'b0:无错
                                                                  1'b1:有错 */
        unsigned int  d1tcmaddr_out_224k_err : 1;  /* bit[9-9]  : D1TCM访问超过224K空间错误
                                                                  1'b0:无错
                                                                  1'b1:有错 */
        unsigned int  itcm_err_bank0         : 1;  /* bit[10-10]: ITCM是否访问了分配给DTCM的bank0
                                                                  1'b1:访问了分配给DTCM的bank0
                                                                  1'b0:未访问 */
        unsigned int  itcm_err_bank1         : 1;  /* bit[11-11]: ITCM是否访问了分配给DTCM的bank1
                                                                  1'b1:访问了分配给DTCM的bank0
                                                                  1'b0:未访问 */
        unsigned int  itcm_err_bank2         : 1;  /* bit[12-12]: ITCM是否访问了分配给DTCM的bank2
                                                                  1'b1:访问了分配给DTCM的bank0
                                                                  1'b0:未访问 */
        unsigned int  itcm_err_bank3         : 1;  /* bit[13-13]: ITCM是否访问了分配给DTCM的bank3
                                                                  1'b1:访问了分配给DTCM的bank0
                                                                  1'b0:未访问 */
        unsigned int  itcm_err_bank4         : 1;  /* bit[14-14]: ITCM是否访问了分配给DTCM的bank4
                                                                  1'b1:访问了分配给DTCM的bank0
                                                                  1'b0:未访问 */
        unsigned int  itcm_err_bank5         : 1;  /* bit[15-15]: ITCM是否访问了分配给DTCM的bank5
                                                                  1'b1:访问了分配给DTCM的bank0
                                                                  1'b0:未访问 */
        unsigned int  itcm_err_bank6         : 1;  /* bit[16-16]: ITCM是否访问了分配给DTCM的bank6
                                                                  1'b1:访问了分配给DTCM的bank0
                                                                  1'b0:未访问 */
        ...
        unsigned int  d0tcm_err_bank4        : 1;  /* bit[21-21]: D0TCM是否访问了分配给ITCM的bank4
                                                                  ...
                                                                  1'b0:未访问 */
        unsigned int  d0tcm_err_bank5        : 1;  /* bit[22-22]: D0TCM是否访问了分配给ITCM的bank5
                                                                  1'b1:访问了分配给ITCM的bank4
                                                                  1'b0:未访问 */
        unsigned int  d0tcm_err_bank6        : 1;  /* bit[23-23]: D0TCM是否访问了分配给ITCM的bank6
                                                                  1'b1:访问了分配给ITCM的bank4
                                                                  1'b0:未访问 */
        unsigned int  d1tcm_err_bank0        : 1;  /* bit[24-24]: D1TCM是否访问了分配给ITCM的bank0
                                                                  1'b1:访问了分配给ITCM的bank0
                                                                  1'b0:未访问 */
        unsigned int  d1tcm_err_bank1        : 1;  /* bit[25-25]: D1TCM是否访问了分配给ITCM的bank1
                                                                  1'b1:访问了分配给ITCM的bank1
                                                                  1'b0:未访问 */
        unsigned int  d1tcm_err_bank2        : 1;  /* bit[26-26]: D1TCM是否访问了分配给ITCM的bank2
                                                                  1'b1:访问了分配给ITCM的bank2
                                                                  1'b0:未访问 */
        unsigned int  d1tcm_err_bank3        : 1;  /* bit[27-27]: D1TCM是否访问了分配给ITCM的bank3
                                                                  1'b1:访问了分配给ITCM的bank3
                                                                  1'b0:未访问 */
        unsigned int  d1tcm_err_bank4        : 1;  /* bit[28-28]: D1TCM是否访问了分配给ITCM的bank4
                                                                  1'b1:访问了分配给ITCM的bank4
                                                                  1'b0:未访问 */
        unsigned int  d1tcm_err_bank5        : 1;  /* bit[29-29]: D1TCM是否访问了分配给ITCM的bank5
                                                                  1'b1:访问了分配给ITCM的bank4
                                                                  1'b0:未访问 */
        unsigned int  d1tcm_err_bank6        : 1;  /* bit[30-30]: D1TCM是否访问了分配给ITCM的bank6
                                                                  1'b1:访问了分配给ITCM的bank4
                                                                  1'b0:未访问 */
        unsigned int  reserved_2             : 1;  /* bit[31-31]: reserved */
    } reg;
...
#define SOC_REMAPCTRL_TCM_ERR_TYPE_itcmaddr_out_224k_err_START   (1)
#define SOC_REMAPCTRL_TCM_ERR_TYPE_itcmaddr_out_224k_err_END     (1)
#define SOC_REMAPCTRL_TCM_ERR_TYPE_d0tcm_page_err_START          (4)
#define SOC_REMAPCTRL_TCM_ERR_TYPE_d0tcm_page_err_END            (4)
#define SOC_REMAPCTRL_TCM_ERR_TYPE_d0tcmaddr_out_224k_err_START  (5)
#define SOC_REMAPCTRL_TCM_ERR_TYPE_d0tcmaddr_out_224k_err_END    (5)
#define SOC_REMAPCTRL_TCM_ERR_TYPE_d1tcm_page_err_START          (8)
#define SOC_REMAPCTRL_TCM_ERR_TYPE_d1tcm_page_err_END            (8)
#define SOC_REMAPCTRL_TCM_ERR_TYPE_d1tcmaddr_out_224k_err_START  (9)
#define SOC_REMAPCTRL_TCM_ERR_TYPE_d1tcmaddr_out_224k_err_END    (9)
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_BANK_SEL_UNION
 结构说明  : BANK_SEL 寄存器结构定义。地址偏移量:0x0A0，初值:0x0000007C，宽度:32
 寄存器说明: BANK选择寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  bank4_sel : 1;  /* bit[4-4] : bank4分配给ITCM还是DTCM
                                                    1'b0:分配给ITCM
                                                    1'b1:分配给DTCM */
        unsigned int  bank5_sel : 1;  /* bit[5-5] : bank4分配给ITCM还是DTCM
                                                    1'b0:分配给ITCM
                                                    1'b1:分配给DTCM */
        unsigned int  bank6_sel : 1;  /* bit[6-6] : bank4分配给ITCM还是DTCM
                                                    1'b0:分配给ITCM
                                                    1'b1:分配给DTCM */
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_ITCM_ERR_ADDR_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_D0TCM_ERR_ADDR_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_D1TCM_ERR_ADDR_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_ITCM_ERR_CNT_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_D0TCM_ERR_CNT_UNION
...
/*****************************************************************************
 结构名    : SOC_REMAPCTRL_D1TCM_ERR_CNT_UNION
...
#endif /* end of soc_remapctrl_interface.h */
