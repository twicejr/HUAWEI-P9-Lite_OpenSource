...
#define SOC_SCTRL_SCPERCLKEN1_ADDR(base)              ((base) + (0x188))

/* 寄存器说明：外设时钟最终状态寄存器1。
   位域定义UNION结构:  SOC_SCTRL_SCPERSTAT1_UNION */
#define SOC_SCTRL_SCPERSTAT1_ADDR(base)               ((base) + (0x18C))
...
/* 寄存器说明：外设控制寄存器8，控制信号由SCTRL内部逻辑产生的状态输出控制。
...
/* 寄存器说明：外设安全控制寄存器。
   位域定义UNION结构:  SOC_SCTRL_SC_PERI_SEC_CTRL_UNION */
...
typedef union
{
    ...
    struct
    {
        unsigned int  reset_source : 32; /* bit[0-31]: 写：往该寄存器写入任意值会触发系统软复位。
                                                       ...
                                                       [1]:a53_tsensor1_rst_req对应大核
                                                       [0]:a53_tsensor0_rst_req对应小核。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : SCISOSTAT 寄存器结构定义。地址偏移量:0x048，初值:0x0000000B，宽度:32
 寄存器说明: 掉电子系统ISO使能状态寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : SCPWRSTAT 寄存器结构定义。地址偏移量:0x068，初值:0x00000004，宽度:32
 寄存器说明: 掉电子系统电源使能状态寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : SCPWRACK 寄存器结构定义。地址偏移量:0x06C，初值:0x00000004，宽度:32
 寄存器说明: 掉电子系统最终电源状态寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  iomcu_mtcmos_ack : 1;  /* bit[1]   : IOMCU子系统电源电源反馈状态：
                                                           0：IOMCU子系统电源使能撤销；
                                                           1：IOMCU子系统电源使能。 */
        unsigned int  reserved_0       : 1;  /* bit[2]   : Debug子系统电源单元电源反馈状态：
                                                           0--电源关闭
                                                           1--电源使能。 */
        unsigned int  mmbuf_mtcmos_ack : 1;  /* bit[3]   : MMBUF子系统电源单元电源反馈状态：
                                                           0--电源关闭
                                                           1--电源使能。 */
        unsigned int  reserved_1       : 28; /* bit[4-31]: 保留。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : SCPERPWRDOWNTIME 寄存器结构定义。地址偏移量:0x070，初值:0x01FFFFEE，宽度:32
 寄存器说明: 外设区掉电时间配置寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  intr_wakeup_iomcu       : 1;  /* bit[31]:  */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  noc_aobus_mmbuf_t_maintimeout_msk : 1;  /* bit[8]    : 含义同bit0。 */
        ...
        unsigned int  ao_gpio6_int_wk_msk               : 1;  /* bit[12]   : 含义同bit0。 */
        unsigned int  ao_gpio7_int_wk_msk               : 1;  /* bit[13]   : 含义同bit0。 */
        unsigned int  ao_gpio8_int_wk_msk               : 1;  /* bit[14]   : 含义同bit0。 */
...
#define SOC_SCTRL_SCINT_MASK1_noc_aobus_mmbuf_t_maintimeout_msk_START  (8)
#define SOC_SCTRL_SCINT_MASK1_noc_aobus_mmbuf_t_maintimeout_msk_END    (8)
...
#define SOC_SCTRL_SCINT_MASK1_ao_gpio6_int_wk_msk_START                (12)
#define SOC_SCTRL_SCINT_MASK1_ao_gpio6_int_wk_msk_END                  (12)
#define SOC_SCTRL_SCINT_MASK1_ao_gpio7_int_wk_msk_START                (13)
#define SOC_SCTRL_SCINT_MASK1_ao_gpio7_int_wk_msk_END                  (13)
#define SOC_SCTRL_SCINT_MASK1_ao_gpio8_int_wk_msk_START                (14)
#define SOC_SCTRL_SCINT_MASK1_ao_gpio8_int_wk_msk_END                  (14)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_0                           : 2;  /* bit[6-7]  : 保留。 */
        unsigned int  noc_aobus_mmbuf_t_maintimeout_msksta : 1;  /* bit[8]    : noc_aobus_mmbuf_t_maintimeout_msksta 含义同bit0。 */
        unsigned int  noc_asp_cfg_t_maintimeout_msksta     : 1;  /* bit[9]    : noc_asp_cfg_t_maintimeout_msksta 含义同bit0。 */
        unsigned int  iomcu_ahb_slv_maintimeout_msksta     : 1;  /* bit[10]   : iomcu_ahb_slv_maintimeout_msksta 含义同bit0。 */
        unsigned int  iomcu_apb_slv_maintimeout_msksta     : 1;  /* bit[11]   : iomcu_apb_slv_maintimeout_msksta 含义同bit0。 */
        unsigned int  ao_gpio6_int_wk                      : 1;  /* bit[12]   : ao_gpio6_int_wk 含义同bit0。 */
        unsigned int  ao_gpio7_int_wk                      : 1;  /* bit[13]   : ao_gpio7_int_wk 含义同bit0。 */
        unsigned int  ao_gpio8_int_wk                      : 1;  /* bit[14]   : ao_gpio8_int_wk 含义同bit0。 */
        unsigned int  reserved_1                           : 17; /* bit[15-31]: 保留。 */
    } reg;
...
#define SOC_SCTRL_SCINT_STAT1_ao_gpio6_int_wk_START                       (12)
#define SOC_SCTRL_SCINT_STAT1_ao_gpio6_int_wk_END                         (12)
#define SOC_SCTRL_SCINT_STAT1_ao_gpio7_int_wk_START                       (13)
#define SOC_SCTRL_SCINT_STAT1_ao_gpio7_int_wk_END                         (13)
#define SOC_SCTRL_SCINT_STAT1_ao_gpio8_int_wk_START                       (14)
#define SOC_SCTRL_SCINT_STAT1_ao_gpio8_int_wk_END                         (14)
...
/*****************************************************************************
 ...
 结构说明  : SCPPLLCTRL0 寄存器结构定义。地址偏移量:0x100，初值:0x00904B06，宽度:32
 寄存器说明: PPLL0控制寄存器0。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : SCPPLLCTRL1 寄存器结构定义。地址偏移量:0x104，初值:0x06000000，宽度:32
 寄存器说明: PPLL0控制寄存器1。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : SCPPLLSSCCTRL 寄存器结构定义。地址偏移量:0x108，初值:0x0000019F，宽度:32
 寄存器说明: PPLL0 SSC控制寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : SCPPLLSTAT 寄存器结构定义。地址偏移量:0x10C，初值:0x00000000，宽度:32
 寄存器说明: PPLL0状态寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : SCFPLLCTRL0 寄存器结构定义。地址偏移量:0x120，初值:0x00904B06，宽度:32
 寄存器说明: FPLL0控制寄存器0。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : SCFPLLCTRL1 寄存器结构定义。地址偏移量:0x124，初值:0x00904B06，宽度:32
 寄存器说明: FPLL0控制寄存器1。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : SCFPLLCTRL2 寄存器结构定义。地址偏移量:0x128，初值:0x00904B06，宽度:32
 寄存器说明: FPLL0控制寄存器2。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : SCFPLLCTRL3 寄存器结构定义。地址偏移量:0x12C，初值:0x00904B06，宽度:32
 寄存器说明: FPLL0控制寄存器3。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  gt_clk_timer0     : 1;  /* bit[4]  : 外设时钟使能控制：
                                                           0：写0无效果；
                                                           1：使能IP时钟。 */
        unsigned int  reserved_0        : 2;  /* bit[5-6]: 外设时钟使能控制：
                                                           0：写0无效果；
                                                           1：使能IP时钟。 */
        ...
        unsigned int  gt_clk_sci1       : 1;  /* bit[24] : 外设时钟使能控制：
                                                           0：写0无效果；
                                                           1：使能IP时钟。 */
        unsigned int  reserved_1        : 1;  /* bit[25] : 外设时钟使能控制：
                                                           0：写0无效果；
                                                           1：使能IP时钟。 */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  gt_clk_timer0     : 1;  /* bit[4]  : 外设时钟禁止控制：
                                                           0：写0无效果；
                                                           1：禁止IP时钟。 */
        unsigned int  reserved_0        : 2;  /* bit[5-6]: 外设时钟禁止控制：
                                                           0：写0无效果；
                                                           1：禁止IP时钟。 */
        ...
        unsigned int  gt_clk_sci1       : 1;  /* bit[24] : 外设时钟禁止控制：
                                                           0：写0无效果；
                                                           1：禁止IP时钟。 */
        unsigned int  reserved_1        : 1;  /* bit[25] : 外设时钟禁止控制：
                                                           0：写0无效果；
                                                           1：禁止IP时钟。 */
...
/*****************************************************************************
 ...
 结构说明  : SCPERCLKEN0 寄存器结构定义。地址偏移量:0x168，初值:0xF3FFFFFF，宽度:32
 寄存器说明: 外设时钟使能状态寄存器0。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  gt_clk_sci1       : 1;  /* bit[24] : 外设时钟使能状态：
                                                           0：IP时钟使能撤销状态；
                                                           1：IP时钟使能状态。 */
        unsigned int  reserved_1        : 1;  /* bit[25] : 外设时钟使能状态：
                                                           0：IP时钟使能撤销状态；
                                                           1：IP时钟使能状态。 */
...
/*****************************************************************************
 ...
 结构说明  : SCPERSTAT0 寄存器结构定义。地址偏移量:0x16C，初值:0xF1FFFFFF，宽度:32
 寄存器说明: 外设时钟最终状态寄存器0。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  gt_clk_sci1       : 1;  /* bit[24]: 外设时钟最终状态：
                                                          0：IP时钟禁止状态；
                                                          1：IP时钟使能状态。 */
        unsigned int  reserved          : 1;  /* bit[25]: 外设时钟最终状态：
                                                          0：IP时钟禁止状态；
                                                          1：IP时钟使能状态。 */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  gt_aclk_asc                      : 1;  /* bit[8] : 外设时钟使能控制：
                                                                         0：写0无效；
                                                                         1：写1使能IP时钟。 */
        unsigned int  gt_clk_fll_frc_tp                : 1;  /* bit[9] : 外设时钟使能控制：
                                                                         0：写0无效；
                                                                         1：写1使能IP时钟。 */
        ...
        unsigned int  gt_timerclk_refh                 : 1;  /* bit[20]: 外设时钟使能控制：
                                                                         0：写0无效；
                                                                         1：写1使能IP时钟。 */
        unsigned int  reserved_0                       : 1;  /* bit[21]: 外设时钟使能控制：
                                                                         0：写0无效；
                                                                         1：写1使能IP时钟。 */
        ...
        unsigned int  gt_pclk_mmbufcfg                 : 1;  /* bit[25]: 外设时钟使能控制：
                                                                         0：写0无效；
                                                                         1：写1使能IP时钟。 */
        unsigned int  gt_auto_aclk_mmbuf_sw            : 1;  /* bit[26]: 外设时钟使能控制：
                                                                         0：写0无效；
                                                                         1：写1使能IP时钟。 */
        unsigned int  reserved_1                       : 1;  /* bit[27]: 外设时钟使能控制：
                                                                         0：写0无效；
                                                                         1：写1使能IP时钟。 */
        unsigned int  gt_clk_autodiv_aobus             : 1;  /* bit[28]: 外设时钟使能控制：
                                                                         0：写0无效；
                                                                         1：写1使能IP时钟。 */
        unsigned int  gt_clk_autodiv_aobus_fll         : 1;  /* bit[29]: 外设时钟使能控制：
                                                                         0：写0无效；
                                                                         1：写1使能IP时钟。 */
        unsigned int  reserved_2                       : 1;  /* bit[30]: aobus2mmbuf_auto_gate_bypass
                                                                         0：写0无效；
...
#define SOC_SCTRL_SCPEREN1_gt_clk_fll_frc_tp_START                 (9)
#define SOC_SCTRL_SCPEREN1_gt_clk_fll_frc_tp_END                   (9)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  gt_aclk_asc                      : 1;  /* bit[8] : 外设时钟禁止控制：
                                                                         0：写0无效；
                                                                         1：写1禁止IP时钟。 */
        unsigned int  gt_clk_fll_frc_tp                : 1;  /* bit[9] : 外设时钟禁止控制：
                                                                         0：写0无效；
                                                                         1：写1禁止IP时钟。 */
        ...
        unsigned int  gt_timerclk_refh                 : 1;  /* bit[20]: 外设时钟禁止控制：
                                                                         0：写0无效；
                                                                         1：写1禁止IP时钟。 */
        unsigned int  reserved_0                       : 1;  /* bit[21]: 外设时钟禁止控制：
                                                                         0：写0无效；
                                                                         1：写1禁止IP时钟。 */
        ...
        unsigned int  gt_pclk_mmbufcfg                 : 1;  /* bit[25]: 外设时钟禁止控制：
                                                                         0：写0无效；
                                                                         1：写1禁止IP时钟。 */
        unsigned int  gt_auto_aclk_mmbuf_sw            : 1;  /* bit[26]: 外设时钟禁止控制：
                                                                         0：写0无效；
                                                                         1：写1禁止IP时钟。 */
        unsigned int  reserved_1                       : 1;  /* bit[27]: 外设时钟禁止控制：
                                                                         0：写0无效；
                                                                         1：写1禁止IP时钟。 */
        unsigned int  gt_clk_autodiv_aobus             : 1;  /* bit[28]: 外设时钟禁止控制：
                                                                         0：写0无效；
                                                                         1：写1禁止IP时钟。 */
        unsigned int  gt_clk_autodiv_aobus_fll         : 1;  /* bit[29]: 外设时钟禁止控制：
                                                                         0：写0无效；
                                                                         1：写1禁止IP时钟。 */
        unsigned int  reserved_2                       : 1;  /* bit[30]: aobus2mmbuf_auto_gate_bypass，Dallas不使用
                                                                         0：写0无效；
...
#define SOC_SCTRL_SCPERDIS1_gt_clk_fll_frc_tp_START                 (9)
#define SOC_SCTRL_SCPERDIS1_gt_clk_fll_frc_tp_END                   (9)
...
/*****************************************************************************
 ...
 结构说明  : SCPERCLKEN1 寄存器结构定义。地址偏移量:0x188，初值:0x8C1FFC70，宽度:32
 寄存器说明: 外设时钟使能状态寄存器1。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  gt_aclk_asc                      : 1;  /* bit[8] : 外设时钟使能状态：
                                                                         0：IP时钟禁止状态；
                                                                         1：IP时钟使能状态。 */
        unsigned int  gt_clk_fll_frc_tp                : 1;  /* bit[9] : 外设时钟使能状态：
                                                                         0：IP时钟禁止状态；
                                                                         1：IP时钟使能状态。 */
        ...
        unsigned int  gt_timerclk_refh                 : 1;  /* bit[20]: 外设时钟使能状态：
                                                                         0：IP时钟禁止状态；
                                                                         1：IP时钟使能状态。 */
        unsigned int  reserved_0                       : 1;  /* bit[21]: 外设时钟使能状态：
                                                                         0：IP时钟禁止状态；
                                                                         1：IP时钟使能状态。 */
        ...
        unsigned int  gt_pclk_mmbufcfg                 : 1;  /* bit[25]: 0：时钟关闭；
                                                                         1：时钟开启。 */
        unsigned int  gt_auto_aclk_mmbuf_sw            : 1;  /* bit[26]: 外设时钟使能状态：
                                                                         0：IP时钟禁止状态；
                                                                         1：IP时钟使能状态。 */
        unsigned int  reserved_1                       : 1;  /* bit[27]: 外设时钟使能状态：
                                                                         0：IP时钟禁止状态；
                                                                         1：IP时钟使能状态。 */
        unsigned int  gt_clk_autodiv_aobus             : 1;  /* bit[28]: 外设时钟使能状态：
                                                                         0：IP时钟禁止状态；
                                                                         1：IP时钟使能状态。 */
        unsigned int  gt_clk_autodiv_aobus_fll         : 1;  /* bit[29]: 外设时钟使能状态：
                                                                         0：IP时钟禁止状态；
                                                                         1：IP时钟使能状态。 */
        unsigned int  reserved_2                       : 1;  /* bit[30]: aobus2mmbuf_auto_gate_bypass，Dallas不使用
                                                                         0:no bypass
...
#define SOC_SCTRL_SCPERCLKEN1_gt_clk_fll_frc_tp_START                 (9)
#define SOC_SCTRL_SCPERCLKEN1_gt_clk_fll_frc_tp_END                   (9)
...
/*****************************************************************************
 ...
 结构说明  : SCPERSTAT1 寄存器结构定义。地址偏移量:0x18C，初值:0x7C3FFCF0，宽度:32
 寄存器说明: 外设时钟最终状态寄存器1。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  st_aclk_asc                 : 1;  /* bit[8] : 外设时钟最终状态：
                                                                    0：IP时钟禁止状态；
                                                                    1：IP时钟使能状态。 */
        unsigned int  gt_clk_fll_frc_tp           : 1;  /* bit[9] : 外设时钟最终状态：
                                                                    0：IP时钟禁止状态；
                                                                    1：IP时钟使能状态。 */
        ...
        unsigned int  gt_pclk_mmbufcfg            : 1;  /* bit[25]: 0：时钟关闭；
                                                                    1：时钟开启。 */
        unsigned int  gt_auto_aclk_mmbuf_sw       : 1;  /* bit[26]: 外设时钟最终状态：
                                                                    0：IP时钟禁止状态；
                                                                    1：IP时钟使能状态。 */
...
typedef union
{
    ...
    struct
    {
        unsigned int  reserved_0          : 17; /* bit[0-16] : 外设时钟禁止控制：
                                                               0：写0无效；
                                                               1：写1使能IP时钟。 */
        unsigned int  gt_pclk_ao_gpio6    : 1;  /* bit[17]   : 含义同bit0。 */
        unsigned int  gt_pclk_ao_gpio7    : 1;  /* bit[18]   : 含义同bit0。 */
        unsigned int  gt_pclk_ao_gpio8    : 1;  /* bit[19]   : 含义同bit0。 */
        unsigned int  gt_clk_mdm2aspcodec : 1;  /* bit[20]   : 含义同bit0。 */
        unsigned int  reserved_1          : 11; /* bit[21-31]: 保留。 */
    } reg;
} SOC_SCTRL_SCPEREN2_UNION;
#endif
#define SOC_SCTRL_SCPEREN2_gt_pclk_ao_gpio6_START     (17)
#define SOC_SCTRL_SCPEREN2_gt_pclk_ao_gpio6_END       (17)
#define SOC_SCTRL_SCPEREN2_gt_pclk_ao_gpio7_START     (18)
#define SOC_SCTRL_SCPEREN2_gt_pclk_ao_gpio7_END       (18)
#define SOC_SCTRL_SCPEREN2_gt_pclk_ao_gpio8_START     (19)
#define SOC_SCTRL_SCPEREN2_gt_pclk_ao_gpio8_END       (19)
#define SOC_SCTRL_SCPEREN2_gt_clk_mdm2aspcodec_START  (20)
#define SOC_SCTRL_SCPEREN2_gt_clk_mdm2aspcodec_END    (20)
...
#endif
#define SOC_SCTRL_SCPERDIS2_gt_pclk_ao_gpio6_START     (17)
#define SOC_SCTRL_SCPERDIS2_gt_pclk_ao_gpio6_END       (17)
#define SOC_SCTRL_SCPERDIS2_gt_pclk_ao_gpio7_START     (18)
#define SOC_SCTRL_SCPERDIS2_gt_pclk_ao_gpio7_END       (18)
#define SOC_SCTRL_SCPERDIS2_gt_pclk_ao_gpio8_START     (19)
#define SOC_SCTRL_SCPERDIS2_gt_pclk_ao_gpio8_END       (19)
#define SOC_SCTRL_SCPERDIS2_gt_clk_mdm2aspcodec_START  (20)
#define SOC_SCTRL_SCPERDIS2_gt_clk_mdm2aspcodec_END    (20)


/*****************************************************************************
 结构名    : SOC_SCTRL_SCPERCLKEN2_UNION
 结构说明  : SCPERCLKEN2 寄存器结构定义。地址偏移量:0x198，初值:0xFFFFFFFF，宽度:32
 寄存器说明: 外设时钟使能状态寄存器2。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  reserved_0          : 17; /* bit[0-16] : 外设时钟状态：
                                                               0：时钟禁止；
                                                               1：时钟使能。 */
        unsigned int  gt_pclk_ao_gpio6    : 1;  /* bit[17]   : 含义同bit0。 */
        unsigned int  gt_pclk_ao_gpio7    : 1;  /* bit[18]   : 含义同bit0。 */
...
#endif
#define SOC_SCTRL_SCPERCLKEN2_gt_pclk_ao_gpio6_START     (17)
#define SOC_SCTRL_SCPERCLKEN2_gt_pclk_ao_gpio6_END       (17)
#define SOC_SCTRL_SCPERCLKEN2_gt_pclk_ao_gpio7_START     (18)
#define SOC_SCTRL_SCPERCLKEN2_gt_pclk_ao_gpio7_END       (18)
#define SOC_SCTRL_SCPERCLKEN2_gt_pclk_ao_gpio8_START     (19)
#define SOC_SCTRL_SCPERCLKEN2_gt_pclk_ao_gpio8_END       (19)
#define SOC_SCTRL_SCPERCLKEN2_gt_clk_mdm2aspcodec_START  (20)
#define SOC_SCTRL_SCPERCLKEN2_gt_clk_mdm2aspcodec_END    (20)


/*****************************************************************************
 结构名    : SOC_SCTRL_SCPERSTAT2_UNION
 结构说明  : SCPERSTAT2 寄存器结构定义。地址偏移量:0x19C，初值:0x00000C4F，宽度:32
 寄存器说明: 外设时钟最终状态寄存器2。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  reserved : 32; /* bit[0-31]: [20]:st_clk_mdm2aspcodec
                                                   [19]:st_pclk_ao_gpio8
                                                   [18]:st_pclk_ao_gpio7
                                                   [17]:st_pclk_ao_gpio6
                                                   [16]:asp_sw2mdmpll1
                                                   [15]:asp_sw2mdmpll0
                                                   [14]:reset_dram_n Dallas不使用
                                                   [13]:st_clk_autodiv_aobus_fll
                                                   [12]:st_clk_autodiv_aobus
...
/*****************************************************************************
 ...
 结构说明  : SCPERSTAT3 寄存器结构定义。地址偏移量:0x1A0，初值:0x00000002，宽度:32
 寄存器说明: 外设时钟最终状态寄存器3。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  reserved : 32; /* bit[0-31]: [4]：autodiv_fll_stat default:0x0 "aobus_noc_fll自动降频状态指示
                                                   0:不降频；
                                                   1：处于降频；"
                                                   [3]:autodiv_aobus_stat default:0x0 "aobus_noc自动降频状态指示
                                                   0:不降频；
                                                   1：处于降频；"
                                                   [2]:st_aclk_mmbuf default:0x0 "aclk_mmbuf自动门控和投票后的最终状态:
                                                   0:关闭；
                                                   1：打开；"
                                                   [1]:st_clk_noc_aobus2sysbusddrc default:0x1 "clk_noc_aobus2sysbusddrc自动门控和投票后的最终状态;
                                                   0:关闭；
                                                   1：打开；"
                                                   [0]:noc_aobus_idle_flag default:0x0 "aobus的idle flag信号:
                                                   0:aobus no idle;
                                                   1:aobus idle."
                                                   其他：保留。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : SCPERCLKEN3 寄存器结构定义。地址偏移量:0x1A4，初值:0x00000000，宽度:32
 寄存器说明: 外设时钟使能寄存器3。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  gt_clk_mmbuf_pending_en                  : 1;  /* bit[0]   : clk_mmbuf根据总线pending信号sc_noc_aobus_idle_flag自动关闭
                                                                                   0：disable
                                                                                   1：enable。 */
        unsigned int  sc_aonoc_asp_mst_i_mainnopendingtrans_bp : 1;  /* bit[1]   : sc_aonoc_asp_mst_i_mainnopendingtrans bypass
                                                                                   1:bypass;
...
#endif
#define SOC_SCTRL_SCPERCLKEN3_gt_clk_mmbuf_pending_en_START                   (0)
#define SOC_SCTRL_SCPERCLKEN3_gt_clk_mmbuf_pending_en_END                     (0)
...
/*****************************************************************************
 ...
 结构说明  : SCPERRSTSTAT0 寄存器结构定义。地址偏移量:0x208，初值:0x04000780，宽度:32
 寄存器说明: 外设软复位状态寄存器0。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  ip_rst_ao_gpio6   : 1;  /* bit[13]   : 含义同bit0。 */
        unsigned int  ip_rst_ao_gpio7   : 1;  /* bit[14]   : 含义同bit0。 */
        unsigned int  ip_rst_ao_gpio8   : 1;  /* bit[15]   : 含义同bit0。 */
        unsigned int  ip_rst_dram_tmp_0 : 2;  /* bit[16-17]: dram复位配置，DALLAS不使用
                                                             0：无操作
                                                             1：对SCPERRSTSTAT1.ip_rst_dram_tmp_0对应bit置1。 */
        unsigned int  reserved_5        : 14; /* bit[18-31]: 保留。 */
    } reg;
...
#define SOC_SCTRL_SCPERRSTEN1_ip_rst_ao_gpio6_START    (13)
#define SOC_SCTRL_SCPERRSTEN1_ip_rst_ao_gpio6_END      (13)
#define SOC_SCTRL_SCPERRSTEN1_ip_rst_ao_gpio7_START    (14)
#define SOC_SCTRL_SCPERRSTEN1_ip_rst_ao_gpio7_END      (14)
#define SOC_SCTRL_SCPERRSTEN1_ip_rst_ao_gpio8_START    (15)
#define SOC_SCTRL_SCPERRSTEN1_ip_rst_ao_gpio8_END      (15)
...
#define SOC_SCTRL_SCPERRSTDIS1_ip_rst_ao_gpio6_START    (13)
#define SOC_SCTRL_SCPERRSTDIS1_ip_rst_ao_gpio6_END      (13)
#define SOC_SCTRL_SCPERRSTDIS1_ip_rst_ao_gpio7_START    (14)
#define SOC_SCTRL_SCPERRSTDIS1_ip_rst_ao_gpio7_END      (14)
#define SOC_SCTRL_SCPERRSTDIS1_ip_rst_ao_gpio8_START    (15)
#define SOC_SCTRL_SCPERRSTDIS1_ip_rst_ao_gpio8_END      (15)
...
/*****************************************************************************
 ...
 结构说明  : SCPERRSTSTAT1 寄存器结构定义。地址偏移量:0x214，初值:0x00001805，宽度:32
 寄存器说明: 外设软复位状态寄存器1。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
#define SOC_SCTRL_SCPERRSTSTAT1_ip_rst_ao_gpio6_START    (13)
#define SOC_SCTRL_SCPERRSTSTAT1_ip_rst_ao_gpio6_END      (13)
#define SOC_SCTRL_SCPERRSTSTAT1_ip_rst_ao_gpio7_START    (14)
#define SOC_SCTRL_SCPERRSTSTAT1_ip_rst_ao_gpio7_END      (14)
#define SOC_SCTRL_SCPERRSTSTAT1_ip_rst_ao_gpio8_START    (15)
#define SOC_SCTRL_SCPERRSTSTAT1_ip_rst_ao_gpio8_END      (15)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  softrst_dram_dis  : 1;  /* bit[4]   : dram复位配置使能,DALLAS不使用
                                                            0：无操作
...
/*****************************************************************************
 ...
 结构说明  : SCIPCLKRSTBUS 寄存器结构定义。地址偏移量:0x240，初值:0x00000000，宽度:32
 寄存器说明: IP防总线挂死控制寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  rst_gt_gpio6_bypass  : 1;  /* bit[25]   : 含义同bit0。 */
        unsigned int  rst_gt_gpio7_bypass  : 1;  /* bit[26]   : 含义同bit0。 */
        unsigned int  rst_gt_gpio8_bypass  : 1;  /* bit[27]   : 含义同bit0。 */
...
#define SOC_SCTRL_SCIPCLKRSTBUS_rst_gt_gpio7_bypass_START   (26)
#define SOC_SCTRL_SCIPCLKRSTBUS_rst_gt_gpio7_bypass_END     (26)
#define SOC_SCTRL_SCIPCLKRSTBUS_rst_gt_gpio8_bypass_START   (27)
#define SOC_SCTRL_SCIPCLKRSTBUS_rst_gt_gpio8_bypass_END     (27)


/*****************************************************************************
 结构名    : SOC_SCTRL_SCCLKDIV0_UNION
 结构说明  : SCCLKDIV0 寄存器结构定义。地址偏移量:0x250，初值:0x00000202，宽度:32
 寄存器说明: 时钟分频比控制寄存器0。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  sc_clk_asp_pll_sel : 1;  /* bit[11]   : 保留。 ASP 主时钟选择FLL还是PPLL0，先用这bit吧
                                                              0:PPLL0
                                                              1:FPLL。 */
        unsigned int  reserved_0         : 1;  /* bit[12]   : MMBUF备份400MHz选择
                                                              0:PPLL0
                                                              1:备份400MHz。 */
        unsigned int  reserved_1         : 1;  /* bit[13]   : memrep时钟选择
                                                              0:19.2Mhz
                                                              1:40MHz。 */
        unsigned int  sc_sel_aspcodec    : 1;  /* bit[14]   : aspcodec时钟选择
                                                              0：clk_modem_base
                                                              1：备份49.152Mhz(ppll0为1228.8M进行25分频）。 */
...
#define SOC_SCTRL_SCCLKDIV0_sc_sel_aspcodec_START     (14)
#define SOC_SCTRL_SCCLKDIV0_sc_sel_aspcodec_END       (14)
...
/*****************************************************************************
 ...
 结构说明  : SCCLKDIV1 寄存器结构定义。地址偏移量:0x254，初值:0x00000017，宽度:32
 寄存器说明: 时钟分频比控制寄存器1。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : SCCLKDIV2 寄存器结构定义。地址偏移量:0x258，初值:0x00003FFF，宽度:32
 寄存器说明: 时钟分频比控制寄存器2。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : SCCLKDIV4 寄存器结构定义。地址偏移量:0x260，初值:0x00008DE5，宽度:32
 寄存器说明: 时钟分频比控制寄存器4。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  gt_aobus_noc_ini  : 1;  /* bit[6]    : aobus ppll0输出门控
                                                             0：时钟关闭；
                                                             1：时钟开启。 */
        unsigned int  gt_ppll0_aspcodec : 1;  /* bit[7]    : aspcodec分频前时钟门控
                                                             0：时钟关闭
                                                             1：时钟打开。 */
        unsigned int  sc_div_asp_hclk   : 2;  /* bit[8-9]  : asp hclk分频比。(源时钟为clk_asp_subsys)
                                                             ...
                                                             2'h2:3；
                                                             2'h3:4。 */
        unsigned int  reserved_0        : 1;  /* bit[10]   : clk memrep pll输出门控。 */
        unsigned int  reserved_1        : 5;  /* bit[11-15]: clk memrep pll输出分频
...
#define SOC_SCTRL_SCCLKDIV4_gt_ppll0_aspcodec_START  (7)
#define SOC_SCTRL_SCCLKDIV4_gt_ppll0_aspcodec_END    (7)
...
/*****************************************************************************
 ...
 结构说明  : SCCLKDIV5 寄存器结构定义。地址偏移量:0x264，初值:0x000003FF，宽度:32
 寄存器说明: 时钟分频比控制寄存器5。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : SCPERCTRL0 寄存器结构定义。地址偏移量:0x300，初值:0x00000C9B，宽度:32
 寄存器说明: 外设控制寄存器0。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : SCPERCTRL1 寄存器结构定义。地址偏移量:0x304，初值:0x00000000，宽度:32
 寄存器说明: 外设控制寄存器1。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  rst_32k_timer_on  : 1;  /* bit[5]   : bbp on区32K计数器的软复位信号
                                                            1'b1:复位
                                                            1'b0:解除复位 */
        unsigned int  bbp_on_ctrl       : 26; /* bit[6-31]: 保留。 */
    } reg;
} SOC_SCTRL_SCPERCTRL1_UNION;
#endif
#define SOC_SCTRL_SCPERCTRL1_rst_apb_bbp_on_START     (0)
#define SOC_SCTRL_SCPERCTRL1_rst_apb_bbp_on_END       (0)
#define SOC_SCTRL_SCPERCTRL1_rst_19m_bbp_on_START     (1)
#define SOC_SCTRL_SCPERCTRL1_rst_19m_bbp_on_END       (1)
#define SOC_SCTRL_SCPERCTRL1_rst_32k_bbp_on_START     (2)
#define SOC_SCTRL_SCPERCTRL1_rst_32k_bbp_on_END       (2)
#define SOC_SCTRL_SCPERCTRL1_rst_104m_gbbp1_on_START  (3)
#define SOC_SCTRL_SCPERCTRL1_rst_104m_gbbp1_on_END    (3)
#define SOC_SCTRL_SCPERCTRL1_rst_104m_gbbp2_on_START  (4)
#define SOC_SCTRL_SCPERCTRL1_rst_104m_gbbp2_on_END    (4)
#define SOC_SCTRL_SCPERCTRL1_rst_32k_timer_on_START   (5)
#define SOC_SCTRL_SCPERCTRL1_rst_32k_timer_on_END     (5)
#define SOC_SCTRL_SCPERCTRL1_bbp_on_ctrl_START        (6)
#define SOC_SCTRL_SCPERCTRL1_bbp_on_ctrl_END          (31)


/*****************************************************************************
 结构名    : SOC_SCTRL_SCPERCTRL2_UNION
 结构说明  : SCPERCTRL2 寄存器结构定义。地址偏移量:0x308，初值:0x00000715，宽度:32
 寄存器说明: 外设控制寄存器2。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : SCPERCTRL3 寄存器结构定义。地址偏移量:0x30C，初值:0x00004000，宽度:32
 寄存器说明: 外设控制寄存器3。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  reserved_0               : 1;  /* bit[0]    : 通过AHB进行DEBUG功能选择：
                                                                    0：AHB端口不能访问SRAM；
                                                                    1：AHB端口可以访问SRAM。 */
        unsigned int  reserved_1               : 1;  /* bit[1]    : reset_memrep_msk
                                                                    0:bisr复位后更新repair_frm_efu
                                                                    1:bisr复位后不更新repair_frm_efu。 */
        unsigned int  reserved_2               : 1;  /* bit[2]    : 1'b0:非IDDQ模式
                                                                    1'b1:BISR控制EFUSE进入IDDQ模式。 */
        unsigned int  reserved_3               : 1;  /* bit[3]    : 指示修复数据来源SRAM：
                                                                    1'b0:修复数据来源EFUSE；
                                                                    1'b1:修复数据来源SRAM。 */
        unsigned int  reserved_4               : 1;  /* bit[4]    : 指示修复数据来源EFUSE：
                                                                    1'b0:
                                                                    1'b1:修复数据来源EFUSE
                                                                    该信号在reset_memrep_n信号的上升沿自动变为1。 */
        unsigned int  reserved_5               : 3;  /* bit[5-7]  : 控制内部双端口RAM POWER,具体参考memory手册。 */
        ...
        unsigned int  sleep_mode_lpmcu_bypass  : 1;  /* bit[11]   : 1'b0:sleepmode有效时关时钟
                                                                    1'b1:sleepmode有效时不关时钟。 */
        unsigned int  reserved_6               : 1;  /* bit[12]   : ao区memroy修复数据屏蔽保护,此bit需要在suspend流程配置为1'b1
        ...
        unsigned int  reserved_8               : 16; /* bit[16-31]: 保留。 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  ddr_ret_en : 1;  /* bit[0]    : 配置DDRPHY进入Retention模式的控制信号，4个通道单独控制；
                                                      1'b0：ret无效。
                                                      1'b1：ret有效。 */
        unsigned int  reserved_0 : 3;  /* bit[1-3]  : 保留。 */
        unsigned int  reserved_1 : 1;  /* bit[4]    : xo_mode_a2d 信号指示当前32K来源是19.2MHz/586 还是32768Hz，
                                                      0表示19.2MHz/586，
                                                      1表示32768Hz;
                                                      注意：软件不允许配置此bit。 */
...
#define SOC_SCTRL_SCPERCTRL4_ddr_ret_en_END    (0)
...
/*****************************************************************************
 ...
 结构说明  : SCPERCTRL5 寄存器结构定义。地址偏移量:0x314，初值:0x00101003，宽度:32
 寄存器说明: 外设控制寄存器5。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : SCPERCTRL6 寄存器结构定义。地址偏移量:0x318，初值:0x00000000，宽度:32
 寄存器说明: 外设控制寄存器6。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_3             : 1;  /* bit[20]   : 由原始中断cfg_ispa7_dbgen_dx和mask位reserved相与后确定，含义如下：
                                                                  0:no int;
                                                                  1:int produced。 */
        unsigned int  reserved_4             : 1;  /* bit[21]   : 由原始中断bbdrx_timeout_dbg_info和mask位相与后确定，含义如下：
                                                                  0:no int;
                                                                  1:int produced。 */
        unsigned int  reserved_5             : 1;  /* bit[22]   : 由原始中断reserved和mask位bbp_on_state相与后确定，含义如下：
                                                                  0:no int;
                                                                  1:int produced。 */
        unsigned int  reserved_6             : 1;  /* bit[23]   : 由原始中断tp_a2_grp和mask位ao_hpm_opc相与后确定，含义如下：
                                                                  0:no int;
                                                                  1:int produced。 */
...
/*****************************************************************************
 ...
 结构说明  : SCPERCTRL7 寄存器结构定义。地址偏移量:0x31C，初值:0x0000000C，宽度:32
 寄存器说明: 外设控制寄存器7。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  reserved              : 2;  /* bit[0-1]  : reserved。 */
        ...
        unsigned int  scperctrl7            : 12; /* bit[4-15] : 保留。 */
...
/*****************************************************************************
 ...
 结构说明  : SCPERCTRL8 寄存器结构定义。地址偏移量:0x320，初值:0x00000007，宽度:32
 寄存器说明: 外设控制寄存器8，控制信号由SCTRL内部逻辑产生的状态输出控制。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  rst_gt_gpio6 : 1;  /* bit[0]   : 防挂死状态
                                                       0：防挂死功能有效
                                                       1：防挂死功能无效 */
        unsigned int  rst_gt_gpio7 : 1;  /* bit[1]   : 含义同bit0。 */
        unsigned int  rst_gt_gpio8 : 1;  /* bit[2]   : 含义同bit0。 */
        unsigned int  reserved     : 29; /* bit[3-31]: 保留。 */
    } reg;
} SOC_SCTRL_SCPERCTRL8_UNION;
#endif
#define SOC_SCTRL_SCPERCTRL8_rst_gt_gpio6_START  (0)
#define SOC_SCTRL_SCPERCTRL8_rst_gt_gpio6_END    (0)
#define SOC_SCTRL_SCPERCTRL8_rst_gt_gpio7_START  (1)
#define SOC_SCTRL_SCPERCTRL8_rst_gt_gpio7_END    (1)
#define SOC_SCTRL_SCPERCTRL8_rst_gt_gpio8_START  (2)
#define SOC_SCTRL_SCPERCTRL8_rst_gt_gpio8_END    (2)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  bbp_apb_bus_slv_stat : 1;  /* bit[30]   : bbp_apb_bus_slv_stat
                                                                apb时钟域的复位状态
                                                                1'b1:处于解复位状态
                                                                1'b0：处于复位状态。 */
        unsigned int  reserved             : 1;  /* bit[31]   : 保留。 */
...
typedef union
{
    ...
    struct
    {
        unsigned int  reserved : 32; /* bit[0-31]: memory repair模块err指示。 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  reserved : 32; /* bit[0-31]: 各bit对应1路MRB：
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_0         : 1;  /* bit[20]   : reserved目前未使用。 */
        unsigned int  reserved_1         : 1;  /* bit[21]   : reserved目前未使用。 */
        unsigned int  reserved_2         : 1;  /* bit[22]   : reserved0:no int 1:int occur 。 */
        unsigned int  reserved_3         : 1;  /* bit[23]   : reserved目前未使用。 */
        unsigned int  reserved_4         : 1;  /* bit[24]   : [0]:repair_start_point_err
                                                              指示启动修复是否从状态机的idle态开始：
                                                              0：是；
                                                              1：否（发起修复启动错误）。 */
        unsigned int  reserved_5         : 1;  /* bit[25]   : 指示修复时从EFUSE/SRAM的数据包是否全0：
                                                              0：非全0；
                                                              1：全0（数据包错误）。 */
        unsigned int  reserved_6         : 1;  /* bit[26]   : 指示该次修复过程是否完成：
                                                              0：该次修复过程没有结束；
                                                              1：该次修复过程结束。 */
...
/*****************************************************************************
 ...
 结构说明  : SCPERSTATUS6 寄存器结构定义。地址偏移量:0x378，初值:0x00020000，宽度:32
 寄存器说明: 外设状态寄存器6。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
typedef union
{
    ...
    struct
    {
        unsigned int  reserved : 32; /* bit[0-31]: 每1bit对应1路MRB，指示MRB是否修复修复完成(没有启动修复也认为是一种修复完成)：
                                                   0：该MRB修复没有完成；
                                                   1：该MRB修复完成。
                                                   [31:19]为预留位。 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  reserved : 32; /* bit[0-31]: [2:0]->MRB0,[5:3]->MRB1,…,{repair_data_err1[0],[31:30]}->MRB10。每组含义：
                                                   000：数据正常；
...
typedef union
{
    ...
    struct
    {
        unsigned int  reserved : 32; /* bit[0-31]: [3:1]->MRB11,[6:4]->MRB12,…,[30:28]->MRB20。每组含义：
                                                   000：数据正常；
                                                   001：期望收到压缩数据包，但收到了非压缩数据包；
                                                   010：期望收到非压缩数据包，但收到了压缩数据包；
                                                   011：收到的数据解压后，bit流长度小于对应MRB期望的bit流长度；
...
typedef union
{
    ...
    struct
    {
        unsigned int  reserved : 32; /* bit[0-31]: {[1:0],repair_data_err1[31]}->MRB21,[4:2]->MRB22,…,[31:29]->MRB31。每组含义：
                                                   000：数据正常；
                                                   001：期望收到压缩数据包，但收到了非压缩数据包；
                                                   010：期望收到非压缩数据包，但收到了压缩数据包；
                                                   011：收到的数据解压后，bit流长度小于对应MRB期望的bit流长度；
...
typedef union
{
    ...
    struct
    {
        unsigned int  reserved : 32; /* bit[0-31]: 每bit对应1路MRB，指示该MRB是否有输出bit1(该MRB有坏点)。
                                                   0：没有坏点；
                                                   1：有坏点。 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  reserved : 32; /* bit[0-31]: 没bit对应1路MRB，指示该MRB是否真实的启动了修复(MRB0/1/2还有硬件控制)。
                                                   0：可以修复；
                                                   1：禁止修复。 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned int  bbp_on_state : 32; /* bit[0-31]: 保留。 */
    } reg;
} SOC_SCTRL_SCPERSTATUS14_UNION;
#endif
#define SOC_SCTRL_SCPERSTATUS14_bbp_on_state_START  (0)
#define SOC_SCTRL_SCPERSTATUS14_bbp_on_state_END    (31)


/*****************************************************************************
 结构名    : SOC_SCTRL_SCINNERSTAT_UNION
 结构说明  : SCINNERSTAT 寄存器结构定义。地址偏移量:0x3A0，初值:0x02E00000，宽度:32
 寄存器说明: 内部状态寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  reserved_0           : 1;  /* bit[0]    : Memory repair bypass信号状态，来自efuse。 */
        ...
        unsigned int  factest_mode         : 2;  /* bit[2-3]  : FACTEST_MODE[1:0]=
                                                                ...
                                                                2'b01: FAC_TEST。 */
        unsigned int  reserved_1           : 10; /* bit[4-13] : Memory repair bypass hardware信号状态，启动和gpu相关，来自efuse。 */
        ...
        unsigned int  vote_clk_gt_sel_flag : 7;  /* bit[19-25]: [25:24]:sel_clk_aobus_noc
                                                                ...
                                                                0：时钟关闭；
                                                                1：时钟开启。
                                                                最终配置值由iomcu，audio和此配置位投票确定，有需求打开就时钟，所有请求都关闭才关闭时钟；DALLAS不使用投票。
                                                                [19]:gt_clk_mmbuf
                                                                mmbuf pll分频前时钟门控配置：
                                                                0：时钟关闭；
                                                                1：时钟开启。
...
/*****************************************************************************
 ...
 结构说明  : SCINNERCTRL 寄存器结构定义。地址偏移量:0x3B0，初值:0x00000001，宽度:32
 寄存器说明: 内部使用的配置寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : SCTIMERCTRL0 寄存器结构定义。地址偏移量:0x3C0，初值:0x00000000，宽度:32
 寄存器说明: 系统TIMER时钟选择和控制寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  mdmtimer_stop_dbg_bp : 1;  /* bit[1]    : modem timer auto stop in modem cpu debug bypass
                                                                0:modem timer auto stop in modem cpu debug
                                                                1:modem timer not auto stop in modem cpu debug。 */
        unsigned int  timeren0ov           : 1;  /* bit[2]    : Timer0时钟使能控制。
                                                                0：使能信号通过采样参考时钟得到，参考时钟的选择由[timeren0sel]指定；
                                                                1：使能信号被强制拉高。 */
        unsigned int  timeren0sel          : 1;  /* bit[3]    : Time0时钟使能参考时钟选择。
                                                                0：选择32.768kHz睡眠时钟作为参考时钟计数；
                                                                1：选择TCXO时钟的4分频时钟作为参考时钟计数。 */
        unsigned int  timeren1ov           : 1;  /* bit[4]    : Timer1时钟使能控制。
                                                                0：使能信号通过采样参考时钟得到，参考时钟的选择由[timeren1sel]指定；
                                                                1：使能信号被强制拉高。 */
        unsigned int  timeren1sel          : 1;  /* bit[5]    : Time1时钟使能参考时钟选择。
                                                                0：选择32.768kHz睡眠时钟作为参考时钟计数；
                                                                1：选择TCXO时钟的4分频时钟作为参考时钟计数。 */
        unsigned int  timeren4ov           : 1;  /* bit[6]    : Timer4时钟使能控制。
                                                                0：使能信号通过采样参考时钟得到，参考时钟的选择由[timeren4sel]指定；
                                                                1：使能信号被强制拉高。 */
        unsigned int  timeren4sel          : 1;  /* bit[7]    : Time4时钟使能参考时钟选择。
                                                                0：选择32.768kHz睡眠时钟作为参考时钟计数；
                                                                1：选择TCXO时钟的4分频时钟作为参考时钟计数。 */
        unsigned int  timeren5ov           : 1;  /* bit[8]    : Timer5时钟使能控制。
                                                                0：使能信号通过采样参考时钟得到，参考时钟的选择由[timeren5sel]指定；
                                                                1：使能信号被强制拉高。 */
        unsigned int  timeren5sel          : 1;  /* bit[9]    : Time5时钟使能参考时钟选择。
                                                                0：选择32.768kHz睡眠时钟作为参考时钟计数；
                                                                1：选择TCXO时钟的4分频时钟作为参考时钟计数。 */
        unsigned int  timeren6ov           : 1;  /* bit[10]   : Timer6时钟使能控制。
                                                                0：使能信号通过采样参考时钟得到，参考时钟的选择由[timeren6sel]指定；
                                                                1：使能信号被强制拉高。 */
        unsigned int  timeren6sel          : 1;  /* bit[11]   : Time6时钟使能参考时钟选择。
                                                                0：选择32.768kHz睡眠时钟作为参考时钟计数；
                                                                1：选择TCXO时钟的4分频时钟作为参考时钟计数。 */
        unsigned int  timeren7ov           : 1;  /* bit[12]   : Timer7时钟使能控制。
                                                                0：使能信号通过采样参考时钟得到，参考时钟的选择由[timeren7sel]指定；
                                                                1：使能信号被强制拉高。 */
        unsigned int  timeren7sel          : 1;  /* bit[13]   : Time7时钟使能参考时钟选择。
                                                                0：选择32.768kHz睡眠时钟作为参考时钟计数；
                                                                1：选择TCXO时钟的4分频时钟作为参考时钟计数。 */
        unsigned int  reserved             : 18; /* bit[14-31]: 保留。 */
    } reg;
...
#define SOC_SCTRL_SCTIMERCTRL0_timeren0ov_START            (2)
#define SOC_SCTRL_SCTIMERCTRL0_timeren0ov_END              (2)
#define SOC_SCTRL_SCTIMERCTRL0_timeren0sel_START           (3)
#define SOC_SCTRL_SCTIMERCTRL0_timeren0sel_END             (3)
#define SOC_SCTRL_SCTIMERCTRL0_timeren1ov_START            (4)
#define SOC_SCTRL_SCTIMERCTRL0_timeren1ov_END              (4)
#define SOC_SCTRL_SCTIMERCTRL0_timeren1sel_START           (5)
#define SOC_SCTRL_SCTIMERCTRL0_timeren1sel_END             (5)
#define SOC_SCTRL_SCTIMERCTRL0_timeren4ov_START            (6)
#define SOC_SCTRL_SCTIMERCTRL0_timeren4ov_END              (6)
#define SOC_SCTRL_SCTIMERCTRL0_timeren4sel_START           (7)
#define SOC_SCTRL_SCTIMERCTRL0_timeren4sel_END             (7)
#define SOC_SCTRL_SCTIMERCTRL0_timeren5ov_START            (8)
#define SOC_SCTRL_SCTIMERCTRL0_timeren5ov_END              (8)
#define SOC_SCTRL_SCTIMERCTRL0_timeren5sel_START           (9)
#define SOC_SCTRL_SCTIMERCTRL0_timeren5sel_END             (9)
#define SOC_SCTRL_SCTIMERCTRL0_timeren6ov_START            (10)
#define SOC_SCTRL_SCTIMERCTRL0_timeren6ov_END              (10)
#define SOC_SCTRL_SCTIMERCTRL0_timeren6sel_START           (11)
#define SOC_SCTRL_SCTIMERCTRL0_timeren6sel_END             (11)
#define SOC_SCTRL_SCTIMERCTRL0_timeren7ov_START            (12)
#define SOC_SCTRL_SCTIMERCTRL0_timeren7ov_END              (12)
#define SOC_SCTRL_SCTIMERCTRL0_timeren7sel_START           (13)
#define SOC_SCTRL_SCTIMERCTRL0_timeren7sel_END             (13)
...
#endif
#define SOC_SCTRL_SCTIMERCTRL1_timeren8ov_START    (0)
#define SOC_SCTRL_SCTIMERCTRL1_timeren8ov_END      (0)
#define SOC_SCTRL_SCTIMERCTRL1_timeren8sel_START   (1)
#define SOC_SCTRL_SCTIMERCTRL1_timeren8sel_END     (1)
#define SOC_SCTRL_SCTIMERCTRL1_timeren9ov_START    (2)
#define SOC_SCTRL_SCTIMERCTRL1_timeren9ov_END      (2)
#define SOC_SCTRL_SCTIMERCTRL1_timeren9sel_START   (3)
#define SOC_SCTRL_SCTIMERCTRL1_timeren9sel_END     (3)
#define SOC_SCTRL_SCTIMERCTRL1_timeren10ov_START   (4)
#define SOC_SCTRL_SCTIMERCTRL1_timeren10ov_END     (4)
#define SOC_SCTRL_SCTIMERCTRL1_timeren10sel_START  (5)
#define SOC_SCTRL_SCTIMERCTRL1_timeren10sel_END    (5)
#define SOC_SCTRL_SCTIMERCTRL1_timeren11ov_START   (6)
#define SOC_SCTRL_SCTIMERCTRL1_timeren11ov_END     (6)
#define SOC_SCTRL_SCTIMERCTRL1_timeren11sel_START  (7)
#define SOC_SCTRL_SCTIMERCTRL1_timeren11sel_END    (7)
#define SOC_SCTRL_SCTIMERCTRL1_timeren12ov_START   (8)
#define SOC_SCTRL_SCTIMERCTRL1_timeren12ov_END     (8)
#define SOC_SCTRL_SCTIMERCTRL1_timeren12sel_START  (9)
#define SOC_SCTRL_SCTIMERCTRL1_timeren12sel_END    (9)
#define SOC_SCTRL_SCTIMERCTRL1_timeren13ov_START   (10)
#define SOC_SCTRL_SCTIMERCTRL1_timeren13ov_END     (10)
#define SOC_SCTRL_SCTIMERCTRL1_timeren13sel_START  (11)
#define SOC_SCTRL_SCTIMERCTRL1_timeren13sel_END    (11)
#define SOC_SCTRL_SCTIMERCTRL1_timeren14ov_START   (12)
#define SOC_SCTRL_SCTIMERCTRL1_timeren14ov_END     (12)
#define SOC_SCTRL_SCTIMERCTRL1_timeren14sel_START  (13)
#define SOC_SCTRL_SCTIMERCTRL1_timeren14sel_END    (13)
#define SOC_SCTRL_SCTIMERCTRL1_timeren15ov_START   (14)
#define SOC_SCTRL_SCTIMERCTRL1_timeren15ov_END     (14)
#define SOC_SCTRL_SCTIMERCTRL1_timeren15sel_START  (15)
#define SOC_SCTRL_SCTIMERCTRL1_timeren15sel_END    (15)
#define SOC_SCTRL_SCTIMERCTRL1_timeren16ov_START   (16)
#define SOC_SCTRL_SCTIMERCTRL1_timeren16ov_END     (16)
#define SOC_SCTRL_SCTIMERCTRL1_timeren16sel_START  (17)
#define SOC_SCTRL_SCTIMERCTRL1_timeren16sel_END    (17)
#define SOC_SCTRL_SCTIMERCTRL1_timeren17ov_START   (18)
#define SOC_SCTRL_SCTIMERCTRL1_timeren17ov_END     (18)
#define SOC_SCTRL_SCTIMERCTRL1_timeren17sel_START  (19)
#define SOC_SCTRL_SCTIMERCTRL1_timeren17sel_END    (19)


/*****************************************************************************
 结构名    : SOC_SCTRL_SC_SECOND_INT_MASK_UNION
 结构说明  : SC_SECOND_INT_MASK 寄存器结构定义。地址偏移量:0x3D0，初值:0x00000000，宽度:32
 寄存器说明: 二级中断屏蔽配置寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  aomcu_ao_noc_mainstatalarm_intmsk          : 1;  /* bit[0]   : aomcu_ao_noc_mainstatalarm_intmsk
                                                                                     0:int msk
                                                                                     1:int enable。 */
        unsigned int  aomcu_ao_noc_mainfault_intmsk              : 1;  /* bit[1]   : aomcu_ao_noc_mainfault_intmsk
                                                                                     0:int msk
                                                                                     1:int enable。 */
        unsigned int  asp_transaction_probe_mainstatalarm_intmsk : 1;  /* bit[2]   : asp_transaction_probe_mainstatalarm_intmsk
                                                                                     0:int msk
                                                                                     1:int enable。 */
        unsigned int  asp_error_probe_observer_mainfault_intmsk  : 1;  /* bit[3]   : asp_error_probe_observer_mainfault_intmsk
                                                                                     0:int msk
                                                                                     1:int enable。 */
        unsigned int  msk_noc_aobus_mmbuf_t_maintimeout          : 1;  /* bit[4]   : msk_noc_aobus_mmbuf_t_maintimeout
                                                                                     0:int msk
                                                                                     1:int enable。 */
        unsigned int  msk_noc_asp_cfg_t_maintimeout              : 1;  /* bit[5]   : msk_noc_asp_cfg_t_maintimeout
                                                                                     0:int msk
                                                                                     1:int enable。 */
        unsigned int  msk_iomcu_ahb_slv_maintimeout              : 1;  /* bit[6]   : msk_iomcu_ahb_slv_maintimeout
                                                                                     0:int msk
                                                                                     1:int enable。 */
        unsigned int  msk_iomcu_apb_slv_maintimeout              : 1;  /* bit[7]   : msk_iomcu_apb_slv_maintimeout
                                                                                     0:int msk
                                                                                     1:int enable。 */
...
#define SOC_SCTRL_SC_SECOND_INT_MASK_msk_noc_aobus_mmbuf_t_maintimeout_START           (4)
#define SOC_SCTRL_SC_SECOND_INT_MASK_msk_noc_aobus_mmbuf_t_maintimeout_END             (4)
#define SOC_SCTRL_SC_SECOND_INT_MASK_msk_noc_asp_cfg_t_maintimeout_START               (5)
#define SOC_SCTRL_SC_SECOND_INT_MASK_msk_noc_asp_cfg_t_maintimeout_END                 (5)
#define SOC_SCTRL_SC_SECOND_INT_MASK_msk_iomcu_ahb_slv_maintimeout_START               (6)
#define SOC_SCTRL_SC_SECOND_INT_MASK_msk_iomcu_ahb_slv_maintimeout_END                 (6)
#define SOC_SCTRL_SC_SECOND_INT_MASK_msk_iomcu_apb_slv_maintimeout_START               (7)
#define SOC_SCTRL_SC_SECOND_INT_MASK_msk_iomcu_apb_slv_maintimeout_END                 (7)
...
typedef union
{
    ...
    struct
    {
        unsigned int  aomcu_ao_noc_mainstatalarm_int          : 1;  /* bit[0]   : aomcu_ao_noc_mainstatalarm_int目前未使用。 */
        unsigned int  aomcu_ao_noc_mainfault_int              : 1;  /* bit[1]   : aomcu_ao_noc_mainfault_int目前未使用。 */
        unsigned int  asp_transaction_probe_mainstatalarm_int : 1;  /* bit[2]   : asp_transaction_probe_mainstatalarm_int。 */
        unsigned int  asp_error_probe_observer_mainfault_int  : 1;  /* bit[3]   : asp_error_probe_observer_mainfault_int目前未使用。 */
        unsigned int  noc_aobus_mmbuf_t_maintimeout           : 1;  /* bit[4]   : noc_aobus_mmbuf_t_maintimeout。 */
...
typedef union
{
    ...
    struct
    {
        unsigned int  aomcu_ao_noc_mainstatalarm_int_msksta          : 1;  /* bit[0]   : 屏蔽后中断。 */
        unsigned int  aomcu_ao_noc_mainfault_int_msksta              : 1;  /* bit[1]   : 屏蔽后中断。 */
        unsigned int  asp_transaction_probe_mainstatalarm_int_msksta : 1;  /* bit[2]   : 屏蔽后中断。 */
        unsigned int  asp_error_probe_observer_mainfault_int_msksta  : 1;  /* bit[3]   : 屏蔽后中断。 */
        unsigned int  noc_aobus_mmbuf_t_maintimeout_msksta           : 1;  /* bit[4]   : 屏蔽后中断。 */
...
/*****************************************************************************
 ...
 结构说明  : SCIOMCUSTAT 寄存器结构定义。地址偏移量:0x58C，初值:0x00000000，宽度:32
 寄存器说明: IOMCU子系统状态寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  iomcu_dma_mst_nopendingtrans_bp : 1;  /* bit[4]    : iomcu_dma_mst_nopendingtrans bypass
                                                                           1:bypass;
                                                                           0:iomcu_dma_mst_nopendingtrans is one input of sc_noc_aobus_idle_flag is AndGate。 */
        unsigned int  iomcu_axi_mst_nopendingtrans_bp : 1;  /* bit[5]    : iomcu_axi_mst_nopendingtrans bypass
                                                                           1:bypass;
                                                                           0:iomcu_axi_mst_nopendingtrans is one input of sc_noc_aobus_idle_flag is AndGate。 */
        unsigned int  iomcu_axi_ahb_nopendingtrans_bp : 1;  /* bit[6]    : iomcu_axi_ahb_nopendingtrans bypass
                                                                           1:bypass;
                                                                           0:iomcu_axi_ahb_nopendingtrans is one input of sc_noc_aobus_idle_flag is AndGate。 */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  dsp_jtag_sel       : 2;  /* bit[1-2] : 10：hifi dsp的JTAG
                                                             01：bbp dsp的JTAG
                                                             11：bbe_dsp_c JTAG。
                                                             00：上面三个dsp的JTAG串联hifi dsp->bbp dsp->bbe_dsp_c。 */
        unsigned int  reserved           : 29; /* bit[3-31]: 保留。 */
    } reg;
...
/*****************************************************************************
 结构名    : SOC_SCTRL_SC_PERI_SEC_CTRL_UNION
 结构说明  : SC_PERI_SEC_CTRL 寄存器结构定义。地址偏移量:0x860，初值:0x00000000，宽度:32
 寄存器说明: 外设安全控制寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  mmbuf_sec_ctrl    : 12; /* bit[20-31]: 安全状态
                                                             ...
                                                             0： disable err resp
                                                             1： enable err resp
                                                             tzpcdecprot5[22] REGION0_IS_SEC(0xea800000~0xea807fff) 0：安全；1：非安全
                                                             tzpcdecprot5[23] REGION1_IS_SEC(0xea808000~0xea80ffff) 0：安全；1：非安全
                                                             tzpcdecprot5[24] REGION2_IS_SEC(0xea810000~0xea817fff) 0：安全；1：非安全
                                                             tzpcdecprot5[25] REGION3_IS_SEC(0xea818000~0xea81ffff) 0：安全；1：非安全
                                                             tzpcdecprot5[26] REGION4_IS_SEC(0xea820000~0xea827fff) 0：安全；1：非安全
                                                             tzpcdecprot5[27] REGION5_IS_SEC(0xea828000~0xea82ffff) 0：安全；1：非安全
                                                             tzpcdecprot5[28] REGION6_IS_SEC(0xea830000~0xea837fff) 0：安全；1：非安全
                                                             tzpcdecprot5[29] REGION7_IS_SEC(0xea838000~0xea847fff) 0：安全；1：非安全
...
typedef union
{
    ...
    struct
    {
        unsigned int  ip_rst_asp_subsys : 1;  /* bit[0]   : 输出控制crg的rsten0_sec[16]
                                                            外设软复位使能状态：
                                                            0：IP软复位使能撤销；
                                                            1：IP软复位使能。 */
        unsigned int  reserved          : 31; /* bit[1-31]: 保留。 */
...
/*****************************************************************************
 ...
 结构说明  : SCSOCID0 寄存器结构定义。地址偏移量:0xE00，初值:0x62500100，宽度:32
 寄存器说明: SOCID寄存器0。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  version_code : 16; /* bit[0-15] : 0x0100是芯片的版本号。
                                                        ASIC使用：TSMC16FF_TSMC_MEM ，默认值为0x62500100
                                                        FPGA使用： FPGA_XILINX ，默认值为 0x62501000
                                                        emulator使用：EMULATOR_VERSION ， 默认值为 0x62502000。 */
        unsigned int  chip_code    : 16; /* bit[16-31]: 0x6250是芯片的编号。 */
    } reg;
