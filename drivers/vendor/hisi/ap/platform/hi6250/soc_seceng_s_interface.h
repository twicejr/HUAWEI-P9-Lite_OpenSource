 ...
 ****************************************************************************/
/* 寄存器说明：This register maps the virtual register R0 to a physical address in memory。
   位域定义UNION结构:  SOC_SECENG_S_MEMORY_MAP0_UNION */
#define SOC_SECENG_S_MEMORY_MAP0_ADDR(base)           ((base) + (0x00000))

/* 寄存器说明：This register maps the virtual register R1 to a physical address in memory。
   位域定义UNION结构:  SOC_SECENG_S_MEMORY_MAP1_UNION */
#define SOC_SECENG_S_MEMORY_MAP1_ADDR(base)           ((base) + (0x00004))

/* 寄存器说明：This register maps the virtual register R2 to a physical address in memory。
   位域定义UNION结构:  SOC_SECENG_S_MEMORY_MAP2_UNION */
#define SOC_SECENG_S_MEMORY_MAP2_ADDR(base)           ((base) + (0x00008))

/* 寄存器说明：This register maps the virtual register R3 to a physical address in memory。
   位域定义UNION结构:  SOC_SECENG_S_MEMORY_MAP3_UNION */
#define SOC_SECENG_S_MEMORY_MAP3_ADDR(base)           ((base) + (0x0000C))

/* 寄存器说明：This register maps the virtual register R4 to a physical address in memory。
   位域定义UNION结构:  SOC_SECENG_S_MEMORY_MAP4_UNION */
#define SOC_SECENG_S_MEMORY_MAP4_ADDR(base)           ((base) + (0x00010))

/* 寄存器说明：This register maps the virtual register R5 to a physical address in memory。
   位域定义UNION结构:  SOC_SECENG_S_MEMORY_MAP5_UNION */
#define SOC_SECENG_S_MEMORY_MAP5_ADDR(base)           ((base) + (0x00014))

/* 寄存器说明：This register maps the virtual register R6 to a physical address in memory。
   位域定义UNION结构:  SOC_SECENG_S_MEMORY_MAP6_UNION */
#define SOC_SECENG_S_MEMORY_MAP6_ADDR(base)           ((base) + (0x00018))

/* 寄存器说明：This register maps the virtual register R7 to a physical address in memory。
   位域定义UNION结构:  SOC_SECENG_S_MEMORY_MAP7_UNION */
#define SOC_SECENG_S_MEMORY_MAP7_ADDR(base)           ((base) + (0x0001C))

/* 寄存器说明：This register maps the virtual register R8 to a physical address in memory。
   位域定义UNION结构:  SOC_SECENG_S_MEMORY_MAP8_UNION */
#define SOC_SECENG_S_MEMORY_MAP8_ADDR(base)           ((base) + (0x00020))

/* 寄存器说明：This register maps the virtual register R9 to a physical address in memory。
   位域定义UNION结构:  SOC_SECENG_S_MEMORY_MAP9_UNION */
#define SOC_SECENG_S_MEMORY_MAP9_ADDR(base)           ((base) + (0x00024))

/* 寄存器说明：This register maps the virtual register R10 to a physical address in memory。
   位域定义UNION结构:  SOC_SECENG_S_MEMORY_MAP10_UNION */
#define SOC_SECENG_S_MEMORY_MAP10_ADDR(base)          ((base) + (0x00028))

/* 寄存器说明：This register maps the virtual register R11 to a physical address in memory。
   位域定义UNION结构:  SOC_SECENG_S_MEMORY_MAP11_UNION */
#define SOC_SECENG_S_MEMORY_MAP11_ADDR(base)          ((base) + (0x0002C))

/* 寄存器说明：This register maps the virtual register R12 to a physical address in memory。
   位域定义UNION结构:  SOC_SECENG_S_MEMORY_MAP12_UNION */
#define SOC_SECENG_S_MEMORY_MAP12_ADDR(base)          ((base) + (0x00030))

/* 寄存器说明：This register maps the virtual register R13 to a physical address in memory。
   位域定义UNION结构:  SOC_SECENG_S_MEMORY_MAP13_UNION */
#define SOC_SECENG_S_MEMORY_MAP13_ADDR(base)          ((base) + (0x00034))

/* 寄存器说明：This register maps the virtual register R14 to a physical address in memory。
   位域定义UNION结构:  SOC_SECENG_S_MEMORY_MAP14_UNION */
#define SOC_SECENG_S_MEMORY_MAP14_ADDR(base)          ((base) + (0x00038))

/* 寄存器说明：This register maps the virtual register R15 to a physical address in memory。
   位域定义UNION结构:  SOC_SECENG_S_MEMORY_MAP15_UNION */
#define SOC_SECENG_S_MEMORY_MAP15_ADDR(base)          ((base) + (0x0003C))

/* 寄存器说明：This register maps the virtual register R16 to a physical address in memory。
   位域定义UNION结构:  SOC_SECENG_S_MEMORY_MAP16_UNION */
#define SOC_SECENG_S_MEMORY_MAP16_ADDR(base)          ((base) + (0x00040))

/* 寄存器说明：This register maps the virtual register R17 to a physical address in memory。
   位域定义UNION结构:  SOC_SECENG_S_MEMORY_MAP17_UNION */
#define SOC_SECENG_S_MEMORY_MAP17_ADDR(base)          ((base) + (0x00044))

/* 寄存器说明：This register maps the virtual register R18 to a physical address in memory。
   位域定义UNION结构:  SOC_SECENG_S_MEMORY_MAP18_UNION */
#define SOC_SECENG_S_MEMORY_MAP18_ADDR(base)          ((base) + (0x00048))

/* 寄存器说明：This register maps the virtual register R19 to a physical address in memory。
   位域定义UNION结构:  SOC_SECENG_S_MEMORY_MAP19_UNION */
#define SOC_SECENG_S_MEMORY_MAP19_ADDR(base)          ((base) + (0x0004C))

/* 寄存器说明：This register maps the virtual register R20 to a physical address in memory。
   位域定义UNION结构:  SOC_SECENG_S_MEMORY_MAP20_UNION */
#define SOC_SECENG_S_MEMORY_MAP20_ADDR(base)          ((base) + (0x00050))

/* 寄存器说明：This register maps the virtual register R21 to a physical address in memory。
   位域定义UNION结构:  SOC_SECENG_S_MEMORY_MAP21_UNION */
#define SOC_SECENG_S_MEMORY_MAP21_ADDR(base)          ((base) + (0x00054))

/* 寄存器说明：This register maps the virtual register R22 to a physical address in memory。
   位域定义UNION结构:  SOC_SECENG_S_MEMORY_MAP22_UNION */
#define SOC_SECENG_S_MEMORY_MAP22_ADDR(base)          ((base) + (0x00058))

/* 寄存器说明：This register maps the virtual register R23 to a physical address in memory。
   位域定义UNION结构:  SOC_SECENG_S_MEMORY_MAP23_UNION */
#define SOC_SECENG_S_MEMORY_MAP23_ADDR(base)          ((base) + (0x0005C))

/* 寄存器说明：This register maps the virtual register R24 to a physical address in memory。
   位域定义UNION结构:  SOC_SECENG_S_MEMORY_MAP24_UNION */
#define SOC_SECENG_S_MEMORY_MAP24_ADDR(base)          ((base) + (0x00060))

/* 寄存器说明：This register maps the virtual register R25 to a physical address in memory。
   位域定义UNION结构:  SOC_SECENG_S_MEMORY_MAP25_UNION */
#define SOC_SECENG_S_MEMORY_MAP25_ADDR(base)          ((base) + (0x00064))

/* 寄存器说明：This register maps the virtual register R26 to a physical address in memory。
   位域定义UNION结构:  SOC_SECENG_S_MEMORY_MAP26_UNION */
#define SOC_SECENG_S_MEMORY_MAP26_ADDR(base)          ((base) + (0x00068))

/* 寄存器说明：This register maps the virtual register R27 to a physical address in memory。
   位域定义UNION结构:  SOC_SECENG_S_MEMORY_MAP27_UNION */
#define SOC_SECENG_S_MEMORY_MAP27_ADDR(base)          ((base) + (0x0006C))

/* 寄存器说明：This register maps the virtual register R28 to a physical address in memory。
   位域定义UNION结构:  SOC_SECENG_S_MEMORY_MAP28_UNION */
#define SOC_SECENG_S_MEMORY_MAP28_ADDR(base)          ((base) + (0x00070))

/* 寄存器说明：This register maps the virtual register R29 to a physical address in memory。
   位域定义UNION结构:  SOC_SECENG_S_MEMORY_MAP29_UNION */
#define SOC_SECENG_S_MEMORY_MAP29_ADDR(base)          ((base) + (0x00074))

/* 寄存器说明：This register maps the virtual register R30 to a physical address in memory。
   位域定义UNION结构:  SOC_SECENG_S_MEMORY_MAP30_UNION */
#define SOC_SECENG_S_MEMORY_MAP30_ADDR(base)          ((base) + (0x00078))

/* 寄存器说明：This register maps the virtual register R31 to a physical address in memory。
   位域定义UNION结构:  SOC_SECENG_S_MEMORY_MAP31_UNION */
#define SOC_SECENG_S_MEMORY_MAP31_ADDR(base)          ((base) + (0x0007C))

/* 寄存器说明：This register holds the PKA's OPCODE。
   位域定义UNION结构:  SOC_SECENG_S_OPCODE_UNION */
#define SOC_SECENG_S_OPCODE_ADDR(base)                ((base) + (0x00080))

/* 寄存器说明：This register maps N_NP_T0_T1 to a virtual address。
   位域定义UNION结构:  SOC_SECENG_S_N_NP_T0_T1_ADDR_UNION */
#define SOC_SECENG_S_N_NP_T0_T1_ADDR_ADDR(base)       ((base) + (0x00084))

/* 寄存器说明：This register holds the PKA pipe status。
   位域定义UNION结构:  SOC_SECENG_S_PKA_STATUS_UNION */
#define SOC_SECENG_S_PKA_STATUS_ADDR(base)            ((base) + (0x00088))

/* 寄存器说明：Writing to this register triggers a software reset of the PKA。
   位域定义UNION结构:  SOC_SECENG_S_PKA_SW_RESET_UNION */
#define SOC_SECENG_S_PKA_SW_RESET_ADDR(base)          ((base) + (0x0008C))

/* 寄存器说明：This register holds the size of the operation。
   位域定义UNION结构:  SOC_SECENG_S_PKA_L0_UNION */
#define SOC_SECENG_S_PKA_L0_ADDR(base)                ((base) + (0x00090))

/* 寄存器说明：This register holds the size of the operation。
   位域定义UNION结构:  SOC_SECENG_S_PKA_L1_UNION */
#define SOC_SECENG_S_PKA_L1_ADDR(base)                ((base) + (0x00094))

/* 寄存器说明：This register holds the size of the operation。
   位域定义UNION结构:  SOC_SECENG_S_PKA_L2_UNION */
#define SOC_SECENG_S_PKA_L2_ADDR(base)                ((base) + (0x00098))

/* 寄存器说明：This register holds the size of the operation。
   位域定义UNION结构:  SOC_SECENG_S_PKA_L3_UNION */
#define SOC_SECENG_S_PKA_L3_ADDR(base)                ((base) + (0x0009C))

/* 寄存器说明：This register holds the size of the operation。
   位域定义UNION结构:  SOC_SECENG_S_PKA_L4_UNION */
#define SOC_SECENG_S_PKA_L4_ADDR(base)                ((base) + (0x000A0))

/* 寄存器说明：This register holds the size of the operation。
   位域定义UNION结构:  SOC_SECENG_S_PKA_L5_UNION */
#define SOC_SECENG_S_PKA_L5_ADDR(base)                ((base) + (0x000A4))

/* 寄存器说明：This register holds the size of the operation。
   位域定义UNION结构:  SOC_SECENG_S_PKA_L6_UNION */
#define SOC_SECENG_S_PKA_L6_ADDR(base)                ((base) + (0x000A8))

/* 寄存器说明：This register holds the size of the operation。
   位域定义UNION结构:  SOC_SECENG_S_PKA_L7_UNION */
#define SOC_SECENG_S_PKA_L7_ADDR(base)                ((base) + (0x000AC))

/* 寄存器说明：This register indicates whether the PKA pipe is ready to receive a new OPCODE。
   位域定义UNION结构:  SOC_SECENG_S_PKA_PIPE_RDY_UNION */
#define SOC_SECENG_S_PKA_PIPE_RDY_ADDR(base)          ((base) + (0x000B0))

/* 寄存器说明：This register indicates whether PKA operation is completed。
   位域定义UNION结构:  SOC_SECENG_S_PKA_DONE_UNION */
#define SOC_SECENG_S_PKA_DONE_ADDR(base)              ((base) + (0x000B4))

/* 寄存器说明：This register defines which PKA FSM monitor is being output。
   位域定义UNION结构:  SOC_SECENG_S_PKA_MON_SELECT_UNION */
#define SOC_SECENG_S_PKA_MON_SELECT_ADDR(base)        ((base) + (0x000B8))

/* 寄存器说明：This register enables/disables all the debug mechanism。
   位域定义UNION结构:  SOC_SECENG_S_PKA_DEBUG_REG_EN_UNION */
#define SOC_SECENG_S_PKA_DEBUG_REG_EN_ADDR(base)      ((base) + (0x000BC))

/* 寄存器说明：This register holds the debug counter's value。
   位域定义UNION结构:  SOC_SECENG_S_DEBUG_CNT_ADDR_UNION */
#define SOC_SECENG_S_DEBUG_CNT_ADDR_ADDR(base)        ((base) + (0x000C0))

/* 寄存器说明：This register indicates whether the PKA is in halt state。
   位域定义UNION结构:  SOC_SECENG_S_PKA_DEBUG_HALT_UNION */
#define SOC_SECENG_S_PKA_DEBUG_HALT_ADDR(base)        ((base) + (0x000C8))

/* 寄存器说明：This register holds the PKA address' offset。
   位域定义UNION结构:  SOC_SECENG_S_PKA_MSB_ADDR_UNION */
#define SOC_SECENG_S_PKA_MSB_ADDR_ADDR(base)          ((base) + (0x000CC))

/* 寄存器说明：This register holds the PKA monitor bus' register output。
   位域定义UNION结构:  SOC_SECENG_S_PKA_MON_READ_UNION */
#define SOC_SECENG_S_PKA_MON_READ_ADDR(base)          ((base) + (0x000D0))

/* 寄存器说明：Interrupt masking register。
   位域定义UNION结构:  SOC_SECENG_S_RNG_IMR_UNION */
#define SOC_SECENG_S_RNG_IMR_ADDR(base)               ((base) + (0x00100))

/* 寄存器说明：Status register。
   位域定义UNION结构:  SOC_SECENG_S_RNG_ISR_UNION */
#define SOC_SECENG_S_RNG_ISR_ADDR(base)               ((base) + (0x00104))

/* 寄存器说明：Interrupt/status bit clear Register。
   位域定义UNION结构:  SOC_SECENG_S_RNG_ICR_UNION */
#define SOC_SECENG_S_RNG_ICR_ADDR(base)               ((base) + (0x00108))

/* 寄存器说明：This register handles TRNG configuration。
   位域定义UNION结构:  SOC_SECENG_S_TRNG_CONFIG_UNION */
#define SOC_SECENG_S_TRNG_CONFIG_ADDR(base)           ((base) + (0x0010C))

/* 寄存器说明：This register indicates that the TRNG data is valid。
   位域定义UNION结构:  SOC_SECENG_S_TRNG_VALID_UNION */
#define SOC_SECENG_S_TRNG_VALID_ADDR(base)            ((base) + (0x00110))

/* 寄存器说明：This register contains the data collected in the TRNG[31_0]。
   位域定义UNION结构:  SOC_SECENG_S_EHR_DATA_0_UNION */
#define SOC_SECENG_S_EHR_DATA_0_ADDR(base)            ((base) + (0x00114))

/* 寄存器说明：This register contains the data collected in the TRNG[63_32]。
   位域定义UNION结构:  SOC_SECENG_S_EHR_DATA_1_UNION */
#define SOC_SECENG_S_EHR_DATA_1_ADDR(base)            ((base) + (0x00118))

/* 寄存器说明：This register contains the data collected in the TRNG[95_64]。
   位域定义UNION结构:  SOC_SECENG_S_EHR_DATA_2_UNION */
#define SOC_SECENG_S_EHR_DATA_2_ADDR(base)            ((base) + (0x0011C))

/* 寄存器说明：This register contains the data collected in the TRNG[127_96]。
   位域定义UNION结构:  SOC_SECENG_S_EHR_DATA_3_UNION */
#define SOC_SECENG_S_EHR_DATA_3_ADDR(base)            ((base) + (0x00120))

/* 寄存器说明：This register contains the data collected in the TRNG[159_128]。
   位域定义UNION结构:  SOC_SECENG_S_EHR_DATA_4_UNION */
#define SOC_SECENG_S_EHR_DATA_4_ADDR(base)            ((base) + (0x00124))

/* 寄存器说明：This register contains the data collected in the TRNG[191_160]。
   位域定义UNION结构:  SOC_SECENG_S_EHR_DATA_5_UNION */
#define SOC_SECENG_S_EHR_DATA_5_ADDR(base)            ((base) + (0x00128))

/* 寄存器说明：This register holds the enable signal for the random source。
   位域定义UNION结构:  SOC_SECENG_S_RND_SOURCE_ENABLE_UNION */
#define SOC_SECENG_S_RND_SOURCE_ENABLE_ADDR(base)     ((base) + (0x0012C))

/* 寄存器说明：Counts clocks between sampling of random bit。
   位域定义UNION结构:  SOC_SECENG_S_SAMPLE_CNT1_UNION */
#define SOC_SECENG_S_SAMPLE_CNT1_ADDR(base)           ((base) + (0x00130))

/* 寄存器说明：Statistics about autocorrelation test activations。
   位域定义UNION结构:  SOC_SECENG_S_AUTOCORR_STATISTIC_UNION */
#define SOC_SECENG_S_AUTOCORR_STATISTIC_ADDR(base)    ((base) + (0x00134))

/* 寄存器说明：Debug regsiter
   位域定义UNION结构:  SOC_SECENG_S_TRNG_DEBUG_CONTROL_UNION */
#define SOC_SECENG_S_TRNG_DEBUG_CONTROL_ADDR(base)    ((base) + (0x00138))

/* 寄存器说明：Generate SW reset solely to RNG block。
   位域定义UNION结构:  SOC_SECENG_S_RNG_SW_RESET_UNION */
#define SOC_SECENG_S_RNG_SW_RESET_ADDR(base)          ((base) + (0x00140))

/* 寄存器说明：Defines the RNG in debug mode
   位域定义UNION结构:  SOC_SECENG_S_RNG_DEBUG_EN_INPUT_UNION */
#define SOC_SECENG_S_RNG_DEBUG_EN_INPUT_ADDR(base)    ((base) + (0x001B4))

/* 寄存器说明：RNG busy indication
   位域定义UNION结构:  SOC_SECENG_S_RNG_BUSY_UNION */
#define SOC_SECENG_S_RNG_BUSY_ADDR(base)              ((base) + (0x001B8))

/* 寄存器说明：Resets the counter of collected bits in the TRNG
   位域定义UNION结构:  SOC_SECENG_S_RST_BITS_COUNTER_UNION */
#define SOC_SECENG_S_RST_BITS_COUNTER_ADDR(base)      ((base) + (0x001BC))

/* 寄存器说明：This register holds the RNG version
   位域定义UNION结构:  SOC_SECENG_S_RNG_VERSION_UNION */
#define SOC_SECENG_S_RNG_VERSION_ADDR(base)           ((base) + (0x001C0))

/* 寄存器说明：Writing to this register enables/disables the RNG clock。
   位域定义UNION结构:  SOC_SECENG_S_RNG_CLK_ENABLE_UNION */
#define SOC_SECENG_S_RNG_CLK_ENABLE_ADDR(base)        ((base) + (0x001C4))

/* 寄存器说明：Writing to this register enables/disables the RNG DMA。
   位域定义UNION结构:  SOC_SECENG_S_RNG_DMA_ENABLE_UNION */
#define SOC_SECENG_S_RNG_DMA_ENABLE_ADDR(base)        ((base) + (0x001C8))

/* 寄存器说明：This register defines which ring-oscillator length should be used when using the RNG DMA。
   位域定义UNION结构:  SOC_SECENG_S_RNG_DMA_SRC_MASK_UNION */
#define SOC_SECENG_S_RNG_DMA_SRC_MASK_ADDR(base)      ((base) + (0x001CC))

/* 寄存器说明：This register defines the start address of the DMA for the TRNG data。
   位域定义UNION结构:  SOC_SECENG_S_RNG_DMA_SRAM_ADDR_UNION */
#define SOC_SECENG_S_RNG_DMA_SRAM_ADDR_ADDR(base)     ((base) + (0x001D0))

/* 寄存器说明：This register defines the number of 192-bits samples that the DMA collects per RNG configuration。
   位域定义UNION结构:  SOC_SECENG_S_RNG_DMA_SAMPLES_NUM_UNION */
#define SOC_SECENG_S_RNG_DMA_SAMPLES_NUM_ADDR(base)   ((base) + (0x001D4))

/* 寄存器说明：This register defines the maximum number of clock cycles per TRNG collection of 192 samples。 If the number of cycles for a collection exceeds this threshold, TRNG signals an interrupt。
   位域定义UNION结构:  SOC_SECENG_S_RNG_WATCHDOG_VAL_UNION */
#define SOC_SECENG_S_RNG_WATCHDOG_VAL_ADDR(base)      ((base) + (0x001D8))

/* 寄存器说明：This register holds the RNG DMA status。
   位域定义UNION结构:  SOC_SECENG_S_RNG_DMA_STATUS_UNION */
#define SOC_SECENG_S_RNG_DMA_STATUS_ADDR(base)        ((base) + (0x001DC))

/* 寄存器说明：The AES clock enable register。 NOTE! This is a special register, affected by internal logic。 Test result of this register is NA。
   位域定义UNION结构:  SOC_SECENG_S_AES_CLK_ENABLE_UNION */
...
/* 寄存器说明：The DES clock enable register。 NOTE! This is a special register, affected by internal logic。 Test result of this register is NA。
   位域定义UNION结构:  SOC_SECENG_S_DES_CLK_ENABLE_UNION */
...
/* 寄存器说明：The HASH clock enable register。 NOTE! This is a special register, affected by internal logic。 Test result of this register is NA。
   位域定义UNION结构:  SOC_SECENG_S_HASH_CLK_ENABLE_UNION */
#define SOC_SECENG_S_HASH_CLK_ENABLE_ADDR(base)       ((base) + (0x00818))

/* 寄存器说明：The PKA clock enable register。 NOTE! This is a special register, affected by internal logic。 Test result of this register is NA。
   位域定义UNION结构:  SOC_SECENG_S_PKA_CLK_ENABLE_UNION */
...
/* 寄存器说明：DMA_CLK enable register。 NOTE! This is a special register, affected by internal logic。 Test result of this register is NA。
   位域定义UNION结构:  SOC_SECENG_S_DMA_CLK_ENABLE_UNION */
...
/* 寄存器说明：This register holds the flow ID of the descriptor that caused that last error。
   位域定义UNION结构:  SOC_SECENG_S_HASH_COMPARE_ERR_ID_FIFO0_UNION */
...
/* 寄存器说明：This register holds the flow ID of the descriptor that caused that one-before-last error。
   位域定义UNION结构:  SOC_SECENG_S_HASH_COMPARE_ERR_ID_FIFO1_UNION */
#define SOC_SECENG_S_HASH_COMPARE_ERR_ID_FIFO1_ADDR(base) ((base) + (0x00944))

/* 寄存器说明：This register holds the flow ID of the descriptor that caused that one-before-last error。
   位域定义UNION结构:  SOC_SECENG_S_HASH_COMPARE_ERR_ID_FIFO2_UNION */
#define SOC_SECENG_S_HASH_COMPARE_ERR_ID_FIFO2_ADDR(base) ((base) + (0x00948))

/* 寄存器说明：This register holds the flow ID of the descriptor that caused that one-before-last error。
   位域定义UNION结构:  SOC_SECENG_S_HASH_COMPARE_ERR_ID_FIFO3_UNION */
#define SOC_SECENG_S_HASH_COMPARE_ERR_ID_FIFO3_ADDR(base) ((base) + (0x0094C))

/* 寄存器说明：The Interrupt Request register。 Each bit of this register holds the interrupt status of a single interrupt source。
   位域定义UNION结构:  SOC_SECENG_S_HOST_RGF_IRR_UNION */
#define SOC_SECENG_S_HOST_RGF_IRR_ADDR(base)          ((base) + (0x00A00))

/* 寄存器说明：The Interrupt Mask register. Each bit of this register holds the mask of a single interrupt source.
   位域定义UNION结构:  SOC_SECENG_S_HOST_RGF_IMR_UNION */
#define SOC_SECENG_S_HOST_RGF_IMR_ADDR(base)          ((base) + (0x00A04))

/* 寄存器说明：Interrupt Clear Register。
   位域定义UNION结构:  SOC_SECENG_S_HOST_RGF_ICR_UNION */
#define SOC_SECENG_S_HOST_RGF_ICR_ADDR(base)          ((base) + (0x00A08))

/* 寄存器说明：This register defines the endianness of the Host-accessible registers。
            NOTE! This is a special register, affected by internal logic。 Test result of this register is NA。
   位域定义UNION结构:  SOC_SECENG_S_HOST_RGF_ENDIAN_UNION */
#define SOC_SECENG_S_HOST_RGF_ENDIAN_ADDR(base)       ((base) + (0x00A0C))

/* 寄存器说明：Writing to this register generates a general reset to CryptoCell。 This reset takes about 4 core clock cycles。 NOTE! This is a special register, affected by internal logic。 Test result of this register is NA。
   位域定义UNION结构:  SOC_SECENG_S_HOST_RGF_CC_SW_RST_UNION */
#define SOC_SECENG_S_HOST_RGF_CC_SW_RST_ADDR(base)    ((base) + (0x00A20))

/* 寄存器说明：This register holds the CryptoCell product signature。
   位域定义UNION结构:  SOC_SECENG_S_HOST_RGF_SIGNATURE_UNION */
#define SOC_SECENG_S_HOST_RGF_SIGNATURE_ADDR(base)    ((base) + (0x00A24))

/* 寄存器说明：This register holds the values of CryptoCell's pre-synthesis flags
   位域定义UNION结构:  SOC_SECENG_S_HOST_BOOT_UNION */
#define SOC_SECENG_S_HOST_BOOT_ADDR(base)             ((base) + (0x00A28))

/* 寄存器说明：Provisioning constant mask
   位域定义UNION结构:  SOC_SECENG_S_HOST_PROVISION_CONST_MASK_UNION */
#define SOC_SECENG_S_HOST_PROVISION_CONST_MASK_ADDR(base) ((base) + (0x00A30))

/* 寄存器说明：AES hardware key select
   位域定义UNION结构:  SOC_SECENG_S_HOST_CRYPTOKEY_SEL_UNION */
#define SOC_SECENG_S_HOST_CRYPTOKEY_SEL_ADDR(base)    ((base) + (0x00A38))

/* 寄存器说明：This register defines whether the Host has access to the cry_kernel registers directly (compatibility mode) and not only through the descriptors。 The default value is 0 - no access。
   位域定义UNION结构:  SOC_SECENG_S_HOST_HOST_CRY_ACCESS_EN_UNION */
#define SOC_SECENG_S_HOST_HOST_CRY_ACCESS_EN_ADDR(base) ((base) + (0x0A44))

/* 寄存器说明：The DCU（Debug Control Unit）enable register。
   位域定义UNION结构:  SOC_SECENG_S_HOST_DCU_EN_UNION */
#define SOC_SECENG_S_HOST_DCU_EN_ADDR(base)           ((base) + (0x0A64))

/* 寄存器说明：Secure Timer BIST Kick signal。
   位域定义UNION结构:  SOC_SECENG_S_HOST_SECURE_TIMER_BIST_KICK_UNION */
#define SOC_SECENG_S_HOST_SECURE_TIMER_BIST_KICK_ADDR(base) ((base) + (0x0A68))

/* 寄存器说明：this register holds the Secure Timer BIST result。
   位域定义UNION结构:  SOC_SECENG_S_HOST_SECURE_TIMER_BIST_VAL_UNION */
#define SOC_SECENG_S_HOST_SECURE_TIMER_BIST_VAL_ADDR(base) ((base) + (0x0A6C))

/* 寄存器说明：Writing to this register sets/resets the CryptoCell to Always-On test signal。
   位域定义UNION结构:  SOC_SECENG_S_HOST_CC_AO_TEST_UNION */
#define SOC_SECENG_S_HOST_CC_AO_TEST_ADDR(base)       ((base) + (0x0A70))

/* 寄存器说明：Writing to this register resets the low-resolution Secure Timer (residing in the Always-On model)。
   位域定义UNION结构:  SOC_SECENG_S_HOST_LOW_RES_SECURE_TIMER_RST_UNION */
#define SOC_SECENG_S_HOST_LOW_RES_SECURE_TIMER_RST_ADDR(base) ((base) + (0x0A74))

/* 寄存器说明：This register holds the low-resolution Secure Timer value, bits 31:0 (residing in the Always-On model)。
   位域定义UNION结构:  SOC_SECENG_S_HOST_LOW_RES_SECURE_TIMER_0_UNION */
#define SOC_SECENG_S_HOST_LOW_RES_SECURE_TIMER_0_ADDR(base) ((base) + (0x0A78))

/* 寄存器说明：This register holds the low-resolution Secure Timer value, bits 63:32 (residing in the Always-On model)。
   位域定义UNION结构:  SOC_SECENG_S_HOST_LOW_RES_SECURE_TIMER_1_UNION */
#define SOC_SECENG_S_HOST_LOW_RES_SECURE_TIMER_1_ADDR(base) ((base) + (0x0A7C))

/* 寄存器说明：Writing to this register resets the high-resolution Secure Timer。
   位域定义UNION结构:  SOC_SECENG_S_HOST_HIGH_RES_SECURE_TIMER_RST_UNION */
#define SOC_SECENG_S_HOST_HIGH_RES_SECURE_TIMER_RST_ADDR(base) ((base) + (0x0A80))

/* 寄存器说明：This register holds the high-resolution Secure Timer value, bits 31:0。
   位域定义UNION结构:  SOC_SECENG_S_HOST_HIGH_RES_SECURE_TIMER_0_UNION */
#define SOC_SECENG_S_HOST_HIGH_RES_SECURE_TIMER_0_ADDR(base) ((base) + (0x0A84))

/* 寄存器说明：This register holds the high-resolution Secure Timer value, bits 39:32。
   位域定义UNION结构:  SOC_SECENG_S_HOST_HIGH_RES_SECURE_TIMER_1_UNION */
#define SOC_SECENG_S_HOST_HIGH_RES_SECURE_TIMER_1_ADDR(base) ((base) + (0x0A88))

/* 寄存器说明：This register holds the high-resolution Secure Timer value, bits 31:0。
   位域定义UNION结构:  SOC_SECENG_S_HOST_HIGH_RES_SECURE_TIMER_TH_0_UNION */
#define SOC_SECENG_S_HOST_HIGH_RES_SECURE_TIMER_TH_0_ADDR(base) ((base) + (0x0A8C))

/* 寄存器说明：This register holds the high-resolution Secure Timer value, bits 39:32。
   位域定义UNION结构:  SOC_SECENG_S_HOST_HIGH_RES_SECURE_TIMER_TH_1_UNION */
#define SOC_SECENG_S_HOST_HIGH_RES_SECURE_TIMER_TH_1_ADDR(base) ((base) + (0x0A90))

/* 寄存器说明：This register holds the latched value of the low-resolution Secure Timer, bits 31:0 (latched at reset of high-resolution timer)。
   位域定义UNION结构:  SOC_SECENG_S_HOST_LATCHED_EXTERNAL_TIMER_0_UNION */
#define SOC_SECENG_S_HOST_LATCHED_EXTERNAL_TIMER_0_ADDR(base) ((base) + (0x0A94))

/* 寄存器说明：This register holds the latched value of the low-resolution Secure Timer, bits 64:32 (latched at reset of high-resolution timer)。
   位域定义UNION结构:  SOC_SECENG_S_HOST_LATCHED_EXTERNAL_TIMER_1_UNION */
#define SOC_SECENG_S_HOST_LATCHED_EXTERNAL_TIMER_1_ADDR(base) ((base) + (0x0A98))

/* 寄存器说明：reflects HW Defines in the NVM
   位域定义UNION结构:  SOC_SECENG_S_NVM_CC_BOOT_UNION */
#define SOC_SECENG_S_NVM_CC_BOOT_ADDR(base)           ((base) + (0x00AA0))

/* 寄存器说明：This register serves for indirect access to the NVM。 NOTE! This is a special register, affected by internal logic。 Test result of this register is NA。
   位域定义UNION结构:  SOC_SECENG_S_HOST_AIB_ADDR_REG_UNION */
#define SOC_SECENG_S_HOST_AIB_ADDR_REG_ADDR(base)     ((base) + (0x00AA4))

/* 寄存器说明：The write data for AIB transactions should be written to this register。 NOTE! This is a special register, affected by internal logic。 Test result of this register is NA。
   位域定义UNION结构:  SOC_SECENG_S_HOST_AIB_WDATA_REG_UNION */
#define SOC_SECENG_S_HOST_AIB_WDATA_REG_ADDR(base)    ((base) + (0x00AA8))

/* 寄存器说明：The data for AIB transactions can be read from this register。
   位域定义UNION结构:  SOC_SECENG_S_HOST_AIB_RDATA_REG_UNION */
#define SOC_SECENG_S_HOST_AIB_RDATA_REG_ADDR(base)    ((base) + (0x00AAC))

/* 寄存器说明：This register reflects the fuse_aib_prog_completed input, which indicates that the fuse programming was completed。 NOTE! This is a special register, affected by internal logic。 Test result of this register is NA。
   位域定义UNION结构:  SOC_SECENG_S_AIB_FUSE_PROG_COMPLETED_UNION */
#define SOC_SECENG_S_AIB_FUSE_PROG_COMPLETED_ADDR(base) ((base) + (0x00AB0))

/* 寄存器说明：This register reflects the fuse_aib_ack input, which indicates that the AIB transaction was completed。 NOTE! This is a special register, affected by internal logic。 Test result of this register is NA。
   位域定义UNION结构:  SOC_SECENG_S_AIB_FUSE_ACK_UNION */
#define SOC_SECENG_S_AIB_FUSE_ACK_ADDR(base)          ((base) + (0x00AB4))

/* 寄存器说明：AIB debug status register。
   位域定义UNION结构:  SOC_SECENG_S_AIB_DEBUG_STATUS_UNION */
#define SOC_SECENG_S_AIB_DEBUG_STATUS_ADDR(base)      ((base) + (0x00AB8))

/* 寄存器说明：Indicates that the LCS register holds a valid value。 NOTE! This is a special register, affected by internal logic。 Test result of this register is NA。
   位域定义UNION结构:  SOC_SECENG_S_LCS_IS_VALID_UNION */
#define SOC_SECENG_S_LCS_IS_VALID_ADDR(base)          ((base) + (0x00ABC))

/* 寄存器说明：Bits [31:0] of the Session key
   位域定义UNION结构:  SOC_SECENG_S_HOST_SESSION_KEY0_UNION */
#define SOC_SECENG_S_HOST_SESSION_KEY0_ADDR(base)     ((base) + (0x00AC0))

/* 寄存器说明：Bits [63:32] of the Session key
   位域定义UNION结构:  SOC_SECENG_S_HOST_SESSION_KEY1_UNION */
#define SOC_SECENG_S_HOST_SESSION_KEY1_ADDR(base)     ((base) + (0x00AC4))

/* 寄存器说明：Bits [95:64] of the Session key
   位域定义UNION结构:  SOC_SECENG_S_HOST_SESSION_KEY2_UNION */
#define SOC_SECENG_S_HOST_SESSION_KEY2_ADDR(base)     ((base) + (0x00AC8))

/* 寄存器说明：Bits [127:96] of the Session key。 Writing to this register also creates a write pulse toward the always-on module。
   位域定义UNION结构:  SOC_SECENG_S_HOST_SESSION_KEY3_UNION */
#define SOC_SECENG_S_HOST_SESSION_KEY3_ADDR(base)     ((base) + (0x00ACC))

/* 寄存器说明：Indication from the always-on register that the session key is valid。
   位域定义UNION结构:  SOC_SECENG_S_HOST_SEESION_KEY_IS_VALID_UNION */
#define SOC_SECENG_S_HOST_SEESION_KEY_IS_VALID_ADDR(base) ((base) + (0x00AD0))

/* 寄存器说明：The lifecycle state register。 NOTE! This is a special register, affected by internal logic。 Test result of this register is NA。
   位域定义UNION结构:  SOC_SECENG_S_LCS_REG_UNION */
#define SOC_SECENG_S_LCS_REG_ADDR(base)               ((base) + (0x00AD4))

/* 寄存器说明：Host disable security for the current power cycle。
   位域定义UNION结构:  SOC_SECENG_S_HOST_CPC_SECURITY_DISABLE_UNION */
#define SOC_SECENG_S_HOST_CPC_SECURITY_DISABLE_ADDR(base) ((base) + (0x00AD8))

/* 寄存器说明：The Always-On state counter。
   位域定义UNION结构:  SOC_SECENG_S_HOST_AO_CC_STATE_COUNTER_UNION */
#define SOC_SECENG_S_HOST_AO_CC_STATE_COUNTER_ADDR(base) ((base) + (0x00ADC))

/* 寄存器说明：State counter increment。 Writing any value to this address asserts the CC_AO_STATE_COUNTER_INC outputs for 1 cycle。
   位域定义UNION结构:  SOC_SECENG_S_HOST_CC_AO_STATE_COUNTER_INC_UNION */
#define SOC_SECENG_S_HOST_CC_AO_STATE_COUNTER_INC_ADDR(base) ((base) + (0x00AE0))

/* 寄存器说明：This register reflects the Host AO_CC_IS_SD input from the Always-On that determines the LCS is Secure-Disabled。
   位域定义UNION结构:  SOC_SECENG_S_HOST_AO_CC_IS_SD_UNION */
#define SOC_SECENG_S_HOST_AO_CC_IS_SD_ADDR(base)      ((base) + (0x00AE4))

/* 寄存器说明：This register interface is used to update the RKEK registers when the device is in RMA mode, The RKEK is updated by shifting when MSB word is written first。 After the eighth writing the registers are blocked for further writing。 (write -once)。
   位域定义UNION结构:  SOC_SECENG_S_HOST_RMA_RKEK_WR_UNION */
...
/* 寄存器说明：This register holds the number of uncompleted write transactions, with ID=0。
   位域定义UNION结构:  SOC_SECENG_S_AXIM_MON_INFLIGHT0_UNION */
#define SOC_SECENG_S_AXIM_MON_INFLIGHT0_ADDR(base)    ((base) + (0x00B00))

/* 寄存器说明：This register holds the number of uncompleted write transactions, with ID=0。
   位域定义UNION结构:  SOC_SECENG_S_AXIM_MON_INFLIGHT1_UNION */
...
/* 寄存器说明：This register holds the number of uncompleted write transactions, with ID=2。
   位域定义UNION结构:  SOC_SECENG_S_AXIM_MON_INFLIGHT2_UNION */
...
/* 寄存器说明：This register holds the number of uncompleted write transactions, with ID=3。
   位域定义UNION结构:  SOC_SECENG_S_AXIM_MON_INFLIGHT3_UNION */
...
/* 寄存器说明：This register holds the number of uncompleted write transactions, with ID=4。
   位域定义UNION结构:  SOC_SECENG_S_AXIM_MON_INFLIGHT4_UNION */
...
/* 寄存器说明：This register holds the number of uncompleted write transactions, with ID=5。
   位域定义UNION结构:  SOC_SECENG_S_AXIM_MON_INFLIGHT5_UNION */
...
/* 寄存器说明：This register holds the number of uncompleted write transactions, with ID=8。
   位域定义UNION结构:  SOC_SECENG_S_AXIM_MON_INFLIGHT8_UNION */
...
/* 寄存器说明：This register holds the number of uncompleted write transactions, with ID=9。
   位域定义UNION结构:  SOC_SECENG_S_AXIM_MON_INFLIGHT9_UNION */
...
/* 寄存器说明：This register holds the number of uncompleted write transactions, with ID=10。
   位域定义UNION结构:  SOC_SECENG_S_AXIM_MON_INFLIGHT10_UNION */
...
/* 寄存器说明：This register holds the number of uncompleted write transactions, with ID=11。
   位域定义UNION结构:  SOC_SECENG_S_AXIM_MON_INFLIGHT11_UNION */
...
/* 寄存器说明：This register holds the number of uncompleted write transactions, with ID=0 and last indication bit set。
   位域定义UNION结构:  SOC_SECENG_S_AXIM_MON_INFLIGHTLAST0_UNION */
...
/* 寄存器说明：This register holds the number of uncompleted write transactions, with ID=1 and last indication bit set。
   位域定义UNION结构:  SOC_SECENG_S_AXIM_MON_INFLIGHTLAST1_UNION */
#define SOC_SECENG_S_AXIM_MON_INFLIGHTLAST1_ADDR(base) ((base) + (0x00B44))

/* 寄存器说明：This register holds the number of uncompleted write transactions, with ID=1 and last indication bit set。
   位域定义UNION结构:  SOC_SECENG_S_AXIM_MON_INFLIGHTLAST2_UNION */
...
/* 寄存器说明：This register holds the number of uncompleted write transactions, with ID=3 and last indication bit set。
   位域定义UNION结构:  SOC_SECENG_S_AXIM_MON_INFLIGHTLAST3_UNION */
...
/* 寄存器说明：This register holds the number of uncompleted write transactions, with ID=4 and last indication bit set。
   位域定义UNION结构:  SOC_SECENG_S_AXIM_MON_INFLIGHTLAST4_UNION */
...
/* 寄存器说明：This register holds the number of uncompleted write transactions, with ID=5 and last indication bit set。
   位域定义UNION结构:  SOC_SECENG_S_AXIM_MON_INFLIGHTLAST5_UNION */
...
/* 寄存器说明：This register holds the number of uncompleted write transactions, with ID=8 and last indication bit set。
   位域定义UNION结构:  SOC_SECENG_S_AXIM_MON_INFLIGHTLAST8_UNION */
...
/* 寄存器说明：This register holds the number of uncompleted write transactions, with ID=9 and last indication bit set。
   位域定义UNION结构:  SOC_SECENG_S_AXIM_MON_INFLIGHTLAST9_UNION */
...
/* 寄存器说明：This register holds the number of uncompleted write transactions, with ID=10 and last indication bit set。
   位域定义UNION结构:  SOC_SECENG_S_AXIM_MON_INFLIGHTLAST10_UNION */
...
/* 寄存器说明：This register holds the completion counter of the transaction with ID=0。
   位域定义UNION结构:  SOC_SECENG_S_AXIM_MON_COMP0_UNION */
...
/* 寄存器说明：This register holds the completion counter of the transaction with ID=1。
   位域定义UNION结构:  SOC_SECENG_S_AXIM_MON_COMP1_UNION */
...
/* 寄存器说明：This register holds the completion counter of the transaction with ID=2。
   位域定义UNION结构:  SOC_SECENG_S_AXIM_MON_COMP2_UNION */
...
/* 寄存器说明：This register holds the completion counter of the transaction with ID=3。
   位域定义UNION结构:  SOC_SECENG_S_AXIM_MON_COMP3_UNION */
...
/* 寄存器说明：This register holds the completion counter of the transaction with ID=4。
   位域定义UNION结构:  SOC_SECENG_S_AXIM_MON_COMP4_UNION */
...
/* 寄存器说明：This register holds the completion counter of the transaction with ID=5。
   位域定义UNION结构:  SOC_SECENG_S_AXIM_MON_COMP5_UNION */
...
/* 寄存器说明：This register holds the completion counter of the transaction with ID=8。
   位域定义UNION结构:  SOC_SECENG_S_AXIM_MON_COMP8_UNION */
...
/* 寄存器说明：This register holds the completion counter of the transaction with ID=9。
   位域定义UNION结构:  SOC_SECENG_S_AXIM_MON_COMP9_UNION */
...
/* 寄存器说明：This register holds the completion counter of the transaction with ID=10。
   位域定义UNION结构:  SOC_SECENG_S_AXIM_MON_COMP10_UNION */
...
/* 寄存器说明：Location of LLI table located in the SRAM。 in SINGLE/MULTI_LLI mode, writing to this register triggers the DMA。 NOTE! This is a special register, affected by internal logic。 Test result of this register is NA。
   位域定义UNION结构:  SOC_SECENG_S_SRC_LLI_SRAM_ADDR_UNION */
...
/* 寄存器说明：This register is used in direct LLI mode - holds the location of the data source in the memory (AXI)。
   位域定义UNION结构:  SOC_SECENG_S_SRC_LLI_WORD0_UNION */
...
/* 寄存器说明：This register is used in direct LLI mode - holds the number of bytes to be read from the memory (AXI)。 Writing to this register triggers the DMA。 NOTE! This is a special register, affected by internal logic。 Test result of this register is NA。
   位域定义UNION结构:  SOC_SECENG_S_SRC_LLI_WORD1_UNION */
...
/* 寄存器说明：Location of data (start address) to be read from SRAM。 NOTE! This is a special register, affected by internal logic。 Test result of this register is NA。
   位域定义UNION结构:  SOC_SECENG_S_SRAM_SRC_ADDR_UNION */
...
/* 寄存器说明：Cryptographic result - CPU can directly access it。 NOTE! This is a special register, affected by internal logic。 Test result of this register is NA。
   位域定义UNION结构:  SOC_SECENG_S_DOUT_BUFFER_UNION */
...
/* 寄存器说明：DOUT memory DMA busy - Indicates that memory (AXI) destination DMA (DOUT) is busy。
   位域定义UNION结构:  SOC_SECENG_S_DOUT_MEM_DMA_BUSY_UNION */
...
/* 寄存器说明：This register holds the destination LLI table address in SRAM。 NOTE! This is a special register, affected by internal logic。 Test result of this register is NA。
   位域定义UNION结构:  SOC_SECENG_S_DST_LLI_SRAM_ADDR_UNION */
...
/* 寄存器说明：This register is used in direct LLI mode - holds the location of the data destination in the memory (AXI)
   位域定义UNION结构:  SOC_SECENG_S_DST_LLI_WORD0_UNION */
...
/* 寄存器说明：This register is used in direct LLI mode - holds the number of bytes to be written to the memory (AXI)。
   位域定义UNION结构:  SOC_SECENG_S_DST_LLI_WORD1_UNION */
...
/* 寄存器说明：Location of result to be sent to in SRAM NOTE! This is a special register, affected by internal logic。 Test result of this register is NA。
   位域定义UNION结构:  SOC_SECENG_S_SRAM_DEST_ADDR_UNION */
...
/* 寄存器说明：This register defines the endianness of the DOUT interface from SRAM。
   位域定义UNION结构:  SOC_SECENG_S_DOUT_SRAM_ENDIANNESS_UNION */
...
/* 寄存器说明：This register counts the number of completed descriptors in which the ACK_NEEDED field equals 1。
   位域定义UNION结构:  SOC_SECENG_S_DSCRPTR_COMPLETION_COUNTER0_UNION */
...
/* 寄存器说明：This register counts the number of completed descriptors in which the ACK_NEEDED field equals 2。
   位域定义UNION结构:  SOC_SECENG_S_DSCRPTR_COMPLETION_COUNTER1_UNION */
...
/* 寄存器说明：This register enables the Host to write a descriptor using a single address。
   位域定义UNION结构:  SOC_SECENG_S_DSCRPTR_SINGLE_ADDR_EN_UNION */
...
/* 寄存器说明：This register holds the number of cycles measured when using the special performance descriptor。
   位域定义UNION结构:  SOC_SECENG_S_DSCRPTR_MEASURE_CNTR_UNION */
...
/* 寄存器说明：This register holds the upper 16bits of the address to which CryptoCell writes when descriptor does not comply with restriction。
   位域定义UNION结构:  SOC_SECENG_S_DSCRPTR_FILTER_DROPPED_ADDRESS_HIGH_UNION */
...
/* 寄存器说明：This register holds the watermark value of descriptor queue0。
   位域定义UNION结构:  SOC_SECENG_S_DSCRPTR_QUEUE0_WATERMARK_UNION */
...
/* 寄存器说明：This register holds the number of empty entries in descriptor queue0。
   位域定义UNION结构:  SOC_SECENG_S_DSCRPTR_QUEUE0_CONTENT_UNION */
...
/* 寄存器说明：READ WRITE DATA FROM SRAM NOTE! This is a special register, affected by internal logic。 Test result of this register is NA。
   位域定义UNION结构:  SOC_SECENG_S_SRAM_DATA_UNION */
...
/* 寄存器说明：first address given to SRAM DMA for read/write transactions from SRAM。
   位域定义UNION结构:  SOC_SECENG_S_SRAM_ADDR_UNION */
#define SOC_SECENG_S_SRAM_ADDR_ADDR(base)             ((base) + (0x00F04))

/* 寄存器说明：sram data ready。
   位域定义UNION结构:  SOC_SECENG_S_SRAM_DATA_READY_UNION */
 ...
 ****************************************************************************/
/*****************************************************************************
 结构名    : SOC_SECENG_S_MEMORY_MAP0_UNION
 结构说明  : MEMORY_MAP0 寄存器结构定义。地址偏移量:0x00000，初值:0x00000000，宽度:32
 寄存器说明: This register maps the virtual register R0 to a physical address in memory。
*****************************************************************************/
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_MEMORY_MAP1_UNION
 结构说明  : MEMORY_MAP1 寄存器结构定义。地址偏移量:0x00004，初值:0x00000000，宽度:32
 寄存器说明: This register maps the virtual register R1 to a physical address in memory。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_MEMORY_MAP2_UNION
 结构说明  : MEMORY_MAP2 寄存器结构定义。地址偏移量:0x00008，初值:0x00000000，宽度:32
 寄存器说明: This register maps the virtual register R2 to a physical address in memory。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_MEMORY_MAP3_UNION
 结构说明  : MEMORY_MAP3 寄存器结构定义。地址偏移量:0x0000C，初值:0x00000000，宽度:32
 寄存器说明: This register maps the virtual register R3 to a physical address in memory。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_MEMORY_MAP4_UNION
 结构说明  : MEMORY_MAP4 寄存器结构定义。地址偏移量:0x00010，初值:0x00000000，宽度:32
 寄存器说明: This register maps the virtual register R4 to a physical address in memory。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_MEMORY_MAP5_UNION
 结构说明  : MEMORY_MAP5 寄存器结构定义。地址偏移量:0x00014，初值:0x00000000，宽度:32
 寄存器说明: This register maps the virtual register R5 to a physical address in memory。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_MEMORY_MAP6_UNION
 结构说明  : MEMORY_MAP6 寄存器结构定义。地址偏移量:0x00018，初值:0x00000000，宽度:32
 寄存器说明: This register maps the virtual register R6 to a physical address in memory。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_MEMORY_MAP7_UNION
 结构说明  : MEMORY_MAP7 寄存器结构定义。地址偏移量:0x0001C，初值:0x00000000，宽度:32
 寄存器说明: This register maps the virtual register R7 to a physical address in memory。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_MEMORY_MAP8_UNION
 结构说明  : MEMORY_MAP8 寄存器结构定义。地址偏移量:0x00020，初值:0x00000000，宽度:32
 寄存器说明: This register maps the virtual register R8 to a physical address in memory。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_MEMORY_MAP9_UNION
 结构说明  : MEMORY_MAP9 寄存器结构定义。地址偏移量:0x00024，初值:0x00000000，宽度:32
 寄存器说明: This register maps the virtual register R9 to a physical address in memory。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_MEMORY_MAP10_UNION
 结构说明  : MEMORY_MAP10 寄存器结构定义。地址偏移量:0x00028，初值:0x00000000，宽度:32
 寄存器说明: This register maps the virtual register R10 to a physical address in memory。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_MEMORY_MAP11_UNION
 结构说明  : MEMORY_MAP11 寄存器结构定义。地址偏移量:0x0002C，初值:0x00000000，宽度:32
 寄存器说明: This register maps the virtual register R11 to a physical address in memory。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_MEMORY_MAP12_UNION
 结构说明  : MEMORY_MAP12 寄存器结构定义。地址偏移量:0x00030，初值:0x00000000，宽度:32
 寄存器说明: This register maps the virtual register R12 to a physical address in memory。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_MEMORY_MAP13_UNION
 结构说明  : MEMORY_MAP13 寄存器结构定义。地址偏移量:0x00034，初值:0x00000000，宽度:32
 寄存器说明: This register maps the virtual register R13 to a physical address in memory。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_MEMORY_MAP14_UNION
 结构说明  : MEMORY_MAP14 寄存器结构定义。地址偏移量:0x00038，初值:0x00000000，宽度:32
 寄存器说明: This register maps the virtual register R14 to a physical address in memory。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_MEMORY_MAP15_UNION
 结构说明  : MEMORY_MAP15 寄存器结构定义。地址偏移量:0x0003C，初值:0x00000000，宽度:32
 寄存器说明: This register maps the virtual register R15 to a physical address in memory。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_MEMORY_MAP16_UNION
 结构说明  : MEMORY_MAP16 寄存器结构定义。地址偏移量:0x00040，初值:0x00000000，宽度:32
 寄存器说明: This register maps the virtual register R16 to a physical address in memory。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_MEMORY_MAP17_UNION
 结构说明  : MEMORY_MAP17 寄存器结构定义。地址偏移量:0x00044，初值:0x00000000，宽度:32
 寄存器说明: This register maps the virtual register R17 to a physical address in memory。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_MEMORY_MAP18_UNION
 结构说明  : MEMORY_MAP18 寄存器结构定义。地址偏移量:0x00048，初值:0x00000000，宽度:32
 寄存器说明: This register maps the virtual register R18 to a physical address in memory。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_MEMORY_MAP19_UNION
 结构说明  : MEMORY_MAP19 寄存器结构定义。地址偏移量:0x0004C，初值:0x00000000，宽度:32
 寄存器说明: This register maps the virtual register R19 to a physical address in memory。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_MEMORY_MAP20_UNION
 结构说明  : MEMORY_MAP20 寄存器结构定义。地址偏移量:0x00050，初值:0x00000000，宽度:32
 寄存器说明: This register maps the virtual register R20 to a physical address in memory。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_MEMORY_MAP21_UNION
 结构说明  : MEMORY_MAP21 寄存器结构定义。地址偏移量:0x00054，初值:0x00000000，宽度:32
 寄存器说明: This register maps the virtual register R21 to a physical address in memory。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_MEMORY_MAP22_UNION
 结构说明  : MEMORY_MAP22 寄存器结构定义。地址偏移量:0x00058，初值:0x00000000，宽度:32
 寄存器说明: This register maps the virtual register R22 to a physical address in memory。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_MEMORY_MAP23_UNION
 结构说明  : MEMORY_MAP23 寄存器结构定义。地址偏移量:0x0005C，初值:0x00000000，宽度:32
 寄存器说明: This register maps the virtual register R23 to a physical address in memory。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_MEMORY_MAP24_UNION
 结构说明  : MEMORY_MAP24 寄存器结构定义。地址偏移量:0x00060，初值:0x00000000，宽度:32
 寄存器说明: This register maps the virtual register R24 to a physical address in memory。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_MEMORY_MAP25_UNION
 结构说明  : MEMORY_MAP25 寄存器结构定义。地址偏移量:0x00064，初值:0x00000000，宽度:32
 寄存器说明: This register maps the virtual register R25 to a physical address in memory。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_MEMORY_MAP26_UNION
 结构说明  : MEMORY_MAP26 寄存器结构定义。地址偏移量:0x00068，初值:0x00000000，宽度:32
 寄存器说明: This register maps the virtual register R26 to a physical address in memory。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_MEMORY_MAP27_UNION
 结构说明  : MEMORY_MAP27 寄存器结构定义。地址偏移量:0x0006C，初值:0x00000000，宽度:32
 寄存器说明: This register maps the virtual register R27 to a physical address in memory。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_MEMORY_MAP28_UNION
 结构说明  : MEMORY_MAP28 寄存器结构定义。地址偏移量:0x00070，初值:0x00000000，宽度:32
 寄存器说明: This register maps the virtual register R28 to a physical address in memory。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_MEMORY_MAP29_UNION
 结构说明  : MEMORY_MAP29 寄存器结构定义。地址偏移量:0x00074，初值:0x00000000，宽度:32
 寄存器说明: This register maps the virtual register R29 to a physical address in memory。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_MEMORY_MAP30_UNION
 结构说明  : MEMORY_MAP30 寄存器结构定义。地址偏移量:0x00078，初值:0x00000000，宽度:32
 寄存器说明: This register maps the virtual register R30 to a physical address in memory。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_MEMORY_MAP31_UNION
 结构说明  : MEMORY_MAP31 寄存器结构定义。地址偏移量:0x0007C，初值:0x00000000，宽度:32
 寄存器说明: This register maps the virtual register R31 to a physical address in memory。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_OPCODE_UNION
 结构说明  : OPCODE 寄存器结构定义。地址偏移量:0x00080，初值:0x00000000，宽度:32
 寄存器说明: This register holds the PKA's OPCODE。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_N_NP_T0_T1_ADDR_UNION
 结构说明  : N_NP_T0_T1_ADDR 寄存器结构定义。地址偏移量:0x00084，初值:0x000FF820，宽度:32
 寄存器说明: This register maps N_NP_T0_T1 to a virtual address。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_PKA_STATUS_UNION
 结构说明  : PKA_STATUS 寄存器结构定义。地址偏移量:0x00088，初值:0x00000001，宽度:32
 寄存器说明: This register holds the PKA pipe status。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_PKA_SW_RESET_UNION
 结构说明  : PKA_SW_RESET 寄存器结构定义。地址偏移量:0x0008C，初值:0x00000000，宽度:32
 寄存器说明: Writing to this register triggers a software reset of the PKA。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_PKA_L0_UNION
 结构说明  : PKA_L0 寄存器结构定义。地址偏移量:0x00090，初值:0x00000000，宽度:32
 寄存器说明: This register holds the size of the operation。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_PKA_L1_UNION
 结构说明  : PKA_L1 寄存器结构定义。地址偏移量:0x00094，初值:0x00000000，宽度:32
 寄存器说明: This register holds the size of the operation。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_PKA_L2_UNION
 结构说明  : PKA_L2 寄存器结构定义。地址偏移量:0x00098，初值:0x00000000，宽度:32
 寄存器说明: This register holds the size of the operation。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_PKA_L3_UNION
 结构说明  : PKA_L3 寄存器结构定义。地址偏移量:0x0009C，初值:0x00000000，宽度:32
 寄存器说明: This register holds the size of the operation。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_PKA_L4_UNION
 结构说明  : PKA_L4 寄存器结构定义。地址偏移量:0x000A0，初值:0x00000000，宽度:32
 寄存器说明: This register holds the size of the operation。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_PKA_L5_UNION
 结构说明  : PKA_L5 寄存器结构定义。地址偏移量:0x000A4，初值:0x00000000，宽度:32
 寄存器说明: This register holds the size of the operation。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_PKA_L6_UNION
 结构说明  : PKA_L6 寄存器结构定义。地址偏移量:0x000A8，初值:0x00000000，宽度:32
 寄存器说明: This register holds the size of the operation。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_PKA_L7_UNION
 结构说明  : PKA_L7 寄存器结构定义。地址偏移量:0x000AC，初值:0x00000000，宽度:32
 寄存器说明: This register holds the size of the operation。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_PKA_PIPE_RDY_UNION
 结构说明  : PKA_PIPE_RDY 寄存器结构定义。地址偏移量:0x000B0，初值:0x00000001，宽度:32
 寄存器说明: This register indicates whether the PKA pipe is ready to receive a new OPCODE。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_PKA_DONE_UNION
 结构说明  : PKA_DONE 寄存器结构定义。地址偏移量:0x000B4，初值:0x00000001，宽度:32
 寄存器说明: This register indicates whether PKA operation is completed。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_PKA_MON_SELECT_UNION
 结构说明  : PKA_MON_SELECT 寄存器结构定义。地址偏移量:0x000B8，初值:0x00000000，宽度:32
 寄存器说明: This register defines which PKA FSM monitor is being output。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_PKA_DEBUG_REG_EN_UNION
 结构说明  : PKA_DEBUG_REG_EN 寄存器结构定义。地址偏移量:0x000BC，初值:0x00000000，宽度:32
 寄存器说明: This register enables/disables all the debug mechanism。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DEBUG_CNT_ADDR_UNION
 结构说明  : DEBUG_CNT_ADDR 寄存器结构定义。地址偏移量:0x000C0，初值:0x00000000，宽度:32
 寄存器说明: This register holds the debug counter's value。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_PKA_DEBUG_HALT_UNION
 结构说明  : PKA_DEBUG_HALT 寄存器结构定义。地址偏移量:0x000C8，初值:0x00000000，宽度:32
 寄存器说明: This register indicates whether the PKA is in halt state。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_PKA_MSB_ADDR_UNION
 结构说明  : PKA_MSB_ADDR 寄存器结构定义。地址偏移量:0x000CC，初值:0x00000000，宽度:32
 寄存器说明: This register holds the PKA address' offset。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_PKA_MON_READ_UNION
 结构说明  : PKA_MON_READ 寄存器结构定义。地址偏移量:0x000D0，初值:0x0000FEEF，宽度:32
 寄存器说明: This register holds the PKA monitor bus' register output。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_RNG_IMR_UNION
 结构说明  : RNG_IMR 寄存器结构定义。地址偏移量:0x00100，初值:0x0000003F，宽度:32
 寄存器说明: Interrupt masking register。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_RNG_ISR_UNION
 结构说明  : RNG_ISR 寄存器结构定义。地址偏移量:0x00104，初值:0x00000000，宽度:32
 寄存器说明: Status register。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_RNG_ICR_UNION
 结构说明  : RNG_ICR 寄存器结构定义。地址偏移量:0x00108，初值:0x00000000，宽度:32
 寄存器说明: Interrupt/status bit clear Register。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_TRNG_CONFIG_UNION
 结构说明  : TRNG_CONFIG 寄存器结构定义。地址偏移量:0x0010C，初值:0x00000000，宽度:32
 寄存器说明: This register handles TRNG configuration。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_TRNG_VALID_UNION
 结构说明  : TRNG_VALID 寄存器结构定义。地址偏移量:0x00110，初值:0x00000000，宽度:32
 寄存器说明: This register indicates that the TRNG data is valid。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_EHR_DATA_0_UNION
 结构说明  : EHR_DATA_0 寄存器结构定义。地址偏移量:0x00114，初值:0x00000000，宽度:32
 寄存器说明: This register contains the data collected in the TRNG[31_0]。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_EHR_DATA_1_UNION
 结构说明  : EHR_DATA_1 寄存器结构定义。地址偏移量:0x00118，初值:0x00000000，宽度:32
 寄存器说明: This register contains the data collected in the TRNG[63_32]。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_EHR_DATA_2_UNION
 结构说明  : EHR_DATA_2 寄存器结构定义。地址偏移量:0x0011C，初值:0x00000000，宽度:32
 寄存器说明: This register contains the data collected in the TRNG[95_64]。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_EHR_DATA_3_UNION
 结构说明  : EHR_DATA_3 寄存器结构定义。地址偏移量:0x00120，初值:0x00000000，宽度:32
 寄存器说明: This register contains the data collected in the TRNG[127_96]。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_EHR_DATA_4_UNION
 结构说明  : EHR_DATA_4 寄存器结构定义。地址偏移量:0x00124，初值:0x00000000，宽度:32
 寄存器说明: This register contains the data collected in the TRNG[159_128]。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_EHR_DATA_5_UNION
 结构说明  : EHR_DATA_5 寄存器结构定义。地址偏移量:0x00128，初值:0x00000000，宽度:32
 寄存器说明: This register contains the data collected in the TRNG[191_160]。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_RND_SOURCE_ENABLE_UNION
 结构说明  : RND_SOURCE_ENABLE 寄存器结构定义。地址偏移量:0x0012C，初值:0x00000000，宽度:32
 寄存器说明: This register holds the enable signal for the random source。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_SAMPLE_CNT1_UNION
 结构说明  : SAMPLE_CNT1 寄存器结构定义。地址偏移量:0x00130，初值:0x0000FFFF，宽度:32
 寄存器说明: Counts clocks between sampling of random bit。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AUTOCORR_STATISTIC_UNION
 结构说明  : AUTOCORR_STATISTIC 寄存器结构定义。地址偏移量:0x00134，初值:0x00000000，宽度:32
 寄存器说明: Statistics about autocorrelation test activations。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_TRNG_DEBUG_CONTROL_UNION
 结构说明  : TRNG_DEBUG_CONTROL 寄存器结构定义。地址偏移量:0x00138，初值:0x00000000，宽度:32
 寄存器说明: Debug regsiter
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_RNG_SW_RESET_UNION
 结构说明  : RNG_SW_RESET 寄存器结构定义。地址偏移量:0x00140，初值:0x00000000，宽度:32
 寄存器说明: Generate SW reset solely to RNG block。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_RNG_DEBUG_EN_INPUT_UNION
 结构说明  : RNG_DEBUG_EN_INPUT 寄存器结构定义。地址偏移量:0x001B4，初值:0x00000000，宽度:32
 寄存器说明: Defines the RNG in debug mode
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_RNG_BUSY_UNION
 结构说明  : RNG_BUSY 寄存器结构定义。地址偏移量:0x001B8，初值:0x00000000，宽度:32
 寄存器说明: RNG busy indication
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_RST_BITS_COUNTER_UNION
 结构说明  : RST_BITS_COUNTER 寄存器结构定义。地址偏移量:0x001BC，初值:0x00000000，宽度:32
 寄存器说明: Resets the counter of collected bits in the TRNG
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_RNG_VERSION_UNION
 结构说明  : RNG_VERSION 寄存器结构定义。地址偏移量:0x001C0，初值:0x0000000F，宽度:32
 寄存器说明: This register holds the RNG version
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_RNG_CLK_ENABLE_UNION
 结构说明  : RNG_CLK_ENABLE 寄存器结构定义。地址偏移量:0x001C4，初值:0x00000001，宽度:32
 寄存器说明: Writing to this register enables/disables the RNG clock。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_RNG_DMA_ENABLE_UNION
 结构说明  : RNG_DMA_ENABLE 寄存器结构定义。地址偏移量:0x001C8，初值:0x00000000，宽度:32
 寄存器说明: Writing to this register enables/disables the RNG DMA。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_RNG_DMA_SRC_MASK_UNION
 结构说明  : RNG_DMA_SRC_MASK 寄存器结构定义。地址偏移量:0x001CC，初值:0x00000000，宽度:32
 寄存器说明: This register defines which ring-oscillator length should be used when using the RNG DMA。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_RNG_DMA_SRAM_ADDR_UNION
 结构说明  : RNG_DMA_SRAM_ADDR 寄存器结构定义。地址偏移量:0x001D0，初值:0x00000000，宽度:32
 寄存器说明: This register defines the start address of the DMA for the TRNG data。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_RNG_DMA_SAMPLES_NUM_UNION
 结构说明  : RNG_DMA_SAMPLES_NUM 寄存器结构定义。地址偏移量:0x001D4，初值:0x00000000，宽度:32
 寄存器说明: This register defines the number of 192-bits samples that the DMA collects per RNG configuration。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_RNG_WATCHDOG_VAL_UNION
 结构说明  : RNG_WATCHDOG_VAL 寄存器结构定义。地址偏移量:0x001D8，初值:0x00000000，宽度:32
 寄存器说明: This register defines the maximum number of clock cycles per TRNG collection of 192 samples。 If the number of cycles for a collection exceeds this threshold, TRNG signals an interrupt。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_RNG_DMA_STATUS_UNION
 结构说明  : RNG_DMA_STATUS 寄存器结构定义。地址偏移量:0x001DC，初值:0x00000000，宽度:32
 寄存器说明: This register holds the RNG DMA status。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AES_CLK_ENABLE_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DES_CLK_ENABLE_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HASH_CLK_ENABLE_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_PKA_CLK_ENABLE_UNION
 结构说明  : PKA_CLK_ENABLE 寄存器结构定义。地址偏移量:0x0081C，初值:0x00000000，宽度:32
 寄存器说明: The PKA clock enable register。 NOTE! This is a special register, affected by internal logic。 Test result of this register is NA。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DMA_CLK_ENABLE_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_CLK_STATUS_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_CRYPTO_CTL_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_CRYPTO_BUSY_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HASH_BUSY_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_VERSION_UNION
 结构说明  : VERSION 寄存器结构定义。地址偏移量:0x00928，初值:0xBF400002，宽度:32
 寄存器说明: This register holds the current CryptoCell version。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_CONTEXT_ID_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HASH_COMPARE_ERR_ID_FIFO0_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HASH_COMPARE_ERR_ID_FIFO1_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HASH_COMPARE_ERR_ID_FIFO2_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HASH_COMPARE_ERR_ID_FIFO3_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_RGF_IRR_UNION
 结构说明  : HOST_RGF_IRR 寄存器结构定义。地址偏移量:0x00A00，初值:0x00000000，宽度:32
 寄存器说明: The Interrupt Request register。 Each bit of this register holds the interrupt status of a single interrupt source。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_10                : 1;  /* bit[18]   : 保留 */
        ...
        unsigned int  reserved_11                : 1;  /* bit[21]   : 保留 */
        ...
        unsigned int  reserved_12                : 7;  /* bit[25-31]: 保留 */
    } reg;
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_RGF_IMR_UNION
 结构说明  : HOST_RGF_IMR 寄存器结构定义。地址偏移量:0x00A04，初值:0x01FFFFFF，宽度:32
 寄存器说明: The Interrupt Mask register. Each bit of this register holds the mask of a single interrupt source.
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_3              : 8;  /* bit[11-18]: 保留 */
        ...
        unsigned int  reserved_4              : 1;  /* bit[21]   : 保留 */
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_RGF_ICR_UNION
 结构说明  : HOST_RGF_ICR 寄存器结构定义。地址偏移量:0x00A08，初值:0x00000000，宽度:32
 寄存器说明: Interrupt Clear Register。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_RGF_ENDIAN_UNION
 结构说明  : HOST_RGF_ENDIAN 寄存器结构定义。地址偏移量:0x00A0C，初值:0x00000000，宽度:32
 寄存器说明: This register defines the endianness of the Host-accessible registers。
            NOTE! This is a special register, affected by internal logic。 Test result of this register is NA。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  dout_wr_bg  : 1;  /* bit[3]    : DOUT write endianess
                                                       0 - little endia
                                                       1 - big endian */
        unsigned int  reserved_1  : 3;  /* bit[4-6]  : 保留 */
        unsigned int  din_rd_bg   : 1;  /* bit[7]    : DIN read endianess
                                                       0 - little endia
                                                       1 - big endian */
        unsigned int  reserved_2  : 3;  /* bit[8-10] : 保留 */
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_RGF_CC_SW_RST_UNION
 结构说明  : HOST_RGF_CC_SW_RST 寄存器结构定义。地址偏移量:0x00A20，初值:0x00000000，宽度:32
 寄存器说明: Writing to this register generates a general reset to CryptoCell。 This reset takes about 4 core clock cycles。 NOTE! This is a special register, affected by internal logic。 Test result of this register is NA。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_RGF_SIGNATURE_UNION
 结构说明  : HOST_RGF_SIGNATURE 寄存器结构定义。地址偏移量:0x00A24，初值:0xD5C63000，宽度:32
 寄存器说明: This register holds the CryptoCell product signature。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_BOOT_UNION
 结构说明  : HOST_BOOT 寄存器结构定义。地址偏移量:0x00A28，初值:0x5FFBDACE，宽度:32
 寄存器说明: This register holds the values of CryptoCell's pre-synthesis flags
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_2              : 1;  /* bit[18] : 保留 */
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_PROVISION_CONST_MASK_UNION
 结构说明  : HOST_PROVISION_CONST_MASK 寄存器结构定义。地址偏移量:0x00A30，初值:0x00000000，宽度:32
 寄存器说明: Provisioning constant mask
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_CRYPTOKEY_SEL_UNION
 结构说明  : HOST_CRYPTOKEY_SEL 寄存器结构定义。地址偏移量:0x00A38，初值:0x00000000，宽度:32
 寄存器说明: AES hardware key select
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_HOST_CRY_ACCESS_EN_UNION
 结构说明  : HOST_HOST_CRY_ACCESS_EN 寄存器结构定义。地址偏移量:0x0A44，初值:0x00000000，宽度:32
 寄存器说明: This register defines whether the Host has access to the cry_kernel registers directly (compatibility mode) and not only through the descriptors。 The default value is 0 - no access。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_DCU_EN_UNION
 结构说明  : HOST_DCU_EN 寄存器结构定义。地址偏移量:0x0A64，初值:0x00000000，宽度:32
 寄存器说明: The DCU（Debug Control Unit）enable register。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  secure_CPU_dbgen_en      : 1;  /* bit[0]    : 该bit控制debug等级为证书认证方式（efuse bit2025为0，efuse bit2026为1）下MCPU的dbgen信号以及M3和M7的dbgen信号。
                                                                    写该bit为1则MCPU的dbgen被配置为0x1；
                                                                    写该bit为0则MCPU的dbgen被配置为0x0；
                                                                    同时写该寄存器的bit2和bit0为1，则M3和M7的dbgen信号被配置为0x1； */
        unsigned int  secure_CPU_niden_en      : 1;  /* bit[1]    : 该bit控制debug等级为证书认证方式（efuse bit2025为0，efuse bit2026为1）下MCPU的niden信号和M7的niden信号。
                                                                    写该bit为1则MCPU的niden被配置为0x1；
                                                                    写该bit为0则MCPU的niden被配置为0x0；
                                                                    同时写该寄存器的bit3和bit1为1，则M7的niden信号被配置为0x1； */
        unsigned int  secure_CPU_spiden_en     : 1;  /* bit[2]    : 该bit控制debug等级为证书认证方式（efuse bit2025为0，efuse bit2026为1）下MCPU和M7的spiden信号以及M3和M7的dbgen信号。
                                                                    写该bit为1则MCPU和M7的spiden被配置为0x1；
                                                                    写该bit为0则MCPU和M7的spiden被配置为0x0；
                                                                    同时写该寄存器的bit2和bit0为1，则M3和M7的dbgen信号被配置为0x1； */
        unsigned int  secure_CPU_spniden_en    : 1;  /* bit[3]    : 该bit控制debug等级为证书认证方式（efuse bit2025为0，efuse bit2026为1）下MCPU的spniden信号和M7的niden信号。
                                                                    写该bit为1则MCPU的spniden被配置为0x1；
                                                                    写该bit为0则MCPU的spniden被配置为0x0；
                                                                    同时写该寄存器的bit3和bit1为1，则M7的niden信号被配置为0x1； */
        unsigned int  switch_CPU_dbgen_en      : 1;  /* bit[4]    : 该bit控制debug等级为证书认证方式（efuse bit2025为0，efuse bit2026为1）下A53和CCI的dbgen信号：
                                                                    写该bit为1则A53和CCI的dbgen被配置为0x1；
                                                                    写该bit为0则A53和CCI的dbgen被配置为0x0。 */
        unsigned int  switch_CPU_niden_en      : 1;  /* bit[5]    : 该bit控制debug等级为证书认证方式（efuse bit2025为0，efuse bit2026为1）下A53和CCI以及CCI400的niden信号：
                                                                    写该bit为1则A53和CCI的niden被配置为0x1；
                                                                    写该bit为0则A53和CCI的niden被配置为0x0。 */
        unsigned int  switch_CPU_spiden_en     : 1;  /* bit[6]    : 该bit控制debug等级为证书认证方式（efuse bit2025为0，efuse bit2026为1）下A53和CCI的spiden信号：
                                                                    写该bit为1则A53和CCI的spiden被配置为0x1；
                                                                    写该bit为0则A53和CCI的spiden被配置为0x0。 */
        unsigned int  switch_CPU_spniden_en    : 1;  /* bit[7]    : 该bit控制debug等级为证书认证方式（efuse bit2025为0，efuse bit2026为1）下A53和CCI的spniden信号：
                                                                    写该bit为1则A53和CCI的spniden被配置为0x1；
                                                                    写该bit为0则A53和CCI的spniden被配置为0x0。 */
        unsigned int  nonsecure_CPU_dbgen_en   : 1;  /* bit[8]    : 该bit控制debug等级为证书认证方式（efuse bit2025为0，efuse bit2026为1）下ISP A7的dbgen信号：
                                                                    写该bit为1则ISP A7的dbgen被配置为0x1；
                                                                    写该bit为0则ISP A7的dbgen被配置为0x0。 */
        unsigned int  nonsecure_CPU_niden_en   : 1;  /* bit[9]    : 该bit控制debug等级为证书认证方式（efuse bit2025为0，efuse bit2026为1）下ISP A7的niden信号：
                                                                    写该bit为1则ISP A7的niden被配置为0x1；
                                                                    写该bit为0则ISP A7的niden被配置为0x0。 */
        unsigned int  nonsecure_CPU_spiden_en  : 1;  /* bit[10]   : 该bit控制debug等级为证书认证方式（efuse bit2025为0，efuse bit2026为1）下ISP A7的spiden信号：
                                                                    写该bit为1则ISP A7的spiden被配置为0x1；
                                                                    写该bit为0则ISP A7的spiden被配置为0x0。 */
        unsigned int  nonsecure_CPU_spniden_en : 1;  /* bit[11]   : 该bit控制debug等级为证书认证方式（efuse bit2025为0，efuse bit2026为1）下ISP A7的spniden信号：
                                                                    写该bit为1则ISP A7的spniden被配置为0x1；
                                                                    写该bit为0则ISP A7的spniden被配置为0x0。 */
        unsigned int  reserved_0               : 4;  /* bit[12-15]: 保留 */
        unsigned int  CBBE16_dsp_dbgen_en      : 1;  /* bit[16]   : 该bit控制debug等级为证书认证方式（efuse bit2025为0，efuse bit2026为1）下CBBE16的dbgen信号：
                                                                    写该bit为1则CBBE16的dbgen被配置为0x1；
                                                                    写该bit为0则CBBE16的dbgen被配置为0x0。 */
        unsigned int  reserved_1               : 1;  /* bit[17]   : 
                                                                    Dallas中IVP DSP删除。该bit保留。
                                                                    该bit控制debug等级为证书认证方式（efuse bit2025为0，efuse bit2026为1）下IVP DSP的dbgen信号：
                                                                    写该bit为1则IVP DSP的dbgen被配置为0x1；
                                                                    写该bit为0则IVP DSP的dbgen被配置为0x0。 */
        unsigned int  hifi_dsp_dbgen_en        : 1;  /* bit[18]   : 该bit控制debug等级为证书认证方式（efuse bit2025为0，efuse bit2026为1）下hifi DSP的dbgen信号：
                                                                    写该bit为1则hifi DSP的dbgen被配置为0x1；
                                                                    写该bit为0则hifi DSP的dbgen被配置为0x0。 */
        unsigned int  BBE16_dsp_dbgen_en       : 1;  /* bit[19]   : 该bit控制debug等级为证书认证方式（efuse bit2025为0，efuse bit2026为1）下BBE16的dbgen信号：
                                                                    写该bit为1则BBE16的dbgen被配置为0x1；
                                                                    写该bit为0则BBE16的dbgen被配置为0x0。 */
        unsigned int  coresight_deviceen_en    : 1;  /* bit[20]   : 该bit控制debug等级为证书认证方式（efuse bit2025为0，efuse bit2026为1）下coresight的deviceen信号：
                                                                    写该bit为1则coresight的deviceen被配置为0x1；
                                                                    写该bit为0则coresight的deviceen被配置为0x0。 */
        unsigned int  coresight_dbgen_en       : 1;  /* bit[21]   : 该bit控制debug等级为证书认证方式（efuse bit2025为0，efuse bit2026为1）下coresight的dbgen信号：
                                                                    写该bit为1则coresight的dbgen被配置为0x1；
                                                                    写该bit为0则coresight的dbgen被配置为0x0。 */
        unsigned int  coresight_niden_en       : 1;  /* bit[22]   : 该bit控制debug等级为证书认证方式（efuse bit2025为0，efuse bit2026为1）下coresight的niden信号：
                                                                    写该bit为1则coresight的niden被配置为0x1；
                                                                    写该bit为0则coresight的niden被配置为0x0。 */
        unsigned int  coresight_spiden_en      : 1;  /* bit[23]   : 该bit控制debug等级为证书认证方式（efuse bit2025为0，efuse bit2026为1）下coresight的spiden信号：
                                                                    写该bit为1则coresight的spiden被配置为0x1；
                                                                    写该bit为0则coresight的spiden被配置为0x0。 */
        unsigned int  coresight_spniden_en     : 1;  /* bit[24]   : 该bit控制debug等级为证书认证方式（efuse bit2025为0，efuse bit2026为1）下coresight的spniden信号：
                                                                    写该bit为1则coresight的spniden被配置为0x1；
                                                                    写该bit为0则coresight的spniden被配置为0x0。 */
        ...
        unsigned int  lock_bit                 : 1;  /* bit[31]   : Writing 1 to this field locks the DCU_EN bits for further writing.
                                                                    该bit为本寄存器的写锁定控制位。一旦该bit被写1之后，再改写本寄存器，配置无效。 */
    } reg;
...
#define SOC_SECENG_S_HOST_DCU_EN_CBBE16_dsp_dbgen_en_START       (16)
#define SOC_SECENG_S_HOST_DCU_EN_CBBE16_dsp_dbgen_en_END         (16)
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_SECURE_TIMER_BIST_KICK_UNION
 结构说明  : HOST_SECURE_TIMER_BIST_KICK 寄存器结构定义。地址偏移量:0x0A68，初值:0x00000000，宽度:32
 寄存器说明: Secure Timer BIST Kick signal。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_SECURE_TIMER_BIST_VAL_UNION
 结构说明  : HOST_SECURE_TIMER_BIST_VAL 寄存器结构定义。地址偏移量:0x0A6C，初值:0x00000000，宽度:32
 寄存器说明: this register holds the Secure Timer BIST result。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_CC_AO_TEST_UNION
 结构说明  : HOST_CC_AO_TEST 寄存器结构定义。地址偏移量:0x0A70，初值:0x00000000，宽度:32
 寄存器说明: Writing to this register sets/resets the CryptoCell to Always-On test signal。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_LOW_RES_SECURE_TIMER_RST_UNION
 结构说明  : HOST_LOW_RES_SECURE_TIMER_RST 寄存器结构定义。地址偏移量:0x0A74，初值:0x00000000，宽度:32
 寄存器说明: Writing to this register resets the low-resolution Secure Timer (residing in the Always-On model)。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_LOW_RES_SECURE_TIMER_0_UNION
 结构说明  : HOST_LOW_RES_SECURE_TIMER_0 寄存器结构定义。地址偏移量:0x0A78，初值:0x00000000，宽度:32
 寄存器说明: This register holds the low-resolution Secure Timer value, bits 31:0 (residing in the Always-On model)。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_LOW_RES_SECURE_TIMER_1_UNION
 结构说明  : HOST_LOW_RES_SECURE_TIMER_1 寄存器结构定义。地址偏移量:0x0A7C，初值:0x00000000，宽度:32
 寄存器说明: This register holds the low-resolution Secure Timer value, bits 63:32 (residing in the Always-On model)。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_HIGH_RES_SECURE_TIMER_RST_UNION
 结构说明  : HOST_HIGH_RES_SECURE_TIMER_RST 寄存器结构定义。地址偏移量:0x0A80，初值:0x00000000，宽度:32
 寄存器说明: Writing to this register resets the high-resolution Secure Timer。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_HIGH_RES_SECURE_TIMER_0_UNION
 结构说明  : HOST_HIGH_RES_SECURE_TIMER_0 寄存器结构定义。地址偏移量:0x0A84，初值:0x00000000，宽度:32
 寄存器说明: This register holds the high-resolution Secure Timer value, bits 31:0。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_HIGH_RES_SECURE_TIMER_1_UNION
 结构说明  : HOST_HIGH_RES_SECURE_TIMER_1 寄存器结构定义。地址偏移量:0x0A88，初值:0x00000000，宽度:32
 寄存器说明: This register holds the high-resolution Secure Timer value, bits 39:32。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_HIGH_RES_SECURE_TIMER_TH_0_UNION
 结构说明  : HOST_HIGH_RES_SECURE_TIMER_TH_0 寄存器结构定义。地址偏移量:0x0A8C，初值:0x00000000，宽度:32
 寄存器说明: This register holds the high-resolution Secure Timer value, bits 31:0。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_HIGH_RES_SECURE_TIMER_TH_1_UNION
 结构说明  : HOST_HIGH_RES_SECURE_TIMER_TH_1 寄存器结构定义。地址偏移量:0x0A90，初值:0x00000000，宽度:32
 寄存器说明: This register holds the high-resolution Secure Timer value, bits 39:32。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_LATCHED_EXTERNAL_TIMER_0_UNION
 结构说明  : HOST_LATCHED_EXTERNAL_TIMER_0 寄存器结构定义。地址偏移量:0x0A94，初值:0x00000000，宽度:32
 寄存器说明: This register holds the latched value of the low-resolution Secure Timer, bits 31:0 (latched at reset of high-resolution timer)。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_LATCHED_EXTERNAL_TIMER_1_UNION
 结构说明  : HOST_LATCHED_EXTERNAL_TIMER_1 寄存器结构定义。地址偏移量:0x0A98，初值:0x00000000，宽度:32
 寄存器说明: This register holds the latched value of the low-resolution Secure Timer, bits 64:32 (latched at reset of high-resolution timer)。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_NVM_CC_BOOT_UNION
 结构说明  : NVM_CC_BOOT 寄存器结构定义。地址偏移量:0x00AA0，初值:0x00000006，宽度:32
 寄存器说明: reflects HW Defines in the NVM
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_1          : 29; /* bit[3-31]: 保留 */
    } reg;
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_AIB_ADDR_REG_UNION
 结构说明  : HOST_AIB_ADDR_REG 寄存器结构定义。地址偏移量:0x00AA4，初值:0x00000000，宽度:32
 寄存器说明: This register serves for indirect access to the NVM。 NOTE! This is a special register, affected by internal logic。 Test result of this register is NA。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_AIB_WDATA_REG_UNION
 结构说明  : HOST_AIB_WDATA_REG 寄存器结构定义。地址偏移量:0x00AA8，初值:0x00000000，宽度:32
 寄存器说明: The write data for AIB transactions should be written to this register。 NOTE! This is a special register, affected by internal logic。 Test result of this register is NA。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_AIB_RDATA_REG_UNION
 结构说明  : HOST_AIB_RDATA_REG 寄存器结构定义。地址偏移量:0x00AAC，初值:0x00000000，宽度:32
 寄存器说明: The data for AIB transactions can be read from this register。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AIB_FUSE_PROG_COMPLETED_UNION
 结构说明  : AIB_FUSE_PROG_COMPLETED 寄存器结构定义。地址偏移量:0x00AB0，初值:0x00000000，宽度:32
 寄存器说明: This register reflects the fuse_aib_prog_completed input, which indicates that the fuse programming was completed。 NOTE! This is a special register, affected by internal logic。 Test result of this register is NA。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AIB_FUSE_ACK_UNION
 结构说明  : AIB_FUSE_ACK 寄存器结构定义。地址偏移量:0x00AB4，初值:0x00000000，宽度:32
 寄存器说明: This register reflects the fuse_aib_ack input, which indicates that the AIB transaction was completed。 NOTE! This is a special register, affected by internal logic。 Test result of this register is NA。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AIB_DEBUG_STATUS_UNION
 结构说明  : AIB_DEBUG_STATUS 寄存器结构定义。地址偏移量:0x00AB8，初值:0x00000000，宽度:32
 寄存器说明: AIB debug status register。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_LCS_IS_VALID_UNION
 结构说明  : LCS_IS_VALID 寄存器结构定义。地址偏移量:0x00ABC，初值:0x00000000，宽度:32
 寄存器说明: Indicates that the LCS register holds a valid value。 NOTE! This is a special register, affected by internal logic。 Test result of this register is NA。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_SESSION_KEY0_UNION
 结构说明  : HOST_SESSION_KEY0 寄存器结构定义。地址偏移量:0x00AC0，初值:0x00000000，宽度:32
 寄存器说明: Bits [31:0] of the Session key
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_SESSION_KEY1_UNION
 结构说明  : HOST_SESSION_KEY1 寄存器结构定义。地址偏移量:0x00AC4，初值:0x00000000，宽度:32
 寄存器说明: Bits [63:32] of the Session key
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_SESSION_KEY2_UNION
 结构说明  : HOST_SESSION_KEY2 寄存器结构定义。地址偏移量:0x00AC8，初值:0x00000000，宽度:32
 寄存器说明: Bits [95:64] of the Session key
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_SESSION_KEY3_UNION
 结构说明  : HOST_SESSION_KEY3 寄存器结构定义。地址偏移量:0x00ACC，初值:0x00000000，宽度:32
 寄存器说明: Bits [127:96] of the Session key。 Writing to this register also creates a write pulse toward the always-on module。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_SEESION_KEY_IS_VALID_UNION
 结构说明  : HOST_SEESION_KEY_IS_VALID 寄存器结构定义。地址偏移量:0x00AD0，初值:0x00000000，宽度:32
 寄存器说明: Indication from the always-on register that the session key is valid。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_LCS_REG_UNION
 结构说明  : LCS_REG 寄存器结构定义。地址偏移量:0x00AD4，初值:0x00000005，宽度:32
 寄存器说明: The lifecycle state register。 NOTE! This is a special register, affected by internal logic。 Test result of this register is NA。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_CPC_SECURITY_DISABLE_UNION
 结构说明  : HOST_CPC_SECURITY_DISABLE 寄存器结构定义。地址偏移量:0x00AD8，初值:0x00000000，宽度:32
 寄存器说明: Host disable security for the current power cycle。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_AO_CC_STATE_COUNTER_UNION
 结构说明  : HOST_AO_CC_STATE_COUNTER 寄存器结构定义。地址偏移量:0x00ADC，初值:0xFFFFFFFF，宽度:32
 寄存器说明: The Always-On state counter。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_CC_AO_STATE_COUNTER_INC_UNION
 结构说明  : HOST_CC_AO_STATE_COUNTER_INC 寄存器结构定义。地址偏移量:0x00AE0，初值:0x00000000，宽度:32
 寄存器说明: State counter increment。 Writing any value to this address asserts the CC_AO_STATE_COUNTER_INC outputs for 1 cycle。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_AO_CC_IS_SD_UNION
 结构说明  : HOST_AO_CC_IS_SD 寄存器结构定义。地址偏移量:0x00AE4，初值:0x00000000，宽度:32
 寄存器说明: This register reflects the Host AO_CC_IS_SD input from the Always-On that determines the LCS is Secure-Disabled。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_HOST_RMA_RKEK_WR_UNION
 结构说明  : HOST_RMA_RKEK_WR 寄存器结构定义。地址偏移量:0x00AE8，初值:0x00000000，宽度:32
 寄存器说明: This register interface is used to update the RKEK registers when the device is in RMA mode, The RKEK is updated by shifting when MSB word is written first。 After the eighth writing the registers are blocked for further writing。 (write -once)。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_INFLIGHT0_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_INFLIGHT1_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_INFLIGHT2_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_INFLIGHT3_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_INFLIGHT4_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_INFLIGHT5_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_INFLIGHT8_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_INFLIGHT9_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_INFLIGHT10_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_INFLIGHT11_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_INFLIGHTLAST0_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_INFLIGHTLAST1_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_INFLIGHTLAST2_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_INFLIGHTLAST3_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_INFLIGHTLAST4_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_INFLIGHTLAST5_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_INFLIGHTLAST8_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_INFLIGHTLAST9_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_INFLIGHTLAST10_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_INFLIGHTLAST11_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_PIDTABLE0_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_PIDTABLE1_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_PIDTABLE2_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_PIDTABLE3_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_COMP0_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_COMP1_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_COMP2_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_COMP3_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_COMP4_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_COMP5_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_COMP8_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_COMP9_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_COMP10_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_COMP11_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_RMAX_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_RMIN_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_WMAX_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_WMIN_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_MON_ERR_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_RDSTAT_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_RLATENCY_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_RBURST_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_WLATENCY_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_WBURST_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_CACHETYPE_CFG_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_PROT_CFG_UNION
...
typedef union
{
    ...
    {
        unsigned int  reserved_0: 2;  /* bit[0-1]  : 保留 */
        unsigned int  reserved_1: 2;  /* bit[2-3]  : 保留 */
        unsigned int  dd_arprot : 1;  /* bit[4]    : Control the ARPROT value of the direct data. */
        unsigned int  reserved_2: 3;  /* bit[5-7]  : 保留 */
        unsigned int  reserved_3: 2;  /* bit[8-9]  : 保留 */
        unsigned int  reserved_4: 2;  /* bit[10-11]: 保留 */
        unsigned int  dd_awprot : 1;  /* bit[12]   : Control the AWPROT value of the direct data. */
        unsigned int  reserved_5: 3;  /* bit[13-15]: 保留 */
        unsigned int  reserved_6: 16; /* bit[16-31]: 保留 */
    } reg;
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_CFG1_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_ACE_CONST_UNION
 结构说明  : AXIM_ACE_CONST 寄存器结构定义。地址偏移量:0x00BEC，初值:0x11FC100A，宽度:32
 寄存器说明: AXIM ACE CONST。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXIM_CACHE_PARAMS_UNION
 结构说明  : AXIM_CACHE_PARAMS 寄存器结构定义。地址偏移量:0x00BF0，初值:0x00000777，宽度:32
 寄存器说明: AXI master configuration for DMA。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_ADDR_AXIM_CTRL_UNION
 结构说明  : ADDR_AXIM_CTRL 寄存器结构定义。地址偏移量:0x00BF4，初值:0x00000002，宽度:32
 寄存器说明: Control AXI master。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DIN_BUFFER_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DIN_MEM_DMA_BUSY_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_SRC_LLI_SRAM_ADDR_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_SRC_LLI_WORD0_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_SRC_LLI_WORD1_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_SRAM_SRC_ADDR_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DIN_SRAM_BYTES_LEN_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DIN_SRAM_DMA_BUSY_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DIN_SRAM_ENDIANNESS_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXI_CPU_DIN_PARAMS_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DIN_SW_RESET_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DIN_CPU_DATA_SIZE_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_WRITE_ALIGN_LAST_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_FIFO_IN_EMPTY_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DISABLE_OUTSTD_REQ_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DIN_FIFO_RST_PNTR_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DOUT_BUFFER_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DOUT_MEM_DMA_BUSY_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DST_LLI_SRAM_ADDR_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DST_LLI_WORD0_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DST_LLI_WORD1_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_SRAM_DEST_ADDR_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DOUT_SRAM_BYTES_LEN_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DOUT_SRAM_DMA_BUSY_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DOUT_SRAM_ENDIANNESS_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_READ_ALIGN_LAST_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DOUT_FIFO_EMPTY_UNION
 结构说明  : DOUT_FIFO_EMPTY 寄存器结构定义。地址偏移量:0x00D50，初值:0x00000000，宽度:32
 寄存器说明: DOUT_FIFO_EMPTY Register。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_AXI_CPU_DOUT_PARAMS_UNION
 结构说明  : AXI_CPU_DOUT_PARAMS 寄存器结构定义。地址偏移量:0x00D54，初值:0x00008000，宽度:32
 寄存器说明: AXI_CPU_DOUT_PARAMS Register。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DOUT_SW_RESET_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DSCRPTR_COMPLETION_COUNTER0_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DSCRPTR_COMPLETION_COUNTER1_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DSCRPTR_COMPLETION_STATUS_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DSCRPTR_SW_RESET_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DSCRPTR_DEBUG_MODE_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DSCRPTR_SINGLE_ADDR_EN_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DSCRPTR_MEASURE_CNTR_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DSCRPTR_FILTER_DROPPED_ADDRESS_HIGH_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DSCRPTR_QUEUE0_WORD0_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DSCRPTR_QUEUE0_WORD1_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DSCRPTR_QUEUE0_WORD2_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DSCRPTR_QUEUE0_WORD3_UNION
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved          : 1;  /* bit[28]   : 保留 */
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DSCRPTR_QUEUE0_WORD4_UNION
...
typedef union
{
    ...
    struct
    {
        unsigned int  data_flow_mode       : 6;  /* bit[0-5]  : Data-flow mode:
                                                                ...
                                                                · 6'd44 - SET-FLOW-ID  */
        unsigned int  reserved             : 1;  /* bit[6]    : 保留 */
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DSCRPTR_QUEUE0_WORD5_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DSCRPTR_QUEUE0_WATERMARK_UNION
 结构说明  : DSCRPTR_QUEUE0_WATERMARK 寄存器结构定义。地址偏移量:0x00E98，初值:0x0000001F，宽度:32
 寄存器说明: This register holds the watermark value of descriptor queue0。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_DSCRPTR_QUEUE0_CONTENT_UNION
 结构说明  : DSCRPTR_QUEUE0_CONTENT 寄存器结构定义。地址偏移量:0x00E9C，初值:0x0000000F，宽度:32
 寄存器说明: This register holds the number of empty entries in descriptor queue0。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_SRAM_DATA_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_SRAM_ADDR_UNION
...
/*****************************************************************************
 结构名    : SOC_SECENG_S_SRAM_DATA_READY_UNION
