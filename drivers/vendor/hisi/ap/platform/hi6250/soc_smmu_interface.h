...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  smr_ptw_qos     : 6;  /* bit[5-10] : Qos control for PTW transaction. */
        unsigned int  smr_nscfg_en    : 1;  /* bit[11]   : Enable control of Secure configuration. When Enable, AxPROT[1] of TBU will use the value of smr_nscfg.
                                                           Only can be modified in secure mode. */
...
#define SOC_SMMU_SMRx_smr_ptw_qos_END        (10)
#define SOC_SMMU_SMRx_smr_nscfg_en_START     (11)
#define SOC_SMMU_SMRx_smr_nscfg_en_END       (11)
