...
typedef union
{
    ...
    struct
    {
        unsigned int  local_sensorerror   : 10; /* bit[0-9]  : Tsensor1 ATE 温度校准误差信息，最高位表示符号：
                                                               1：采样温度减去校准误差
                                                               0：采样温度加上校准误差。 */
...
typedef union
{
    ...
    struct
    {
        unsigned int  local_sensorerror   : 10; /* bit[0-9]  : Tsensor2 ATE 温度校准误差信息，最高位表示符号：
                                                               1：采样温度减去校准误差
                                                               0：采样温度加上校准误差。 */
        unsigned int  remote_sensor1error : 6;  /* bit[10-15]: reserved */
        unsigned int  remote_sensor2error : 8;  /* bit[16-23]: reserved */
...
typedef union
{
    ...
    struct
    {
        unsigned int  local_sensorerror   : 10; /* bit[0-9]  : Tsensor3 ATE 温度校准误差信息，最高位表示符号：
                                                               1：采样温度减去校准误差
                                                               0：采样温度加上校准误差。 */
        unsigned int  remote_sensor1error : 6;  /* bit[10-15]: reserved */
        unsigned int  remote_sensor2error : 8;  /* bit[16-23]: reserved */
...
typedef union
{
    ...
    struct
    {
        unsigned int  local_sensorerror   : 10; /* bit[0-9]  : Tsensor4 ATE 温度校准误差信息，最高位表示符号：
                                                               1：采样温度减去校准误差
                                                               0：采样温度加上校准误差。 */
        unsigned int  remote_sensor1error : 6;  /* bit[10-15]: reserved */
        unsigned int  remote_sensor2error : 8;  /* bit[16-23]: reserved */
