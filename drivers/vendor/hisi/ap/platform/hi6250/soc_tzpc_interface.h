...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  gpio28        : 1;  /* bit[29]: gpio28 slv上电默认为安全属性。 */
        unsigned int  gpio29        : 1;  /* bit[30]: gpio29 slv上电默认为安全属性。 */
        unsigned int  gpio30        : 1;  /* bit[31]: gpio30 slv上电默认为安全属性。 */
    } reg;
...
#define SOC_TZPC_DECPROT0STAT_gpio28_START         (29)
#define SOC_TZPC_DECPROT0STAT_gpio28_END           (29)
#define SOC_TZPC_DECPROT0STAT_gpio29_START         (30)
#define SOC_TZPC_DECPROT0STAT_gpio29_END           (30)
#define SOC_TZPC_DECPROT0STAT_gpio30_START         (31)
#define SOC_TZPC_DECPROT0STAT_gpio30_END           (31)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  gpio28        : 1;  /* bit[29]:  */
        unsigned int  gpio29        : 1;  /* bit[30]:  */
        unsigned int  gpio30        : 1;  /* bit[31]:  */
    } reg;
...
#define SOC_TZPC_DECPROT0SET_gpio28_START         (29)
#define SOC_TZPC_DECPROT0SET_gpio28_END           (29)
#define SOC_TZPC_DECPROT0SET_gpio29_START         (30)
#define SOC_TZPC_DECPROT0SET_gpio29_END           (30)
#define SOC_TZPC_DECPROT0SET_gpio30_START         (31)
#define SOC_TZPC_DECPROT0SET_gpio30_END           (31)
...
#define SOC_TZPC_DECPROT0CLR_gpio28_START         (29)
#define SOC_TZPC_DECPROT0CLR_gpio28_END           (29)
#define SOC_TZPC_DECPROT0CLR_gpio29_START         (30)
#define SOC_TZPC_DECPROT0CLR_gpio29_END           (30)
#define SOC_TZPC_DECPROT0CLR_gpio30_START         (31)
#define SOC_TZPC_DECPROT0CLR_gpio30_END           (31)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  Loadmonitor   : 1;  /* bit[1] : Loadmonitor slv上电默认为安全属性。 */
...
#endif
#define SOC_TZPC_DECPROT1STAT_Loadmonitor_START    (1)
#define SOC_TZPC_DECPROT1STAT_Loadmonitor_END      (1)
...
typedef union
{
    ...
    struct
    {
        unsigned int  reserved_0    : 1;  /* bit[0] : IP安全属性置位：
                                                      0：IP安全属性不变；
                                                      1：IP安全属性置“1”。 */
        unsigned int  Loadmonitor   : 1;  /* bit[1] :  */
...
#endif
#define SOC_TZPC_DECPROT1SET_Loadmonitor_START    (1)
#define SOC_TZPC_DECPROT1SET_Loadmonitor_END      (1)
...
#endif
#define SOC_TZPC_DECPROT1CLR_Loadmonitor_START    (1)
#define SOC_TZPC_DECPROT1CLR_Loadmonitor_END      (1)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_2     : 1;  /* bit[30]   : reserved */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_1     : 1;  /* bit[27]   :  */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  usbotg    : 1;  /* bit[1] : USBOTG（内部寄存器） slv上电默认为安全属性。 */
        unsigned int  usbotg_bc : 1;  /* bit[2] : USBOTG （BC寄存器） slv上电默认为安全属性。 */
        unsigned int  perf_stat : 1;  /* bit[3] : perf_stat slv上电默认为安全属性。 */
        unsigned int  ipf       : 1;  /* bit[4] : ipf slv上电默认为安全属性。 */
        ...
        unsigned int  ipc_s_mdm : 1;  /* bit[23]: ipc_s_mdm slv上电默认为安全属性。 */
        unsigned int  reserved_2: 1;  /* bit[24]: 保留。 */
        unsigned int  reserved_3: 1;  /* bit[25]: 保留。 */
        unsigned int  reserved_4: 1;  /* bit[26]: 保留。 */
        unsigned int  reserved_5: 1;  /* bit[27]: 保留。 */
        unsigned int  reserved_6: 1;  /* bit[28]: 保留。 */
        unsigned int  reserved_7: 1;  /* bit[29]: 保留。 */
        unsigned int  reserved_8: 1;  /* bit[30]: 保留。 */
        unsigned int  reserved_9: 1;  /* bit[31]: 保留。 */
    } reg;
} SOC_TZPC_DECPROT4STAT_UNION;
#endif
#define SOC_TZPC_DECPROT4STAT_socp_START       (0)
#define SOC_TZPC_DECPROT4STAT_socp_END         (0)
#define SOC_TZPC_DECPROT4STAT_usbotg_START     (1)
#define SOC_TZPC_DECPROT4STAT_usbotg_END       (1)
#define SOC_TZPC_DECPROT4STAT_usbotg_bc_START  (2)
#define SOC_TZPC_DECPROT4STAT_usbotg_bc_END    (2)
#define SOC_TZPC_DECPROT4STAT_perf_stat_START  (3)
#define SOC_TZPC_DECPROT4STAT_perf_stat_END    (3)
#define SOC_TZPC_DECPROT4STAT_ipf_START        (4)
#define SOC_TZPC_DECPROT4STAT_ipf_END          (4)
...
#define SOC_TZPC_DECPROT4STAT_ipc_s_mdm_START  (23)
#define SOC_TZPC_DECPROT4STAT_ipc_s_mdm_END    (23)
...
typedef union
{
    ...
    struct
    {
        unsigned int  socp      : 1;  /* bit[0] : IP安全属性置位：
                                                  0：IP安全属性不变；
                                                  1：IP安全属性置“1”。 */
        unsigned int  usbotg    : 1;  /* bit[1] :  */
        unsigned int  usbotg_bc : 1;  /* bit[2] :  */
        unsigned int  perf_stat : 1;  /* bit[3] :  */
        unsigned int  ipf       : 1;  /* bit[4] :  */
...
#define SOC_TZPC_DECPROT4SET_usbotg_START     (1)
#define SOC_TZPC_DECPROT4SET_usbotg_END       (1)
#define SOC_TZPC_DECPROT4SET_usbotg_bc_START  (2)
#define SOC_TZPC_DECPROT4SET_usbotg_bc_END    (2)
#define SOC_TZPC_DECPROT4SET_perf_stat_START  (3)
#define SOC_TZPC_DECPROT4SET_perf_stat_END    (3)
#define SOC_TZPC_DECPROT4SET_ipf_START        (4)
#define SOC_TZPC_DECPROT4SET_ipf_END          (4)
...
#define SOC_TZPC_DECPROT4SET_ipc_s_mdm_START  (23)
#define SOC_TZPC_DECPROT4SET_ipc_s_mdm_END    (23)
...
#define SOC_TZPC_DECPROT4CLR_usbotg_START     (1)
#define SOC_TZPC_DECPROT4CLR_usbotg_END       (1)
#define SOC_TZPC_DECPROT4CLR_usbotg_bc_START  (2)
#define SOC_TZPC_DECPROT4CLR_usbotg_bc_END    (2)
#define SOC_TZPC_DECPROT4CLR_perf_stat_START  (3)
#define SOC_TZPC_DECPROT4CLR_perf_stat_END    (3)
#define SOC_TZPC_DECPROT4CLR_ipf_START        (4)
#define SOC_TZPC_DECPROT4CLR_ipf_END          (4)
...
#define SOC_TZPC_DECPROT4CLR_ipc_s_mdm_START  (23)
#define SOC_TZPC_DECPROT4CLR_ipc_s_mdm_END    (23)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_5    : 1;  /* bit[22]: 保留。 */
        unsigned int  reserved_6    : 1;  /* bit[23]: 保留。 */
        unsigned int  reserved_7    : 1;  /* bit[24]: 保留。 */
        unsigned int  reserved_8    : 1;  /* bit[25]: 保留。 */
        unsigned int  reserved_9    : 1;  /* bit[26]: 保留。 */
        unsigned int  reserved_10   : 1;  /* bit[27]: 保留。 */
        unsigned int  reserved_11   : 1;  /* bit[28]: 保留。 */
        unsigned int  reserved_12   : 1;  /* bit[29]: 保留。 */
        unsigned int  reserved_13   : 1;  /* bit[30]: 保留。 */
        unsigned int  reserved_14   : 1;  /* bit[31]: 保留。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : DECPROT6STAT 寄存器结构定义。地址偏移量:0x848，初值:0xFFEFFE60，宽度:32
 寄存器说明: IP安全属性状态寄存器6。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  usbotg           : 1;  /* bit[8] : usbotg mst上电默认为安全属性。 */
        ...
        unsigned int  ipf              : 1;  /* bit[19]: ipf mst上电默认为非安全属性。 */
        unsigned int  psam             : 1;  /* bit[20]: psam mst上电默认为安全属性。 */
...
#define SOC_TZPC_DECPROT6STAT_usbotg_START            (8)
#define SOC_TZPC_DECPROT6STAT_usbotg_END              (8)
...
#define SOC_TZPC_DECPROT6STAT_ipf_START               (19)
#define SOC_TZPC_DECPROT6STAT_ipf_END                 (19)
#define SOC_TZPC_DECPROT6STAT_psam_START              (20)
#define SOC_TZPC_DECPROT6STAT_psam_END                (20)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  ipf              : 1;  /* bit[19]:  */
        unsigned int  psam             : 1;  /* bit[20]:  */
...
#define SOC_TZPC_DECPROT6SET_usbotg_START            (8)
#define SOC_TZPC_DECPROT6SET_usbotg_END              (8)
...
#define SOC_TZPC_DECPROT6SET_ipf_START               (19)
#define SOC_TZPC_DECPROT6SET_ipf_END                 (19)
#define SOC_TZPC_DECPROT6SET_psam_START              (20)
#define SOC_TZPC_DECPROT6SET_psam_END                (20)
...
#define SOC_TZPC_DECPROT6CLR_usbotg_START            (8)
#define SOC_TZPC_DECPROT6CLR_usbotg_END              (8)
...
#define SOC_TZPC_DECPROT6CLR_ipf_START               (19)
#define SOC_TZPC_DECPROT6CLR_ipf_END                 (19)
#define SOC_TZPC_DECPROT6CLR_psam_START              (20)
#define SOC_TZPC_DECPROT6CLR_psam_END                (20)


/*****************************************************************************
 结构名    : SOC_TZPC_DECPROT7STAT_UNION
 结构说明  : DECPROT7STAT 寄存器结构定义。地址偏移量:0x854，初值:0x00000003，宽度:32
 寄存器说明: IP安全属性状态寄存器7。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  psam_ns_region : 1;  /* bit[0]   : psam slv内部非安全region上电默认为非安全属性。 */
        unsigned int  ipf_ns_region  : 1;  /* bit[1]   : ipf slv内部非安全region上电默认为非安全属性。 */
        unsigned int  psam_s_region  : 1;  /* bit[2]   : psam slv内部安全region上电默认为非安全属性。 */
        unsigned int  ipf_s_region   : 1;  /* bit[3]   : ipf slv内部安全region上电默认为非安全属性。 */
        unsigned int  reserved       : 28; /* bit[4-31]: 保留。 */
    } reg;
} SOC_TZPC_DECPROT7STAT_UNION;
#endif
#define SOC_TZPC_DECPROT7STAT_psam_ns_region_START  (0)
#define SOC_TZPC_DECPROT7STAT_psam_ns_region_END    (0)
#define SOC_TZPC_DECPROT7STAT_ipf_ns_region_START   (1)
#define SOC_TZPC_DECPROT7STAT_ipf_ns_region_END     (1)
#define SOC_TZPC_DECPROT7STAT_psam_s_region_START   (2)
#define SOC_TZPC_DECPROT7STAT_psam_s_region_END     (2)
#define SOC_TZPC_DECPROT7STAT_ipf_s_region_START    (3)
#define SOC_TZPC_DECPROT7STAT_ipf_s_region_END      (3)
...
typedef union
{
    ...
    struct
    {
        unsigned int  psam_ns_region : 1;  /* bit[0]   : IP安全属性置位：
                                                         0：IP安全属性不变；
                                                         1：IP安全属性置“1”。 */
        unsigned int  ipf_ns_region  : 1;  /* bit[1]   :  */
        unsigned int  psam_s_region  : 1;  /* bit[2]   :  */
        unsigned int  ipf_s_region   : 1;  /* bit[3]   :  */
        unsigned int  reserved       : 28; /* bit[4-31]: 保留。 */
    } reg;
} SOC_TZPC_DECPROT7SET_UNION;
#endif
#define SOC_TZPC_DECPROT7SET_psam_ns_region_START  (0)
#define SOC_TZPC_DECPROT7SET_psam_ns_region_END    (0)
#define SOC_TZPC_DECPROT7SET_ipf_ns_region_START   (1)
#define SOC_TZPC_DECPROT7SET_ipf_ns_region_END     (1)
#define SOC_TZPC_DECPROT7SET_psam_s_region_START   (2)
#define SOC_TZPC_DECPROT7SET_psam_s_region_END     (2)
#define SOC_TZPC_DECPROT7SET_ipf_s_region_START    (3)
#define SOC_TZPC_DECPROT7SET_ipf_s_region_END      (3)
...
#endif
#define SOC_TZPC_DECPROT7CLR_psam_ns_region_START  (0)
#define SOC_TZPC_DECPROT7CLR_psam_ns_region_END    (0)
#define SOC_TZPC_DECPROT7CLR_ipf_ns_region_START   (1)
#define SOC_TZPC_DECPROT7CLR_ipf_ns_region_END     (1)
#define SOC_TZPC_DECPROT7CLR_psam_s_region_START   (2)
#define SOC_TZPC_DECPROT7CLR_psam_s_region_END     (2)
#define SOC_TZPC_DECPROT7CLR_ipf_s_region_START    (3)
#define SOC_TZPC_DECPROT7CLR_ipf_s_region_END      (3)
