...
/* 寄存器说明：VENC Transaction Probe的bin_0配置
   位域定义UNION结构:  SOC_VCODEC_BUS_VENC_TRANS_P_THRESHOLDS_0_0_UNION */
#define SOC_VCODEC_BUS_VENC_TRANS_P_THRESHOLDS_0_0_ADDR(base) ((base) + (0x80BC))

/* 寄存器说明：VENC Transaction Probe的bin_1配置
   位域定义UNION结构:  SOC_VCODEC_BUS_VENC_TRANS_P_THRESHOLDS_0_1_UNION */
#define SOC_VCODEC_BUS_VENC_TRANS_P_THRESHOLDS_0_1_ADDR(base) ((base) + (0x80C0))

/* 寄存器说明：VENC Transaction Probe的bin_2配置
   位域定义UNION结构:  SOC_VCODEC_BUS_VENC_TRANS_P_THRESHOLDS_0_2_UNION */
#define SOC_VCODEC_BUS_VENC_TRANS_P_THRESHOLDS_0_2_ADDR(base) ((base) + (0x80C4))

/* 寄存器说明：VENC Transaction Probe的bin_3配置
   位域定义UNION结构:  SOC_VCODEC_BUS_VENC_TRANS_P_THRESHOLDS_0_3_UNION */
#define SOC_VCODEC_BUS_VENC_TRANS_P_THRESHOLDS_0_3_ADDR(base) ((base) + (0x80C8))
...
/*****************************************************************************
 ...
 结构说明  : VENC_ADAPTER_ID_COREID 寄存器结构定义。地址偏移量:0x1000，初值:0x9CF36901，宽度:32
 寄存器说明: adapter域ID。
*****************************************************************************/
...
/*****************************************************************************
 ...
 结构说明  : VDEC_ADAPTER_ID_COREID 寄存器结构定义。地址偏移量:0x1080，初值:0xB6F00401，宽度:32
 寄存器说明: adapter域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : ERR_ID_COREID 寄存器结构定义。地址偏移量:0x1C00，初值:0x3CC0860D，宽度:32
 寄存器说明: VCODEC_BUS Err probe域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : VENC_QOS_ID_COREID 寄存器结构定义。地址偏移量:0x0100，初值:0x66A46204，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_VCODEC_BUS_VENC_TRANS_P_THRESHOLDS_0_0_UNION
 结构说明  : VENC_TRANS_P_THRESHOLDS_0_0 寄存器结构定义。地址偏移量:0x80BC，初值:0x00000000，宽度:32
 寄存器说明: VENC Transaction Probe的bin_0配置
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  thresholds_0_0 : 2;  /* bit[0-1] : 0x0-->选择threshold_0（delay：64；outstanding：6）；
                                                         0x1-->选择threshold_1（delay：128；outstanding：12）；
                                                         0x2-->选择threshold_2（delay：256；outstanding：18）；
                                                         0x3-->选择threshold_3（delay：1023；outstanding：24）； */
        unsigned int  reserved       : 30; /* bit[2-31]: 保留 */
    } reg;
} SOC_VCODEC_BUS_VENC_TRANS_P_THRESHOLDS_0_0_UNION;
#endif
#define SOC_VCODEC_BUS_VENC_TRANS_P_THRESHOLDS_0_0_thresholds_0_0_START  (0)
#define SOC_VCODEC_BUS_VENC_TRANS_P_THRESHOLDS_0_0_thresholds_0_0_END    (1)


/*****************************************************************************
 结构名    : SOC_VCODEC_BUS_VENC_TRANS_P_THRESHOLDS_0_1_UNION
 结构说明  : VENC_TRANS_P_THRESHOLDS_0_1 寄存器结构定义。地址偏移量:0x80C0，初值:0x00000000，宽度:32
 寄存器说明: VENC Transaction Probe的bin_1配置
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  thresholds_0_1 : 2;  /* bit[0-1] : 0x0-->选择threshold_0（delay：64；outstanding：6）；
                                                         0x1-->选择threshold_1（delay：128；outstanding：12）；
                                                         0x2-->选择threshold_2（delay：256；outstanding：18）；
                                                         0x3-->选择threshold_3（delay：1023；outstanding：24）； */
        unsigned int  reserved       : 30; /* bit[2-31]: 保留 */
    } reg;
} SOC_VCODEC_BUS_VENC_TRANS_P_THRESHOLDS_0_1_UNION;
#endif
#define SOC_VCODEC_BUS_VENC_TRANS_P_THRESHOLDS_0_1_thresholds_0_1_START  (0)
#define SOC_VCODEC_BUS_VENC_TRANS_P_THRESHOLDS_0_1_thresholds_0_1_END    (1)


/*****************************************************************************
 结构名    : SOC_VCODEC_BUS_VENC_TRANS_P_THRESHOLDS_0_2_UNION
 结构说明  : VENC_TRANS_P_THRESHOLDS_0_2 寄存器结构定义。地址偏移量:0x80C4，初值:0x00000000，宽度:32
 寄存器说明: VENC Transaction Probe的bin_2配置
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  thresholds_0_2 : 2;  /* bit[0-1] : 0x0-->选择threshold_0（delay：64；outstanding：6）；
                                                         0x1-->选择threshold_1（delay：128；outstanding：12）；
                                                         0x2-->选择threshold_2（delay：256；outstanding：18）；
                                                         0x3-->选择threshold_3（delay：1023；outstanding：24）； */
        unsigned int  reserved       : 30; /* bit[2-31]: 保留 */
    } reg;
} SOC_VCODEC_BUS_VENC_TRANS_P_THRESHOLDS_0_2_UNION;
#endif
#define SOC_VCODEC_BUS_VENC_TRANS_P_THRESHOLDS_0_2_thresholds_0_2_START  (0)
#define SOC_VCODEC_BUS_VENC_TRANS_P_THRESHOLDS_0_2_thresholds_0_2_END    (1)


/*****************************************************************************
 结构名    : SOC_VCODEC_BUS_VENC_TRANS_P_THRESHOLDS_0_3_UNION
 结构说明  : VENC_TRANS_P_THRESHOLDS_0_3 寄存器结构定义。地址偏移量:0x80C8，初值:0x00000000，宽度:32
 寄存器说明: VENC Transaction Probe的bin_3配置
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  thresholds_0_3 : 2;  /* bit[0-1] : 0x0-->选择threshold_0（delay：64；outstanding：6）；
                                                         0x1-->选择threshold_1（delay：128；outstanding：12）；
                                                         0x2-->选择threshold_2（delay：256；outstanding：18）；
                                                         0x3-->选择threshold_3（delay：1023；outstanding：24）； */
        unsigned int  reserved       : 30; /* bit[2-31]: 保留 */
    } reg;
} SOC_VCODEC_BUS_VENC_TRANS_P_THRESHOLDS_0_3_UNION;
#endif
#define SOC_VCODEC_BUS_VENC_TRANS_P_THRESHOLDS_0_3_thresholds_0_3_START  (0)
#define SOC_VCODEC_BUS_VENC_TRANS_P_THRESHOLDS_0_3_thresholds_0_3_END    (1)
...
/*****************************************************************************
 ...
 结构说明  : VENC_TRANS_M_ID_COREID 寄存器结构定义。地址偏移量:0x8400，初值:0xF992EE06，宽度:32
 寄存器说明: VENC Transaction probe域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : VDEC_QOS_ID_COREID 寄存器结构定义。地址偏移量:0x0000，初值:0x4F829004，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : VDEC_QOS_BANDWIDTH 寄存器结构定义。地址偏移量:0x0010，初值:0x00000640，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
