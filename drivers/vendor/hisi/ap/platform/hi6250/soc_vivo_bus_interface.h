...
/* 寄存器说明：DSS0_RD Transaction Probe的bin_0配置
   位域定义UNION结构:  SOC_VIVO_BUS_DSS0_RD_TRANS_P_THRESHOLDS_0_0_UNION */
#define SOC_VIVO_BUS_DSS0_RD_TRANS_P_THRESHOLDS_0_0_ADDR(base) ((base) + (0x80BC))

/* 寄存器说明：DSS0_RD Transaction Probe的bin_1配置
   位域定义UNION结构:  SOC_VIVO_BUS_DSS0_RD_TRANS_P_THRESHOLDS_0_1_UNION */
#define SOC_VIVO_BUS_DSS0_RD_TRANS_P_THRESHOLDS_0_1_ADDR(base) ((base) + (0x80C0))

/* 寄存器说明：DSS0_RD Transaction Probe的bin_2配置
   位域定义UNION结构:  SOC_VIVO_BUS_DSS0_RD_TRANS_P_THRESHOLDS_0_2_UNION */
#define SOC_VIVO_BUS_DSS0_RD_TRANS_P_THRESHOLDS_0_2_ADDR(base) ((base) + (0x80C4))

/* 寄存器说明：DSS0_RD Transaction Probe的bin_3配置
   位域定义UNION结构:  SOC_VIVO_BUS_DSS0_RD_TRANS_P_THRESHOLDS_0_3_UNION */
#define SOC_VIVO_BUS_DSS0_RD_TRANS_P_THRESHOLDS_0_3_ADDR(base) ((base) + (0x80C8))
...
/* 寄存器说明：DSS0_RD Transaction Probe的bin_0配置
   位域定义UNION结构:  SOC_VIVO_BUS_DSS1_RD_TRANS_P_THRESHOLDS_0_0_UNION */
#define SOC_VIVO_BUS_DSS1_RD_TRANS_P_THRESHOLDS_0_0_ADDR(base) ((base) + (0xA0BC))

/* 寄存器说明：DSS0_RD Transaction Probe的bin_1配置
   位域定义UNION结构:  SOC_VIVO_BUS_DSS1_RD_TRANS_P_THRESHOLDS_0_1_UNION */
#define SOC_VIVO_BUS_DSS1_RD_TRANS_P_THRESHOLDS_0_1_ADDR(base) ((base) + (0xA0C0))

/* 寄存器说明：DSS0_RD Transaction Probe的bin_2配置
   位域定义UNION结构:  SOC_VIVO_BUS_DSS1_RD_TRANS_P_THRESHOLDS_0_2_UNION */
#define SOC_VIVO_BUS_DSS1_RD_TRANS_P_THRESHOLDS_0_2_ADDR(base) ((base) + (0xA0C4))

/* 寄存器说明：DSS0_RD Transaction Probe的bin_3配置
   位域定义UNION结构:  SOC_VIVO_BUS_DSS1_RD_TRANS_P_THRESHOLDS_0_3_UNION */
#define SOC_VIVO_BUS_DSS1_RD_TRANS_P_THRESHOLDS_0_3_ADDR(base) ((base) + (0xA0C8))
...
/* 寄存器说明：DSS0_WR
            TransactionStatProfilter域ID
   位域定义UNION结构:  SOC_VIVO_BUS_DSS1_WR_TRANS_P_ID_COREID_UNION */
...
/* 寄存器说明：DSS1_WR Transaction Probe的bin_1配置。
...
/* 寄存器说明：DSS1_WR Transaction Probe的bin_2配置。
...
/* 寄存器说明：DSS1_WR Transaction Probe的bin_3配置。
...
/* 寄存器说明：ISP_RD Transaction Probe的bin_1配置。
...
/* 寄存器说明：ISP_RD Transaction Probe的bin_2配置。
   位域定义UNION结构:  SOC_VIVO_BUS_ISP_RD_TRANS_P_THRESHOLDS_0_2_UNION */
#define SOC_VIVO_BUS_ISP_RD_TRANS_P_THRESHOLDS_0_2_ADDR(base) ((base) + (0x80B4))

/* 寄存器说明：ISP_RD Transaction Probe的bin_3配置。
   位域定义UNION结构:  SOC_VIVO_BUS_ISP_RD_TRANS_P_THRESHOLDS_0_3_UNION */
...
/* 寄存器说明：ISP_WR Transaction Probe的bin_1配置。
...
/* 寄存器说明：ISP_WR Transaction Probe的bin_2配置。
   位域定义UNION结构:  SOC_VIVO_BUS_ISP_WR_TRANS_P_THRESHOLDS_0_2_UNION */
#define SOC_VIVO_BUS_ISP_WR_TRANS_P_THRESHOLDS_0_2_ADDR(base) ((base) + (0x90B4))

/* 寄存器说明：ISP_WR Transaction Probe的bin_3配置。
   位域定义UNION结构:  SOC_VIVO_BUS_ISP_WR_TRANS_P_THRESHOLDS_0_3_UNION */
...
/* 寄存器说明：A7TOVIVOBUS_RD Transaction Probe的bin_1配置。
...
/* 寄存器说明：A7TOVIVOBUS_RD Transaction Probe的bin_2配置。
   位域定义UNION结构:  SOC_VIVO_BUS_A7TOVIVOBUS_RD_TRANS_P_THRESHOLDS_0_2_UNION */
#define SOC_VIVO_BUS_A7TOVIVOBUS_RD_TRANS_P_THRESHOLDS_0_2_ADDR(base) ((base) + (0xA0B4))

/* 寄存器说明：A7TOVIVOBUS_RD Transaction Probe的bin_3配置。
   位域定义UNION结构:  SOC_VIVO_BUS_A7TOVIVOBUS_RD_TRANS_P_THRESHOLDS_0_3_UNION */
#define SOC_VIVO_BUS_A7TOVIVOBUS_RD_TRANS_P_THRESHOLDS_0_3_ADDR(base) ((base) + (0xA0B8))
...
/* 寄存器说明：A7TOVIVOBUS_WR Transaction Probe的bin_1配置。
...
/* 寄存器说明：A7TOVIVOBUS_WR Transaction Probe的bin_2配置。
   位域定义UNION结构:  SOC_VIVO_BUS_A7TOVIVOBUS_WR_TRANS_P_THRESHOLDS_0_2_UNION */
#define SOC_VIVO_BUS_A7TOVIVOBUS_WR_TRANS_P_THRESHOLDS_0_2_ADDR(base) ((base) + (0xB0B4))

/* 寄存器说明：A7TOVIVOBUS_WR Transaction Probe的bin_3配置。
   位域定义UNION结构:  SOC_VIVO_BUS_A7TOVIVOBUS_WR_TRANS_P_THRESHOLDS_0_3_UNION */
#define SOC_VIVO_BUS_A7TOVIVOBUS_WR_TRANS_P_THRESHOLDS_0_3_ADDR(base) ((base) + (0xB0B8))
...
/*****************************************************************************
 ...
 结构说明  : DSS0_RD_QOS_ID_COREID 寄存器结构定义。地址偏移量:0x0000，初值:0xA22AD104，宽度:32
 寄存器说明: 
*****************************************************************************/
...
/*****************************************************************************
 ...
 结构说明  : DSS0_RD_QOS_BANDWIDTH 寄存器结构定义。地址偏移量:0x0010，初值:0x00000A80，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : DSS1_RD_QOS_ID_COREID 寄存器结构定义。地址偏移量:0x0100，初值:0x73BF1F04，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : DSS1_RD_QOS_BANDWIDTH 寄存器结构定义。地址偏移量:0x0110，初值:0x00000A80，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : DSS1_WR_QOS_ID_COREID 寄存器结构定义。地址偏移量:0x0180，初值:0x31539404，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : DSS1_WR_QOS_BANDWIDTH 寄存器结构定义。地址偏移量:0x0190，初值:0x00000640，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : VIVOBUS_ERR_ID_COREID 寄存器结构定义。地址偏移量:0x1C00，初值:0x8F259D0D，宽度:32
 寄存器说明: VIVOBUS Err probe域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
typedef union
{
    ...
    struct
    {
        unsigned int  errlog1 : 32; /* bit[0-31]: RouteId：路由信息，各bit含义如下
                                                  [31：15]:保留
                                                  [14:12]-->Initiator Flow ID，用于表示发起访问的master；
                                                  [11:9]-->target Flow ID，用于表示被访问的slave；
                                                  [8]--->TARG SUBRANGE
                                                  [7:0]-->Seq ID，Transaction标记；。 */
    } reg;
} SOC_VIVO_BUS_VIVOBUS_ERRLOG1_UNION;
#endif
#define SOC_VIVO_BUS_VIVOBUS_ERRLOG1_errlog1_START  (0)
#define SOC_VIVO_BUS_VIVOBUS_ERRLOG1_errlog1_END    (31)
...
/*****************************************************************************
 ...
 结构说明  : DSS0_RD_TRANS_F_ID_COREID 寄存器结构定义。地址偏移量:0x8000，初值:0xF2415C09，宽度:32
 寄存器说明: DSS0_RD TransactionStatFilter域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : DSS0_RD_TRANS_P_ID_COREID 寄存器结构定义。地址偏移量:0x8080，初值:0xF775310A，宽度:32
 寄存器说明: DSS0_RD TransactionStatProfilter域ID
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  coretypeid : 32; /* bit[0-31]: ID_coreId */
    } reg;
} SOC_VIVO_BUS_DSS0_RD_TRANS_P_ID_COREID_UNION;
#endif
#define SOC_VIVO_BUS_DSS0_RD_TRANS_P_ID_COREID_coretypeid_START  (0)
#define SOC_VIVO_BUS_DSS0_RD_TRANS_P_ID_COREID_coretypeid_END    (31)
...
typedef union
{
    ...
    struct
    {
        unsigned int  flexnocid : 32; /* bit[0-31]: FlexNoC生成代码的软件版本 */
    } reg;
} SOC_VIVO_BUS_DSS0_RD_TRANS_P_ID_REVISIONID_UNION;
#endif
#define SOC_VIVO_BUS_DSS0_RD_TRANS_P_ID_REVISIONID_flexnocid_START  (0)
...
/*****************************************************************************
 结构名    : SOC_VIVO_BUS_DSS0_RD_TRANS_P_THRESHOLDS_0_0_UNION
 结构说明  : DSS0_RD_TRANS_P_THRESHOLDS_0_0 寄存器结构定义。地址偏移量:0x80BC，初值:0x00000000，宽度:32
 寄存器说明: DSS0_RD Transaction Probe的bin_0配置
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  thresholds_0_0 : 2;  /* bit[0-1] : 0x0-->选择threshold_0（delay：64；outstanding：7）；
                                                         0x1-->选择threshold_1（delay：128；outstanding：14）；
                                                         0x2-->选择threshold_2（delay：256；outstanding：21）；
                                                         0x3-->选择threshold_3（delay：1023；outstanding：28）； */
        unsigned int  reserved       : 30; /* bit[2-31]: 保留 */
    } reg;
...
/*****************************************************************************
 结构名    : SOC_VIVO_BUS_DSS0_RD_TRANS_P_THRESHOLDS_0_1_UNION
 结构说明  : DSS0_RD_TRANS_P_THRESHOLDS_0_1 寄存器结构定义。地址偏移量:0x80C0，初值:0x00000000，宽度:32
 寄存器说明: DSS0_RD Transaction Probe的bin_1配置
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  thresholds_0_1 : 2;  /* bit[0-1] : 0x0-->选择threshold_0（delay：64；outstanding：7）；
                                                         0x1-->选择threshold_1（delay：128；outstanding：14）；
                                                         0x2-->选择threshold_2（delay：256；outstanding：21）；
                                                         0x3-->选择threshold_3（delay：1023；outstanding：28）； */
        unsigned int  reserved       : 30; /* bit[2-31]: 保留 */
...
/*****************************************************************************
 结构名    : SOC_VIVO_BUS_DSS0_RD_TRANS_P_THRESHOLDS_0_2_UNION
 结构说明  : DSS0_RD_TRANS_P_THRESHOLDS_0_2 寄存器结构定义。地址偏移量:0x80C4，初值:0x00000000，宽度:32
 寄存器说明: DSS0_RD Transaction Probe的bin_2配置
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  thresholds_0_2 : 2;  /* bit[0-1] : 0x0-->选择threshold_0（delay：64；outstanding：7）；
                                                         0x1-->选择threshold_1（delay：128；outstanding：14）；
                                                         0x2-->选择threshold_2（delay：256；outstanding：21）；
                                                         0x3-->选择threshold_3（delay：1023；outstanding：28）； */
        unsigned int  reserved       : 30; /* bit[2-31]: 保留 */
...
/*****************************************************************************
 结构名    : SOC_VIVO_BUS_DSS0_RD_TRANS_P_THRESHOLDS_0_3_UNION
 结构说明  : DSS0_RD_TRANS_P_THRESHOLDS_0_3 寄存器结构定义。地址偏移量:0x80C8，初值:0x00000000，宽度:32
 寄存器说明: DSS0_RD Transaction Probe的bin_3配置
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  thresholds_0_3 : 2;  /* bit[0-1] : 0x0-->选择threshold_0（delay：64；outstanding：7）；
                                                         0x1-->选择threshold_1（delay：128；outstanding：14）；
                                                         0x2-->选择threshold_2（delay：256；outstanding：21）；
                                                         0x3-->选择threshold_3（delay：1023；outstanding：28）； */
        unsigned int  reserved       : 30; /* bit[2-31]: 保留 */
...
/*****************************************************************************
 ...
 结构说明  : DSS0_RD_TRANS_M_ID_COREID 寄存器结构定义。地址偏移量:0x8400，初值:0x86574A06，宽度:32
 寄存器说明: DSS0_RD Transaction probe域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : DSS1_RD_TRANS_F_ID_COREID 寄存器结构定义。地址偏移量:0xA000，初值:0xE89BD309，宽度:32
 寄存器说明: DSS1_RD TransactionStatFilter域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
#define SOC_VIVO_BUS_DSS1_RD_TRANS_F_ID_COREID_coretypeid_END    (31)
...
#endif
#define SOC_VIVO_BUS_DSS1_RD_TRANS_F_ID_REVISIONID_flexnocid_START  (0)
...
/*****************************************************************************
 ...
 结构说明  : DSS1_RD_TRANS_P_ID_COREID 寄存器结构定义。地址偏移量:0xA080，初值:0x0E19E70A，宽度:32
 寄存器说明: DSS0_RD TransactionStatProfilter域ID
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
#define SOC_VIVO_BUS_DSS1_RD_TRANS_P_ID_COREID_coretypeid_END    (31)
...
#endif
#define SOC_VIVO_BUS_DSS1_RD_TRANS_P_ID_REVISIONID_flexnocid_START  (0)
...
/*****************************************************************************
 结构名    : SOC_VIVO_BUS_DSS1_RD_TRANS_P_THRESHOLDS_0_0_UNION
 结构说明  : DSS1_RD_TRANS_P_THRESHOLDS_0_0 寄存器结构定义。地址偏移量:0xA0BC，初值:0x00000000，宽度:32
 寄存器说明: DSS0_RD Transaction Probe的bin_0配置
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  thresholds_0_0 : 2;  /* bit[0-1] : 0x0-->选择threshold_0（delay：64；outstanding：8）；
                                                         0x1-->选择threshold_1（delay：128；outstanding：16）；
                                                         0x2-->选择threshold_2（delay：256；outstanding：24）；
                                                         0x3-->选择threshold_3（delay：1023；outstanding：32）； */
        unsigned int  reserved       : 30; /* bit[2-31]: 保留 */
    } reg;
...
/*****************************************************************************
 结构名    : SOC_VIVO_BUS_DSS1_RD_TRANS_P_THRESHOLDS_0_1_UNION
 结构说明  : DSS1_RD_TRANS_P_THRESHOLDS_0_1 寄存器结构定义。地址偏移量:0xA0C0，初值:0x00000000，宽度:32
 寄存器说明: DSS0_RD Transaction Probe的bin_1配置
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  thresholds_0_1 : 2;  /* bit[0-1] : 0x0-->选择threshold_0（delay：64；outstanding：8）；
                                                         0x1-->选择threshold_1（delay：128；outstanding：16）；
                                                         0x2-->选择threshold_2（delay：256；outstanding：24）；
                                                         0x3-->选择threshold_3（delay：1023；outstanding：32）； */
        unsigned int  reserved       : 30; /* bit[2-31]: 保留 */
...
/*****************************************************************************
 结构名    : SOC_VIVO_BUS_DSS1_RD_TRANS_P_THRESHOLDS_0_2_UNION
 结构说明  : DSS1_RD_TRANS_P_THRESHOLDS_0_2 寄存器结构定义。地址偏移量:0xA0C4，初值:0x00000000，宽度:32
 寄存器说明: DSS0_RD Transaction Probe的bin_2配置
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  thresholds_0_2 : 2;  /* bit[0-1] : 0x0-->选择threshold_0（delay：64；outstanding：8）；
                                                         0x1-->选择threshold_1（delay：128；outstanding：16）；
                                                         0x2-->选择threshold_2（delay：256；outstanding：24）；
                                                         0x3-->选择threshold_3（delay：1023；outstanding：32）； */
        unsigned int  reserved       : 30; /* bit[2-31]: 保留 */
...
/*****************************************************************************
 结构名    : SOC_VIVO_BUS_DSS1_RD_TRANS_P_THRESHOLDS_0_3_UNION
 结构说明  : DSS1_RD_TRANS_P_THRESHOLDS_0_3 寄存器结构定义。地址偏移量:0xA0C8，初值:0x00000000，宽度:32
 寄存器说明: DSS0_RD Transaction Probe的bin_3配置
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  thresholds_0_3 : 2;  /* bit[0-1] : 0x0-->选择threshold_0（delay：64；outstanding：8）；
                                                         0x1-->选择threshold_1（delay：128；outstanding：16）；
                                                         0x2-->选择threshold_2（delay：256；outstanding：24）；
                                                         0x3-->选择threshold_3（delay：1023；outstanding：32）； */
        unsigned int  reserved       : 30; /* bit[2-31]: 保留 */
...
/*****************************************************************************
 ...
 结构说明  : DSS1_RD_TRANS_M_ID_COREID 寄存器结构定义。地址偏移量:0xA400，初值:0xABE6D906，宽度:32
 寄存器说明: DSS1_RD Transaction probe域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : DSS1_WR_TRANS_F_ID_COREID 寄存器结构定义。地址偏移量:0xB000，初值:0x99C62409，宽度:32
 寄存器说明: DSS1_WR TransactionStatFilter域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  corechecksum : 32; /* bit[0-31]: ID_coreId */
    } reg;
} SOC_VIVO_BUS_DSS1_WR_TRANS_F_ID_COREID_UNION;
#endif
#define SOC_VIVO_BUS_DSS1_WR_TRANS_F_ID_COREID_corechecksum_START  (0)
...
/*****************************************************************************
 结构名    : SOC_VIVO_BUS_DSS1_WR_TRANS_P_ID_COREID_UNION
 结构说明  : DSS1_WR_TRANS_P_ID_COREID 寄存器结构定义。地址偏移量:0xB080，初值:0xF161E50A，宽度:32
 寄存器说明: DSS0_WR
            TransactionStatProfilter域ID
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
...
#define SOC_VIVO_BUS_DSS1_WR_TRANS_P_ID_COREID_coretypeid_END    (31)
...
typedef union
{
    ...
    struct
    {
        unsigned int  thresholds_0_0 : 2;  /* bit[0-1] : 0x0-->选择threshold_0（delay：40；outstanding：2）；
                                                         ...
                                                         0x3-->选择threshold_3（delay：256；outstanding：8）；。 */
        unsigned int  reserved       : 30; /* bit[2-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : DSS1_WR_TRANS_M_ID_COREID 寄存器结构定义。地址偏移量:0xB400，初值:0x2E6AF906，宽度:32
 寄存器说明: DSS1_WR Transaction probe域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : ISP_RD_QOS_ID_COREID 寄存器结构定义。地址偏移量:0x0000，初值:0x1D319D04，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  id_coreid : 32; /* bit[0-31]: id_coreid */
    } reg;
} SOC_VIVO_BUS_ISP_RD_QOS_ID_COREID_UNION;
#endif
#define SOC_VIVO_BUS_ISP_RD_QOS_ID_COREID_id_coreid_START  (0)
#define SOC_VIVO_BUS_ISP_RD_QOS_ID_COREID_id_coreid_END    (31)
...
typedef union
{
    ...
    struct
    {
        unsigned int  flexnocid : 32; /* bit[0-31]: flexnocid */
    } reg;
} SOC_VIVO_BUS_ISP_RD_QOS_ID_REVISIONID_UNION;
#endif
#define SOC_VIVO_BUS_ISP_RD_QOS_ID_REVISIONID_flexnocid_START  (0)
...
/*****************************************************************************
 ...
 结构说明  : ISP_RD_QOS_BANDWIDTH 寄存器结构定义。地址偏移量:0x0010，初值:0x000003C0，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : ISP_WR_QOS_ID_COREID 寄存器结构定义。地址偏移量:0x0080，初值:0x64697E04，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
#endif
#define SOC_VIVO_BUS_ISP_WR_QOS_ID_COREID_id_coreid_START  (0)
#define SOC_VIVO_BUS_ISP_WR_QOS_ID_COREID_id_coreid_END    (31)
...
#endif
#define SOC_VIVO_BUS_ISP_WR_QOS_ID_REVISIONID_flexnocid_START  (0)
...
/*****************************************************************************
 ...
 结构说明  : ISP_WR_QOS_BANDWIDTH 寄存器结构定义。地址偏移量:0x0090，初值:0x00000D10，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : A7T0VIVOBUS_RD_QOS_ID_COREID 寄存器结构定义。地址偏移量:0x0100，初值:0x74CB4C04，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
#endif
#define SOC_VIVO_BUS_A7T0VIVOBUS_RD_QOS_ID_COREID_id_coreid_START  (0)
#define SOC_VIVO_BUS_A7T0VIVOBUS_RD_QOS_ID_COREID_id_coreid_END    (31)


/*****************************************************************************
 结构名    : SOC_VIVO_BUS_A7T0VIVOBUS_RD_QOS_ID_REVISIONID_UNION
 结构说明  : A7T0VIVOBUS_RD_QOS_ID_REVISIONID 寄存器结构定义。地址偏移量:0x0104，初值:0x00012D53，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
#endif
#define SOC_VIVO_BUS_A7T0VIVOBUS_RD_QOS_ID_REVISIONID_flexnocid_START  (0)
...
/*****************************************************************************
 ...
 结构说明  : A7T0VIVOBUS_RD_QOS_BANDWIDTH 寄存器结构定义。地址偏移量:0x0110，初值:0x00000200，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : A7T0VIVOBUS_WR_QOS_ID_COREID 寄存器结构定义。地址偏移量:0x0180，初值:0x98FFCA04，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
#endif
#define SOC_VIVO_BUS_A7T0VIVOBUS_WR_QOS_ID_COREID_id_coreid_START  (0)
#define SOC_VIVO_BUS_A7T0VIVOBUS_WR_QOS_ID_COREID_id_coreid_END    (31)


/*****************************************************************************
 结构名    : SOC_VIVO_BUS_A7T0VIVOBUS_WR_QOS_ID_REVISIONID_UNION
 结构说明  : A7T0VIVOBUS_WR_QOS_ID_REVISIONID 寄存器结构定义。地址偏移量:0x0184，初值:0x00012D53，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
#endif
#define SOC_VIVO_BUS_A7T0VIVOBUS_WR_QOS_ID_REVISIONID_flexnocid_START  (0)
...
/*****************************************************************************
 ...
 结构说明  : A7T0VIVOBUS_WR_QOS_BANDWIDTH 寄存器结构定义。地址偏移量:0x0190，初值:0x00000A00，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : ISP_RD_TRANS_F_ID_COREID 寄存器结构定义。地址偏移量:0x8000，初值:0x95684309，宽度:32
 寄存器说明: ISP_RD TransactionStatFilter域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : ISP_RD_TRANS_P_ID_COREID 寄存器结构定义。地址偏移量:0x8080，初值:0x63196E0A，宽度:32
 寄存器说明: ISP_RD TransactionStatProfilter域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_VIVO_BUS_ISP_RD_TRANS_P_THRESHOLDS_0_2_UNION
 结构说明  : ISP_RD_TRANS_P_THRESHOLDS_0_2 寄存器结构定义。地址偏移量:0x80B4，初值:0x00000000，宽度:32
 寄存器说明: ISP_RD Transaction Probe的bin_2配置。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
#endif
#define SOC_VIVO_BUS_ISP_RD_TRANS_P_THRESHOLDS_0_2_thresholds_0_1_START  (0)
#define SOC_VIVO_BUS_ISP_RD_TRANS_P_THRESHOLDS_0_2_thresholds_0_1_END    (1)


/*****************************************************************************
 结构名    : SOC_VIVO_BUS_ISP_RD_TRANS_P_THRESHOLDS_0_3_UNION
 结构说明  : ISP_RD_TRANS_P_THRESHOLDS_0_3 寄存器结构定义。地址偏移量:0x80B8，初值:0x00000000，宽度:32
 寄存器说明: ISP_RD Transaction Probe的bin_3配置。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
#endif
#define SOC_VIVO_BUS_ISP_RD_TRANS_P_THRESHOLDS_0_3_thresholds_0_1_START  (0)
#define SOC_VIVO_BUS_ISP_RD_TRANS_P_THRESHOLDS_0_3_thresholds_0_1_END    (1)
...
/*****************************************************************************
 ...
 结构说明  : ISP_RD_TRANS_M_ID_COREID 寄存器结构定义。地址偏移量:0x8400，初值:0xB92E1606，宽度:32
 寄存器说明: ISP_RD Transaction probe域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : ISP_WR_TRANS_F_ID_COREID 寄存器结构定义。地址偏移量:0x9000，初值:0x2BB73509，宽度:32
 寄存器说明: ISP_WR TransactionStatFilter域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : ISP_WR_TRANS_P_ID_COREID 寄存器结构定义。地址偏移量:0x9080，初值:0x055CF90A，宽度:32
 寄存器说明: ISP_RD TransactionStatProfilter域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
typedef union
{
    ...
    struct
    {
        unsigned int  thresholds_0_0 : 2;  /* bit[0-1] : 0x0-->选择threshold_0（delay：64；outstanding：2）；
                                                         ...
                                                         0x2-->选择threshold_2（delay：256；outstanding：8）；
                                                         0x3-->选择threshold_3（delay：1023；outstanding：12）；。 */
        unsigned int  reserved       : 30; /* bit[2-31]: 保留 */
    } reg;
...
/*****************************************************************************
 结构名    : SOC_VIVO_BUS_ISP_WR_TRANS_P_THRESHOLDS_0_2_UNION
 结构说明  : ISP_WR_TRANS_P_THRESHOLDS_0_2 寄存器结构定义。地址偏移量:0x90B4，初值:0x00000000，宽度:32
 寄存器说明: ISP_WR Transaction Probe的bin_2配置。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_VIVO_BUS_ISP_WR_TRANS_P_THRESHOLDS_0_3_UNION
 结构说明  : ISP_WR_TRANS_P_THRESHOLDS_0_3 寄存器结构定义。地址偏移量:0x90B8，初值:0x00000000，宽度:32
 寄存器说明: ISP_WR Transaction Probe的bin_3配置。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : ISP_WR_TRANS_M_ID_COREID 寄存器结构定义。地址偏移量:0x9400，初值:0xFBCB5806，宽度:32
 寄存器说明: ISP_WR Transaction probe域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : A7TOVIVOBUS_RD_TRANS_F_ID_COREID 寄存器结构定义。地址偏移量:0xA000，初值:0xFA8FED09，宽度:32
 寄存器说明: A7TOVIVOBUS_RD TransactionStatFilter域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
typedef union
{
    ...
    struct
    {
        unsigned int  thresholds_0_0 : 2;  /* bit[0-1] : 0x0-->选择threshold_0（delay：64；outstanding：2）；
                                                         ...
                                                         0x3-->选择threshold_3（delay：1023；outstanding：8）；。 */
        unsigned int  reserved       : 30; /* bit[2-31]: 保留 */
    } reg;
...
/*****************************************************************************
 结构名    : SOC_VIVO_BUS_A7TOVIVOBUS_RD_TRANS_P_THRESHOLDS_0_2_UNION
 结构说明  : A7TOVIVOBUS_RD_TRANS_P_THRESHOLDS_0_2 寄存器结构定义。地址偏移量:0xA0B4，初值:0x00000000，宽度:32
 寄存器说明: A7TOVIVOBUS_RD Transaction Probe的bin_2配置。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
} SOC_VIVO_BUS_A7TOVIVOBUS_RD_TRANS_P_THRESHOLDS_0_2_UNION;
#endif
#define SOC_VIVO_BUS_A7TOVIVOBUS_RD_TRANS_P_THRESHOLDS_0_2_thresholds_0_2_START  (0)
#define SOC_VIVO_BUS_A7TOVIVOBUS_RD_TRANS_P_THRESHOLDS_0_2_thresholds_0_2_END    (1)


/*****************************************************************************
 结构名    : SOC_VIVO_BUS_A7TOVIVOBUS_RD_TRANS_P_THRESHOLDS_0_3_UNION
 结构说明  : A7TOVIVOBUS_RD_TRANS_P_THRESHOLDS_0_3 寄存器结构定义。地址偏移量:0xA0B8，初值:0x00000000，宽度:32
 寄存器说明: A7TOVIVOBUS_RD Transaction Probe的bin_3配置。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
} SOC_VIVO_BUS_A7TOVIVOBUS_RD_TRANS_P_THRESHOLDS_0_3_UNION;
#endif
#define SOC_VIVO_BUS_A7TOVIVOBUS_RD_TRANS_P_THRESHOLDS_0_3_thresholds_0_3_START  (0)
#define SOC_VIVO_BUS_A7TOVIVOBUS_RD_TRANS_P_THRESHOLDS_0_3_thresholds_0_3_END    (1)
...
/*****************************************************************************
 ...
 结构说明  : A7TOVIVOBUS_RD_TRANS_M_ID_COREID 寄存器结构定义。地址偏移量:0xA400，初值:0x9BD06E06，宽度:32
 寄存器说明: A7TOVIVOBUS_RD Transaction probe域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 ...
 结构说明  : A7TOVIVOBUS_WR_TRANS_F_ID_COREID 寄存器结构定义。地址偏移量:0xB000，初值:0xAB389409，宽度:32
 寄存器说明: ISP_WR TransactionStatFilter域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_VIVO_BUS_A7TOVIVOBUS_WR_TRANS_P_THRESHOLDS_0_2_UNION
 结构说明  : A7TOVIVOBUS_WR_TRANS_P_THRESHOLDS_0_2 寄存器结构定义。地址偏移量:0xB0B4，初值:0x00000000，宽度:32
 寄存器说明: A7TOVIVOBUS_WR Transaction Probe的bin_2配置。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
} SOC_VIVO_BUS_A7TOVIVOBUS_WR_TRANS_P_THRESHOLDS_0_2_UNION;
#endif
#define SOC_VIVO_BUS_A7TOVIVOBUS_WR_TRANS_P_THRESHOLDS_0_2_thresholds_0_1_START  (0)
#define SOC_VIVO_BUS_A7TOVIVOBUS_WR_TRANS_P_THRESHOLDS_0_2_thresholds_0_1_END    (1)


/*****************************************************************************
 结构名    : SOC_VIVO_BUS_A7TOVIVOBUS_WR_TRANS_P_THRESHOLDS_0_3_UNION
 结构说明  : A7TOVIVOBUS_WR_TRANS_P_THRESHOLDS_0_3 寄存器结构定义。地址偏移量:0xB0B8，初值:0x00000000，宽度:32
 寄存器说明: A7TOVIVOBUS_WR Transaction Probe的bin_3配置。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
} SOC_VIVO_BUS_A7TOVIVOBUS_WR_TRANS_P_THRESHOLDS_0_3_UNION;
#endif
#define SOC_VIVO_BUS_A7TOVIVOBUS_WR_TRANS_P_THRESHOLDS_0_3_thresholds_0_1_START  (0)
#define SOC_VIVO_BUS_A7TOVIVOBUS_WR_TRANS_P_THRESHOLDS_0_3_thresholds_0_1_END    (1)
...
/*****************************************************************************
 ...
 结构说明  : A7TOVIVOBUS_WR_TRANS_M_ID_COREID 寄存器结构定义。地址偏移量:0xB400，初值:0x88540906，宽度:32
 寄存器说明: A7TOVIVOBUS_WR Transaction probe域ID。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
