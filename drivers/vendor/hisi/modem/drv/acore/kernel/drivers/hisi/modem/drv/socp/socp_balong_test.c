...
/* 初始化成功 */
BSP_S32 SOCP_LLT_INIT_001(void)
{
    BSP_U32 i=0;
...
/* 重复初始化成功, 测试之前重启单板 */
BSP_S32 SOCP_LLT_INIT_002(void)
{
    CHECK_RET(socp_init(), BSP_OK);
    CHECK_RET(socp_init(), BSP_OK);
...
BSP_U32 SOCP_LLT_RESET_002(void)
{
    BSP_U32 i=0;
...
BSP_U32 SOCP_LLT_INIT_004(void)
{
    CHECK_RET(socp_init(), BSP_OK);
...
/* 设置编码目标通道，无效通道ID */
BSP_S32 SOCP_LLT_ENC_DST_001(void)
{
    BSP_U32 u32ChanId;
    SOCP_CODER_DEST_CHAN_S EncDstAttr;
...
/* 设置编码目标通道，无效属性参数 */
BSP_S32 SOCP_LLT_ENC_DST_002(void)
{
    ...
    EncDstAttr.sCoderSetDstBuf.pucOutputStart = (unsigned char *) BSP_NULL;
    CHECK_RET(bsp_socp_coder_set_dest_chan_attr(u32ChanId, &EncDstAttr), BSP_ERR_SOCP_NULL);
    EncDstAttr.sCoderSetDstBuf.pucOutputStart = (unsigned char *) 0x30004000;

    EncDstAttr.sCoderSetDstBuf.pucOutputStart = (unsigned char *) 0x30004004;
    ...
    EncDstAttr.sCoderSetDstBuf.pucOutputEnd = (unsigned char *) BSP_NULL;
    CHECK_RET(bsp_socp_coder_set_dest_chan_attr(u32ChanId, &EncDstAttr), BSP_ERR_SOCP_NULL);
    EncDstAttr.sCoderSetDstBuf.pucOutputEnd = (unsigned char *) 0x30007fff;
...
/* 设置编码目标通道，设置正确属性 */
BSP_S32 SOCP_LLT_ENC_DST_003(void)
{
    BSP_U32 u32ChanId = SOCP_CODER_DEST_CHAN_3; /* 避免通道已经初始化，使用保留的通道 */
    SOCP_CODER_DEST_CHAN_S EncDstAttr;
...
/* 设置编码目标通道，重复配置属性 */
BSP_S32 SOCP_LLT_ENC_DST_004(void)
{
    BSP_U32 u32ChanId = SOCP_CODER_DEST_CHAN_3; /* 避免通道已经初始化，使用保留的通道 */
    SOCP_CODER_DEST_CHAN_S EncDstAttr;
...
#if 0
/* 设置编码目标通道，无效通道ID */
BSP_S32 SOCP_LLT_ENC_DST_005(void)
{
    BSP_U32 u32ChanId = SOCP_CODER_DEST_CHAN_0;
    SOCP_CODER_DEST_CHAN_S EncDstAttr;
...
#endif
/* 申请编码源通道，空指针检查 */
BSP_S32 SOCP_LLT_ENC_SRC_001(void)
{
    DEV_INIT();
...
BSP_S32 SOCP_LLT_ENC_SRC_002(void)
{
    ...
    EncSrcAttr.u32BypassEn = BSP_FALSE;
    EncSrcAttr.u32DestChanID = SOCP_CODER_DEST_CHAN_0;
    EncSrcAttr.sCoderSetSrcBuf.pucInputStart = (unsigned char *)0x30004000;
    EncSrcAttr.sCoderSetSrcBuf.pucInputEnd = (unsigned char *)0x30007fff;
    ...
    EncSrcAttr.sCoderSetSrcBuf.pucInputStart = (unsigned char *) BSP_NULL;
    CHECK_RET(bsp_socp_coder_set_src_chan(u32ChanId, &EncSrcAttr), BSP_ERR_SOCP_NULL);
    EncSrcAttr.sCoderSetSrcBuf.pucInputStart = (unsigned char *) 0x30004000;

    EncSrcAttr.sCoderSetSrcBuf.pucInputStart = (unsigned char *) 0x30004004;
    CHECK_RET(bsp_socp_coder_set_src_chan(u32ChanId, &EncSrcAttr), BSP_ERR_SOCP_NOT_8BYTESALIGN);
    EncSrcAttr.sCoderSetSrcBuf.pucInputStart = (unsigned char *) 0x30004000;

    EncSrcAttr.sCoderSetSrcBuf.pucInputEnd = (unsigned char *) 0x30003800;
    CHECK_RET(bsp_socp_coder_set_src_chan(u32ChanId, &EncSrcAttr), BSP_ERR_SOCP_INVALID_PARA);
    EncSrcAttr.sCoderSetSrcBuf.pucInputEnd = (unsigned char *) 0x30007fff;

    EncSrcAttr.sCoderSetSrcBuf.pucInputEnd = (unsigned char *) BSP_NULL;
    CHECK_RET(bsp_socp_coder_set_src_chan(u32ChanId, &EncSrcAttr), BSP_ERR_SOCP_NULL);
    EncSrcAttr.sCoderSetSrcBuf.pucInputEnd = (unsigned char *) 0x30007fff;

    EncSrcAttr.sCoderSetSrcBuf.pucInputEnd = (unsigned char *) 0x30008004;
    CHECK_RET(bsp_socp_coder_set_src_chan(u32ChanId, &EncSrcAttr), BSP_ERR_SOCP_NOT_8BYTESALIGN);
    EncSrcAttr.sCoderSetSrcBuf.pucInputEnd = (unsigned char *) 0x30007fff;

    EncSrcAttr.eMode = SOCP_ENCSRC_CHNMODE_LIST;
    EncSrcAttr.sCoderSetSrcBuf.u32RDThreshold = 0x10;
    EncSrcAttr.sCoderSetSrcBuf.pucRDStart = (unsigned char *) BSP_NULL;
    CHECK_RET(bsp_socp_coder_set_src_chan(u32ChanId, &EncSrcAttr), BSP_ERR_SOCP_NULL);
    EncSrcAttr.sCoderSetSrcBuf.pucRDStart = (unsigned char *)0x30004000;

    EncSrcAttr.sCoderSetSrcBuf.pucRDStart = (unsigned char *) 0x30004004;
    CHECK_RET(bsp_socp_coder_set_src_chan(u32ChanId, &EncSrcAttr), BSP_ERR_SOCP_NOT_8BYTESALIGN);
    EncSrcAttr.sCoderSetSrcBuf.pucRDStart = (unsigned char *) 0x30004000;

    EncSrcAttr.sCoderSetSrcBuf.pucRDEnd = (unsigned char *)0x30003800;
    CHECK_RET(bsp_socp_coder_set_src_chan(u32ChanId, &EncSrcAttr), BSP_ERR_SOCP_INVALID_PARA);
    EncSrcAttr.sCoderSetSrcBuf.pucRDEnd = (unsigned char *) 0x30007fff;

    EncSrcAttr.sCoderSetSrcBuf.pucRDEnd = (unsigned char *) BSP_NULL;
    CHECK_RET(bsp_socp_coder_set_src_chan(u32ChanId, &EncSrcAttr), BSP_ERR_SOCP_NULL);
    EncSrcAttr.sCoderSetSrcBuf.pucRDEnd = (unsigned char *) 0x30007fff;

    EncSrcAttr.sCoderSetSrcBuf.pucRDEnd = (unsigned char *) 0x30008004;
    CHECK_RET(bsp_socp_coder_set_src_chan(u32ChanId, &EncSrcAttr), BSP_ERR_SOCP_NOT_8BYTESALIGN);
    EncSrcAttr.sCoderSetSrcBuf.pucRDEnd = (unsigned char *) 0x30007fff;
...
{
    BSP_U32 u32ChanId = 10;     /* 避免通道正在running，使用保留的通道 */
    SOCP_CODER_SRC_CHAN_S EncSrcAttr;
    ...
    EncSrcAttr.eMode = SOCP_ENCSRC_CHNMODE_LIST;
    EncSrcAttr.sCoderSetSrcBuf.pucRDStart = (unsigned char *) 0x30001000;
    EncSrcAttr.sCoderSetSrcBuf.pucRDEnd = (unsigned char *) 0x30001fff;
...
/* 设置解码通道属性 */
BSP_S32 SOCP_LLT_DEC_SRC_001(void)
{
    BSP_U32 u32ChanId;
    SOCP_DECODER_SRC_CHAN_STRU DecSrcAttr;
...
/* 设置解码通道属性 */
BSP_S32 SOCP_LLT_DEC_SRC_002(void)
{
    ...
    DecSrcAttr.sDecoderSetSrcBuf.pucInputStart = (unsigned char *) BSP_NULL;
    CHECK_RET(bsp_socp_decoder_set_src_chan_attr(u32ChanId, &DecSrcAttr), BSP_ERR_SOCP_NULL);
    DecSrcAttr.sDecoderSetSrcBuf.pucInputStart = (unsigned char *) 0x30004000;

    DecSrcAttr.sDecoderSetSrcBuf.pucInputStart = (unsigned char *) 0x30004004;
    CHECK_RET(bsp_socp_decoder_set_src_chan_attr(u32ChanId, &DecSrcAttr), BSP_ERR_SOCP_NOT_8BYTESALIGN);
    DecSrcAttr.sDecoderSetSrcBuf.pucInputStart = (unsigned char *) 0x30004000;

    DecSrcAttr.sDecoderSetSrcBuf.pucInputEnd   = (unsigned char *)0x30003800;   /* 起始大于结束*/
    CHECK_RET(bsp_socp_decoder_set_src_chan_attr(u32ChanId, &DecSrcAttr), BSP_ERR_SOCP_INVALID_PARA);
    DecSrcAttr.sDecoderSetSrcBuf.pucInputEnd = (unsigned char *) 0x30007fff;

    DecSrcAttr.sDecoderSetSrcBuf.pucInputEnd = (unsigned char *) BSP_NULL;
    CHECK_RET(bsp_socp_decoder_set_src_chan_attr(u32ChanId, &DecSrcAttr), BSP_ERR_SOCP_NULL);
    DecSrcAttr.sDecoderSetSrcBuf.pucInputEnd = (unsigned char *) 0x30007fff;

    DecSrcAttr.sDecoderSetSrcBuf.pucInputEnd = (unsigned char *) 0x30008008;   /* 长度非8字节对齐 */
    CHECK_RET(bsp_socp_decoder_set_src_chan_attr(u32ChanId, &DecSrcAttr), BSP_ERR_SOCP_NOT_8BYTESALIGN);
    DecSrcAttr.sDecoderSetSrcBuf.pucInputEnd = (unsigned char *) 0x30007fff;
...
/* 设置解码通道属性 */
BSP_S32 SOCP_LLT_DEC_SRC_003(void)
{
    BSP_U32 u32ChanId = SOCP_DECODER_SRC_CHAN_3;    /* 使用未使用的通道 */
    SOCP_DECODER_SRC_CHAN_STRU DecSrcAttr;
...
/* 重复设置解码通道属性 */
BSP_S32 SOCP_LLT_DEC_SRC_004(void)
{
    /* 对应通道1*/
    BSP_U32 u32ChanId = SOCP_DECODER_SRC_CHAN_3;    /* 使用未使用的通道 */
    SOCP_DECODER_SRC_CHAN_STRU DecSrcAttr;
...
/* 设置解码通道属性 */
BSP_S32 SOCP_LLT_DEC_SRC_005(void)
{
    BSP_U32 u32ChanId = SOCP_DECODER_SRC_CHAN_0;
    SOCP_DECODER_SRC_CHAN_STRU DecSrcAttr;
    int i;
    ...
    for(i=0; i<2; i++)
    {
        u32ChanId = SOCP_DECODER_SRC_CHAN_2 + i;
        CHECK_RET(bsp_socp_decoder_set_src_chan_attr(u32ChanId, &DecSrcAttr), BSP_OK);
        CHECK_RET(socp_soft_free_decsrc_chan(u32ChanId),BSP_OK);
    }
...
/* 申请解码目的通道 */
BSP_S32 SOCP_LLT_DEC_DST_001(void)
{
...
/* 申请解码目的通道 */
BSP_S32 SOCP_LLT_DEC_DST_002(void)
{
    BSP_U32 u32ChanId;
    ...
    DecDestAttr.sDecoderDstSetBuf.pucOutputStart = (unsigned char *) 0;
    CHECK_RET(bsp_socp_decoder_set_dest_chan(u32ChanId, &DecDestAttr), BSP_ERR_SOCP_NULL);
    DecDestAttr.sDecoderDstSetBuf.pucOutputStart = (unsigned char *) 0x30004000;

    DecDestAttr.sDecoderDstSetBuf.pucOutputEnd = (unsigned char *) 0;
    CHECK_RET(bsp_socp_decoder_set_dest_chan(u32ChanId, &DecDestAttr), BSP_ERR_SOCP_NULL);
    DecDestAttr.sDecoderDstSetBuf.pucOutputEnd = (unsigned char *) 0x30007fff;

    DecDestAttr.sDecoderDstSetBuf.pucOutputStart = (unsigned char *) 0x30008000;
    CHECK_RET(bsp_socp_decoder_set_dest_chan(u32ChanId, &DecDestAttr), BSP_ERR_SOCP_INVALID_PARA);
    DecDestAttr.sDecoderDstSetBuf.pucOutputStart = (unsigned char *) 0x30004000;

    DecDestAttr.sDecoderDstSetBuf.pucOutputStart = (unsigned char *) 0x30004004;
    CHECK_RET(bsp_socp_decoder_set_dest_chan(u32ChanId, &DecDestAttr), BSP_ERR_SOCP_NOT_8BYTESALIGN);
    DecDestAttr.sDecoderDstSetBuf.pucOutputStart = (unsigned char *) 0x30004000;

    DecDestAttr.sDecoderDstSetBuf.pucOutputEnd = (unsigned char *) 0x30007ff3;
    CHECK_RET(bsp_socp_decoder_set_dest_chan(u32ChanId, &DecDestAttr), BSP_ERR_SOCP_NOT_8BYTESALIGN);
    DecDestAttr.sDecoderDstSetBuf.pucOutputEnd = (unsigned char *) 0x30007fff;
...
/* 申请解码目的通道 */
BSP_S32 SOCP_LLT_DEC_DST_003(void)
{
    BSP_U32 u32ChanId;
    SOCP_DECODER_DEST_CHAN_STRU DecDestAttr;
...
/* 申请解码目的通道 */
BSP_S32 SOCP_LLT_DEC_DST_004(void)
{
...
/* 释放通道，释放无效通道*/
BSP_S32 SOCP_LLT_FREE_CHAN_001(void)
{
    BSP_U32 u32ChanId;
...
/* 释放通道，释放未申请通道 */
BSP_S32 SOCP_LLT_FREE_CHAN_002(void)
{
    BSP_U32 u32ChanId;

    DEV_INIT();

    u32ChanId = (SOCP_CODER_SRC_CHAN << 16)|10; /* 使用保留通道 */
    CHECK_RET(bsp_socp_free_channel(u32ChanId), BSP_ERR_SOCP_INVALID_CHAN);
...
/* 释放通道，释放编码通道成功 */
BSP_S32 SOCP_LLT_FREE_CHAN_003(void)
{
    BSP_U32 u32ChanId;
...
/* 释放通道，释放解码通道成功 */
BSP_S32 SOCP_LLT_FREE_CHAN_004(void)
{
    BSP_U32 u32ChanId;
...
/* 释放通道，释放运行中的通道 */
BSP_S32 SOCP_LLT_FREE_CHAN_005(void)
{
    BSP_U32 u32ChanId;
    BSP_U32 ret;
    ...
    ret = SocpSetEncChan1(SOCP_CODER_DEST_CHAN_6);
    if(-1 == (s32)ret)
    {
       socp_printf("SOCP TEST: FREE CHANNEL CASE 5 FAILED\n");
        return 0;
...
#if 0
/* 释放通道，反复申请释放 */
BSP_S32 SOCP_LLT_FREE_CHAN_006(void)
{
    BSP_U32 u32ChanId[6];
    BSP_S32 n=4;
    BSP_S32 i, j, ret;
...
BSP_S32 SOCP_LLT_SET_EVENT_001(void)
{
    BSP_U32 u32ChanId;
    DEV_INIT();
...
BSP_S32 SOCP_LLT_SET_EVENT_002(void)
{
    BSP_U32 u32ChanId;
    DEV_INIT();

    u32ChanId = (SOCP_CODER_SRC_CHAN << 16)|10;
    CHECK_RET(bsp_socp_register_event_cb(u32ChanId, SocpEventCB), BSP_ERR_SOCP_INVALID_CHAN);

    u32ChanId = (SOCP_DECODER_DEST_CHAN << 16)|3;
    CHECK_RET(bsp_socp_register_event_cb(u32ChanId, SocpEventCB), BSP_ERR_SOCP_INVALID_CHAN);
...
BSP_S32 SOCP_LLT_SET_EVENT_003(void)
{
    BSP_U32 u32ChanId;
    DEV_INIT();
    ...
    u32ChanId = SOCP_DECODER_SRC_CHAN_3;
    CHECK_RET(bsp_socp_register_event_cb(u32ChanId, SocpEventCB), BSP_ERR_SOCP_INVALID_CHAN);
...
/* 设置事件回调函数，设置有效事件回调函数 */
BSP_S32 SOCP_LLT_SET_EVENT_004(void)
{
    BSP_U32 u32ChanId1;
    BSP_U32 u32ChanId2;
    DEV_INIT();
...
/* 设置事件回调函数，设置事件回调函数为空 */
BSP_S32 SOCP_LLT_SET_EVENT_005(void)
{
    BSP_U32 u32ChanId1;
    BSP_U32 u32ChanId2;
    DEV_INIT();
...
BSP_S32 SOCP_LLT_SET_EVENT_006(void)
{
    BSP_U32 u32ChanId;
    BSP_U32 i;
    DEV_INIT();
...
BSP_S32 SOCP_LLT_SET_READ_001(void)
{
    BSP_U32 u32ChanId;
    DEV_INIT();
...
BSP_S32 SOCP_LLT_SET_READ_002(void)
{
    BSP_U32 u32ChanId;
    DEV_INIT();
...
BSP_S32 SOCP_LLT_SET_READ_003(void)
{
    BSP_U32 u32ChanId;
...
BSP_S32 SOCP_LLT_SET_READ_004(void)
{
    BSP_U32 u32ChanId;
    DEV_INIT();
...
BSP_S32 SOCP_LLT_SET_READ_005(void)
{
    BSP_U32 u32ChanId;
    DEV_INIT();
...
BSP_S32 SOCP_LLT_SET_RD_001(void)
{
    BSP_U32 u32ChanId;
    DEV_INIT();
...
BSP_S32 SOCP_LLT_SET_RD_002(void)
{
    BSP_U32 u32ChanId;
    DEV_INIT();
...
BSP_S32 SOCP_LLT_SET_RD_003(void)
{
    BSP_U32 u32ChanId;
...
BSP_S32 SOCP_LLT_SET_RD_004(void)
{
    BSP_U32 u32ChanId;
...
/* 设置RD回调函数，设置有效RD回调函数 */
BSP_S32 SOCP_LLT_SET_RD_005(void)
{
    BSP_U32 u32ChanId;
    DEV_INIT();
...
/* 设置RD回调函数，设置RD回调函数为空 */
BSP_S32 SOCP_LLT_SET_RD_006(void)
{
    BSP_U32 u32ChanId;
    DEV_INIT();
...
/* 通道控制，启动无效通道 */
BSP_S32 SOCP_LLT_START_001(void)
{
    BSP_U32 u32ChanId;
    DEV_INIT();
...
/* 通道控制，启动未申请通道 */
BSP_S32 SOCP_LLT_START_002(void)
{
    BSP_U32 u32ChanId;
    DEV_INIT();
...
/* 通道控制，启动时，目的通道未设置 */
BSP_S32 SOCP_LLT_START_003(void)
{
    BSP_U32 u32ChanId;
    DEV_INIT();
...
/* 通道控制，启动成功 */
BSP_S32 SOCP_LLT_START_004(void)
{
...
/* 通道控制，重复启动 */
BSP_S32 SOCP_LLT_START_005(void)
{
    BSP_U32 u32ChanId1, u32ChanId2;
    DEV_INIT();
...
/* 通道控制，停止无效通道 */
BSP_S32 SOCP_LLT_STOP_001(void)
{
    BSP_U32 u32ChanId;
    DEV_INIT();
...
/* 通道控制，停止未申请通道 */
BSP_S32 SOCP_LLT_STOP_002(void)
{
    BSP_U32 u32ChanId;
    DEV_INIT();
...
/* 通道控制，停止成功 */
BSP_S32 SOCP_LLT_STOP_003(void)
{
    BSP_U32 u32ChanId1, u32ChanId2;
    DEV_INIT();
...
/* 通道控制，重复停止 */
BSP_S32 SOCP_LLT_STOP_004(void)
{
    BSP_U32 u32ChanId1, u32ChanId2;
    DEV_INIT();
...
/* 通道控制，反复打开、停止 */
BSP_S32 SOCP_LLT_STOP_005(void)
{
...
void socp_set_dstchan_mode(u32 chan, u32 mode)
{
    if((chan >= SOCP_MAX_ENCDST_CHN) || (mode > 1))
    {
        socp_printf("error chan %d, mode %d.\n", chan, mode);
        return ;
    }
    
    SOCP_REG_SETBITS(SOCP_REG_ENC_MASK0, (16+chan), 1, 0);
    
    SOCP_REG_SETBITS(SOCP_REG_ENCDEST_SBCFG(chan), 0, 1, mode);
    
    socp_printf("success chan %d, mode %d.\n", chan, mode);
}

void socp_get_dstchan_mode(u32 chan)
{
    u32  ModeState = 0;

    SOCP_REG_READ(SOCP_REG_ENCDEST_SBCFG(chan), ModeState);
    
    socp_printf("set success chan %d, ModeState 0x%08x.\n", chan, ModeState);
}

void socp_print_chan_pointer(u32 u32ChanID)
{
    u32 u32WritePtr, u32ReadPtr;

    SOCP_REG_READ(SOCP_REG_ENCDEST_BUFWPTR(u32ChanID&0xff), u32WritePtr);
    SOCP_REG_READ(SOCP_REG_ENCDEST_BUFRPTR(u32ChanID&0xff), u32ReadPtr);

    socp_printf("chan[%d] u32WritePtr=[0x%08x], u32ReadPtr=[0x%08x]\n", u32ChanID&0xff, u32WritePtr, u32ReadPtr);
}
...
BSP_S32 socp_decode_task_stress_001(BSP_VOID *param)
{
    ...
    //kfree(packet);
    TM_socp_free(packet);
    socp_printf("socp_decode_task_stress_001 done.\n");
...
//        socp_printf("0x%x, 0x%x, 0x%x\n", WtBuff.u32Size, WtBuff.u32RbSize, cnt);
    ...
    TM_socp_free(packet);
    socp_printf("socp_decode_dcore_task_stress break.\n");

    return BSP_OK;
}

/* 编码测试, APP CPU发APP CPU收，固定长度块式数据包 */
BSP_S32 SOCP_LLT_ENCODE_001_START(void)
{
    char taskName[30] = {0};
...
BSP_S32 SOCP_LLT_ENCODE_001_STOP(void)
{
    /*停止通道*/
...
BSP_S32 SOCP_LLT_ENCODE_002_START(void)
{
    char taskName[30] = {0};

    socp_printf("SOCP_LLT_ENCODE_002\n");
...
BSP_S32 SOCP_LLT_ENCODE_002_STOP(void)
{
    /*停止通道*/
    CHECK_RET(bsp_socp_stop(g_stCase[0].SrcCh), BSP_OK);
    CHECK_RET(bsp_socp_free_channel(g_stCase[0].SrcCh), BSP_OK);
...
BSP_S32 SOCP_LLT_ENCODE_003_START(void)
{
    char taskName[30] = {0};

    socp_printf("SOCP_LLT_ENCODE_003\n");
...
BSP_S32 SOCP_LLT_ENCODE_003_STOP(void)
{
    /*停止通道*/
...
BSP_S32 SOCP_LLT_ENCODE_004_START(void)
{
    char taskName[30] = {0};
...
BSP_S32 SOCP_LLT_ENCODE_004_STOP(void)
{
    /*停止通道*/
    CHECK_RET(bsp_socp_stop(g_stCase[1].SrcCh), BSP_OK);
    CHECK_RET(bsp_socp_free_channel(g_stCase[1].SrcCh), BSP_OK);
...
BSP_S32 SOCP_LLT_ENCODE_006_START(void)
{
    g_ul_rev_pkt_flag = false;
    ...
    CHECK_RET(bsp_socp_register_event_cb(g_stCase[0].DstCh, g_stCase[0].EventCb), BSP_OK);
    CHECK_RET(bsp_socp_register_read_cb(g_stCase[0].DstCh, g_stCase[0].ReadCb), BSP_OK);

    return 0;
}

BSP_S32 SOCP_LLT_ENCODE_006_STOP(void)
{
    CHECK_RET(socp_soft_free_encdst_chan(g_stCase[0].DstCh), BSP_OK);
    /*释放申请的内存*/
    if(g_stCase[0].bDstSet)
...
BSP_S32 SOCP_LLT_ENCODE_007_START(void)
{
    g_ul_rev_pkt_flag = false;
...
BSP_S32 SOCP_LLT_ENCODE_007_STOP(void)
{
    CHECK_RET(socp_soft_free_encdst_chan(g_stCase[1].DstCh), BSP_OK);
    /*释放申请的内存*/
    if(g_stCase[1].bDstSet)
...
BSP_S32 SOCP_LLT_ENCODE_009_START(void)
{
    char taskName[30] = {0};
...
BSP_S32 SOCP_LLT_ENCODE_009_STOP(void)
{
    /*停止通道*/
...
BSP_S32 SOCP_LLT_ENCODE_010_START(void)
{
    char taskName[30] = {0};
...
BSP_S32 SOCP_LLT_ENCODE_010_STOP(void)
{
    /*停止通道*/
...
BSP_S32 SOCP_LLT_ENCODE_011_START(void)
{
    char taskName[30] = {0};
...
BSP_S32 SOCP_LLT_ENCODE_011_STOP(void)
{
    /*停止通道*/
...
BSP_S32 SOCP_LLT_ENCODE_012_START(void)
{
    int i;
...
BSP_S32 SOCP_LLT_ENCODE_012_STOP(void)
{
    BSP_U32 i = 0;
    BSP_U32 dstChanID;
...
/* 编码测试,改变data type 测试*/
BSP_S32 SOCP_LLT_ENCODE_013_START(void)
{
    char taskName[30] = {0};
...
BSP_S32 SOCP_LLT_ENCODE_013_STOP(void)
{
    /*停止通道*/
...
/* 编码测试,测试数据包长为1的情况*/
BSP_S32 SOCP_LLT_ENCODE_014_START(void)
{
    SOCP_ST_CASE_S *pCase = &g_stCase[0];
...
BSP_S32 SOCP_LLT_ENCODE_014_STOP(void)
{
    CHECK_RET(socp_soft_free_encdst_chan(g_stCase[0].DstCh), BSP_OK);
...
/* 编码测试,测试数据包长为2048的情况*/
BSP_S32 SOCP_LLT_ENCODE_015_START(void)
{
    SOCP_ST_CASE_S *pCase = &g_stCase[0];
...
BSP_S32 SOCP_LLT_ENCODE_015_STOP(void)
{
    CHECK_RET(socp_soft_free_encdst_chan(g_stCase[0].DstCh), BSP_OK);
...
/* 编码测试,测试包头错误 */
BSP_S32 SOCP_LLT_ENCODE_016_START(void)
{
    char taskName[30] = {0};
...
BSP_S32 SOCP_LLT_ENCODE_016_STOP(void)
{
    /*停止通道*/
    CHECK_RET(bsp_socp_stop(g_stCase[0].SrcCh), BSP_OK);
    CHECK_RET(bsp_socp_free_channel(g_stCase[0].SrcCh), BSP_OK);
...
BSP_S32 SOCP_LLT_ENCODE_017_START(void)
{
    char taskName[30] = {0};
...
BSP_S32 SOCP_LLT_ENCODE_017_STOP(void)
{
    /*停止通道*/
...
/* 编码测试，多通道测试 */
BSP_S32 SOCP_LLT_ENCODE_018_START(void)
{
    char taskName[30] = {0};
...
BSP_S32 SOCP_LLT_ENCODE_018_STOP(void)
{
    /*停止通道*/
    CHECK_RET(bsp_socp_stop(g_stCase[0].SrcCh), BSP_OK);
    CHECK_RET(bsp_socp_free_channel(g_stCase[0].SrcCh), BSP_OK);
...
/* 编码测试，多通道测试 , 多输入，多输出*/
BSP_S32 SOCP_LLT_ENCODE_019_START(void)
{
    char taskName[30] = {0};
...
BSP_S32 SOCP_LLT_ENCODE_019_STOP(void)
{
    BSP_U32 i = 0;
...
/* 编码测试 , 双核多通道测试*/
BSP_S32 SOCP_LLT_ENCODE_020_START(void)
{
    char taskName[30] = {0};
...
BSP_S32 SOCP_LLT_ENCODE_020_STOP(void)
{
    /*停止通道*/
    CHECK_RET(bsp_socp_stop(g_stCase[9].SrcCh), BSP_OK);
    CHECK_RET(bsp_socp_free_channel(g_stCase[9].SrcCh), BSP_OK);
...
BSP_S32 SOCP_LLT_ENCODE_021_START(void)
{
    char taskName[30] = {0};
...
BSP_S32 SOCP_LLT_ENCODE_021_STOP(void)
{
    /*停止通道*/
...
/* SOCP工作状态测试: 忙碌 */
BSP_S32 SOCP_LLT_ENCODE_022_START(void)
{
    char taskName[30] = {0};
    ...
    if(SOCP_BUSY == state)
    {
        socp_printf("SOCP_LLT_ENCODE_022: BUSY TEST SUCCEED\n");
    }
    else
    {
        socp_printf("SOCP_LLT_ENCODE_022: BUSY TEST FAILED\n");
    }
...
/* SOCP工作状态测试: 忙碌 */
BSP_S32 SOCP_LLT_ENCODE_022_STOP(void)
{
    /*停止通道*/
    CHECK_RET(bsp_socp_stop(g_stCase[0].SrcCh), BSP_OK);
    CHECK_RET(bsp_socp_free_channel(g_stCase[0].SrcCh), BSP_OK);
...
/* SOCP工作状态测试: 空闲 */
BSP_S32 SOCP_LLT_ENCODE_023_START(void)
{
    char taskName[30] = {0};
...
/* SOCP工作状态测试: 空闲 */
BSP_S32 SOCP_LLT_ENCODE_023_STOP(void)
{
    SOCP_STATE_ENUM_UINT32 state;
    /*停止通道*/
    CHECK_RET(bsp_socp_stop(g_stCase[0].SrcCh), BSP_OK);
    ...
    if(SOCP_IDLE == state)
    {
        socp_printf("SOCP_LLT_ENCODE_022: IDLE TEST SUCCEED\n");
    }
    else
    {
        socp_printf("SOCP_LLT_ENCODE_022: IDLE TEST FAILED\n");
    }
    return 0;
}

/* 解码通路 测试 */
BSP_S32 SOCP_LLT_DECODE_001_START(void)
{
    char taskName[30] = {0};
    DEV_INIT();
    msleep(50);
...
BSP_S32 SOCP_LLT_DECODE_001_STOP(void)
{
    /*停止通道*/
...
/* 解码测试传输阈值测试 */
BSP_S32 SOCP_LLT_DECODE_002_START(void)
{
    char taskName[30] = {0};
    DEV_INIT();
...
BSP_S32 SOCP_LLT_DECODE_002_STOP(void)
{
    /*停止通道*/
...
/* 解码测试 测试data type匹配*/
BSP_S32 SOCP_LLT_DECODE_003_START(void)
{
    char taskName[30] = {0};
    DEV_INIT();
...
BSP_S32 SOCP_LLT_DECODE_003_STOP(void)
{
    /*停止通道*/
...
/* 解码测试发送一个数据包测试 */
BSP_S32 SOCP_LLT_DECODE_004_START(void)
{
    char taskName[30] = {0};
    DEV_INIT();
...
BSP_S32 SOCP_LLT_DECODE_004_STOP(void)
{
    /*停止通道*/
...
/* 解码测试数据包长度为6，最小值 */
BSP_S32 SOCP_LLT_DECODE_005_START(void)
{
    char taskName[30] = {0};
...
BSP_S32 SOCP_LLT_DECODE_005_STOP(void)
{
    /*停止通道*/
...
/* 解码测试最大数据包长度 2024 */
BSP_S32 SOCP_LLT_DECODE_006_START(void)
{
    char taskName[30] = {0};
    SOCP_DEC_PKTLGTH_STRU  pPktlgth;
    pPktlgth.u32PktMax = 2;
...
BSP_S32 SOCP_LLT_DECODE_006_STOP(void)
{
    /*停止通道*/
...
/* 解码测试 包头异常*/
BSP_S32 SOCP_LLT_DECODE_007_START(void)
{
    char taskName[30] = {0};
...
BSP_S32 SOCP_LLT_DECODE_007_STOP(void)
{
    /*停止通道*/
    CHECK_RET(bsp_socp_stop(g_stDecCase[0].SrcCh), BSP_OK);
    CHECK_RET(socp_soft_free_decsrc_chan(g_stDecCase[0].SrcCh), BSP_OK);
...
/* 解码测试crc校验错 */
BSP_S32 SOCP_LLT_DECODE_008_START(void)
{
    char taskName[30] = {0};
...
BSP_S32 SOCP_LLT_DECODE_008_STOP(void)
{
    /*停止通道*/
    CHECK_RET(bsp_socp_stop(g_stDecCase[0].SrcCh), BSP_OK);
    CHECK_RET(socp_soft_free_decsrc_chan(g_stDecCase[0].SrcCh), BSP_OK);
...
BSP_S32 SOCP_LLT_DECODE_009_START(void)
{
    char taskName[30] = {0};
    SOCP_DEC_PKTLGTH_STRU pPktlgth;
...
BSP_S32 SOCP_LLT_DECODE_009_STOP(void)
{
    /*停止通道*/
    CHECK_RET(bsp_socp_stop(g_stDecCase[8].SrcCh), BSP_OK);
    CHECK_RET(socp_soft_free_decsrc_chan(g_stDecCase[8].SrcCh), BSP_OK);
...
/* 解码测试,包长错误,大 于 最大包长 */
BSP_S32 SOCP_LLT_DECODE_010_START(void)
{
    char taskName[30] = {0};
    SOCP_DEC_PKTLGTH_STRU pPktlgth;
...
BSP_S32 SOCP_LLT_DECODE_010_STOP(void)
{
    /*停止通道*/
    CHECK_RET(bsp_socp_stop(g_stDecCase[9].SrcCh), BSP_OK);
    CHECK_RET(socp_soft_free_decsrc_chan(g_stDecCase[9].SrcCh), BSP_OK);
...
BSP_S32 SOCP_LLT_DECODE_011_START(void)
{
    char taskName[30] = {0};
...
BSP_S32 SOCP_LLT_DECODE_011_STOP(void)
{
    /*停止通道*/
    CHECK_RET(bsp_socp_stop(g_stDecCase[0].SrcCh), BSP_OK);
    CHECK_RET(socp_soft_free_decsrc_chan(g_stDecCase[0].SrcCh), BSP_OK);
...
/* 解码测试buffer下溢错误 */
BSP_S32 SOCP_LLT_DECODE_012_START(void)
{
    char taskName[30] = {0};
...
BSP_S32 SOCP_LLT_DECODE_012_STOP(void)
{
    /*停止通道*/
...
/* 解码测试输入输出一对四 */
BSP_S32 SOCP_LLT_DECODE_013_START(void)
{
    char taskName[30] = {0};
...
BSP_S32 SOCP_LLT_DECODE_013_STOP(void)
{
    BSP_U32 i = 0;
    BSP_U32 u32DstId = 0;
...
/* 解码测试四对十六 */
BSP_S32 SOCP_LLT_DECODE_014_START(void)
{
    char taskName[30] = {0};
...
BSP_S32 SOCP_LLT_DECODE_014_STOP(void)
{
    BSP_U32 i = 0;
...
/* 编码测试，多通道测试 , 多输入，多输出*/
BSP_S32 SOCP_LLT_ENCODE_STRESS(void)
{
    char taskName[30] = {0};
...
/* 解码压力测试，四对十六通道测试*/
BSP_S32 SOCP_LLT_DECODE_STRESS(void)
{
    char taskName[30] = {0};
...
/*双核编码测试，M核上发送，A核上接收*/
BSP_S32 SOCP_LLT_ENCODE_DCORE_STRESS(void)
{
    DEV_INIT();
