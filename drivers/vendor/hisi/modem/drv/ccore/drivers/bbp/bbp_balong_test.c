...
unsigned int bbp_pwrctrl_is_enabled_test(int pwr_id)
{
    ...
    state = bbp_bit_chk(g_bbpinfo.pwr.pwr_act[pwr_id].mos_ctrl.state_reg,(0x1 << g_bbpinfo.pwr.pwr_act[pwr_id].mos_ctrl.state_bit))\
           &bbp_bit_chk(g_bbpinfo.pwr.pwr_act[pwr_id].mos_ctrl.rdy_reg,(0x1 << g_bbpinfo.pwr.pwr_act[pwr_id].mos_ctrl.rdy_bit))\
           &bbp_bit_chk(g_bbpinfo.pwr.pwr_act[pwr_id].clk_ctrl.state_reg,(0x1 << g_bbpinfo.pwr.pwr_act[pwr_id].clk_ctrl.state_bit))\
           &~(bbp_bit_chk(g_bbpinfo.pwr.pwr_act[pwr_id].rst_ctrl.state_reg,(0x1 << g_bbpinfo.pwr.pwr_act[pwr_id].rst_ctrl.state_bit)))\
           &~(bbp_bit_chk(g_bbpinfo.pwr.pwr_act[pwr_id].iso_ctrl.state_reg,(0x1 << g_bbpinfo.pwr.pwr_act[pwr_id].iso_ctrl.state_bit)));
