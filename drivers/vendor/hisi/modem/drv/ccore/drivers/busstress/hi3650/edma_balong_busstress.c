...
#define EDMA_HANDLE_NUM (EDMA_MOVE_TYPE_BUTTOM)
...
struct edma_busstress_info
{
    ...
    AXI_DMA_TASK_HANDLE_S  stDMATaskHandle[EDMA_MOVE_TYPE_BUTTOM];
...
u32 g_edma_busstress_test_ok_cnt[EDMA_MOVE_TYPE_BUTTOM] = {0};
u32 g_edma_busstress_test_fail_cnt[EDMA_MOVE_TYPE_BUTTOM] = {0};
...
s32 edma_test_lli_loop(enum edma_req_id req )
{
    ...
    psttemp = edma_lli_loop_cb;
        ...
        psttemp->src_addr = (unsigned int)osl_cachedma_malloc(EDMA_BUSSTRESS_DDR_TO_BBEDTCM_SIZE);//edma_lli_loop_src;
        psttemp->des_addr = (unsigned int)EDMA_BUSSTRESS_DDR_TO_BBE16DTCM_DST_ADDR;//edma_lli_loop_des;EDMA_BUSSTRESS_DDR_TO_BBE16DTCM_DST_ADDR
        psttemp->cnt0 = EDMA_BUSSTRESS_DDR_TO_BBEDTCM_SIZE;
        psttemp->bindx = 0;
        psttemp->cindx = 0;
        psttemp->cnt1  = 0;
