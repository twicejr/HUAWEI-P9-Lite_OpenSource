...
void pmic_volt_ctrl(void)
{
    ...
    if( 0x20 == osl_reg_get_bit((void *)(0x9001a000 + (0x5<<2)), 0, 31) )
    {
        /* pmu version v520 = 0x20
        ldo32 给 ddrphy_IO 供电方案，需要增加开 ldo32 */

    	/*set ldo32 to 1.2v*/
    	osl_reg_set_bit((void *)(0x9001a000 + 0x25c), 0, 3, 0x7);
    	/*open ldo32*/
    	osl_reg_set_bit((void *)(0x9001a000 + 0x258), 1, 1, 0x1);
    }
...
void mddrc_init(void)
{
	...
	osl_reg_set_bit((void *)(0x90000000 + 0x800), 0, 0, 0x1);
