...
typedef NV_RFIC_6362_STRU TDS_NV_RFIC_6362_STRU;
...
typedef struct
{
	...
	TDS_NV_PBAND_CHAN_PARA_STRU		astChanPara[TDS_RF_SUPPORT_BAND_NUM];
...
typedef struct
{
    ...
    UINT16 ulRsv;
    TDS_MIPI_CMD_STRU   stAptModeDisable[TDS_APT_MIPI_NUM];
    TDS_MIPI_CMD_STRU   stAptModeStandby[TDS_APT_MIPI_NUM];
    TDS_MIPI_CMD_STRU   stAptMode3G4G[TDS_APT_MIPI_NUM];
    TDS_MIPI_CMD_STRU   stAptData[TDS_APT_MIPI_NUM];
    TDS_MIPI_CMD_STRU   stAptOff[TDS_APT_MIPI_NUM];
    TDS_MIPI_CMD_STRU   stPaTrig;
}TDS_NV_LPHY_MIPI_APT_STRU;

#define TDS_ETM_STANDBY_NUM  6
#define TDS_ETM_IDL_NUM      6

typedef struct
{
    UINT16 usEtmValidFlag;
    UINT8  ucIDLCmdNum;
    UINT8  ucStandbyCmdNum;
    TDS_MIPI_CMD_STRU   astEtmAptStandby[TDS_ETM_STANDBY_NUM];
    TDS_MIPI_CMD_STRU   astEtmAptIDL[TDS_ETM_IDL_NUM];
    TDS_MIPI_CMD_STRU   astEtmRes[2];
    //TDS_MIPI_CMD_STRU   astEtmRes1[TDS_ETM_IDL_NUM];
    //TDS_MIPI_CMD_STRU   astEtmRes2[TDS_ETM_IDL_NUM];
}TDS_NV_ETM_MIPI_PARA_STRU;
...
typedef struct
{
    ...
    NV_AFC_PORT_SEL_INDEX_STRU        stAfcPortSelIdxPara;
    TDS_NV_HIGH_SPEED_PARA_STRU       stTdsHighSpeedPara;
    TDS_NV_GU_VIA_C_CONFIG_STRU       stTdsGuViaPara;
    UCOM_NV_VIA_C_SEC_CONFIG_STRU     stTdsGuSecViaPara;
    TDS_NV_TX_POWER_PARA_STRU         stTdsTxPowerPara;
    TDS_NV_LPHY_MIPI_APT_STRU         stTdsMipiAptPara;
    TDS_NV_ETM_MIPI_PARA_STRU         stEtmAptPara;
}TDS_NV_STRU;
...
TDS_NV_PBAND_CHAN_PARA_STRU* TDS_GetChanNvPara(UINT32 ulBandIdx);
...
extern UINT16 gusTdsEquipBandIndex;
#else
extern UINT16 gusTdsEquipBandIndex;
#endif
