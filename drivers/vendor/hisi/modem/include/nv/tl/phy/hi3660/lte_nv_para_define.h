...
/*	UINT16    usReserved; */
    ...
    INT32    lHrlRsrpThr;
    INT16    sTHrlOnRsrpThr;    /*时域谐波打开 rsrp门限*/
    INT16    sTHrlOffRsrpThr;   /*时域谐波关闭 rsrp门限*/
}NV_AGC_PARA_STRU;
/*UL NV */
typedef enum
{
...
typedef struct{
	...
	/*#ifdef FEATURE_LTE_CAT_PART_R11*/
	UINT8                               ucUeCapUl;
    UINT8                               aucResv[3];
    /*#endif*/
    #if 0
...
typedef UINT32 HAR_SOURCE_ENUM_UINT32;
...
typedef struct
{
    ...
    HAR_SOURCE_ENUM_UINT32 enHarSource;
