...
#define CT_OM_NOTCH_SWITCH_REQ             (0X180)

#define CT_OM_ET_LUT_REQ                    (0x149)
#define CT_OM_ET_LUT_CFG                    (0x14A)
#define CT_OM_ET_DELAY_REQ                  (0x14B)
#define CT_OM_ET_DELAY_CFG                  (0x14C)
...
#define NCIT_OM_TX_ANT_SET_REQ             (0x174)
#define NCIT_OM_RSSI_QUERY_REQ             (0x175)

/* 调测工具 */
#define RFTOOL_OM_TRX_SET_REQ              (0x5000)
#define RFTOOL_OM_GET_RSSI_REQ             (0x5001)
#define ETTOOL_OM_PARA_REQ                 (0x5002)
#define ETTOOL_OM_DLYTRIG_REQ              (0x5003)
#define	ETTOOL_OM_LABPARA_EXTR_PLANB_REQ   (0x5004)
#define	ETTOOL_OM_DATACOLLECTION_REQ       (0x5005)
#define	ETTOOL_OM_MIPISEND_REQ             (0x5006)
#define	RFTOOL_OM_RSSI_QRY_INIT_REQ        (0x5007)
#endif
...
#define CT_HD3_POWER_NUM        3
#define HD3_CAL_POINT_NUM       4
...
/****************************************************************************************************
描述:   HD3校准，用于^HD3
ID:     OM_PHY_CT_F_CALIHD3_SET_REQ,       PHY_OM_CT_F_CALIHD3_SET_CNF,       PHY_OM_CT_F_CALIHD3_IND
结构:   OM_PHY_CT_F_CALIHD3_SET_REQ_STRU, PHY_OM_CT_F_CALIHD3_SET_CNF_STRU, PHY_OM_CT_F_CALIHD3_IND_STRU
******************************************************************************************************/
typedef struct
{
	UINT32 ulMsgId;
    ...
    UINT16 usBand;      /*BAND号*/
    //UINT16 usRes;
}OM_PHY_CT_HD3_SET_REQ_STRU;

typedef struct
{
	UINT32 ulMsgId;
}OM_PHY_CT_HD3_SET_CNF_STRU;

typedef struct
{
    INT16  asPowCode[CT_HD3_POWER_NUM];
    UINT16 usPowCodeNum;
	INT32  aulBr[CT_HD3_POWER_NUM];
	INT32  aulBi[CT_HD3_POWER_NUM];
}OM_PHY_CT_HD3_RESULT_STRU;

typedef struct
{
	UINT32 ulMsgId;
	UINT16 usCalNum;  /*指示有几组校准结果,最多支持两组结果*/
	UINT16 usRes;
    OM_PHY_CT_HD3_RESULT_STRU astHD3Result[HD3_CAL_POINT_NUM];/*对应NV的4个点*/

}OM_PHY_CT_HD3_IND_STRU;
...
typedef struct
{
    ...
    UINT16  ausCmtms[TX_POW_MAX_NUM];
...
typedef UINT16 PHY_OM_CT_MODE_UINT16;
typedef struct
{
    UINT16 usFreq;
    UINT16 usTxRfCode;           /*发射功率控制字，包括RF和IF两部分*/
    UINT8 ucPaLevel;
    UINT8 ucRsv[3];
}CT_TX_OPT_PARA_STRU;
...
typedef struct
{
    ...
    UINT16 usAptEnbFlg;
    UINT16 usCalAptFlg;
	PHY_OM_CT_MODE_UINT16 enCtMode;
	UINT16 usResv;
...
typedef struct
{
    ...
    UINT8  ucType;
    UINT8  aucRsv[3];
    UINT16 usDbbPowValue[TX_POW_MAX_NUM];
    UINT16 usIntDelay;
    UINT16 usFracDelay;
...
typedef enum
{
	...
	COMM_AT_CT_AAGCSET_CMDID           = 28,
	COMM_AT_CT_AGC_RESULT_REPORT_CMDID,
	COMM_AT_CMD_HD3_REQ,
	COMM_AT_CMD_HD3_IND,
    COMM_AT_CMD_RF_TOOL                = 33,
    COMM_AT_CMD_ET_TOOL,
    COMM_AT_CMD_DLY_TRIG_TOOL,
    COMM_AT_CMD_LAB_EXT_TOOL,
    COMM_AT_CMD_DATA_COLLECT_TOOL,
    COMM_AT_CMD_ET_TOOL_MIPI
