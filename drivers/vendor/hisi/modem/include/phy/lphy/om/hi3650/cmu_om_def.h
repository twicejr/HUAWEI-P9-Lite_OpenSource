...
typedef struct
{
	...
	INT16            asCmuSnr[CMU_RX_MAX_NUM];
	UINT32           aulCmuSdrPhRx[CMU_RX_MAX_NUM];// kalman input
	UINT32           aulCmuSdrPnRx[CMU_RX_MAX_NUM];// kalman input
	UINT32           aulCmuFilteredPhRx[CMU_RX_MAX_NUM];
       UINT32           aulCmuFilteredPnRx[CMU_RX_MAX_NUM];
	UINT32           aulChPowerTxRx[CMU_TX_MAX_NUM*CMU_RX_MAX_NUM];
	UINT32           aulNoisePowerTxRx[CMU_TX_MAX_NUM*CMU_RX_MAX_NUM];
	UINT16           ausConnectionInd[CMU_TX_MAX_NUM*CMU_RX_MAX_NUM];
	UINT32           aulAgcNoisePower[CMU_RX_MAX_NUM];
}CMU_PARA_OM_STRU;
typedef struct
{
