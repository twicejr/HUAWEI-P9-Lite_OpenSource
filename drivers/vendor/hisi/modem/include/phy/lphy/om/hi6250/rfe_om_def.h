...
typedef union{
    struct{
        UINT32      cycle                   :   5;//[0,4] 0-24  cycle
        UINT32      quarterChip             :   2;//[5,6] 0-3
        UINT32      chip                    :   15;//[7,21] 0-32767
        UINT32      chipGroup               :   2;//[22,23] 0-2
        UINT32      supperframe             :   6;//[29,24] 0-53
    } u;
    UINT32 bits;
}RFE_OM_CDMA_TIMING_UINION;
typedef union{
    struct{
...
typedef struct{
    ...
    UINT8                          ucValidFlg;
    UINT8                          aucRsv[3];
    RFE_OM_CDMA_TIMING_UINION       uCdmaTiming;            /*cdma 定时结构体*/
