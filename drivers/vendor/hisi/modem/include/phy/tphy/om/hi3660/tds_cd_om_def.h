...
typedef enum TDS_CD_OM_RPT_DSCH_IND
{
    ...
    TPHY_REQ_CD_BLER                    = OM_TCMD_ID(TPHY_CD_MID, OM_TYPE_IND, 0x06),
...
{
    OM_REQ_ENABLE_ENUM_UINT16  usCdSoftBitInRptEnb;
    OM_REQ_ENABLE_ENUM_UINT16  usCdSoftBitBbpRptEnb;
}TDS_CD_OM_REQ_CTRL_STRU;

typedef struct TDS_CD_OM_BLER_CTRL
{
    OM_REQ_ENABLE_ENUM_UINT16  usCdDschBlerRptEnb;
    ...
    OM_REQ_ENABLE_ENUM_UINT16  usTpyVoiceRptEnb;
}TDS_CD_OM_BLER_CTRL_STRU;


typedef struct TDS_CD_OM_DSCH_IND_RPT_CTRL
{
    OM_REQ_ENABLE_ENUM_UINT16  usCdSoftBitInputDschRptEnb;
    OM_REQ_ENABLE_ENUM_UINT16  usCdHarqParaInputDschRptEnb;
    OM_REQ_ENABLE_ENUM_UINT16  usCdTurboParaInputDschRptEnb;
    OM_REQ_ENABLE_ENUM_UINT16  usCdTurboBitOutputDschRptEnb;
    OM_REQ_ENABLE_ENUM_UINT16  usCdTurboCrcDschRptEnb;
    OM_REQ_ENABLE_ENUM_UINT16  usCdDschParaRptEnb;
}TDS_CD_OM_DSCH_IND_CTRL_STRU;

typedef struct TDS_CD_OM_DPCH_IND_RPT_CTRL
{
    OM_REQ_ENABLE_ENUM_UINT16  usCdSoftBitInputDpchRptEnb;
    OM_REQ_ENABLE_ENUM_UINT16  usCdHarqDataInputDpchRptEnb;
    OM_REQ_ENABLE_ENUM_UINT16  usCdHarqParaInputDpchRptEnb;
    OM_REQ_ENABLE_ENUM_UINT16  usCdHarqDataOutputDpchRptEnb;
    OM_REQ_ENABLE_ENUM_UINT16  usCdTfciDataDpchRptEnb;
    OM_REQ_ENABLE_ENUM_UINT16  usCdTfciDpchRptEnb;
    OM_REQ_ENABLE_ENUM_UINT16  usCdSbFlagDpchRptEnb;
    OM_REQ_ENABLE_ENUM_UINT16  usCdDpchCdTableRptEnb;

}TDS_CD_OM_DPCH_IND_CTRL_STRU;

typedef struct TDS_CD_OM_DEC_IND_RPT_CTRL
{
    OM_REQ_ENABLE_ENUM_UINT16  usCdVitParaInputRptEnb;
    OM_REQ_ENABLE_ENUM_UINT16  usCdVitDataInputRptEnb;
    OM_REQ_ENABLE_ENUM_UINT16  usCdVitDataOutputRptEnb;
    OM_REQ_ENABLE_ENUM_UINT16  usCdVitCrcRptEnb;

    OM_REQ_ENABLE_ENUM_UINT16  usCdTurboParaInputRptEnb;
    OM_REQ_ENABLE_ENUM_UINT16  usCdTurboDataInputRptEnb;
    OM_REQ_ENABLE_ENUM_UINT16  usCdTurboDataOutputRptEnb;
    OM_REQ_ENABLE_ENUM_UINT16  usCdTurboCrcRptEnb;
}TDS_CD_OM_DEC_IND_CTRL_STRU;

typedef struct TDS_CD_OM_PCCPCH_IND_RPT_CTRL
{
    OM_REQ_ENABLE_ENUM_UINT16  usCdSoftBitInputPccpchRptEnb;
    OM_REQ_ENABLE_ENUM_UINT16  usreserved;
}TDS_CD_OM_PCCPCH_IND_CTRL_STRU;

typedef struct TDS_CD_OM_FPACH_IND_RPT_CTRL
{
    OM_REQ_ENABLE_ENUM_UINT16  usCdSoftBitInputFpachRptEnb;
    OM_REQ_ENABLE_ENUM_UINT16  usreserved;
}TDS_CD_OM_FPACH_IND_CTRL_STRU;

typedef struct TDS_CD_OM_SCCPCH_IND_RPT_CTRL
{
    OM_REQ_ENABLE_ENUM_UINT16  usCdSoftBitInputSccpchRptEnb;
    OM_REQ_ENABLE_ENUM_UINT16  usreserved;
