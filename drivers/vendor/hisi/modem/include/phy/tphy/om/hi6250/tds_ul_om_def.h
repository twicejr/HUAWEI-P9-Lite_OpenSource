...
typedef enum
{
    ...
    TPHY_REQ_HP_SAR                = OM_TCMD_ID(TPHY_UL_MID, OM_TYPE_REQ, 0x10),  //meiaihong
...
typedef enum
{
    ...
    TPHY_TRACE_UL_HP_SAR_IND                     = OM_TCMD_ID(TPHY_UL_MID, OM_TYPE_IND, 0x10),//meiaihong
...
typedef struct TPHY_OM_HP_SAR_INFO
{
