 ...
 *                to whole control palne and data plane VISP module.
 *                
 *
 *-----------------------------------------------------------------------*
...
#ifndef __FWCOMMON_DEBUG_H__
#define __FWCOMMON_DEBUG_H__
...
/**
* @defgroup FWCOMMON_RegLogHookFunc FWCOMMON_RegLogHookFunc
* @ingroup d Debugging Functions
* @par Prototype
* @code
* UINT32 FWCOMMON_RegLogHookFunc( FWCOMMON_LOG_HOOK_FUNC_S * pstHookFunc);
* @endcode 
* 
* @par Description
...
* firewall settings.     
* 
* @param[in] pstHookFunc Pointer to the FWCOMMON_LOG_HOOK_FUNC_S.  []
* @param[out]   []
* 
* @retval UINT32 On Success [FW_OK|]
* @retval UINT32 pstHookFunc is NULL pointer [FWCOMMON_DEBUG_REGLOGHOOK_NULLPTR|]
...
* 
* @par Related Topics
* FWCOMMON_LOG_HOOK_FUNC_S
*/ 
UINT32 FWCOMMON_RegLogHookFunc(FWIPSAFE_LOG_HOOK_FUNC_S* pstHookFunc);

/**
* @defgroup FWCOMMON_SetLogLevel FWCOMMON_SetLogLevel
* @ingroup d Debugging Functions
* @par Prototype
* @code
* UINT32 FWCOMMON_SetLogLevel(UINT32 u32LogLevel);
* @endcode 
* 
* @par Description
...
* 
* @retval UINT32 On Success [FW_OK|]
* @retval UINT32 Please refer the return value of TCPIP_SetLogLevel of VISP control plane [|]
* @retval UINT32 Please refer the return value of SFE_SetLogLevel of VISP data plane [|]
* 
* 
* @par Dependency
...
/**
* @defgroup FWCOMMON_GetLogLevel FWCOMMON_GetLogLevel
* @ingroup d Debugging Functions
* @par Prototype
* @code
* UINT32 FWCOMMON_GetLogLevel(UINT32* pu32LogLevel);
* @endcode 
* 
* @par Description
* This function gets the firewall log level. If control plane and data plane has different 
* log level then output parameter contains data plane's log level.
*
* @param[in]   []
...
* \n
* 
* Control plane and data plane's log level can be get by TCPIP_GetLogLevel and SFE_GetLogLevel respectively.
* 
* 
* @par Related Topics
* FWCOMMON_LOG_LEVEL_E
...
/**
* @defgroup FWCOMMON_SetLogType FWCOMMON_SetLogType
* @ingroup d Debugging Functions
* @par Prototype
* @code
* UINT32 FWCOMMON_SetLogType(UINT32 ul32WarningLogEnable, 
...
/**
* @defgroup FWCOMMON_GetLogType FWCOMMON_GetLogType
* @ingroup d Debugging Functions
* @par Prototype
* @code
* UINT32 FWCOMMON_GetLogType(UINT32* pu32WarningLogEnable, 
...
* If control plane and data plane has different
* log type settings, then output parameter contains data plane's log type settings.
* 
* 
* @param[in]   []
...
/**
* @defgroup FWCOMMON_ShowLogSwitch FWCOMMON_ShowLogSwitch
* @ingroup d Debugging Functions
* @par Prototype
* @code
* VOID FWCOMMON_ShowLogSwitch(VOID);
* @endcode 
* 
* @par Description
...
/**
* @defgroup FWCOMMON_RegDebugOutputHookFunc FWCOMMON_RegDebugOutputHookFunc
* @ingroup d Debugging Functions
* @par Prototype
* @code
* UINT32 FWCOMMON_RegDebugOutputHookFunc(FWCOMMON_DEBUG_OUTPUT_CALLBACK_FUNC 
*                                       pfDebugOutput);
* @endcode 
* 
* @par Description
* This function is used to set the callback function for the firewall debug in control plane only. Firewall calls the
* registered function for any debug. This callback function will be called based on
* firewall settings.
* 
...
* None
*/ 
UINT32 FWCOMMON_RegDebugOutputHookFunc(FWIPSAFE_DEBUG_OUTPUT_CALLBACK_FUNC 
                                      pfDebugOutput);

/**
* @defgroup FWCOMMON_SetDebugTypeSwitch FWCOMMON_SetDebugTypeSwitch
* @ingroup d Debugging Functions
* @par Prototype
* @code
* UINT32 FWCOMMON_SetDebugTypeSwitch (UINT32 u32DebugTypeSwitch);
* @endcode 
* 
* @par Description
...
/**
* @defgroup FWCOMMON_SetDebugVcpuSwitch FWCOMMON_SetDebugVcpuSwitch
* @ingroup d Debugging Functions
* @par Prototype
* @code
* UINT32 FWCOMMON_SetDebugVcpuSwitch (UINT32 u32DebugVcpuSwitch);
* @endcode 
* 
* @par Description
...
/**
* @defgroup FWCOMMON_SetDebugModuleSwitch FWCOMMON_SetDebugModuleSwitch
* @ingroup d Debugging Functions
* @par Prototype
* @code
* UINT32 FWCOMMON_SetDebugModuleSwitch (UINT32 u32DebugModuleSwitch);
* @endcode 
* 
* @par Description
...
/**
* @defgroup FWCOMMON_GetDebugSwitch FWCOMMON_GetDebugSwitch
* @ingroup d Debugging Functions
* @par Prototype
* @code
* UINT32 FWCOMMON_GetDebugSwitch(UINT32* pu32DebugTypeSwitch, 
...
/**
* @defgroup FWCOMMON_ShowDebugSwitch FWCOMMON_ShowDebugSwitch
* @ingroup d Debugging Functions
* @par Prototype
* @code
* VOID FWCOMMON_ShowDebugSwitch(VOID);
* 
* @endcode 
* 
* @par Description
...
/**
* @defgroup FWCOMMON_RegInfoOutputHookFunc FWCOMMON_RegInfoOutputHookFunc
* @ingroup d Debugging Functions
* @par Prototype
* @code
* UINT32 FWCOMMON_RegInfoOutputHookFunc(FWCOMMON_INFO_OUTPUT_CALLBACK_FUNC 
*                                          pfInfoOutput);
* @endcode 
* 
* @par Description
...
* None
*/ 
UINT32 FWCOMMON_RegInfoOutputHookFunc(FWIPSAFE_INFO_OUTPUT_CALLBACK_FUNC 
                                         pfInfoOutput);

/**
* @defgroup FWCOMMON_SetOutputToCOMSwitch FWCOMMON_SetOutputToCOMSwitch
* @ingroup d Debugging Functions
* @par Prototype
* @code
* VOID FWCOMMON_SetOutputToCOMSwitch(UINT32 u32Switch);
* @endcode 
* 
* @par Description
