...
#ifndef _IPBIR_VISP_COMMON_MAP_H_
#define _IPBIR_VISP_COMMON_MAP_H_

/* -------------------------------------------------------------------------- */
/* Include Product Header files - Based on the selected Product */
#if (IPB_IR_PRODUCT_TYPE == IPB_IR_PRODUCT_VISP)

#include "ipbircommon/ipbirmap/visp/visp/ipbir_visp_def.h"

#elif (IPB_IR_PRODUCT_TYPE == IPB_IR_PRODUCT_NODE_B)

#include "ipbircommon/ipbirmap/visp/nodeb/ipbir_nodeb_def.h"
...
#endif  /* end of _IPBIR_VISP_COMMON_MAP_H_ */
