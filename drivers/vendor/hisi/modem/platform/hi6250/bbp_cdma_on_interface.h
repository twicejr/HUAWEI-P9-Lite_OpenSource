...
typedef union
{
    unsigned int      ck_msr_interger_1x_reg;
    struct
    {
        unsigned int  ck_msr_integer_26ms_1x    : 11; /* bit[0-10] : 时钟测量结果整数部分除以25的结果。时钟测量结果整数部分表示1个32k时钟内，有多少个122.88MHz时钟。 */
        unsigned int  reserved_0                : 5;  /* bit[11-15]: 保留 */
        unsigned int  ck_msr_integer_1_4chip_1x : 5;  /* bit[16-20]: 时钟测量结果整数部分对25取模的结果。时钟测量结果整数部分表示1个32k时钟内，有多少个122.88MHz时钟。 */
...
typedef union
{
    unsigned int      ck_msr_frac_1x_reg;
    struct
    {
        unsigned int  ck_msr_frac_1x : 11; /* bit[0-10] : 时钟测量结果小数部分。精度为1/2048。 */
...
typedef union
{
    unsigned int      sleep_period_1x_reg;
    struct
    {
        unsigned int  sleep_period_1x : 23; /* bit[0-22] : 睡眠时间：从开始睡眠到唤醒时刻的时间。配置32k时钟个数 */
...
typedef union
{
    unsigned int      ck_switch_cnt_1x_reg;
    struct
    {
        unsigned int  ck_switch_cnt_1x : 12; /* bit[0-11] : 正常唤醒时，从wakeup中断，到切换系统定时之间的时间。配置为32k时钟个数。最大值对应时长62.5ms。 */
...
typedef union
{
    unsigned int      deep_sleep_cnt_1x_reg;
    struct
    {
        unsigned int  deep_sleep_cnt_1x : 12; /* bit[0-11] : 距离wakeup时刻还有多长时间，BBP产生深睡指示。配置为32k时钟个数。 */
        unsigned int  reserved          : 20; /* bit[12-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      sleep_mode_reg;
    struct
    {
        unsigned int  sleep_mode_1x : 1;  /* bit[0]   : 进入睡眠的模式。
                                                        0：表示立即睡眠
                                                        1：表示到达指定时刻再进入睡眠 */
...
typedef union
{
    unsigned int      sleep_start_1x_reg;
    struct
    {
        unsigned int  sleep_start_1x : 1;  /* bit[0]   : 软件配置的睡眠指令，脉冲信号。 Sleep_mode=0时，立即进入睡眠；Sleep_mode=1时，等待配置的时刻进入睡眠 */
        unsigned int  reserved       : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      switch_up_1x_reg;
    struct
    {
        unsigned int  switch_up_1x : 1;  /* bit[0]   : 强制唤醒指令，脉冲信号。 */
        unsigned int  reserved     : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      deep_sleep_ind_1x_reg;
    struct
    {
        unsigned int  deep_sleep_ind_1x : 1;  /* bit[0]   : 深睡指示，1有效 */
        unsigned int  reserved          : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      sleep_cnt_32k_1x_reg;
    struct
    {
        unsigned int  sleep_cnt_32k_1x : 23; /* bit[0-22] : 上报的睡眠时间，用32k时钟周期个数表示。 */
        unsigned int  reserved         : 9;  /* bit[23-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      wakeup_type_1x_reg;
    struct
    {
        unsigned int  wakeup_type_1x : 1;  /* bit[0]   : 唤醒种类。
                                                         0：表示自然唤醒；
                                                         1：表示强制唤醒 */
        unsigned int  reserved       : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      sleep_status_1x_reg;
    struct
    {
        unsigned int  sleep_status_1x : 1;  /* bit[0]   : BBP处于睡眠状态指示。从sleep_start开始到int_32k_to_sys期间为1，其他时间为0。 */
        unsigned int  reserved        : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      sys_cnt_period_1x_reg;
    struct
    {
        unsigned int  sys_cnt_period_1x : 1;  /* bit[0]   : sys cnt周期选择
                                                            0表示2s
                                                            1表示5.12s */
        unsigned int  reserved          : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      wakeup_int_bbe16_reg;
    struct
    {
        unsigned int  cbbp_int01_mask_bbe16 : 2;  /* bit[0-1]  : 上报bbe16唤醒中断的mask，1表示屏蔽相应的中断
                                                                 bit0：1x唤醒中断，
                                                                 bit1：evdo唤醒中断 */
        unsigned int  reserved_0            : 6;  /* bit[2-7]  : 保留 */
        unsigned int  cbbp_int01_clr_bbe16  : 2;  /* bit[8-9]  : 上报bbe16唤醒中断的clr
                                                                 bit0：1x唤醒中断，
                                                                 bit1：evdo唤醒中断 */
        unsigned int  reserved_1            : 21; /* bit[10-30]: 保留 */
        unsigned int  cbbp_int01_en_bbe16   : 1;  /* bit[31]   : 上报bbe16唤醒中断的使能 */
    } reg;
...
typedef union
{
    unsigned int      wakeup_int_sta_bbe16_reg;
    struct
    {
        unsigned int  cbbp_int01_sta_bbe16 : 2;  /* bit[0-1] : 上报bbe16唤醒中断的sta，1表示相应的中断有效
                                                               bit0：1x唤醒中断，
                                                               bit1：evdo唤醒中断 */
...
typedef union
{
    unsigned int      wakeup_int_arm_reg;
    struct
    {
        unsigned int  cbbp_int01_mask_arm : 2;  /* bit[0-1]  : 上报arm唤醒中断的mask，1表示屏蔽相应的中断
                                                               bit0：1x唤醒中断，
                                                               bit1：evdo唤醒中断 */
        unsigned int  reserved_0          : 6;  /* bit[2-7]  : 保留 */
        unsigned int  cbbp_int01_clr_arm  : 2;  /* bit[8-9]  : 上报arm唤醒中断的clr
                                                               bit0：1x唤醒中断，
                                                               bit1：evdo唤醒中断 */
        unsigned int  reserved_1          : 21; /* bit[10-30]: 保留 */
        unsigned int  cbbp_int01_en_arm   : 1;  /* bit[31]   : 上报arm唤醒中断的使能 */
    } reg;
...
typedef union
{
    unsigned int      wakeup_int_sta_arm_reg;
    struct
    {
        unsigned int  cbbp_int01_sta_arm : 2;  /* bit[0-1] : 上报arm唤醒中断的sta，1表示相应的中断
                                                             bit0：1x唤醒中断，
                                                             bit1：evdo唤醒中断 */
        unsigned int  reserved           : 30; /* bit[2-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      dsp_ready_ind_cdrx_1x_reg;
    struct
    {
        unsigned int  dsp_ready_ind_cdrx_1x : 1;  /* bit[0]   : 自然唤醒流程中，软件已经准备好接收时钟切换中断 */
        unsigned int  reserved              : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      ck_msr_interger_evdo_reg;
    struct
    {
        unsigned int  ck_msr_integer_26ms_evdo    : 11; /* bit[0-10] : 时钟测量结果整数部分除以25的结果。时钟测量结果整数部分表示1个32k时钟内，有多少个122.88MHz时钟。 */
        unsigned int  reserved_0                  : 5;  /* bit[11-15]: 保留 */
        unsigned int  ck_msr_integer_1_4chip_evdo : 5;  /* bit[16-20]: 时钟测量结果整数部分对25取模的结果。时钟测量结果整数部分表示1个32k时钟内，有多少个122.88MHz时钟。 */
        unsigned int  reserved_1                  : 11; /* bit[21-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      ck_msr_frac_evdo_reg;
    struct
    {
        unsigned int  ck_msr_frac_evdo : 11; /* bit[0-10] : 时钟测量结果小数部分。精度为1/2048。 */
        unsigned int  reserved         : 21; /* bit[11-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      sleep_period_evdo_reg;
    struct
    {
        unsigned int  sleep_period_evdo : 23; /* bit[0-22] : 睡眠时间：从开始睡眠到唤醒时刻的时间。配置32k时钟个数 */
        unsigned int  reserved          : 9;  /* bit[23-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      ck_switch_cnt_evdo_reg;
    struct
    {
        unsigned int  ck_switch_cnt_evdo : 12; /* bit[0-11] : 正常唤醒时，从wakeup中断，到切换系统定时之间的时间。配置为32k时钟个数。最大值对应时长62.5ms。 */
        unsigned int  reserved           : 20; /* bit[12-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      deep_sleep_cnt_evdo_reg;
    struct
    {
        unsigned int  deep_sleep_cnt_evdo : 12; /* bit[0-11] : 距离wakeup时刻还有多长时间，BBP产生深睡指示。配置为32k时钟个数。 */
        unsigned int  reserved            : 20; /* bit[12-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      sleep_mode_evdo_reg;
    struct
    {
        unsigned int  sleep_mode_evdo : 1;  /* bit[0]   : 进入睡眠的模式。
                                                          0：表示立即睡眠
                                                          1：表示到达指定时刻再进入睡眠 */
        unsigned int  reserved        : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      sleep_start_evdo_reg;
    struct
    {
        unsigned int  sleep_start_evdo : 1;  /* bit[0]   : 软件配置的睡眠指令，脉冲信号。 Sleep_mode=0时，立即进入睡眠；Sleep_mode=1时，等待配置的时刻进入睡眠 */
        unsigned int  reserved         : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      switch_up_evdo_reg;
    struct
    {
        unsigned int  switch_up_evdo : 1;  /* bit[0]   : 强制唤醒指令，脉冲信号。 */
        unsigned int  reserved       : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      deep_sleep_ind_evdo_reg;
    struct
    {
        unsigned int  deep_sleep_ind_evdo : 1;  /* bit[0]   : 深睡指示，1有效 */
        unsigned int  reserved            : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      sleep_cnt_32k_evdo_reg;
    struct
    {
        unsigned int  sleep_cnt_32k_evdo : 23; /* bit[0-22] : 上报的睡眠时间，用32k时钟周期个数表示。 */
        unsigned int  reserved           : 9;  /* bit[23-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      wakeup_type_evdo_reg;
    struct
    {
        unsigned int  wakeup_type_evdo : 1;  /* bit[0]   : 唤醒种类。
                                                           0：表示自然唤醒；
                                                           1：表示强制唤醒 */
        unsigned int  reserved         : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      sleep_status_evdo_reg;
    struct
    {
        unsigned int  sleep_status_evdo : 1;  /* bit[0]   : BBP处于睡眠状态指示。从sleep_start开始到int_32k_to_sys期间为1，其他时间为0。 */
        unsigned int  reserved          : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      sys_cnt_period_evdo_reg;
    struct
    {
        unsigned int  sys_cnt_period_evdo : 1;  /* bit[0]   : sys cnt周期选择
                                                              0表示2s
                                                              1表示5.12s */
        unsigned int  reserved            : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      switch_int_bbe16_reg;
    struct
    {
        unsigned int  cbbp_int02_mask_bbe16 : 4;  /* bit[0-3]  : 上报bbe16时钟切换中断的mask，1表示屏蔽相应的中断
                                                                 bit0：1x唤醒时系统定时从32k切换到122M，
                                                                 bit1：1x睡眠时系统定时从122M切换到32k
                                                                 bit2：evdo唤醒时系统定时从32k切换到122M，
                                                                 bit3：evdo睡眠时系统定时从122M切换到32k */
        unsigned int  reserved_0            : 4;  /* bit[4-7]  : 保留 */
        unsigned int  cbbp_int02_clr_bbe16  : 4;  /* bit[8-11] : 上报bbe16时钟切换中断的clr
                                                                 bit0：1x唤醒时系统定时从32k切换到122M，
                                                                 bit1：1x睡眠时系统定时从122M切换到32k
                                                                 bit2：evdo唤醒时系统定时从32k切换到122M，
                                                                 bit3：evdo睡眠时系统定时从122M切换到32k */
        unsigned int  reserved_1            : 19; /* bit[12-30]: 保留 */
        unsigned int  cbbp_int02_en_bbe16   : 1;  /* bit[31]   : 上报bbe16时钟切换中断的使能 */
    } reg;
...
typedef union
{
    unsigned int      switch_int_sta_bbe16_reg;
    struct
    {
        unsigned int  cbbp_int02_sta_bbe16 : 4;  /* bit[0-3] : 上报bbe16时钟切换中断的sta，1表示相应的中断
                                                               bit0：1x唤醒时系统定时从32k切换到122M，
                                                               bit1：1x睡眠时系统定时从122M切换到32k
                                                               bit2：evdo唤醒时系统定时从32k切换到122M，
                                                               bit3：evdo睡眠时系统定时从122M切换到32k */
...
typedef union
{
    unsigned int      switch_int_arm_reg;
    struct
    {
        unsigned int  cbbp_int02_mask_arm : 4;  /* bit[0-3]  : 上报arm时钟切换中断的mask，1表示屏蔽相应的中断
                                                               bit0：1x唤醒时系统定时从32k切换到122M，
                                                               bit1：1x睡眠时系统定时从122M切换到32k
                                                               bit2：evdo唤醒时系统定时从32k切换到122M，
                                                               bit3：evdo睡眠时系统定时从122M切换到32k */
        unsigned int  reserved_0          : 4;  /* bit[4-7]  : 保留 */
        unsigned int  cbbp_int02_clr_arm  : 4;  /* bit[8-11] : 上报arm时钟切换中断的clr
                                                               bit0：1x唤醒时系统定时从32k切换到122M，
                                                               bit1：1x睡眠时系统定时从122M切换到32k
                                                               bit2：evdo唤醒时系统定时从32k切换到122M，
                                                               bit3：evdo睡眠时系统定时从122M切换到32k */
        unsigned int  reserved_1          : 19; /* bit[12-30]: 保留 */
        unsigned int  cbbp_int02_en_arm   : 1;  /* bit[31]   : 上报arm时钟切换中断的使能 */
    } reg;
...
typedef union
{
    unsigned int      switch_int_sta_arm_reg;
    struct
    {
        unsigned int  cbbp_int02_sta_arm : 4;  /* bit[0-3] : 上报arm时钟切换中断的STA，1表示相应的中断
                                                             bit0：1x唤醒时系统定时从32k切换到122M，
                                                             bit1：1x睡眠时系统定时从122M切换到32k
                                                             bit2：evdo唤醒时系统定时从32k切换到122M，
                                                             bit3：evdo睡眠时系统定时从122M切换到32k */
...
typedef union
{
    unsigned int      dsp_ready_ind_cdrx_evdo_reg;
    struct
    {
        unsigned int  dsp_ready_ind_cdrx_evdo : 1;  /* bit[0]   : 自然唤醒流程中，软件已经准备好接收时钟切换中断 */
        unsigned int  reserved                : 31; /* bit[1-31]: 保留 */
    } reg;
