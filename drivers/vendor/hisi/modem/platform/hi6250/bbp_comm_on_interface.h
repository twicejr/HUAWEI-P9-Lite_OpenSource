...
typedef union
{
    unsigned int      afc_pwm_sel_mix_reg;
    struct
    {
        unsigned int  afc_pwm_sel : 1;  /* bit[0]   : 0，表示配置AFC选择PDM输出；
                                                      1，表示配置选择PWM输出 */
...
typedef union
{
    unsigned int      afc_en_mix_reg;
    struct
    {
        unsigned int  afc_en   : 1;  /* bit[0]   : 1，表示配置AFC使能；
                                                   0，表示配置AFC不使能 */
        unsigned int  reserved : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      afc_cfg_width_mix_reg;
    struct
    {
        unsigned int  afc_cfg_width : 12; /* bit[0-11] : AFC配置值 */
...
typedef union
{
    unsigned int      afc_cfg_sel_mix_reg;
    struct
    {
        unsigned int  afc_cfg_sel : 1;  /* bit[0]   : 1，表示选择配置AFC值
                                                      0，表示选择BBP产生的AFC值 */
        unsigned int  reserved    : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      afc_pwm_sel_mix_ch1_reg;
    struct
    {
        unsigned int  afc_pwm_sel_ch1 : 1;  /* bit[0]   : 0，表示配置AFC选择PDM输出；
                                                          1，表示配置选择PWM输出 */
        unsigned int  reserved        : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      afc_en_mix_ch1_reg;
    struct
    {
        unsigned int  afc_en_ch1 : 1;  /* bit[0]   : 1，表示配置AFC使能；
                                                     0，表示配置AFC不使能 */
        unsigned int  reserved   : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      afc_cfg_width_mix_ch1_reg;
    struct
    {
        unsigned int  afc_cfg_width_ch1 : 12; /* bit[0-11] : AFC配置值 */
        unsigned int  reserved          : 20; /* bit[12-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      afc_cfg_sel_mix_ch1_reg;
    struct
    {
        unsigned int  afc_cfg_sel_ch1 : 1;  /* bit[0]   : 1，表示选择配置AFC值
                                                          0，表示选择BBP产生的AFC值 */
        unsigned int  reserved        : 31; /* bit[1-31]: 保留 */
    } reg;
