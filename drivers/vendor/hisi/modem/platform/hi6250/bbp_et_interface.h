...
/* 寄存器说明：
 bit[31:4]   
 bit[3]      tx动态延时减少
             1'b0: 正常工作模式，支持tx整数延时每次动态减少一个样点。（默认值）
             1'b1: 不支持动态减少延时，供调试用。
 bit[2]      tx动态延时增加
             1'b0: 正常工作模式，支持tx整数延时每次动态增加一个样点。（默认值）
             1'b1: 不支持动态增加延时，供调试用。
 bit[1]      et动态延时减少
             1'b0: 正常工作模式，默认值。
             1'b1: 不支持动态减少延时，供调试用。
...
/*****************************************************************************
 ...
 结构说明  : APT_CALIBRE_MODE 寄存器结构定义。地址偏移量:0xCFC，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
...
/*****************************************************************************
 ...
 结构说明  : CALIBRE_VCC 寄存器结构定义。地址偏移量:0xD00，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
...
/*****************************************************************************
 ...
 结构说明  : REG_CK_SEL 寄存器结构定义。地址偏移量:0xD30，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
