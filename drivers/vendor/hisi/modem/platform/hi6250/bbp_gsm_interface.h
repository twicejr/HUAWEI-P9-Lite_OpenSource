...
/* 寄存器说明：
 bit[31:2]   
 bit[1:0]    扩展1定向线控CPU接口配置。
             bit0，rx_blank_ind；
             bit1，tx_blank_ind。
             线控CPU接口强配信号。
   UNION结构:  GBBP_CPU_EXT1_CTRL_UNION */
#define GBBP_CPU_EXT1_CTRL_ADDR                       (SOC_BBP_GSM_BASE_ADDR + 0x5E24)

/* 寄存器说明：
 bit[31:1]   
 bit[0]      定向线控信号写使能指示信号。
   UNION结构:  GBBP_CPU_EXT1_CTRL_WR_UNION */
#define GBBP_CPU_EXT1_CTRL_WR_ADDR                    (SOC_BBP_GSM_BASE_ADDR + 0x5E28)
...
/* 寄存器说明：
 bit[31:27]  保留
 bit[26:16]  距当前时刻第二近FB周期的FB最大能量对应的FN_LOW
 bit[15:11]  保留
 bit[10:0]   最近一个FB周期的FB最大能量对应的FN_LOW
   UNION结构:  GBBP_FB_MAX_FN_LOW_UNION */
#define GBBP_FB_MAX_FN_LOW_ADDR                       (SOC_BBP_GSM_BASE_ADDR + 0x5E38)

/* 寄存器说明：
 bit[31:11]  保留
 bit[10:0]   距当前时刻第三近FB周期的FB最大能量对应的FN_LOW
   UNION结构:  GBBP_FB_MAX_FN_LOW2_UNION */
#define GBBP_FB_MAX_FN_LOW2_ADDR                      (SOC_BBP_GSM_BASE_ADDR + 0x5E3C)
...
/* 寄存器说明：
 bit[31:30]  使用晶体AFC方案时的通道指示。
             00：表示将该条SSI发送到channel0；
             01：表示发送到channel1；
             10：表示发送到channel2；
             11：表示发送到channel3；
...
/* 寄存器说明：
 bit[31:30]  GDSP使用CPU方式配置一个RF-SSI的通道指示。
             00：表示将该条SSI发送到channel0；
             01：表示发送到channel1；
             10：表示发送到channel2；
             11：表示发送到channel3；
...
#define GBBP_G_RFIC_SSI_RAM_MEMDEPTH  (256)
...
/*****************************************************************************
 结构名    : GBBP_CPU_EXT1_CTRL_UNION
 结构说明  : CPU_EXT1_CTRL 寄存器结构定义。地址偏移量:0x5E24，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    unsigned int      cpu_ext1_ctrl_reg;
    struct
    {
        unsigned int  cpu_gtc_ext1_line_ctrl_imi : 2;  /* bit[0-1] : 扩展1定向线控CPU接口配置。
                                                                     bit0，rx_blank_ind；
                                                                     bit1，tx_blank_ind。
                                                                     线控CPU接口强配信号。 */
        unsigned int  reserved                   : 30; /* bit[2-31]:  */
    } reg;
} GBBP_CPU_EXT1_CTRL_UNION;
#define GBBP_CPU_EXT1_CTRL_cpu_gtc_ext1_line_ctrl_imi_START  (0)
#define GBBP_CPU_EXT1_CTRL_cpu_gtc_ext1_line_ctrl_imi_END    (1)


/*****************************************************************************
 结构名    : GBBP_CPU_EXT1_CTRL_WR_UNION
 结构说明  : CPU_EXT1_CTRL_WR 寄存器结构定义。地址偏移量:0x5E28，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    unsigned int      cpu_ext1_ctrl_wr_reg;
    struct
    {
        unsigned int  cpu_gtc_ext1_line_ctrl_wr_en_imi : 1;  /* bit[0]   : 定向线控信号写使能指示信号。 */
        unsigned int  reserved                         : 31; /* bit[1-31]:  */
    } reg;
} GBBP_CPU_EXT1_CTRL_WR_UNION;
#define GBBP_CPU_EXT1_CTRL_WR_cpu_gtc_ext1_line_ctrl_wr_en_imi_START  (0)
#define GBBP_CPU_EXT1_CTRL_WR_cpu_gtc_ext1_line_ctrl_wr_en_imi_END    (0)
...
/*****************************************************************************
 结构名    : GBBP_FB_MAX_FN_LOW_UNION
 结构说明  : FB_MAX_FN_LOW 寄存器结构定义。地址偏移量:0x5E38，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    unsigned int      fb_max_fn_low_reg;
    struct
    {
        unsigned int  fb_max1_fn_low : 11; /* bit[0-10] : 最近一个FB周期的FB最大能量对应的FN_LOW */
        unsigned int  reserved_0     : 5;  /* bit[11-15]: 保留 */
        unsigned int  fb_max2_fn_low : 11; /* bit[16-26]: 距当前时刻第二近FB周期的FB最大能量对应的FN_LOW */
        unsigned int  reserved_1     : 5;  /* bit[27-31]: 保留 */
    } reg;
} GBBP_FB_MAX_FN_LOW_UNION;
#define GBBP_FB_MAX_FN_LOW_fb_max1_fn_low_START  (0)
#define GBBP_FB_MAX_FN_LOW_fb_max1_fn_low_END    (10)
#define GBBP_FB_MAX_FN_LOW_fb_max2_fn_low_START  (16)
#define GBBP_FB_MAX_FN_LOW_fb_max2_fn_low_END    (26)


/*****************************************************************************
 结构名    : GBBP_FB_MAX_FN_LOW2_UNION
 结构说明  : FB_MAX_FN_LOW2 寄存器结构定义。地址偏移量:0x5E3C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    unsigned int      fb_max_fn_low2_reg;
    struct
    {
        unsigned int  fb_max3_fn_low : 11; /* bit[0-10] : 距当前时刻第三近FB周期的FB最大能量对应的FN_LOW */
        unsigned int  reserved       : 21; /* bit[11-31]: 保留 */
    } reg;
} GBBP_FB_MAX_FN_LOW2_UNION;
#define GBBP_FB_MAX_FN_LOW2_fb_max3_fn_low_START  (0)
#define GBBP_FB_MAX_FN_LOW2_fb_max3_fn_low_END    (10)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  rf_ssi_afc_ch_info  : 2;  /* bit[30-31]: 使用晶体AFC方案时的通道指示。
                                                               00：表示将该条SSI发送到channel0；
                                                               01：表示发送到channel1；
                                                               10：表示发送到channel2；
                                                               11：表示发送到channel3； */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  rf_ssi_wrone_ch_info     : 2;  /* bit[30-31]: GDSP使用CPU方式配置一个RF-SSI的通道指示。
                                                                    00：表示将该条SSI发送到channel0；
                                                                    01：表示发送到channel1；
                                                                    10：表示发送到channel2；
                                                                    11：表示发送到channel3； */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved                 : 6;  /* bit[24-29]: 保留 */
        unsigned int  cpu_rfic_ssi_rd0_ch_info : 2;  /* bit[30-31]: SSI回读配置数据0的通道指示。
                                                                    00：表示将该条SSI发送到channel0；
                                                                    01：表示发送到channel1；
                                                                    10：表示发送到channel2；
                                                                    11：表示发送到channel3； */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved                 : 6;  /* bit[24-29]: 保留 */
        unsigned int  cpu_rfic_ssi_rd1_ch_info : 2;  /* bit[30-31]: SSI回读配置数据1的通道指示。
                                                                    00：表示将该条SSI发送到channel0；
                                                                    01：表示发送到channel1；
                                                                    10：表示发送到channel2；
                                                                    11：表示发送到channel3； */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved                 : 6;  /* bit[24-29]: 保留 */
        unsigned int  cpu_rfic_ssi_rd2_ch_info : 2;  /* bit[30-31]: SSI回读配置数据2的通道指示。
                                                                    00：表示将该条SSI发送到channel0；
                                                                    01：表示发送到channel1；
                                                                    10：表示发送到channel2；
                                                                    11：表示发送到channel3； */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved                 : 6;  /* bit[24-29]: 保留 */
        unsigned int  cpu_rfic_ssi_rd3_ch_info : 2;  /* bit[30-31]: SSI回读配置数据3的通道指示。
                                                                    00：表示将该条SSI发送到channel0；
                                                                    01：表示发送到channel1；
                                                                    10：表示发送到channel2；
                                                                    11：表示发送到channel3； */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved                 : 6;  /* bit[24-29]: 保留 */
        unsigned int  cpu_rfic_ssi_rd4_ch_info : 2;  /* bit[30-31]: SSI回读配置数据4的通道指示。
                                                                    00：表示将该条SSI发送到channel0；
                                                                    01：表示发送到channel1；
                                                                    10：表示发送到channel2；
                                                                    11：表示发送到channel3； */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved                 : 6;  /* bit[24-29]: 保留 */
        unsigned int  cpu_rfic_ssi_rd5_ch_info : 2;  /* bit[30-31]: SSI回读配置数据5的通道指示。
                                                                    00：表示将该条SSI发送到channel0；
                                                                    01：表示发送到channel1；
                                                                    10：表示发送到channel2；
                                                                    11：表示发送到channel3； */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved                 : 6;  /* bit[24-29]: 保留 */
        unsigned int  cpu_rfic_ssi_rd6_ch_info : 2;  /* bit[30-31]: SSI回读配置数据6的通道指示。
                                                                    00：表示将该条SSI发送到channel0；
                                                                    01：表示发送到channel1；
                                                                    10：表示发送到channel2；
                                                                    11：表示发送到channel3； */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved                 : 6;  /* bit[24-29]: 保留 */
        unsigned int  cpu_rfic_ssi_rd7_ch_info : 2;  /* bit[30-31]: SSI回读配置数据7的通道指示。
                                                                    00：表示将该条SSI发送到channel0；
                                                                    01：表示发送到channel1；
                                                                    10：表示发送到channel2；
                                                                    11：表示发送到channel3； */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  g_rfic_ssi_ram_addr    : 8;  /* bit[16-23]: g本频或强配的rfic-ssi RAM。
                                                                  数据：
                                                                  [23:16]：rfic的寄存器地址； */
        unsigned int  g_rfic_ssi_ram_ch_info : 2;  /* bit[24-25]: g本频或强配的rfic-ssi RAM。
                                                                  数据通道指示。 */
        unsigned int  reserved               : 6;  /* bit[26-31]: 保留 */
    } reg;
