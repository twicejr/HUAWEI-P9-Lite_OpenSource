...
typedef union
{
    unsigned int      ck_msr_frac_reg;
    struct
    {
        unsigned int  ck_msr_frac : 11; /* bit[0-10] : 时钟测量小数部分，即ck_msr_counter除以ck_msr_period的小数部分。
                                                       注意：DSP配置时，将测量结果乘以2048后配置给BBP使用。 */
...
typedef union
{
    unsigned int      ck_msr_integer_reg;
    struct
    {
        unsigned int  ck_msr_integer : 11; /* bit[0-10] : 时钟测量整数部分，即ck_msr_counter除以ck_msr_period的整数部分。 */
        unsigned int  reserved       : 21; /* bit[11-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      deep_sleep_threshold_reg;
    struct
    {
        unsigned int  deep_sleep_threshold : 12; /* bit[0-11] : 产生深睡指示的10ms帧数，即表示在唤醒之前多长时间内，BBP产生深睡指示。单位，10ms。 */
...
typedef union
{
    unsigned int      deep_sleep_ind_1card_reg;
    struct
    {
        unsigned int  deep_sleep_ind_1card : 1;  /* bit[0]   : 上报ARM的深睡指示。1，表示此时距离唤醒时刻的时间小于deep_sleep_threshold配置的时间；0，表示此时距离唤醒时刻的时间大于deep_sleep_threshold配置的时间。 */
...
typedef union
{
    unsigned int      bbp_wakeup_type_2card_reg;
    struct
    {
        unsigned int  bbp_wakeup_type_2card : 1;  /* bit[0]   : BBP唤醒方式。1，表示CPU强制唤醒；0，表示BBP根据配置时刻唤醒。 */
        unsigned int  reserved              : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      bbp_sleep_status_2card_reg;
    struct
    {
        unsigned int  bbp_sleep_status_2card : 1;  /* bit[0]   : BBP睡眠查询标志。1，表示BBP处于睡眠状态；0，表示BBP处于唤醒状态。 */
        unsigned int  reserved               : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      deep_sleep_ind_2card_reg;
    struct
    {
        unsigned int  deep_sleep_ind_2card : 1;  /* bit[0]   : 上报ARM的深睡指示。1，表示此时距离唤醒时刻的时间小于deep_sleep_threshold配置的时间；0，表示此时距离唤醒时刻的时间大于deep_sleep_threshold配置的时间。 */
        unsigned int  reserved             : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      sys_cnt_sleep_2card_reg;
    struct
    {
        unsigned int  wake_sfn_2card      : 12; /* bit[0-11] : 睡眠期间SFN。
                                                               注意：软件在查询时，需连续读取两次，如果两次的值相同，则表示获取的结果正确。 */
        unsigned int  wake_cnt_2card_clk  : 4;  /* bit[12-15]: 睡眠期间系统帧定时计数器clk计数值。
                                                               注意：软件在查询时，需连续读取两次，如果两次的值相同，则表示获取的结果正确。 */
        unsigned int  wake_cnt_2card_chip : 12; /* bit[16-27]: 睡眠期间系统帧定时计数器chip计数值。
                                                               注意：软件在查询时，需连续读取两次，如果两次的值相同，则表示获取的结果正确。 */
        unsigned int  wake_cnt_2card_slot : 4;  /* bit[28-31]: 睡眠期间系统帧定时计数器slot计数值。
                                                               注意：软件在查询时，需连续读取两次，如果两次的值相同，则表示获取的结果正确。 */
    } reg;
...
typedef union
{
    unsigned int      sys_cnt_sleep_1card_reg;
    struct
    {
        unsigned int  wake_sfn_1card      : 12; /* bit[0-11] : 睡眠期间SFN。
                                                               注意：软件在查询时，需连续读取两次，如果两次的值相同，则表示获取的结果正确。 */
        unsigned int  wake_cnt_1card_clk  : 4;  /* bit[12-15]: 睡眠期间系统帧定时计数器clk计数值。
                                                               注意：软件在查询时，需连续读取两次，如果两次的值相同，则表示获取的结果正确。 */
        unsigned int  wake_cnt_1card_chip : 12; /* bit[16-27]: 睡眠期间系统帧定时计数器chip计数值。
                                                               注意：软件在查询时，需连续读取两次，如果两次的值相同，则表示获取的结果正确。 */
        unsigned int  wake_cnt_1card_slot : 4;  /* bit[28-31]: 睡眠期间系统帧定时计数器slot计数值。
                                                               注意：软件在查询时，需连续读取两次，如果两次的值相同，则表示获取的结果正确。 */
    } reg;
...
typedef union
{
    unsigned int      bbp_wakeup_type_1card_reg;
    struct
    {
        unsigned int  bbp_wakeup_type_1card : 1;  /* bit[0]   : BBP唤醒方式。1，表示CPU强制唤醒；0，表示BBP根据配置时刻唤醒。 */
        unsigned int  reserved              : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      bbp_sleep_status_1card_reg;
    struct
    {
        unsigned int  bbp_sleep_status_1card : 1;  /* bit[0]   : BBP睡眠查询标志。1，表示BBP处于睡眠状态；0，表示BBP处于唤醒状态。 */
        unsigned int  reserved               : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      arm_int02_sta_reg;
    struct
    {
        unsigned int  arm_int02_sta : 2;  /* bit[0-1] : 中断状态寄存器。1，表示相应比特位置有中断；0，表示相应比特位置没有中断。 */
...
typedef union
{
    unsigned int      arm_int02_en_reg;
    struct
    {
        unsigned int  arm_int02_en : 1;  /* bit[0]   : 中断使能寄存器。1，表示使能中断；0，表示不使能中断。 */
        unsigned int  reserved     : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      arm_int03_sta_reg;
    struct
    {
        unsigned int  arm_int03_sta : 4;  /* bit[0-3] : 中断状态寄存器。1，表示相应比特位置有中断；0，表示相应比特位置没有中断。 */
...
typedef union
{
    unsigned int      arm_int03_en_reg;
    struct
    {
        unsigned int  arm_int03_en : 1;  /* bit[0]   : 中断使能寄存器。1，表示使能中断；0，表示不使能中断。 */
        unsigned int  reserved     : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      drx_rst_con_reg;
    struct
    {
        unsigned int  drx_rst_control_1card_sys : 1;  /* bit[0]   : Card1 DRX RST控制，控制61M时钟域RST。
                                                                    复位时，将该bit置1，之后再将该bit复位为0。 */
        unsigned int  drx_rst_control_1card_32k : 1;  /* bit[1]   : Card1 DRX RST控制，控制32k时钟域RST。
                                                                    复位时，将该bit置1，之后再将该bit复位为0。 */
        unsigned int  drx_rst_control_1card_imi : 1;  /* bit[2]   : Card1 DRX RST控制，控制IMI时钟域RST。
                                                                    复位时，将该bit置1，之后再将该bit复位为0。 */
        unsigned int  reserved_0                : 1;  /* bit[3]   : 保留 */
        unsigned int  drx_rst_control_2card_sys : 1;  /* bit[4]   : Card2 DRX RST控制，控制61M时钟域RST。
                                                                    复位时，将该bit置1，之后再将该bit复位为0。 */
        unsigned int  drx_rst_control_2card_32k : 1;  /* bit[5]   : Card2 DRX RST控制，控制32k时钟域RST。
                                                                    复位时，将该bit置1，之后再将该bit复位为0。 */
        unsigned int  drx_rst_control_2card_imi : 1;  /* bit[6]   : Card2 DRX RST控制，控制IMI时钟域RST。
                                                                    复位时，将该bit置1，之后再将该bit复位为0。 */
...
typedef union
{
    unsigned int      drx_afc_value_reg;
    struct
    {
        unsigned int  cpu_wdrx_afc_value : 12; /* bit[0-11] : DRX态AFC值。 */
        unsigned int  reserved           : 19; /* bit[12-30]: 保留 */
        unsigned int  cpu_wdrx_afc_ind   : 1;  /* bit[31]   : DRX态AFC值指示。 */
    } reg;
...
typedef union
{
    unsigned int      sleep_en_1card_reg;
    struct
    {
        unsigned int  sleep_en_1card : 1;  /* bit[0]   : 进入睡眠模式使能。1，表示BBP立即进入睡眠；0，无效。BBP内部将此信号处理为脉冲信号。 */
        unsigned int  reserved       : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      switch_up_1card_reg;
    struct
    {
        unsigned int  switch_up_1card : 1;  /* bit[0]   : CPU强制唤醒使能。1，表示BBP立即唤醒；0，无效。BBP内部将此信号处理为脉冲信号。 */
        unsigned int  reserved        : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      dsp_ready_ind_1card_reg;
    struct
    {
        unsigned int  dsp_ready_ind_1card : 1;  /* bit[0]   : 自然唤醒流程中，DSP指示BBP产生时钟切换中断的配置。如果已经达到时钟切换时刻，而DSP没有配置此寄存器，则BBP继续维护32k定时，直到DSP配置此寄存器位置，再产生时钟切换中断 */
        unsigned int  reserved            : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      ck_switch_cnt_1card_reg;
    struct
    {
        unsigned int  ck_switch_cnt_1card : 12; /* bit[0-11] : 从唤醒时刻到时钟切换时刻32.768k时钟个数。 */
        unsigned int  reserved            : 20; /* bit[12-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      ck_wake_sfn_1card_reg;
    struct
    {
        unsigned int  ck_wake_sfn_1card : 12; /* bit[0-11] : 唤醒时刻SFN值。 */
        unsigned int  reserved          : 20; /* bit[12-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      ck_wake_cnt_1card_reg;
    struct
    {
        unsigned int  ck_wake_cnt_1card_clk  : 4;  /* bit[0-3]  : 唤醒时刻帧内计数值clk计数。 */
        unsigned int  ck_wake_cnt_1card_chip : 12; /* bit[4-15] : 唤醒时刻帧内计数值chip计数。 */
        unsigned int  ck_wake_cnt_1card_slot : 4;  /* bit[16-19]: 唤醒时刻帧内计数值slot计数。 */
...
typedef union
{
    unsigned int      arm_int02_mask_1card_reg;
    struct
    {
        unsigned int  arm_int02_mask_1card : 1;  /* bit[0]   : 中断屏蔽寄存器。1，表示屏蔽相应比特位置的中断；0，表示不屏蔽相应比特位置的中断。 */
        unsigned int  reserved             : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      arm_int02_clr_1card_reg;
    struct
    {
        unsigned int  arm_int02_clr_1card : 1;  /* bit[0]   : 中断清除寄存器。1，表示清除相应比特位置中断；0，表示不清除相应比特位置的中断。 */
        unsigned int  reserved            : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      arm_int03_mask_1card_reg;
    struct
    {
        unsigned int  arm_int03_mask_1card : 2;  /* bit[0-1] : 中断屏蔽寄存器。1，表示屏蔽相应比特位置的中断；0，表示不屏蔽相应比特位置的中断。 */
        unsigned int  reserved             : 30; /* bit[2-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      arm_int03_clr_1card_reg;
    struct
    {
        unsigned int  arm_int03_clr_1card : 2;  /* bit[0-1] : 中断清除寄存器。1，表示清除相应比特位置中断；0，表示不清除相应比特位置的中断。 */
        unsigned int  reserved            : 30; /* bit[2-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      sleep_en_2card_reg;
    struct
    {
        unsigned int  sleep_en_2card : 1;  /* bit[0]   : 进入睡眠模式使能。1，表示BBP立即进入睡眠；0，无效。BBP内部将此信号处理为脉冲信号。 */
        unsigned int  reserved       : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      switch_up_2card_reg;
    struct
    {
        unsigned int  switch_up_2card : 1;  /* bit[0]   : CPU强制唤醒使能。1，表示BBP立即唤醒；0，无效。BBP内部将此信号处理为脉冲信号。 */
        unsigned int  reserved        : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      ck_switch_cnt_2card_reg;
    struct
    {
        unsigned int  ck_switch_cnt_2card : 12; /* bit[0-11] : 从唤醒时刻到时钟切换时刻32.768k时钟个数。 */
        unsigned int  reserved            : 20; /* bit[12-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      ck_wake_sfn_2card_reg;
    struct
    {
        unsigned int  ck_wake_sfn_2card : 12; /* bit[0-11] : 唤醒时刻SFN值。 */
        unsigned int  reserved          : 20; /* bit[12-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      ck_wake_cnt_2card_reg;
    struct
    {
        unsigned int  ck_wake_cnt_2card_clk  : 4;  /* bit[0-3]  : 唤醒时刻帧内计数值clk计数。 */
        unsigned int  ck_wake_cnt_2card_chip : 12; /* bit[4-15] : 唤醒时刻帧内计数值chip计数。 */
        unsigned int  ck_wake_cnt_2card_slot : 4;  /* bit[16-19]: 唤醒时刻帧内计数值slot计数。 */
        unsigned int  reserved               : 12; /* bit[20-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      dsp_ready_ind_2card_reg;
    struct
    {
        unsigned int  dsp_ready_ind_2card : 1;  /* bit[0]   : 自然唤醒流程中，DSP指示BBP产生时钟切换中断的配置。如果已经达到时钟切换时刻，而DSP没有配置此寄存器，则BBP继续维护32k定时，直到DSP配置此寄存器位置，再产生时钟切换中断 */
        unsigned int  reserved            : 31; /* bit[1-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      arm_int02_mask_2card_reg;
    struct
    {
        unsigned int  reserved_0           : 1;  /* bit[0]   : 保留 */
        unsigned int  arm_int02_mask_2card : 1;  /* bit[1]   : 中断屏蔽寄存器。1，表示屏蔽相应比特位置的中断；0，表示不屏蔽相应比特位置的中断。 */
...
typedef union
{
    unsigned int      arm_int02_clr_2card_reg;
    struct
    {
        unsigned int  reserved_0          : 1;  /* bit[0]   : 保留 */
        unsigned int  arm_int02_clr_2card : 1;  /* bit[1]   : 中断清除寄存器。1，表示清除相应比特位置中断；0，表示不清除相应比特位置的中断。 */
        unsigned int  reserved_1          : 30; /* bit[2-31]: 保留 */
    } reg;
...
typedef union
{
    unsigned int      arm_int03_mask_2card_reg;
    struct
    {
        unsigned int  reserved_0           : 2;  /* bit[0-1] : 保留 */
        unsigned int  arm_int03_mask_2card : 2;  /* bit[2-3] : 中断屏蔽寄存器。1，表示屏蔽相应比特位置的中断；0，表示不屏蔽相应比特位置的中断。 */
...
typedef union
{
    unsigned int      arm_int03_clr_2card_reg;
    struct
    {
        unsigned int  reserved_0          : 2;  /* bit[0-1] : 保留 */
        unsigned int  arm_int03_clr_2card : 2;  /* bit[2-3] : 中断清除寄存器。1，表示清除相应比特位置中断；0，表示不清除相应比特位置的中断。 */
        unsigned int  reserved_1          : 28; /* bit[4-31]: 保留 */
    } reg;
