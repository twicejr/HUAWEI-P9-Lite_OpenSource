...
OBC_LOCAL_MOUDLE_NAME	?=gttf_ccore
endif

ifeq ($(INSTANCE_ID) ,INSTANCE_1)
OBC_LOCAL_MOUDLE_NAME	?=gttf1_ccore
endif

ifeq ($(INSTANCE_ID) ,INSTANCE_2)
OBC_LOCAL_MOUDLE_NAME	?=gttf2_ccore
endif
...
OBC_LOCAL_SRC_FILE += \
    ...
    $(BALONG_TOPDIR)/modem/ps/as/gu/ttf/Gtf/GTFCOM/GTTFTrace.c
