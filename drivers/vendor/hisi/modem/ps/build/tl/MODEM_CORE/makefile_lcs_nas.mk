...
OBC_LOCAL_MOUDLE_NAME	?=lcs_nas
endif

ifeq ($(INSTANCE_ID) ,INSTANCE_1)
OBC_LOCAL_MOUDLE_NAME	?=lcs_nas1
endif

ifeq ($(INSTANCE_ID) ,INSTANCE_2)
OBC_LOCAL_MOUDLE_NAME	?=lcs_nas2
endif
...
PS_LTE_NAS_SRC  := $(PS_NAS_SRC_DIR)/tl/lte/LCS/SRC 
				   
OBC_LOCAL_SRC_FILE := 
OBC_LOCAL_SRC_DIR  :=  $(PS_LTE_NAS_SRC)
