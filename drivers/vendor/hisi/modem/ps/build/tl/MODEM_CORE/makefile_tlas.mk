...
PS_TDS_COMM_SRC := $(PS_AS_SRC_DIR)/tl/tds/comm/rtos_ps/source \
                   $(PS_AS_SRC_DIR)/tl/tds/comm/tgl/source \
                   $(PS_AS_SRC_DIR)/tl/tds/comm/tgl_ps/source
				   
PS_TDS_L2_SRC   := $(PS_AS_SRC_DIR)/tl/tds/l2/com/source

PS_TDS_RRC_SRC  := $(PS_AS_SRC_DIR)/tl/tds/rrc/com/source
...
OBC_LOCAL_SRC_FILE := 
OBC_LOCAL_SRC_DIR  :=  $(PS_LTE_RRC_SRC) $(PS_LT_COMM_SRC) 
