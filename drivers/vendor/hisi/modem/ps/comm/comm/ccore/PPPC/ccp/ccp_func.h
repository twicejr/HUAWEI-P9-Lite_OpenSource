...
VOID PPP_CCP_ReceivePacket (VOID *pstCcpInfo, UCHAR* pHead, UCHAR* pPacket, VOS_UINT32 ulLen,VOS_UINT32 ulRPIndex) ;
...
VOS_UINT16 PPP_CCP_extcode(PPPFSM_S *, UCHAR , UCHAR , UCHAR *, UCHAR *, VOS_UINT32, VOS_UINT32);

VOID PPP_CCP_disabled( PPPFSM_S *f ); /* dyo 99.8.23 */


VOID PPP_CCP_rresetreq (PPPFSM_S *f, UCHAR id, UCHAR *pHead, UCHAR *pPacket, VOS_UINT32 ulLen,VOS_UINT32 ulRPIndex) ;
VOID PPP_CCP_rresetack (PPPFSM_S *f, UCHAR id, UCHAR *pPacket, VOS_UINT32 ulLen,VOS_UINT32 ulRPIndex) ;
