...
#ifndef __CONN_DALMP_INUSE_cs0024_h
#define __CONN_DALMP_INUSE_cs0024_h
#include "ed_lib.h"
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for "CONN_DALMP_INUSE_Redirect".
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for body of "CONN_DALMP_INUSE_Redirect".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for "CONN_DALMP_INUSE_ConnectionFailureReport".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for body of "CONN_DALMP_INUSE_ConnectionFailureReport".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for "CONN_DALMP_INUSE_ConnectionFailureReportAck".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for body of "CONN_DALMP_INUSE_ConnectionFailureReportAck".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
