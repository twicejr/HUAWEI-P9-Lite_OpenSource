...
#ifndef __CONN_DIDSP_INUSE_cs0024_h
#define __CONN_DIDSP_INUSE_cs0024_h
#include "ed_lib.h"
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for "CONN_DIDSP_INUSE_Page".
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for body of "CONN_DIDSP_INUSE_Page".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for "CONN_DIDSP_INUSE_ConnectionRequest".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for body of "CONN_DIDSP_INUSE_ConnectionRequest".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for "CONN_DIDSP_INUSE_ConnectionDeny".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for body of "CONN_DIDSP_INUSE_ConnectionDeny".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
