...
#ifndef __MAC_DRTCMACP_INUSE_cs0024_h
#define __MAC_DRTCMACP_INUSE_cs0024_h
#include "ed_lib.h"
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for "MAC_DRTCMACP_INUSE_RTCAck".
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for body of "MAC_DRTCMACP_INUSE_RTCAck".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for "MAC_DRTCMACP_INUSE_BroadcastReverseRateLimit".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for body of "MAC_DRTCMACP_INUSE_BroadcastReverseRateLimit".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for "MAC_DRTCMACP_INUSE_UnicastReverseRateLimit".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for body of "MAC_DRTCMACP_INUSE_UnicastReverseRateLimit".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
