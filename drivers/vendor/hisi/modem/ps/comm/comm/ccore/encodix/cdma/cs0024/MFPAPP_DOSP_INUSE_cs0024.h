...
#ifndef __MFPAPP_DOSP_INUSE_cs0024_h
#define __MFPAPP_DOSP_INUSE_cs0024_h
#include "ed_lib.h"
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for "MFPAPP_DOSP_INUSE_DataOverSignaling".
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for body of "MFPAPP_DOSP_INUSE_DataOverSignaling".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for "MFPAPP_DOSP_INUSE_DataOverSignalingAck".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for body of "MFPAPP_DOSP_INUSE_DataOverSignalingAck".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
