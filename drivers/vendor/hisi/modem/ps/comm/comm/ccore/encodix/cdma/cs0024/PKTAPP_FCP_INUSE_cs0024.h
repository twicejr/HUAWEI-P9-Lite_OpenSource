...
#ifndef __PKTAPP_FCP_INUSE_cs0024_h
#define __PKTAPP_FCP_INUSE_cs0024_h
#include "ed_lib.h"
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for "PKTAPP_FCP_INUSE_XonRequest".
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for body of "PKTAPP_FCP_INUSE_XonRequest".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for "PKTAPP_FCP_INUSE_XonResponse".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for body of "PKTAPP_FCP_INUSE_XonResponse".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for "PKTAPP_FCP_INUSE_XoffRequest".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for body of "PKTAPP_FCP_INUSE_XoffRequest".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for "PKTAPP_FCP_INUSE_XoffResponse".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for body of "PKTAPP_FCP_INUSE_XoffResponse".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for "PKTAPP_FCP_INUSE_DataReady".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for body of "PKTAPP_FCP_INUSE_DataReady".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for "PKTAPP_FCP_INUSE_DataReadyAck".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for body of "PKTAPP_FCP_INUSE_DataReadyAck".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
