...
#ifndef __PKTAPP_LUP_INUSE_cs0024_h
#define __PKTAPP_LUP_INUSE_cs0024_h
#include "ed_lib.h"
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for "PKTAPP_LUP_INUSE_LocationRequest".
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for body of "PKTAPP_LUP_INUSE_LocationRequest".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for "PKTAPP_LUP_INUSE_LocationNotification".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for body of "PKTAPP_LUP_INUSE_LocationNotification".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for "PKTAPP_LUP_INUSE_LocationAssignment".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for body of "PKTAPP_LUP_INUSE_LocationAssignment".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for "PKTAPP_LUP_INUSE_LocationComplete".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for body of "PKTAPP_LUP_INUSE_LocationComplete".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
