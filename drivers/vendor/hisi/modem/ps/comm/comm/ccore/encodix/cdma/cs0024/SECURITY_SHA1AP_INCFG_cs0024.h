...
#ifndef __SECURITY_SHA1AP_INCFG_cs0024_h
#define __SECURITY_SHA1AP_INCFG_cs0024_h
#include "ed_lib.h"
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for "SECURITY_SHA1AP_INCFG_ConfigurationRequest".
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for body of "SECURITY_SHA1AP_INCFG_ConfigurationRequest".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for "SECURITY_SHA1AP_INCFG_ConfigurationResponse".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for body of "SECURITY_SHA1AP_INCFG_ConfigurationResponse".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
