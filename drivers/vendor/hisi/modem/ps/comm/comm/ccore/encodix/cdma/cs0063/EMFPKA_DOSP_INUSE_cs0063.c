...
#define THIS Source
/*-----------------------------------------------------------------
	ENCODING FUNCTION FOR GSM-L3 MESSAGE EMFPKA_DOSP_INUSE_DataOverSignaling
	Mode: 
		0=normal (full message)
		1=body only
-----------------------------------------------------------------*/
ED_EXLONG L3_ENCODE_c_EMFPKA_DOSP_INUSE_DataOverSignaling (char* Buffer, ED_EXLONG BitOffset, const c_EMFPKA_DOSP_INUSE_DataOverSignaling* Source, int Mode, struct SCSN1CContextSet* pCSN1CContextSet)
{
	int Len=0;
	...
	/* Code for contents */
	{
		...
		Len = ENCODE_c_EMFPKA_DOSP_INUSE_DataOverSignaling_contents (Buffer, CurrOfs, (&(Source->contents)), pCSN1CContextSet);
...
{
	return L3_ENCODE_c_EMFPKA_DOSP_INUSE_DataOverSignaling (Buffer, BitOffset, Source, 0, pCSN1CContextSet);
}

/*-----------------------------------------------------------------
	BODY-ONLY ENCODING FUNCTION FOR GSM-L3 MESSAGE EMFPKA_DOSP_INUSE_DataOverSignaling
-----------------------------------------------------------------*/
...
{
	return L3_ENCODE_c_EMFPKA_DOSP_INUSE_DataOverSignaling (Buffer, BitOffset, Source, 1, pCSN1CContextSet);
}

#undef THIS
#define THIS Destin
/*-----------------------------------------------------------------
	DECODING FUNCTION FOR GSM-L3 MESSAGE EMFPKA_DOSP_INUSE_DataOverSignaling
-----------------------------------------------------------------*/
ED_EXPORT_CALL (ED_EXLONG, DECODE_c_EMFPKA_DOSP_INUSE_DataOverSignaling (const char* ED_CONST Buffer, ED_CONST ED_EXLONG BitOffset, c_EMFPKA_DOSP_INUSE_DataOverSignaling* ED_CONST Destin, ED_EXLONG Length, struct SCSN1CContextSet* pCSN1CContextSet))
{
	...
	Len = DECODE_BODY_c_EMFPKA_DOSP_INUSE_DataOverSignaling (Buffer, (BitOffset+8), Destin, Length-(8), pCSN1CContextSet);
	if (Len < 0) return Len;
...

{
	...
	RetLen = DECODE_c_EMFPKA_DOSP_INUSE_DataOverSignaling_contents (Buffer, CurrOfs, (&(Destin->contents)), Len, pCSN1CContextSet);
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (RetLen != Len) {
...
#define THIS Source
/*-----------------------------------------------------------------
	ENCODING FUNCTION FOR GSM-L3 MESSAGE EMFPKA_DOSP_INUSE_DataOverSignalingAck
	Mode: 
		0=normal (full message)
		1=body only
-----------------------------------------------------------------*/
ED_EXLONG L3_ENCODE_c_EMFPKA_DOSP_INUSE_DataOverSignalingAck (char* Buffer, ED_EXLONG BitOffset, const c_EMFPKA_DOSP_INUSE_DataOverSignalingAck* Source, int Mode, struct SCSN1CContextSet* pCSN1CContextSet)
{
	int Len=0;
	ED_EXLONG CurrOfs = BitOffset+Len;
	ED_EXTRAPARAMS_CODE
	...
	{
		/* Append to buffer value part DEBUG FIELD=<Source->contents> DOT=<.> */
		Len = ENCODE_c_EMFPKA_DOSP_INUSE_DataOverSignalingAck_contents (Buffer, CurrOfs, (&(Source->contents)), pCSN1CContextSet);
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len < 0) {
...
{
	return L3_ENCODE_c_EMFPKA_DOSP_INUSE_DataOverSignalingAck (Buffer, BitOffset, Source, 0, pCSN1CContextSet);
}

/*-----------------------------------------------------------------
	BODY-ONLY ENCODING FUNCTION FOR GSM-L3 MESSAGE EMFPKA_DOSP_INUSE_DataOverSignalingAck
-----------------------------------------------------------------*/
...
{
	return L3_ENCODE_c_EMFPKA_DOSP_INUSE_DataOverSignalingAck (Buffer, BitOffset, Source, 1, pCSN1CContextSet);
}

#undef THIS
#define THIS Destin
/*-----------------------------------------------------------------
	DECODING FUNCTION FOR GSM-L3 MESSAGE EMFPKA_DOSP_INUSE_DataOverSignalingAck
-----------------------------------------------------------------*/
ED_EXPORT_CALL (ED_EXLONG, DECODE_c_EMFPKA_DOSP_INUSE_DataOverSignalingAck (const char* ED_CONST Buffer, ED_CONST ED_EXLONG BitOffset, c_EMFPKA_DOSP_INUSE_DataOverSignalingAck* ED_CONST Destin, ED_EXLONG Length, struct SCSN1CContextSet* pCSN1CContextSet))
{
	...
	Len = DECODE_BODY_c_EMFPKA_DOSP_INUSE_DataOverSignalingAck (Buffer, (BitOffset+8), Destin, Length-(8), pCSN1CContextSet);
	if (Len < 0) return Len;
...

{
	...
	Len = Length + BitOffset - CurrOfs;
	/* Read value part LOCATOR_16 */
	RetLen = DECODE_c_EMFPKA_DOSP_INUSE_DataOverSignalingAck_contents (Buffer, CurrOfs, (&(Destin->contents)), Len, pCSN1CContextSet);
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (RetLen != Len) {
