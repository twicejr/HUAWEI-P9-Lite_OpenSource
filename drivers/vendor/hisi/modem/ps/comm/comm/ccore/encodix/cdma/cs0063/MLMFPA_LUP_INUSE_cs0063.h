...
#ifndef __MLMFPA_LUP_INUSE_cs0063_h
#define __MLMFPA_LUP_INUSE_cs0063_h
#include "ed_lib.h"
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for "MLMFPA_LUP_INUSE_LocationRequest".
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for body of "MLMFPA_LUP_INUSE_LocationRequest".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for "MLMFPA_LUP_INUSE_LocationNotification".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for body of "MLMFPA_LUP_INUSE_LocationNotification".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for "MLMFPA_LUP_INUSE_LocationAssignment".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for body of "MLMFPA_LUP_INUSE_LocationAssignment".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for "MLMFPA_LUP_INUSE_LocationComplete".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for body of "MLMFPA_LUP_INUSE_LocationComplete".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for "MLMFPA_LUP_INUSE_StorageBLOBRequest".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for body of "MLMFPA_LUP_INUSE_StorageBLOBRequest".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for "MLMFPA_LUP_INUSE_StorageBLOBNotification".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for body of "MLMFPA_LUP_INUSE_StorageBLOBNotification".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for "MLMFPA_LUP_INUSE_StorageBLOBAssignment".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for body of "MLMFPA_LUP_INUSE_StorageBLOBAssignment".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for "MLMFPA_LUP_INUSE_StorageBLOBComplete".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
	Encoding/decoding functions for body of "MLMFPA_LUP_INUSE_StorageBLOBComplete".
	It returns number of bits used or <0 in case of error.
----------------------------------------------------------------------------*/
