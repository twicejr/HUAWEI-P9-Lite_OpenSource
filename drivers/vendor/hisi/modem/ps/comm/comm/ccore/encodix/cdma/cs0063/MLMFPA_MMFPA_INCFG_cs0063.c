...
#define THIS Source
/*-----------------------------------------------------------------
	ENCODING FUNCTION FOR GSM-L3 MESSAGE MLMFPA_MMFPA_INCFG_ConfigurationRequest
	Mode: 
		0=normal (full message)
		1=body only
-----------------------------------------------------------------*/
ED_EXLONG L3_ENCODE_c_MLMFPA_MMFPA_INCFG_ConfigurationRequest (char* Buffer, ED_EXLONG BitOffset, const c_MLMFPA_MMFPA_INCFG_ConfigurationRequest* Source, int Mode, struct SCSN1CContextSet* pCSN1CContextSet)
{
	int Len=0;
	...
	/* Code for contents */
	{
		...
		Len = ENCODE_c_MLMFPA_MMFPA_INCFG_ConfigurationRequest_contents (Buffer, CurrOfs, (&(Source->contents)), pCSN1CContextSet);
...
{
	return L3_ENCODE_c_MLMFPA_MMFPA_INCFG_ConfigurationRequest (Buffer, BitOffset, Source, 0, pCSN1CContextSet);
}

/*-----------------------------------------------------------------
	BODY-ONLY ENCODING FUNCTION FOR GSM-L3 MESSAGE MLMFPA_MMFPA_INCFG_ConfigurationRequest
-----------------------------------------------------------------*/
...
{
	return L3_ENCODE_c_MLMFPA_MMFPA_INCFG_ConfigurationRequest (Buffer, BitOffset, Source, 1, pCSN1CContextSet);
}

#undef THIS
#define THIS Destin
/*-----------------------------------------------------------------
	DECODING FUNCTION FOR GSM-L3 MESSAGE MLMFPA_MMFPA_INCFG_ConfigurationRequest
-----------------------------------------------------------------*/
ED_EXPORT_CALL (ED_EXLONG, DECODE_c_MLMFPA_MMFPA_INCFG_ConfigurationRequest (const char* ED_CONST Buffer, ED_CONST ED_EXLONG BitOffset, c_MLMFPA_MMFPA_INCFG_ConfigurationRequest* ED_CONST Destin, ED_EXLONG Length, struct SCSN1CContextSet* pCSN1CContextSet))
{
	...
	Len = DECODE_BODY_c_MLMFPA_MMFPA_INCFG_ConfigurationRequest (Buffer, (BitOffset+8), Destin, Length-(8), pCSN1CContextSet);
	if (Len < 0) return Len;
...

{
	...
	RetLen = DECODE_c_MLMFPA_MMFPA_INCFG_ConfigurationRequest_contents (Buffer, CurrOfs, (&(Destin->contents)), Len, pCSN1CContextSet);
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (RetLen != Len) {
...
#define THIS Source
/*-----------------------------------------------------------------
	ENCODING FUNCTION FOR GSM-L3 MESSAGE MLMFPA_MMFPA_INCFG_ConfigurationResponse
	Mode: 
		0=normal (full message)
		1=body only
-----------------------------------------------------------------*/
ED_EXLONG L3_ENCODE_c_MLMFPA_MMFPA_INCFG_ConfigurationResponse (char* Buffer, ED_EXLONG BitOffset, const c_MLMFPA_MMFPA_INCFG_ConfigurationResponse* Source, int Mode, struct SCSN1CContextSet* pCSN1CContextSet)
{
	int Len=0;
	ED_EXLONG CurrOfs = BitOffset+Len;
	ED_EXTRAPARAMS_CODE
	...
	{
		/* Append to buffer value part DEBUG FIELD=<Source->contents> DOT=<.> */
		Len = ENCODE_c_MLMFPA_MMFPA_INCFG_ConfigurationResponse_contents (Buffer, CurrOfs, (&(Source->contents)), pCSN1CContextSet);
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len < 0) {
...
{
	return L3_ENCODE_c_MLMFPA_MMFPA_INCFG_ConfigurationResponse (Buffer, BitOffset, Source, 0, pCSN1CContextSet);
}

/*-----------------------------------------------------------------
	BODY-ONLY ENCODING FUNCTION FOR GSM-L3 MESSAGE MLMFPA_MMFPA_INCFG_ConfigurationResponse
-----------------------------------------------------------------*/
...
{
	return L3_ENCODE_c_MLMFPA_MMFPA_INCFG_ConfigurationResponse (Buffer, BitOffset, Source, 1, pCSN1CContextSet);
}

#undef THIS
#define THIS Destin
/*-----------------------------------------------------------------
	DECODING FUNCTION FOR GSM-L3 MESSAGE MLMFPA_MMFPA_INCFG_ConfigurationResponse
-----------------------------------------------------------------*/
ED_EXPORT_CALL (ED_EXLONG, DECODE_c_MLMFPA_MMFPA_INCFG_ConfigurationResponse (const char* ED_CONST Buffer, ED_CONST ED_EXLONG BitOffset, c_MLMFPA_MMFPA_INCFG_ConfigurationResponse* ED_CONST Destin, ED_EXLONG Length, struct SCSN1CContextSet* pCSN1CContextSet))
{
	...
	Len = DECODE_BODY_c_MLMFPA_MMFPA_INCFG_ConfigurationResponse (Buffer, (BitOffset+8), Destin, Length-(8), pCSN1CContextSet);
	if (Len < 0) return Len;
...

{
	...
	Len = Length + BitOffset - CurrOfs;
	/* Read value part LOCATOR_16 */
	RetLen = DECODE_c_MLMFPA_MMFPA_INCFG_ConfigurationResponse_contents (Buffer, CurrOfs, (&(Destin->contents)), Len, pCSN1CContextSet);
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (RetLen != Len) {
