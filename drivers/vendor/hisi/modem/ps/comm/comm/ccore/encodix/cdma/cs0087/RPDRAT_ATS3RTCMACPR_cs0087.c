...
#define THIS Source
/*-----------------------------------------------------------------
	ENCODING FUNCTION FOR GSM-L3 MESSAGE RPDRAT_ATS3RTCMACPR_HRPDOpenLoopParameters
	Mode: 
		0=normal (full message)
		1=body only
-----------------------------------------------------------------*/
ED_EXLONG L3_ENCODE_c_RPDRAT_ATS3RTCMACPR_HRPDOpenLoopParameters (char* Buffer, ED_EXLONG BitOffset, const c_RPDRAT_ATS3RTCMACPR_HRPDOpenLoopParameters* Source, int Mode, struct SCSN1CContextSet* pCSN1CContextSet)
{
	int Len=0;
	...
	/* Code for contents */
	{
		...
		Len = ENCODE_c_RPDRAT_ATS3RTCMACPR_HRPDOpenLoopParameters_contents (Buffer, CurrOfs, (&(Source->contents)), pCSN1CContextSet);
...
{
	return L3_ENCODE_c_RPDRAT_ATS3RTCMACPR_HRPDOpenLoopParameters (Buffer, BitOffset, Source, 0, pCSN1CContextSet);
}

/*-----------------------------------------------------------------
	BODY-ONLY ENCODING FUNCTION FOR GSM-L3 MESSAGE RPDRAT_ATS3RTCMACPR_HRPDOpenLoopParameters
-----------------------------------------------------------------*/
...
{
	return L3_ENCODE_c_RPDRAT_ATS3RTCMACPR_HRPDOpenLoopParameters (Buffer, BitOffset, Source, 1, pCSN1CContextSet);
}

#undef THIS
#define THIS Destin
/*-----------------------------------------------------------------
	DECODING FUNCTION FOR GSM-L3 MESSAGE RPDRAT_ATS3RTCMACPR_HRPDOpenLoopParameters
-----------------------------------------------------------------*/
ED_EXPORT_CALL (ED_EXLONG, DECODE_c_RPDRAT_ATS3RTCMACPR_HRPDOpenLoopParameters (const char* ED_CONST Buffer, ED_CONST ED_EXLONG BitOffset, c_RPDRAT_ATS3RTCMACPR_HRPDOpenLoopParameters* ED_CONST Destin, ED_EXLONG Length, struct SCSN1CContextSet* pCSN1CContextSet))
{
	...
	Len = DECODE_BODY_c_RPDRAT_ATS3RTCMACPR_HRPDOpenLoopParameters (Buffer, (BitOffset+8), Destin, Length-(8), pCSN1CContextSet);
	if (Len < 0) return Len;
...

{
	...
	RetLen = DECODE_c_RPDRAT_ATS3RTCMACPR_HRPDOpenLoopParameters_contents (Buffer, CurrOfs, (&(Destin->contents)), Len, pCSN1CContextSet);
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (RetLen != Len) {
