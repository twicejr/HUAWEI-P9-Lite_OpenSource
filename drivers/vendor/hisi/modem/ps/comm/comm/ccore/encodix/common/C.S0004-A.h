...
#define CSN1C_USER_CONTEXT_DATA CS0004E_Details p_CS0004E_Details;
#define P_REV_IN_USE04 (Context->p_CS0004E_Details.n_P_REV_IN_USEs)
#define P_CHANNEL04 (Context->p_CS0004E_Details.n_CHANNEL)
#define MOB_P_REV04 (Context->p_CS0004E_Details.n_MOB_P_REV)
#define CSN1C_CS0004E_SETUP_CONTEXT CSN1C_CONTEXT_PTR->p_CS0004E_Details = *(pp_CS0004E_Details);
...
extern int CS0004E_r_csch_CalcSDUSize (const char* Buffer, long BitOffset, long Length, unsigned par_P_REV_IN_USE, unsigned par_MSG_TAG ED_EXTRAPARAMS_DECL);
