...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (RetLen != Len) {
		ED_SIGNAL_ERROR ("<ERRID:124> Error decoding subfield CiphModeSetting\n");
		ED_HANDLE_MANDATORY_IE_SYNTAX_ERROR ((-1), 124, (Destin->CiphModeSetting));
	} 
#endif
	CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (CurrOfs > (BitOffset+Length)) {
		ED_SIGNAL_ERROR ("<ERRID:125> Message too short decoding subfield CiphModeSetting\n");
		ED_HANDLE_MANDATORY_IE_MSG_TOO_SHORT ((-1), 124, (Destin->CiphModeSetting));
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (RetLen != Len) {
		ED_SIGNAL_ERROR ("<ERRID:126> Error decoding subfield CipherResp\n");
		ED_HANDLE_MANDATORY_IE_SYNTAX_ERROR ((-1), 126, (Destin->CipherResp));
	} 
#endif
	CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (CurrOfs > (BitOffset+Length)) {
		ED_SIGNAL_ERROR ("<ERRID:127> Message too short decoding subfield CipherResp\n");
		ED_HANDLE_MANDATORY_IE_MSG_TOO_SHORT ((-1), 126, (Destin->CipherResp));
	} 
#endif
...
long DECODE_BODY_c_CLASSMARK_ENQUIRY (const char* ED_CONST Buffer, ED_CONST long BitOffset, c_CLASSMARK_ENQUIRY* ED_CONST Destin, long Length)
{
	...
	------------------------------------------------------*/
	/* Detect IEI tag 0x10 */
	ED_EXPECT_OPTIONAL_IE (0x10,  8, 128, 0, KnownL3IEs)
	/* Tag = EDBitsToInt (Buffer, CurrOfs, 8); */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len != 8) {
			ED_SIGNAL_ERROR ("<ERRID:129> Size error decoding IE ClassmarkEnquiryMask\n");
			ED_HANDLE_IE_SIZE_ERROR (0x10, 129, (Destin->ClassmarkEnquiryMask), (Destin->ClassmarkEnquiryMask_Present))
		} 
#endif
		/* Read value part */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (RetLen != Len) {
			ED_SIGNAL_ERROR ("<ERRID:130> Error decoding subfield ClassmarkEnquiryMask\n");
			ED_HANDLE_OPTIONAL_IE_SYNTAX_ERROR (0x10, 130, (Destin->ClassmarkEnquiryMask), (Destin->ClassmarkEnquiryMask_Present));
		} 
#endif
		CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (CurrOfs > (BitOffset+Length)) {
			ED_SIGNAL_ERROR ("<ERRID:131> Message too short decoding subfield ClassmarkEnquiryMask\n");
			ED_HANDLE_OPTIONAL_IE_MSG_TOO_SHORT (0x10, 130, (Destin->ClassmarkEnquiryMask), (Destin->ClassmarkEnquiryMask_Present));
		} 
#endif
...
long DECODE_BODY_c_FREQUENCY_REDEFINITION (const char* ED_CONST Buffer, ED_CONST long BitOffset, c_FREQUENCY_REDEFINITION* ED_CONST Destin, long Length)
{
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (RetLen != Len) {
		ED_SIGNAL_ERROR ("<ERRID:132> Error decoding subfield ChannelDescription\n");
		ED_HANDLE_MANDATORY_IE_SYNTAX_ERROR ((-1), 132, (Destin->ChannelDescription));
	} 
#endif
	CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (CurrOfs > (BitOffset+Length)) {
		ED_SIGNAL_ERROR ("<ERRID:133> Message too short decoding subfield ChannelDescription\n");
		ED_HANDLE_MANDATORY_IE_MSG_TOO_SHORT ((-1), 132, (Destin->ChannelDescription));
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Len > 64) {
		ED_SIGNAL_ERROR ("<ERRID:134> Size error decoding IE MobileAllocation\n");
		ED_HANDLE_IE_SIZE_ERROR ((-1), 134, (Destin->MobileAllocation), (Destin->MobileAllocation_Present))
	} 
#endif
	/* Read value part */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (RetLen != Len) {
		ED_SIGNAL_ERROR ("<ERRID:135> Error decoding subfield MobileAllocation\n");
		ED_HANDLE_MANDATORY_IE_SYNTAX_ERROR ((-1), 135, (Destin->MobileAllocation));
	} 
#endif
	CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (CurrOfs > (BitOffset+Length)) {
		ED_SIGNAL_ERROR ("<ERRID:136> Message too short decoding subfield MobileAllocation\n");
		ED_HANDLE_MANDATORY_IE_MSG_TOO_SHORT ((-1), 135, (Destin->MobileAllocation));
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (RetLen != Len) {
		ED_SIGNAL_ERROR ("<ERRID:137> Error decoding subfield StartingTime\n");
		ED_HANDLE_MANDATORY_IE_SYNTAX_ERROR ((-1), 137, (Destin->StartingTime));
	} 
#endif
	CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (CurrOfs > (BitOffset+Length)) {
		ED_SIGNAL_ERROR ("<ERRID:138> Message too short decoding subfield StartingTime\n");
		ED_HANDLE_MANDATORY_IE_MSG_TOO_SHORT ((-1), 137, (Destin->StartingTime));
	} 
#endif
	...
	------------------------------------------------------*/
	/* Detect IEI tag 0x62 */
	ED_EXPECT_OPTIONAL_IE (0x62,  8, 139, 3, KnownL3IEs)
	/* Tag = EDBitsToInt (Buffer, CurrOfs, 8); */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (RetLen != Len) {
			ED_SIGNAL_ERROR ("<ERRID:140> Error decoding subfield CellChannelDescription\n");
			ED_HANDLE_OPTIONAL_IE_SYNTAX_ERROR (0x62, 140, (Destin->CellChannelDescription), (Destin->CellChannelDescription_Present));
		} 
#endif
		CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (CurrOfs > (BitOffset+Length)) {
			ED_SIGNAL_ERROR ("<ERRID:141> Message too short decoding subfield CellChannelDescription\n");
			ED_HANDLE_OPTIONAL_IE_MSG_TOO_SHORT (0x62, 140, (Destin->CellChannelDescription), (Destin->CellChannelDescription_Present));
		} 
#endif
...
long DECODE_BODY_c_HANDOVER_COMMAND (const char* ED_CONST Buffer, ED_CONST long BitOffset, c_HANDOVER_COMMAND* ED_CONST Destin, long Length)
{
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (RetLen != Len) {
		ED_SIGNAL_ERROR ("<ERRID:142> Error decoding subfield CellDescription\n");
		ED_HANDLE_MANDATORY_IE_SYNTAX_ERROR ((-1), 142, (Destin->CellDescription));
	} 
#endif
	CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (CurrOfs > (BitOffset+Length)) {
		ED_SIGNAL_ERROR ("<ERRID:143> Message too short decoding subfield CellDescription\n");
		ED_HANDLE_MANDATORY_IE_MSG_TOO_SHORT ((-1), 142, (Destin->CellDescription));
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (RetLen != Len) {
		ED_SIGNAL_ERROR ("<ERRID:144> Error decoding subfield DescriptionOfTheFirstChannelAfterTime\n");
		ED_HANDLE_MANDATORY_IE_SYNTAX_ERROR ((-1), 144, (Destin->DescriptionOfTheFirstChannelAfterTime));
	} 
#endif
	CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (CurrOfs > (BitOffset+Length)) {
		ED_SIGNAL_ERROR ("<ERRID:145> Message too short decoding subfield DescriptionOfTheFirstChannelAfterTime\n");
		ED_HANDLE_MANDATORY_IE_MSG_TOO_SHORT ((-1), 144, (Destin->DescriptionOfTheFirstChannelAfterTime));
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (RetLen != Len) {
		ED_SIGNAL_ERROR ("<ERRID:146> Error decoding subfield HandoverRef\n");
		ED_HANDLE_MANDATORY_IE_SYNTAX_ERROR ((-1), 146, (Destin->HandoverRef));
	} 
#endif
	CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (CurrOfs > (BitOffset+Length)) {
		ED_SIGNAL_ERROR ("<ERRID:147> Message too short decoding subfield HandoverRef\n");
		ED_HANDLE_MANDATORY_IE_MSG_TOO_SHORT ((-1), 146, (Destin->HandoverRef));
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (RetLen != Len) {
		ED_SIGNAL_ERROR ("<ERRID:148> Error decoding subfield PowerCommandAndAccessType\n");
		ED_HANDLE_MANDATORY_IE_SYNTAX_ERROR ((-1), 148, (Destin->PowerCommandAndAccessType));
	} 
#endif
	CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (CurrOfs > (BitOffset+Length)) {
		ED_SIGNAL_ERROR ("<ERRID:149> Message too short decoding subfield PowerCommandAndAccessType\n");
		ED_HANDLE_MANDATORY_IE_MSG_TOO_SHORT ((-1), 148, (Destin->PowerCommandAndAccessType));
	} 
#endif
	...
	------------------------------------------------------*/
	/* Detect IEI tag 0x0D */
	ED_EXPECT_OPTIONAL_IE (0x0D,  4, 150, 4, KnownL3IEs)
	/* Tag = EDBitsToInt (Buffer, CurrOfs, 4); */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (RetLen != Len) {
			ED_SIGNAL_ERROR ("<ERRID:151> Error decoding subfield SynchronizationIndication\n");
			ED_HANDLE_OPTIONAL_IE_SYNTAX_ERROR (0x0D, 151, (Destin->SynchronizationIndication), (Destin->SynchronizationIndication_Present));
		} 
#endif
		CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (CurrOfs > (BitOffset+Length)) {
			ED_SIGNAL_ERROR ("<ERRID:152> Message too short decoding subfield SynchronizationIndication\n");
			ED_HANDLE_OPTIONAL_IE_MSG_TOO_SHORT (0x0D, 151, (Destin->SynchronizationIndication), (Destin->SynchronizationIndication_Present));
		} 
#endif
	...
	------------------------------------------------------*/
	/* Detect IEI tag 0x02 */
	ED_EXPECT_OPTIONAL_IE (0x02,  8, 153, 5, KnownL3IEs)
	/* Tag = EDBitsToInt (Buffer, CurrOfs, 8); */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (RetLen != Len) {
			ED_SIGNAL_ERROR ("<ERRID:154> Error decoding subfield FrequencyShortListAfterTime\n");
			ED_HANDLE_OPTIONAL_IE_SYNTAX_ERROR (0x02, 154, (Destin->FrequencyShortListAfterTime), (Destin->FrequencyShortListAfterTime_Present));
		} 
#endif
		CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (CurrOfs > (BitOffset+Length)) {
			ED_SIGNAL_ERROR ("<ERRID:155> Message too short decoding subfield FrequencyShortListAfterTime\n");
			ED_HANDLE_OPTIONAL_IE_MSG_TOO_SHORT (0x02, 154, (Destin->FrequencyShortListAfterTime), (Destin->FrequencyShortListAfterTime_Present));
		} 
#endif
	...
	------------------------------------------------------*/
	/* Detect IEI tag 0x05 */
	ED_EXPECT_OPTIONAL_IE (0x05,  8, 156, 6, KnownL3IEs)
	/* Tag = EDBitsToInt (Buffer, CurrOfs, 8); */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if ((Len < 16) || (Len > 1032)) {
			ED_SIGNAL_ERROR ("<ERRID:157> Size error decoding IE FrequencyListAfterTime\n");
			ED_HANDLE_IE_SIZE_ERROR (0x05, 157, (Destin->FrequencyListAfterTime), (Destin->FrequencyListAfterTime_Present))
		} 
#endif
		/* Read value part */
		RetLen = DECODE_c_CellChannel (Buffer, CurrOfs, &(Destin->FrequencyListAfterTime), Len);
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (RetLen != Len) {
			ED_SIGNAL_ERROR ("<ERRID:158> Error decoding subfield FrequencyListAfterTime\n");
			ED_HANDLE_OPTIONAL_IE_SYNTAX_ERROR (0x05, 158, (Destin->FrequencyListAfterTime), (Destin->FrequencyListAfterTime_Present));
		} 
#endif
		CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (CurrOfs > (BitOffset+Length)) {
			ED_SIGNAL_ERROR ("<ERRID:159> Message too short decoding subfield FrequencyListAfterTime\n");
			ED_HANDLE_OPTIONAL_IE_MSG_TOO_SHORT (0x05, 158, (Destin->FrequencyListAfterTime), (Destin->FrequencyListAfterTime_Present));
		} 
#endif
	...
	------------------------------------------------------*/
	/* Detect IEI tag 0x62 */
	ED_EXPECT_OPTIONAL_IE (0x62,  8, 160, 7, KnownL3IEs)
	/* Tag = EDBitsToInt (Buffer, CurrOfs, 8); */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (RetLen != Len) {
			ED_SIGNAL_ERROR ("<ERRID:161> Error decoding subfield CellChannelDescription\n");
			ED_HANDLE_OPTIONAL_IE_SYNTAX_ERROR (0x62, 161, (Destin->CellChannelDescription), (Destin->CellChannelDescription_Present));
		} 
#endif
		CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (CurrOfs > (BitOffset+Length)) {
			ED_SIGNAL_ERROR ("<ERRID:162> Message too short decoding subfield CellChannelDescription\n");
			ED_HANDLE_OPTIONAL_IE_MSG_TOO_SHORT (0x62, 161, (Destin->CellChannelDescription), (Destin->CellChannelDescription_Present));
		} 
#endif
	...
	------------------------------------------------------*/
	/* Detect IEI tag 0x10 */
	ED_EXPECT_OPTIONAL_IE (0x10,  8, 163, 8, KnownL3IEs)
	/* Tag = EDBitsToInt (Buffer, CurrOfs, 8); */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if ((Len < 8) || (Len > 80)) {
			ED_SIGNAL_ERROR ("<ERRID:164> Size error decoding IE DescriptionOfTheMultislotCfg\n");
			ED_HANDLE_IE_SIZE_ERROR (0x10, 164, (Destin->DescriptionOfTheMultislotCfg), (Destin->DescriptionOfTheMultislotCfg_Present))
		} 
#endif
		/* Read value part */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (RetLen != Len) {
			ED_SIGNAL_ERROR ("<ERRID:165> Error decoding subfield DescriptionOfTheMultislotCfg\n");
			ED_HANDLE_OPTIONAL_IE_SYNTAX_ERROR (0x10, 165, (Destin->DescriptionOfTheMultislotCfg), (Destin->DescriptionOfTheMultislotCfg_Present));
		} 
#endif
		CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (CurrOfs > (BitOffset+Length)) {
			ED_SIGNAL_ERROR ("<ERRID:166> Message too short decoding subfield DescriptionOfTheMultislotCfg\n");
			ED_HANDLE_OPTIONAL_IE_MSG_TOO_SHORT (0x10, 165, (Destin->DescriptionOfTheMultislotCfg), (Destin->DescriptionOfTheMultislotCfg_Present));
		} 
#endif
	...
	------------------------------------------------------*/
	/* Detect IEI tag 0x63 */
	ED_EXPECT_OPTIONAL_IE (0x63,  8, 167, 9, KnownL3IEs)
	/* Tag = EDBitsToInt (Buffer, CurrOfs, 8); */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (RetLen != Len) {
			ED_SIGNAL_ERROR ("<ERRID:168> Error decoding subfield ModeOfTheFirstChannelChannelSet1\n");
			ED_HANDLE_OPTIONAL_IE_SYNTAX_ERROR (0x63, 168, (Destin->ModeOfTheFirstChannelChannelSet1), (Destin->ModeOfTheFirstChannelChannelSet1_Present));
		} 
#endif
		CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (CurrOfs > (BitOffset+Length)) {
			ED_SIGNAL_ERROR ("<ERRID:169> Message too short decoding subfield ModeOfTheFirstChannelChannelSet1\n");
			ED_HANDLE_OPTIONAL_IE_MSG_TOO_SHORT (0x63, 168, (Destin->ModeOfTheFirstChannelChannelSet1), (Destin->ModeOfTheFirstChannelChannelSet1_Present));
		} 
#endif
	...
	------------------------------------------------------*/
	/* Detect IEI tag 0x11 */
	ED_EXPECT_OPTIONAL_IE (0x11,  8, 170, 10, KnownL3IEs)
	/* Tag = EDBitsToInt (Buffer, CurrOfs, 8); */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (RetLen != Len) {
			ED_SIGNAL_ERROR ("<ERRID:171> Error decoding subfield ModeOfChannelSet2\n");
			ED_HANDLE_OPTIONAL_IE_SYNTAX_ERROR (0x11, 171, (Destin->ModeOfChannelSet2), (Destin->ModeOfChannelSet2_Present));
		} 
#endif
		CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (CurrOfs > (BitOffset+Length)) {
			ED_SIGNAL_ERROR ("<ERRID:172> Message too short decoding subfield ModeOfChannelSet2\n");
			ED_HANDLE_OPTIONAL_IE_MSG_TOO_SHORT (0x11, 171, (Destin->ModeOfChannelSet2), (Destin->ModeOfChannelSet2_Present));
		} 
#endif
	...
	------------------------------------------------------*/
	/* Detect IEI tag 0x13 */
	ED_EXPECT_OPTIONAL_IE (0x13,  8, 173, 11, KnownL3IEs)
	/* Tag = EDBitsToInt (Buffer, CurrOfs, 8); */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (RetLen != Len) {
			ED_SIGNAL_ERROR ("<ERRID:174> Error decoding subfield ModeOfChannelSet3\n");
			ED_HANDLE_OPTIONAL_IE_SYNTAX_ERROR (0x13, 174, (Destin->ModeOfChannelSet3), (Destin->ModeOfChannelSet3_Present));
		} 
#endif
		CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (CurrOfs > (BitOffset+Length)) {
			ED_SIGNAL_ERROR ("<ERRID:175> Message too short decoding subfield ModeOfChannelSet3\n");
			ED_HANDLE_OPTIONAL_IE_MSG_TOO_SHORT (0x13, 174, (Destin->ModeOfChannelSet3), (Destin->ModeOfChannelSet3_Present));
		} 
#endif
	...
	------------------------------------------------------*/
	/* Detect IEI tag 0x14 */
	ED_EXPECT_OPTIONAL_IE (0x14,  8, 176, 12, KnownL3IEs)
	/* Tag = EDBitsToInt (Buffer, CurrOfs, 8); */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (RetLen != Len) {
			ED_SIGNAL_ERROR ("<ERRID:177> Error decoding subfield ModeOfChannelSet4\n");
			ED_HANDLE_OPTIONAL_IE_SYNTAX_ERROR (0x14, 177, (Destin->ModeOfChannelSet4), (Destin->ModeOfChannelSet4_Present));
		} 
#endif
		CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (CurrOfs > (BitOffset+Length)) {
			ED_SIGNAL_ERROR ("<ERRID:178> Message too short decoding subfield ModeOfChannelSet4\n");
			ED_HANDLE_OPTIONAL_IE_MSG_TOO_SHORT (0x14, 177, (Destin->ModeOfChannelSet4), (Destin->ModeOfChannelSet4_Present));
		} 
#endif
	...
	------------------------------------------------------*/
	/* Detect IEI tag 0x15 */
	ED_EXPECT_OPTIONAL_IE (0x15,  8, 179, 13, KnownL3IEs)
	/* Tag = EDBitsToInt (Buffer, CurrOfs, 8); */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (RetLen != Len) {
			ED_SIGNAL_ERROR ("<ERRID:180> Error decoding subfield ModeOfChannelSet5\n");
			ED_HANDLE_OPTIONAL_IE_SYNTAX_ERROR (0x15, 180, (Destin->ModeOfChannelSet5), (Destin->ModeOfChannelSet5_Present));
		} 
#endif
		CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (CurrOfs > (BitOffset+Length)) {
			ED_SIGNAL_ERROR ("<ERRID:181> Message too short decoding subfield ModeOfChannelSet5\n");
			ED_HANDLE_OPTIONAL_IE_MSG_TOO_SHORT (0x15, 180, (Destin->ModeOfChannelSet5), (Destin->ModeOfChannelSet5_Present));
		} 
#endif
	...
	------------------------------------------------------*/
	/* Detect IEI tag 0x16 */
	ED_EXPECT_OPTIONAL_IE (0x16,  8, 182, 14, KnownL3IEs)
	/* Tag = EDBitsToInt (Buffer, CurrOfs, 8); */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (RetLen != Len) {
			ED_SIGNAL_ERROR ("<ERRID:183> Error decoding subfield ModeOfChannelSet6\n");
			ED_HANDLE_OPTIONAL_IE_SYNTAX_ERROR (0x16, 183, (Destin->ModeOfChannelSet6), (Destin->ModeOfChannelSet6_Present));
		} 
#endif
		CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (CurrOfs > (BitOffset+Length)) {
			ED_SIGNAL_ERROR ("<ERRID:184> Message too short decoding subfield ModeOfChannelSet6\n");
			ED_HANDLE_OPTIONAL_IE_MSG_TOO_SHORT (0x16, 183, (Destin->ModeOfChannelSet6), (Destin->ModeOfChannelSet6_Present));
		} 
#endif
	...
	------------------------------------------------------*/
	/* Detect IEI tag 0x17 */
	ED_EXPECT_OPTIONAL_IE (0x17,  8, 185, 15, KnownL3IEs)
	/* Tag = EDBitsToInt (Buffer, CurrOfs, 8); */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (RetLen != Len) {
			ED_SIGNAL_ERROR ("<ERRID:186> Error decoding subfield ModeOfChannelSet7\n");
			ED_HANDLE_OPTIONAL_IE_SYNTAX_ERROR (0x17, 186, (Destin->ModeOfChannelSet7), (Destin->ModeOfChannelSet7_Present));
		} 
#endif
		CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (CurrOfs > (BitOffset+Length)) {
			ED_SIGNAL_ERROR ("<ERRID:187> Message too short decoding subfield ModeOfChannelSet7\n");
			ED_HANDLE_OPTIONAL_IE_MSG_TOO_SHORT (0x17, 186, (Destin->ModeOfChannelSet7), (Destin->ModeOfChannelSet7_Present));
		} 
#endif
	...
	------------------------------------------------------*/
	/* Detect IEI tag 0x18 */
	ED_EXPECT_OPTIONAL_IE (0x18,  8, 188, 16, KnownL3IEs)
	/* Tag = EDBitsToInt (Buffer, CurrOfs, 8); */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (RetLen != Len) {
			ED_SIGNAL_ERROR ("<ERRID:189> Error decoding subfield ModeOfChannelSet8\n");
			ED_HANDLE_OPTIONAL_IE_SYNTAX_ERROR (0x18, 189, (Destin->ModeOfChannelSet8), (Destin->ModeOfChannelSet8_Present));
		} 
#endif
		CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (CurrOfs > (BitOffset+Length)) {
			ED_SIGNAL_ERROR ("<ERRID:190> Message too short decoding subfield ModeOfChannelSet8\n");
			ED_HANDLE_OPTIONAL_IE_MSG_TOO_SHORT (0x18, 189, (Destin->ModeOfChannelSet8), (Destin->ModeOfChannelSet8_Present));
		} 
#endif
	...
	------------------------------------------------------*/
	/* Detect IEI tag 0x64 */
	ED_EXPECT_OPTIONAL_IE (0x64,  8, 191, 17, KnownL3IEs)
	/* Tag = EDBitsToInt (Buffer, CurrOfs, 8); */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (RetLen != Len) {
			ED_SIGNAL_ERROR ("<ERRID:192> Error decoding subfield DescriptionOfTheSecondChannelAfterTime\n");
			ED_HANDLE_OPTIONAL_IE_SYNTAX_ERROR (0x64, 192, (Destin->DescriptionOfTheSecondChannelAfterTime), (Destin->DescriptionOfTheSecondChannelAfterTime_Present));
		} 
#endif
		CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (CurrOfs > (BitOffset+Length)) {
			ED_SIGNAL_ERROR ("<ERRID:193> Message too short decoding subfield DescriptionOfTheSecondChannelAfterTime\n");
			ED_HANDLE_OPTIONAL_IE_MSG_TOO_SHORT (0x64, 192, (Destin->DescriptionOfTheSecondChannelAfterTime), (Destin->DescriptionOfTheSecondChannelAfterTime_Present));
		} 
#endif
	...
	------------------------------------------------------*/
	/* Detect IEI tag 0x66 */
	ED_EXPECT_OPTIONAL_IE (0x66,  8, 194, 18, KnownL3IEs)
	/* Tag = EDBitsToInt (Buffer, CurrOfs, 8); */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (RetLen != Len) {
			ED_SIGNAL_ERROR ("<ERRID:195> Error decoding subfield ModeOfTheSecondChannel\n");
			ED_HANDLE_OPTIONAL_IE_SYNTAX_ERROR (0x66, 195, (Destin->ModeOfTheSecondChannel), (Destin->ModeOfTheSecondChannel_Present));
		} 
#endif
		CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (CurrOfs > (BitOffset+Length)) {
			ED_SIGNAL_ERROR ("<ERRID:196> Message too short decoding subfield ModeOfTheSecondChannel\n");
			ED_HANDLE_OPTIONAL_IE_MSG_TOO_SHORT (0x66, 195, (Destin->ModeOfTheSecondChannel), (Destin->ModeOfTheSecondChannel_Present));
		} 
#endif
	...
	------------------------------------------------------*/
	/* Detect IEI tag 0x69 */
	ED_EXPECT_OPTIONAL_IE (0x69,  8, 197, 19, KnownL3IEs)
	/* Tag = EDBitsToInt (Buffer, CurrOfs, 8); */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (RetLen != Len) {
			ED_SIGNAL_ERROR ("<ERRID:198> Error decoding subfield FrequencyChannelSequenceAfterTime\n");
			ED_HANDLE_OPTIONAL_IE_SYNTAX_ERROR (0x69, 198, (Destin->FrequencyChannelSequenceAfterTime), (Destin->FrequencyChannelSequenceAfterTime_Present));
		} 
#endif
		CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (CurrOfs > (BitOffset+Length)) {
			ED_SIGNAL_ERROR ("<ERRID:199> Message too short decoding subfield FrequencyChannelSequenceAfterTime\n");
			ED_HANDLE_OPTIONAL_IE_MSG_TOO_SHORT (0x69, 198, (Destin->FrequencyChannelSequenceAfterTime), (Destin->FrequencyChannelSequenceAfterTime_Present));
		} 
#endif
	...
	------------------------------------------------------*/
	/* Detect IEI tag 0x72 */
	ED_EXPECT_OPTIONAL_IE (0x72,  8, 200, 20, KnownL3IEs)
	/* Tag = EDBitsToInt (Buffer, CurrOfs, 8); */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if ((Len < 8) || (Len > 64)) {
			ED_SIGNAL_ERROR ("<ERRID:201> Size error decoding IE MobileAllocationAfterTime\n");
			ED_HANDLE_IE_SIZE_ERROR (0x72, 201, (Destin->MobileAllocationAfterTime), (Destin->MobileAllocationAfterTime_Present))
		} 
#endif
		/* Read value part */
		RetLen = DECODE_c_MobileAllocation (Buffer, CurrOfs, &(Destin->MobileAllocationAfterTime), Len);
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (RetLen != Len) {
			ED_SIGNAL_ERROR ("<ERRID:202> Error decoding subfield MobileAllocationAfterTime\n");
			ED_HANDLE_OPTIONAL_IE_SYNTAX_ERROR (0x72, 202, (Destin->MobileAllocationAfterTime), (Destin->MobileAllocationAfterTime_Present));
		} 
#endif
		CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (CurrOfs > (BitOffset+Length)) {
			ED_SIGNAL_ERROR ("<ERRID:203> Message too short decoding subfield MobileAllocationAfterTime\n");
			ED_HANDLE_OPTIONAL_IE_MSG_TOO_SHORT (0x72, 202, (Destin->MobileAllocationAfterTime), (Destin->MobileAllocationAfterTime_Present));
		} 
#endif
	...
	------------------------------------------------------*/
	/* Detect IEI tag 0x7C */
	ED_EXPECT_OPTIONAL_IE (0x7C,  8, 204, 21, KnownL3IEs)
	/* Tag = EDBitsToInt (Buffer, CurrOfs, 8); */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (RetLen != Len) {
			ED_SIGNAL_ERROR ("<ERRID:205> Error decoding subfield StartingTime\n");
			ED_HANDLE_OPTIONAL_IE_SYNTAX_ERROR (0x7C, 205, (Destin->StartingTime), (Destin->StartingTime_Present));
		} 
#endif
		CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (CurrOfs > (BitOffset+Length)) {
			ED_SIGNAL_ERROR ("<ERRID:206> Message too short decoding subfield StartingTime\n");
			ED_HANDLE_OPTIONAL_IE_MSG_TOO_SHORT (0x7C, 205, (Destin->StartingTime), (Destin->StartingTime_Present));
		} 
#endif
	...
	------------------------------------------------------*/
	/* Detect IEI tag 0x7B */
	ED_EXPECT_OPTIONAL_IE (0x7B,  8, 207, 22, KnownL3IEs)
	/* Tag = EDBitsToInt (Buffer, CurrOfs, 8); */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len != 8) {
			ED_SIGNAL_ERROR ("<ERRID:208> Size error decoding IE RealTimeDifference\n");
			ED_HANDLE_IE_SIZE_ERROR (0x7B, 208, (Destin->RealTimeDifference), (Destin->RealTimeDifference_Present))
		} 
#endif
		/* Read value part */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (RetLen != Len) {
			ED_SIGNAL_ERROR ("<ERRID:209> Error decoding subfield RealTimeDifference\n");
			ED_HANDLE_OPTIONAL_IE_SYNTAX_ERROR (0x7B, 209, (Destin->RealTimeDifference), (Destin->RealTimeDifference_Present));
		} 
#endif
		CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (CurrOfs > (BitOffset+Length)) {
			ED_SIGNAL_ERROR ("<ERRID:210> Message too short decoding subfield RealTimeDifference\n");
			ED_HANDLE_OPTIONAL_IE_MSG_TOO_SHORT (0x7B, 209, (Destin->RealTimeDifference), (Destin->RealTimeDifference_Present));
		} 
#endif
	...
	------------------------------------------------------*/
	/* Detect IEI tag 0x7D */
	ED_EXPECT_OPTIONAL_IE (0x7D,  8, 211, 23, KnownL3IEs)
	/* Tag = EDBitsToInt (Buffer, CurrOfs, 8); */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (RetLen != Len) {
			ED_SIGNAL_ERROR ("<ERRID:212> Error decoding subfield TimingAdvance\n");
			ED_HANDLE_OPTIONAL_IE_SYNTAX_ERROR (0x7D, 212, (Destin->TimingAdvance), (Destin->TimingAdvance_Present));
		} 
#endif
		CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (CurrOfs > (BitOffset+Length)) {
			ED_SIGNAL_ERROR ("<ERRID:213> Message too short decoding subfield TimingAdvance\n");
			ED_HANDLE_OPTIONAL_IE_MSG_TOO_SHORT (0x7D, 212, (Destin->TimingAdvance), (Destin->TimingAdvance_Present));
		} 
#endif
	...
	------------------------------------------------------*/
	/* Detect IEI tag 0x12 */
	ED_EXPECT_OPTIONAL_IE (0x12,  8, 214, 24, KnownL3IEs)
	/* Tag = EDBitsToInt (Buffer, CurrOfs, 8); */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (RetLen != Len) {
			ED_SIGNAL_ERROR ("<ERRID:215> Error decoding subfield FrequencyShortListBeforeTime\n");
			ED_HANDLE_OPTIONAL_IE_SYNTAX_ERROR (0x12, 215, (Destin->FrequencyShortListBeforeTime), (Destin->FrequencyShortListBeforeTime_Present));
		} 
#endif
		CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (CurrOfs > (BitOffset+Length)) {
			ED_SIGNAL_ERROR ("<ERRID:216> Message too short decoding subfield FrequencyShortListBeforeTime\n");
			ED_HANDLE_OPTIONAL_IE_MSG_TOO_SHORT (0x12, 215, (Destin->FrequencyShortListBeforeTime), (Destin->FrequencyShortListBeforeTime_Present));
		} 
#endif
	...
	------------------------------------------------------*/
	/* Detect IEI tag 0x19 */
	ED_EXPECT_OPTIONAL_IE (0x19,  8, 217, 25, KnownL3IEs)
	/* Tag = EDBitsToInt (Buffer, CurrOfs, 8); */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if ((Len < 16) || (Len > 1032)) {
			ED_SIGNAL_ERROR ("<ERRID:218> Size error decoding IE FrequencyListBeforeTime\n");
			ED_HANDLE_IE_SIZE_ERROR (0x19, 218, (Destin->FrequencyListBeforeTime), (Destin->FrequencyListBeforeTime_Present))
		} 
#endif
		/* Read value part */
		RetLen = DECODE_c_CellChannel (Buffer, CurrOfs, &(Destin->FrequencyListBeforeTime), Len);
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (RetLen != Len) {
			ED_SIGNAL_ERROR ("<ERRID:219> Error decoding subfield FrequencyListBeforeTime\n");
			ED_HANDLE_OPTIONAL_IE_SYNTAX_ERROR (0x19, 219, (Destin->FrequencyListBeforeTime), (Destin->FrequencyListBeforeTime_Present));
		} 
#endif
		CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (CurrOfs > (BitOffset+Length)) {
			ED_SIGNAL_ERROR ("<ERRID:220> Message too short decoding subfield FrequencyListBeforeTime\n");
			ED_HANDLE_OPTIONAL_IE_MSG_TOO_SHORT (0x19, 219, (Destin->FrequencyListBeforeTime), (Destin->FrequencyListBeforeTime_Present));
		} 
#endif
	...
	------------------------------------------------------*/
	/* Detect IEI tag 0x1C */
	ED_EXPECT_OPTIONAL_IE (0x1C,  8, 221, 26, KnownL3IEs)
	/* Tag = EDBitsToInt (Buffer, CurrOfs, 8); */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (RetLen != Len) {
			ED_SIGNAL_ERROR ("<ERRID:222> Error decoding subfield DescriptionOfTheFirstChannelBeforeTime\n");
			ED_HANDLE_OPTIONAL_IE_SYNTAX_ERROR (0x1C, 222, (Destin->DescriptionOfTheFirstChannelBeforeTime), (Destin->DescriptionOfTheFirstChannelBeforeTime_Present));
		} 
#endif
		CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (CurrOfs > (BitOffset+Length)) {
			ED_SIGNAL_ERROR ("<ERRID:223> Message too short decoding subfield DescriptionOfTheFirstChannelBeforeTime\n");
			ED_HANDLE_OPTIONAL_IE_MSG_TOO_SHORT (0x1C, 222, (Destin->DescriptionOfTheFirstChannelBeforeTime), (Destin->DescriptionOfTheFirstChannelBeforeTime_Present));
		} 
#endif
	...
	------------------------------------------------------*/
	/* Detect IEI tag 0x1D */
	ED_EXPECT_OPTIONAL_IE (0x1D,  8, 224, 27, KnownL3IEs)
	/* Tag = EDBitsToInt (Buffer, CurrOfs, 8); */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (RetLen != Len) {
			ED_SIGNAL_ERROR ("<ERRID:225> Error decoding subfield DescriptionOfTheSecondChannelBeforeTime\n");
			ED_HANDLE_OPTIONAL_IE_SYNTAX_ERROR (0x1D, 225, (Destin->DescriptionOfTheSecondChannelBeforeTime), (Destin->DescriptionOfTheSecondChannelBeforeTime_Present));
		} 
#endif
		CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (CurrOfs > (BitOffset+Length)) {
			ED_SIGNAL_ERROR ("<ERRID:226> Message too short decoding subfield DescriptionOfTheSecondChannelBeforeTime\n");
			ED_HANDLE_OPTIONAL_IE_MSG_TOO_SHORT (0x1D, 225, (Destin->DescriptionOfTheSecondChannelBeforeTime), (Destin->DescriptionOfTheSecondChannelBeforeTime_Present));
		} 
#endif
	...
	------------------------------------------------------*/
	/* Detect IEI tag 0x1E */
	ED_EXPECT_OPTIONAL_IE (0x1E,  8, 227, 28, KnownL3IEs)
	/* Tag = EDBitsToInt (Buffer, CurrOfs, 8); */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (RetLen != Len) {
			ED_SIGNAL_ERROR ("<ERRID:228> Error decoding subfield FrequencyChannelSequenceBeforeTime\n");
			ED_HANDLE_OPTIONAL_IE_SYNTAX_ERROR (0x1E, 228, (Destin->FrequencyChannelSequenceBeforeTime), (Destin->FrequencyChannelSequenceBeforeTime_Present));
		} 
#endif
		CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (CurrOfs > (BitOffset+Length)) {
			ED_SIGNAL_ERROR ("<ERRID:229> Message too short decoding subfield FrequencyChannelSequenceBeforeTime\n");
			ED_HANDLE_OPTIONAL_IE_MSG_TOO_SHORT (0x1E, 228, (Destin->FrequencyChannelSequenceBeforeTime), (Destin->FrequencyChannelSequenceBeforeTime_Present));
		} 
#endif
	...
	------------------------------------------------------*/
	/* Detect IEI tag 0x21 */
	ED_EXPECT_OPTIONAL_IE (0x21,  8, 230, 29, KnownL3IEs)
	/* Tag = EDBitsToInt (Buffer, CurrOfs, 8); */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if ((Len < 8) || (Len > 64)) {
			ED_SIGNAL_ERROR ("<ERRID:231> Size error decoding IE MobileAllocationBeforeTime\n");
			ED_HANDLE_IE_SIZE_ERROR (0x21, 231, (Destin->MobileAllocationBeforeTime), (Destin->MobileAllocationBeforeTime_Present))
		} 
#endif
		/* Read value part */
		RetLen = DECODE_c_MobileAllocation (Buffer, CurrOfs, &(Destin->MobileAllocationBeforeTime), Len);
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (RetLen != Len) {
			ED_SIGNAL_ERROR ("<ERRID:232> Error decoding subfield MobileAllocationBeforeTime\n");
			ED_HANDLE_OPTIONAL_IE_SYNTAX_ERROR (0x21, 232, (Destin->MobileAllocationBeforeTime), (Destin->MobileAllocationBeforeTime_Present));
		} 
#endif
		CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (CurrOfs > (BitOffset+Length)) {
			ED_SIGNAL_ERROR ("<ERRID:233> Message too short decoding subfield MobileAllocationBeforeTime\n");
			ED_HANDLE_OPTIONAL_IE_MSG_TOO_SHORT (0x21, 232, (Destin->MobileAllocationBeforeTime), (Destin->MobileAllocationBeforeTime_Present));
		} 
#endif
	...
	------------------------------------------------------*/
	/* Detect IEI tag 0x09 */
	ED_EXPECT_OPTIONAL_IE (0x09,  4, 234, 30, KnownL3IEs)
	/* Tag = EDBitsToInt (Buffer, CurrOfs, 4); */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (RetLen != Len) {
			ED_SIGNAL_ERROR ("<ERRID:235> Error decoding subfield CipherModeSetting\n");
			ED_HANDLE_OPTIONAL_IE_SYNTAX_ERROR (0x09, 235, (Destin->CipherModeSetting), (Destin->CipherModeSetting_Present));
		} 
#endif
		CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (CurrOfs > (BitOffset+Length)) {
			ED_SIGNAL_ERROR ("<ERRID:236> Message too short decoding subfield CipherModeSetting\n");
			ED_HANDLE_OPTIONAL_IE_MSG_TOO_SHORT (0x09, 235, (Destin->CipherModeSetting), (Destin->CipherModeSetting_Present));
		} 
#endif
	...
	------------------------------------------------------*/
	/* Detect IEI tag 0x01 */
	ED_EXPECT_OPTIONAL_IE (0x01,  8, 237, 31, KnownL3IEs)
	/* Tag = EDBitsToInt (Buffer, CurrOfs, 8); */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len != 8) {
			ED_SIGNAL_ERROR ("<ERRID:238> Size error decoding IE VgcsTargetModeIndication\n");
			ED_HANDLE_IE_SIZE_ERROR (0x01, 238, (Destin->VgcsTargetModeIndication), (Destin->VgcsTargetModeIndication_Present))
		} 
#endif
		/* Read value part */
		Destin->VgcsTargetModeIndication = EDBitsToInt (Buffer, CurrOfs, 8);
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (RetLen != Len) {
			ED_SIGNAL_ERROR ("<ERRID:239> Error decoding subfield VgcsTargetModeIndication\n");
			ED_HANDLE_OPTIONAL_IE_SYNTAX_ERROR (0x01, 239, (Destin->VgcsTargetModeIndication), (Destin->VgcsTargetModeIndication_Present));
		} 
#endif
		CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (CurrOfs > (BitOffset+Length)) {
			ED_SIGNAL_ERROR ("<ERRID:240> Message too short decoding subfield VgcsTargetModeIndication\n");
			ED_HANDLE_OPTIONAL_IE_MSG_TOO_SHORT (0x01, 239, (Destin->VgcsTargetModeIndication), (Destin->VgcsTargetModeIndication_Present));
		} 
#endif
	...
	------------------------------------------------------*/
	/* Detect IEI tag 0x03 */
	ED_EXPECT_OPTIONAL_IE (0x03,  8, 241, 32, KnownL3IEs)
	/* Tag = EDBitsToInt (Buffer, CurrOfs, 8); */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if ((Len < 16) || (Len > 48)) {
			ED_SIGNAL_ERROR ("<ERRID:242> Size error decoding IE MultiRateCfg\n");
			ED_HANDLE_IE_SIZE_ERROR (0x03, 242, (Destin->MultiRateCfg), (Destin->MultiRateCfg_Present))
		} 
#endif
		/* Read value part */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (RetLen != Len) {
			ED_SIGNAL_ERROR ("<ERRID:243> Error decoding subfield MultiRateCfg\n");
			ED_HANDLE_OPTIONAL_IE_SYNTAX_ERROR (0x03, 243, (Destin->MultiRateCfg), (Destin->MultiRateCfg_Present));
		} 
#endif
		CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (CurrOfs > (BitOffset+Length)) {
			ED_SIGNAL_ERROR ("<ERRID:244> Message too short decoding subfield MultiRateCfg\n");
			ED_HANDLE_OPTIONAL_IE_MSG_TOO_SHORT (0x03, 243, (Destin->MultiRateCfg), (Destin->MultiRateCfg_Present));
		} 
#endif
	...
	------------------------------------------------------*/
	/* Detect IEI tag 0x76 */
	ED_EXPECT_OPTIONAL_IE (0x76,  8, 245, 33, KnownL3IEs)
	/* Tag = EDBitsToInt (Buffer, CurrOfs, 8); */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if ((Len < 32) || (Len > 256)) {
			ED_SIGNAL_ERROR ("<ERRID:246> Size error decoding IE DynamicARFCNMapping\n");
			ED_HANDLE_IE_SIZE_ERROR (0x76, 246, (Destin->DynamicARFCNMapping), (Destin->DynamicARFCNMapping_Present))
		} 
#endif
		/* Read value part */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (RetLen != Len) {
			ED_SIGNAL_ERROR ("<ERRID:247> Error decoding subfield DynamicARFCNMapping\n");
			ED_HANDLE_OPTIONAL_IE_SYNTAX_ERROR (0x76, 247, (Destin->DynamicARFCNMapping), (Destin->DynamicARFCNMapping_Present));
		} 
#endif
		CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (CurrOfs > (BitOffset+Length)) {
			ED_SIGNAL_ERROR ("<ERRID:248> Message too short decoding subfield DynamicARFCNMapping\n");
			ED_HANDLE_OPTIONAL_IE_MSG_TOO_SHORT (0x76, 247, (Destin->DynamicARFCNMapping), (Destin->DynamicARFCNMapping_Present));
		} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if ((Len < 8) || (Len > 4792)) {
		ED_SIGNAL_ERROR ("<ERRID:249> Size error decoding IE HandoverToUtranCommand\n");
		ED_HANDLE_IE_SIZE_ERROR ((-1), 249, (Destin->HandoverToUtranCommand), (Destin->HandoverToUtranCommand_Present))
	} 
#endif
	/* Read value part */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (RetLen != Len) {
		ED_SIGNAL_ERROR ("<ERRID:250> Error decoding subfield HandoverToUtranCommand\n");
		ED_HANDLE_MANDATORY_IE_SYNTAX_ERROR ((-1), 250, (Destin->HandoverToUtranCommand));
	} 
#endif
	CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (CurrOfs > (BitOffset+Length)) {
		ED_SIGNAL_ERROR ("<ERRID:251> Message too short decoding subfield HandoverToUtranCommand\n");
		ED_HANDLE_MANDATORY_IE_MSG_TOO_SHORT ((-1), 250, (Destin->HandoverToUtranCommand));
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (RetLen != Len) {
		ED_SIGNAL_ERROR ("<ERRID:252> Error decoding subfield TimingAdvance\n");
		ED_HANDLE_MANDATORY_IE_SYNTAX_ERROR ((-1), 252, (Destin->TimingAdvance));
	} 
#endif
	CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (CurrOfs > (BitOffset+Length)) {
		ED_SIGNAL_ERROR ("<ERRID:253> Message too short decoding subfield TimingAdvance\n");
		ED_HANDLE_MANDATORY_IE_MSG_TOO_SHORT ((-1), 252, (Destin->TimingAdvance));
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len < 0) {
			ED_SIGNAL_ERROR ("<ERRID:254> Error encoding subfield RrCause\n");
			return -1;
		} 
#endif
		CurrOfs += Len;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (RetLen != Len) {
		ED_SIGNAL_ERROR ("<ERRID:255> Error decoding subfield RrCause\n");
		ED_HANDLE_MANDATORY_IE_SYNTAX_ERROR ((-1), 255, (Destin->RrCause));
	} 
#endif
	CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (CurrOfs > (BitOffset+Length)) {
		ED_SIGNAL_ERROR ("<ERRID:256> Message too short decoding subfield RrCause\n");
		ED_HANDLE_MANDATORY_IE_MSG_TOO_SHORT ((-1), 255, (Destin->RrCause));
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len < 0) {
			ED_SIGNAL_ERROR ("<ERRID:257> Error encoding subfield ApduId\n");
			return -1;
		} 
#endif
		CurrOfs += Len;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len < 0) {
			ED_SIGNAL_ERROR ("<ERRID:258> Error encoding subfield ApduFlags\n");
			return -1;
		} 
#endif
		CurrOfs += Len;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len < 0) {
			ED_SIGNAL_ERROR ("<ERRID:259> Error encoding subfield ApduData\n");
			return -1;
		} 
#endif
		CurrOfs += Len+8;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (RetLen != Len) {
		ED_SIGNAL_ERROR ("<ERRID:260> Error decoding subfield ApduId\n");
		ED_HANDLE_MANDATORY_IE_SYNTAX_ERROR ((-1), 260, (Destin->ApduId));
	} 
#endif
	CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (CurrOfs > (BitOffset+Length)) {
		ED_SIGNAL_ERROR ("<ERRID:261> Message too short decoding subfield ApduId\n");
		ED_HANDLE_MANDATORY_IE_MSG_TOO_SHORT ((-1), 260, (Destin->ApduId));
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (RetLen != Len) {
		ED_SIGNAL_ERROR ("<ERRID:262> Error decoding subfield ApduFlags\n");
		ED_HANDLE_MANDATORY_IE_SYNTAX_ERROR ((-1), 262, (Destin->ApduFlags));
	} 
#endif
	CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (CurrOfs > (BitOffset+Length)) {
		ED_SIGNAL_ERROR ("<ERRID:263> Message too short decoding subfield ApduFlags\n");
		ED_HANDLE_MANDATORY_IE_MSG_TOO_SHORT ((-1), 262, (Destin->ApduFlags));
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if ((Len < 8) || (Len > 1976)) {
		ED_SIGNAL_ERROR ("<ERRID:264> Size error decoding IE ApduData\n");
		ED_HANDLE_IE_SIZE_ERROR ((-1), 264, (Destin->ApduData), (Destin->ApduData_Present))
	} 
#endif
	/* Read value part */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (RetLen != Len) {
		ED_SIGNAL_ERROR ("<ERRID:265> Error decoding subfield ApduData\n");
		ED_HANDLE_MANDATORY_IE_SYNTAX_ERROR ((-1), 265, (Destin->ApduData));
	} 
#endif
	CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (CurrOfs > (BitOffset+Length)) {
		ED_SIGNAL_ERROR ("<ERRID:266> Message too short decoding subfield ApduData\n");
		ED_HANDLE_MANDATORY_IE_MSG_TOO_SHORT ((-1), 265, (Destin->ApduData));
	} 
#endif
