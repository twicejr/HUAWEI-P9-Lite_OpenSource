...
long L3_ENCODE_c_ASSIGNMENT_COMPLETE (char* Buffer, long BitOffset, const c_ASSIGNMENT_COMPLETE* Source, int Mode)
{
	...
	/* Code for RrCause */
	{
		...
		if (Len < 0) {
			ED_SIGNAL_ERROR ("<ERRID:267> Error encoding subfield RrCause\n");
			return -1;
		} 
#endif
		CurrOfs += Len;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len < 0) {
			ED_SIGNAL_ERROR ("<ERRID:268> Error encoding subfield RrCause\n");
			return -1;
		} 
#endif
		CurrOfs += Len;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len < 0) {
			ED_SIGNAL_ERROR ("<ERRID:269> Error encoding subfield ChannelDescription\n");
			return -1;
		} 
#endif
		CurrOfs += Len;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len < 0) {
			ED_SIGNAL_ERROR ("<ERRID:270> Error encoding subfield ChannelMode\n");
			return -1;
		} 
#endif
		CurrOfs += Len;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
			if (Len < 0) {
				ED_SIGNAL_ERROR ("<ERRID:271> Error encoding subfield MobileEquipmentId\n");
				return -1;
			} 
#endif
			CurrOfs += Len+8;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len < 0) {
			ED_SIGNAL_ERROR ("<ERRID:272> Error encoding subfield MobileStationClassmark\n");
			return -1;
		} 
#endif
		CurrOfs += Len+8;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
			if (Len < 0) {
				ED_SIGNAL_ERROR ("<ERRID:273> Error encoding subfield AdditionalMobileStationClassmarkInfo\n");
				return -1;
			} 
#endif
			CurrOfs += Len+8;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len < 0) {
			ED_SIGNAL_ERROR ("<ERRID:274> Error encoding subfield TemporaryLogicalLinkId\n");
			return -1;
		} 
#endif
		CurrOfs += Len;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len < 0) {
			ED_SIGNAL_ERROR ("<ERRID:275> Error encoding subfield RouteingAreaId\n");
			return -1;
		} 
#endif
		CurrOfs += Len;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len < 0) {
			ED_SIGNAL_ERROR ("<ERRID:276> Error encoding subfield SuspensionCause\n");
			return -1;
		} 
#endif
		CurrOfs += Len;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len < 0) {
			ED_SIGNAL_ERROR ("<ERRID:277> Error encoding subfield RrCause\n");
			return -1;
		} 
#endif
		CurrOfs += Len;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
			if (Len < 0) {
				ED_SIGNAL_ERROR ("<ERRID:278> Error encoding subfield MobileObservedTimeDifference\n");
				return -1;
			} 
#endif
			CurrOfs += Len+8;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len < 0) {
			ED_SIGNAL_ERROR ("<ERRID:279> Error encoding subfield RrCause\n");
			return -1;
		} 
#endif
		CurrOfs += Len;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len < 0) {
			ED_SIGNAL_ERROR ("<ERRID:280> Error encoding subfield MeasurementResults\n");
			return -1;
		} 
#endif
		CurrOfs += Len;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len < 0) {
			ED_SIGNAL_ERROR ("<ERRID:281> Error encoding subfield CiphKeySequenceNum\n");
			return -1;
		} 
#endif
		CurrOfs += Len;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len < 0) {
			ED_SIGNAL_ERROR ("<ERRID:282> Error encoding subfield SpareHalfOctet\n");
			return -1;
		} 
#endif
		CurrOfs += Len;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len < 0) {
			ED_SIGNAL_ERROR ("<ERRID:283> Error encoding subfield MobileStationClassmark\n");
			return -1;
		} 
#endif
		CurrOfs += Len+8;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len < 0) {
			ED_SIGNAL_ERROR ("<ERRID:284> Error encoding subfield MobileId\n");
			return -1;
		} 
#endif
		CurrOfs += Len+8;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len < 0) {
			ED_SIGNAL_ERROR ("<ERRID:286> Error encoding subfield MacModeAndChannelCodingReq\n");
			return -1;
		} 
#endif
		CurrOfs += Len;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len < 0) {
			ED_SIGNAL_ERROR ("<ERRID:288> Error encoding subfield Tlli\n");
			return -1;
		} 
#endif
		CurrOfs += Len;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len < 0) {
			ED_SIGNAL_ERROR ("<ERRID:289> Error encoding subfield ChannelReqDescription\n");
			return -1;
		} 
#endif
		CurrOfs += Len;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len < 0) {
			ED_SIGNAL_ERROR ("<ERRID:290> Error encoding subfield GprsMeasurementResults\n");
			return -1;
		} 
#endif
		CurrOfs += Len;
