...
long L3_ENCODE_c_Packet_Cell_Change_Failure (char* Buffer, long BitOffset, const c_Packet_Cell_Change_Failure* Source, int Mode)
{
	...
	/* Code for contents */
	{
		...
		if (Len < 0) {
			ED_SIGNAL_ERROR ("<ERRID:545> Error encoding subfield contents\n");
			return -1;
		} 
#endif
		CurrOfs += Len;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len < 0) {
			ED_SIGNAL_ERROR ("<ERRID:546> Error encoding subfield contents\n");
			return -1;
		} 
#endif
		CurrOfs += Len;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len < 0) {
			ED_SIGNAL_ERROR ("<ERRID:548> Error encoding subfield contents\n");
			return -1;
		} 
#endif
		CurrOfs += Len;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len < 0) {
			ED_SIGNAL_ERROR ("<ERRID:549> Error encoding subfield contents\n");
			return -1;
		} 
#endif
		CurrOfs += Len;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len < 0) {
			ED_SIGNAL_ERROR ("<ERRID:551> Error encoding subfield contents\n");
			return -1;
		} 
#endif
		CurrOfs += Len;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len < 0) {
			ED_SIGNAL_ERROR ("<ERRID:552> Error encoding subfield contents\n");
			return -1;
		} 
#endif
		CurrOfs += Len;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len < 0) {
			ED_SIGNAL_ERROR ("<ERRID:554> Error encoding subfield contents\n");
			return -1;
		} 
#endif
		CurrOfs += Len;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len < 0) {
			ED_SIGNAL_ERROR ("<ERRID:555> Error encoding subfield contents\n");
			return -1;
		} 
#endif
		CurrOfs += Len;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Len < 0) {
			ED_SIGNAL_ERROR ("<ERRID:557> Error encoding subfield contents\n");
			return -1;
		} 
#endif
		CurrOfs += Len;
