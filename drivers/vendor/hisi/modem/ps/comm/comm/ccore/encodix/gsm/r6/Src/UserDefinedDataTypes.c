...
long ENCODE_c_LocationAreaId (char* ED_CONST Buffer, ED_CONST long BitOffset, const c_LocationAreaId* ED_CONST Source)
{
	...
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:558> Error encoding subfield MCC2\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:559> Error encoding subfield MCC1\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:560> Error encoding subfield MNC3\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:561> Error encoding subfield MCC3\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:562> Error encoding subfield MNC2\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:563> Error encoding subfield MNC1\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:564> Error encoding subfield LAC\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:565> Error decoding subfield MCC2\n");
		ED_HANDLE_IE_SYNTAX_ERROR (565)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:566> Error decoding subfield MCC1\n");
		ED_HANDLE_IE_SYNTAX_ERROR (566)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:567> Error decoding subfield MNC3\n");
		ED_HANDLE_IE_SYNTAX_ERROR (567)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:568> Error decoding subfield MCC3\n");
		ED_HANDLE_IE_SYNTAX_ERROR (568)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:569> Error decoding subfield MNC2\n");
		ED_HANDLE_IE_SYNTAX_ERROR (569)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:570> Error decoding subfield MNC1\n");
		ED_HANDLE_IE_SYNTAX_ERROR (570)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:571> Error decoding subfield LAC\n");
		ED_HANDLE_IE_SYNTAX_ERROR (571)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:572> Error encoding subfield spare1\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:573> Error encoding subfield RevisionLevel\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:574> Error encoding subfield EsInd\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:575> Error encoding subfield A5_1\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:576> Error encoding subfield RFPowerCapability\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:577> Error encoding subfield spare2\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:578> Error encoding subfield PSCapability\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:579> Error encoding subfield SSScreenIndicator\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:580> Error encoding subfield SMCapability\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:581> Error encoding subfield VBS\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:582> Error encoding subfield VGCS\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:583> Error encoding subfield FC\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:584> Error encoding subfield CM3\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:585> Error encoding subfield spare3\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:586> Error encoding subfield LCSVA_CAP\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:587> Error encoding subfield UCS2\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:588> Error encoding subfield SoLSA\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:589> Error encoding subfield CMSP\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:590> Error encoding subfield A5_3\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:591> Error encoding subfield A5_2\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:592> Error decoding subfield spare1\n");
		ED_HANDLE_IE_SYNTAX_ERROR (592)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:593> Error decoding subfield RevisionLevel\n");
		ED_HANDLE_IE_SYNTAX_ERROR (593)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:594> Error decoding subfield EsInd\n");
		ED_HANDLE_IE_SYNTAX_ERROR (594)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:595> Error decoding subfield A5_1\n");
		ED_HANDLE_IE_SYNTAX_ERROR (595)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:596> Error decoding subfield RFPowerCapability\n");
		ED_HANDLE_IE_SYNTAX_ERROR (596)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:597> Error decoding subfield spare2\n");
		ED_HANDLE_IE_SYNTAX_ERROR (597)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:598> Error decoding subfield PSCapability\n");
		ED_HANDLE_IE_SYNTAX_ERROR (598)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:599> Error decoding subfield SSScreenIndicator\n");
		ED_HANDLE_IE_SYNTAX_ERROR (599)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:600> Error decoding subfield SMCapability\n");
		ED_HANDLE_IE_SYNTAX_ERROR (600)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:601> Error decoding subfield VBS\n");
		ED_HANDLE_IE_SYNTAX_ERROR (601)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:602> Error decoding subfield VGCS\n");
		ED_HANDLE_IE_SYNTAX_ERROR (602)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:603> Error decoding subfield FC\n");
		ED_HANDLE_IE_SYNTAX_ERROR (603)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:604> Error decoding subfield CM3\n");
		ED_HANDLE_IE_SYNTAX_ERROR (604)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:605> Error decoding subfield spare3\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:606> Error decoding subfield LCSVA_CAP\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:607> Error decoding subfield UCS2\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:608> Error decoding subfield SoLSA\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:609> Error decoding subfield CMSP\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:610> Error decoding subfield A5_3\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:611> Error decoding subfield A5_2\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:612> Error encoding subfield MCC2\n");
		return -1;
	} 
#endif
	EDIntToBits (Buffer, CurrOfs+4, (*Source).MCC1, 4);
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:613> Error encoding subfield MCC1\n");
		return -1;
	} 
#endif
	EDIntToBits (Buffer, CurrOfs+8, (*Source).MNC3, 4);
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:614> Error encoding subfield MNC3\n");
		return -1;
	} 
#endif
	EDIntToBits (Buffer, CurrOfs+12, (*Source).MCC3, 4);
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:615> Error encoding subfield MCC3\n");
		return -1;
	} 
#endif
	EDIntToBits (Buffer, CurrOfs+16, (*Source).MNC2, 4);
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:616> Error encoding subfield MNC2\n");
		return -1;
	} 
#endif
	EDIntToBits (Buffer, CurrOfs+20, (*Source).MNC1, 4);
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:617> Error encoding subfield MNC1\n");
		return -1;
	} 
#endif
	EDIntToBits (Buffer, CurrOfs+24, (*Source).LAC, 16);
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:618> Error encoding subfield LAC\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:619> Error encoding subfield RAC\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:620> Error decoding subfield MCC2\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:621> Error decoding subfield MCC1\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:622> Error decoding subfield MNC3\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:623> Error decoding subfield MCC3\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:624> Error decoding subfield MNC2\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:625> Error decoding subfield MNC1\n");
		ED_HANDLE_IE_SYNTAX_ERROR (625)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:626> Error decoding subfield LAC\n");
		ED_HANDLE_IE_SYNTAX_ERROR (626)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:627> Error decoding subfield RAC\n");
		ED_HANDLE_IE_SYNTAX_ERROR (627)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:628> Error encoding subfield KeySequence\n");
		return -1;
	} 
#endif
	EDIntToBits (Buffer, CurrOfs, 0, 1);Ret = 1;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:629> Error encoding subfield spare\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:630> Error decoding subfield KeySequence\n");
		ED_HANDLE_IE_SYNTAX_ERROR (630)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:631> Error decoding subfield spare\n");
		ED_HANDLE_IE_SYNTAX_ERROR (631)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:632> Error encoding subfield BCCHArfcnHi\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:633> Error encoding subfield NCC\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:634> Error encoding subfield BCC\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:635> Error encoding subfield BCCHArfcnLo\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:636> Error decoding subfield BCCHArfcnHi\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:637> Error decoding subfield NCC\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:638> Error decoding subfield BCC\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:639> Error decoding subfield BCCHArfcnLo\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:640> Error encoding subfield spare\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:641> Error encoding subfield PWRC\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:642> Error encoding subfield DTX\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:643> Error encoding subfield RadioLinkTimeout\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:645> Error decoding subfield PWRC\n");
		ED_HANDLE_IE_SYNTAX_ERROR (645)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:646> Error decoding subfield DTX\n");
		ED_HANDLE_IE_SYNTAX_ERROR (646)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:647> Error decoding subfield RadioLinkTimeout\n");
		ED_HANDLE_IE_SYNTAX_ERROR (647)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:648> Error encoding subfield DTXbit8\n");
		return -1;
	} 
#endif
	EDIntToBits (Buffer, CurrOfs+1, ((*Source).PWRC != 0 ? 1 : 0), 1);Ret = 1;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:649> Error encoding subfield PWRC\n");
		return -1;
	} 
#endif
	EDIntToBits (Buffer, CurrOfs+2, (*Source).DTX, 2);
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:650> Error encoding subfield DTX\n");
		return -1;
	} 
#endif
	EDIntToBits (Buffer, CurrOfs+4, (*Source).RadioLinkTimeout, 4);
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:651> Error encoding subfield RadioLinkTimeout\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:652> Error decoding subfield DTXbit8\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:653> Error decoding subfield PWRC\n");
		ED_HANDLE_IE_SYNTAX_ERROR (653)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:654> Error decoding subfield DTX\n");
		ED_HANDLE_IE_SYNTAX_ERROR (654)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:655> Error decoding subfield RadioLinkTimeout\n");
		ED_HANDLE_IE_SYNTAX_ERROR (655)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:656> Error encoding subfield CellReseHyst\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:657> Error encoding subfield MsTxpwrMaxCch\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:658> Error encoding subfield ACS\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:659> Error encoding subfield NECI\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:660> Error encoding subfield RxLevAccessMin\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:661> Error decoding subfield CellReseHyst\n");
		ED_HANDLE_IE_SYNTAX_ERROR (661)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:662> Error decoding subfield MsTxpwrMaxCch\n");
		ED_HANDLE_IE_SYNTAX_ERROR (662)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:663> Error decoding subfield ACS\n");
		ED_HANDLE_IE_SYNTAX_ERROR (663)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:664> Error decoding subfield NECI\n");
		ED_HANDLE_IE_SYNTAX_ERROR (664)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:665> Error decoding subfield RxLevAccessMin\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:666> Error encoding subfield Mac0Mode\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:667> Error encoding subfield CS\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:668> Error decoding subfield Mac0Mode\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:669> Error decoding subfield CS\n");
		ED_HANDLE_IE_SYNTAX_ERROR (669)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:670> Error encoding subfield ChType\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:671> Error encoding subfield TN\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:672> Error encoding subfield TSC\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:673> Error encoding subfield H\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Ret < 0) {
			ED_SIGNAL_ERROR ("<ERRID:674> Error encoding subfield MAIO\n");
			return -1;
		} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Ret < 0) {
			ED_SIGNAL_ERROR ("<ERRID:675> Error encoding subfield HSN\n");
			return -1;
		} 
#endif
	}
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Ret < 0) {
			ED_SIGNAL_ERROR ("<ERRID:676> Error encoding subfield spare\n");
			return -1;
		} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Ret < 0) {
			ED_SIGNAL_ERROR ("<ERRID:677> Error encoding subfield ARFCN\n");
			return -1;
		} 
#endif
	}
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:678> Error decoding subfield ChType\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:679> Error decoding subfield TN\n");
		ED_HANDLE_IE_SYNTAX_ERROR (679)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:680> Error decoding subfield TSC\n");
		ED_HANDLE_IE_SYNTAX_ERROR (680)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:681> Error decoding subfield H\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Ret < 0) {
			ED_SIGNAL_ERROR ("<ERRID:682> Error decoding subfield MAIO\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:683> Error decoding subfield HSN\n");
		ED_HANDLE_IE_SYNTAX_ERROR (683)
	} 
#endif
	Len += Ret;
	}/* FINE */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Ret < 0) {
			ED_SIGNAL_ERROR ("<ERRID:684> Error decoding subfield spare\n");
			ED_HANDLE_IE_SYNTAX_ERROR (684)
		} 
#endif
		Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:685> Error decoding subfield ARFCN\n");
		ED_HANDLE_IE_SYNTAX_ERROR (685)
	} 
#endif
	Len += Ret;
	}/* FINE */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:686> Error encoding subfield ClassmarkChange\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:687> Error encoding subfield UTRANClassmarkChange\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:688> Error encoding subfield CDMAClassmarkChange\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:690> Error decoding subfield ClassmarkChange\n");
		ED_HANDLE_IE_SYNTAX_ERROR (690)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:691> Error decoding subfield UTRANClassmarkChange\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:692> Error decoding subfield CDMAClassmarkChange\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:693> Error decoding subfield spare\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:694> Error encoding subfield Channel1\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:695> Error encoding subfield Channel2\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:696> Error decoding subfield Channel1\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:697> Error decoding subfield Channel2\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:698> Error encoding subfield MTMO\n");
		return -1;
	} 
#endif
#define ED_IS_ENCODING
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Ret < 0) {
			ED_SIGNAL_ERROR ("<ERRID:699> Error encoding subfield spare\n");
			return -1;
		} 
#endif
	}
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Ret < 0) {
			ED_SIGNAL_ERROR ("<ERRID:700> Error encoding subfield spare2\n");
			return -1;
		} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Ret < 0) {
			ED_SIGNAL_ERROR ("<ERRID:701> Error encoding subfield Priority\n");
			return -1;
		} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Ret < 0) {
			ED_SIGNAL_ERROR ("<ERRID:702> Error encoding subfield RLCMode\n");
			return -1;
		} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Ret < 0) {
			ED_SIGNAL_ERROR ("<ERRID:703> Error encoding subfield LLCFramType\n");
			return -1;
		} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Ret < 0) {
			ED_SIGNAL_ERROR ("<ERRID:704> Error encoding subfield ReqBandwidth\n");
			return -1;
		} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Ret < 0) {
			ED_SIGNAL_ERROR ("<ERRID:705> Error encoding subfield RLCOctetCount\n");
			return -1;
		} 
#endif
	}
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:706> Error decoding subfield MTMO\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Ret < 0) {
			ED_SIGNAL_ERROR ("<ERRID:707> Error decoding subfield spare\n");
			ED_HANDLE_IE_SYNTAX_ERROR (707)
		} 
#endif
		Len += Ret;
	}/* FINE */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Ret < 0) {
			ED_SIGNAL_ERROR ("<ERRID:708> Error decoding subfield spare2\n");
			ED_HANDLE_IE_SYNTAX_ERROR (708)
		} 
#endif
		Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:709> Error decoding subfield Priority\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:710> Error decoding subfield RLCMode\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:711> Error decoding subfield LLCFramType\n");
		ED_HANDLE_IE_SYNTAX_ERROR (711)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:712> Error decoding subfield ReqBandwidth\n");
		ED_HANDLE_IE_SYNTAX_ERROR (712)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:713> Error decoding subfield RLCOctetCount\n");
		ED_HANDLE_IE_SYNTAX_ERROR (713)
	} 
#endif
	Len += Ret;
	}/* FINE */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:714> Error encoding subfield SC\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:715> Error encoding subfield AlgIdent\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:716> Error decoding subfield SC\n");
		ED_HANDLE_IE_SYNTAX_ERROR (716)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:717> Error decoding subfield AlgIdent\n");
		ED_HANDLE_IE_SYNTAX_ERROR (717)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:718> Error encoding subfield CR\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:719> Error encoding subfield spare\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:720> Error decoding subfield CR\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:721> Error decoding subfield spare\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:722> Error encoding subfield MSCR\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:723> Error encoding subfield ATT\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:724> Error encoding subfield BsAgBlksRes\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:725> Error encoding subfield CCCHConf\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:726> Error encoding subfield spare\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:727> Error encoding subfield BsPaMfrms\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:728> Error encoding subfield T3212TimeOutValue\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:729> Error decoding subfield MSCR\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:730> Error decoding subfield ATT\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:731> Error decoding subfield BsAgBlksRes\n");
		ED_HANDLE_IE_SYNTAX_ERROR (731)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:732> Error decoding subfield CCCHConf\n");
		ED_HANDLE_IE_SYNTAX_ERROR (732)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:733> Error decoding subfield spare\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:734> Error decoding subfield BsPaMfrms\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:735> Error decoding subfield T3212TimeOutValue\n");
		ED_HANDLE_IE_SYNTAX_ERROR (735)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:736> Error encoding subfield spare\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:737> Error encoding subfield LowestARFCN\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:738> Error encoding subfield IncSkipOfARFCN\n");
		return -1;
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:739> Error decoding subfield spare\n");
		ED_HANDLE_IE_SYNTAX_ERROR (739)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:740> Error decoding subfield LowestARFCN\n");
		ED_HANDLE_IE_SYNTAX_ERROR (740)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:741> Error decoding subfield IncSkipOfARFCN\n");
		ED_HANDLE_IE_SYNTAX_ERROR (741)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:742> Error encoding subfield ChType\n");
		return -1;
	} 
#endif
	EDIntToBits (Buffer, CurrOfs+5, (*Source).TN, 3);
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:743> Error encoding subfield TN\n");
		return -1;
	} 
#endif
	EDIntToBits (Buffer, CurrOfs+8, (*Source).TSC, 3);
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:744> Error encoding subfield TSC\n");
		return -1;
	} 
#endif
	EDIntToBits (Buffer, CurrOfs+11, ((*Source).H != 0 ? 1 : 0), 1);Ret = 1;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:745> Error encoding subfield H\n");
		return -1;
	} 
#endif
#define ED_IS_ENCODING
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Ret < 0) {
			ED_SIGNAL_ERROR ("<ERRID:746> Error encoding subfield MAIO\n");
			return -1;
		} 
#endif
		EDIntToBits (Buffer, CurrOfs+18, (*Source).HSN, 6);
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Ret < 0) {
			ED_SIGNAL_ERROR ("<ERRID:747> Error encoding subfield HSN\n");
			return -1;
		} 
#endif
	}
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Ret < 0) {
			ED_SIGNAL_ERROR ("<ERRID:748> Error encoding subfield spare\n");
			return -1;
		} 
#endif
		EDIntToBits (Buffer, CurrOfs+14, (*Source).ARFCN, 10);
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Ret < 0) {
			ED_SIGNAL_ERROR ("<ERRID:749> Error encoding subfield ARFCN\n");
			return -1;
		} 
#endif
	}
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:750> Error encoding subfield MA\n");
		return -1;
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:751> Error decoding subfield ChType\n");
		ED_HANDLE_IE_SYNTAX_ERROR (751)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:752> Error decoding subfield TN\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:753> Error decoding subfield TSC\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:754> Error decoding subfield H\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Ret < 0) {
			ED_SIGNAL_ERROR ("<ERRID:755> Error decoding subfield MAIO\n");
			ED_HANDLE_IE_SYNTAX_ERROR (755)
		} 
#endif
		Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:756> Error decoding subfield HSN\n");
		ED_HANDLE_IE_SYNTAX_ERROR (756)
	} 
#endif
	Len += Ret;
	}/* FINE */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (Ret < 0) {
			ED_SIGNAL_ERROR ("<ERRID:757> Error decoding subfield spare\n");
			ED_HANDLE_IE_SYNTAX_ERROR (757)
		} 
#endif
		Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:758> Error decoding subfield ARFCN\n");
		ED_HANDLE_IE_SYNTAX_ERROR (758)
	} 
#endif
	Len += Ret;
	}/* FINE */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:759> Error decoding subfield MA\n");
		ED_HANDLE_IE_SYNTAX_ERROR (759)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:760> Error encoding subfield ACK\n");
		return -1;
	} 
#endif
	EDIntToBits (Buffer, CurrOfs, 0, 3);Ret = 3;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:762> Error decoding subfield ACK\n");
		ED_HANDLE_IE_SYNTAX_ERROR (762)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:763> Error decoding subfield spare\n");
		ED_HANDLE_IE_SYNTAX_ERROR (763)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:764> Error encoding subfield BSICNCell\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:765> Error encoding subfield BCCHFreqNCell\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:766> Error encoding subfield RXLevNCell\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:767> Error decoding subfield BSICNCell\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:768> Error decoding subfield BCCHFreqNCell\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:769> Error decoding subfield RXLevNCell\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:770> Error encoding subfield BAUsed\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:771> Error encoding subfield DTXUsed\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:772> Error encoding subfield RXLevFullServingCell\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:773> Error encoding subfield _3G_BA_USED\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:774> Error encoding subfield MeasValid\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:775> Error encoding subfield RXLevSubServingCell\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:776> Error encoding subfield spare2\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:777> Error encoding subfield RXQualFullServingCell\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:778> Error encoding subfield RXQualSubServingCell\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:779> Error encoding subfield NoNcellM\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:780> Error encoding subfield Measurements\n");
		return -1;
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:781> Error decoding subfield BAUsed\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:782> Error decoding subfield DTXUsed\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:783> Error decoding subfield RXLevFullServingCell\n");
		ED_HANDLE_IE_SYNTAX_ERROR (783)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:784> Error decoding subfield _3G_BA_USED\n");
		ED_HANDLE_IE_SYNTAX_ERROR (784)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:785> Error decoding subfield MeasValid\n");
		ED_HANDLE_IE_SYNTAX_ERROR (785)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:786> Error decoding subfield RXLevSubServingCell\n");
		ED_HANDLE_IE_SYNTAX_ERROR (786)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:787> Error decoding subfield spare2\n");
		ED_HANDLE_IE_SYNTAX_ERROR (787)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:788> Error decoding subfield RXQualFullServingCell\n");
		ED_HANDLE_IE_SYNTAX_ERROR (788)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:789> Error decoding subfield RXQualSubServingCell\n");
		ED_HANDLE_IE_SYNTAX_ERROR (789)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:790> Error decoding subfield NoNcellM\n");
		ED_HANDLE_IE_SYNTAX_ERROR (790)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:791> Error decoding subfield Measurements\n");
		ED_HANDLE_IE_SYNTAX_ERROR (791)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:792> Error encoding subfield C_VALUE\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:793> Error encoding subfield RXQUAL\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:794> Error encoding subfield spare\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:795> Error encoding subfield SIGN_VAR\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:796> Error decoding subfield C_VALUE\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:797> Error decoding subfield RXQUAL\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:798> Error decoding subfield spare\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:799> Error decoding subfield SIGN_VAR\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:800> Error encoding subfield MobileTimeDiff\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:801> Error encoding subfield spare\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:802> Error decoding subfield MobileTimeDiff\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:803> Error decoding subfield spare\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:804> Error encoding subfield TD\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:805> Error encoding subfield Downlink\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:806> Error encoding subfield TMA\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:808> Error encoding subfield DedicatedMode\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:809> Error decoding subfield TD\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:810> Error decoding subfield Downlink\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:811> Error decoding subfield TMA\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:812> Error decoding subfield spare\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:813> Error decoding subfield DedicatedMode\n");
		ED_HANDLE_IE_SYNTAX_ERROR (813)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:815> Error encoding subfield TD\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:816> Error encoding subfield Downlink\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:817> Error encoding subfield TMA\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:818> Error decoding subfield spare\n");
		ED_HANDLE_IE_SYNTAX_ERROR (818)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:819> Error decoding subfield TD\n");
		ED_HANDLE_IE_SYNTAX_ERROR (819)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:820> Error decoding subfield Downlink\n");
		ED_HANDLE_IE_SYNTAX_ERROR (820)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:821> Error decoding subfield TMA\n");
		ED_HANDLE_IE_SYNTAX_ERROR (821)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:822> Error encoding subfield PM\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:823> Error encoding subfield spare\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:824> Error decoding subfield PM\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:826> Error encoding subfield spare\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:827> Error encoding subfield PowerLevel\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:828> Error decoding subfield spare\n");
		ED_HANDLE_IE_SYNTAX_ERROR (828)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:829> Error decoding subfield PowerLevel\n");
		ED_HANDLE_IE_SYNTAX_ERROR (829)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:830> Error encoding subfield ATC\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:831> Error encoding subfield spare\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:832> Error encoding subfield FPC\n");
		return -1;
	} 
#endif
	EDIntToBits (Buffer, CurrOfs+3, (*Source).PowerLevel, 5);
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:833> Error encoding subfield PowerLevel\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:834> Error decoding subfield ATC\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:835> Error decoding subfield spare\n");
		ED_HANDLE_IE_SYNTAX_ERROR (835)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:836> Error decoding subfield FPC\n");
		ED_HANDLE_IE_SYNTAX_ERROR (836)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:837> Error decoding subfield PowerLevel\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:838> Error encoding subfield MaxRetrans\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:839> Error encoding subfield Tx\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:840> Error encoding subfield CellBarrAccess\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:841> Error encoding subfield RE\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:842> Error encoding subfield AC_C15\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:843> Error encoding subfield AC_C14\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:844> Error encoding subfield AC_C13\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:845> Error encoding subfield AC_C12\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:846> Error encoding subfield AC_C11\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:847> Error encoding subfield EC_C10\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:848> Error encoding subfield AC_C09\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:849> Error encoding subfield AC_C08\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:850> Error encoding subfield AC_C07\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:851> Error encoding subfield AC_C06\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:852> Error encoding subfield AC_C05\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:853> Error encoding subfield AC_C04\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:854> Error encoding subfield AC_C03\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:855> Error encoding subfield AC_C02\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:856> Error encoding subfield AC_C01\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:857> Error encoding subfield AC_C00\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:858> Error decoding subfield MaxRetrans\n");
		ED_HANDLE_IE_SYNTAX_ERROR (858)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:859> Error decoding subfield Tx\n");
		ED_HANDLE_IE_SYNTAX_ERROR (859)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:860> Error decoding subfield CellBarrAccess\n");
		ED_HANDLE_IE_SYNTAX_ERROR (860)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:861> Error decoding subfield RE\n");
		ED_HANDLE_IE_SYNTAX_ERROR (861)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:862> Error decoding subfield AC_C15\n");
		ED_HANDLE_IE_SYNTAX_ERROR (862)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:863> Error decoding subfield AC_C14\n");
		ED_HANDLE_IE_SYNTAX_ERROR (863)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:864> Error decoding subfield AC_C13\n");
		ED_HANDLE_IE_SYNTAX_ERROR (864)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:865> Error decoding subfield AC_C12\n");
		ED_HANDLE_IE_SYNTAX_ERROR (865)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:866> Error decoding subfield AC_C11\n");
		ED_HANDLE_IE_SYNTAX_ERROR (866)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:867> Error decoding subfield EC_C10\n");
		ED_HANDLE_IE_SYNTAX_ERROR (867)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:868> Error decoding subfield AC_C09\n");
		ED_HANDLE_IE_SYNTAX_ERROR (868)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:869> Error decoding subfield AC_C08\n");
		ED_HANDLE_IE_SYNTAX_ERROR (869)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:870> Error decoding subfield AC_C07\n");
		ED_HANDLE_IE_SYNTAX_ERROR (870)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:871> Error decoding subfield AC_C06\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:872> Error decoding subfield AC_C05\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:873> Error decoding subfield AC_C04\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:874> Error decoding subfield AC_C03\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:875> Error decoding subfield AC_C02\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:876> Error decoding subfield AC_C01\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:877> Error decoding subfield AC_C00\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:878> Error encoding subfield RA\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:879> Error encoding subfield T1\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:880> Error encoding subfield T3\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:881> Error encoding subfield T2\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:882> Error decoding subfield RA\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:883> Error decoding subfield T1\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:884> Error decoding subfield T3\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:885> Error decoding subfield T2\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:886> Error encoding subfield T1\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:887> Error encoding subfield T3\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:888> Error encoding subfield T2\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:889> Error decoding subfield T1\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:890> Error decoding subfield T3\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:891> Error decoding subfield T2\n");
		ED_HANDLE_IE_SYNTAX_ERROR (891)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:892> Error encoding subfield NCI\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:893> Error encoding subfield ROT\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:894> Error encoding subfield SI\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:895> Error decoding subfield NCI\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:896> Error decoding subfield ROT\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:897> Error decoding subfield SI\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:898> Error encoding subfield spare\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:899> Error encoding subfield value\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:900> Error decoding subfield spare\n");
		ED_HANDLE_IE_SYNTAX_ERROR (900)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:901> Error decoding subfield value\n");
		ED_HANDLE_IE_SYNTAX_ERROR (901)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:902> Error encoding subfield TargetMode\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:903> Error encoding subfield GroupCipherKeyNumber\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:904> Error encoding subfield spare\n");
		return -1;
	} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:905> Error decoding subfield TargetMode\n");
		ED_HANDLE_IE_SYNTAX_ERROR (905)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:906> Error decoding subfield GroupCipherKeyNumber\n");
		ED_HANDLE_IE_SYNTAX_ERROR (906)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (Ret < 0) {
		ED_SIGNAL_ERROR ("<ERRID:907> Error decoding subfield spare\n");
		ED_HANDLE_IE_SYNTAX_ERROR (907)
	} 
#endif
	Len += Ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (length < 0) {
			ED_SIGNAL_ERROR ("<ERRID:908> Error encoding sequence IncSkipOfARFCN\n");
			return -1;
		} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (ret < 0) {
			ED_SIGNAL_ERROR ("<ERRID:909> Error decoding sequence IncSkipOfARFCN\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (length < 0) {
			ED_SIGNAL_ERROR ("<ERRID:910> Error encoding sequence GrpChannelMA\n");
			return -1;
		} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (ret < 0) {
			ED_SIGNAL_ERROR ("<ERRID:911> Error decoding sequence GrpChannelMA\n");
			ED_HANDLE_IE_SYNTAX_ERROR (911)
		} 
#endif
		len += ret;
		CurrOfs += ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (length < 0) {
			ED_SIGNAL_ERROR ("<ERRID:912> Error encoding sequence MeasurementResultsList\n");
			return -1;
		} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (ret < 0) {
			ED_SIGNAL_ERROR ("<ERRID:913> Error decoding sequence MeasurementResultsList\n");
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (length < 0) {
			ED_SIGNAL_ERROR ("<ERRID:914> Error encoding sequence MobileAllocation\n");
			return -1;
		} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (ret < 0) {
			ED_SIGNAL_ERROR ("<ERRID:915> Error decoding sequence MobileAllocation\n");
			ED_HANDLE_IE_SYNTAX_ERROR (915)
		} 
#endif
		len += ret;
		CurrOfs += ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (length < 0) {
			ED_SIGNAL_ERROR ("<ERRID:916> Error encoding sequence NeighbourCellDescription\n");
			return -1;
		} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (ret < 0) {
			ED_SIGNAL_ERROR ("<ERRID:917> Error decoding sequence NeighbourCellDescription\n");
			ED_HANDLE_IE_SYNTAX_ERROR (917)
		} 
#endif
		len += ret;
		CurrOfs += ret;
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (length < 0) {
			ED_SIGNAL_ERROR ("<ERRID:918> Error encoding sequence NeighbourCellDescription2\n");
			return -1;
		} 
#endif
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
		if (ret < 0) {
			ED_SIGNAL_ERROR ("<ERRID:919> Error decoding sequence NeighbourCellDescription2\n");
