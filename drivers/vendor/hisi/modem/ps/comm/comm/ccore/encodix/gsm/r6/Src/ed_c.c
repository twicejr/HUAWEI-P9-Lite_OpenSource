...
/* SETITEMS commands for type 'c_Packet_Cell_Change_Order_message_content_GSM_target_cell_LSA_Parameters_LSA_ID_information'. Existing items are not changed. */
void SETITEMS_c_Packet_Cell_Change_Order_message_content_GSM_target_cell_LSA_Parameters_LSA_ID_information (c_Packet_Cell_Change_Order_message_content_GSM_target_cell_LSA_Parameters_LSA_ID_information* sequence, int desiredItems)
{
	int i;
	if (desiredItems > sequence->items) {
		for (i=sequence->items; i<desiredItems; i++) {
...
/* SETITEMS commands for type 'c_Packet_Cell_Change_Order_message_content_GSM_target_cell_LSA_Parameters_LSA_ID_information_data_LSA_ID'. Existing items are not changed. */
void SETITEMS_c_Packet_Cell_Change_Order_message_content_GSM_target_cell_LSA_Parameters_LSA_ID_information_data_LSA_ID (c_Packet_Cell_Change_Order_message_content_GSM_target_cell_LSA_Parameters_LSA_ID_information_data_LSA_ID* sequence, int desiredItems)
{
	int i;
	if (desiredItems > sequence->items) {
		for (i=sequence->items; i<desiredItems; i++) {
...
/* SETITEMS commands for type 'c_Packet_Cell_Change_Order_message_content_GSM_target_cell_LSA_Parameters_LSA_ID_information_data_ShortLSA_ID'. Existing items are not changed. */
void SETITEMS_c_Packet_Cell_Change_Order_message_content_GSM_target_cell_LSA_Parameters_LSA_ID_information_data_ShortLSA_ID (c_Packet_Cell_Change_Order_message_content_GSM_target_cell_LSA_Parameters_LSA_ID_information_data_ShortLSA_ID* sequence, int desiredItems)
{
	int i;
	if (desiredItems > sequence->items) {
		for (i=sequence->items; i<desiredItems; i++) {
...
void SETITEMS_c_Packet_Resource_Request_message_content_MS_Radio_Access_Capability_2_MS_RA_capability_Access_capabilities (c_Packet_Resource_Request_message_content_MS_Radio_Access_Capability_2_MS_RA_capability_Access_capabilities* sequence, int desiredItems)
{
	...
	if (desiredItems > sequence->items) {
		for (i=sequence->items; i<desiredItems; i++) {
			...
			(sequence->data[i].Access_capabilities.DTM_Enhancements_Capability) = 0;
			(sequence->data[i].Access_capabilities.Downlink_Advanced_Receiver_Performance) = 0;
			(sequence->data[i].Access_capabilities.ES_IND) = 0;
			(sequence->data[i].Access_capabilities.Extended_RLC_MAC_Control_Message_Segmentation_Capability) = 0;
			(sequence->data[i].Access_capabilities.GERAN_Feature_Package_1) = 0;
			(sequence->data[i].Access_capabilities.GMSK_Multislot_Power_Profile) = 0;
			(sequence->data[i].Access_capabilities.Modulation_based_multislot_class_support) = 0;
			(sequence->data[i].Access_capabilities.Multiple_TBF_Capability) = 0;
			(sequence->data[i].Access_capabilities.PS) = 0;
			(sequence->data[i].Access_capabilities.PS_Handover_Capability) = 0;
			(sequence->data[i].Access_capabilities.RF_Power_Capability) = 0;
			(sequence->data[i].Access_capabilities.Revision_Level_Indicator) = 0;
			(sequence->data[i].Access_capabilities.UMTS_1_28_Mcps_TDD_Radio_Access_Technology_Capability) = 0;
			...
			(sequence->data[i].Access_capabilities._8_PSK_Multislot_Power_Profile) = 0;
