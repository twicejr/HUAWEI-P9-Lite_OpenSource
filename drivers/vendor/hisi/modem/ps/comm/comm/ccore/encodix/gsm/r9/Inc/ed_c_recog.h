...
typedef enum {
	...
	ID_L3Uplink_EXTENDED_MEASUREMENT_REPORT,
...
typedef struct {
	...
	union {
		...
		c_RR_STATUS fld_c_RR_STATUS;
		c_EXTENDED_MEASUREMENT_REPORT fld_c_EXTENDED_MEASUREMENT_REPORT;
		c_APPLICATION_INFORMATION fld_c_APPLICATION_INFORMATION;
		char Dummy; /* Avoids empty unions! */
	} Data;
} TL3Uplink_Data;
...
typedef enum {
	...
	ID_PLENDownlink_SYSTEM_INFORMATION_TYPE_2N,
	...
	ID_PLENDownlink_EXTENDED_MEASUREMENT_ORDER
} TPLENDownlink_Type;
...
typedef struct {
	...
	union {
		...
		c_SYSTEM_INFORMATION_TYPE_2N fld_c_SYSTEM_INFORMATION_TYPE_2N;
		...
		c_EXTENDED_MEASUREMENT_ORDER fld_c_EXTENDED_MEASUREMENT_ORDER;
		char Dummy; /* Avoids empty unions! */
	} Data;
} TPLENDownlink_Data;
