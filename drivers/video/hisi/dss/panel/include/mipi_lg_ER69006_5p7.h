...
static char lcd_power_on_cmd3[] = {
	0xB4,
	0x0C, 0x00,
};

static char lcd_power_on_cmd4[] = {
	0xB6,
	0x3B, 0xD3, 0x00,
};

static char lcd_power_on_cmd5[] = {
	0xC1,
...
static char lcd_power_on_cmd6[] = {
	0xC2,
	0x01, 0xF7, 0x80, 0x84, 0x63,
	0x00, 0x60, 0x00, 0x11, 0x30,
};
static char lcd_power_on_cmd7[] = {
	0xC3,
	0x55, 0x01, 0x00, 0x01, 0x00,
	0x00,
};
static char lcd_power_on_cmd8[] = {
	0xC4,
...
static char lcd_power_on_cmd9[] = {
	0xC6,
	0x59, 0x07, 0x4A, 0x07, 0x4A,
	0x01, 0x0E, 0x01, 0x02, 0x01,
	0x02, 0x09, 0x15, 0x07,
};
static char lcd_power_on_cmd10[] = {
	0xC7,
...
static char lcd_power_on_cmd11[] = {
	0xC8,
...
static char lcd_power_on_cmd12[] = {
	0xC9,
	0x1F, 0x68, 0x1F, 0x68, 0x4C,
	0x4C, 0xC4, 0x11,
};
static char lcd_power_on_cmd13[] = {
	0xCB,
	0x9F, 0xFB, 0x73, 0x3E, 0x00,
	0x08, 0x00, 0x00, 0x00,
};
static char lcd_power_on_cmd14[] = {
	0xCC,
	0x06,
};
static char lcd_power_on_cmd15[] = {
	0xD0,
...
static char lcd_power_on_cmd16[] = {
	0xD3,
...
static char lcd_power_on_cmd17[] = {
	0xD4,
	0x57, 0x33, 0x03,
};
static char lcd_power_on_cmd18[] = {
	0xD6,
	0x01,
};
static char lcd_power_on_cmd19[] = {
	0xB0,
	0x03,
};
...
static struct dsi_cmd_desc lcd_display_on_cmd[] = {
	...
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lcd_power_on_cmd3), lcd_power_on_cmd3},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lcd_power_on_cmd4), lcd_power_on_cmd4},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lcd_power_on_cmd5), lcd_power_on_cmd5},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lcd_power_on_cmd6), lcd_power_on_cmd6},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lcd_power_on_cmd7), lcd_power_on_cmd7},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lcd_power_on_cmd8), lcd_power_on_cmd8},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lcd_power_on_cmd9), lcd_power_on_cmd9},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lcd_power_on_cmd10), lcd_power_on_cmd10},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lcd_power_on_cmd11), lcd_power_on_cmd11},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lcd_power_on_cmd12), lcd_power_on_cmd12},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lcd_power_on_cmd13), lcd_power_on_cmd13},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lcd_power_on_cmd14), lcd_power_on_cmd14},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lcd_power_on_cmd15), lcd_power_on_cmd15},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lcd_power_on_cmd16), lcd_power_on_cmd16},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lcd_power_on_cmd17), lcd_power_on_cmd17},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lcd_power_on_cmd18), lcd_power_on_cmd18},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lcd_power_on_cmd19), lcd_power_on_cmd19},
