...
#define DTS_COMP_BOE_ER69006_5P7 "hisilicon,mipi_boe_ER69006_5P7"
#define CABC_OFF	(0)
...
#define SUPPORT_COMFORM_MODE 1
#define SUPPORT_CINEMA_MODE 2
...
static char boe_power_on_cmd1[] = {
	0xD6,
	0x01,
};


static char boe_power_on_cmd2[] = {
	0xCB,
	0x3C, 0xFD, 0x2F, 0x0F, 0x00, 0x00, 0x00, 0x00, 0x00,
};
...
static char boe_pwm_freq[] = {
	0xCE,
	0x5D, 0x40, 0x43, 0x49, 0x55, 0x62, 0x71, 0x82,
	0x94, 0xA8, 0xB9, 0xCB, 0xDB, 0xE9, 0xF5, 0xFC,
	0xFF, 0x09, 0x19, 0x04, 0x04, 0x00, 0x00, 0x00,
};

static struct dsi_cmd_desc boe_display_on_cmds[] = {
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(manual_cmd_access_protect), manual_cmd_access_protect},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(boe_power_on_cmd1), boe_power_on_cmd1},
	...
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(boe_power_on_cmd2), boe_power_on_cmd2},
...
static struct dsi_cmd_desc boe_pwm_freq_cmd[] = {
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(boe_pwm_freq), boe_pwm_freq},
};
...
static struct dsi_cmd_desc boe_cabc_off_cmds[] = {
	{DTYPE_DCS_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(cabc_off), cabc_off},
};

static struct dsi_cmd_desc boe_cabc_ui_on_cmds[] = {
	{DTYPE_DCS_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(cabc_set_mode_UI), cabc_set_mode_UI},
};

static struct dsi_cmd_desc boe_cabc_still_on_cmds[] = {
	{DTYPE_DCS_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(cabc_set_mode_STILL), cabc_set_mode_STILL},
};

static struct dsi_cmd_desc boe_cabc_moving_on_cmds[] = {
	{DTYPE_DCS_LWRITE, 0, 10, WAIT_TYPE_US,
...
static u32 acm_lut_hue_table[] = {
	0x0000, 0x0001, 0x0002, 0x0004, 0x0005, 0x0006, 0x0007, 0x0009, 0x000a, 0x000b, 0x000c, 0x000e, 0x000f, 0x0010, 0x0011, 0x0013,
	0x0014, 0x0015, 0x0016, 0x0018, 0x0019, 0x001a, 0x001b, 0x001c, 0x001d, 0x001f, 0x0020, 0x0021, 0x0022, 0x0023, 0x0024, 0x0025,
	0x0026, 0x0028, 0x0029, 0x002a, 0x002b, 0x002c, 0x002d, 0x002e, 0x0030, 0x0031, 0x0032, 0x0033, 0x0034, 0x0035, 0x0036, 0x0037,
	0x0038, 0x0039, 0x003a, 0x003b, 0x003c, 0x003d, 0x003f, 0x0040, 0x0041, 0x0042, 0x0043, 0x0044, 0x0045, 0x0046, 0x0047, 0x0048,
	0x0049, 0x004a, 0x004b, 0x004c, 0x004d, 0x004e, 0x004f, 0x0050, 0x0051, 0x0052, 0x0053, 0x0055, 0x0056, 0x0057, 0x0058, 0x0059,
	0x005a, 0x005b, 0x005c, 0x005d, 0x005e, 0x005f, 0x0060, 0x0061, 0x0062, 0x0063, 0x0064, 0x0065, 0x0066, 0x0067, 0x0068, 0x0069,
static int mipi_boe_panel_on(struct platform_device *pdev)
{
	...
	if (pinfo->lcd_init_step == LCD_INIT_POWER_ON) {
		...
		mipi_dsi_cmds_tx(boe_display_on_cmds, \
			ARRAY_SIZE(boe_display_on_cmds), mipi_dsi0_base);

		// lcd display effect sequence
		mipi_dsi_cmds_tx(boe_pwm_freq_cmd, \
			ARRAY_SIZE(boe_pwm_freq_cmd), mipi_dsi0_base);
		if (pinfo->panel_effect_support) {
			mipi_dsi_cmds_tx(cabc_mode_paras, \
				ARRAY_SIZE(cabc_mode_paras), mipi_dsi0_base);

			mipi_dsi_cmds_tx(boe_cabc_ui_on_cmds, \
				ARRAY_SIZE(boe_cabc_ui_on_cmds), mipi_dsi0_base);
		}
...
static int mipi_boe_panel_off(struct platform_device *pdev)
{
	...
	if (pinfo->lcd_uninit_step == LCD_UNINIT_MIPI_HS_SEND_SEQUENCE) {
		...
		mipi_dsi_cmds_tx(boe_display_off_cmds, \
			ARRAY_SIZE(boe_display_off_cmds), hisifd->mipi_dsi0_base);
...
static ssize_t mipi_boe_panel_lcd_gram_check_show(struct platform_device *pdev, char *buf)
{
	ssize_t ret = 0;
...
static ssize_t mipi_boe_panel_lcd_gram_check_store(struct platform_device *pdev,
...
static int mipi_boe_panel_set_backlight(struct platform_device *pdev, uint32_t bl_level)
{
	int ret = 0;
	char __iomem *mipi_dsi0_base = NULL;
	struct hisi_fb_data_type *hisifd = NULL;
	...
	const char *buf, size_t count)
{
	...
	if (flag==CABC_OFF ){
              g_cabc_mode=0;
              mipi_dsi_cmds_tx(boe_cabc_off_cmds, \
                               ARRAY_SIZE(boe_cabc_off_cmds),\
                               mipi_dsi0_base);
	}else  if (flag==CABC_UI_MODE) {
              g_cabc_mode=1;
              mipi_dsi_cmds_tx(boe_cabc_ui_on_cmds, \
                               ARRAY_SIZE(boe_cabc_ui_on_cmds),\
                               mipi_dsi0_base);
	} else if (flag==CABC_STILL_MODE ){
              g_cabc_mode=2;
              mipi_dsi_cmds_tx(boe_cabc_still_on_cmds, \
                               ARRAY_SIZE(boe_cabc_still_on_cmds),\
                               mipi_dsi0_base);
	}else if (flag==CABC_MOVING_MODE ){
              g_cabc_mode=3;
              mipi_dsi_cmds_tx(boe_cabc_moving_on_cmds, \
                               ARRAY_SIZE(boe_cabc_moving_on_cmds),\
                               mipi_dsi0_base);
	}
...
static ssize_t mipi_boe_panel_lcd_check_reg_show(struct platform_device *pdev, char *buf)
{
	ssize_t ret = 0;
	struct hisi_fb_data_type *hisifd = NULL;
	char __iomem *mipi_dsi0_base = NULL;
...
static ssize_t mipi_boe_panel_lcd_mipi_detect_show(struct platform_device *pdev, char *buf)
{
	ssize_t ret = 0;
	struct hisi_fb_data_type *hisifd = NULL;
	char __iomem *mipi_dsi0_base = NULL;
...
static ssize_t mipi_boe_panel_lcd_sleep_ctrl_show(struct platform_device *pdev, char *buf)
{
	ssize_t ret = 0;
	struct hisi_fb_data_type *hisifd = NULL;
...
static ssize_t mipi_boe_panel_lcd_sleep_ctrl_store(struct platform_device *pdev, const char *buf, size_t count)
{
	ssize_t ret = 0;
	unsigned long val = 0;
	struct hisi_fb_data_type *hisifd = NULL;
...
static ssize_t mipi_boe_panel_lcd_test_config_show(struct platform_device *pdev,
	char *buf)
{
	if (!strncmp(lcd_cmd_now, "LCD_INCOME0", strlen("LCD_INCOME0")) || /* incoming sence0 config */
		...
		return snprintf(buf, PAGE_SIZE, "CHECKSUM");
		...
		return snprintf(buf, PAGE_SIZE, "/sys/class/ina231/ina231_0/ina231_set,"
										...
										"1,9999999,1,9999999,1,99999");//vol_min,vol_max,power_min,power_max,curr_min,curr_max
...
static ssize_t mipi_boe_panel_lcd_test_config_store(struct platform_device *pdev,
	const char *buf, size_t count)
{
	struct hisi_fb_data_type *hisifd = NULL;
	char __iomem *mipi_dsi0_base = NULL;
...
static ssize_t mipi_boe_panel_info_show(struct platform_device *pdev, char *buf)
{
	struct hisi_fb_data_type *hisifd = NULL;
	ssize_t ret = 0;
...
static struct hisi_fb_panel_data g_panel_data = {
	...
	.lcd_mipi_detect = mipi_boe_panel_lcd_mipi_detect_show,
	.lcd_hkadc_debug_show = NULL,
	.lcd_hkadc_debug_store = NULL,
	.lcd_gram_check_show = mipi_boe_panel_lcd_gram_check_show,
	.lcd_gram_check_store = mipi_boe_panel_lcd_gram_check_store,
	.set_display_region = mipi_boe_panel_set_display_region,
	.lcd_sleep_ctrl_show = mipi_boe_panel_lcd_sleep_ctrl_show,
	.lcd_sleep_ctrl_store = mipi_boe_panel_lcd_sleep_ctrl_store,
	.esd_handle = mipi_boe_panel_check_esd,
	.lcd_test_config_show = mipi_boe_panel_lcd_test_config_show,
	.lcd_test_config_store = mipi_boe_panel_lcd_test_config_store,
	.lcd_support_mode_show = mipi_boe_panel_lcd_support_mode_show,
	.lcd_support_mode_store = mipi_boe_panel_lcd_support_mode_store,
	.panel_info_show = mipi_boe_panel_info_show,
};
...
static int mipi_boe_probe(struct platform_device *pdev)
{
	...
	if (pinfo->acm_support == 1) {
		...
		pinfo->cinema_acm_lut_hue_table_len = ARRAY_SIZE(cinema_acm_lut_hue_table);
		pinfo->cinema_acm_lut_sata_table = cinema_acm_lut_sata_table;
		pinfo->cinema_acm_lut_sata_table_len = ARRAY_SIZE(cinema_acm_lut_sata_table);
		pinfo->cinema_acm_lut_satr_table = cinema_acm_lut_satr_table;
		pinfo->cinema_acm_lut_satr_table_len = ARRAY_SIZE(cinema_acm_lut_satr_table);
	...
	if (pinfo->gamma_support == 1) {
		...
		pinfo->cinema_gamma_lut_table_len = ARRAY_SIZE(cinema_gamma_lut_table_R);
	...
	if(pinfo->comform_mode_support == 1){
		support_mode = (support_mode | SUPPORT_COMFORM_MODE);
	}
	if(pinfo->cinema_mode_support == 1){
		support_mode = (support_mode | SUPPORT_CINEMA_MODE);
	}
