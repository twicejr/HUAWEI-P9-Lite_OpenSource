...
#include "include/mipi_jdi_R63450_5p7.h"
	...
	char *buf)
{
	...
	ret = snprintf(buf, PAGE_SIZE, "jdi_R63450_WQHD 5.7' CMD TFT\n");
...
static int mipi_lcd_probe(struct platform_device *pdev)
{
	...
	*/
	...
	pinfo->dirty_region_info.w_min = 1008;
...
static const struct of_device_id hisi_panel_match_table[] = {
	{
		.compatible = DTS_COMP_JDI_R63450_5P7,
		.data = NULL,
	},
	{},
};
