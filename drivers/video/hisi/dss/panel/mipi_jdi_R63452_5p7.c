...
#include "include/mipi_jdi_R63452_5p7.h"
...
static int mipi_lcd_panel_on(struct platform_device *pdev)
{
	...
	static struct lcd_reg_read_t lcd_status_reg[] = {
		...
		{0x0A, 0x38, 0xFF, "lcd power state", true},
	...
	char *buf)
{
	...
	ret = snprintf(buf, PAGE_SIZE, "jdi_R63452 5.7' CMD TFT\n");
...
static int mipi_lcd_probe(struct platform_device *pdev)
{
	...
	np = of_find_compatible_node(NULL, NULL, DTS_COMP_JDI_R63452_5P7);
	if (!np) {
		HISI_FB_ERR("NOT FOUND device node %s!\n", DTS_COMP_JDI_R63452_5P7);
		goto err_return;
	}
	...
	pinfo->bl_min = 63;
	/* 10000stage 6412,2048stage 1900 for 450nit */
	pinfo->bl_max = 6412;
	...
	pinfo->color_temp_rectify_R = 31837; /*97.16%percent*/
	pinfo->color_temp_rectify_G = 32768; /*100% percent*/
	pinfo->color_temp_rectify_B = 32709; /*99.82% percent*/
	g_led_rg_para1 = 6;
...
static const struct of_device_id hisi_panel_match_table[] = {
	{
		.compatible = DTS_COMP_JDI_R63452_5P7,
		.data = NULL,
	},
	{},
};
