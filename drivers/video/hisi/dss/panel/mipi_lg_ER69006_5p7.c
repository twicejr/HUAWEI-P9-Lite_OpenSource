...
#include "include/mipi_lg_ER69006_5p7.h"
...
static int mipi_lcd_panel_on(struct platform_device *pdev)
{
	...
	static struct lcd_reg_read_t check_reg_between_11_29[] = {
		{0x0A, 0x18, 0xFF, "lcd power 0x18 state"},
		{0x0A, 0x18, 0xFF, "lcd power 0x18 state",true},
		{0xAB, 0x00, 0xFF, "mipi_error_report",true},
	};
#endif
	...
	char *buf)
{
	...
	ret = snprintf(buf, PAGE_SIZE, "lg_eR69006_FHD 5.7' CMD TFT\n");
...
static int mipi_lcd_probe(struct platform_device *pdev)
{
	...
	pinfo->bl_min = 63;
	/* 10000stage 5942,2048stage 1875 for 450nit */
	pinfo->bl_max = 5924;
...
static const struct of_device_id hisi_panel_match_table[] = {
	{
		.compatible = DTS_COMP_LG_ER69006_FHD,
		.data = NULL,
	},
	{},
};
