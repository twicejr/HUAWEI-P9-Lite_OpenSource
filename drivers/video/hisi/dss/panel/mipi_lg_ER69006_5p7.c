...
static char lg_power_on_cmd2[] = {
	0xB3,
	0x04, 0x10, 0x00, 0x00, 0x00,
};

static char lg_power_on_cmd3[] = {
	0xB4,
	0x0C, 0x00,
};

static char lg_power_on_cmd4[] = {
	0xB6,
	0x3B, 0xD3, 0x00,
};

static char lg_power_on_cmd5[] = {
	0xC1,
	0x04, 0x00, 0x10, 0x8F, 0x4E,
	0x19, 0xFF, 0xAF, 0xC7, 0xFC,
	0xCA, 0x9A, 0x73, 0x8D, 0xFD,
	0x6F, 0x4E, 0xFD, 0x5F, 0x0C,
	0x52, 0x00, 0x00, 0xAA, 0x40,
	0x00, 0xC2, 0x11, 0x08, 0x00,
	0x01,
};

static char lg_power_on_cmd6[] = {
	0xC2,
	0x01, 0xF7, 0x80, 0x84, 0x63,
	0x00, 0x60, 0x00, 0x11, 0x30,
};
static char lg_power_on_cmd7[] = {
	0xC3,
	0x55, 0x01, 0x00, 0x01, 0x00,
	0x00,
};
static char lg_power_on_cmd8[] = {
	0xC4,
	0x70, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x02,
	0x01, 0x00, 0x05, 0x01, 0x00,
	0x00, 0x00,
};
static char lg_power_on_cmd9[] = {
	0xC6,
	0x59, 0x07, 0x4A, 0x07, 0x4A,
	0x01, 0x0E, 0x01, 0x02, 0x01,
	0x02, 0x09, 0x15, 0x07,
};
static char lg_power_on_cmd10[] = {
	0xC7,
	0x00, 0x12, 0x1E, 0x2C, 0x3A,
	0x47, 0x50, 0x5D, 0x3F, 0x47,
	0x51, 0x5F, 0x66, 0x6E, 0x7F,
	0x00, 0x12, 0x1E, 0x2C, 0x3A,
	0x47, 0x50, 0x5D, 0x3F, 0x47,
	0x51, 0x5F, 0x66, 0x6E, 0x7F,
};
static char lg_power_on_cmd11[] = {
	0xC8,
...
static char lg_power_on_cmd12[] = {
	0xC9,
	0x1F, 0x68, 0x1F, 0x68, 0x4C,
	0x4C, 0xC4, 0x11,
};
static char lg_power_on_cmd13[] = {
	0xCB,
	0x9F, 0xFB, 0x73, 0x3E, 0x00,
	0x08, 0x00, 0x00, 0x00,
};
static char lg_power_on_cmd14[] = {
	0xCC,
	0x06,
};
static char lg_power_on_cmd15[] = {
	0xD0,
	0x19, 0x01, 0x91, 0x0B, 0xD9,
	0x19, 0x19, 0x00, 0x00, 0x00,
	0x19, 0x99, 0x00, 0x00, 0x00,
	0x00,
};
static char lg_power_on_cmd16[] = {
	0xD3,
	0x1B, 0x3B, 0xBB, 0xAD, 0xA5,
	0x33, 0x33, 0x33, 0x00, 0x80,
	0xA4, 0xA6, 0x5B, 0x5B, 0x33,
	0x33, 0x33, 0xF7, 0xF2, 0x1F,
	0x7D, 0x7C, 0xFF, 0x0F, 0x99,
	0x00, 0xFF, 0xFF,
};
static char lg_power_on_cmd17[] = {
	0xD4,
	0x57, 0x33, 0x03,
};
static char lg_power_on_cmd18[] = {
	0xD6,
	0x01,
};
static char lg_power_on_cmd19[] = {
	0xB0,
	0x00,
};
...
static struct dsi_cmd_desc lg_display_on_cmds[] = {
	...
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lg_power_on_cmd2), lg_power_on_cmd2},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lg_power_on_cmd3), lg_power_on_cmd3},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lg_power_on_cmd4), lg_power_on_cmd4},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lg_power_on_cmd5), lg_power_on_cmd5},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lg_power_on_cmd6), lg_power_on_cmd6},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lg_power_on_cmd7), lg_power_on_cmd7},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lg_power_on_cmd8), lg_power_on_cmd8},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lg_power_on_cmd9), lg_power_on_cmd9},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lg_power_on_cmd10), lg_power_on_cmd10},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lg_power_on_cmd11), lg_power_on_cmd11},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lg_power_on_cmd12), lg_power_on_cmd12},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lg_power_on_cmd13), lg_power_on_cmd13},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lg_power_on_cmd14), lg_power_on_cmd14},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lg_power_on_cmd15), lg_power_on_cmd15},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lg_power_on_cmd16), lg_power_on_cmd16},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lg_power_on_cmd17), lg_power_on_cmd17},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lg_power_on_cmd18), lg_power_on_cmd18},
	{DTYPE_GEN_LWRITE, 0, 10, WAIT_TYPE_US,
		sizeof(lg_power_on_cmd19), lg_power_on_cmd19},
...
static ssize_t mipi_lg_panel_lcd_sleep_ctrl_store(struct platform_device *pdev, const char *buf, size_t count)
{
	ssize_t ret = 0;
	unsigned long val = 0;
	struct hisi_fb_data_type *hisifd = NULL;
