...
#include "display_effect_lg_R69006_5p5.h"

#define DTS_COMP_LG_R69006_5P5 "hisilicon,mipi_lg_R69006_5P5"
...
static struct dsi_cmd_desc lg_display_off_cmds[] = {
	{DTYPE_DCS_WRITE, 0, 22, WAIT_TYPE_MS,
	...
	char *buf)
{
	...
	ret = snprintf(buf, PAGE_SIZE, "lg_R69006 5.2' CMD TFT 1080 x 1920\n");
...
static irqreturn_t mipi_lg_panel_lcd_bist_check_isr(int irq, void *ptr)
{
	struct hisi_fb_data_type *hisifd = NULL;
...
static int mipi_lg_probe(struct platform_device *pdev)
{
	...
	np = of_find_compatible_node(NULL, NULL, DTS_COMP_LG_R69006_5P5);
	if (!np) {
		HISI_FB_ERR("NOT FOUND device node %s!\n", DTS_COMP_LG_R69006_5P5);
		goto err_return;
	}
	...
	HISI_FB_INFO("%s, lcd_id is 0x%x\n", DTS_COMP_LG_R69006_5P5, panel_lcd_id);
...
static const struct of_device_id hisi_panel_match_table[] = {
	{
		.compatible = DTS_COMP_LG_R69006_5P5,
		.data = NULL,
	},
	{},
};
