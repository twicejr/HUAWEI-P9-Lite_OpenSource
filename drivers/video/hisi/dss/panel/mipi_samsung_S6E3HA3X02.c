...
static char pentile_setting[] = {
	0xC2,
	0x00, 0x00, 0xD8, 0xD8, 0x00, 0x80, 0x2B, 0x05, 0x08, 0x0E, 0x07, 0x0B, 0x05, 0x0D, 0x0A, 0x15, 0x13, 0x20, 0x1E,
};
...
//		sizeof(reg_2A), reg_2A},
//	{DTYPE_DCS_LWRITE, 0, 200, WAIT_TYPE_US,
//		sizeof(reg_2B), reg_2B},
	{DTYPE_GEN_LWRITE, 0, 200, WAIT_TYPE_US,
		sizeof(test_key_enable), test_key_enable},
//	{DTYPE_GEN_LWRITE, 0, 200, WAIT_TYPE_US,
//		sizeof(reg_B0), reg_B0},
//	{DTYPE_GEN_LWRITE, 0, 200, WAIT_TYPE_US,
//		sizeof(reg_B5), reg_B5},
	{DTYPE_GEN_LWRITE, 0, 200, WAIT_TYPE_US,
	...
	const char *buf, size_t count)
{
	...
	case HBM_ON_MEDIUM:
		...
		break;
	default:
		HISI_FB_ERR("check your input parameter !\n");
		return count;
	}
	...
	const char *buf, size_t count)
{
	...
	mipi_dsi_cmds_tx(acl_enable_cmds, \
		ARRAY_SIZE(acl_enable_cmds), hisifd->mipi_dsi0_base);
	hisifb_deactivate_vsync(hisifd);
	...
	char *buf)
{
	...
	if (!strncmp(lcd_cmd_now, "LCD_INCOME0", strlen("LCD_INCOME0")) || /* incoming sence0 config */
		...
		return snprintf(buf, PAGE_SIZE, "CURRENT1_0,CURRENT2_0");
		...
		return snprintf(buf, PAGE_SIZE, "CURRENT1_1,CURRENT2_1");
		...
		return snprintf(buf, PAGE_SIZE, "CURRENT1_2,CURRENT2_2");
		...
		return snprintf(buf, PAGE_SIZE, "CURRENT1_3,CURRENT2_3");
		...
		return snprintf(buf, PAGE_SIZE, "CURRENT1_4,CURRENT2_4");
		...
		return snprintf(buf, PAGE_SIZE, "CURRENT1_5,CURRENT2_5");
		...
		return snprintf(buf, PAGE_SIZE, "/sys/class/ina231/ina231_0/ina231_set,"
										...
										"0,9999999,0,9999999,0,999999");//vol_min,vol_max,power_min,power_max,curr_min,curr_max
