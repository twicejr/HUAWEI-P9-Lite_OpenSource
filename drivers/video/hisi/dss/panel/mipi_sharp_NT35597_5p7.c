...
static struct dsi_cmd_desc lcd_display_init_cmd[] = {
	{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_MS, sizeof(select_page_cmd1), select_page_cmd1},
	{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_MS, sizeof(reload_cmd1), reload_cmd1},
	{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_MS, sizeof(tear_on), tear_on},
	{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_MS, sizeof(set_page3), set_page3},
	{DTYPE_DCS_LWRITE, 0,10, WAIT_TYPE_US, sizeof(reload_cmd1), reload_cmd1},
	{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US, sizeof(set_pwm_freq), set_pwm_freq},
	{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_MS, sizeof(select_page_cmd1), select_page_cmd1},
};
...
static struct dsi_cmd_desc crc_func_off_cmd[] = {
	{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US, sizeof(crc_func_off), crc_func_off},
};
static struct dsi_cmd_desc lcd_ifbc_vesa3x_en_cmd[] = {
	{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US, sizeof(vesa3x_enable), vesa3x_enable},
	{DTYPE_DCS_WRITE1, 0, 2, WAIT_TYPE_MS, sizeof(select_page_cmd1), select_page_cmd1},
	{DTYPE_DCS_LWRITE, 0, 10, WAIT_TYPE_US, sizeof(vesa_dsc_set1), vesa_dsc_set1},
	{DTYPE_DCS_LWRITE, 0, 10, WAIT_TYPE_US, sizeof(vesa_dsc_set2), vesa_dsc_set2},
	{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US, sizeof(reload_cmd1), reload_cmd1},
	{DTYPE_DCS_WRITE1, 0, 2, WAIT_TYPE_MS, sizeof(page2_8), page2_8},
	{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US, sizeof(vesa_version), vesa_version},
	{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US, sizeof(reload_cmd1), reload_cmd1},
	{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US, sizeof(select_page_cmd3), select_page_cmd3},
	{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US, sizeof(reload_cmd1), reload_cmd1},
	{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US, sizeof(lcm_set_cmd1), lcm_set_cmd1},
	{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US, sizeof(lcm_set_cmd2), lcm_set_cmd2},
	{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US, sizeof(lcm_set_cmd3), lcm_set_cmd3},
	{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US, sizeof(lcm_set_cmd4), lcm_set_cmd4},
	{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US, sizeof(lcm_set_cmd5), lcm_set_cmd5},
	{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US, sizeof(lcm_set_cmd6), lcm_set_cmd6},
	{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US, sizeof(lcm_set_cmd7), lcm_set_cmd7},
	{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US, sizeof(lcm_set_cmd8), lcm_set_cmd8},
	{DTYPE_DCS_WRITE1, 0, 10, WAIT_TYPE_US, sizeof(lcm_set_cmd9), lcm_set_cmd9},
	{DTYPE_DCS_WRITE1, 0, 2, WAIT_TYPE_MS, sizeof(select_page_cmd1), select_page_cmd1},
};
...
static struct gpio_desc asic_lcd_gpio_lowpower_cmd1[] = {
    /* AVEE_-5.5V */
    {DTYPE_GPIO_OUTPUT, WAIT_TYPE_MS, 5,
        GPIO_LCD_N5V5_ENABLE_NAME, &gpio_lcd_n5v5_enable, 0},
    /* AVDD_5.5V*/
...
static struct gpio_desc asic_lcd_gpio_lowpower_cmd2[] = {
    /* reset */
    {DTYPE_GPIO_OUTPUT, WAIT_TYPE_MS, 5,
        GPIO_LCD_RESET_NAME, &gpio_lcd_reset, 0},
    /* AVEE_-5.8V input */
	...
	if (pinfo->lcd_uninit_step == LCD_UNINIT_MIPI_HS_SEND_SEQUENCE) {
		...
		if (!hisifd->fb_shutdown)  {
			...
			if (!gesture_func && !g_debug_enable_lcd_sleep_in) {	//lcd panel shutdown
				...
				/* vsn,vsp disable */
				gpio_cmds_tx(asic_lcd_gpio_lowpower_cmd1, \
					ARRAY_SIZE(asic_lcd_gpio_lowpower_cmd1));
				...
				/* lcd reset set to L */
				gpio_cmds_tx(asic_lcd_gpio_lowpower_cmd2, \
					ARRAY_SIZE(asic_lcd_gpio_lowpower_cmd2));
...
static ssize_t mipi_sharp_panel_lcd_sleep_ctrl_store(struct platform_device *pdev,  const char *buf, size_t count)
{
	ssize_t ret = 0;
	unsigned long val = 0;
	struct hisi_fb_data_type *hisifd = NULL;
