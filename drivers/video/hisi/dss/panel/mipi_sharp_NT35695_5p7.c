...
#include "include/mipi_sharp_NT35695_5p7.h"
	...
	char *buf)
{
	...
	ret = snprintf(buf, PAGE_SIZE, "sharp_NT35695 5.7 CMD TFT\n");
...
static int mipi_lcd_probe(struct platform_device *pdev)
{
	...
	* so need a clk_post_adjust more than 200ui.
...
static const struct of_device_id hisi_panel_match_table[] = {
	{
		.compatible = DTS_COMP_SHARP_NT35695_5P7,
		.data = NULL,
	},
	{},
};
