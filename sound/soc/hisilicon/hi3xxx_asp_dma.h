...
#ifndef __HI3xxx_DMA_H__
#define __HI3xxx_DMA_H__

/* HI3xxx_DMAC base addr */
...
*/
/* austin */
#define AUSTIN_BASE_ADDR_SIO_AUDIO      0xe804F000
#define HI3xxx_SIO_I2S_RX_CHN_REG       0xa0
#define HI3xxx_SIO_I2S_TX_CHN_REG       0xc0

#define SLIMBUS_BASE_ADDR_PORT0			0xe8051000
#define SLIMBUS_BASE_ADDR_PORT2			0XE8051080

#define HI3xxx_MIN_STOP_DMA_TIME_US 	1000
#define HI3xxx_MAX_STOP_DMA_TIME_US 	2000
...
#define CONFIG_PERI_AUDIO_TX			(0x0 << ASP_DMAC_PERI_OFFSET)
#define CONFIG_PERI_AUDIO_RX			(0x2 << ASP_DMAC_PERI_OFFSET)
...
#define DMA_CONFIG_TX	(	\
			...
			CONFIG_SL 	 	 			| CONFIG_DL 		| 	\
			CONFIG_SW 	 	 			| CONFIG_DW 		|	\
			CONFIG_PERI_AUDIO_TX 		| CONFIG_FLOW_CTRL  | 	\
			CONFIG_ITC_EN 	 			| CONFIG_CH_EN)
...
#define DMA_CONFIG_RX	(	\
			...
			CONFIG_SL 	 	 			| CONFIG_DL 		| 	\
			CONFIG_SW 	 	 			| CONFIG_DW 		|	\
			CONFIG_PERI_AUDIO_RX 		| CONFIG_FLOW_CTRL  | 	\
			CONFIG_ITC_EN 	 			| CONFIG_CH_EN)
